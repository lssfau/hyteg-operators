...
class P2ToP2VectorElementwiseRhoGMassIcosahedralShellMap : public Operator< P2Function< real_t >, P2VectorFunction< real_t > >
{
 public:
   P2ToP2VectorElementwiseRhoGMassIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                       size_t                                     minLevel,
                                                       size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ToP2VectorElementwiseRhoGMassIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5816    7585      80      55     55              0                 0              1
   void applyScaled_P2ToP2VectorElementwiseRhoGMassIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5516    7555      80      55     55              0                 0              4
   void toMatrixScaled_P2ToP2VectorElementwiseRhoGMassIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst_edge_0,
