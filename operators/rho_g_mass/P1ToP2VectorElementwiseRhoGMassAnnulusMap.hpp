...
class P1ToP2VectorElementwiseRhoGMassAnnulusMap : public Operator< P1Function< real_t >, P2VectorFunction< real_t > >
{
 public:
   P1ToP2VectorElementwiseRhoGMassAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                              size_t                                     minLevel,
                                              size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P1ToP2VectorElementwiseRhoGMassAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    504     748      28      20     12              0                 0              1
   void applyScaled_P1ToP2VectorElementwiseRhoGMassAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    468     736      28      20     12              0                 0              4
   void toMatrixScaled_P1ToP2VectorElementwiseRhoGMassAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
