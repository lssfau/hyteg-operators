...
P2ToP2VectorElementwiseRhoGMassAnnulusMap::P2ToP2VectorElementwiseRhoGMassAnnulusMap(
...
void P2ToP2VectorElementwiseRhoGMassAnnulusMap::applyScaled( const real_t&                     operatorScaling,
                                                             ...
                                                             UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ToP2VectorElementwiseRhoGMassAnnulusMap_macro_2D(
...
void P2ToP2VectorElementwiseRhoGMassAnnulusMap::apply( const P2Function< real_t >&       src,
                                                       const P2VectorFunction< real_t >& dst,
                                                       uint_t                            level,
                                                       DoFType                           flag,
                                                       UpdateType                        updateType ) const
...
void P2ToP2VectorElementwiseRhoGMassAnnulusMap::toMatrixScaled( const real_t&                               toMatrixScaling,
...
void P2ToP2VectorElementwiseRhoGMassAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                          const P2Function< idx_t >&                  src,
                                                          const P2VectorFunction< idx_t >&            dst,
                                                          uint_t                                      level,
                                                          DoFType                                     flag ) const
