...
P2ToP2VectorElementwiseRhoGMassIcosahedralShellMap::P2ToP2VectorElementwiseRhoGMassIcosahedralShellMap(
...
void P2ToP2VectorElementwiseRhoGMassIcosahedralShellMap::applyScaled( const real_t&                     operatorScaling,
                                                                      ...
                                                                      UpdateType                        updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ToP2VectorElementwiseRhoGMassIcosahedralShellMap_macro_3D(
...
void P2ToP2VectorElementwiseRhoGMassIcosahedralShellMap::apply( const P2Function< real_t >&       src,
                                                                const P2VectorFunction< real_t >& dst,
                                                                uint_t                            level,
                                                                DoFType                           flag,
                                                                UpdateType                        updateType ) const
...
void P2ToP2VectorElementwiseRhoGMassIcosahedralShellMap::toMatrixScaled( const real_t& toMatrixScaling,
                                                                         ...
                                                                         DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ToP2VectorElementwiseRhoGMassIcosahedralShellMap_macro_3D(
...
void P2ToP2VectorElementwiseRhoGMassIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                   const P2Function< idx_t >&                  src,
                                                                   const P2VectorFunction< idx_t >&            dst,
                                                                   uint_t                                      level,
                                                                   DoFType                                     flag ) const
