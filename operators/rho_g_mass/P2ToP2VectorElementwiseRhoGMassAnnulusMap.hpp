...
class P2ToP2VectorElementwiseRhoGMassAnnulusMap : public Operator< P2Function< real_t >, P2VectorFunction< real_t > >
{
 public:
   P2ToP2VectorElementwiseRhoGMassAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                              size_t                                     minLevel,
                                              size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ToP2VectorElementwiseRhoGMassAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    974    1338      36      30     18              0                 0              1
   void applyScaled_P2ToP2VectorElementwiseRhoGMassAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    902    1326      36      30     18              0                 0              4
   void toMatrixScaled_P2ToP2VectorElementwiseRhoGMassAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
