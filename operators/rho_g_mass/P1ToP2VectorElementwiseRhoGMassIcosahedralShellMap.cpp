...
P1ToP2VectorElementwiseRhoGMassIcosahedralShellMap::P1ToP2VectorElementwiseRhoGMassIcosahedralShellMap(
...
void P1ToP2VectorElementwiseRhoGMassIcosahedralShellMap::applyScaled( const real_t&                     operatorScaling,
                                                                      ...
                                                                      UpdateType                        updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P1ToP2VectorElementwiseRhoGMassIcosahedralShellMap_macro_3D(
...
void P1ToP2VectorElementwiseRhoGMassIcosahedralShellMap::apply( const P1Function< real_t >&       src,
                                                                const P2VectorFunction< real_t >& dst,
                                                                uint_t                            level,
                                                                DoFType                           flag,
                                                                UpdateType                        updateType ) const
                                                                         ...
                                                                         DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P1ToP2VectorElementwiseRhoGMassIcosahedralShellMap_macro_3D(
...
void P1ToP2VectorElementwiseRhoGMassIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                   const P1Function< idx_t >&                  src,
                                                                   const P2VectorFunction< idx_t >&            dst,
                                                                   uint_t                                      level,
                                                                   DoFType                                     flag ) const
