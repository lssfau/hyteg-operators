...
///     v: test function (vector space: TensorialVectorSpace(Lagrange, degree: 2))
///     rho: coefficient (scalar space: Lagrange, degree: 1)
///
///     - ∫ rho T (g · v)

class P1ToP2VectorElementwiseRhoGMassIcosahedralShellMap : public Operator< P1Function< real_t >, P2VectorFunction< real_t > >
{
 public:
   P1ToP2VectorElementwiseRhoGMassIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                       size_t                                     minLevel,
                                                       size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P1ToP2VectorElementwiseRhoGMassIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1778    2587      56      25     25              0                 0              1
   void applyScaled_P1ToP2VectorElementwiseRhoGMassIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1658    2557      56      25     25              0                 0              4
   void toMatrixScaled_P1ToP2VectorElementwiseRhoGMassIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst_edge_0,
