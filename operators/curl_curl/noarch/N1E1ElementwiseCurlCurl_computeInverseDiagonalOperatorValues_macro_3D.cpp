...
{
    {
       ...
       const walberla::float64 Dummy_604 = 1.0 / (abs_det_jac_affine_WHITE_UP)*0.16666666666666666;
       const walberla::float64 tmp_1 = jac_affine_0_0_WHITE_UP*2.0;
       const walberla::float64 tmp_2 = jac_affine_0_1_WHITE_UP*2.0;
       const walberla::float64 tmp_3 = jac_affine_1_0_WHITE_UP*2.0;
       const walberla::float64 tmp_4 = jac_affine_1_1_WHITE_UP*2.0;
       const walberla::float64 tmp_5 = jac_affine_2_0_WHITE_UP*2.0;
       const walberla::float64 tmp_6 = jac_affine_2_1_WHITE_UP*2.0;
       const walberla::float64 tmp_7 = jac_affine_0_2_WHITE_UP*-2.0;
       const walberla::float64 tmp_8 = jac_affine_1_2_WHITE_UP*-2.0;
       const walberla::float64 tmp_9 = jac_affine_2_2_WHITE_UP*-2.0;
       const walberla::float64 elMatDiag_0 = Dummy_604*((jac_affine_0_0_WHITE_UP*jac_affine_0_0_WHITE_UP)*4.0 + (jac_affine_1_0_WHITE_UP*jac_affine_1_0_WHITE_UP)*4.0 + (jac_affine_2_0_WHITE_UP*jac_affine_2_0_WHITE_UP)*4.0);
       const walberla::float64 elMatDiag_1 = Dummy_604*((jac_affine_0_1_WHITE_UP*jac_affine_0_1_WHITE_UP)*4.0 + (jac_affine_1_1_WHITE_UP*jac_affine_1_1_WHITE_UP)*4.0 + (jac_affine_2_1_WHITE_UP*jac_affine_2_1_WHITE_UP)*4.0);
       const walberla::float64 elMatDiag_2 = Dummy_604*((jac_affine_0_2_WHITE_UP*jac_affine_0_2_WHITE_UP)*4.0 + (jac_affine_1_2_WHITE_UP*jac_affine_1_2_WHITE_UP)*4.0 + (jac_affine_2_2_WHITE_UP*jac_affine_2_2_WHITE_UP)*4.0);
       const walberla::float64 elMatDiag_3 = Dummy_604*(((-tmp_1 + tmp_2)*(-tmp_1 + tmp_2)) + ((-tmp_3 + tmp_4)*(-tmp_3 + tmp_4)) + ((-tmp_5 + tmp_6)*(-tmp_5 + tmp_6)));
       const walberla::float64 elMatDiag_4 = Dummy_604*(((tmp_1 + tmp_7)*(tmp_1 + tmp_7)) + ((tmp_3 + tmp_8)*(tmp_3 + tmp_8)) + ((tmp_5 + tmp_9)*(tmp_5 + tmp_9)));
       const walberla::float64 elMatDiag_5 = Dummy_604*(((-tmp_2 - tmp_7)*(-tmp_2 - tmp_7)) + ((-tmp_4 - tmp_8)*(-tmp_4 - tmp_8)) + ((-tmp_6 - tmp_9)*(-tmp_6 - tmp_9)));
       {
          /* CellType.WHITE_UP */
       ...
       const walberla::float64 Dummy_605 = 1.0 / (abs_det_jac_affine_WHITE_DOWN)*0.16666666666666666;
       const walberla::float64 Dummy_606 = jac_affine_0_0_WHITE_DOWN*2.0;
       const walberla::float64 Dummy_607 = jac_affine_0_1_WHITE_DOWN*2.0;
       const walberla::float64 Dummy_608 = jac_affine_1_0_WHITE_DOWN*2.0;
       const walberla::float64 Dummy_609 = jac_affine_1_1_WHITE_DOWN*2.0;
       const walberla::float64 Dummy_610 = jac_affine_2_0_WHITE_DOWN*2.0;
       const walberla::float64 Dummy_611 = jac_affine_2_1_WHITE_DOWN*2.0;
       const walberla::float64 Dummy_612 = jac_affine_0_2_WHITE_DOWN*-2.0;
       const walberla::float64 Dummy_613 = jac_affine_1_2_WHITE_DOWN*-2.0;
       const walberla::float64 Dummy_614 = jac_affine_2_2_WHITE_DOWN*-2.0;
       const walberla::float64 Dummy_615 = Dummy_605*((jac_affine_0_0_WHITE_DOWN*jac_affine_0_0_WHITE_DOWN)*4.0 + (jac_affine_1_0_WHITE_DOWN*jac_affine_1_0_WHITE_DOWN)*4.0 + (jac_affine_2_0_WHITE_DOWN*jac_affine_2_0_WHITE_DOWN)*4.0);
       const walberla::float64 Dummy_616 = Dummy_605*((jac_affine_0_1_WHITE_DOWN*jac_affine_0_1_WHITE_DOWN)*4.0 + (jac_affine_1_1_WHITE_DOWN*jac_affine_1_1_WHITE_DOWN)*4.0 + (jac_affine_2_1_WHITE_DOWN*jac_affine_2_1_WHITE_DOWN)*4.0);
       const walberla::float64 Dummy_617 = Dummy_605*((jac_affine_0_2_WHITE_DOWN*jac_affine_0_2_WHITE_DOWN)*4.0 + (jac_affine_1_2_WHITE_DOWN*jac_affine_1_2_WHITE_DOWN)*4.0 + (jac_affine_2_2_WHITE_DOWN*jac_affine_2_2_WHITE_DOWN)*4.0);
       const walberla::float64 Dummy_618 = Dummy_605*(((-Dummy_606 + Dummy_607)*(-Dummy_606 + Dummy_607)) + ((-Dummy_608 + Dummy_609)*(-Dummy_608 + Dummy_609)) + ((-Dummy_610 + Dummy_611)*(-Dummy_610 + Dummy_611)));
       const walberla::float64 Dummy_619 = Dummy_605*(((Dummy_606 + Dummy_612)*(Dummy_606 + Dummy_612)) + ((Dummy_608 + Dummy_613)*(Dummy_608 + Dummy_613)) + ((Dummy_610 + Dummy_614)*(Dummy_610 + Dummy_614)));
       const walberla::float64 Dummy_620 = Dummy_605*(((-Dummy_607 - Dummy_612)*(-Dummy_607 - Dummy_612)) + ((-Dummy_609 - Dummy_613)*(-Dummy_609 - Dummy_613)) + ((-Dummy_611 - Dummy_614)*(-Dummy_611 - Dummy_614)));
       {
          /* CellType.WHITE_DOWN */
          for (int64_t ctr_2 = 0; ctr_2 < micro_edges_per_macro_edge; ctr_2 += 1)
          for (int64_t ctr_1 = 0; ctr_1 < -ctr_2 + micro_edges_per_macro_edge; ctr_1 += 1)
       ...
       const walberla::float64 Dummy_621 = 1.0 / (abs_det_jac_affine_BLUE_UP)*0.16666666666666666;
       const walberla::float64 Dummy_622 = jac_affine_0_0_BLUE_UP*2.0;
       const walberla::float64 Dummy_623 = jac_affine_0_1_BLUE_UP*2.0;
       const walberla::float64 Dummy_624 = jac_affine_1_0_BLUE_UP*2.0;
       const walberla::float64 Dummy_625 = jac_affine_1_1_BLUE_UP*2.0;
       const walberla::float64 Dummy_626 = jac_affine_2_0_BLUE_UP*2.0;
       const walberla::float64 Dummy_627 = jac_affine_2_1_BLUE_UP*2.0;
       const walberla::float64 Dummy_628 = jac_affine_0_2_BLUE_UP*-2.0;
       const walberla::float64 Dummy_629 = jac_affine_1_2_BLUE_UP*-2.0;
       const walberla::float64 Dummy_630 = jac_affine_2_2_BLUE_UP*-2.0;
       const walberla::float64 Dummy_631 = Dummy_621*((jac_affine_0_0_BLUE_UP*jac_affine_0_0_BLUE_UP)*4.0 + (jac_affine_1_0_BLUE_UP*jac_affine_1_0_BLUE_UP)*4.0 + (jac_affine_2_0_BLUE_UP*jac_affine_2_0_BLUE_UP)*4.0);
       const walberla::float64 Dummy_632 = Dummy_621*((jac_affine_0_1_BLUE_UP*jac_affine_0_1_BLUE_UP)*4.0 + (jac_affine_1_1_BLUE_UP*jac_affine_1_1_BLUE_UP)*4.0 + (jac_affine_2_1_BLUE_UP*jac_affine_2_1_BLUE_UP)*4.0);
       const walberla::float64 Dummy_633 = Dummy_621*((jac_affine_0_2_BLUE_UP*jac_affine_0_2_BLUE_UP)*4.0 + (jac_affine_1_2_BLUE_UP*jac_affine_1_2_BLUE_UP)*4.0 + (jac_affine_2_2_BLUE_UP*jac_affine_2_2_BLUE_UP)*4.0);
       const walberla::float64 Dummy_634 = Dummy_621*(((-Dummy_622 + Dummy_623)*(-Dummy_622 + Dummy_623)) + ((-Dummy_624 + Dummy_625)*(-Dummy_624 + Dummy_625)) + ((-Dummy_626 + Dummy_627)*(-Dummy_626 + Dummy_627)));
       const walberla::float64 Dummy_635 = Dummy_621*(((Dummy_622 + Dummy_628)*(Dummy_622 + Dummy_628)) + ((Dummy_624 + Dummy_629)*(Dummy_624 + Dummy_629)) + ((Dummy_626 + Dummy_630)*(Dummy_626 + Dummy_630)));
       const walberla::float64 Dummy_636 = Dummy_621*(((-Dummy_623 - Dummy_628)*(-Dummy_623 - Dummy_628)) + ((-Dummy_625 - Dummy_629)*(-Dummy_625 - Dummy_629)) + ((-Dummy_627 - Dummy_630)*(-Dummy_627 - Dummy_630)));
       {
          /* CellType.BLUE_UP */
          for (int64_t ctr_2 = 0; ctr_2 < micro_edges_per_macro_edge; ctr_2 += 1)
          for (int64_t ctr_1 = 0; ctr_1 < -ctr_2 + micro_edges_per_macro_edge; ctr_1 += 1)
       ...
       const walberla::float64 Dummy_637 = 1.0 / (abs_det_jac_affine_BLUE_DOWN)*0.16666666666666666;
       const walberla::float64 Dummy_638 = jac_affine_0_0_BLUE_DOWN*2.0;
       const walberla::float64 Dummy_639 = jac_affine_0_1_BLUE_DOWN*2.0;
       const walberla::float64 Dummy_640 = jac_affine_1_0_BLUE_DOWN*2.0;
       const walberla::float64 Dummy_641 = jac_affine_1_1_BLUE_DOWN*2.0;
       const walberla::float64 Dummy_642 = jac_affine_2_0_BLUE_DOWN*2.0;
       const walberla::float64 Dummy_643 = jac_affine_2_1_BLUE_DOWN*2.0;
       const walberla::float64 Dummy_644 = jac_affine_0_2_BLUE_DOWN*-2.0;
       const walberla::float64 Dummy_645 = jac_affine_1_2_BLUE_DOWN*-2.0;
       const walberla::float64 Dummy_646 = jac_affine_2_2_BLUE_DOWN*-2.0;
       const walberla::float64 Dummy_647 = Dummy_637*((jac_affine_0_0_BLUE_DOWN*jac_affine_0_0_BLUE_DOWN)*4.0 + (jac_affine_1_0_BLUE_DOWN*jac_affine_1_0_BLUE_DOWN)*4.0 + (jac_affine_2_0_BLUE_DOWN*jac_affine_2_0_BLUE_DOWN)*4.0);
       const walberla::float64 Dummy_648 = Dummy_637*((jac_affine_0_1_BLUE_DOWN*jac_affine_0_1_BLUE_DOWN)*4.0 + (jac_affine_1_1_BLUE_DOWN*jac_affine_1_1_BLUE_DOWN)*4.0 + (jac_affine_2_1_BLUE_DOWN*jac_affine_2_1_BLUE_DOWN)*4.0);
       const walberla::float64 Dummy_649 = Dummy_637*((jac_affine_0_2_BLUE_DOWN*jac_affine_0_2_BLUE_DOWN)*4.0 + (jac_affine_1_2_BLUE_DOWN*jac_affine_1_2_BLUE_DOWN)*4.0 + (jac_affine_2_2_BLUE_DOWN*jac_affine_2_2_BLUE_DOWN)*4.0);
       const walberla::float64 Dummy_650 = Dummy_637*(((-Dummy_638 + Dummy_639)*(-Dummy_638 + Dummy_639)) + ((-Dummy_640 + Dummy_641)*(-Dummy_640 + Dummy_641)) + ((-Dummy_642 + Dummy_643)*(-Dummy_642 + Dummy_643)));
       const walberla::float64 Dummy_651 = Dummy_637*(((Dummy_638 + Dummy_644)*(Dummy_638 + Dummy_644)) + ((Dummy_640 + Dummy_645)*(Dummy_640 + Dummy_645)) + ((Dummy_642 + Dummy_646)*(Dummy_642 + Dummy_646)));
       const walberla::float64 Dummy_652 = Dummy_637*(((-Dummy_639 - Dummy_644)*(-Dummy_639 - Dummy_644)) + ((-Dummy_641 - Dummy_645)*(-Dummy_641 - Dummy_645)) + ((-Dummy_643 - Dummy_646)*(-Dummy_643 - Dummy_646)));
       {
          /* CellType.BLUE_DOWN */
          for (int64_t ctr_2 = 0; ctr_2 < micro_edges_per_macro_edge; ctr_2 += 1)
          for (int64_t ctr_1 = 0; ctr_1 < -ctr_2 + micro_edges_per_macro_edge; ctr_1 += 1)
       ...
       const walberla::float64 Dummy_653 = 1.0 / (abs_det_jac_affine_GREEN_UP)*0.16666666666666666;
       const walberla::float64 Dummy_654 = jac_affine_0_0_GREEN_UP*2.0;
       const walberla::float64 Dummy_655 = jac_affine_0_1_GREEN_UP*2.0;
       const walberla::float64 Dummy_656 = jac_affine_1_0_GREEN_UP*2.0;
       const walberla::float64 Dummy_657 = jac_affine_1_1_GREEN_UP*2.0;
       const walberla::float64 Dummy_658 = jac_affine_2_0_GREEN_UP*2.0;
       const walberla::float64 Dummy_659 = jac_affine_2_1_GREEN_UP*2.0;
       const walberla::float64 Dummy_660 = jac_affine_0_2_GREEN_UP*-2.0;
       const walberla::float64 Dummy_661 = jac_affine_1_2_GREEN_UP*-2.0;
       const walberla::float64 Dummy_662 = jac_affine_2_2_GREEN_UP*-2.0;
       const walberla::float64 Dummy_663 = Dummy_653*((jac_affine_0_0_GREEN_UP*jac_affine_0_0_GREEN_UP)*4.0 + (jac_affine_1_0_GREEN_UP*jac_affine_1_0_GREEN_UP)*4.0 + (jac_affine_2_0_GREEN_UP*jac_affine_2_0_GREEN_UP)*4.0);
       const walberla::float64 Dummy_664 = Dummy_653*((jac_affine_0_1_GREEN_UP*jac_affine_0_1_GREEN_UP)*4.0 + (jac_affine_1_1_GREEN_UP*jac_affine_1_1_GREEN_UP)*4.0 + (jac_affine_2_1_GREEN_UP*jac_affine_2_1_GREEN_UP)*4.0);
       const walberla::float64 Dummy_665 = Dummy_653*((jac_affine_0_2_GREEN_UP*jac_affine_0_2_GREEN_UP)*4.0 + (jac_affine_1_2_GREEN_UP*jac_affine_1_2_GREEN_UP)*4.0 + (jac_affine_2_2_GREEN_UP*jac_affine_2_2_GREEN_UP)*4.0);
       const walberla::float64 Dummy_666 = Dummy_653*(((-Dummy_654 + Dummy_655)*(-Dummy_654 + Dummy_655)) + ((-Dummy_656 + Dummy_657)*(-Dummy_656 + Dummy_657)) + ((-Dummy_658 + Dummy_659)*(-Dummy_658 + Dummy_659)));
       const walberla::float64 Dummy_667 = Dummy_653*(((Dummy_654 + Dummy_660)*(Dummy_654 + Dummy_660)) + ((Dummy_656 + Dummy_661)*(Dummy_656 + Dummy_661)) + ((Dummy_658 + Dummy_662)*(Dummy_658 + Dummy_662)));
       const walberla::float64 Dummy_668 = Dummy_653*(((-Dummy_655 - Dummy_660)*(-Dummy_655 - Dummy_660)) + ((-Dummy_657 - Dummy_661)*(-Dummy_657 - Dummy_661)) + ((-Dummy_659 - Dummy_662)*(-Dummy_659 - Dummy_662)));
       {
          /* CellType.GREEN_UP */
          for (int64_t ctr_2 = 0; ctr_2 < micro_edges_per_macro_edge; ctr_2 += 1)
          for (int64_t ctr_1 = 0; ctr_1 < -ctr_2 + micro_edges_per_macro_edge; ctr_1 += 1)
       ...
       const walberla::float64 Dummy_669 = 1.0 / (abs_det_jac_affine_GREEN_DOWN)*0.16666666666666666;
       const walberla::float64 Dummy_670 = jac_affine_0_0_GREEN_DOWN*2.0;
       const walberla::float64 Dummy_671 = jac_affine_0_1_GREEN_DOWN*2.0;
       const walberla::float64 Dummy_672 = jac_affine_1_0_GREEN_DOWN*2.0;
       const walberla::float64 Dummy_673 = jac_affine_1_1_GREEN_DOWN*2.0;
       const walberla::float64 Dummy_674 = jac_affine_2_0_GREEN_DOWN*2.0;
       const walberla::float64 Dummy_675 = jac_affine_2_1_GREEN_DOWN*2.0;
       const walberla::float64 Dummy_676 = jac_affine_0_2_GREEN_DOWN*-2.0;
       const walberla::float64 Dummy_677 = jac_affine_1_2_GREEN_DOWN*-2.0;
       const walberla::float64 Dummy_678 = jac_affine_2_2_GREEN_DOWN*-2.0;
       const walberla::float64 Dummy_679 = Dummy_669*((jac_affine_0_0_GREEN_DOWN*jac_affine_0_0_GREEN_DOWN)*4.0 + (jac_affine_1_0_GREEN_DOWN*jac_affine_1_0_GREEN_DOWN)*4.0 + (jac_affine_2_0_GREEN_DOWN*jac_affine_2_0_GREEN_DOWN)*4.0);
       const walberla::float64 Dummy_680 = Dummy_669*((jac_affine_0_1_GREEN_DOWN*jac_affine_0_1_GREEN_DOWN)*4.0 + (jac_affine_1_1_GREEN_DOWN*jac_affine_1_1_GREEN_DOWN)*4.0 + (jac_affine_2_1_GREEN_DOWN*jac_affine_2_1_GREEN_DOWN)*4.0);
       const walberla::float64 Dummy_681 = Dummy_669*((jac_affine_0_2_GREEN_DOWN*jac_affine_0_2_GREEN_DOWN)*4.0 + (jac_affine_1_2_GREEN_DOWN*jac_affine_1_2_GREEN_DOWN)*4.0 + (jac_affine_2_2_GREEN_DOWN*jac_affine_2_2_GREEN_DOWN)*4.0);
       const walberla::float64 Dummy_682 = Dummy_669*(((-Dummy_670 + Dummy_671)*(-Dummy_670 + Dummy_671)) + ((-Dummy_672 + Dummy_673)*(-Dummy_672 + Dummy_673)) + ((-Dummy_674 + Dummy_675)*(-Dummy_674 + Dummy_675)));
       const walberla::float64 Dummy_683 = Dummy_669*(((Dummy_670 + Dummy_676)*(Dummy_670 + Dummy_676)) + ((Dummy_672 + Dummy_677)*(Dummy_672 + Dummy_677)) + ((Dummy_674 + Dummy_678)*(Dummy_674 + Dummy_678)));
       const walberla::float64 Dummy_684 = Dummy_669*(((-Dummy_671 - Dummy_676)*(-Dummy_671 - Dummy_676)) + ((-Dummy_673 - Dummy_677)*(-Dummy_673 - Dummy_677)) + ((-Dummy_675 - Dummy_678)*(-Dummy_675 - Dummy_678)));
       {
          /* CellType.GREEN_DOWN */
          for (int64_t ctr_2 = 0; ctr_2 < micro_edges_per_macro_edge; ctr_2 += 1)
          for (int64_t ctr_1 = 0; ctr_1 < -ctr_2 + micro_edges_per_macro_edge; ctr_1 += 1)
