...
{
    {
       ...
       {
          /* CellType.WHITE_UP */
          const real_t _data_phi_0_0_WHITE_UP [] = {-0.090535362930810992, -0.011579335952356828, -0.11760379463625681, -0.068767228413546891, 0.10234491325961378, 0.16073565742743148, 0.60687827722315146, 0.039095058653867309, 0.14760845367810674, 0.23182336169080051, -0.0053570531758102002, -0.026981886857756689, -0.08826927993497348, 0.59856367989927617, 0.38991501098196513, 0.097478145633287397, 0.013105850958460542, 0.018445551186837106, 0.0024799881361180498, 0.0006199931725955482, -0.047387428697692885, -0.091259737764059851, -0.1113914185759802, -0.080241973959818302, 0.13353232929213443, 0.048239998198448431, 0.15974715277305154, 0.1795192875052915, 0.59447960443206538, 0.21476218679656028, -0.012365312874640544, -0.11783608671457169, 0.099840210581437105, -0.12209237840485256, 0.49602512400408078, 0.161149647055262, 0.44517368008565716, 0.010752243911943793, 0.029702925690040238, 0.0096499466656436994, -0.039132866314689811, 0.52330757747208378, -0.025291504202103146, -0.086435669103359453, 0.011878329657082472, 0.36424725943509562, 0.087569474525404659, 0.019025274908404714, 0.0045739076500237383, 0.14025821597205745, -0.075020078347640823, -0.10978594944123118, -0.087269478727699787, -0.038293245964176326, 0.20646997194002201, 0.61807351051034776, 0.15194937966625316, 0.16847248498571801, 0.041417872063914368, 0.12398553331449269, -0.10872199595435525, -0.071573088371655491, -0.066785736996983452, -0.0060897460877574749, 0.15682570344877764, 0.17098019180848095, 0.027487844842548723, 0.67204203738214874, 0.10804168047678223, 0.11779310945201321, 0.37695779888932324, -0.066990727368889835, -0.055283676461052214, -0.083546970475516125, 0.026846095514264753, 0.033800130105328889, 0.020177061431168701, 0.31851359257248568, 0.19013738420444903, 0.23938931158843763, -0.10297005415588911, -0.053714325748548342, -0.050503954623664971, -0.1046997294598791, 0.62152169062946561, 0.085872752242822009, 0.1084579951005582, 0.20350077550717194, 0.25702315969221257, 0.03551169081575134, -0.083475373185951274, -0.053119697675226007, -0.051073377242295631, -0.085005424835789295, 0.025080212002029836, 0.19093237635024654, 0.10152786415556034, 0.17117472918588617, 0.091021779458552471, 0.69293691178698702, -0.097002376729223169, -0.070699586880466903, 0.42474742969688395, -0.0086506859049516431, 0.027272664380649191, 0.0030019501617763451, 0.26395899941365064, 0.0046382953510501583, 0.40784148099371537, 0.044891829516916615};
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             {
                const real_t tmp_qloop_0 = (k_dof_0*_data_phi_0_0_WHITE_UP[10*q] + k_dof_1*_data_phi_0_0_WHITE_UP[10*q + 1] + k_dof_2*_data_phi_0_0_WHITE_UP[10*q + 2] + k_dof_3*_data_phi_0_0_WHITE_UP[10*q + 3] + k_dof_4*_data_phi_0_0_WHITE_UP[10*q + 4] + k_dof_5*_data_phi_0_0_WHITE_UP[10*q + 5] + k_dof_6*_data_phi_0_0_WHITE_UP[10*q + 6] + k_dof_7*_data_phi_0_0_WHITE_UP[10*q + 7] + k_dof_8*_data_phi_0_0_WHITE_UP[10*q + 8] + k_dof_9*_data_phi_0_0_WHITE_UP[10*q + 9])*_data_q_w[q];
                const real_t tmp_qloop_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 14];
                const real_t q_tmp_0_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q];
                const real_t q_tmp_0_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 1];
                const real_t q_tmp_0_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 2];
                const real_t q_tmp_0_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 3];
                const real_t q_tmp_0_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 4];
                const real_t q_tmp_0_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 5];
                const real_t q_tmp_0_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 6];
                const real_t q_tmp_0_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 7];
                const real_t q_tmp_0_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 8];
                const real_t q_tmp_0_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 9];
                const real_t q_tmp_1_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 10];
                const real_t q_tmp_1_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 11];
                const real_t q_tmp_1_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 12];
                const real_t q_tmp_1_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 13];
                const real_t q_tmp_1_4 = tmp_qloop_1;
                const real_t q_tmp_1_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 15];
                const real_t q_tmp_1_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 16];
                const real_t q_tmp_1_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 17];
                const real_t q_tmp_1_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 18];
                const real_t q_tmp_1_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 19];
                const real_t q_tmp_2_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 20];
                const real_t q_tmp_2_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 21];
                const real_t q_tmp_2_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 22];
                const real_t q_tmp_2_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 23];
                const real_t q_tmp_2_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 24];
                const real_t q_tmp_2_5 = tmp_qloop_1;
                const real_t q_tmp_2_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 25];
                const real_t q_tmp_2_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 26];
                const real_t q_tmp_2_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 27];
                const real_t q_tmp_2_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 28];
                const real_t q_tmp_3_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 29];
                const real_t q_tmp_3_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 30];
                const real_t q_tmp_3_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 31];
                const real_t q_tmp_3_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 32];
                const real_t q_tmp_3_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 33];
                const real_t q_tmp_3_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 34];
                const real_t q_tmp_3_6 = tmp_qloop_1;
                const real_t q_tmp_3_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 35];
                const real_t q_tmp_3_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 36];
                const real_t q_tmp_3_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_UP[38*q + 37];
       ...
       {
          /* CellType.WHITE_DOWN */
          const real_t _data_phi_0_0_WHITE_DOWN [] = {-0.090535362930810992, -0.011579335952356828, -0.11760379463625681, -0.068767228413546891, 0.10234491325961378, 0.16073565742743148, 0.60687827722315146, 0.039095058653867309, 0.14760845367810674, 0.23182336169080051, -0.0053570531758102002, -0.026981886857756689, -0.08826927993497348, 0.59856367989927617, 0.38991501098196513, 0.097478145633287397, 0.013105850958460542, 0.018445551186837106, 0.0024799881361180498, 0.0006199931725955482, -0.047387428697692885, -0.091259737764059851, -0.1113914185759802, -0.080241973959818302, 0.13353232929213443, 0.048239998198448431, 0.15974715277305154, 0.1795192875052915, 0.59447960443206538, 0.21476218679656028, -0.012365312874640544, -0.11783608671457169, 0.099840210581437105, -0.12209237840485256, 0.49602512400408078, 0.161149647055262, 0.44517368008565716, 0.010752243911943793, 0.029702925690040238, 0.0096499466656436994, -0.039132866314689811, 0.52330757747208378, -0.025291504202103146, -0.086435669103359453, 0.011878329657082472, 0.36424725943509562, 0.087569474525404659, 0.019025274908404714, 0.0045739076500237383, 0.14025821597205745, -0.075020078347640823, -0.10978594944123118, -0.087269478727699787, -0.038293245964176326, 0.20646997194002201, 0.61807351051034776, 0.15194937966625316, 0.16847248498571801, 0.041417872063914368, 0.12398553331449269, -0.10872199595435525, -0.071573088371655491, -0.066785736996983452, -0.0060897460877574749, 0.15682570344877764, 0.17098019180848095, 0.027487844842548723, 0.67204203738214874, 0.10804168047678223, 0.11779310945201321, 0.37695779888932324, -0.066990727368889835, -0.055283676461052214, -0.083546970475516125, 0.026846095514264753, 0.033800130105328889, 0.020177061431168701, 0.31851359257248568, 0.19013738420444903, 0.23938931158843763, -0.10297005415588911, -0.053714325748548342, -0.050503954623664971, -0.1046997294598791, 0.62152169062946561, 0.085872752242822009, 0.1084579951005582, 0.20350077550717194, 0.25702315969221257, 0.03551169081575134, -0.083475373185951274, -0.053119697675226007, -0.051073377242295631, -0.085005424835789295, 0.025080212002029836, 0.19093237635024654, 0.10152786415556034, 0.17117472918588617, 0.091021779458552471, 0.69293691178698702, -0.097002376729223169, -0.070699586880466903, 0.42474742969688395, -0.0086506859049516431, 0.027272664380649191, 0.0030019501617763451, 0.26395899941365064, 0.0046382953510501583, 0.40784148099371537, 0.044891829516916615};
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 2; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 11; q += 1)
             {
                const real_t tmp_qloop_0 = (k_dof_0*_data_phi_0_0_WHITE_DOWN[10*q] + k_dof_1*_data_phi_0_0_WHITE_DOWN[10*q + 1] + k_dof_2*_data_phi_0_0_WHITE_DOWN[10*q + 2] + k_dof_3*_data_phi_0_0_WHITE_DOWN[10*q + 3] + k_dof_4*_data_phi_0_0_WHITE_DOWN[10*q + 4] + k_dof_5*_data_phi_0_0_WHITE_DOWN[10*q + 5] + k_dof_6*_data_phi_0_0_WHITE_DOWN[10*q + 6] + k_dof_7*_data_phi_0_0_WHITE_DOWN[10*q + 7] + k_dof_8*_data_phi_0_0_WHITE_DOWN[10*q + 8] + k_dof_9*_data_phi_0_0_WHITE_DOWN[10*q + 9])*_data_q_w[q];
                const real_t tmp_qloop_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 14];
                const real_t q_tmp_0_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q];
                const real_t q_tmp_0_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 1];
                const real_t q_tmp_0_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 2];
                const real_t q_tmp_0_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 3];
                const real_t q_tmp_0_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 4];
                const real_t q_tmp_0_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 5];
                const real_t q_tmp_0_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 6];
                const real_t q_tmp_0_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 7];
                const real_t q_tmp_0_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 8];
                const real_t q_tmp_0_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 9];
                const real_t q_tmp_1_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 10];
                const real_t q_tmp_1_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 11];
                const real_t q_tmp_1_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 12];
                const real_t q_tmp_1_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 13];
                const real_t q_tmp_1_4 = tmp_qloop_1;
                const real_t q_tmp_1_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 15];
                const real_t q_tmp_1_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 16];
                const real_t q_tmp_1_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 17];
                const real_t q_tmp_1_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 18];
                const real_t q_tmp_1_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 19];
                const real_t q_tmp_2_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 20];
                const real_t q_tmp_2_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 21];
                const real_t q_tmp_2_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 22];
                const real_t q_tmp_2_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 23];
                const real_t q_tmp_2_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 24];
                const real_t q_tmp_2_5 = tmp_qloop_1;
                const real_t q_tmp_2_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 25];
                const real_t q_tmp_2_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 26];
                const real_t q_tmp_2_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 27];
                const real_t q_tmp_2_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 28];
                const real_t q_tmp_3_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 29];
                const real_t q_tmp_3_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 30];
                const real_t q_tmp_3_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 31];
                const real_t q_tmp_3_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 32];
                const real_t q_tmp_3_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 33];
                const real_t q_tmp_3_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 34];
                const real_t q_tmp_3_6 = tmp_qloop_1;
                const real_t q_tmp_3_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 35];
                const real_t q_tmp_3_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 36];
                const real_t q_tmp_3_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_WHITE_DOWN[38*q + 37];
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_0_1 = q_acc_0_1 + q_tmp_0_1;
                q_acc_0_2 = q_acc_0_2 + q_tmp_0_2;
                q_acc_0_3 = q_acc_0_3 + q_tmp_0_3;
       ...
       const real_t abs_det_jac_affine_BLUE_UP = abs(jac_affine_0_0_BLUE_UP*jac_affine_1_1_BLUE_UP*jac_affine_2_2_BLUE_UP - jac_affine_0_0_BLUE_UP*jac_affine_1_2_BLUE_UP*jac_affine_2_1_BLUE_UP - jac_affine_0_1_BLUE_UP*jac_affine_1_0_BLUE_UP*jac_affine_2_2_BLUE_UP + jac_affine_0_1_BLUE_UP*jac_affine_1_2_BLUE_UP*jac_affine_2_0_BLUE_UP + jac_affine_0_2_BLUE_UP*jac_affine_1_0_BLUE_UP*jac_affine_2_1_BLUE_UP - jac_affine_0_2_BLUE_UP*jac_affine_1_1_BLUE_UP*jac_affine_2_0_BLUE_UP);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 11; q += 1)
             {
                const real_t tmp_qloop_0 = (k_dof_0*_data_phi_0_0_BLUE_UP[10*q] + k_dof_1*_data_phi_0_0_BLUE_UP[10*q + 1] + k_dof_2*_data_phi_0_0_BLUE_UP[10*q + 2] + k_dof_3*_data_phi_0_0_BLUE_UP[10*q + 3] + k_dof_4*_data_phi_0_0_BLUE_UP[10*q + 4] + k_dof_5*_data_phi_0_0_BLUE_UP[10*q + 5] + k_dof_6*_data_phi_0_0_BLUE_UP[10*q + 6] + k_dof_7*_data_phi_0_0_BLUE_UP[10*q + 7] + k_dof_8*_data_phi_0_0_BLUE_UP[10*q + 8] + k_dof_9*_data_phi_0_0_BLUE_UP[10*q + 9])*_data_q_w[q];
                const real_t tmp_qloop_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 14];
                const real_t q_tmp_0_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q];
                const real_t q_tmp_0_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 1];
                const real_t q_tmp_0_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 2];
                const real_t q_tmp_0_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 3];
                const real_t q_tmp_0_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 4];
                const real_t q_tmp_0_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 5];
                const real_t q_tmp_0_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 6];
                const real_t q_tmp_0_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 7];
                const real_t q_tmp_0_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 8];
                const real_t q_tmp_0_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 9];
                const real_t q_tmp_1_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 10];
                const real_t q_tmp_1_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 11];
                const real_t q_tmp_1_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 12];
                const real_t q_tmp_1_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 13];
                const real_t q_tmp_1_4 = tmp_qloop_1;
                const real_t q_tmp_1_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 15];
                const real_t q_tmp_1_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 16];
                const real_t q_tmp_1_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 17];
                const real_t q_tmp_1_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 18];
                const real_t q_tmp_1_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 19];
                const real_t q_tmp_2_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 20];
                const real_t q_tmp_2_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 21];
                const real_t q_tmp_2_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 22];
                const real_t q_tmp_2_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 23];
                const real_t q_tmp_2_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 24];
                const real_t q_tmp_2_5 = tmp_qloop_1;
                const real_t q_tmp_2_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 25];
                const real_t q_tmp_2_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 26];
                const real_t q_tmp_2_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 27];
                const real_t q_tmp_2_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 28];
                const real_t q_tmp_3_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 29];
                const real_t q_tmp_3_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 30];
                const real_t q_tmp_3_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 31];
                const real_t q_tmp_3_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 32];
                const real_t q_tmp_3_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 33];
                const real_t q_tmp_3_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 34];
                const real_t q_tmp_3_6 = tmp_qloop_1;
                const real_t q_tmp_3_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 35];
                const real_t q_tmp_3_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 36];
                const real_t q_tmp_3_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_UP[38*q + 37];
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_0_1 = q_acc_0_1 + q_tmp_0_1;
                q_acc_0_2 = q_acc_0_2 + q_tmp_0_2;
                q_acc_0_3 = q_acc_0_3 + q_tmp_0_3;
       ...
       const real_t abs_det_jac_affine_BLUE_DOWN = abs(jac_affine_0_0_BLUE_DOWN*jac_affine_1_1_BLUE_DOWN*jac_affine_2_2_BLUE_DOWN - jac_affine_0_0_BLUE_DOWN*jac_affine_1_2_BLUE_DOWN*jac_affine_2_1_BLUE_DOWN - jac_affine_0_1_BLUE_DOWN*jac_affine_1_0_BLUE_DOWN*jac_affine_2_2_BLUE_DOWN + jac_affine_0_1_BLUE_DOWN*jac_affine_1_2_BLUE_DOWN*jac_affine_2_0_BLUE_DOWN + jac_affine_0_2_BLUE_DOWN*jac_affine_1_0_BLUE_DOWN*jac_affine_2_1_BLUE_DOWN - jac_affine_0_2_BLUE_DOWN*jac_affine_1_1_BLUE_DOWN*jac_affine_2_0_BLUE_DOWN);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 11; q += 1)
             {
                const real_t tmp_qloop_0 = (k_dof_0*_data_phi_0_0_BLUE_DOWN[10*q] + k_dof_1*_data_phi_0_0_BLUE_DOWN[10*q + 1] + k_dof_2*_data_phi_0_0_BLUE_DOWN[10*q + 2] + k_dof_3*_data_phi_0_0_BLUE_DOWN[10*q + 3] + k_dof_4*_data_phi_0_0_BLUE_DOWN[10*q + 4] + k_dof_5*_data_phi_0_0_BLUE_DOWN[10*q + 5] + k_dof_6*_data_phi_0_0_BLUE_DOWN[10*q + 6] + k_dof_7*_data_phi_0_0_BLUE_DOWN[10*q + 7] + k_dof_8*_data_phi_0_0_BLUE_DOWN[10*q + 8] + k_dof_9*_data_phi_0_0_BLUE_DOWN[10*q + 9])*_data_q_w[q];
                const real_t tmp_qloop_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 14];
                const real_t q_tmp_0_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q];
                const real_t q_tmp_0_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 1];
                const real_t q_tmp_0_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 2];
                const real_t q_tmp_0_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 3];
                const real_t q_tmp_0_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 4];
                const real_t q_tmp_0_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 5];
                const real_t q_tmp_0_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 6];
                const real_t q_tmp_0_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 7];
                const real_t q_tmp_0_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 8];
                const real_t q_tmp_0_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 9];
                const real_t q_tmp_1_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 10];
                const real_t q_tmp_1_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 11];
                const real_t q_tmp_1_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 12];
                const real_t q_tmp_1_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 13];
                const real_t q_tmp_1_4 = tmp_qloop_1;
                const real_t q_tmp_1_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 15];
                const real_t q_tmp_1_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 16];
                const real_t q_tmp_1_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 17];
                const real_t q_tmp_1_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 18];
                const real_t q_tmp_1_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 19];
                const real_t q_tmp_2_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 20];
                const real_t q_tmp_2_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 21];
                const real_t q_tmp_2_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 22];
                const real_t q_tmp_2_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 23];
                const real_t q_tmp_2_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 24];
                const real_t q_tmp_2_5 = tmp_qloop_1;
                const real_t q_tmp_2_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 25];
                const real_t q_tmp_2_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 26];
                const real_t q_tmp_2_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 27];
                const real_t q_tmp_2_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 28];
                const real_t q_tmp_3_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 29];
                const real_t q_tmp_3_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 30];
                const real_t q_tmp_3_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 31];
                const real_t q_tmp_3_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 32];
                const real_t q_tmp_3_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 33];
                const real_t q_tmp_3_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 34];
                const real_t q_tmp_3_6 = tmp_qloop_1;
                const real_t q_tmp_3_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 35];
                const real_t q_tmp_3_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 36];
                const real_t q_tmp_3_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE_DOWN[38*q + 37];
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_0_1 = q_acc_0_1 + q_tmp_0_1;
                q_acc_0_2 = q_acc_0_2 + q_tmp_0_2;
                q_acc_0_3 = q_acc_0_3 + q_tmp_0_3;
       ...
       {
          /* CellType.GREEN_UP */
          const real_t _data_phi_0_0_GREEN_UP [] = {-0.090535362930810992, -0.011579335952356828, -0.11760379463625681, -0.068767228413546891, 0.10234491325961378, 0.16073565742743148, 0.60687827722315146, 0.039095058653867309, 0.14760845367810674, 0.23182336169080051, -0.0053570531758102002, -0.026981886857756689, -0.08826927993497348, 0.59856367989927617, 0.38991501098196513, 0.097478145633287397, 0.013105850958460542, 0.018445551186837106, 0.0024799881361180498, 0.0006199931725955482, -0.047387428697692885, -0.091259737764059851, -0.1113914185759802, -0.080241973959818302, 0.13353232929213443, 0.048239998198448431, 0.15974715277305154, 0.1795192875052915, 0.59447960443206538, 0.21476218679656028, -0.012365312874640544, -0.11783608671457169, 0.099840210581437105, -0.12209237840485256, 0.49602512400408078, 0.161149647055262, 0.44517368008565716, 0.010752243911943793, 0.029702925690040238, 0.0096499466656436994, -0.039132866314689811, 0.52330757747208378, -0.025291504202103146, -0.086435669103359453, 0.011878329657082472, 0.36424725943509562, 0.087569474525404659, 0.019025274908404714, 0.0045739076500237383, 0.14025821597205745, -0.075020078347640823, -0.10978594944123118, -0.087269478727699787, -0.038293245964176326, 0.20646997194002201, 0.61807351051034776, 0.15194937966625316, 0.16847248498571801, 0.041417872063914368, 0.12398553331449269, -0.10872199595435525, -0.071573088371655491, -0.066785736996983452, -0.0060897460877574749, 0.15682570344877764, 0.17098019180848095, 0.027487844842548723, 0.67204203738214874, 0.10804168047678223, 0.11779310945201321, 0.37695779888932324, -0.066990727368889835, -0.055283676461052214, -0.083546970475516125, 0.026846095514264753, 0.033800130105328889, 0.020177061431168701, 0.31851359257248568, 0.19013738420444903, 0.23938931158843763, -0.10297005415588911, -0.053714325748548342, -0.050503954623664971, -0.1046997294598791, 0.62152169062946561, 0.085872752242822009, 0.1084579951005582, 0.20350077550717194, 0.25702315969221257, 0.03551169081575134, -0.083475373185951274, -0.053119697675226007, -0.051073377242295631, -0.085005424835789295, 0.025080212002029836, 0.19093237635024654, 0.10152786415556034, 0.17117472918588617, 0.091021779458552471, 0.69293691178698702, -0.097002376729223169, -0.070699586880466903, 0.42474742969688395, -0.0086506859049516431, 0.027272664380649191, 0.0030019501617763451, 0.26395899941365064, 0.0046382953510501583, 0.40784148099371537, 0.044891829516916615};
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 11; q += 1)
             {
                const real_t tmp_qloop_0 = (k_dof_0*_data_phi_0_0_GREEN_UP[10*q] + k_dof_1*_data_phi_0_0_GREEN_UP[10*q + 1] + k_dof_2*_data_phi_0_0_GREEN_UP[10*q + 2] + k_dof_3*_data_phi_0_0_GREEN_UP[10*q + 3] + k_dof_4*_data_phi_0_0_GREEN_UP[10*q + 4] + k_dof_5*_data_phi_0_0_GREEN_UP[10*q + 5] + k_dof_6*_data_phi_0_0_GREEN_UP[10*q + 6] + k_dof_7*_data_phi_0_0_GREEN_UP[10*q + 7] + k_dof_8*_data_phi_0_0_GREEN_UP[10*q + 8] + k_dof_9*_data_phi_0_0_GREEN_UP[10*q + 9])*_data_q_w[q];
                const real_t tmp_qloop_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 14];
                const real_t q_tmp_0_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q];
                const real_t q_tmp_0_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 1];
                const real_t q_tmp_0_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 2];
                const real_t q_tmp_0_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 3];
                const real_t q_tmp_0_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 4];
                const real_t q_tmp_0_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 5];
                const real_t q_tmp_0_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 6];
                const real_t q_tmp_0_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 7];
                const real_t q_tmp_0_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 8];
                const real_t q_tmp_0_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 9];
                const real_t q_tmp_1_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 10];
                const real_t q_tmp_1_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 11];
                const real_t q_tmp_1_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 12];
                const real_t q_tmp_1_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 13];
                const real_t q_tmp_1_4 = tmp_qloop_1;
                const real_t q_tmp_1_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 15];
                const real_t q_tmp_1_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 16];
                const real_t q_tmp_1_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 17];
                const real_t q_tmp_1_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 18];
                const real_t q_tmp_1_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 19];
                const real_t q_tmp_2_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 20];
                const real_t q_tmp_2_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 21];
                const real_t q_tmp_2_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 22];
                const real_t q_tmp_2_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 23];
                const real_t q_tmp_2_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 24];
                const real_t q_tmp_2_5 = tmp_qloop_1;
                const real_t q_tmp_2_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 25];
                const real_t q_tmp_2_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 26];
                const real_t q_tmp_2_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 27];
                const real_t q_tmp_2_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 28];
                const real_t q_tmp_3_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 29];
                const real_t q_tmp_3_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 30];
                const real_t q_tmp_3_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 31];
                const real_t q_tmp_3_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 32];
                const real_t q_tmp_3_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 33];
                const real_t q_tmp_3_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 34];
                const real_t q_tmp_3_6 = tmp_qloop_1;
                const real_t q_tmp_3_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 35];
                const real_t q_tmp_3_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 36];
                const real_t q_tmp_3_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_UP[38*q + 37];
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_0_1 = q_acc_0_1 + q_tmp_0_1;
                q_acc_0_2 = q_acc_0_2 + q_tmp_0_2;
                q_acc_0_3 = q_acc_0_3 + q_tmp_0_3;
       ...
       const real_t abs_det_jac_affine_GREEN_DOWN = abs(jac_affine_0_0_GREEN_DOWN*jac_affine_1_1_GREEN_DOWN*jac_affine_2_2_GREEN_DOWN - jac_affine_0_0_GREEN_DOWN*jac_affine_1_2_GREEN_DOWN*jac_affine_2_1_GREEN_DOWN - jac_affine_0_1_GREEN_DOWN*jac_affine_1_0_GREEN_DOWN*jac_affine_2_2_GREEN_DOWN + jac_affine_0_1_GREEN_DOWN*jac_affine_1_2_GREEN_DOWN*jac_affine_2_0_GREEN_DOWN + jac_affine_0_2_GREEN_DOWN*jac_affine_1_0_GREEN_DOWN*jac_affine_2_1_GREEN_DOWN - jac_affine_0_2_GREEN_DOWN*jac_affine_1_1_GREEN_DOWN*jac_affine_2_0_GREEN_DOWN);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 11; q += 1)
             {
                const real_t tmp_qloop_0 = (k_dof_0*_data_phi_0_0_GREEN_DOWN[10*q] + k_dof_1*_data_phi_0_0_GREEN_DOWN[10*q + 1] + k_dof_2*_data_phi_0_0_GREEN_DOWN[10*q + 2] + k_dof_3*_data_phi_0_0_GREEN_DOWN[10*q + 3] + k_dof_4*_data_phi_0_0_GREEN_DOWN[10*q + 4] + k_dof_5*_data_phi_0_0_GREEN_DOWN[10*q + 5] + k_dof_6*_data_phi_0_0_GREEN_DOWN[10*q + 6] + k_dof_7*_data_phi_0_0_GREEN_DOWN[10*q + 7] + k_dof_8*_data_phi_0_0_GREEN_DOWN[10*q + 8] + k_dof_9*_data_phi_0_0_GREEN_DOWN[10*q + 9])*_data_q_w[q];
                const real_t tmp_qloop_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 14];
                const real_t q_tmp_0_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q];
                const real_t q_tmp_0_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 1];
                const real_t q_tmp_0_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 2];
                const real_t q_tmp_0_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 3];
                const real_t q_tmp_0_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 4];
                const real_t q_tmp_0_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 5];
                const real_t q_tmp_0_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 6];
                const real_t q_tmp_0_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 7];
                const real_t q_tmp_0_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 8];
                const real_t q_tmp_0_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 9];
                const real_t q_tmp_1_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 10];
                const real_t q_tmp_1_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 11];
                const real_t q_tmp_1_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 12];
                const real_t q_tmp_1_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 13];
                const real_t q_tmp_1_4 = tmp_qloop_1;
                const real_t q_tmp_1_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 15];
                const real_t q_tmp_1_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 16];
                const real_t q_tmp_1_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 17];
                const real_t q_tmp_1_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 18];
                const real_t q_tmp_1_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 19];
                const real_t q_tmp_2_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 20];
                const real_t q_tmp_2_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 21];
                const real_t q_tmp_2_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 22];
                const real_t q_tmp_2_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 23];
                const real_t q_tmp_2_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 24];
                const real_t q_tmp_2_5 = tmp_qloop_1;
                const real_t q_tmp_2_6 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 25];
                const real_t q_tmp_2_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 26];
                const real_t q_tmp_2_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 27];
                const real_t q_tmp_2_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 28];
                const real_t q_tmp_3_0 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 29];
                const real_t q_tmp_3_1 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 30];
                const real_t q_tmp_3_2 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 31];
                const real_t q_tmp_3_3 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 32];
                const real_t q_tmp_3_4 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 33];
                const real_t q_tmp_3_5 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 34];
                const real_t q_tmp_3_6 = tmp_qloop_1;
                const real_t q_tmp_3_7 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 35];
                const real_t q_tmp_3_8 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 36];
                const real_t q_tmp_3_9 = tmp_qloop_0*_data_tabulated_and_untitled_0_0_GREEN_DOWN[38*q + 37];
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_0_1 = q_acc_0_1 + q_tmp_0_1;
                q_acc_0_2 = q_acc_0_2 + q_tmp_0_2;
                q_acc_0_3 = q_acc_0_3 + q_tmp_0_3;
