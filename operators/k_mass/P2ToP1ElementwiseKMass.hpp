...
class P2ToP1ElementwiseKMass : public Operator< P2Function< real_t >, P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    188     195      12       0      0              0                 0              1
   void applyScaled_P2ToP1ElementwiseKMass_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    672     655      36       0      0              0                 0              1
   void applyScaled_P2ToP1ElementwiseKMass_macro_3D( real_t* RESTRICT _data_dst,
                                                     real_t* RESTRICT _data_kEdge,
                                                     real_t* RESTRICT _data_kVertex,
                                                     real_t* RESTRICT _data_srcEdge,
                                                     real_t* RESTRICT _data_srcVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    170     192      12       0      0              0                 0              4
   void toMatrixScaled_P2ToP1ElementwiseKMass_macro_2D( idx_t* RESTRICT                      _data_dst,
                                                        real_t* RESTRICT                     _data_kEdge,
                                                        real_t* RESTRICT                     _data_kVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    632     651      36       0      0              0                 0              4
   void toMatrixScaled_P2ToP1ElementwiseKMass_macro_3D( idx_t* RESTRICT                      _data_dst,
                                                        real_t* RESTRICT                     _data_kEdge,
                                                        real_t* RESTRICT                     _data_kVertex,
                                                        idx_t* RESTRICT                      _data_srcEdge,
                                                        idx_t* RESTRICT                      _data_srcVertex,
