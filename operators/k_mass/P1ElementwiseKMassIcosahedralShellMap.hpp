                                              ...
                                              public OperatorWithInverseDiagonal< P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    884    1412      46      10      0              0                 0              1
   void applyScaled_P1ElementwiseKMassIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    868    1402      46      10      0              0                 0              4
   void toMatrixScaled_P1ElementwiseKMassIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst,
                                                                       real_t* RESTRICT _data_k,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    842    1366      46      10      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P1ElementwiseKMassIcosahedralShellMap_macro_3D(
