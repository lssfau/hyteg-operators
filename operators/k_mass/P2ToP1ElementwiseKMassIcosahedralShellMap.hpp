...
class P2ToP1ElementwiseKMassIcosahedralShellMap : public Operator< P2Function< real_t >, P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2421    3614      58      22      0              0                 0              1
   void applyScaled_P2ToP1ElementwiseKMassIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2381    3610      58      22      0              0                 0              4
   void toMatrixScaled_P2ToP1ElementwiseKMassIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst,
                                                                           real_t* RESTRICT _data_kEdge,
                                                                           real_t* RESTRICT _data_kVertex,
