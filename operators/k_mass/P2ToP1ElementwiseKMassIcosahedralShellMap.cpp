...
void P2ToP1ElementwiseKMassIcosahedralShellMap::applyScaled( const real_t&               operatorScaling,
                                                             ...
                                                             UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ToP1ElementwiseKMassIcosahedralShellMap_macro_3D(
...
void P2ToP1ElementwiseKMassIcosahedralShellMap::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                                ...
                                                                DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ToP1ElementwiseKMassIcosahedralShellMap_macro_3D(
