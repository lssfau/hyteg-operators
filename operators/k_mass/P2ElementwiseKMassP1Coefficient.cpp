...
P2ElementwiseKMassP1Coefficient::P2ElementwiseKMassP1Coefficient( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                  size_t                                     minLevel,
                                                                  size_t                                     maxLevel,
...
void P2ElementwiseKMassP1Coefficient::applyScaled( const real_t&               operatorScaling,
                                                   ...
                                                   UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseKMassP1Coefficient_macro_3D(
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseKMassP1Coefficient_macro_2D(
...
void P2ElementwiseKMassP1Coefficient::apply( const P2Function< real_t >& src,
                                             const P2Function< real_t >& dst,
                                             uint_t                      level,
                                             DoFType                     flag,
                                             UpdateType                  updateType ) const
...
void P2ElementwiseKMassP1Coefficient::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                      ...
                                                      DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseKMassP1Coefficient_macro_3D(
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ElementwiseKMassP1Coefficient_macro_2D(
...
void P2ElementwiseKMassP1Coefficient::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                const P2Function< idx_t >&                  src,
                                                const P2Function< idx_t >&                  dst,
                                                uint_t                                      level,
                                                DoFType                                     flag ) const
...
void P2ElementwiseKMassP1Coefficient::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseKMassP1Coefficient_macro_3D(
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseKMassP1Coefficient_macro_2D(
...
void P2ElementwiseKMassP1Coefficient::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseKMassP1Coefficient::getInverseDiagonalValues() const
{
   return invDiag_;
}
