                                              ...
                                              public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2646    3867      58      22      0              0                 0              1
   void applyScaled_P2ElementwiseKMassIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2546    3812      58      22      0              0                 0              4
   void toMatrixScaled_P2ElementwiseKMassIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2061    3272      58      22      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseKMassIcosahedralShellMap_macro_3D(
