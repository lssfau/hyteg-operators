...
class P2ElementwiseKMassP1CoefficientParametricP2Map : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                       public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseKMassP1CoefficientParametricP2Map( const std::shared_ptr< PrimitiveStorage >& storage,
                                                   size_t                                     minLevel,
                                                   size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseKMassP1CoefficientParametricP2Map
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    368     366      12       0      6              0                 0              1
   void applyScaled_P2ElementwiseKMassP1CoefficientParametricP2Map_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1623    1579      36       0     11              0                 0              1
   void applyScaled_P2ElementwiseKMassP1CoefficientParametricP2Map_macro_3D( real_t* RESTRICT _data_dstEdge,
                                                                             real_t* RESTRICT _data_dstVertex,
                                                                             real_t* RESTRICT _data_k,
                                                                             real_t* RESTRICT _data_micromesh_edge_0,
                                                                             real_t* RESTRICT _data_micromesh_edge_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    332     345      12       0      6              0                 0              4
   void toMatrixScaled_P2ElementwiseKMassP1CoefficientParametricP2Map_macro_2D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1523    1524      36       0     11              0                 0              4
   void toMatrixScaled_P2ElementwiseKMassP1CoefficientParametricP2Map_macro_3D( idx_t* RESTRICT  _data_dstEdge,
                                                                                idx_t* RESTRICT  _data_dstVertex,
                                                                                real_t* RESTRICT _data_k,
                                                                                real_t* RESTRICT _data_micromesh_edge_0,
                                                                                real_t* RESTRICT _data_micromesh_edge_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    248     240      12       0      6              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseKMassP1CoefficientParametricP2Map_macro_2D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1038     984      36       0     11              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseKMassP1CoefficientParametricP2Map_macro_3D(
       real_t* RESTRICT _data_invDiag_Edge,
       real_t* RESTRICT _data_invDiag_Vertex,
       real_t* RESTRICT _data_k,
       real_t* RESTRICT _data_micromesh_edge_0,
