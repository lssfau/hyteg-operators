...
void P1ElementwiseKMassAnnulusMap::applyScaled( const real_t&               operatorScaling,
                                                ...
                                                UpdateType                  updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P1ElementwiseKMassAnnulusMap_macro_2D(
...
void P1ElementwiseKMassAnnulusMap::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                   ...
                                                   DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P1ElementwiseKMassAnnulusMap_macro_2D(
...
void P1ElementwiseKMassAnnulusMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P1ElementwiseKMassAnnulusMap_macro_2D(
