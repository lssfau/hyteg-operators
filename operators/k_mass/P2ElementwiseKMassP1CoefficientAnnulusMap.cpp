                                                       ...
                                                       UpdateType                  updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         apply_P2ElementwiseKMassP1CoefficientAnnulusMap_macro_2D(
                                                          ...
                                                          DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrix_P2ElementwiseKMassP1CoefficientAnnulusMap_macro_2D(
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValues_P2ElementwiseKMassP1CoefficientAnnulusMap_macro_2D(
