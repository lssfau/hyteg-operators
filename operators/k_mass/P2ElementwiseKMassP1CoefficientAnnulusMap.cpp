...
P2ElementwiseKMassP1CoefficientAnnulusMap::P2ElementwiseKMassP1CoefficientAnnulusMap(
...
void P2ElementwiseKMassP1CoefficientAnnulusMap::applyScaled( const real_t&               operatorScaling,
                                                             ...
                                                             UpdateType                  updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseKMassP1CoefficientAnnulusMap_macro_2D(
...
void P2ElementwiseKMassP1CoefficientAnnulusMap::apply( const P2Function< real_t >& src,
                                                       const P2Function< real_t >& dst,
                                                       uint_t                      level,
                                                       DoFType                     flag,
                                                       UpdateType                  updateType ) const
...
void P2ElementwiseKMassP1CoefficientAnnulusMap::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                                ...
                                                                DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ElementwiseKMassP1CoefficientAnnulusMap_macro_2D(
...
void P2ElementwiseKMassP1CoefficientAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                          const P2Function< idx_t >&                  src,
                                                          const P2Function< idx_t >&                  dst,
                                                          uint_t                                      level,
                                                          DoFType                                     flag ) const
...
void P2ElementwiseKMassP1CoefficientAnnulusMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseKMassP1CoefficientAnnulusMap_macro_2D(
...
void P2ElementwiseKMassP1CoefficientAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseKMassP1CoefficientAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
