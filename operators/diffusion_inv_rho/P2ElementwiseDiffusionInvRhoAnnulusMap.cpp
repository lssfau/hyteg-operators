...
P2ElementwiseDiffusionInvRhoAnnulusMap::P2ElementwiseDiffusionInvRhoAnnulusMap(
...
void P2ElementwiseDiffusionInvRhoAnnulusMap::applyScaled( const real_t&               operatorScaling,
...
void P2ElementwiseDiffusionInvRhoAnnulusMap::apply( const P2Function< real_t >& src,
                                                    const P2Function< real_t >& dst,
                                                    uint_t                      level,
                                                    DoFType                     flag,
                                                    UpdateType                  updateType ) const
...
void P2ElementwiseDiffusionInvRhoAnnulusMap::toMatrixScaled( const real_t&                               toMatrixScaling,
...
void P2ElementwiseDiffusionInvRhoAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                       const P2Function< idx_t >&                  src,
                                                       const P2Function< idx_t >&                  dst,
                                                       uint_t                                      level,
                                                       DoFType                                     flag ) const
...
void P2ElementwiseDiffusionInvRhoAnnulusMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseDiffusionInvRhoAnnulusMap_macro_2D(
...
void P2ElementwiseDiffusionInvRhoAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseDiffusionInvRhoAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
