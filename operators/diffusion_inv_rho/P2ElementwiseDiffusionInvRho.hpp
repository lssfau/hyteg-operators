...
///         - ∫ w/(rho*rho) ∇T · ∇rho
///
class P2ElementwiseDiffusionInvRho : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                     public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseDiffusionInvRho( const std::shared_ptr< PrimitiveStorage >& storage,
                                 size_t                                     minLevel,
                                 size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseDiffusionInvRho
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    422     516      18       0      0              0                 0              1
   void applyScaled_P2ElementwiseDiffusionInvRho_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1865    2096      47       0      0              0                 0              1
   void applyScaled_P2ElementwiseDiffusionInvRho_macro_3D( real_t* RESTRICT _data_dstEdge,
                                                           real_t* RESTRICT _data_dstVertex,
                                                           real_t* RESTRICT _data_rho,
                                                           real_t* RESTRICT _data_srcEdge,
                                                           real_t* RESTRICT _data_srcVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    386     510      18       0      0              0                 0              4
   void toMatrixScaled_P2ElementwiseDiffusionInvRho_macro_2D( idx_t* RESTRICT                      _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1765    2086      47       0      0              0                 0              4
   void toMatrixScaled_P2ElementwiseDiffusionInvRho_macro_3D( idx_t* RESTRICT                      _data_dstEdge,
                                                              idx_t* RESTRICT                      _data_dstVertex,
                                                              real_t* RESTRICT                     _data_rho,
                                                              idx_t* RESTRICT                      _data_srcEdge,
                                                              idx_t* RESTRICT                      _data_srcVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    212     300      18       0      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseDiffusionInvRho_macro_2D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    785    1006      47       0      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseDiffusionInvRho_macro_3D(
       real_t* RESTRICT _data_invDiag_Edge,
       real_t* RESTRICT _data_invDiag_Vertex,
       real_t* RESTRICT _data_rho,
       real_t           diagScaling,
