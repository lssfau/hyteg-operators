...
///         - ∫ w/(rho*rho) ∇T · ∇rho
///
class P2ElementwiseDiffusionInvRhoIcosahedralShellMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                        public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseDiffusionInvRhoIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                    size_t                                     minLevel,
                                                    size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseDiffusionInvRhoIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5401    7742      78      28      0              0                 0              1
   void applyScaled_P2ElementwiseDiffusionInvRhoIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5301    7732      78      28      0              0                 0              4
   void toMatrixScaled_P2ElementwiseDiffusionInvRhoIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4051    6382      78      28      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseDiffusionInvRhoIcosahedralShellMap_macro_3D(
