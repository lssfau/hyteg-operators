...
#include "P2VectorElementwiseFullStokesRotationIcosahedralShellMap.hpp"
...
P2VectorElementwiseFullStokesRotationIcosahedralShellMap::P2VectorElementwiseFullStokesRotationIcosahedralShellMap(
...
void P2VectorElementwiseFullStokesRotationIcosahedralShellMap::apply( const P2VectorFunction< real_t >& src,
                                                                      ...
                                                                      UpdateType                        updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         apply_P2VectorElementwiseFullStokesRotationIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseFullStokesRotationIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                         ...
                                                                         DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrix_P2VectorElementwiseFullStokesRotationIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseFullStokesRotationIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValues_P2VectorElementwiseFullStokesRotationIcosahedralShellMap_macro_3D(
...
std::shared_ptr< P2VectorFunction< real_t > >
    P2VectorElementwiseFullStokesRotationIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
