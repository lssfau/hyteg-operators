...
P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap::P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap(
...
void P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap::apply( const P2VectorFunction< real_t >& src,
                                                                        ...
                                                                        UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         apply_P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                           ...
                                                                           DoFType flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrix_P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap::computeInverseDiagonalOperatorValues()
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValues_P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap_macro_2D(
...
std::shared_ptr< P2VectorFunction< real_t > >
    P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
