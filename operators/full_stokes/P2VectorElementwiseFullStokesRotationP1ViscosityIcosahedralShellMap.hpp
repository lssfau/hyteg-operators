...
///
class P2VectorElementwiseFullStokesRotationP1ViscosityIcosahedralShellMap
  ...
  public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseFullStokesRotationP1ViscosityIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  36598   46962     196     210    150              0                 0              1
   void apply_P2VectorElementwiseFullStokesRotationP1ViscosityIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  35698   46062     196     210    150              0                 0              4
   void toMatrix_P2VectorElementwiseFullStokesRotationP1ViscosityIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   8713   12387     196     210    150              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseFullStokesRotationP1ViscosityIcosahedralShellMap_macro_3D(
