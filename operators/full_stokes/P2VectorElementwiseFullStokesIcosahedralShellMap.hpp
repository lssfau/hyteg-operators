  ...
  public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  15953   16822      46      10      0              0                 0              1
   void apply_P2VectorElementwiseFullStokesIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  15053   15922      46      10      0              0                 0              4
   void toMatrix_P2VectorElementwiseFullStokesIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5243    6232      46      10      0              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseFullStokesIcosahedralShellMap_macro_3D(
