...
class P2VectorElementwiseFullStokesIcosahedralShellMap
...
{
 public:
   P2VectorElementwiseFullStokesIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                     size_t                                     minLevel,
                                                     size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseFullStokesIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  16053   16952      46      10      0              0                 0              1
   void applyScaled_P2VectorElementwiseFullStokesIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  15153   16487      46      10      0              0                 0              4
   void toMatrixScaled_P2VectorElementwiseFullStokesIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5343    6362      46      10      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseFullStokesIcosahedralShellMap_macro_3D(
