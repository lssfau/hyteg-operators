...
///
class P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap
  ...
  public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  36583   46947     196     210    150              0                 0              1
   void apply_P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  35683   46047     196     210    150              0                 0              4
   void toMatrix_P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   8698   12372     196     210    150              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap_macro_3D(
