...
class P2VectorElementwiseFullStokesP1ViscosityAnnulusMap
...
{
 public:
   P2VectorElementwiseFullStokesP1ViscosityAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                       size_t                                     minLevel,
                                                       size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseFullStokesP1ViscosityAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2156    2560      20      12      0              0                 0              1
   void applyScaled_P2VectorElementwiseFullStokesP1ViscosityAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2012    2482      20      12      0              0                 0              4
   void toMatrixScaled_P2VectorElementwiseFullStokesP1ViscosityAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    968    1280      20      12      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseFullStokesP1ViscosityAnnulusMap_macro_2D(
