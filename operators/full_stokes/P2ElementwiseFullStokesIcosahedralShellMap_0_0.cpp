...
P2ElementwiseFullStokesIcosahedralShellMap_0_0::P2ElementwiseFullStokesIcosahedralShellMap_0_0(
...
void P2ElementwiseFullStokesIcosahedralShellMap_0_0::applyScaled( const real_t&               operatorScaling,
                                                                  ...
                                                                  UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseFullStokesIcosahedralShellMap_0_0_macro_3D(
...
void P2ElementwiseFullStokesIcosahedralShellMap_0_0::apply( const P2Function< real_t >& src,
                                                            const P2Function< real_t >& dst,
                                                            uint_t                      level,
                                                            DoFType                     flag,
                                                            UpdateType                  updateType ) const
...
void P2ElementwiseFullStokesIcosahedralShellMap_0_0::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                                     ...
                                                                     DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseFullStokesIcosahedralShellMap_0_0_macro_3D(
...
void P2ElementwiseFullStokesIcosahedralShellMap_0_0::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                               const P2Function< idx_t >&                  src,
                                                               const P2Function< idx_t >&                  dst,
                                                               uint_t                                      level,
                                                               DoFType                                     flag ) const
...
void P2ElementwiseFullStokesIcosahedralShellMap_0_0::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseFullStokesIcosahedralShellMap_0_0_macro_3D(
...
void P2ElementwiseFullStokesIcosahedralShellMap_0_0::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseFullStokesIcosahedralShellMap_0_0::getInverseDiagonalValues() const
{
   return invDiag_;
}
