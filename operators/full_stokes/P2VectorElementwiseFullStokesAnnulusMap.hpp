                                                ...
                                                public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2204    2620      20      12      0              0                 0              1
   void applyScaled_P2VectorElementwiseFullStokesAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2060    2542      20      12      0              0                 0              4
   void toMatrixScaled_P2VectorElementwiseFullStokesAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1016    1340      20      12      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseFullStokesAnnulusMap_macro_2D(
