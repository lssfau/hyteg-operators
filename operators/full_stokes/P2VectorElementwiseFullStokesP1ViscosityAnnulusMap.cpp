...
P2VectorElementwiseFullStokesP1ViscosityAnnulusMap::P2VectorElementwiseFullStokesP1ViscosityAnnulusMap(
...
void P2VectorElementwiseFullStokesP1ViscosityAnnulusMap::applyScaled( const real_t&                     operatorScaling,
                                                                      ...
                                                                      UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2VectorElementwiseFullStokesP1ViscosityAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesP1ViscosityAnnulusMap::apply( const P2VectorFunction< real_t >& src,
                                                                const P2VectorFunction< real_t >& dst,
                                                                uint_t                            level,
                                                                DoFType                           flag,
                                                                UpdateType                        updateType ) const
...
void P2VectorElementwiseFullStokesP1ViscosityAnnulusMap::toMatrixScaled( const real_t& toMatrixScaling,
                                                                         ...
                                                                         DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2VectorElementwiseFullStokesP1ViscosityAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesP1ViscosityAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                   const P2VectorFunction< idx_t >&            src,
                                                                   const P2VectorFunction< idx_t >&            dst,
                                                                   uint_t                                      level,
                                                                   DoFType                                     flag ) const
...
void P2VectorElementwiseFullStokesP1ViscosityAnnulusMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
...
void P2VectorElementwiseFullStokesP1ViscosityAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2VectorFunction< real_t > > P2VectorElementwiseFullStokesP1ViscosityAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
