...
P2VectorElementwiseFullStokesAnnulusMap::P2VectorElementwiseFullStokesAnnulusMap(
...
void P2VectorElementwiseFullStokesAnnulusMap::applyScaled( const real_t&                     operatorScaling,
                                                           ...
                                                           UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2VectorElementwiseFullStokesAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesAnnulusMap::apply( const P2VectorFunction< real_t >& src,
                                                     const P2VectorFunction< real_t >& dst,
                                                     uint_t                            level,
                                                     DoFType                           flag,
                                                     UpdateType                        updateType ) const
...
void P2VectorElementwiseFullStokesAnnulusMap::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                              ...
                                                              DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2VectorElementwiseFullStokesAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                        const P2VectorFunction< idx_t >&            src,
                                                        const P2VectorFunction< idx_t >&            dst,
                                                        uint_t                                      level,
                                                        DoFType                                     flag ) const
...
void P2VectorElementwiseFullStokesAnnulusMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
...
void P2VectorElementwiseFullStokesAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2VectorFunction< real_t > > P2VectorElementwiseFullStokesAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
