                                              ...
                                              public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   void applyScaled_P2ElementwiseFullStokesAnnulusMap_0_0_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   void toMatrixScaled_P2ElementwiseFullStokesAnnulusMap_0_0_macro_2D( idx_t* RESTRICT  _data_dstEdge,
   ...
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseFullStokesAnnulusMap_0_0_macro_2D(
