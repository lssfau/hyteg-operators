...
class P2ElementwiseFullStokesAnnulusMap_0_1 : public Operator< P2Function< real_t >, P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1160    1538      20      12      0              0                 0              1
   void applyScaled_P2ElementwiseFullStokesAnnulusMap_0_1_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1124    1532      20      12      0              0                 0              4
   void toMatrixScaled_P2ElementwiseFullStokesAnnulusMap_0_1_macro_2D( idx_t* RESTRICT  _data_dstEdge,
