...
#include "P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap.hpp"
...
P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap::
    P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                         size_t                                     minLevel,
                                                                         size_t                                     maxLevel,
...
void P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap::apply( const P2VectorFunction< real_t >& src,
                                                                                 ...
                                                                                 UpdateType updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         apply_P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap::toMatrix(
    ...
    DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrix_P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValues_P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap_macro_3D(
...
std::shared_ptr< P2VectorFunction< real_t > >
    P2VectorElementwiseFullStokesRotationP0ViscosityIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
