...
P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap::P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap(
...
void P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap::applyScaled( const real_t&                     operatorScaling,
                                                                           ...
                                                                           UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap::apply( const P2VectorFunction< real_t >& src,
                                                                     const P2VectorFunction< real_t >& dst,
                                                                     uint_t                            level,
                                                                     DoFType                           flag,
                                                                     UpdateType                        updateType ) const
...
void P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap::toMatrixScaled( const real_t& toMatrixScaling,
                                                                              ...
                                                                              DoFType flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                        const P2VectorFunction< idx_t >&            src,
                                                                        const P2VectorFunction< idx_t >&            dst,
                                                                        uint_t                                      level,
                                                                        DoFType                                     flag ) const
...
void P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap::computeInverseDiagonalOperatorValuesScaled(
...
void P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2VectorFunction< real_t > >
    P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
