...
void P2ElementwiseFullStokes_0_0::apply( const P2Function< walberla::float64 >& src,
...
std::shared_ptr< P2Function< walberla::float64 > > P2ElementwiseFullStokes_0_0::getInverseDiagonalValues() const
{
   return invDiag_;
}
