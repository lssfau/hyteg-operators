...
///
class P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap
...
{
 public:
   P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                               size_t                                     minLevel,
                                                               size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3724    5336      20      36      0              0                 0              1
   void apply_P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3580    5192      20      36      0              0                 0              4
   void toMatrix_P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1264    2000      20      36      0              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap_macro_2D(
