...
void P2ElementwiseFullStokesIcosahedralShellMap_1_1::apply( const P2Function< walberla::float64 >& src,
...
std::shared_ptr< P2Function< walberla::float64 > >
    P2ElementwiseFullStokesIcosahedralShellMap_1_1::getInverseDiagonalValues() const
{
   return invDiag_;
}
