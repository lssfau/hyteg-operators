...
class P2VectorElementwiseFullStokesP1ViscosityDim2D : public Operator< P2VectorFunction< real_t >, P2VectorFunction< real_t > >,
                                                      public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 public:
   P2VectorElementwiseFullStokesP1ViscosityDim2D( const std::shared_ptr< PrimitiveStorage >& storage,
                                                  size_t                                     minLevel,
                                                  size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseFullStokesP1ViscosityDim2D
   ...
   void applyScaled_P2VectorElementwiseFullStokesP1ViscosityDim2D_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   void toMatrixScaled_P2VectorElementwiseFullStokesP1ViscosityDim2D_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   void computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseFullStokesP1ViscosityDim2D_macro_2D(
