...
void P2ElementwiseFullStokesAnnulusMap_0_0::applyScaled( const real_t&               operatorScaling,
                                                         ...
                                                         UpdateType                  updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseFullStokesAnnulusMap_0_0_macro_2D(
...
void P2ElementwiseFullStokesAnnulusMap_0_0::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                            ...
                                                            DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ElementwiseFullStokesAnnulusMap_0_0_macro_2D(
...
void P2ElementwiseFullStokesAnnulusMap_0_0::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseFullStokesAnnulusMap_0_0_macro_2D(
