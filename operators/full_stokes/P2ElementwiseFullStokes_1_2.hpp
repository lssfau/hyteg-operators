...
class P2ElementwiseFullStokes_1_2 : public Operator< P2Function< real_t >, P2Function< real_t > >
{
 public:
   P2ElementwiseFullStokes_1_2( const std::shared_ptr< PrimitiveStorage >& storage,
                                size_t                                     minLevel,
                                size_t                                     maxLevel,
 ...
 private:
   ...
   void applyScaled_P2ElementwiseFullStokes_1_2_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   void toMatrixScaled_P2ElementwiseFullStokes_1_2_macro_3D( idx_t* RESTRICT                      _data_dstEdge,
