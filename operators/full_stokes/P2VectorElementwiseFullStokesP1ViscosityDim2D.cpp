...
P2VectorElementwiseFullStokesP1ViscosityDim2D::P2VectorElementwiseFullStokesP1ViscosityDim2D(
...
void P2VectorElementwiseFullStokesP1ViscosityDim2D::applyScaled( const real_t&                     operatorScaling,
...
void P2VectorElementwiseFullStokesP1ViscosityDim2D::apply( const P2VectorFunction< real_t >& src,
                                                           const P2VectorFunction< real_t >& dst,
                                                           uint_t                            level,
                                                           DoFType                           flag,
                                                           UpdateType                        updateType ) const
...
void P2VectorElementwiseFullStokesP1ViscosityDim2D::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                                    ...
                                                                    DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2VectorElementwiseFullStokesP1ViscosityDim2D_macro_2D(
...
void P2VectorElementwiseFullStokesP1ViscosityDim2D::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                              const P2VectorFunction< idx_t >&            src,
                                                              const P2VectorFunction< idx_t >&            dst,
                                                              uint_t                                      level,
                                                              DoFType                                     flag ) const
...
void P2VectorElementwiseFullStokesP1ViscosityDim2D::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseFullStokesP1ViscosityDim2D_macro_2D(
...
void P2VectorElementwiseFullStokesP1ViscosityDim2D::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2VectorFunction< real_t > > P2VectorElementwiseFullStokesP1ViscosityDim2D::getInverseDiagonalValues() const
{
   return invDiag_;
}
