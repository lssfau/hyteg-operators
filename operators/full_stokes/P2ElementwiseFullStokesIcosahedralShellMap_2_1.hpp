...
class P2ElementwiseFullStokesIcosahedralShellMap_2_1 : public Operator< P2Function< real_t >, P2Function< real_t > >
{
 public:
   P2ElementwiseFullStokesIcosahedralShellMap_2_1( const std::shared_ptr< PrimitiveStorage >& storage,
                                                   size_t                                     minLevel,
                                                   size_t                                     maxLevel,
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4468    5537      46      10      0              0                 0              1
   void applyScaled_P2ElementwiseFullStokesIcosahedralShellMap_2_1_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4368    5527      46      10      0              0                 0              4
   void toMatrixScaled_P2ElementwiseFullStokesIcosahedralShellMap_2_1_macro_3D( idx_t* RESTRICT  _data_dstEdge,
