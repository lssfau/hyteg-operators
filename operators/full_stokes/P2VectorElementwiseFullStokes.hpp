...
class P2VectorElementwiseFullStokes : public Operator< P2VectorFunction< real_t >, P2VectorFunction< real_t > >,
                                      public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 public:
   P2VectorElementwiseFullStokes( const std::shared_ptr< PrimitiveStorage >& storage,
                                  size_t                                     minLevel,
                                  size_t                                     maxLevel,
