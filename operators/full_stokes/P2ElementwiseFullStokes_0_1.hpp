...
class P2ElementwiseFullStokes_0_1 : public Operator< P2Function< real_t >, P2Function< real_t > >
{
 public:
   P2ElementwiseFullStokes_0_1( const std::shared_ptr< PrimitiveStorage >& storage,
                                size_t                                     minLevel,
                                size_t                                     maxLevel,
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    587     621      12       0      0              0                 0              1
   void applyScaled_P2ElementwiseFullStokes_0_1_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   void applyScaled_P2ElementwiseFullStokes_0_1_macro_3D( real_t* RESTRICT _data_dstEdge,
                                                          real_t* RESTRICT _data_dstVertex,
                                                          real_t* RESTRICT _data_muEdge,
                                                          real_t* RESTRICT _data_muVertex,
                                                          real_t* RESTRICT _data_srcEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    551     615      12       0      0              0                 0              4
   void toMatrixScaled_P2ElementwiseFullStokes_0_1_macro_2D( idx_t* RESTRICT                      _data_dstEdge,
   ...
   void toMatrixScaled_P2ElementwiseFullStokes_0_1_macro_3D( idx_t* RESTRICT                      _data_dstEdge,
                                                             idx_t* RESTRICT                      _data_dstVertex,
                                                             real_t* RESTRICT                     _data_muEdge,
                                                             real_t* RESTRICT                     _data_muVertex,
                                                             idx_t* RESTRICT                      _data_srcEdge,
