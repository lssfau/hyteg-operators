...
#include "P2VectorElementwiseFullStokesP1ViscosityIcosahedralShellMap.hpp"
...
P2VectorElementwiseFullStokesP1ViscosityIcosahedralShellMap::P2VectorElementwiseFullStokesP1ViscosityIcosahedralShellMap(
...
void P2VectorElementwiseFullStokesP1ViscosityIcosahedralShellMap::applyScaled( const real_t&                     operatorScaling,
                                                                               ...
                                                                               UpdateType updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2VectorElementwiseFullStokesP1ViscosityIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseFullStokesP1ViscosityIcosahedralShellMap::apply( const P2VectorFunction< real_t >& src,
                                                                         const P2VectorFunction< real_t >& dst,
                                                                         uint_t                            level,
                                                                         DoFType                           flag,
                                                                         UpdateType                        updateType ) const
...
void P2VectorElementwiseFullStokesP1ViscosityIcosahedralShellMap::toMatrixScaled( const real_t& toMatrixScaling,
                                                                                  ...
                                                                                  DoFType flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2VectorElementwiseFullStokesP1ViscosityIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseFullStokesP1ViscosityIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                            const P2VectorFunction< idx_t >&            src,
                                                                            const P2VectorFunction< idx_t >&            dst,
                                                                            uint_t                                      level,
                                                                            DoFType flag ) const
...
void P2VectorElementwiseFullStokesP1ViscosityIcosahedralShellMap::computeInverseDiagonalOperatorValuesScaled(
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseFullStokesP1ViscosityIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseFullStokesP1ViscosityIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2VectorFunction< real_t > >
    P2VectorElementwiseFullStokesP1ViscosityIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
