...
class P2ElementwiseFullStokesIcosahedralShellMap_1_1 : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                       public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseFullStokesIcosahedralShellMap_1_1( const std::shared_ptr< PrimitiveStorage >& storage,
                                                   size_t                                     minLevel,
                                                   size_t                                     maxLevel,
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3698    4392      46      10      0              0                 0              1
   void applyScaled_P2ElementwiseFullStokesIcosahedralShellMap_1_1_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3598    4337      46      10      0              0                 0              4
   void toMatrixScaled_P2ElementwiseFullStokesIcosahedralShellMap_1_1_macro_3D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2483    3212      46      10      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseFullStokesIcosahedralShellMap_1_1_macro_3D(
