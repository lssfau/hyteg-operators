...
#include "P2VectorElementwiseFullStokesRotationAnnulusMap.hpp"
...
P2VectorElementwiseFullStokesRotationAnnulusMap::P2VectorElementwiseFullStokesRotationAnnulusMap(
...
void P2VectorElementwiseFullStokesRotationAnnulusMap::apply( const P2VectorFunction< real_t >& src,
                                                             ...
                                                             UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         apply_P2VectorElementwiseFullStokesRotationAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesRotationAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                ...
                                                                DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrix_P2VectorElementwiseFullStokesRotationAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesRotationAnnulusMap::computeInverseDiagonalOperatorValues()
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValues_P2VectorElementwiseFullStokesRotationAnnulusMap_macro_2D(
...
std::shared_ptr< P2VectorFunction< real_t > > P2VectorElementwiseFullStokesRotationAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
