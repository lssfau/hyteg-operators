...
P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap::P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap(
...
void P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap::applyScaled( const real_t&                     operatorScaling,
                                                                         ...
                                                                         UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap::apply( const P2VectorFunction< real_t >& src,
                                                                   const P2VectorFunction< real_t >& dst,
                                                                   uint_t                            level,
                                                                   DoFType                           flag,
                                                                   UpdateType                        updateType ) const
...
void P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap::toMatrixScaled( const real_t& toMatrixScaling,
                                                                            ...
                                                                            DoFType flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                      const P2VectorFunction< idx_t >&            src,
                                                                      const P2VectorFunction< idx_t >&            dst,
                                                                      uint_t                                      level,
                                                                      DoFType                                     flag ) const
...
void P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap::computeInverseDiagonalOperatorValuesScaled(
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2VectorFunction< real_t > >
    P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
