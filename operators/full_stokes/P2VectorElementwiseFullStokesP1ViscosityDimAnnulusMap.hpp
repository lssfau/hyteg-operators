...
class P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap
...
{
 public:
   P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                          size_t                                     minLevel,
                                                          size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap
   ...
   void applyScaled_P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   void toMatrixScaled_P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   void computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseFullStokesP1ViscosityDimAnnulusMap_macro_2D(
