...
void P2ElementwiseFullStokesAnnulusMap_1_0::applyScaled( const real_t&               operatorScaling,
                                                         ...
                                                         UpdateType                  updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseFullStokesAnnulusMap_1_0_macro_2D(
...
void P2ElementwiseFullStokesAnnulusMap_1_0::toMatrixScaled( const real_t&                               toMatrixScaling,
