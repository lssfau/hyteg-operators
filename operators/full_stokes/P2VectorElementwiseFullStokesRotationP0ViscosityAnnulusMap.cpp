...
#include "P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap.hpp"
...
P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap::P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap(
    const std::shared_ptr< PrimitiveStorage >& storage,
    size_t                                     minLevel,
    size_t                                     maxLevel,
    const P0Function< real_t >&                _mu,
...
void P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap::apply( const P2VectorFunction< real_t >& src,
                                                                        ...
                                                                        UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         real_t* _data_mu = mu.getDGFunction()->volumeDoFFunction()->dofMemory( it.first, level );
         real_t* _data_nx_rotationVertex =
             face.getData( nx_rotation.getVertexDoFFunction().getFaceDataID() )->getPointer( level );
         real_t* _data_nx_rotationEdge = face.getData( nx_rotation.getEdgeDoFFunction().getFaceDataID() )->getPointer( level );
         real_t* _data_ny_rotationVertex =
             face.getData( ny_rotation.getVertexDoFFunction().getFaceDataID() )->getPointer( level );
         real_t* _data_ny_rotationEdge = face.getData( ny_rotation.getEdgeDoFFunction().getFaceDataID() )->getPointer( level );
         ...
         apply_P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                           ...
                                                                           DoFType flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrix_P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap_macro_2D(
...
void P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap::computeInverseDiagonalOperatorValues()
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValues_P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap_macro_2D(
...
std::shared_ptr< P2VectorFunction< real_t > >
    P2VectorElementwiseFullStokesRotationP0ViscosityAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
