...
{
    {
       ...
       const real_t tmp_qloop_76 = tmp_qloop_17*1.0 / (tmp_qloop_12*tmp_qloop_3 - tmp_qloop_13*tmp_qloop_15);
       {
          /* FaceType.GRAY */
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                ...
                const real_t tmp_qloop_53 = tmp_qloop_29*tmp_qloop_50;
                const real_t tmp_qloop_54 = tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[6*q];
                const real_t tmp_qloop_55 = tmp_qloop_52 + tmp_qloop_54;
                const real_t tmp_qloop_56 = tmp_qloop_33*tmp_qloop_50;
                const real_t tmp_qloop_57 = tmp_qloop_56*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q];
                const real_t tmp_qloop_58 = -tmp_qloop_32*tmp_qloop_50;
                const real_t tmp_qloop_59 = tmp_qloop_58*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q];
                const real_t tmp_qloop_60 = tmp_qloop_57*0.66666666666666667 + tmp_qloop_59*0.66666666666666667;
                const real_t tmp_qloop_61 = tmp_qloop_56*2.0*_data_jac_affine_inv_T_grad_phi_0_0_GRAY[q] + tmp_qloop_58*2.0*_data_jac_affine_inv_T_grad_phi_1_0_GRAY[q];
                const real_t tmp_qloop_62 = tmp_qloop_61*(tmp_qloop_57*1.0 + tmp_qloop_59*1.0);
                const real_t tmp_qloop_63 = tmp_qloop_51*1.0*_data_jac_affine_inv_T_grad_psi_1_1_GRAY[q] + tmp_qloop_53*1.0*_data_jac_affine_inv_T_grad_psi_0_1_GRAY[q];
                const real_t tmp_qloop_64 = tmp_qloop_63*(tmp_qloop_52*2.0 + tmp_qloop_54*2.0);
                const real_t tmp_qloop_65 = tmp_qloop_51*_data_jac_affine_inv_T_grad_phi_1_0_GRAY[q] + tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_0_GRAY[q];
                const real_t tmp_qloop_66 = tmp_qloop_56*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[6*q] + tmp_qloop_58*_data_jac_affine_inv_T_grad_phi_1_1_GRAY[6*q] + tmp_qloop_65;
                const real_t tmp_qloop_67 = tmp_qloop_51*0.5;
                const real_t tmp_qloop_68 = tmp_qloop_53*0.5;
                const real_t tmp_qloop_69 = tmp_qloop_56*0.5*_data_jac_affine_inv_T_grad_psi_0_1_GRAY[q] + tmp_qloop_58*0.5*_data_jac_affine_inv_T_grad_psi_1_1_GRAY[q];
                const real_t tmp_qloop_70 = tmp_qloop_67*2.0*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q] + tmp_qloop_68*2.0*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q] + tmp_qloop_69*2.0;
                const real_t tmp_qloop_71 = -p_affine_0_0 + tmp_qloop_0*_data_q_p_0[q] + tmp_qloop_1*_data_q_p_1[q];
                const real_t tmp_qloop_72 = (tmp_qloop_71*tmp_qloop_71);
                const real_t tmp_qloop_73 = -p_affine_0_1 + tmp_qloop_6*_data_q_p_0[q] + tmp_qloop_7*_data_q_p_1[q];
                const real_t tmp_qloop_74 = (tmp_qloop_73*tmp_qloop_73);
                const real_t tmp_qloop_75 = tmp_qloop_72 + tmp_qloop_74;
                const real_t tmp_qloop_77 = pow(tmp_qloop_75, -0.50000000000000000)*tmp_qloop_76*1.0;
                const real_t tmp_qloop_78 = tmp_qloop_71*tmp_qloop_77;
                const real_t tmp_qloop_79 = tmp_qloop_13*(rayVertex_1 + tmp_qloop_73) - tmp_qloop_3*(rayVertex_0 + tmp_qloop_71);
                const real_t tmp_qloop_80 = pow(tmp_qloop_75, -1.5000000000000000)*1.0;
                const real_t tmp_qloop_81 = tmp_qloop_80*(radRayVertex + tmp_qloop_76*tmp_qloop_79);
                const real_t tmp_qloop_82 = tmp_qloop_73*tmp_qloop_77;
                const real_t tmp_qloop_83 = tmp_qloop_80*(radRayVertex + tmp_qloop_76*tmp_qloop_79);
                const real_t tmp_qloop_84 = tmp_qloop_71*tmp_qloop_73;
                const real_t tmp_qloop_85 = abs_det_jac_affine_GRAY*(mu_dof_0*_data_phi_0_0_GRAY[6*q] + mu_dof_1*_data_phi_0_0_GRAY[6*q + 1] + mu_dof_2*_data_phi_0_0_GRAY[6*q + 2] + mu_dof_3*_data_phi_0_0_GRAY[6*q + 3] + mu_dof_4*_data_phi_0_0_GRAY[6*q + 4] + mu_dof_5*_data_phi_0_0_GRAY[6*q + 5])*abs((tmp_qloop_13*tmp_qloop_78 - tmp_qloop_83*tmp_qloop_84)*(tmp_qloop_3*tmp_qloop_82 + tmp_qloop_81*tmp_qloop_84) - (tmp_qloop_13*tmp_qloop_82 + tmp_qloop_72*tmp_qloop_83)*(tmp_qloop_3*tmp_qloop_78 - tmp_qloop_74*tmp_qloop_81))*_data_q_w[q];
                const real_t tmp_qloop_86 = tmp_qloop_51*_data_jac_affine_inv_T_grad_phi_1_1_GRAY[6*q + 1];
                const real_t tmp_qloop_87 = tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[6*q + 1];
                const real_t tmp_qloop_88 = tmp_qloop_86 + tmp_qloop_87;
                const real_t tmp_qloop_89 = tmp_qloop_63*(tmp_qloop_86*2.0 + tmp_qloop_87*2.0);
                const real_t tmp_qloop_90 = tmp_qloop_56*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[6*q + 1] + tmp_qloop_58*_data_jac_affine_inv_T_grad_phi_1_1_GRAY[6*q + 1] + tmp_qloop_65;
                const real_t tmp_qloop_91 = tmp_qloop_51*_data_jac_affine_inv_T_grad_phi_1_1_GRAY[6*q + 2];
                const real_t tmp_qloop_92 = tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[6*q + 2];
                const real_t tmp_qloop_93 = tmp_qloop_91 + tmp_qloop_92;
                const real_t tmp_qloop_94 = tmp_qloop_63*(tmp_qloop_91*2.0 + tmp_qloop_92*2.0);
                const real_t tmp_qloop_95 = tmp_qloop_56*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[6*q + 2] + tmp_qloop_58*_data_jac_affine_inv_T_grad_phi_1_1_GRAY[6*q + 2] + tmp_qloop_65;
                const real_t tmp_qloop_96 = tmp_qloop_51*_data_jac_affine_inv_T_grad_phi_1_1_GRAY[6*q + 3];
                const real_t tmp_qloop_97 = tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[6*q + 3];
                const real_t tmp_qloop_98 = tmp_qloop_96 + tmp_qloop_97;
                const real_t tmp_qloop_99 = tmp_qloop_63*(tmp_qloop_96*2.0 + tmp_qloop_97*2.0);
                const real_t tmp_qloop_100 = tmp_qloop_56*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[6*q + 3] + tmp_qloop_58*_data_jac_affine_inv_T_grad_phi_1_1_GRAY[6*q + 3] + tmp_qloop_65;
                const real_t tmp_qloop_101 = tmp_qloop_51*_data_jac_affine_inv_T_grad_phi_1_1_GRAY[6*q + 4];
                const real_t tmp_qloop_102 = tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[6*q + 4];
                const real_t tmp_qloop_103 = tmp_qloop_101 + tmp_qloop_102;
                const real_t tmp_qloop_104 = tmp_qloop_63*(tmp_qloop_101*2.0 + tmp_qloop_102*2.0);
                const real_t tmp_qloop_105 = tmp_qloop_56*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[6*q + 4] + tmp_qloop_58*_data_jac_affine_inv_T_grad_phi_1_1_GRAY[6*q + 4] + tmp_qloop_65;
                const real_t tmp_qloop_106 = tmp_qloop_51*_data_jac_affine_inv_T_grad_phi_1_1_GRAY[6*q + 5];
                const real_t tmp_qloop_107 = tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[6*q + 5];
                const real_t tmp_qloop_108 = tmp_qloop_106 + tmp_qloop_107;
                const real_t tmp_qloop_109 = tmp_qloop_63*(tmp_qloop_106*2.0 + tmp_qloop_107*2.0);
                const real_t tmp_qloop_110 = tmp_qloop_56*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[6*q + 5] + tmp_qloop_58*_data_jac_affine_inv_T_grad_phi_1_1_GRAY[6*q + 5] + tmp_qloop_65;
                const real_t tmp_qloop_111 = tmp_qloop_56*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 1];
                const real_t tmp_qloop_112 = tmp_qloop_58*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 1];
                const real_t tmp_qloop_113 = tmp_qloop_111*0.66666666666666667 + tmp_qloop_112*0.66666666666666667;
                const real_t tmp_qloop_114 = tmp_qloop_61*(tmp_qloop_111*1.0 + tmp_qloop_112*1.0);
                const real_t tmp_qloop_115 = tmp_qloop_67*2.0*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 1] + tmp_qloop_68*2.0*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 1] + tmp_qloop_69*2.0;
                const real_t tmp_qloop_116 = tmp_qloop_56*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 2];
                const real_t tmp_qloop_117 = tmp_qloop_58*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 2];
                const real_t tmp_qloop_118 = tmp_qloop_116*0.66666666666666667 + tmp_qloop_117*0.66666666666666667;
                const real_t tmp_qloop_119 = tmp_qloop_61*(tmp_qloop_116*1.0 + tmp_qloop_117*1.0);
                const real_t tmp_qloop_120 = tmp_qloop_67*2.0*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 2] + tmp_qloop_68*2.0*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 2] + tmp_qloop_69*2.0;
                const real_t tmp_qloop_121 = tmp_qloop_56*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 3];
                const real_t tmp_qloop_122 = tmp_qloop_58*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 3];
                const real_t tmp_qloop_123 = tmp_qloop_121*0.66666666666666667 + tmp_qloop_122*0.66666666666666667;
                const real_t tmp_qloop_124 = tmp_qloop_61*(tmp_qloop_121*1.0 + tmp_qloop_122*1.0);
                const real_t tmp_qloop_125 = tmp_qloop_67*2.0*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 3] + tmp_qloop_68*2.0*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 3] + tmp_qloop_69*2.0;
                const real_t tmp_qloop_126 = tmp_qloop_56*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 4];
                const real_t tmp_qloop_127 = tmp_qloop_58*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 4];
                const real_t tmp_qloop_128 = tmp_qloop_126*0.66666666666666667 + tmp_qloop_127*0.66666666666666667;
                const real_t tmp_qloop_129 = tmp_qloop_61*(tmp_qloop_126*1.0 + tmp_qloop_127*1.0);
                const real_t tmp_qloop_130 = tmp_qloop_67*2.0*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 4] + tmp_qloop_68*2.0*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 4] + tmp_qloop_69*2.0;
                const real_t tmp_qloop_131 = tmp_qloop_56*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 5];
                const real_t tmp_qloop_132 = tmp_qloop_58*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 5];
                const real_t tmp_qloop_133 = tmp_qloop_131*0.66666666666666667 + tmp_qloop_132*0.66666666666666667;
                const real_t tmp_qloop_134 = tmp_qloop_61*(tmp_qloop_131*1.0 + tmp_qloop_132*1.0);
                const real_t tmp_qloop_135 = tmp_qloop_67*2.0*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 5] + tmp_qloop_68*2.0*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 5] + tmp_qloop_69*2.0;
                ...
                const real_t q_tmp_0_0 = tmp_qloop_85*(-tmp_qloop_55*tmp_qloop_60 + tmp_qloop_62 + tmp_qloop_64 + tmp_qloop_66*tmp_qloop_70);
                const real_t q_tmp_0_1 = tmp_qloop_85*(-tmp_qloop_60*tmp_qloop_88 + tmp_qloop_62 + tmp_qloop_70*tmp_qloop_90 + tmp_qloop_89);
                const real_t q_tmp_0_2 = tmp_qloop_85*(-tmp_qloop_60*tmp_qloop_93 + tmp_qloop_62 + tmp_qloop_70*tmp_qloop_95 + tmp_qloop_94);
                const real_t q_tmp_0_3 = tmp_qloop_85*(tmp_qloop_100*tmp_qloop_70 - tmp_qloop_60*tmp_qloop_98 + tmp_qloop_62 + tmp_qloop_99);
                const real_t q_tmp_0_4 = tmp_qloop_85*(-tmp_qloop_103*tmp_qloop_60 + tmp_qloop_104 + tmp_qloop_105*tmp_qloop_70 + tmp_qloop_62);
                const real_t q_tmp_0_5 = tmp_qloop_85*(-tmp_qloop_108*tmp_qloop_60 + tmp_qloop_109 + tmp_qloop_110*tmp_qloop_70 + tmp_qloop_62);
                const real_t q_tmp_1_0 = tmp_qloop_85*(-tmp_qloop_113*tmp_qloop_55 + tmp_qloop_114 + tmp_qloop_115*tmp_qloop_66 + tmp_qloop_64);
                const real_t q_tmp_1_1 = tmp_qloop_85*(-tmp_qloop_113*tmp_qloop_88 + tmp_qloop_114 + tmp_qloop_115*tmp_qloop_90 + tmp_qloop_89);
                const real_t q_tmp_1_2 = tmp_qloop_85*(-tmp_qloop_113*tmp_qloop_93 + tmp_qloop_114 + tmp_qloop_115*tmp_qloop_95 + tmp_qloop_94);
                const real_t q_tmp_1_3 = tmp_qloop_85*(tmp_qloop_100*tmp_qloop_115 - tmp_qloop_113*tmp_qloop_98 + tmp_qloop_114 + tmp_qloop_99);
                const real_t q_tmp_1_4 = tmp_qloop_85*(-tmp_qloop_103*tmp_qloop_113 + tmp_qloop_104 + tmp_qloop_105*tmp_qloop_115 + tmp_qloop_114);
                const real_t q_tmp_1_5 = tmp_qloop_85*(-tmp_qloop_108*tmp_qloop_113 + tmp_qloop_109 + tmp_qloop_110*tmp_qloop_115 + tmp_qloop_114);
                const real_t q_tmp_2_0 = tmp_qloop_85*(-tmp_qloop_118*tmp_qloop_55 + tmp_qloop_119 + tmp_qloop_120*tmp_qloop_66 + tmp_qloop_64);
                const real_t q_tmp_2_1 = tmp_qloop_85*(-tmp_qloop_118*tmp_qloop_88 + tmp_qloop_119 + tmp_qloop_120*tmp_qloop_90 + tmp_qloop_89);
                const real_t q_tmp_2_2 = tmp_qloop_85*(-tmp_qloop_118*tmp_qloop_93 + tmp_qloop_119 + tmp_qloop_120*tmp_qloop_95 + tmp_qloop_94);
                const real_t q_tmp_2_3 = tmp_qloop_85*(tmp_qloop_100*tmp_qloop_120 - tmp_qloop_118*tmp_qloop_98 + tmp_qloop_119 + tmp_qloop_99);
                const real_t q_tmp_2_4 = tmp_qloop_85*(-tmp_qloop_103*tmp_qloop_118 + tmp_qloop_104 + tmp_qloop_105*tmp_qloop_120 + tmp_qloop_119);
                const real_t q_tmp_2_5 = tmp_qloop_85*(-tmp_qloop_108*tmp_qloop_118 + tmp_qloop_109 + tmp_qloop_110*tmp_qloop_120 + tmp_qloop_119);
                const real_t q_tmp_3_0 = tmp_qloop_85*(-tmp_qloop_123*tmp_qloop_55 + tmp_qloop_124 + tmp_qloop_125*tmp_qloop_66 + tmp_qloop_64);
                const real_t q_tmp_3_1 = tmp_qloop_85*(-tmp_qloop_123*tmp_qloop_88 + tmp_qloop_124 + tmp_qloop_125*tmp_qloop_90 + tmp_qloop_89);
                const real_t q_tmp_3_2 = tmp_qloop_85*(-tmp_qloop_123*tmp_qloop_93 + tmp_qloop_124 + tmp_qloop_125*tmp_qloop_95 + tmp_qloop_94);
                const real_t q_tmp_3_3 = tmp_qloop_85*(tmp_qloop_100*tmp_qloop_125 - tmp_qloop_123*tmp_qloop_98 + tmp_qloop_124 + tmp_qloop_99);
                const real_t q_tmp_3_4 = tmp_qloop_85*(-tmp_qloop_103*tmp_qloop_123 + tmp_qloop_104 + tmp_qloop_105*tmp_qloop_125 + tmp_qloop_124);
                const real_t q_tmp_3_5 = tmp_qloop_85*(-tmp_qloop_108*tmp_qloop_123 + tmp_qloop_109 + tmp_qloop_110*tmp_qloop_125 + tmp_qloop_124);
                const real_t q_tmp_4_0 = tmp_qloop_85*(-tmp_qloop_128*tmp_qloop_55 + tmp_qloop_129 + tmp_qloop_130*tmp_qloop_66 + tmp_qloop_64);
                const real_t q_tmp_4_1 = tmp_qloop_85*(-tmp_qloop_128*tmp_qloop_88 + tmp_qloop_129 + tmp_qloop_130*tmp_qloop_90 + tmp_qloop_89);
                const real_t q_tmp_4_2 = tmp_qloop_85*(-tmp_qloop_128*tmp_qloop_93 + tmp_qloop_129 + tmp_qloop_130*tmp_qloop_95 + tmp_qloop_94);
                const real_t q_tmp_4_3 = tmp_qloop_85*(tmp_qloop_100*tmp_qloop_130 - tmp_qloop_128*tmp_qloop_98 + tmp_qloop_129 + tmp_qloop_99);
                const real_t q_tmp_4_4 = tmp_qloop_85*(-tmp_qloop_103*tmp_qloop_128 + tmp_qloop_104 + tmp_qloop_105*tmp_qloop_130 + tmp_qloop_129);
                const real_t q_tmp_4_5 = tmp_qloop_85*(-tmp_qloop_108*tmp_qloop_128 + tmp_qloop_109 + tmp_qloop_110*tmp_qloop_130 + tmp_qloop_129);
                const real_t q_tmp_5_0 = tmp_qloop_85*(-tmp_qloop_133*tmp_qloop_55 + tmp_qloop_134 + tmp_qloop_135*tmp_qloop_66 + tmp_qloop_64);
                const real_t q_tmp_5_1 = tmp_qloop_85*(-tmp_qloop_133*tmp_qloop_88 + tmp_qloop_134 + tmp_qloop_135*tmp_qloop_90 + tmp_qloop_89);
                const real_t q_tmp_5_2 = tmp_qloop_85*(-tmp_qloop_133*tmp_qloop_93 + tmp_qloop_134 + tmp_qloop_135*tmp_qloop_95 + tmp_qloop_94);
                const real_t q_tmp_5_3 = tmp_qloop_85*(tmp_qloop_100*tmp_qloop_135 - tmp_qloop_133*tmp_qloop_98 + tmp_qloop_134 + tmp_qloop_99);
                const real_t q_tmp_5_4 = tmp_qloop_85*(-tmp_qloop_103*tmp_qloop_133 + tmp_qloop_104 + tmp_qloop_105*tmp_qloop_135 + tmp_qloop_134);
                const real_t q_tmp_5_5 = tmp_qloop_85*(-tmp_qloop_108*tmp_qloop_133 + tmp_qloop_109 + tmp_qloop_110*tmp_qloop_135 + tmp_qloop_134);
       ...
       const real_t abs_det_jac_affine_BLUE = abs(tmp_coords_jac_5_BLUE);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                ...
                const real_t tmp_qloop_53 = tmp_qloop_29*tmp_qloop_50;
                const real_t tmp_qloop_54 = tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[6*q];
                const real_t tmp_qloop_55 = tmp_qloop_52 + tmp_qloop_54;
                const real_t tmp_qloop_56 = tmp_qloop_33*tmp_qloop_50;
                const real_t tmp_qloop_57 = tmp_qloop_56*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q];
                const real_t tmp_qloop_58 = -tmp_qloop_32*tmp_qloop_50;
                const real_t tmp_qloop_59 = tmp_qloop_58*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q];
                const real_t tmp_qloop_60 = tmp_qloop_57*0.66666666666666667 + tmp_qloop_59*0.66666666666666667;
                const real_t tmp_qloop_61 = tmp_qloop_56*2.0*_data_jac_affine_inv_T_grad_phi_0_0_BLUE[q] + tmp_qloop_58*2.0*_data_jac_affine_inv_T_grad_phi_1_0_BLUE[q];
                const real_t tmp_qloop_62 = tmp_qloop_61*(tmp_qloop_57*1.0 + tmp_qloop_59*1.0);
                const real_t tmp_qloop_63 = tmp_qloop_51*1.0*_data_jac_affine_inv_T_grad_psi_1_1_BLUE[q] + tmp_qloop_53*1.0*_data_jac_affine_inv_T_grad_psi_0_1_BLUE[q];
                const real_t tmp_qloop_64 = tmp_qloop_63*(tmp_qloop_52*2.0 + tmp_qloop_54*2.0);
                const real_t tmp_qloop_65 = tmp_qloop_51*_data_jac_affine_inv_T_grad_phi_1_0_BLUE[q] + tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_0_BLUE[q];
                const real_t tmp_qloop_66 = tmp_qloop_56*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[6*q] + tmp_qloop_58*_data_jac_affine_inv_T_grad_phi_1_1_BLUE[6*q] + tmp_qloop_65;
                const real_t tmp_qloop_67 = tmp_qloop_51*0.5;
                const real_t tmp_qloop_68 = tmp_qloop_53*0.5;
                const real_t tmp_qloop_69 = tmp_qloop_56*0.5*_data_jac_affine_inv_T_grad_psi_0_1_BLUE[q] + tmp_qloop_58*0.5*_data_jac_affine_inv_T_grad_psi_1_1_BLUE[q];
                const real_t tmp_qloop_70 = tmp_qloop_67*2.0*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q] + tmp_qloop_68*2.0*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q] + tmp_qloop_69*2.0;
                const real_t tmp_qloop_71 = -p_affine_0_0 + tmp_qloop_0*_data_q_p_0[q] + tmp_qloop_1*_data_q_p_1[q];
                const real_t tmp_qloop_72 = (tmp_qloop_71*tmp_qloop_71);
                const real_t tmp_qloop_73 = -p_affine_0_1 + tmp_qloop_6*_data_q_p_0[q] + tmp_qloop_7*_data_q_p_1[q];
                const real_t tmp_qloop_74 = (tmp_qloop_73*tmp_qloop_73);
                ...
                const real_t tmp_qloop_83 = tmp_qloop_80*(radRayVertex + tmp_qloop_76*tmp_qloop_79);
                const real_t tmp_qloop_84 = tmp_qloop_71*tmp_qloop_73;
                const real_t tmp_qloop_85 = abs_det_jac_affine_BLUE*(mu_dof_0*_data_phi_0_0_BLUE[6*q] + mu_dof_1*_data_phi_0_0_BLUE[6*q + 1] + mu_dof_2*_data_phi_0_0_BLUE[6*q + 2] + mu_dof_3*_data_phi_0_0_BLUE[6*q + 3] + mu_dof_4*_data_phi_0_0_BLUE[6*q + 4] + mu_dof_5*_data_phi_0_0_BLUE[6*q + 5])*abs((tmp_qloop_13*tmp_qloop_78 - tmp_qloop_83*tmp_qloop_84)*(tmp_qloop_3*tmp_qloop_82 + tmp_qloop_81*tmp_qloop_84) - (tmp_qloop_13*tmp_qloop_82 + tmp_qloop_72*tmp_qloop_83)*(tmp_qloop_3*tmp_qloop_78 - tmp_qloop_74*tmp_qloop_81))*_data_q_w[q];
                const real_t tmp_qloop_86 = tmp_qloop_51*_data_jac_affine_inv_T_grad_phi_1_1_BLUE[6*q + 1];
                const real_t tmp_qloop_87 = tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[6*q + 1];
                const real_t tmp_qloop_88 = tmp_qloop_86 + tmp_qloop_87;
                const real_t tmp_qloop_89 = tmp_qloop_63*(tmp_qloop_86*2.0 + tmp_qloop_87*2.0);
                const real_t tmp_qloop_90 = tmp_qloop_56*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[6*q + 1] + tmp_qloop_58*_data_jac_affine_inv_T_grad_phi_1_1_BLUE[6*q + 1] + tmp_qloop_65;
                const real_t tmp_qloop_91 = tmp_qloop_51*_data_jac_affine_inv_T_grad_phi_1_1_BLUE[6*q + 2];
                const real_t tmp_qloop_92 = tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[6*q + 2];
                const real_t tmp_qloop_93 = tmp_qloop_91 + tmp_qloop_92;
                const real_t tmp_qloop_94 = tmp_qloop_63*(tmp_qloop_91*2.0 + tmp_qloop_92*2.0);
                const real_t tmp_qloop_95 = tmp_qloop_56*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[6*q + 2] + tmp_qloop_58*_data_jac_affine_inv_T_grad_phi_1_1_BLUE[6*q + 2] + tmp_qloop_65;
                const real_t tmp_qloop_96 = tmp_qloop_51*_data_jac_affine_inv_T_grad_phi_1_1_BLUE[6*q + 3];
                const real_t tmp_qloop_97 = tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[6*q + 3];
                const real_t tmp_qloop_98 = tmp_qloop_96 + tmp_qloop_97;
                const real_t tmp_qloop_99 = tmp_qloop_63*(tmp_qloop_96*2.0 + tmp_qloop_97*2.0);
                const real_t tmp_qloop_100 = tmp_qloop_56*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[6*q + 3] + tmp_qloop_58*_data_jac_affine_inv_T_grad_phi_1_1_BLUE[6*q + 3] + tmp_qloop_65;
                const real_t tmp_qloop_101 = tmp_qloop_51*_data_jac_affine_inv_T_grad_phi_1_1_BLUE[6*q + 4];
                const real_t tmp_qloop_102 = tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[6*q + 4];
                const real_t tmp_qloop_103 = tmp_qloop_101 + tmp_qloop_102;
                const real_t tmp_qloop_104 = tmp_qloop_63*(tmp_qloop_101*2.0 + tmp_qloop_102*2.0);
                const real_t tmp_qloop_105 = tmp_qloop_56*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[6*q + 4] + tmp_qloop_58*_data_jac_affine_inv_T_grad_phi_1_1_BLUE[6*q + 4] + tmp_qloop_65;
                const real_t tmp_qloop_106 = tmp_qloop_51*_data_jac_affine_inv_T_grad_phi_1_1_BLUE[6*q + 5];
                const real_t tmp_qloop_107 = tmp_qloop_53*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[6*q + 5];
                const real_t tmp_qloop_108 = tmp_qloop_106 + tmp_qloop_107;
                const real_t tmp_qloop_109 = tmp_qloop_63*(tmp_qloop_106*2.0 + tmp_qloop_107*2.0);
                const real_t tmp_qloop_110 = tmp_qloop_56*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[6*q + 5] + tmp_qloop_58*_data_jac_affine_inv_T_grad_phi_1_1_BLUE[6*q + 5] + tmp_qloop_65;
                const real_t tmp_qloop_111 = tmp_qloop_56*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 1];
                const real_t tmp_qloop_112 = tmp_qloop_58*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 1];
                const real_t tmp_qloop_113 = tmp_qloop_111*0.66666666666666667 + tmp_qloop_112*0.66666666666666667;
                const real_t tmp_qloop_114 = tmp_qloop_61*(tmp_qloop_111*1.0 + tmp_qloop_112*1.0);
                const real_t tmp_qloop_115 = tmp_qloop_67*2.0*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 1] + tmp_qloop_68*2.0*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 1] + tmp_qloop_69*2.0;
                const real_t tmp_qloop_116 = tmp_qloop_56*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 2];
                const real_t tmp_qloop_117 = tmp_qloop_58*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 2];
                const real_t tmp_qloop_118 = tmp_qloop_116*0.66666666666666667 + tmp_qloop_117*0.66666666666666667;
                const real_t tmp_qloop_119 = tmp_qloop_61*(tmp_qloop_116*1.0 + tmp_qloop_117*1.0);
                const real_t tmp_qloop_120 = tmp_qloop_67*2.0*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 2] + tmp_qloop_68*2.0*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 2] + tmp_qloop_69*2.0;
                const real_t tmp_qloop_121 = tmp_qloop_56*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 3];
                const real_t tmp_qloop_122 = tmp_qloop_58*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 3];
                const real_t tmp_qloop_123 = tmp_qloop_121*0.66666666666666667 + tmp_qloop_122*0.66666666666666667;
                const real_t tmp_qloop_124 = tmp_qloop_61*(tmp_qloop_121*1.0 + tmp_qloop_122*1.0);
                const real_t tmp_qloop_125 = tmp_qloop_67*2.0*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 3] + tmp_qloop_68*2.0*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 3] + tmp_qloop_69*2.0;
                const real_t tmp_qloop_126 = tmp_qloop_56*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 4];
                const real_t tmp_qloop_127 = tmp_qloop_58*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 4];
                const real_t tmp_qloop_128 = tmp_qloop_126*0.66666666666666667 + tmp_qloop_127*0.66666666666666667;
                const real_t tmp_qloop_129 = tmp_qloop_61*(tmp_qloop_126*1.0 + tmp_qloop_127*1.0);
                const real_t tmp_qloop_130 = tmp_qloop_67*2.0*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 4] + tmp_qloop_68*2.0*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 4] + tmp_qloop_69*2.0;
                const real_t tmp_qloop_131 = tmp_qloop_56*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 5];
                const real_t tmp_qloop_132 = tmp_qloop_58*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 5];
                const real_t tmp_qloop_133 = tmp_qloop_131*0.66666666666666667 + tmp_qloop_132*0.66666666666666667;
                const real_t tmp_qloop_134 = tmp_qloop_61*(tmp_qloop_131*1.0 + tmp_qloop_132*1.0);
                const real_t tmp_qloop_135 = tmp_qloop_67*2.0*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 5] + tmp_qloop_68*2.0*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 5] + tmp_qloop_69*2.0;
                const real_t jac_blending_0_0 = tmp_qloop_27;
                const real_t jac_blending_0_1 = tmp_qloop_30;
                const real_t jac_blending_1_0 = tmp_qloop_32;
                const real_t jac_blending_1_1 = tmp_qloop_33;
