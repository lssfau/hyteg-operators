       ...
       const real_t tmp_qloop_20 = tmp_qloop_19*1.0;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 6; q += 1)
             {
                ...
                const real_t tmp_qloop_70 = depthDependency*(radiusSurface + tmp_qloop_69);
                const real_t tmp_qloop_71 = additiveOffSet - tmp_qloop_63 + tmp_qloop_70;
                ...
                const real_t tmp_qloop_77 = radiusCMB + tmp_qloop_69;
                const real_t tmp_qloop_78 = (tmp_qloop_77*tmp_qloop_77);
                const real_t tmp_qloop_79 = 1.0 / (etaRef)*((tmp_qloop_71 <= -2.5) ? (additiveOffSet*0.70801927789039698 + tmp_qloop_63*-0.70801927789039698 + tmp_qloop_70*0.70801927789039698 + tmp_qloop_72*0.25619887829476801 + tmp_qloop_73*0.049440241998136299 + tmp_qloop_74*0.0050119007869658802 + tmp_qloop_75*0.000210799310036196 + 0.84819864056416305): ((tmp_qloop_71 >= -2.5 && tmp_qloop_71 <= 0.0) ? (additiveOffSet*0.999816711696631 + tmp_qloop_63*-0.999816711696631 + tmp_qloop_70*0.999816711696631 + tmp_qloop_72*0.49874653174445999 + tmp_qloop_73*0.163477078891512 + tmp_qloop_74*0.0377262341425878 + tmp_qloop_75*0.0057137319852466704 + tmp_qloop_76*0.00042229066167372002 + 0.99999631202959804): ((tmp_qloop_71 >= 0.0 && tmp_qloop_71 <= 1.25) ? (additiveOffSet*1.0002311481775901 + tmp_qloop_63*-1.0002311481775901 + tmp_qloop_70*1.0002311481775901 + tmp_qloop_72*0.49781576903043201 + tmp_qloop_73*0.17411796050345499 + tmp_qloop_74*0.030456484353984001 + tmp_qloop_75*0.0156585460585765 + 0.99999625640632195): ((tmp_qloop_71 >= 1.25 && tmp_qloop_71 <= 2.5) ? (additiveOffSet*0.72915233588440898 + tmp_qloop_63*-0.72915233588440898 + tmp_qloop_70*0.72915233588440898 + tmp_qloop_72*0.9392688549289 + tmp_qloop_73*-0.21938605668132599 + tmp_qloop_74*0.23813465659153299 + tmp_qloop_75*-0.048116994406515803 + tmp_qloop_76*0.0091901766476822806 + 1.0701841156342999): ((tmp_qloop_71 >= 2.5 && tmp_qloop_71 <= 3.75) ? (additiveOffSet*-18.157774987389999 + tmp_qloop_63*18.157774987389999 + tmp_qloop_70*-18.157774987389999 + tmp_qloop_72*18.216957764537799 + tmp_qloop_73*-8.7181905368482795 + tmp_qloop_74*2.61245893835647 + tmp_qloop_75*-0.40584114855030301 + tmp_qloop_76*0.031929232673434102 + 9.7311987868742502): ((tmp_qloop_71 >= 3.75 && tmp_qloop_71 <= 4.375) ? (additiveOffSet*308.46588370142803 + tmp_qloop_63*-308.46588370142803 + tmp_qloop_70*308.46588370142803 + tmp_qloop_72*-172.70828167835899 + tmp_qloop_73*50.0684690859892 + tmp_qloop_74*-7.4040453575121603 + tmp_qloop_75*0.48433410712200098 - 220.83741149551901): (additiveOffSet*-935.63959456652196 + tmp_qloop_63*935.63959456652196 + tmp_qloop_70*-935.63959456652196 + tmp_qloop_72*557.83752587300603 + tmp_qloop_73*-179.24929535351001 + tmp_qloop_74*33.176006484038297 + tmp_qloop_75*-3.3536686327068299 + tmp_qloop_76*0.15155124630876601 + 664.05710533428396)))))))*((tmp_qloop_77 >= -0.75) ? (1.25e+23): ((tmp_qloop_77 >= -0.75840517241379302) ? (radiusCMB*5.43063135866058e+26 + tmp_qloop_68*-5.43063135866058e+26 + tmp_qloop_78*3.54619628745821e+26 + 2.0794881073001899e+26): ((tmp_qloop_77 >= -0.76400862068965503) ? (radiusCMB*2.8816164906437698e+26 + tmp_qloop_68*-2.8816164906437698e+26 + tmp_qloop_78*1.8656863432129701e+26 + 1.11289507706839e+26): ((tmp_qloop_77 >= -0.77241379310344804) ? (radiusCMB*1.66471118539444e+26 + tmp_qloop_68*-1.66471118539444e+26 + tmp_qloop_78*1.06929133385375e+26 + 6.4803200518165701e+25): ((tmp_qloop_77 >= -0.85172413999999996) ? (1.5e+22): ((tmp_qloop_77 >= -0.85948275862069001) ? (radiusCMB*6.6965235842778496e+25 + tmp_qloop_68*-6.6965235842778496e+25 + tmp_qloop_78*3.8579740318342099e+25 + 2.90638521562008e+25): ((tmp_qloop_77 >= -0.86465517241379297) ? (radiusCMB*3.9127983014155496e+25 + tmp_qloop_68*-3.9127983014155496e+25 + tmp_qloop_78*2.2385551110116e+25 + 1.7101032729417599e+25): ((tmp_qloop_77 >= -0.87241379310344802) ? (radiusCMB*2.4361020984252302e+25 + tmp_qloop_68*-2.4361020984252302e+25 + tmp_qloop_78*1.38463307937214e+25 + 1.0716867679420699e+25): ((tmp_qloop_77 >= -0.93793103) ? (2.5e+21): ((tmp_qloop_77 >= -0.95344827586206904) ? (radiusCMB*3.6535322574369698e+25 + tmp_qloop_68*-3.6535322574369698e+25 + tmp_qloop_78*1.9551462059537398e+25 + 1.70704057747143e+25): ((tmp_qloop_77 >= -0.96379310344827596) ? (radiusCMB*9.6647891247610802e+25 + tmp_qloop_68*-9.6647891247610802e+25 + tmp_qloop_78*5.10752322498446e+25 + 4.57275182542852e+25): ((tmp_qloop_77 >= -0.97413793103448298) ? (radiusCMB*2.4634415249381102e+26 + tmp_qloop_68*-2.4634415249381102e+26 + tmp_qloop_78*1.28735188889197e+26 + 1.17865630354825e+26): ((tmp_qloop_77 >= -0.98448275862069001) ? (radiusCMB*5.3212721590952799e+26 + tmp_qloop_68*-5.3212721590952799e+26 + tmp_qloop_78*2.7542030108487401e+26 + 2.5706169141506601e+26): (radiusCMB*1.7196602723807901e+27 + tmp_qloop_68*-1.7196602723807901e+27 + tmp_qloop_78*8.7854567127168094e+26 + 8.4161460110911101e+26))))))))))))))*_data_q_w[q];
