...
#include "../P2VectorElementwiseFullStokesP1ViscosityAnnulusMap.hpp"
       ...
       const real_t tmp_qloop_12 = tmp_qloop_11*1.0;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                ...
                const real_t tmp_qloop_51 = (mu_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + mu_dof_1*_data_q_p_0[q] + mu_dof_2*_data_q_p_1[q])*_data_q_w[q];
                ...
                const real_t tmp_qloop_77 = tmp_qloop_74*0.66666666666666667 + tmp_qloop_75*0.66666666666666667;
                ...
                const real_t q_tmp_0_0 = tmp_qloop_51*(-tmp_qloop_43*(tmp_qloop_37 + tmp_qloop_38 + tmp_qloop_41)*(tmp_qloop_37*0.66666666666666667 + tmp_qloop_38*0.66666666666666667 + tmp_qloop_42) + tmp_qloop_43*(tmp_qloop_44 + (tmp_qloop_37*1.0 + tmp_qloop_38*1.0)*(tmp_qloop_37*2.0 + tmp_qloop_38*2.0) + (tmp_qloop_45 + tmp_qloop_46 + tmp_qloop_49)*(tmp_qloop_45*0.5 + tmp_qloop_46*0.5 + tmp_qloop_50)*2.0));
                const real_t q_tmp_1_1 = tmp_qloop_51*(-tmp_qloop_43*(tmp_qloop_41 + tmp_qloop_52 + tmp_qloop_53)*(tmp_qloop_42 + tmp_qloop_52*0.66666666666666667 + tmp_qloop_53*0.66666666666666667) + tmp_qloop_43*(tmp_qloop_44 + (tmp_qloop_52*1.0 + tmp_qloop_53*1.0)*(tmp_qloop_52*2.0 + tmp_qloop_53*2.0) + (tmp_qloop_49 + tmp_qloop_54 + tmp_qloop_55)*(tmp_qloop_50 + tmp_qloop_54*0.5 + tmp_qloop_55*0.5)*2.0));
                const real_t q_tmp_2_2 = tmp_qloop_51*(-tmp_qloop_43*(tmp_qloop_41 + tmp_qloop_56 + tmp_qloop_57)*(tmp_qloop_42 + tmp_qloop_56*0.66666666666666667 + tmp_qloop_57*0.66666666666666667) + tmp_qloop_43*(tmp_qloop_44 + (tmp_qloop_56*1.0 + tmp_qloop_57*1.0)*(tmp_qloop_56*2.0 + tmp_qloop_57*2.0) + (tmp_qloop_49 + tmp_qloop_58 + tmp_qloop_59)*(tmp_qloop_50 + tmp_qloop_58*0.5 + tmp_qloop_59*0.5)*2.0));
                const real_t q_tmp_3_3 = tmp_qloop_51*(-tmp_qloop_43*(tmp_qloop_41 + tmp_qloop_60 + tmp_qloop_61)*(tmp_qloop_42 + tmp_qloop_60*0.66666666666666667 + tmp_qloop_61*0.66666666666666667) + tmp_qloop_43*(tmp_qloop_44 + (tmp_qloop_60*1.0 + tmp_qloop_61*1.0)*(tmp_qloop_60*2.0 + tmp_qloop_61*2.0) + (tmp_qloop_49 + tmp_qloop_62 + tmp_qloop_63)*(tmp_qloop_50 + tmp_qloop_62*0.5 + tmp_qloop_63*0.5)*2.0));
                const real_t q_tmp_4_4 = tmp_qloop_51*(-tmp_qloop_43*(tmp_qloop_41 + tmp_qloop_64 + tmp_qloop_65)*(tmp_qloop_42 + tmp_qloop_64*0.66666666666666667 + tmp_qloop_65*0.66666666666666667) + tmp_qloop_43*(tmp_qloop_44 + (tmp_qloop_64*1.0 + tmp_qloop_65*1.0)*(tmp_qloop_64*2.0 + tmp_qloop_65*2.0) + (tmp_qloop_49 + tmp_qloop_66 + tmp_qloop_67)*(tmp_qloop_50 + tmp_qloop_66*0.5 + tmp_qloop_67*0.5)*2.0));
                const real_t q_tmp_5_5 = tmp_qloop_51*(-tmp_qloop_43*(tmp_qloop_41 + tmp_qloop_68 + tmp_qloop_69)*(tmp_qloop_42 + tmp_qloop_68*0.66666666666666667 + tmp_qloop_69*0.66666666666666667) + tmp_qloop_43*(tmp_qloop_44 + (tmp_qloop_68*1.0 + tmp_qloop_69*1.0)*(tmp_qloop_68*2.0 + tmp_qloop_69*2.0) + (tmp_qloop_49 + tmp_qloop_70 + tmp_qloop_71)*(tmp_qloop_50 + tmp_qloop_70*0.5 + tmp_qloop_71*0.5)*2.0));
                const real_t q_tmp_6_6 = tmp_qloop_51*(-tmp_qloop_43*(tmp_qloop_72 + tmp_qloop_73 + tmp_qloop_76)*(tmp_qloop_72*0.66666666666666667 + tmp_qloop_73*0.66666666666666667 + tmp_qloop_77) + tmp_qloop_43*(tmp_qloop_78 + (tmp_qloop_72*1.0 + tmp_qloop_73*1.0)*(tmp_qloop_72*2.0 + tmp_qloop_73*2.0) + (tmp_qloop_79 + tmp_qloop_80 + tmp_qloop_83)*(tmp_qloop_79*0.5 + tmp_qloop_80*0.5 + tmp_qloop_84)*2.0));
                const real_t q_tmp_7_7 = tmp_qloop_51*(-tmp_qloop_43*(tmp_qloop_76 + tmp_qloop_85 + tmp_qloop_86)*(tmp_qloop_77 + tmp_qloop_85*0.66666666666666667 + tmp_qloop_86*0.66666666666666667) + tmp_qloop_43*(tmp_qloop_78 + (tmp_qloop_85*1.0 + tmp_qloop_86*1.0)*(tmp_qloop_85*2.0 + tmp_qloop_86*2.0) + (tmp_qloop_83 + tmp_qloop_87 + tmp_qloop_88)*(tmp_qloop_84 + tmp_qloop_87*0.5 + tmp_qloop_88*0.5)*2.0));
                const real_t q_tmp_8_8 = tmp_qloop_51*(-tmp_qloop_43*(tmp_qloop_76 + tmp_qloop_89 + tmp_qloop_90)*(tmp_qloop_77 + tmp_qloop_89*0.66666666666666667 + tmp_qloop_90*0.66666666666666667) + tmp_qloop_43*(tmp_qloop_78 + (tmp_qloop_89*1.0 + tmp_qloop_90*1.0)*(tmp_qloop_89*2.0 + tmp_qloop_90*2.0) + (tmp_qloop_83 + tmp_qloop_91 + tmp_qloop_92)*(tmp_qloop_84 + tmp_qloop_91*0.5 + tmp_qloop_92*0.5)*2.0));
                const real_t q_tmp_9_9 = tmp_qloop_51*(-tmp_qloop_43*(tmp_qloop_76 + tmp_qloop_93 + tmp_qloop_94)*(tmp_qloop_77 + tmp_qloop_93*0.66666666666666667 + tmp_qloop_94*0.66666666666666667) + tmp_qloop_43*(tmp_qloop_78 + (tmp_qloop_93*1.0 + tmp_qloop_94*1.0)*(tmp_qloop_93*2.0 + tmp_qloop_94*2.0) + (tmp_qloop_83 + tmp_qloop_95 + tmp_qloop_96)*(tmp_qloop_84 + tmp_qloop_95*0.5 + tmp_qloop_96*0.5)*2.0));
                const real_t q_tmp_10_10 = tmp_qloop_51*(-tmp_qloop_43*(tmp_qloop_76 + tmp_qloop_97 + tmp_qloop_98)*(tmp_qloop_77 + tmp_qloop_97*0.66666666666666667 + tmp_qloop_98*0.66666666666666667) + tmp_qloop_43*(tmp_qloop_78 + (tmp_qloop_97*1.0 + tmp_qloop_98*1.0)*(tmp_qloop_97*2.0 + tmp_qloop_98*2.0) + (tmp_qloop_100 + tmp_qloop_83 + tmp_qloop_99)*(tmp_qloop_100*0.5 + tmp_qloop_84 + tmp_qloop_99*0.5)*2.0));
                const real_t q_tmp_11_11 = tmp_qloop_51*(-tmp_qloop_43*(tmp_qloop_101 + tmp_qloop_102 + tmp_qloop_76)*(tmp_qloop_101*0.66666666666666667 + tmp_qloop_102*0.66666666666666667 + tmp_qloop_77) + tmp_qloop_43*(tmp_qloop_78 + (tmp_qloop_101*1.0 + tmp_qloop_102*1.0)*(tmp_qloop_101*2.0 + tmp_qloop_102*2.0) + (tmp_qloop_103 + tmp_qloop_104 + tmp_qloop_83)*(tmp_qloop_103*0.5 + tmp_qloop_104*0.5 + tmp_qloop_84)*2.0));
