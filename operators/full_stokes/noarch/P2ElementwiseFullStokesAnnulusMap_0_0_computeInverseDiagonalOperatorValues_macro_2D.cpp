...
{
    {
       ...
       const real_t tmp_qloop_51 = tmp_qloop_15*1.0 / (tmp_qloop_0*tmp_qloop_11 - tmp_qloop_12*tmp_qloop_14);
       {
          /* FaceType.GRAY */
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                ...
                const real_t tmp_qloop_39 = tmp_qloop_22*tmp_qloop_30;
                const real_t tmp_qloop_40 = tmp_qloop_23*tmp_qloop_30;
                const real_t tmp_qloop_41 = (tmp_qloop_39*1.0*_data_jac_affine_inv_T_grad_psi_1_1_GRAY[q] + tmp_qloop_40*1.0*_data_jac_affine_inv_T_grad_psi_0_1_GRAY[q])*(tmp_qloop_39*2.0*_data_jac_affine_inv_T_grad_phi_1_1_GRAY[q] + tmp_qloop_40*2.0*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[q]);
                const real_t tmp_qloop_42 = tmp_qloop_31*_data_jac_affine_inv_T_grad_phi_0_1_GRAY[q] + tmp_qloop_37*_data_jac_affine_inv_T_grad_phi_1_1_GRAY[q];
                const real_t tmp_qloop_43 = tmp_qloop_39*0.5;
                const real_t tmp_qloop_44 = tmp_qloop_40*0.5;
                const real_t tmp_qloop_45 = tmp_qloop_31*0.5*_data_jac_affine_inv_T_grad_psi_0_1_GRAY[q] + tmp_qloop_37*0.5*_data_jac_affine_inv_T_grad_psi_1_1_GRAY[q];
                const real_t tmp_qloop_46 = -p_affine_0_0 + tmp_qloop_2*_data_q_p_0[q] + tmp_qloop_3*_data_q_p_1[q];
                const real_t tmp_qloop_47 = (tmp_qloop_46*tmp_qloop_46);
                const real_t tmp_qloop_48 = -p_affine_0_1 + tmp_qloop_6*_data_q_p_0[q] + tmp_qloop_7*_data_q_p_1[q];
                ...
                const real_t tmp_qloop_54 = -tmp_qloop_0*(rayVertex_0 + tmp_qloop_46) + tmp_qloop_12*(rayVertex_1 + tmp_qloop_48);
                ...
                const real_t tmp_qloop_60 = abs_det_jac_affine_GRAY*(mu_dof_0*_data_phi_0_0_GRAY[6*q] + mu_dof_1*_data_phi_0_0_GRAY[6*q + 1] + mu_dof_2*_data_phi_0_0_GRAY[6*q + 2] + mu_dof_3*_data_phi_0_0_GRAY[6*q + 3] + mu_dof_4*_data_phi_0_0_GRAY[6*q + 4] + mu_dof_5*_data_phi_0_0_GRAY[6*q + 5])*abs((tmp_qloop_0*tmp_qloop_53 - tmp_qloop_49*tmp_qloop_56)*(tmp_qloop_12*tmp_qloop_57 + tmp_qloop_47*tmp_qloop_58) - (tmp_qloop_0*tmp_qloop_57 + tmp_qloop_56*tmp_qloop_59)*(tmp_qloop_12*tmp_qloop_53 - tmp_qloop_58*tmp_qloop_59))*_data_q_w[q];
                const real_t tmp_qloop_61 = tmp_qloop_31*_data_jac_affine_inv_T_grad_phi_0_0_GRAY[6*q + 1];
                const real_t tmp_qloop_62 = tmp_qloop_37*_data_jac_affine_inv_T_grad_phi_1_0_GRAY[6*q + 1];
                const real_t tmp_qloop_63 = tmp_qloop_31*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 1];
                const real_t tmp_qloop_64 = tmp_qloop_37*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 1];
                const real_t tmp_qloop_65 = tmp_qloop_31*_data_jac_affine_inv_T_grad_phi_0_0_GRAY[6*q + 2];
                const real_t tmp_qloop_66 = tmp_qloop_37*_data_jac_affine_inv_T_grad_phi_1_0_GRAY[6*q + 2];
                const real_t tmp_qloop_67 = tmp_qloop_31*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 2];
                const real_t tmp_qloop_68 = tmp_qloop_37*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 2];
                const real_t tmp_qloop_69 = tmp_qloop_31*_data_jac_affine_inv_T_grad_phi_0_0_GRAY[6*q + 3];
                const real_t tmp_qloop_70 = tmp_qloop_37*_data_jac_affine_inv_T_grad_phi_1_0_GRAY[6*q + 3];
                const real_t tmp_qloop_71 = tmp_qloop_31*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 3];
                const real_t tmp_qloop_72 = tmp_qloop_37*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 3];
                const real_t tmp_qloop_73 = tmp_qloop_31*_data_jac_affine_inv_T_grad_phi_0_0_GRAY[6*q + 4];
                const real_t tmp_qloop_74 = tmp_qloop_37*_data_jac_affine_inv_T_grad_phi_1_0_GRAY[6*q + 4];
                const real_t tmp_qloop_75 = tmp_qloop_31*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 4];
                const real_t tmp_qloop_76 = tmp_qloop_37*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 4];
                const real_t tmp_qloop_77 = tmp_qloop_31*_data_jac_affine_inv_T_grad_phi_0_0_GRAY[6*q + 5];
                const real_t tmp_qloop_78 = tmp_qloop_37*_data_jac_affine_inv_T_grad_phi_1_0_GRAY[6*q + 5];
                const real_t tmp_qloop_79 = tmp_qloop_31*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 5];
                const real_t tmp_qloop_80 = tmp_qloop_37*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 5];
                ...
                const real_t q_tmp_0_0 = tmp_qloop_60*(tmp_qloop_41 + (tmp_qloop_32 + tmp_qloop_35)*(tmp_qloop_36 + tmp_qloop_38)*-0.66666666666666667 + (tmp_qloop_32*2.0 + tmp_qloop_35*2.0)*(tmp_qloop_36*1.0 + tmp_qloop_38*1.0) + (tmp_qloop_22*tmp_qloop_34 + tmp_qloop_40*_data_jac_affine_inv_T_grad_phi_0_0_GRAY[6*q] + tmp_qloop_42)*(tmp_qloop_43*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q] + tmp_qloop_44*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q] + tmp_qloop_45)*2.0);
                const real_t q_tmp_1_1 = tmp_qloop_60*(tmp_qloop_41 + (tmp_qloop_61 + tmp_qloop_62)*(tmp_qloop_63 + tmp_qloop_64)*-0.66666666666666667 + (tmp_qloop_61*2.0 + tmp_qloop_62*2.0)*(tmp_qloop_63*1.0 + tmp_qloop_64*1.0) + (tmp_qloop_39*_data_jac_affine_inv_T_grad_phi_1_0_GRAY[6*q + 1] + tmp_qloop_40*_data_jac_affine_inv_T_grad_phi_0_0_GRAY[6*q + 1] + tmp_qloop_42)*(tmp_qloop_43*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 1] + tmp_qloop_44*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 1] + tmp_qloop_45)*2.0);
                const real_t q_tmp_2_2 = tmp_qloop_60*(tmp_qloop_41 + (tmp_qloop_65 + tmp_qloop_66)*(tmp_qloop_67 + tmp_qloop_68)*-0.66666666666666667 + (tmp_qloop_65*2.0 + tmp_qloop_66*2.0)*(tmp_qloop_67*1.0 + tmp_qloop_68*1.0) + (tmp_qloop_39*_data_jac_affine_inv_T_grad_phi_1_0_GRAY[6*q + 2] + tmp_qloop_40*_data_jac_affine_inv_T_grad_phi_0_0_GRAY[6*q + 2] + tmp_qloop_42)*(tmp_qloop_43*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 2] + tmp_qloop_44*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 2] + tmp_qloop_45)*2.0);
                const real_t q_tmp_3_3 = tmp_qloop_60*(tmp_qloop_41 + (tmp_qloop_69 + tmp_qloop_70)*(tmp_qloop_71 + tmp_qloop_72)*-0.66666666666666667 + (tmp_qloop_69*2.0 + tmp_qloop_70*2.0)*(tmp_qloop_71*1.0 + tmp_qloop_72*1.0) + (tmp_qloop_39*_data_jac_affine_inv_T_grad_phi_1_0_GRAY[6*q + 3] + tmp_qloop_40*_data_jac_affine_inv_T_grad_phi_0_0_GRAY[6*q + 3] + tmp_qloop_42)*(tmp_qloop_43*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 3] + tmp_qloop_44*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 3] + tmp_qloop_45)*2.0);
                const real_t q_tmp_4_4 = tmp_qloop_60*(tmp_qloop_41 + (tmp_qloop_73 + tmp_qloop_74)*(tmp_qloop_75 + tmp_qloop_76)*-0.66666666666666667 + (tmp_qloop_73*2.0 + tmp_qloop_74*2.0)*(tmp_qloop_75*1.0 + tmp_qloop_76*1.0) + (tmp_qloop_39*_data_jac_affine_inv_T_grad_phi_1_0_GRAY[6*q + 4] + tmp_qloop_40*_data_jac_affine_inv_T_grad_phi_0_0_GRAY[6*q + 4] + tmp_qloop_42)*(tmp_qloop_43*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 4] + tmp_qloop_44*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 4] + tmp_qloop_45)*2.0);
                const real_t q_tmp_5_5 = tmp_qloop_60*(tmp_qloop_41 + (tmp_qloop_77 + tmp_qloop_78)*(tmp_qloop_79 + tmp_qloop_80)*-0.66666666666666667 + (tmp_qloop_77*2.0 + tmp_qloop_78*2.0)*(tmp_qloop_79*1.0 + tmp_qloop_80*1.0) + (tmp_qloop_39*_data_jac_affine_inv_T_grad_phi_1_0_GRAY[6*q + 5] + tmp_qloop_40*_data_jac_affine_inv_T_grad_phi_0_0_GRAY[6*q + 5] + tmp_qloop_42)*(tmp_qloop_43*_data_jac_affine_inv_T_grad_psi_1_0_GRAY[6*q + 5] + tmp_qloop_44*_data_jac_affine_inv_T_grad_psi_0_0_GRAY[6*q + 5] + tmp_qloop_45)*2.0);
       ...
       const real_t abs_det_jac_affine_BLUE = abs(tmp_coords_jac_5_BLUE);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                ...
                const real_t tmp_qloop_39 = tmp_qloop_22*tmp_qloop_30;
                const real_t tmp_qloop_40 = tmp_qloop_23*tmp_qloop_30;
                const real_t tmp_qloop_41 = (tmp_qloop_39*1.0*_data_jac_affine_inv_T_grad_psi_1_1_BLUE[q] + tmp_qloop_40*1.0*_data_jac_affine_inv_T_grad_psi_0_1_BLUE[q])*(tmp_qloop_39*2.0*_data_jac_affine_inv_T_grad_phi_1_1_BLUE[q] + tmp_qloop_40*2.0*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[q]);
                const real_t tmp_qloop_42 = tmp_qloop_31*_data_jac_affine_inv_T_grad_phi_0_1_BLUE[q] + tmp_qloop_37*_data_jac_affine_inv_T_grad_phi_1_1_BLUE[q];
                const real_t tmp_qloop_43 = tmp_qloop_39*0.5;
                const real_t tmp_qloop_44 = tmp_qloop_40*0.5;
                const real_t tmp_qloop_45 = tmp_qloop_31*0.5*_data_jac_affine_inv_T_grad_psi_0_1_BLUE[q] + tmp_qloop_37*0.5*_data_jac_affine_inv_T_grad_psi_1_1_BLUE[q];
                const real_t tmp_qloop_46 = -p_affine_0_0 + tmp_qloop_2*_data_q_p_0[q] + tmp_qloop_3*_data_q_p_1[q];
                const real_t tmp_qloop_47 = (tmp_qloop_46*tmp_qloop_46);
                const real_t tmp_qloop_48 = -p_affine_0_1 + tmp_qloop_6*_data_q_p_0[q] + tmp_qloop_7*_data_q_p_1[q];
                const real_t tmp_qloop_49 = (tmp_qloop_48*tmp_qloop_48);
                ...
                const real_t tmp_qloop_58 = tmp_qloop_55*(radRayVertex + tmp_qloop_51*tmp_qloop_54);
                const real_t tmp_qloop_59 = tmp_qloop_46*tmp_qloop_48;
                const real_t tmp_qloop_60 = abs_det_jac_affine_BLUE*(mu_dof_0*_data_phi_0_0_BLUE[6*q] + mu_dof_1*_data_phi_0_0_BLUE[6*q + 1] + mu_dof_2*_data_phi_0_0_BLUE[6*q + 2] + mu_dof_3*_data_phi_0_0_BLUE[6*q + 3] + mu_dof_4*_data_phi_0_0_BLUE[6*q + 4] + mu_dof_5*_data_phi_0_0_BLUE[6*q + 5])*abs((tmp_qloop_0*tmp_qloop_53 - tmp_qloop_49*tmp_qloop_56)*(tmp_qloop_12*tmp_qloop_57 + tmp_qloop_47*tmp_qloop_58) - (tmp_qloop_0*tmp_qloop_57 + tmp_qloop_56*tmp_qloop_59)*(tmp_qloop_12*tmp_qloop_53 - tmp_qloop_58*tmp_qloop_59))*_data_q_w[q];
                const real_t tmp_qloop_61 = tmp_qloop_31*_data_jac_affine_inv_T_grad_phi_0_0_BLUE[6*q + 1];
                const real_t tmp_qloop_62 = tmp_qloop_37*_data_jac_affine_inv_T_grad_phi_1_0_BLUE[6*q + 1];
                const real_t tmp_qloop_63 = tmp_qloop_31*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 1];
                const real_t tmp_qloop_64 = tmp_qloop_37*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 1];
                const real_t tmp_qloop_65 = tmp_qloop_31*_data_jac_affine_inv_T_grad_phi_0_0_BLUE[6*q + 2];
                const real_t tmp_qloop_66 = tmp_qloop_37*_data_jac_affine_inv_T_grad_phi_1_0_BLUE[6*q + 2];
                const real_t tmp_qloop_67 = tmp_qloop_31*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 2];
                const real_t tmp_qloop_68 = tmp_qloop_37*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 2];
                const real_t tmp_qloop_69 = tmp_qloop_31*_data_jac_affine_inv_T_grad_phi_0_0_BLUE[6*q + 3];
                const real_t tmp_qloop_70 = tmp_qloop_37*_data_jac_affine_inv_T_grad_phi_1_0_BLUE[6*q + 3];
                const real_t tmp_qloop_71 = tmp_qloop_31*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 3];
                const real_t tmp_qloop_72 = tmp_qloop_37*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 3];
                const real_t tmp_qloop_73 = tmp_qloop_31*_data_jac_affine_inv_T_grad_phi_0_0_BLUE[6*q + 4];
                const real_t tmp_qloop_74 = tmp_qloop_37*_data_jac_affine_inv_T_grad_phi_1_0_BLUE[6*q + 4];
                const real_t tmp_qloop_75 = tmp_qloop_31*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 4];
                const real_t tmp_qloop_76 = tmp_qloop_37*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 4];
                const real_t tmp_qloop_77 = tmp_qloop_31*_data_jac_affine_inv_T_grad_phi_0_0_BLUE[6*q + 5];
                const real_t tmp_qloop_78 = tmp_qloop_37*_data_jac_affine_inv_T_grad_phi_1_0_BLUE[6*q + 5];
                const real_t tmp_qloop_79 = tmp_qloop_31*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 5];
                const real_t tmp_qloop_80 = tmp_qloop_37*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 5];
                const real_t jac_blending_0_0 = tmp_qloop_22;
                const real_t jac_blending_0_1 = tmp_qloop_24;
                const real_t jac_blending_1_0 = tmp_qloop_26;
                const real_t jac_blending_1_1 = tmp_qloop_27;
                ...
                const real_t jac_blending_inv_1_0 = -jac_blending_1_0*tmp_qloop_29;
                const real_t jac_blending_inv_1_1 = jac_blending_0_0*tmp_qloop_29;
                const real_t q_tmp_0_0 = tmp_qloop_60*(tmp_qloop_41 + (tmp_qloop_32 + tmp_qloop_35)*(tmp_qloop_36 + tmp_qloop_38)*-0.66666666666666667 + (tmp_qloop_32*2.0 + tmp_qloop_35*2.0)*(tmp_qloop_36*1.0 + tmp_qloop_38*1.0) + (tmp_qloop_22*tmp_qloop_34 + tmp_qloop_40*_data_jac_affine_inv_T_grad_phi_0_0_BLUE[6*q] + tmp_qloop_42)*(tmp_qloop_43*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q] + tmp_qloop_44*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q] + tmp_qloop_45)*2.0);
                const real_t q_tmp_1_1 = tmp_qloop_60*(tmp_qloop_41 + (tmp_qloop_61 + tmp_qloop_62)*(tmp_qloop_63 + tmp_qloop_64)*-0.66666666666666667 + (tmp_qloop_61*2.0 + tmp_qloop_62*2.0)*(tmp_qloop_63*1.0 + tmp_qloop_64*1.0) + (tmp_qloop_39*_data_jac_affine_inv_T_grad_phi_1_0_BLUE[6*q + 1] + tmp_qloop_40*_data_jac_affine_inv_T_grad_phi_0_0_BLUE[6*q + 1] + tmp_qloop_42)*(tmp_qloop_43*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 1] + tmp_qloop_44*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 1] + tmp_qloop_45)*2.0);
                const real_t q_tmp_2_2 = tmp_qloop_60*(tmp_qloop_41 + (tmp_qloop_65 + tmp_qloop_66)*(tmp_qloop_67 + tmp_qloop_68)*-0.66666666666666667 + (tmp_qloop_65*2.0 + tmp_qloop_66*2.0)*(tmp_qloop_67*1.0 + tmp_qloop_68*1.0) + (tmp_qloop_39*_data_jac_affine_inv_T_grad_phi_1_0_BLUE[6*q + 2] + tmp_qloop_40*_data_jac_affine_inv_T_grad_phi_0_0_BLUE[6*q + 2] + tmp_qloop_42)*(tmp_qloop_43*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 2] + tmp_qloop_44*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 2] + tmp_qloop_45)*2.0);
                const real_t q_tmp_3_3 = tmp_qloop_60*(tmp_qloop_41 + (tmp_qloop_69 + tmp_qloop_70)*(tmp_qloop_71 + tmp_qloop_72)*-0.66666666666666667 + (tmp_qloop_69*2.0 + tmp_qloop_70*2.0)*(tmp_qloop_71*1.0 + tmp_qloop_72*1.0) + (tmp_qloop_39*_data_jac_affine_inv_T_grad_phi_1_0_BLUE[6*q + 3] + tmp_qloop_40*_data_jac_affine_inv_T_grad_phi_0_0_BLUE[6*q + 3] + tmp_qloop_42)*(tmp_qloop_43*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 3] + tmp_qloop_44*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 3] + tmp_qloop_45)*2.0);
                const real_t q_tmp_4_4 = tmp_qloop_60*(tmp_qloop_41 + (tmp_qloop_73 + tmp_qloop_74)*(tmp_qloop_75 + tmp_qloop_76)*-0.66666666666666667 + (tmp_qloop_73*2.0 + tmp_qloop_74*2.0)*(tmp_qloop_75*1.0 + tmp_qloop_76*1.0) + (tmp_qloop_39*_data_jac_affine_inv_T_grad_phi_1_0_BLUE[6*q + 4] + tmp_qloop_40*_data_jac_affine_inv_T_grad_phi_0_0_BLUE[6*q + 4] + tmp_qloop_42)*(tmp_qloop_43*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 4] + tmp_qloop_44*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 4] + tmp_qloop_45)*2.0);
                const real_t q_tmp_5_5 = tmp_qloop_60*(tmp_qloop_41 + (tmp_qloop_77 + tmp_qloop_78)*(tmp_qloop_79 + tmp_qloop_80)*-0.66666666666666667 + (tmp_qloop_77*2.0 + tmp_qloop_78*2.0)*(tmp_qloop_79*1.0 + tmp_qloop_80*1.0) + (tmp_qloop_39*_data_jac_affine_inv_T_grad_phi_1_0_BLUE[6*q + 5] + tmp_qloop_40*_data_jac_affine_inv_T_grad_phi_0_0_BLUE[6*q + 5] + tmp_qloop_42)*(tmp_qloop_43*_data_jac_affine_inv_T_grad_psi_1_0_BLUE[6*q + 5] + tmp_qloop_44*_data_jac_affine_inv_T_grad_psi_0_0_BLUE[6*q + 5] + tmp_qloop_45)*2.0);
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_1_1 = q_acc_1_1 + q_tmp_1_1;
                q_acc_2_2 = q_acc_2_2 + q_tmp_2_2;
                q_acc_3_3 = q_acc_3_3 + q_tmp_3_3;
