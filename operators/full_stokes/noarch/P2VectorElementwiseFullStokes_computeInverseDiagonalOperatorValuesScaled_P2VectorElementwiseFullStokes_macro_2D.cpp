...
void P2VectorElementwiseFullStokes::computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseFullStokes_macro_2D( real_t * RESTRICT  _data_invDiag__edge_0, real_t * RESTRICT  _data_invDiag__edge_1, real_t * RESTRICT  _data_invDiag__vertex_0, real_t * RESTRICT  _data_invDiag__vertex_1, real_t * RESTRICT  _data_muEdge, real_t * RESTRICT  _data_muVertex, real_t diagScaling, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float ) const
{
    {
       ...
       const real_t abs_det_jac_affine_GRAY = abs(tmp_coords_jac_1_GRAY);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 3; q += 1)
             {
                ...
                const real_t tmp_qloop_4 = 0.66666666666666667*_data_tabulated_and_untitled_0_0_GRAY[8*q + 7];
       ...
       const real_t abs_det_jac_affine_BLUE = abs(tmp_coords_jac_5_BLUE);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 3; q += 1)
             {
                ...
                const real_t tmp_qloop_4 = 0.66666666666666667*_data_tabulated_and_untitled_0_0_BLUE[8*q + 7];
                ...
                const real_t q_tmp_0_0 = tmp_qloop_3*(-(tmp_qloop_0 + 0.66666666666666667*_data_tabulated_and_untitled_0_0_BLUE[8*q])*(_data_tabulated_and_untitled_0_0_BLUE[8*q] + _data_tabulated_and_untitled_1_1_BLUE[7*q])*_data_tabulated_and_untitled_0_0_BLUE[8*q + 1] + (tmp_qloop_1 + (tmp_qloop_2 + 0.5*_data_tabulated_and_untitled_1_0_BLUE[7*q])*(_data_tabulated_and_untitled_0_1_BLUE[7*q] + _data_tabulated_and_untitled_1_0_BLUE[7*q])*2.0 + 2.0*(_data_tabulated_and_untitled_0_0_BLUE[8*q]*_data_tabulated_and_untitled_0_0_BLUE[8*q]))*_data_tabulated_and_untitled_0_0_BLUE[8*q + 1]);
