...
class P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap
...
{
 public:
   P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                            size_t                                     minLevel,
                                                            size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2052    2492      20      12      0              0                 0              1
   void applyScaled_P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1908    2414      20      12      0              0                 0              4
   void toMatrixScaled_P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    864    1168      20      12      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseFullStokesP1ViscosityDim2DAnnulusMap_macro_2D(
