...
///
class P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap
...
{
 public:
   P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                               size_t                                     minLevel,
                                                               size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3732    5344      20      36      0              0                 0              1
   void apply_P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3588    5200      20      36      0              0                 0              4
   void toMatrix_P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1272    2008      20      36      0              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseFullStokesRotationP1ViscosityAnnulusMap_macro_2D(
