...
class P2VectorElementwiseFullStokesP0ViscosityIcosahedralShellMap
...
{
 public:
   P2VectorElementwiseFullStokesP0ViscosityIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                size_t                                     minLevel,
                                                                size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseFullStokesP0ViscosityIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  15908   16777      46      10      0              0                 0              1
   void apply_P2VectorElementwiseFullStokesP0ViscosityIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  15008   15877      46      10      0              0                 0              4
   void toMatrix_P2VectorElementwiseFullStokesP0ViscosityIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5198    6187      46      10      0              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseFullStokesP0ViscosityIcosahedralShellMap_macro_3D(
