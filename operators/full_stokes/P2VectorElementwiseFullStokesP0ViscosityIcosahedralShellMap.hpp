  ...
  public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  15908   16802      46      10      0              0                 0              1
   void applyScaled_P2VectorElementwiseFullStokesP0ViscosityIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  15008   16337      46      10      0              0                 0              4
   void toMatrixScaled_P2VectorElementwiseFullStokesP0ViscosityIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5198    6212      46      10      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseFullStokesP0ViscosityIcosahedralShellMap_macro_3D(
