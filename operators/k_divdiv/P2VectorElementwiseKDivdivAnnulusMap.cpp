...
P2VectorElementwiseKDivdivAnnulusMap::P2VectorElementwiseKDivdivAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                            size_t                                     minLevel,
                                                                            size_t                                     maxLevel,
...
void P2VectorElementwiseKDivdivAnnulusMap::applyScaled( const real_t&                     operatorScaling,
                                                        ...
                                                        UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2VectorElementwiseKDivdivAnnulusMap_macro_2D(
...
void P2VectorElementwiseKDivdivAnnulusMap::apply( const P2VectorFunction< real_t >& src,
                                                  const P2VectorFunction< real_t >& dst,
                                                  uint_t                            level,
                                                  DoFType                           flag,
                                                  UpdateType                        updateType ) const
...
void P2VectorElementwiseKDivdivAnnulusMap::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                           ...
                                                           DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2VectorElementwiseKDivdivAnnulusMap_macro_2D(
...
void P2VectorElementwiseKDivdivAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                     const P2VectorFunction< idx_t >&            src,
                                                     const P2VectorFunction< idx_t >&            dst,
                                                     uint_t                                      level,
                                                     DoFType                                     flag ) const
...
void P2VectorElementwiseKDivdivAnnulusMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseKDivdivAnnulusMap_macro_2D(
...
void P2VectorElementwiseKDivdivAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2VectorFunction< real_t > > P2VectorElementwiseKDivdivAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
