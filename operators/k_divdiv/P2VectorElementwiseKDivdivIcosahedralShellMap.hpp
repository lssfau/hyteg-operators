                                                      ...
                                                      public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4573    5572      46      10      0              0                 0              1
   void apply_P2VectorElementwiseKDivdivIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3673    4672      46      10      0              0                 0              4
   void toMatrix_P2VectorElementwiseKDivdivIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1528    2352      46      10      0              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseKDivdivIcosahedralShellMap_macro_3D(
