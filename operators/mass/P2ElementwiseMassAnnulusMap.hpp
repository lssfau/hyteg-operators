                                    ...
                                    public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    542     828      24      18      0              0                 0              1
   void applyScaled_P2ElementwiseMassAnnulusMap_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    506     807      24      18      0              0                 0              4
   void toMatrixScaled_P2ElementwiseMassAnnulusMap_macro_2D( idx_t* RESTRICT                      _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    422     672      24      18      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseMassAnnulusMap_macro_2D( real_t* RESTRICT _data_invDiag_Edge,
