...
class P1ElementwiseMassAnnulusMap : public Operator< P1Function< real_t >, P1Function< real_t > >,
                                    public OperatorWithInverseDiagonal< P1Function< real_t > >
{
 public:
   P1ElementwiseMassAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage, size_t minLevel, size_t maxLevel );
 ...
 protected:
 private:
   /// Integral: P1ElementwiseMassAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    261     408      20      12      0              0                 0              1
   void applyScaled_P1ElementwiseMassAnnulusMap_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    252     402      20      12      0              0                 0              4
   void toMatrixScaled_P1ElementwiseMassAnnulusMap_macro_2D( idx_t* RESTRICT                      _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    243     379      20      12      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P1ElementwiseMassAnnulusMap_macro_2D( real_t* RESTRICT _data_invDiag_,
                                                                                         real_t           diagScaling,
                                                                                         real_t  macro_vertex_coord_id_0comp0,
                                                                                         real_t  macro_vertex_coord_id_0comp1,
                                                                                         real_t  macro_vertex_coord_id_1comp0,
