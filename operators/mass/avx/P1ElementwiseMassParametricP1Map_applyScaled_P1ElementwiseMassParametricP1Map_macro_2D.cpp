...
void P1ElementwiseMassParametricP1Map::applyScaled_P1ElementwiseMassParametricP1Map_macro_2D( real_t * RESTRICT  _data_dst, real_t * RESTRICT  _data_micromesh_0, real_t * RESTRICT  _data_micromesh_1, real_t * RESTRICT  _data_src, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling ) const
{
    {
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const __m256d q_tmp_0_1 = _mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(_data_tabulated_and_untitled_0_0_GRAY[6*q + 1],_data_tabulated_and_untitled_0_0_GRAY[6*q + 1],_data_tabulated_and_untitled_0_0_GRAY[6*q + 1],_data_tabulated_and_untitled_0_0_GRAY[6*q + 1]));
                   const __m256d q_tmp_0_2 = _mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(_data_tabulated_and_untitled_0_0_GRAY[6*q + 2],_data_tabulated_and_untitled_0_0_GRAY[6*q + 2],_data_tabulated_and_untitled_0_0_GRAY[6*q + 2],_data_tabulated_and_untitled_0_0_GRAY[6*q + 2]));
                   ...
                   const __m256d q_tmp_1_2 = _mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(_data_tabulated_and_untitled_0_0_GRAY[6*q + 4],_data_tabulated_and_untitled_0_0_GRAY[6*q + 4],_data_tabulated_and_untitled_0_0_GRAY[6*q + 4],_data_tabulated_and_untitled_0_0_GRAY[6*q + 4]));
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const __m256d q_tmp_0_1 = _mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(_data_tabulated_and_untitled_0_0_BLUE[6*q + 1],_data_tabulated_and_untitled_0_0_BLUE[6*q + 1],_data_tabulated_and_untitled_0_0_BLUE[6*q + 1],_data_tabulated_and_untitled_0_0_BLUE[6*q + 1]));
                   const __m256d q_tmp_0_2 = _mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(_data_tabulated_and_untitled_0_0_BLUE[6*q + 2],_data_tabulated_and_untitled_0_0_BLUE[6*q + 2],_data_tabulated_and_untitled_0_0_BLUE[6*q + 2],_data_tabulated_and_untitled_0_0_BLUE[6*q + 2]));
                   ...
                   const __m256d q_tmp_1_2 = _mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(_data_tabulated_and_untitled_0_0_BLUE[6*q + 4],_data_tabulated_and_untitled_0_0_BLUE[6*q + 4],_data_tabulated_and_untitled_0_0_BLUE[6*q + 4],_data_tabulated_and_untitled_0_0_BLUE[6*q + 4]));
