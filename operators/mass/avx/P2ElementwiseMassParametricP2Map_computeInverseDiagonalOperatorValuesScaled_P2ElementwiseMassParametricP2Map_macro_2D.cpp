          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 6; q += 1)
                {
                   ...
                   const __m256d q_tmp_1_1 = _mm256_mul_pd(tmp_qloop_14,_mm256_mul_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),tmp_qloop_3),_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),tmp_qloop_3)));
                   const __m256d q_tmp_2_2 = _mm256_mul_pd(tmp_qloop_14,_mm256_mul_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q])),tmp_qloop_5),_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q])),tmp_qloop_5)));
                   const __m256d q_tmp_3_3 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_14,tmp_qloop_2),tmp_qloop_4),_mm256_set_pd(16.0,16.0,16.0,16.0));
                   const __m256d q_tmp_4_4 = _mm256_mul_pd(tmp_qloop_14,_mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_4,_mm256_set_pd(-4.0,-4.0,-4.0,-4.0)),_mm256_mul_pd(tmp_qloop_1,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_6),_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_4,_mm256_set_pd(-4.0,-4.0,-4.0,-4.0)),_mm256_mul_pd(tmp_qloop_1,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_6)));
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 6; q += 1)
                {
                   ...
                   const real_t tmp_qloop_9 = tmp_qloop_0 + tmp_qloop_6 - 3.0;
                   const real_t tmp_qloop_10 = micromesh_dof_6*tmp_qloop_9;
                   const real_t tmp_qloop_11 = tmp_qloop_0 - 1.0;
                   const real_t tmp_qloop_12 = micromesh_dof_0*tmp_qloop_9;
                   const real_t tmp_qloop_13 = -tmp_qloop_6 - 8.0*_data_q_p_0[q] + 4.0;
                   const real_t tmp_qloop_14 = abs((micromesh_dof_1*tmp_qloop_11 + micromesh_dof_3*tmp_qloop_6 - micromesh_dof_4*tmp_qloop_6 + micromesh_dof_5*tmp_qloop_13 + tmp_qloop_12)*(micromesh_dof_10*tmp_qloop_8 - micromesh_dof_11*tmp_qloop_0 + micromesh_dof_8*tmp_qloop_7 + micromesh_dof_9*tmp_qloop_0 + tmp_qloop_10) - (-micromesh_dof_10*tmp_qloop_6 + micromesh_dof_11*tmp_qloop_13 + micromesh_dof_7*tmp_qloop_11 + micromesh_dof_9*tmp_qloop_6 + tmp_qloop_10)*(micromesh_dof_2*tmp_qloop_7 + micromesh_dof_3*tmp_qloop_0 + micromesh_dof_4*tmp_qloop_8 - micromesh_dof_5*tmp_qloop_0 + tmp_qloop_12))*_data_q_w[q];
                   const real_t q_tmp_0_0 = tmp_qloop_14*((tmp_qloop_1 + tmp_qloop_3 + tmp_qloop_5 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0)*(tmp_qloop_1 + tmp_qloop_3 + tmp_qloop_5 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0));
                   const real_t q_tmp_1_1 = tmp_qloop_14*((tmp_qloop_3 - _data_q_p_0[q])*(tmp_qloop_3 - _data_q_p_0[q]));
                   const real_t q_tmp_2_2 = tmp_qloop_14*((tmp_qloop_5 - _data_q_p_1[q])*(tmp_qloop_5 - _data_q_p_1[q]));
                   const real_t q_tmp_3_3 = tmp_qloop_14*tmp_qloop_2*tmp_qloop_4*16.0;
                   const real_t q_tmp_4_4 = tmp_qloop_14*((-tmp_qloop_1 + tmp_qloop_4*-4.0 + tmp_qloop_6)*(-tmp_qloop_1 + tmp_qloop_4*-4.0 + tmp_qloop_6));
                   const real_t q_tmp_5_5 = tmp_qloop_14*((tmp_qloop_0 - tmp_qloop_1 + tmp_qloop_2*-4.0)*(tmp_qloop_0 - tmp_qloop_1 + tmp_qloop_2*-4.0));
