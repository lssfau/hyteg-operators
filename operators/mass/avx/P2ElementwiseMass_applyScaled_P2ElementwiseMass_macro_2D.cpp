...
void P2ElementwiseMass::applyScaled_P2ElementwiseMass_macro_2D( real_t * RESTRICT  _data_dstEdge, real_t * RESTRICT  _data_dstVertex, real_t * RESTRICT  _data_srcEdge, real_t * RESTRICT  _data_srcVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling ) const
{
    {
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 6; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_7 = _mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),tmp_qloop_2);
                   const __m256d tmp_qloop_8 = _mm256_mul_pd(tmp_qloop_5,_mm256_set_pd(tmp_qloop_6,tmp_qloop_6,tmp_qloop_6,tmp_qloop_6));
                   const __m256d tmp_qloop_9 = _mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q])),tmp_qloop_4);
                   const __m256d tmp_qloop_10 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_3,_mm256_set_pd(-4.0,-4.0,-4.0,-4.0)),_mm256_mul_pd(_mm256_set_pd(4.0,4.0,4.0,4.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q]))),_mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)));
                   const __m256d tmp_qloop_11 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_1,_mm256_set_pd(-4.0,-4.0,-4.0,-4.0)),_mm256_mul_pd(_mm256_set_pd(4.0,4.0,4.0,4.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q]))),_mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)));
                   const __m256d tmp_qloop_12 = _mm256_mul_pd(tmp_qloop_7,_mm256_set_pd(tmp_qloop_6,tmp_qloop_6,tmp_qloop_6,tmp_qloop_6));
                   const __m256d tmp_qloop_13 = _mm256_mul_pd(tmp_qloop_9,_mm256_set_pd(tmp_qloop_6,tmp_qloop_6,tmp_qloop_6,tmp_qloop_6));
                   const __m256d tmp_qloop_14 = _mm256_mul_pd(tmp_qloop_10,_mm256_set_pd(tmp_qloop_6,tmp_qloop_6,tmp_qloop_6,tmp_qloop_6));
                   const __m256d q_tmp_0_0 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_5,tmp_qloop_5),_mm256_set_pd(tmp_qloop_6,tmp_qloop_6,tmp_qloop_6,tmp_qloop_6));
                   const __m256d q_tmp_0_1 = _mm256_mul_pd(tmp_qloop_7,tmp_qloop_8);
                   const __m256d q_tmp_0_2 = _mm256_mul_pd(tmp_qloop_8,tmp_qloop_9);
                   const __m256d q_tmp_0_3 = _mm256_mul_pd(tmp_qloop_0,tmp_qloop_8);
                   const __m256d q_tmp_0_4 = _mm256_mul_pd(tmp_qloop_10,tmp_qloop_8);
                   const __m256d q_tmp_0_5 = _mm256_mul_pd(tmp_qloop_11,tmp_qloop_8);
                   const __m256d q_tmp_1_1 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_7,tmp_qloop_7),_mm256_set_pd(tmp_qloop_6,tmp_qloop_6,tmp_qloop_6,tmp_qloop_6));
                   const __m256d q_tmp_1_2 = _mm256_mul_pd(tmp_qloop_12,tmp_qloop_9);
                   const __m256d q_tmp_1_3 = _mm256_mul_pd(tmp_qloop_0,tmp_qloop_12);
                   const __m256d q_tmp_1_4 = _mm256_mul_pd(tmp_qloop_10,tmp_qloop_12);
                   const __m256d q_tmp_1_5 = _mm256_mul_pd(tmp_qloop_11,tmp_qloop_12);
                   const __m256d q_tmp_2_2 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_9,tmp_qloop_9),_mm256_set_pd(tmp_qloop_6,tmp_qloop_6,tmp_qloop_6,tmp_qloop_6));
                   const __m256d q_tmp_2_3 = _mm256_mul_pd(tmp_qloop_0,tmp_qloop_13);
                   const __m256d q_tmp_2_4 = _mm256_mul_pd(tmp_qloop_10,tmp_qloop_13);
                   const __m256d q_tmp_2_5 = _mm256_mul_pd(tmp_qloop_11,tmp_qloop_13);
                   const __m256d q_tmp_3_3 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_1,tmp_qloop_3),_mm256_set_pd(16.0,16.0,16.0,16.0)),_mm256_set_pd(tmp_qloop_6,tmp_qloop_6,tmp_qloop_6,tmp_qloop_6));
                   const __m256d q_tmp_3_4 = _mm256_mul_pd(tmp_qloop_0,tmp_qloop_14);
                   const __m256d q_tmp_3_5 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_0,tmp_qloop_11),_mm256_set_pd(tmp_qloop_6,tmp_qloop_6,tmp_qloop_6,tmp_qloop_6));
                   const __m256d q_tmp_4_4 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_10,tmp_qloop_10),_mm256_set_pd(tmp_qloop_6,tmp_qloop_6,tmp_qloop_6,tmp_qloop_6));
                   const __m256d q_tmp_4_5 = _mm256_mul_pd(tmp_qloop_11,tmp_qloop_14);
                   const __m256d q_tmp_5_5 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_11,tmp_qloop_11),_mm256_set_pd(tmp_qloop_6,tmp_qloop_6,tmp_qloop_6,tmp_qloop_6));
