                                            ...
                                            public OperatorWithInverseDiagonal< P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     83     119      13       6      2              0                 0              0
   void applyScaled_P1ElementwiseMassBoundaryAnnulusMap_facet_id_0_macro_2D( real_t* RESTRICT _data_dst,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     83     119      13       6      2              0                 0              0
   void applyScaled_P1ElementwiseMassBoundaryAnnulusMap_facet_id_1_macro_2D( real_t* RESTRICT _data_dst,
                                                                             real_t* RESTRICT _data_src,
                                                                             real_t           macro_vertex_coord_id_0comp0,
                                                                             real_t           macro_vertex_coord_id_0comp1,
                                                                             real_t           macro_vertex_coord_id_1comp0,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     83     119      13       6      2              0                 0              0
   void applyScaled_P1ElementwiseMassBoundaryAnnulusMap_facet_id_2_macro_2D( real_t* RESTRICT _data_dst,
                                                                             real_t* RESTRICT _data_src,
                                                                             real_t           macro_vertex_coord_id_0comp0,
                                                                             real_t           macro_vertex_coord_id_0comp1,
                                                                             real_t           macro_vertex_coord_id_1comp0,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     74     111      13       6      2              0                 0              3
   void toMatrixScaled_P1ElementwiseMassBoundaryAnnulusMap_facet_id_0_macro_2D( idx_t* RESTRICT _data_dst,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     74     111      13       6      2              0                 0              3
   void toMatrixScaled_P1ElementwiseMassBoundaryAnnulusMap_facet_id_1_macro_2D( idx_t* RESTRICT _data_dst,
                                                                                idx_t* RESTRICT _data_src,
                                                                                real_t          macro_vertex_coord_id_0comp0,
                                                                                real_t          macro_vertex_coord_id_0comp1,
                                                                                real_t          macro_vertex_coord_id_1comp0,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     74     111      13       6      2              0                 0              3
   void toMatrixScaled_P1ElementwiseMassBoundaryAnnulusMap_facet_id_2_macro_2D( idx_t* RESTRICT _data_dst,
                                                                                idx_t* RESTRICT _data_src,
                                                                                real_t          macro_vertex_coord_id_0comp0,
                                                                                real_t          macro_vertex_coord_id_0comp1,
                                                                                real_t          macro_vertex_coord_id_1comp0,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     76     106      13       6      2              0                 0              0
   void computeInverseDiagonalOperatorValuesScaled_P1ElementwiseMassBoundaryAnnulusMap_facet_id_0_macro_2D(
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     76     106      13       6      2              0                 0              0
   void computeInverseDiagonalOperatorValuesScaled_P1ElementwiseMassBoundaryAnnulusMap_facet_id_1_macro_2D(
       real_t* RESTRICT _data_invDiag_,
       real_t           diagScaling,
       real_t           macro_vertex_coord_id_0comp0,
       real_t           macro_vertex_coord_id_0comp1,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     76     106      13       6      2              0                 0              0
   void computeInverseDiagonalOperatorValuesScaled_P1ElementwiseMassBoundaryAnnulusMap_facet_id_2_macro_2D(
       real_t* RESTRICT _data_invDiag_,
       real_t           diagScaling,
       real_t           macro_vertex_coord_id_0comp0,
       real_t           macro_vertex_coord_id_0comp1,
