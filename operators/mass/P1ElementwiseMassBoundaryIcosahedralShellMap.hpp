...
class P1ElementwiseMassBoundaryIcosahedralShellMap : public Operator< P1Function< real_t >, P1Function< real_t > >,
                                                     public OperatorWithInverseDiagonal< P1Function< real_t > >
{
 public:
   P1ElementwiseMassBoundaryIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                 size_t                                     minLevel,
                                                 size_t                                     maxLevel,
 ...
 private:
   ...
   BoundaryUID                             P1ElementwiseMassBoundaryIcosahedralShellMap_boundary_uid_;
};
