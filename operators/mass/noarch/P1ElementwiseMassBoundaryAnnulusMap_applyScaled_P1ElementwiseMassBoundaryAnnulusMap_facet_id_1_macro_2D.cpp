...
void P1ElementwiseMassBoundaryAnnulusMap::applyScaled_P1ElementwiseMassBoundaryAnnulusMap_facet_id_1_macro_2D( real_t * RESTRICT  _data_dst, real_t * RESTRICT  _data_src, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling, real_t radRayVertex, real_t radRefVertex, real_t rayVertex_0, real_t rayVertex_1, real_t refVertex_0, real_t refVertex_1, real_t thrVertex_0, real_t thrVertex_1 ) const
{
    {
       ...
       const real_t tmp_kernel_op_6 = -0.78867513459481287 + ((real_t)(-tmp_kernel_op_0));
       const int64_t tmp_kernel_op_12 = 0;
       ...
       const int64_t tmp_kernel_op_14 = 0;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < 1; ctr_0 += 1)
          {
             ...
             const real_t src_dof_2 = _data_src[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1];
             const real_t tmp_kernel_op_2 = jac_affine_0_0_GRAY*jac_blending_0_0_q_0 + jac_affine_1_0_GRAY*jac_blending_0_1_q_0;
             const real_t tmp_kernel_op_3 = jac_affine_0_0_GRAY*jac_blending_1_0_q_0 + jac_affine_1_0_GRAY*jac_blending_1_1_q_0;
             const real_t tmp_kernel_op_4 = 0.5*pow(abs(jac_affine_0_0_GRAY*(jac_blending_0_0_q_0*tmp_kernel_op_2 + jac_blending_1_0_q_0*tmp_kernel_op_3) + jac_affine_1_0_GRAY*(jac_blending_0_1_q_0*tmp_kernel_op_2 + jac_blending_1_1_q_0*tmp_kernel_op_3)), 0.5);
             const real_t tmp_kernel_op_5 = tmp_kernel_op_1*tmp_kernel_op_4;
             const real_t tmp_kernel_op_7 = jac_affine_0_0_GRAY*jac_blending_0_0_q_1 + jac_affine_1_0_GRAY*jac_blending_0_1_q_1;
             const real_t tmp_kernel_op_8 = jac_affine_0_0_GRAY*jac_blending_1_0_q_1 + jac_affine_1_0_GRAY*jac_blending_1_1_q_1;
             const real_t tmp_kernel_op_9 = 0.5*pow(abs(jac_affine_0_0_GRAY*(jac_blending_0_0_q_1*tmp_kernel_op_7 + jac_blending_1_0_q_1*tmp_kernel_op_8) + jac_affine_1_0_GRAY*(jac_blending_0_1_q_1*tmp_kernel_op_7 + jac_blending_1_1_q_1*tmp_kernel_op_8)), 0.5);
             const real_t tmp_kernel_op_10 = tmp_kernel_op_6*tmp_kernel_op_9;
             const real_t tmp_kernel_op_11 = tmp_kernel_op_10*0.78867513459481287 + tmp_kernel_op_5*0.21132486540518713;
             const real_t elMatVec_0 = src_dof_0*((tmp_kernel_op_1*tmp_kernel_op_1)*tmp_kernel_op_4 + (tmp_kernel_op_6*tmp_kernel_op_6)*tmp_kernel_op_9) + src_dof_1*tmp_kernel_op_11 + src_dof_2*((real_t)(tmp_kernel_op_12));
             const real_t elMatVec_1 = src_dof_0*tmp_kernel_op_11 + src_dof_1*(tmp_kernel_op_4*0.044658198738520456 + tmp_kernel_op_9*0.62200846792814624) + src_dof_2*((real_t)(tmp_kernel_op_13));
             const real_t elMatVec_2 = src_dof_0*((real_t)(tmp_kernel_op_12)) + src_dof_1*((real_t)(tmp_kernel_op_13)) + src_dof_2*(tmp_kernel_op_4*((real_t)(tmp_kernel_op_14)) + tmp_kernel_op_9*((real_t)(tmp_kernel_op_14)));
             ...
             _data_dst[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1] = elMatVec_2*operatorScaling + _data_dst[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1];
          }
       }
    }
}
