...
{
    {
       ...
       const int64_t tmp_kernel_op_45 = tmp_kernel_op_4*16;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < 1; ctr_0 += 1)
          {
             ...
             const real_t tmp_kernel_op_22 = tmp_kernel_op_18*tmp_kernel_op_19 + tmp_kernel_op_20*tmp_kernel_op_21;
             const real_t tmp_kernel_op_24 = tmp_kernel_op_19*((real_t)(tmp_kernel_op_23)) + tmp_kernel_op_21*((real_t)(tmp_kernel_op_23));
             const real_t tmp_kernel_op_25 = tmp_kernel_op_13*tmp_kernel_op_21 + tmp_kernel_op_19*tmp_kernel_op_3;
             const real_t tmp_kernel_op_29 = tmp_kernel_op_19*tmp_kernel_op_27 + tmp_kernel_op_21*tmp_kernel_op_28;
             const real_t tmp_kernel_op_32 = tmp_kernel_op_19*tmp_kernel_op_30 + tmp_kernel_op_21*tmp_kernel_op_31;
             ...
             const real_t tmp_kernel_op_35 = tmp_kernel_op_33*((real_t)(tmp_kernel_op_23)) + tmp_kernel_op_34*((real_t)(tmp_kernel_op_23));
             const real_t tmp_kernel_op_36 = tmp_kernel_op_13*tmp_kernel_op_34 + tmp_kernel_op_3*tmp_kernel_op_33;
             ...
             const real_t elMat_0_0 = tmp_kernel_op_10*(tmp_kernel_op_7*tmp_kernel_op_7) + (tmp_kernel_op_14*tmp_kernel_op_14)*tmp_kernel_op_17;
             ...
             const real_t elMat_1_1 = tmp_kernel_op_10*(tmp_kernel_op_18*tmp_kernel_op_18) + tmp_kernel_op_17*(tmp_kernel_op_20*tmp_kernel_op_20);
             ...
             const real_t elMat_2_2 = tmp_kernel_op_10*((real_t)(tmp_kernel_op_39)) + tmp_kernel_op_17*((real_t)(tmp_kernel_op_39));
             ...
             const real_t elMat_3_3 = tmp_kernel_op_0*tmp_kernel_op_10*((real_t)(tmp_kernel_op_45)) + tmp_kernel_op_11*tmp_kernel_op_17*((real_t)(tmp_kernel_op_45));
             ...
             const real_t elMat_4_4 = tmp_kernel_op_10*(tmp_kernel_op_27*tmp_kernel_op_27) + tmp_kernel_op_17*(tmp_kernel_op_28*tmp_kernel_op_28);
             ...
             const real_t elMat_5_5 = tmp_kernel_op_10*(tmp_kernel_op_30*tmp_kernel_op_30) + tmp_kernel_op_17*(tmp_kernel_op_31*tmp_kernel_op_31);
