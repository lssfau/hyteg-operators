...
void P1ElementwiseMassBoundary::applyScaled_P1ElementwiseMassBoundary_facet_id_1_macro_2D( real_t * RESTRICT  _data_dst, real_t * RESTRICT  _data_src, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling ) const
{
    {
       ...
       const real_t tmp_kernel_op_6 = tmp_kernel_op_2*0.5;
       const real_t tmp_kernel_op_7 = tmp_kernel_op_5*tmp_kernel_op_6;
       const real_t tmp_kernel_op_8 = tmp_kernel_op_4*0.21132486540518713 + tmp_kernel_op_7*0.78867513459481287;
       ...
       const int64_t tmp_kernel_op_11 = 0;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < 1; ctr_0 += 1)
          {
             ...
             const real_t elMatVec_0 = src_dof_0*((tmp_kernel_op_1*tmp_kernel_op_1)*tmp_kernel_op_3 + (tmp_kernel_op_5*tmp_kernel_op_5)*tmp_kernel_op_6) + src_dof_1*tmp_kernel_op_8 + src_dof_2*((real_t)(tmp_kernel_op_9));
             const real_t elMatVec_1 = src_dof_0*tmp_kernel_op_8 + src_dof_1*(tmp_kernel_op_3*0.044658198738520456 + tmp_kernel_op_6*0.62200846792814624) + src_dof_2*((real_t)(tmp_kernel_op_10));
             const real_t elMatVec_2 = src_dof_0*((real_t)(tmp_kernel_op_9)) + src_dof_1*((real_t)(tmp_kernel_op_10)) + src_dof_2*(tmp_kernel_op_3*((real_t)(tmp_kernel_op_11)) + tmp_kernel_op_6*((real_t)(tmp_kernel_op_11)));
