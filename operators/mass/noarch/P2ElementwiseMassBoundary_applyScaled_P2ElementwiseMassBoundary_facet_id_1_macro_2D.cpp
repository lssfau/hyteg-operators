...
void P2ElementwiseMassBoundary::applyScaled_P2ElementwiseMassBoundary_facet_id_1_macro_2D( real_t * RESTRICT  _data_dstEdge, real_t * RESTRICT  _data_dstVertex, real_t * RESTRICT  _data_srcEdge, real_t * RESTRICT  _data_srcVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling ) const
{
    {
       ...
       const real_t tmp_kernel_op_15 = tmp_kernel_op_7*tmp_kernel_op_9;
       const real_t tmp_kernel_op_16 = tmp_kernel_op_13*tmp_kernel_op_14;
       const real_t tmp_kernel_op_17 = tmp_kernel_op_12*tmp_kernel_op_16 + tmp_kernel_op_15*tmp_kernel_op_3;
       const real_t tmp_kernel_op_18 = tmp_kernel_op_1 - 0.21132486540518713;
       const real_t tmp_kernel_op_19 = tmp_kernel_op_11 - 0.78867513459481287;
       const real_t tmp_kernel_op_20 = tmp_kernel_op_15*tmp_kernel_op_18 + tmp_kernel_op_16*tmp_kernel_op_19;
       const int64_t tmp_kernel_op_21 = tmp_kernel_op_5;
       const real_t tmp_kernel_op_22 = tmp_kernel_op_15*((real_t)(tmp_kernel_op_21)) + tmp_kernel_op_16*((real_t)(tmp_kernel_op_21));
       ...
       const real_t tmp_kernel_op_26 = tmp_kernel_op_15*tmp_kernel_op_24 + tmp_kernel_op_16*tmp_kernel_op_25;
       ...
       const real_t tmp_kernel_op_29 = tmp_kernel_op_15*tmp_kernel_op_27 + tmp_kernel_op_16*tmp_kernel_op_28;
       const real_t tmp_kernel_op_30 = tmp_kernel_op_18*tmp_kernel_op_9;
       const real_t tmp_kernel_op_31 = tmp_kernel_op_14*tmp_kernel_op_19;
       const real_t tmp_kernel_op_32 = tmp_kernel_op_12*tmp_kernel_op_31 + tmp_kernel_op_3*tmp_kernel_op_30;
       const real_t tmp_kernel_op_33 = tmp_kernel_op_30*((real_t)(tmp_kernel_op_21)) + tmp_kernel_op_31*((real_t)(tmp_kernel_op_21));
       ...
       const int64_t tmp_kernel_op_36 = ((int64_t)((tmp_kernel_op_21*tmp_kernel_op_21)));
       const real_t tmp_kernel_op_37 = tmp_kernel_op_9*((real_t)(tmp_kernel_op_21));
       const real_t tmp_kernel_op_38 = tmp_kernel_op_14*((real_t)(tmp_kernel_op_21));
       ...
       const real_t tmp_kernel_op_47 = tmp_kernel_op_27*tmp_kernel_op_43 + tmp_kernel_op_28*tmp_kernel_op_44;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < 1; ctr_0 += 1)
          {
             ...
             const real_t src_dof_2 = _data_srcVertex[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1];
             const real_t src_dof_3 = _data_srcEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + ((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))];
             const real_t src_dof_4 = _data_srcEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2))];
             const real_t src_dof_5 = _data_srcEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + 2*((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))];
             const real_t elMatVec_0 = src_dof_0*((tmp_kernel_op_13*tmp_kernel_op_13)*tmp_kernel_op_14 + (tmp_kernel_op_7*tmp_kernel_op_7)*tmp_kernel_op_9) + src_dof_1*tmp_kernel_op_20 + src_dof_2*tmp_kernel_op_22 + src_dof_3*tmp_kernel_op_17 + src_dof_4*tmp_kernel_op_26 + src_dof_5*tmp_kernel_op_29;
             const real_t elMatVec_1 = src_dof_0*tmp_kernel_op_20 + src_dof_1*(tmp_kernel_op_14*(tmp_kernel_op_19*tmp_kernel_op_19) + (tmp_kernel_op_18*tmp_kernel_op_18)*tmp_kernel_op_9) + src_dof_2*tmp_kernel_op_33 + src_dof_3*tmp_kernel_op_32 + src_dof_4*tmp_kernel_op_34 + src_dof_5*tmp_kernel_op_35;
             const real_t elMatVec_2 = src_dof_0*tmp_kernel_op_22 + src_dof_1*tmp_kernel_op_33 + src_dof_2*(tmp_kernel_op_14*((real_t)(tmp_kernel_op_36)) + tmp_kernel_op_9*((real_t)(tmp_kernel_op_36))) + src_dof_3*tmp_kernel_op_39 + src_dof_4*tmp_kernel_op_40 + src_dof_5*tmp_kernel_op_41;
             const real_t elMatVec_3 = src_dof_0*tmp_kernel_op_17 + src_dof_1*tmp_kernel_op_32 + src_dof_2*tmp_kernel_op_39 + src_dof_3*(tmp_kernel_op_0*tmp_kernel_op_9*((real_t)(tmp_kernel_op_42)) + tmp_kernel_op_10*tmp_kernel_op_14*((real_t)(tmp_kernel_op_42))) + src_dof_4*tmp_kernel_op_45 + src_dof_5*tmp_kernel_op_46;
             const real_t elMatVec_4 = src_dof_0*tmp_kernel_op_26 + src_dof_1*tmp_kernel_op_34 + src_dof_2*tmp_kernel_op_40 + src_dof_3*tmp_kernel_op_45 + src_dof_4*(tmp_kernel_op_14*(tmp_kernel_op_25*tmp_kernel_op_25) + (tmp_kernel_op_24*tmp_kernel_op_24)*tmp_kernel_op_9) + src_dof_5*tmp_kernel_op_47;
             const real_t elMatVec_5 = src_dof_0*tmp_kernel_op_29 + src_dof_1*tmp_kernel_op_35 + src_dof_2*tmp_kernel_op_41 + src_dof_3*tmp_kernel_op_46 + src_dof_4*tmp_kernel_op_47 + src_dof_5*(tmp_kernel_op_14*(tmp_kernel_op_28*tmp_kernel_op_28) + (tmp_kernel_op_27*tmp_kernel_op_27)*tmp_kernel_op_9);
             ...
             _data_dstVertex[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1] = elMatVec_2*operatorScaling + _data_dstVertex[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1];
             ...
             _data_dstEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2))] = elMatVec_4*operatorScaling + _data_dstEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2))];
             _data_dstEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + 2*((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))] = elMatVec_5*operatorScaling + _data_dstEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + 2*((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))];
          }
       }
    }
}
