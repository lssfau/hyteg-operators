       ...
       const real_t p_affine_const_3_2_WHITE_UP = macro_vertex_coord_id_0comp2 + tmp_coords_jac_0_WHITE_UP*(-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_3comp2);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 11; q += 1)
             {
                ...
                const real_t tmp_qloop_42 = tmp_qloop_1*2.0;
                const real_t tmp_qloop_43 = tmp_qloop_42 - _data_q_p_0[q];
                const real_t tmp_qloop_44 = tmp_qloop_2*2.0;
                const real_t tmp_qloop_45 = tmp_qloop_3*2.0;
                const real_t tmp_qloop_46 = tmp_qloop_0*4.0;
                const real_t tmp_qloop_47 = tmp_qloop_4*4.0;
                const real_t tmp_qloop_48 = tmp_qloop_5*4.0;
                const real_t tmp_qloop_49 = tmp_qloop_47 + tmp_qloop_48;
                const real_t tmp_qloop_50 = tmp_qloop_40*(tmp_qloop_42 + tmp_qloop_44 + tmp_qloop_45 + tmp_qloop_46 + tmp_qloop_49 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] - 3.0*_data_q_p_2[q] + 1.0);
                const real_t tmp_qloop_51 = tmp_qloop_44 - _data_q_p_1[q];
                const real_t tmp_qloop_52 = tmp_qloop_45 - _data_q_p_2[q];
                const real_t tmp_qloop_53 = tmp_qloop_3*-4.0 - tmp_qloop_49 + 4.0*_data_q_p_2[q];
                const real_t tmp_qloop_54 = tmp_qloop_2*-4.0 - tmp_qloop_46 - tmp_qloop_48 + 4.0*_data_q_p_1[q];
                const real_t tmp_qloop_55 = tmp_qloop_1*-4.0 - tmp_qloop_46 - tmp_qloop_47 + 4.0*_data_q_p_0[q];
                const real_t tmp_qloop_56 = tmp_qloop_40*4.0;
                const real_t tmp_qloop_57 = tmp_qloop_40*tmp_qloop_43;
                const real_t tmp_qloop_58 = tmp_qloop_40*tmp_qloop_51;
                const real_t tmp_qloop_59 = tmp_qloop_40*tmp_qloop_52;
                const real_t tmp_qloop_60 = tmp_qloop_3*tmp_qloop_41;
                const real_t tmp_qloop_61 = tmp_qloop_2*tmp_qloop_41;
                const real_t tmp_qloop_62 = tmp_qloop_40*tmp_qloop_53;
                const real_t tmp_qloop_63 = tmp_qloop_40*tmp_qloop_54;
                const real_t tmp_qloop_64 = tmp_qloop_40*tmp_qloop_55;
                ...
                const real_t q_tmp_0_1 = tmp_qloop_43*tmp_qloop_50;
                const real_t q_tmp_0_2 = tmp_qloop_50*tmp_qloop_51;
                const real_t q_tmp_0_3 = tmp_qloop_50*tmp_qloop_52;
                const real_t q_tmp_0_4 = tmp_qloop_48*tmp_qloop_50;
                const real_t q_tmp_0_5 = tmp_qloop_47*tmp_qloop_50;
                const real_t q_tmp_0_6 = tmp_qloop_46*tmp_qloop_50;
                const real_t q_tmp_0_7 = tmp_qloop_50*tmp_qloop_53;
                const real_t q_tmp_0_8 = tmp_qloop_50*tmp_qloop_54;
                const real_t q_tmp_0_9 = tmp_qloop_50*tmp_qloop_55;
                const real_t q_tmp_1_1 = tmp_qloop_56*((tmp_qloop_1 - 0.5*_data_q_p_0[q])*(tmp_qloop_1 - 0.5*_data_q_p_0[q]));
                const real_t q_tmp_1_2 = tmp_qloop_51*tmp_qloop_57;
                const real_t q_tmp_1_3 = tmp_qloop_52*tmp_qloop_57;
                const real_t q_tmp_1_4 = tmp_qloop_48*tmp_qloop_57;
                const real_t q_tmp_1_5 = tmp_qloop_47*tmp_qloop_57;
                const real_t q_tmp_1_6 = tmp_qloop_46*tmp_qloop_57;
                const real_t q_tmp_1_7 = tmp_qloop_53*tmp_qloop_57;
                const real_t q_tmp_1_8 = tmp_qloop_54*tmp_qloop_57;
                const real_t q_tmp_1_9 = tmp_qloop_55*tmp_qloop_57;
                const real_t q_tmp_2_2 = tmp_qloop_56*((tmp_qloop_2 - 0.5*_data_q_p_1[q])*(tmp_qloop_2 - 0.5*_data_q_p_1[q]));
                const real_t q_tmp_2_3 = tmp_qloop_52*tmp_qloop_58;
                const real_t q_tmp_2_4 = tmp_qloop_48*tmp_qloop_58;
                const real_t q_tmp_2_5 = tmp_qloop_47*tmp_qloop_58;
                const real_t q_tmp_2_6 = tmp_qloop_46*tmp_qloop_58;
                const real_t q_tmp_2_7 = tmp_qloop_53*tmp_qloop_58;
                const real_t q_tmp_2_8 = tmp_qloop_54*tmp_qloop_58;
                const real_t q_tmp_2_9 = tmp_qloop_55*tmp_qloop_58;
                const real_t q_tmp_3_3 = tmp_qloop_56*((tmp_qloop_3 - 0.5*_data_q_p_2[q])*(tmp_qloop_3 - 0.5*_data_q_p_2[q]));
                const real_t q_tmp_3_4 = tmp_qloop_48*tmp_qloop_59;
                const real_t q_tmp_3_5 = tmp_qloop_47*tmp_qloop_59;
                const real_t q_tmp_3_6 = tmp_qloop_46*tmp_qloop_59;
                const real_t q_tmp_3_7 = tmp_qloop_53*tmp_qloop_59;
                const real_t q_tmp_3_8 = tmp_qloop_54*tmp_qloop_59;
                const real_t q_tmp_3_9 = tmp_qloop_55*tmp_qloop_59;
                const real_t q_tmp_4_4 = tmp_qloop_2*tmp_qloop_60;
                const real_t q_tmp_4_5 = tmp_qloop_0*tmp_qloop_60;
                const real_t q_tmp_4_6 = tmp_qloop_4*tmp_qloop_61;
                const real_t q_tmp_4_7 = tmp_qloop_48*tmp_qloop_62;
                const real_t q_tmp_4_8 = tmp_qloop_48*tmp_qloop_63;
                const real_t q_tmp_4_9 = tmp_qloop_48*tmp_qloop_64;
                const real_t q_tmp_5_5 = tmp_qloop_1*tmp_qloop_60;
                const real_t q_tmp_5_6 = tmp_qloop_1*tmp_qloop_41*tmp_qloop_5;
                const real_t q_tmp_5_7 = tmp_qloop_47*tmp_qloop_62;
                const real_t q_tmp_5_8 = tmp_qloop_47*tmp_qloop_63;
                const real_t q_tmp_5_9 = tmp_qloop_47*tmp_qloop_64;
                const real_t q_tmp_6_6 = tmp_qloop_1*tmp_qloop_61;
                const real_t q_tmp_6_7 = tmp_qloop_46*tmp_qloop_62;
                const real_t q_tmp_6_8 = tmp_qloop_46*tmp_qloop_63;
                const real_t q_tmp_6_9 = tmp_qloop_46*tmp_qloop_64;
                const real_t q_tmp_7_7 = tmp_qloop_41*((-tmp_qloop_3 - tmp_qloop_6 + _data_q_p_2[q])*(-tmp_qloop_3 - tmp_qloop_6 + _data_q_p_2[q]));
                const real_t q_tmp_7_8 = tmp_qloop_54*tmp_qloop_62;
                const real_t q_tmp_7_9 = tmp_qloop_55*tmp_qloop_62;
                ...
                const real_t q_tmp_8_9 = tmp_qloop_55*tmp_qloop_63;
