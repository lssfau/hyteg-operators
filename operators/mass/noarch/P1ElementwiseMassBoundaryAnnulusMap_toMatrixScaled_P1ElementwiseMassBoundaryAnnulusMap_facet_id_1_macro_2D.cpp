...
void P1ElementwiseMassBoundaryAnnulusMap::toMatrixScaled_P1ElementwiseMassBoundaryAnnulusMap_facet_id_1_macro_2D( idx_t * RESTRICT  _data_dst, idx_t * RESTRICT  _data_src, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t radRayVertex, real_t radRefVertex, real_t rayVertex_0, real_t rayVertex_1, real_t refVertex_0, real_t refVertex_1, real_t thrVertex_0, real_t thrVertex_1, real_t toMatrixScaling ) const
{
    {
       ...
       const real_t tmp_kernel_op_5 = -0.78867513459481287 + ((real_t)(-tmp_kernel_op_0));
       const int64_t tmp_kernel_op_12 = 0;
       const int64_t tmp_kernel_op_13 = 0;
       const int64_t tmp_kernel_op_14 = 0;
       const int64_t elMat_0_2 = tmp_kernel_op_12;
       const int64_t elMat_1_2 = tmp_kernel_op_13;
       const int64_t elMat_2_0 = tmp_kernel_op_12;
       const int64_t elMat_2_1 = tmp_kernel_op_13;
       {
          /* FaceType.GRAY */
          ...
          for (int64_t ctr_0 = 0; ctr_0 < 1; ctr_0 += 1)
          {
             ...
             const real_t tmp_kernel_op_6 = jac_affine_0_0_GRAY*jac_blending_0_0_q_1 + jac_affine_1_0_GRAY*jac_blending_0_1_q_1;
             const real_t tmp_kernel_op_7 = jac_affine_0_0_GRAY*jac_blending_1_0_q_1 + jac_affine_1_0_GRAY*jac_blending_1_1_q_1;
             const real_t tmp_kernel_op_8 = 0.5*pow(abs(jac_affine_0_0_GRAY*(jac_blending_0_0_q_1*tmp_kernel_op_6 + jac_blending_1_0_q_1*tmp_kernel_op_7) + jac_affine_1_0_GRAY*(jac_blending_0_1_q_1*tmp_kernel_op_6 + jac_blending_1_1_q_1*tmp_kernel_op_7)), 0.5);
             const real_t tmp_kernel_op_9 = tmp_kernel_op_1*tmp_kernel_op_4;
             const real_t tmp_kernel_op_10 = tmp_kernel_op_5*tmp_kernel_op_8;
             const real_t tmp_kernel_op_11 = toMatrixScaling*(tmp_kernel_op_10*0.78867513459481287 + tmp_kernel_op_9*0.21132486540518713);
             const real_t elMat_0_0 = toMatrixScaling*((tmp_kernel_op_1*tmp_kernel_op_1)*tmp_kernel_op_4 + (tmp_kernel_op_5*tmp_kernel_op_5)*tmp_kernel_op_8);
             const real_t elMat_0_1 = tmp_kernel_op_11;
             const real_t elMat_1_0 = tmp_kernel_op_11;
             const real_t elMat_1_1 = toMatrixScaling*(tmp_kernel_op_4*0.044658198738520456 + tmp_kernel_op_8*0.62200846792814624);
             const real_t elMat_2_2 = toMatrixScaling*(tmp_kernel_op_4*((real_t)(tmp_kernel_op_14)) + tmp_kernel_op_8*((real_t)(tmp_kernel_op_14)));
             ...
             _data_rowIdx[2] = ((uint64_t)(_data_dst[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1]));
             ...
             _data_colIdx[2] = ((uint64_t)(_data_src[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1]));
