...
{
    {
       ...
       const real_t tmp_kernel_op_18 = tmp_kernel_op_1 - 0.21132486540518713;
       const real_t tmp_kernel_op_20 = tmp_kernel_op_12 - 0.78867513459481287;
       const int64_t tmp_kernel_op_23 = tmp_kernel_op_5;
       ...
       const int64_t tmp_kernel_op_39 = ((int64_t)((tmp_kernel_op_23*tmp_kernel_op_23)));
       const int64_t tmp_kernel_op_45 = tmp_kernel_op_4*16;
       {
          ...
          for (int64_t ctr_0 = -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             const real_t tmp_kernel_op_19 = tmp_kernel_op_10*tmp_kernel_op_7;
             const real_t tmp_kernel_op_21 = tmp_kernel_op_14*tmp_kernel_op_17;
             const real_t tmp_kernel_op_22 = toMatrixScaling*(tmp_kernel_op_18*tmp_kernel_op_19 + tmp_kernel_op_20*tmp_kernel_op_21);
             const real_t tmp_kernel_op_24 = toMatrixScaling*(tmp_kernel_op_19*((real_t)(tmp_kernel_op_23)) + tmp_kernel_op_21*((real_t)(tmp_kernel_op_23)));
             const real_t tmp_kernel_op_25 = toMatrixScaling*(tmp_kernel_op_13*tmp_kernel_op_21 + tmp_kernel_op_19*tmp_kernel_op_3);
             const real_t tmp_kernel_op_29 = toMatrixScaling*(tmp_kernel_op_19*tmp_kernel_op_27 + tmp_kernel_op_21*tmp_kernel_op_28);
             const real_t tmp_kernel_op_32 = toMatrixScaling*(tmp_kernel_op_19*tmp_kernel_op_30 + tmp_kernel_op_21*tmp_kernel_op_31);
             const real_t tmp_kernel_op_33 = tmp_kernel_op_10*tmp_kernel_op_18;
             const real_t tmp_kernel_op_34 = tmp_kernel_op_17*tmp_kernel_op_20;
             const real_t tmp_kernel_op_35 = toMatrixScaling*(tmp_kernel_op_33*((real_t)(tmp_kernel_op_23)) + tmp_kernel_op_34*((real_t)(tmp_kernel_op_23)));
             const real_t tmp_kernel_op_36 = toMatrixScaling*(tmp_kernel_op_13*tmp_kernel_op_34 + tmp_kernel_op_3*tmp_kernel_op_33);
             const real_t tmp_kernel_op_37 = toMatrixScaling*(tmp_kernel_op_27*tmp_kernel_op_33 + tmp_kernel_op_28*tmp_kernel_op_34);
             const real_t tmp_kernel_op_38 = toMatrixScaling*(tmp_kernel_op_30*tmp_kernel_op_33 + tmp_kernel_op_31*tmp_kernel_op_34);
             const real_t tmp_kernel_op_40 = tmp_kernel_op_10*((real_t)(tmp_kernel_op_23));
             const real_t tmp_kernel_op_41 = tmp_kernel_op_17*((real_t)(tmp_kernel_op_23));
             const real_t tmp_kernel_op_42 = toMatrixScaling*(tmp_kernel_op_13*tmp_kernel_op_41 + tmp_kernel_op_3*tmp_kernel_op_40);
             const real_t tmp_kernel_op_43 = toMatrixScaling*(tmp_kernel_op_27*tmp_kernel_op_40 + tmp_kernel_op_28*tmp_kernel_op_41);
             const real_t tmp_kernel_op_44 = toMatrixScaling*(tmp_kernel_op_30*tmp_kernel_op_40 + tmp_kernel_op_31*tmp_kernel_op_41);
             ...
             const real_t tmp_kernel_op_48 = toMatrixScaling*(tmp_kernel_op_13*tmp_kernel_op_47 + tmp_kernel_op_3*tmp_kernel_op_46);
             const real_t tmp_kernel_op_49 = toMatrixScaling*(tmp_kernel_op_10*tmp_kernel_op_3*tmp_kernel_op_30 + tmp_kernel_op_13*tmp_kernel_op_17*tmp_kernel_op_31);
             const real_t tmp_kernel_op_50 = toMatrixScaling*(tmp_kernel_op_30*tmp_kernel_op_46 + tmp_kernel_op_31*tmp_kernel_op_47);
             const real_t elMat_0_0 = toMatrixScaling*(tmp_kernel_op_10*(tmp_kernel_op_7*tmp_kernel_op_7) + (tmp_kernel_op_14*tmp_kernel_op_14)*tmp_kernel_op_17);
             const real_t elMat_0_1 = tmp_kernel_op_22;
             const real_t elMat_0_2 = tmp_kernel_op_24;
             const real_t elMat_0_3 = tmp_kernel_op_25;
             const real_t elMat_0_4 = tmp_kernel_op_29;
             const real_t elMat_0_5 = tmp_kernel_op_32;
             const real_t elMat_1_0 = tmp_kernel_op_22;
             const real_t elMat_1_1 = toMatrixScaling*(tmp_kernel_op_10*(tmp_kernel_op_18*tmp_kernel_op_18) + tmp_kernel_op_17*(tmp_kernel_op_20*tmp_kernel_op_20));
             const real_t elMat_1_2 = tmp_kernel_op_35;
             const real_t elMat_1_3 = tmp_kernel_op_36;
             const real_t elMat_1_4 = tmp_kernel_op_37;
             const real_t elMat_1_5 = tmp_kernel_op_38;
             const real_t elMat_2_0 = tmp_kernel_op_24;
             const real_t elMat_2_1 = tmp_kernel_op_35;
             const real_t elMat_2_2 = toMatrixScaling*(tmp_kernel_op_10*((real_t)(tmp_kernel_op_39)) + tmp_kernel_op_17*((real_t)(tmp_kernel_op_39)));
             const real_t elMat_2_3 = tmp_kernel_op_42;
             const real_t elMat_2_4 = tmp_kernel_op_43;
             const real_t elMat_2_5 = tmp_kernel_op_44;
             const real_t elMat_3_0 = tmp_kernel_op_25;
             const real_t elMat_3_1 = tmp_kernel_op_36;
             const real_t elMat_3_2 = tmp_kernel_op_42;
             const real_t elMat_3_3 = toMatrixScaling*(tmp_kernel_op_0*tmp_kernel_op_10*((real_t)(tmp_kernel_op_45)) + tmp_kernel_op_11*tmp_kernel_op_17*((real_t)(tmp_kernel_op_45)));
             const real_t elMat_3_4 = tmp_kernel_op_48;
             const real_t elMat_3_5 = tmp_kernel_op_49;
             const real_t elMat_4_0 = tmp_kernel_op_29;
             const real_t elMat_4_1 = tmp_kernel_op_37;
             const real_t elMat_4_2 = tmp_kernel_op_43;
             const real_t elMat_4_3 = tmp_kernel_op_48;
             const real_t elMat_4_4 = toMatrixScaling*(tmp_kernel_op_10*(tmp_kernel_op_27*tmp_kernel_op_27) + tmp_kernel_op_17*(tmp_kernel_op_28*tmp_kernel_op_28));
             const real_t elMat_4_5 = tmp_kernel_op_50;
             const real_t elMat_5_0 = tmp_kernel_op_32;
             const real_t elMat_5_1 = tmp_kernel_op_38;
             const real_t elMat_5_2 = tmp_kernel_op_44;
             const real_t elMat_5_3 = tmp_kernel_op_49;
             const real_t elMat_5_4 = tmp_kernel_op_50;
             const real_t elMat_5_5 = toMatrixScaling*(tmp_kernel_op_10*(tmp_kernel_op_30*tmp_kernel_op_30) + tmp_kernel_op_17*(tmp_kernel_op_31*tmp_kernel_op_31));
             ...
             _data_rowIdx[2] = ((uint64_t)(_data_dstVertex[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2))]));
             _data_rowIdx[3] = ((uint64_t)(_data_dstEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + 2*((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))]));
             _data_rowIdx[4] = ((uint64_t)(_data_dstEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2))]));
             ...
             _data_colIdx[2] = ((uint64_t)(_data_srcVertex[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2))]));
             _data_colIdx[3] = ((uint64_t)(_data_srcEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + 2*((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))]));
             _data_colIdx[4] = ((uint64_t)(_data_srcEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2))]));
