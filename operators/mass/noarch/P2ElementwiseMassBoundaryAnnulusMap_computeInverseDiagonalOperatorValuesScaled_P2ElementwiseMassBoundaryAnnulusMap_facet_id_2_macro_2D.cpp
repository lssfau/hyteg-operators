...
void P2ElementwiseMassBoundaryAnnulusMap::computeInverseDiagonalOperatorValuesScaled_P2ElementwiseMassBoundaryAnnulusMap_facet_id_2_macro_2D( real_t * RESTRICT  _data_invDiag_Edge, real_t * RESTRICT  _data_invDiag_Vertex, real_t diagScaling, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t radRayVertex, real_t radRefVertex, real_t rayVertex_0, real_t rayVertex_1, real_t refVertex_0, real_t refVertex_1, real_t thrVertex_0, real_t thrVertex_1 ) const
{
    {
       ...
       const int64_t tmp_kernel_op_16 = ((int64_t)((tmp_kernel_op_5*tmp_kernel_op_5)));
       const int64_t tmp_kernel_op_17 = tmp_kernel_op_4*16;
       const int64_t tmp_kernel_op_18 = tmp_kernel_op_4*4;
       {
          /* FaceType.GRAY */
          ...
          for (int64_t ctr_0 = -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             const real_t tmp_kernel_op_7 = jac_affine_0_0_GRAY*jac_blending_0_0_q_0 + jac_affine_1_0_GRAY*jac_blending_0_1_q_0;
             const real_t tmp_kernel_op_8 = jac_affine_0_0_GRAY*jac_blending_1_0_q_0 + jac_affine_1_0_GRAY*jac_blending_1_1_q_0;
             const real_t tmp_kernel_op_9 = 0.5*pow(abs(jac_affine_0_0_GRAY*(jac_blending_0_0_q_0*tmp_kernel_op_7 + jac_blending_1_0_q_0*tmp_kernel_op_8) + jac_affine_1_0_GRAY*(jac_blending_0_1_q_0*tmp_kernel_op_7 + jac_blending_1_1_q_0*tmp_kernel_op_8)), 0.5);
             const real_t tmp_kernel_op_13 = jac_affine_0_0_GRAY*jac_blending_0_0_q_1 + jac_affine_1_0_GRAY*jac_blending_0_1_q_1;
             const real_t tmp_kernel_op_14 = jac_affine_0_0_GRAY*jac_blending_1_0_q_1 + jac_affine_1_0_GRAY*jac_blending_1_1_q_1;
             const real_t tmp_kernel_op_15 = 0.5*pow(abs(jac_affine_0_0_GRAY*(jac_blending_0_0_q_1*tmp_kernel_op_13 + jac_blending_1_0_q_1*tmp_kernel_op_14) + jac_affine_1_0_GRAY*(jac_blending_0_1_q_1*tmp_kernel_op_13 + jac_blending_1_1_q_1*tmp_kernel_op_14)), 0.5);
             const real_t elMatDiag_0 = tmp_kernel_op_15*((tmp_kernel_op_11*0.42264973081037427 + tmp_kernel_op_12*0.42264973081037427 - 1.0 + 0.42264973081037427*((real_t)(tmp_kernel_op_6)))*(tmp_kernel_op_11*0.42264973081037427 + tmp_kernel_op_12*0.42264973081037427 - 1.0 + 0.42264973081037427*((real_t)(tmp_kernel_op_6))))*5.5980762113533142 + tmp_kernel_op_9*((tmp_kernel_op_1 + tmp_kernel_op_3 - 0.6339745962155614 + ((real_t)(tmp_kernel_op_6)))*(tmp_kernel_op_1 + tmp_kernel_op_3 - 0.6339745962155614 + ((real_t)(tmp_kernel_op_6))));
             const real_t elMatDiag_1 = tmp_kernel_op_15*((tmp_kernel_op_11 - 0.78867513459481287)*(tmp_kernel_op_11 - 0.78867513459481287)) + tmp_kernel_op_9*((tmp_kernel_op_1 - 0.21132486540518713)*(tmp_kernel_op_1 - 0.21132486540518713));
             const real_t elMatDiag_2 = tmp_kernel_op_15*((real_t)(tmp_kernel_op_16)) + tmp_kernel_op_9*((real_t)(tmp_kernel_op_16));
             const real_t elMatDiag_3 = tmp_kernel_op_0*tmp_kernel_op_9*((real_t)(tmp_kernel_op_17)) + tmp_kernel_op_10*tmp_kernel_op_15*((real_t)(tmp_kernel_op_17));
             const real_t elMatDiag_4 = tmp_kernel_op_15*((-tmp_kernel_op_12 + ((real_t)(-tmp_kernel_op_18)))*(-tmp_kernel_op_12 + ((real_t)(-tmp_kernel_op_18)))) + tmp_kernel_op_9*((-tmp_kernel_op_3 + ((real_t)(-tmp_kernel_op_18)))*(-tmp_kernel_op_3 + ((real_t)(-tmp_kernel_op_18))));
             const real_t elMatDiag_5 = tmp_kernel_op_15*((-tmp_kernel_op_10 + tmp_kernel_op_12*-0.25000000000000000 + 0.78867513459481287)*(-tmp_kernel_op_10 + tmp_kernel_op_12*-0.25000000000000000 + 0.78867513459481287))*16.0 + tmp_kernel_op_9*((-tmp_kernel_op_0 + tmp_kernel_op_3*-0.25000000000000000 + 0.21132486540518713)*(-tmp_kernel_op_0 + tmp_kernel_op_3*-0.25000000000000000 + 0.21132486540518713))*16.0;
             ...
             _data_invDiag_Vertex[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2))] = diagScaling*elMatDiag_2 + _data_invDiag_Vertex[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2))];
             _data_invDiag_Edge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + 2*((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))] = diagScaling*elMatDiag_3 + _data_invDiag_Edge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + 2*((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))];
