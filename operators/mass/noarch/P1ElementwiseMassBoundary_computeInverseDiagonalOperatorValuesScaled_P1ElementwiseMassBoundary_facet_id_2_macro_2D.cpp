...
{
    {
       ...
       const real_t elMatDiag_2 = tmp_kernel_op_2*((real_t)(tmp_kernel_op_4)) + tmp_kernel_op_3*((real_t)(tmp_kernel_op_4));
       {
          ...
          for (int64_t ctr_0 = -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             _data_invDiag_[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2))] = diagScaling*elMatDiag_2 + _data_invDiag_[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2))];
          }
       }
    }
}
