...
{
    {
       ...
       const real_t jac_affine_2_1_BLUE_DOWN = -p_affine_const_0_2_BLUE_DOWN + p_affine_const_2_2_BLUE_DOWN;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < 1; ctr_0 += 1)
          {
             ...
             const real_t tmp_kernel_op_18 = jac_blending_0_1_q_0*tmp_kernel_op_14 + jac_blending_1_1_q_0*tmp_kernel_op_15 + jac_blending_2_1_q_0*tmp_kernel_op_16;
             const real_t tmp_kernel_op_19 = jac_blending_0_2_q_0*tmp_kernel_op_14 + jac_blending_1_2_q_0*tmp_kernel_op_15 + jac_blending_2_2_q_0*tmp_kernel_op_16;
             const real_t tmp_kernel_op_20 = -0.28125*pow(abs((jac_affine_0_0_BLUE_DOWN*tmp_kernel_op_11 + jac_affine_1_0_BLUE_DOWN*tmp_kernel_op_12 + jac_affine_2_0_BLUE_DOWN*tmp_kernel_op_13)*(jac_affine_0_1_BLUE_DOWN*tmp_kernel_op_17 + jac_affine_1_1_BLUE_DOWN*tmp_kernel_op_18 + jac_affine_2_1_BLUE_DOWN*tmp_kernel_op_19) - (jac_affine_0_0_BLUE_DOWN*tmp_kernel_op_17 + jac_affine_1_0_BLUE_DOWN*tmp_kernel_op_18 + jac_affine_2_0_BLUE_DOWN*tmp_kernel_op_19)*(jac_affine_0_1_BLUE_DOWN*tmp_kernel_op_11 + jac_affine_1_1_BLUE_DOWN*tmp_kernel_op_12 + jac_affine_2_1_BLUE_DOWN*tmp_kernel_op_13)), 0.5);
             const real_t tmp_kernel_op_21 = tmp_kernel_op_20*16.0;
             ...
             const real_t tmp_kernel_op_58 = jac_blending_0_1_q_2*tmp_kernel_op_54 + jac_blending_1_1_q_2*tmp_kernel_op_55 + jac_blending_2_1_q_2*tmp_kernel_op_56;
             const real_t tmp_kernel_op_59 = jac_blending_0_2_q_2*tmp_kernel_op_54 + jac_blending_1_2_q_2*tmp_kernel_op_55 + jac_blending_2_2_q_2*tmp_kernel_op_56;
             const real_t tmp_kernel_op_60 = 0.26041666666666669*pow(abs((jac_affine_0_0_BLUE_DOWN*tmp_kernel_op_51 + jac_affine_1_0_BLUE_DOWN*tmp_kernel_op_52 + jac_affine_2_0_BLUE_DOWN*tmp_kernel_op_53)*(jac_affine_0_1_BLUE_DOWN*tmp_kernel_op_57 + jac_affine_1_1_BLUE_DOWN*tmp_kernel_op_58 + jac_affine_2_1_BLUE_DOWN*tmp_kernel_op_59) - (jac_affine_0_0_BLUE_DOWN*tmp_kernel_op_57 + jac_affine_1_0_BLUE_DOWN*tmp_kernel_op_58 + jac_affine_2_0_BLUE_DOWN*tmp_kernel_op_59)*(jac_affine_0_1_BLUE_DOWN*tmp_kernel_op_51 + jac_affine_1_1_BLUE_DOWN*tmp_kernel_op_52 + jac_affine_2_1_BLUE_DOWN*tmp_kernel_op_53)), 0.5);
             const real_t tmp_kernel_op_61 = tmp_kernel_op_60*16.0;
