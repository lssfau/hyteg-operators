...
{
    {
       ...
       const real_t tmp_kernel_op_1 = pow(abs((jac_affine_0_0_GRAY*jac_affine_0_0_GRAY) + (jac_affine_1_0_GRAY*jac_affine_1_0_GRAY)), 0.5);
       const real_t tmp_kernel_op_2 = tmp_kernel_op_1*0.5;
       const real_t tmp_kernel_op_3 = tmp_kernel_op_1*0.5;
       const int64_t tmp_kernel_op_4 = 0;
       const real_t elMatDiag_0 = tmp_kernel_op_2*((-0.21132486540518713 + ((real_t)(-tmp_kernel_op_0)))*(-0.21132486540518713 + ((real_t)(-tmp_kernel_op_0)))) + tmp_kernel_op_3*((-0.78867513459481287 + ((real_t)(-tmp_kernel_op_0)))*(-0.78867513459481287 + ((real_t)(-tmp_kernel_op_0))));
       const real_t elMatDiag_1 = tmp_kernel_op_2*0.044658198738520456 + tmp_kernel_op_3*0.62200846792814624;
       const real_t elMatDiag_2 = tmp_kernel_op_2*((real_t)(tmp_kernel_op_4)) + tmp_kernel_op_3*((real_t)(tmp_kernel_op_4));
       {
          /* FaceType.GRAY */
