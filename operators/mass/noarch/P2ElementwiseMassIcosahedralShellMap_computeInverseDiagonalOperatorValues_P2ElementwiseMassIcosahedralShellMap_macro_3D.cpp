       ...
       const real_t tmp_qloop_112 = 1.0 / (tmp_qloop_16*tmp_qloop_16*tmp_qloop_16);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 11; q += 1)
             {
                ...
                const real_t tmp_qloop_117 = tmp_qloop_115*4.0;
                const real_t tmp_qloop_118 = tmp_qloop_107*tmp_qloop_116;
                ...
                const real_t q_tmp_1_1 = tmp_qloop_117*((tmp_qloop_105 - 0.5*_data_q_p_0[q])*(tmp_qloop_105 - 0.5*_data_q_p_0[q]));
                const real_t q_tmp_2_2 = tmp_qloop_117*((tmp_qloop_106 - 0.5*_data_q_p_1[q])*(tmp_qloop_106 - 0.5*_data_q_p_1[q]));
                const real_t q_tmp_3_3 = tmp_qloop_117*((tmp_qloop_107 - 0.5*_data_q_p_2[q])*(tmp_qloop_107 - 0.5*_data_q_p_2[q]));
                const real_t q_tmp_4_4 = tmp_qloop_106*tmp_qloop_118;
                const real_t q_tmp_5_5 = tmp_qloop_105*tmp_qloop_118;
                const real_t q_tmp_6_6 = tmp_qloop_105*tmp_qloop_106*tmp_qloop_116;
