...
void P1ElementwiseMassBoundary::applyScaled_P1ElementwiseMassBoundary_facet_id_2_macro_3D( real_t * RESTRICT  _data_dst, real_t * RESTRICT  _data_src, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_0comp2, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_1comp2, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, real_t macro_vertex_coord_id_2comp2, real_t macro_vertex_coord_id_3comp0, real_t macro_vertex_coord_id_3comp1, real_t macro_vertex_coord_id_3comp2, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling ) const
{
    {
       ...
       const real_t tmp_kernel_op_5 = -0.83333333333333326 + ((real_t)(-tmp_kernel_op_0));
       const real_t tmp_kernel_op_6 = tmp_kernel_op_2*0.16666666666666666;
       const real_t tmp_kernel_op_7 = tmp_kernel_op_5*tmp_kernel_op_6;
       const real_t tmp_kernel_op_8 = -0.33333333333333331 + ((real_t)(-tmp_kernel_op_0));
       const real_t tmp_kernel_op_9 = tmp_kernel_op_2*0.16666666666666666;
       const real_t tmp_kernel_op_10 = tmp_kernel_op_8*tmp_kernel_op_9;
       const real_t tmp_kernel_op_11 = tmp_kernel_op_10*0.16666666666666666 + tmp_kernel_op_4*0.16666666666666666 + tmp_kernel_op_7*0.66666666666666663;
       const real_t tmp_kernel_op_12 = tmp_kernel_op_10*0.16666666666666666 + tmp_kernel_op_4*0.66666666666666663 + tmp_kernel_op_7*0.16666666666666666;
       const int64_t tmp_kernel_op_13 = 0;
       const real_t tmp_kernel_op_14 = tmp_kernel_op_3*0.16666666666666666;
       const real_t tmp_kernel_op_15 = tmp_kernel_op_6*0.66666666666666663;
       const real_t tmp_kernel_op_16 = tmp_kernel_op_9*0.16666666666666666;
       ...
       const int64_t tmp_kernel_op_20 = 0;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < 1; ctr_0 += 1)
          {
             ...
             const real_t elMatVec_0 = src_dof_0*((tmp_kernel_op_1*tmp_kernel_op_1)*tmp_kernel_op_3 + (tmp_kernel_op_5*tmp_kernel_op_5)*tmp_kernel_op_6 + (tmp_kernel_op_8*tmp_kernel_op_8)*tmp_kernel_op_9) + src_dof_1*tmp_kernel_op_11 + src_dof_2*tmp_kernel_op_12 + src_dof_3*((real_t)(tmp_kernel_op_13));
             const real_t elMatVec_1 = src_dof_0*tmp_kernel_op_11 + src_dof_1*(tmp_kernel_op_3*0.027777777777777776 + tmp_kernel_op_6*0.44444444444444442 + tmp_kernel_op_9*0.027777777777777776) + src_dof_2*tmp_kernel_op_17 + src_dof_3*((real_t)(tmp_kernel_op_18));
             const real_t elMatVec_2 = src_dof_0*tmp_kernel_op_12 + src_dof_1*tmp_kernel_op_17 + src_dof_2*(tmp_kernel_op_3*0.44444444444444442 + tmp_kernel_op_6*0.027777777777777776 + tmp_kernel_op_9*0.027777777777777776) + src_dof_3*((real_t)(tmp_kernel_op_19));
             const real_t elMatVec_3 = src_dof_0*((real_t)(tmp_kernel_op_13)) + src_dof_1*((real_t)(tmp_kernel_op_18)) + src_dof_2*((real_t)(tmp_kernel_op_19)) + src_dof_3*(tmp_kernel_op_3*((real_t)(tmp_kernel_op_20)) + tmp_kernel_op_6*((real_t)(tmp_kernel_op_20)) + tmp_kernel_op_9*((real_t)(tmp_kernel_op_20)));
       ...
       const real_t tmp_moved_constant_2 = tmp_kernel_op_1*tmp_moved_constant_1;
       const real_t tmp_moved_constant_3 = tmp_moved_constant_0*0.16666666666666666;
       const real_t tmp_moved_constant_4 = tmp_kernel_op_5*tmp_moved_constant_3;
       const real_t tmp_moved_constant_5 = tmp_moved_constant_0*0.16666666666666666;
       const real_t tmp_moved_constant_6 = tmp_kernel_op_8*tmp_moved_constant_5;
       const real_t tmp_moved_constant_7 = tmp_moved_constant_2*0.16666666666666666 + tmp_moved_constant_4*0.66666666666666663 + tmp_moved_constant_6*0.16666666666666666;
       const real_t tmp_moved_constant_8 = tmp_moved_constant_2*0.66666666666666663 + tmp_moved_constant_4*0.16666666666666666 + tmp_moved_constant_6*0.16666666666666666;
       const real_t tmp_moved_constant_9 = tmp_moved_constant_1*0.16666666666666666;
       const real_t tmp_moved_constant_10 = tmp_moved_constant_3*0.66666666666666663;
       const real_t tmp_moved_constant_11 = tmp_moved_constant_5*0.16666666666666666;
       const real_t tmp_moved_constant_12 = tmp_moved_constant_10*0.16666666666666666 + tmp_moved_constant_11*0.16666666666666666 + tmp_moved_constant_9*0.66666666666666663;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < 1; ctr_0 += 1)
          {
             ...
             const real_t elMatVec_0 = src_dof_0*((tmp_kernel_op_1*tmp_kernel_op_1)*tmp_moved_constant_1 + (tmp_kernel_op_5*tmp_kernel_op_5)*tmp_moved_constant_3 + (tmp_kernel_op_8*tmp_kernel_op_8)*tmp_moved_constant_5) + src_dof_1*tmp_moved_constant_7 + src_dof_2*tmp_moved_constant_8 + src_dof_3*((real_t)(tmp_kernel_op_13));
             const real_t elMatVec_1 = src_dof_0*tmp_moved_constant_7 + src_dof_1*(tmp_moved_constant_1*0.027777777777777776 + tmp_moved_constant_3*0.44444444444444442 + tmp_moved_constant_5*0.027777777777777776) + src_dof_2*tmp_moved_constant_12 + src_dof_3*((real_t)(tmp_kernel_op_18));
             const real_t elMatVec_2 = src_dof_0*tmp_moved_constant_8 + src_dof_1*tmp_moved_constant_12 + src_dof_2*(tmp_moved_constant_1*0.44444444444444442 + tmp_moved_constant_3*0.027777777777777776 + tmp_moved_constant_5*0.027777777777777776) + src_dof_3*((real_t)(tmp_kernel_op_19));
             const real_t elMatVec_3 = src_dof_0*((real_t)(tmp_kernel_op_13)) + src_dof_1*((real_t)(tmp_kernel_op_18)) + src_dof_2*((real_t)(tmp_kernel_op_19)) + src_dof_3*(tmp_moved_constant_1*((real_t)(tmp_kernel_op_20)) + tmp_moved_constant_3*((real_t)(tmp_kernel_op_20)) + tmp_moved_constant_5*((real_t)(tmp_kernel_op_20)));
