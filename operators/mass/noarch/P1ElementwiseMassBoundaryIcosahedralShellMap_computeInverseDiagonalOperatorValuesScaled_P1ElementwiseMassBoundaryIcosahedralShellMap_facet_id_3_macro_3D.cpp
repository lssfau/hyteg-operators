...
{
    {
       ...
       const int64_t tmp_kernel_op_53 = 0;
       {
          /* CellType.WHITE_UP */
          ...
          for (int64_t ctr_0 = -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             const real_t tmp_kernel_op_1 = jac_affine_0_0_WHITE_UP*jac_blending_0_0_q_0 + jac_affine_1_0_WHITE_UP*jac_blending_0_1_q_0 + jac_affine_2_0_WHITE_UP*jac_blending_0_2_q_0;
             const real_t tmp_kernel_op_2 = jac_affine_0_0_WHITE_UP*jac_blending_1_0_q_0 + jac_affine_1_0_WHITE_UP*jac_blending_1_1_q_0 + jac_affine_2_0_WHITE_UP*jac_blending_1_2_q_0;
             const real_t tmp_kernel_op_3 = jac_affine_0_0_WHITE_UP*jac_blending_2_0_q_0 + jac_affine_1_0_WHITE_UP*jac_blending_2_1_q_0 + jac_affine_2_0_WHITE_UP*jac_blending_2_2_q_0;
             const real_t tmp_kernel_op_4 = jac_blending_0_0_q_0*tmp_kernel_op_1 + jac_blending_1_0_q_0*tmp_kernel_op_2 + jac_blending_2_0_q_0*tmp_kernel_op_3;
             const real_t tmp_kernel_op_5 = jac_blending_0_1_q_0*tmp_kernel_op_1 + jac_blending_1_1_q_0*tmp_kernel_op_2 + jac_blending_2_1_q_0*tmp_kernel_op_3;
             const real_t tmp_kernel_op_6 = jac_blending_0_2_q_0*tmp_kernel_op_1 + jac_blending_1_2_q_0*tmp_kernel_op_2 + jac_blending_2_2_q_0*tmp_kernel_op_3;
             const real_t tmp_kernel_op_7 = jac_affine_0_1_WHITE_UP*jac_blending_0_0_q_0 + jac_affine_1_1_WHITE_UP*jac_blending_0_1_q_0 + jac_affine_2_1_WHITE_UP*jac_blending_0_2_q_0;
             const real_t tmp_kernel_op_8 = jac_affine_0_1_WHITE_UP*jac_blending_1_0_q_0 + jac_affine_1_1_WHITE_UP*jac_blending_1_1_q_0 + jac_affine_2_1_WHITE_UP*jac_blending_1_2_q_0;
             const real_t tmp_kernel_op_9 = jac_affine_0_1_WHITE_UP*jac_blending_2_0_q_0 + jac_affine_1_1_WHITE_UP*jac_blending_2_1_q_0 + jac_affine_2_1_WHITE_UP*jac_blending_2_2_q_0;
             const real_t tmp_kernel_op_10 = jac_blending_0_0_q_0*tmp_kernel_op_7 + jac_blending_1_0_q_0*tmp_kernel_op_8 + jac_blending_2_0_q_0*tmp_kernel_op_9;
             const real_t tmp_kernel_op_11 = jac_blending_0_1_q_0*tmp_kernel_op_7 + jac_blending_1_1_q_0*tmp_kernel_op_8 + jac_blending_2_1_q_0*tmp_kernel_op_9;
             const real_t tmp_kernel_op_12 = jac_blending_0_2_q_0*tmp_kernel_op_7 + jac_blending_1_2_q_0*tmp_kernel_op_8 + jac_blending_2_2_q_0*tmp_kernel_op_9;
             const real_t tmp_kernel_op_13 = -0.28125*pow(abs((jac_affine_0_0_WHITE_UP*tmp_kernel_op_10 + jac_affine_1_0_WHITE_UP*tmp_kernel_op_11 + jac_affine_2_0_WHITE_UP*tmp_kernel_op_12)*(jac_affine_0_1_WHITE_UP*tmp_kernel_op_4 + jac_affine_1_1_WHITE_UP*tmp_kernel_op_5 + jac_affine_2_1_WHITE_UP*tmp_kernel_op_6) - (jac_affine_0_0_WHITE_UP*tmp_kernel_op_4 + jac_affine_1_0_WHITE_UP*tmp_kernel_op_5 + jac_affine_2_0_WHITE_UP*tmp_kernel_op_6)*(jac_affine_0_1_WHITE_UP*tmp_kernel_op_10 + jac_affine_1_1_WHITE_UP*tmp_kernel_op_11 + jac_affine_2_1_WHITE_UP*tmp_kernel_op_12)), 0.5);
             const real_t tmp_kernel_op_14 = jac_affine_0_0_WHITE_UP*jac_blending_0_0_q_1 + jac_affine_1_0_WHITE_UP*jac_blending_0_1_q_1 + jac_affine_2_0_WHITE_UP*jac_blending_0_2_q_1;
             const real_t tmp_kernel_op_15 = jac_affine_0_0_WHITE_UP*jac_blending_1_0_q_1 + jac_affine_1_0_WHITE_UP*jac_blending_1_1_q_1 + jac_affine_2_0_WHITE_UP*jac_blending_1_2_q_1;
             const real_t tmp_kernel_op_16 = jac_affine_0_0_WHITE_UP*jac_blending_2_0_q_1 + jac_affine_1_0_WHITE_UP*jac_blending_2_1_q_1 + jac_affine_2_0_WHITE_UP*jac_blending_2_2_q_1;
             const real_t tmp_kernel_op_17 = jac_blending_0_0_q_1*tmp_kernel_op_14 + jac_blending_1_0_q_1*tmp_kernel_op_15 + jac_blending_2_0_q_1*tmp_kernel_op_16;
             const real_t tmp_kernel_op_18 = jac_blending_0_1_q_1*tmp_kernel_op_14 + jac_blending_1_1_q_1*tmp_kernel_op_15 + jac_blending_2_1_q_1*tmp_kernel_op_16;
             const real_t tmp_kernel_op_19 = jac_blending_0_2_q_1*tmp_kernel_op_14 + jac_blending_1_2_q_1*tmp_kernel_op_15 + jac_blending_2_2_q_1*tmp_kernel_op_16;
             const real_t tmp_kernel_op_20 = jac_affine_0_1_WHITE_UP*jac_blending_0_0_q_1 + jac_affine_1_1_WHITE_UP*jac_blending_0_1_q_1 + jac_affine_2_1_WHITE_UP*jac_blending_0_2_q_1;
             const real_t tmp_kernel_op_21 = jac_affine_0_1_WHITE_UP*jac_blending_1_0_q_1 + jac_affine_1_1_WHITE_UP*jac_blending_1_1_q_1 + jac_affine_2_1_WHITE_UP*jac_blending_1_2_q_1;
             const real_t tmp_kernel_op_22 = jac_affine_0_1_WHITE_UP*jac_blending_2_0_q_1 + jac_affine_1_1_WHITE_UP*jac_blending_2_1_q_1 + jac_affine_2_1_WHITE_UP*jac_blending_2_2_q_1;
             const real_t tmp_kernel_op_23 = jac_blending_0_0_q_1*tmp_kernel_op_20 + jac_blending_1_0_q_1*tmp_kernel_op_21 + jac_blending_2_0_q_1*tmp_kernel_op_22;
             const real_t tmp_kernel_op_24 = jac_blending_0_1_q_1*tmp_kernel_op_20 + jac_blending_1_1_q_1*tmp_kernel_op_21 + jac_blending_2_1_q_1*tmp_kernel_op_22;
             const real_t tmp_kernel_op_25 = jac_blending_0_2_q_1*tmp_kernel_op_20 + jac_blending_1_2_q_1*tmp_kernel_op_21 + jac_blending_2_2_q_1*tmp_kernel_op_22;
             const real_t tmp_kernel_op_26 = 0.26041666666666669*pow(abs((jac_affine_0_0_WHITE_UP*tmp_kernel_op_17 + jac_affine_1_0_WHITE_UP*tmp_kernel_op_18 + jac_affine_2_0_WHITE_UP*tmp_kernel_op_19)*(jac_affine_0_1_WHITE_UP*tmp_kernel_op_23 + jac_affine_1_1_WHITE_UP*tmp_kernel_op_24 + jac_affine_2_1_WHITE_UP*tmp_kernel_op_25) - (jac_affine_0_0_WHITE_UP*tmp_kernel_op_23 + jac_affine_1_0_WHITE_UP*tmp_kernel_op_24 + jac_affine_2_0_WHITE_UP*tmp_kernel_op_25)*(jac_affine_0_1_WHITE_UP*tmp_kernel_op_17 + jac_affine_1_1_WHITE_UP*tmp_kernel_op_18 + jac_affine_2_1_WHITE_UP*tmp_kernel_op_19)), 0.5);
             const real_t tmp_kernel_op_27 = jac_affine_0_0_WHITE_UP*jac_blending_0_0_q_2 + jac_affine_1_0_WHITE_UP*jac_blending_0_1_q_2 + jac_affine_2_0_WHITE_UP*jac_blending_0_2_q_2;
             const real_t tmp_kernel_op_28 = jac_affine_0_0_WHITE_UP*jac_blending_1_0_q_2 + jac_affine_1_0_WHITE_UP*jac_blending_1_1_q_2 + jac_affine_2_0_WHITE_UP*jac_blending_1_2_q_2;
             const real_t tmp_kernel_op_29 = jac_affine_0_0_WHITE_UP*jac_blending_2_0_q_2 + jac_affine_1_0_WHITE_UP*jac_blending_2_1_q_2 + jac_affine_2_0_WHITE_UP*jac_blending_2_2_q_2;
             const real_t tmp_kernel_op_30 = jac_blending_0_0_q_2*tmp_kernel_op_27 + jac_blending_1_0_q_2*tmp_kernel_op_28 + jac_blending_2_0_q_2*tmp_kernel_op_29;
             const real_t tmp_kernel_op_31 = jac_blending_0_1_q_2*tmp_kernel_op_27 + jac_blending_1_1_q_2*tmp_kernel_op_28 + jac_blending_2_1_q_2*tmp_kernel_op_29;
             const real_t tmp_kernel_op_32 = jac_blending_0_2_q_2*tmp_kernel_op_27 + jac_blending_1_2_q_2*tmp_kernel_op_28 + jac_blending_2_2_q_2*tmp_kernel_op_29;
             const real_t tmp_kernel_op_33 = jac_affine_0_1_WHITE_UP*jac_blending_0_0_q_2 + jac_affine_1_1_WHITE_UP*jac_blending_0_1_q_2 + jac_affine_2_1_WHITE_UP*jac_blending_0_2_q_2;
             const real_t tmp_kernel_op_34 = jac_affine_0_1_WHITE_UP*jac_blending_1_0_q_2 + jac_affine_1_1_WHITE_UP*jac_blending_1_1_q_2 + jac_affine_2_1_WHITE_UP*jac_blending_1_2_q_2;
             const real_t tmp_kernel_op_35 = jac_affine_0_1_WHITE_UP*jac_blending_2_0_q_2 + jac_affine_1_1_WHITE_UP*jac_blending_2_1_q_2 + jac_affine_2_1_WHITE_UP*jac_blending_2_2_q_2;
             const real_t tmp_kernel_op_36 = jac_blending_0_0_q_2*tmp_kernel_op_33 + jac_blending_1_0_q_2*tmp_kernel_op_34 + jac_blending_2_0_q_2*tmp_kernel_op_35;
             const real_t tmp_kernel_op_37 = jac_blending_0_1_q_2*tmp_kernel_op_33 + jac_blending_1_1_q_2*tmp_kernel_op_34 + jac_blending_2_1_q_2*tmp_kernel_op_35;
             const real_t tmp_kernel_op_38 = jac_blending_0_2_q_2*tmp_kernel_op_33 + jac_blending_1_2_q_2*tmp_kernel_op_34 + jac_blending_2_2_q_2*tmp_kernel_op_35;
             const real_t tmp_kernel_op_39 = 0.26041666666666669*pow(abs((jac_affine_0_0_WHITE_UP*tmp_kernel_op_30 + jac_affine_1_0_WHITE_UP*tmp_kernel_op_31 + jac_affine_2_0_WHITE_UP*tmp_kernel_op_32)*(jac_affine_0_1_WHITE_UP*tmp_kernel_op_36 + jac_affine_1_1_WHITE_UP*tmp_kernel_op_37 + jac_affine_2_1_WHITE_UP*tmp_kernel_op_38) - (jac_affine_0_0_WHITE_UP*tmp_kernel_op_36 + jac_affine_1_0_WHITE_UP*tmp_kernel_op_37 + jac_affine_2_0_WHITE_UP*tmp_kernel_op_38)*(jac_affine_0_1_WHITE_UP*tmp_kernel_op_30 + jac_affine_1_1_WHITE_UP*tmp_kernel_op_31 + jac_affine_2_1_WHITE_UP*tmp_kernel_op_32)), 0.5);
             const real_t tmp_kernel_op_40 = jac_affine_0_0_WHITE_UP*jac_blending_0_0_q_3 + jac_affine_1_0_WHITE_UP*jac_blending_0_1_q_3 + jac_affine_2_0_WHITE_UP*jac_blending_0_2_q_3;
             const real_t tmp_kernel_op_41 = jac_affine_0_0_WHITE_UP*jac_blending_1_0_q_3 + jac_affine_1_0_WHITE_UP*jac_blending_1_1_q_3 + jac_affine_2_0_WHITE_UP*jac_blending_1_2_q_3;
             const real_t tmp_kernel_op_42 = jac_affine_0_0_WHITE_UP*jac_blending_2_0_q_3 + jac_affine_1_0_WHITE_UP*jac_blending_2_1_q_3 + jac_affine_2_0_WHITE_UP*jac_blending_2_2_q_3;
             const real_t tmp_kernel_op_43 = jac_blending_0_0_q_3*tmp_kernel_op_40 + jac_blending_1_0_q_3*tmp_kernel_op_41 + jac_blending_2_0_q_3*tmp_kernel_op_42;
             const real_t tmp_kernel_op_44 = jac_blending_0_1_q_3*tmp_kernel_op_40 + jac_blending_1_1_q_3*tmp_kernel_op_41 + jac_blending_2_1_q_3*tmp_kernel_op_42;
             const real_t tmp_kernel_op_45 = jac_blending_0_2_q_3*tmp_kernel_op_40 + jac_blending_1_2_q_3*tmp_kernel_op_41 + jac_blending_2_2_q_3*tmp_kernel_op_42;
             const real_t tmp_kernel_op_46 = jac_affine_0_1_WHITE_UP*jac_blending_0_0_q_3 + jac_affine_1_1_WHITE_UP*jac_blending_0_1_q_3 + jac_affine_2_1_WHITE_UP*jac_blending_0_2_q_3;
             const real_t tmp_kernel_op_47 = jac_affine_0_1_WHITE_UP*jac_blending_1_0_q_3 + jac_affine_1_1_WHITE_UP*jac_blending_1_1_q_3 + jac_affine_2_1_WHITE_UP*jac_blending_1_2_q_3;
             const real_t tmp_kernel_op_48 = jac_affine_0_1_WHITE_UP*jac_blending_2_0_q_3 + jac_affine_1_1_WHITE_UP*jac_blending_2_1_q_3 + jac_affine_2_1_WHITE_UP*jac_blending_2_2_q_3;
             const real_t tmp_kernel_op_49 = jac_blending_0_0_q_3*tmp_kernel_op_46 + jac_blending_1_0_q_3*tmp_kernel_op_47 + jac_blending_2_0_q_3*tmp_kernel_op_48;
             const real_t tmp_kernel_op_50 = jac_blending_0_1_q_3*tmp_kernel_op_46 + jac_blending_1_1_q_3*tmp_kernel_op_47 + jac_blending_2_1_q_3*tmp_kernel_op_48;
             const real_t tmp_kernel_op_51 = jac_blending_0_2_q_3*tmp_kernel_op_46 + jac_blending_1_2_q_3*tmp_kernel_op_47 + jac_blending_2_2_q_3*tmp_kernel_op_48;
             const real_t tmp_kernel_op_52 = 0.26041666666666669*pow(abs((jac_affine_0_0_WHITE_UP*tmp_kernel_op_43 + jac_affine_1_0_WHITE_UP*tmp_kernel_op_44 + jac_affine_2_0_WHITE_UP*tmp_kernel_op_45)*(jac_affine_0_1_WHITE_UP*tmp_kernel_op_49 + jac_affine_1_1_WHITE_UP*tmp_kernel_op_50 + jac_affine_2_1_WHITE_UP*tmp_kernel_op_51) - (jac_affine_0_0_WHITE_UP*tmp_kernel_op_49 + jac_affine_1_0_WHITE_UP*tmp_kernel_op_50 + jac_affine_2_0_WHITE_UP*tmp_kernel_op_51)*(jac_affine_0_1_WHITE_UP*tmp_kernel_op_43 + jac_affine_1_1_WHITE_UP*tmp_kernel_op_44 + jac_affine_2_1_WHITE_UP*tmp_kernel_op_45)), 0.5);
             const real_t elMatDiag_0 = tmp_kernel_op_13*((-0.66666666666666663 + ((real_t)(-tmp_kernel_op_0)))*(-0.66666666666666663 + ((real_t)(-tmp_kernel_op_0)))) + tmp_kernel_op_26*((-0.80000000000000004 + ((real_t)(-tmp_kernel_op_0)))*(-0.80000000000000004 + ((real_t)(-tmp_kernel_op_0)))) + tmp_kernel_op_39*((-0.80000000000000004 + ((real_t)(-tmp_kernel_op_0)))*(-0.80000000000000004 + ((real_t)(-tmp_kernel_op_0)))) + tmp_kernel_op_52*((-0.40000000000000002 + ((real_t)(-tmp_kernel_op_0)))*(-0.40000000000000002 + ((real_t)(-tmp_kernel_op_0))));
             const real_t elMatDiag_1 = tmp_kernel_op_13*0.1111111111111111 + tmp_kernel_op_26*0.040000000000000008 + tmp_kernel_op_39*0.35999999999999999 + tmp_kernel_op_52*0.040000000000000008;
             const real_t elMatDiag_2 = tmp_kernel_op_13*0.1111111111111111 + tmp_kernel_op_26*0.35999999999999999 + tmp_kernel_op_39*0.040000000000000008 + tmp_kernel_op_52*0.040000000000000008;
             const real_t elMatDiag_3 = tmp_kernel_op_13*((real_t)(tmp_kernel_op_53)) + tmp_kernel_op_26*((real_t)(tmp_kernel_op_53)) + tmp_kernel_op_39*((real_t)(tmp_kernel_op_53)) + tmp_kernel_op_52*((real_t)(tmp_kernel_op_53));
             ...
             _data_invDiag_[ctr_0 + ctr_1*(-ctr_2 + micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + (((micro_edges_per_macro_edge + 1)*(micro_edges_per_macro_edge + 2)*(micro_edges_per_macro_edge + 3)) / (6)) - (((-ctr_2 + micro_edges_per_macro_edge + 1)*(-ctr_2 + micro_edges_per_macro_edge + 2)*(-ctr_2 + micro_edges_per_macro_edge + 3)) / (6))] = diagScaling*elMatDiag_3 + _data_invDiag_[ctr_0 + ctr_1*(-ctr_2 + micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + (((micro_edges_per_macro_edge + 1)*(micro_edges_per_macro_edge + 2)*(micro_edges_per_macro_edge + 3)) / (6)) - (((-ctr_2 + micro_edges_per_macro_edge + 1)*(-ctr_2 + micro_edges_per_macro_edge + 2)*(-ctr_2 + micro_edges_per_macro_edge + 3)) / (6))];
          }
       }
       ...
       const real_t jac_affine_2_1_GREEN_DOWN = -p_affine_const_0_2_GREEN_DOWN + p_affine_const_2_2_GREEN_DOWN;
       {
          ...
          for (int64_t ctr_0 = -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 2; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             const real_t jac_blending_0_1_q_0 = tmp_blending_op_106*tmp_blending_op_111;
             const real_t jac_blending_0_0_q_0 = tmp_blending_op_105*(-tmp_blending_op_100*tmp_blending_op_102 + tmp_blending_op_104*(tmp_blending_op_100 + tmp_blending_op_53*tmp_blending_op_96));
             const real_t tmp_kernel_op_1 = jac_affine_0_0_GREEN_DOWN*jac_blending_0_0_q_0 + jac_affine_1_0_GREEN_DOWN*jac_blending_0_1_q_0 + jac_affine_2_0_GREEN_DOWN*jac_blending_0_2_q_0;
             const real_t tmp_kernel_op_2 = jac_affine_0_0_GREEN_DOWN*jac_blending_1_0_q_0 + jac_affine_1_0_GREEN_DOWN*jac_blending_1_1_q_0 + jac_affine_2_0_GREEN_DOWN*jac_blending_1_2_q_0;
             const real_t tmp_kernel_op_3 = jac_affine_0_0_GREEN_DOWN*jac_blending_2_0_q_0 + jac_affine_1_0_GREEN_DOWN*jac_blending_2_1_q_0 + jac_affine_2_0_GREEN_DOWN*jac_blending_2_2_q_0;
             const real_t tmp_kernel_op_4 = jac_blending_0_0_q_0*tmp_kernel_op_1 + jac_blending_1_0_q_0*tmp_kernel_op_2 + jac_blending_2_0_q_0*tmp_kernel_op_3;
             const real_t tmp_kernel_op_5 = jac_blending_0_1_q_0*tmp_kernel_op_1 + jac_blending_1_1_q_0*tmp_kernel_op_2 + jac_blending_2_1_q_0*tmp_kernel_op_3;
             const real_t tmp_kernel_op_6 = jac_blending_0_2_q_0*tmp_kernel_op_1 + jac_blending_1_2_q_0*tmp_kernel_op_2 + jac_blending_2_2_q_0*tmp_kernel_op_3;
             const real_t tmp_kernel_op_7 = jac_affine_0_1_GREEN_DOWN*jac_blending_0_0_q_0 + jac_affine_1_1_GREEN_DOWN*jac_blending_0_1_q_0 + jac_affine_2_1_GREEN_DOWN*jac_blending_0_2_q_0;
             const real_t tmp_kernel_op_8 = jac_affine_0_1_GREEN_DOWN*jac_blending_1_0_q_0 + jac_affine_1_1_GREEN_DOWN*jac_blending_1_1_q_0 + jac_affine_2_1_GREEN_DOWN*jac_blending_1_2_q_0;
             const real_t tmp_kernel_op_9 = jac_affine_0_1_GREEN_DOWN*jac_blending_2_0_q_0 + jac_affine_1_1_GREEN_DOWN*jac_blending_2_1_q_0 + jac_affine_2_1_GREEN_DOWN*jac_blending_2_2_q_0;
             const real_t tmp_kernel_op_10 = jac_blending_0_0_q_0*tmp_kernel_op_7 + jac_blending_1_0_q_0*tmp_kernel_op_8 + jac_blending_2_0_q_0*tmp_kernel_op_9;
             const real_t tmp_kernel_op_11 = jac_blending_0_1_q_0*tmp_kernel_op_7 + jac_blending_1_1_q_0*tmp_kernel_op_8 + jac_blending_2_1_q_0*tmp_kernel_op_9;
             const real_t tmp_kernel_op_12 = jac_blending_0_2_q_0*tmp_kernel_op_7 + jac_blending_1_2_q_0*tmp_kernel_op_8 + jac_blending_2_2_q_0*tmp_kernel_op_9;
             const real_t tmp_kernel_op_13 = -0.28125*pow(abs((jac_affine_0_0_GREEN_DOWN*tmp_kernel_op_10 + jac_affine_1_0_GREEN_DOWN*tmp_kernel_op_11 + jac_affine_2_0_GREEN_DOWN*tmp_kernel_op_12)*(jac_affine_0_1_GREEN_DOWN*tmp_kernel_op_4 + jac_affine_1_1_GREEN_DOWN*tmp_kernel_op_5 + jac_affine_2_1_GREEN_DOWN*tmp_kernel_op_6) - (jac_affine_0_0_GREEN_DOWN*tmp_kernel_op_4 + jac_affine_1_0_GREEN_DOWN*tmp_kernel_op_5 + jac_affine_2_0_GREEN_DOWN*tmp_kernel_op_6)*(jac_affine_0_1_GREEN_DOWN*tmp_kernel_op_10 + jac_affine_1_1_GREEN_DOWN*tmp_kernel_op_11 + jac_affine_2_1_GREEN_DOWN*tmp_kernel_op_12)), 0.5);
             const real_t tmp_kernel_op_14 = jac_affine_0_0_GREEN_DOWN*jac_blending_0_0_q_1 + jac_affine_1_0_GREEN_DOWN*jac_blending_0_1_q_1 + jac_affine_2_0_GREEN_DOWN*jac_blending_0_2_q_1;
             const real_t tmp_kernel_op_15 = jac_affine_0_0_GREEN_DOWN*jac_blending_1_0_q_1 + jac_affine_1_0_GREEN_DOWN*jac_blending_1_1_q_1 + jac_affine_2_0_GREEN_DOWN*jac_blending_1_2_q_1;
             const real_t tmp_kernel_op_16 = jac_affine_0_0_GREEN_DOWN*jac_blending_2_0_q_1 + jac_affine_1_0_GREEN_DOWN*jac_blending_2_1_q_1 + jac_affine_2_0_GREEN_DOWN*jac_blending_2_2_q_1;
             const real_t tmp_kernel_op_17 = jac_blending_0_0_q_1*tmp_kernel_op_14 + jac_blending_1_0_q_1*tmp_kernel_op_15 + jac_blending_2_0_q_1*tmp_kernel_op_16;
             const real_t tmp_kernel_op_18 = jac_blending_0_1_q_1*tmp_kernel_op_14 + jac_blending_1_1_q_1*tmp_kernel_op_15 + jac_blending_2_1_q_1*tmp_kernel_op_16;
             const real_t tmp_kernel_op_19 = jac_blending_0_2_q_1*tmp_kernel_op_14 + jac_blending_1_2_q_1*tmp_kernel_op_15 + jac_blending_2_2_q_1*tmp_kernel_op_16;
             const real_t tmp_kernel_op_20 = jac_affine_0_1_GREEN_DOWN*jac_blending_0_0_q_1 + jac_affine_1_1_GREEN_DOWN*jac_blending_0_1_q_1 + jac_affine_2_1_GREEN_DOWN*jac_blending_0_2_q_1;
             const real_t tmp_kernel_op_21 = jac_affine_0_1_GREEN_DOWN*jac_blending_1_0_q_1 + jac_affine_1_1_GREEN_DOWN*jac_blending_1_1_q_1 + jac_affine_2_1_GREEN_DOWN*jac_blending_1_2_q_1;
             const real_t tmp_kernel_op_22 = jac_affine_0_1_GREEN_DOWN*jac_blending_2_0_q_1 + jac_affine_1_1_GREEN_DOWN*jac_blending_2_1_q_1 + jac_affine_2_1_GREEN_DOWN*jac_blending_2_2_q_1;
             const real_t tmp_kernel_op_23 = jac_blending_0_0_q_1*tmp_kernel_op_20 + jac_blending_1_0_q_1*tmp_kernel_op_21 + jac_blending_2_0_q_1*tmp_kernel_op_22;
             const real_t tmp_kernel_op_24 = jac_blending_0_1_q_1*tmp_kernel_op_20 + jac_blending_1_1_q_1*tmp_kernel_op_21 + jac_blending_2_1_q_1*tmp_kernel_op_22;
             const real_t tmp_kernel_op_25 = jac_blending_0_2_q_1*tmp_kernel_op_20 + jac_blending_1_2_q_1*tmp_kernel_op_21 + jac_blending_2_2_q_1*tmp_kernel_op_22;
             const real_t tmp_kernel_op_26 = 0.26041666666666669*pow(abs((jac_affine_0_0_GREEN_DOWN*tmp_kernel_op_17 + jac_affine_1_0_GREEN_DOWN*tmp_kernel_op_18 + jac_affine_2_0_GREEN_DOWN*tmp_kernel_op_19)*(jac_affine_0_1_GREEN_DOWN*tmp_kernel_op_23 + jac_affine_1_1_GREEN_DOWN*tmp_kernel_op_24 + jac_affine_2_1_GREEN_DOWN*tmp_kernel_op_25) - (jac_affine_0_0_GREEN_DOWN*tmp_kernel_op_23 + jac_affine_1_0_GREEN_DOWN*tmp_kernel_op_24 + jac_affine_2_0_GREEN_DOWN*tmp_kernel_op_25)*(jac_affine_0_1_GREEN_DOWN*tmp_kernel_op_17 + jac_affine_1_1_GREEN_DOWN*tmp_kernel_op_18 + jac_affine_2_1_GREEN_DOWN*tmp_kernel_op_19)), 0.5);
             const real_t tmp_kernel_op_27 = jac_affine_0_0_GREEN_DOWN*jac_blending_0_0_q_2 + jac_affine_1_0_GREEN_DOWN*jac_blending_0_1_q_2 + jac_affine_2_0_GREEN_DOWN*jac_blending_0_2_q_2;
             const real_t tmp_kernel_op_28 = jac_affine_0_0_GREEN_DOWN*jac_blending_1_0_q_2 + jac_affine_1_0_GREEN_DOWN*jac_blending_1_1_q_2 + jac_affine_2_0_GREEN_DOWN*jac_blending_1_2_q_2;
             const real_t tmp_kernel_op_29 = jac_affine_0_0_GREEN_DOWN*jac_blending_2_0_q_2 + jac_affine_1_0_GREEN_DOWN*jac_blending_2_1_q_2 + jac_affine_2_0_GREEN_DOWN*jac_blending_2_2_q_2;
             const real_t tmp_kernel_op_30 = jac_blending_0_0_q_2*tmp_kernel_op_27 + jac_blending_1_0_q_2*tmp_kernel_op_28 + jac_blending_2_0_q_2*tmp_kernel_op_29;
             const real_t tmp_kernel_op_31 = jac_blending_0_1_q_2*tmp_kernel_op_27 + jac_blending_1_1_q_2*tmp_kernel_op_28 + jac_blending_2_1_q_2*tmp_kernel_op_29;
             const real_t tmp_kernel_op_32 = jac_blending_0_2_q_2*tmp_kernel_op_27 + jac_blending_1_2_q_2*tmp_kernel_op_28 + jac_blending_2_2_q_2*tmp_kernel_op_29;
             const real_t tmp_kernel_op_33 = jac_affine_0_1_GREEN_DOWN*jac_blending_0_0_q_2 + jac_affine_1_1_GREEN_DOWN*jac_blending_0_1_q_2 + jac_affine_2_1_GREEN_DOWN*jac_blending_0_2_q_2;
             const real_t tmp_kernel_op_34 = jac_affine_0_1_GREEN_DOWN*jac_blending_1_0_q_2 + jac_affine_1_1_GREEN_DOWN*jac_blending_1_1_q_2 + jac_affine_2_1_GREEN_DOWN*jac_blending_1_2_q_2;
             const real_t tmp_kernel_op_35 = jac_affine_0_1_GREEN_DOWN*jac_blending_2_0_q_2 + jac_affine_1_1_GREEN_DOWN*jac_blending_2_1_q_2 + jac_affine_2_1_GREEN_DOWN*jac_blending_2_2_q_2;
             const real_t tmp_kernel_op_36 = jac_blending_0_0_q_2*tmp_kernel_op_33 + jac_blending_1_0_q_2*tmp_kernel_op_34 + jac_blending_2_0_q_2*tmp_kernel_op_35;
             const real_t tmp_kernel_op_37 = jac_blending_0_1_q_2*tmp_kernel_op_33 + jac_blending_1_1_q_2*tmp_kernel_op_34 + jac_blending_2_1_q_2*tmp_kernel_op_35;
             const real_t tmp_kernel_op_38 = jac_blending_0_2_q_2*tmp_kernel_op_33 + jac_blending_1_2_q_2*tmp_kernel_op_34 + jac_blending_2_2_q_2*tmp_kernel_op_35;
             const real_t tmp_kernel_op_39 = 0.26041666666666669*pow(abs((jac_affine_0_0_GREEN_DOWN*tmp_kernel_op_30 + jac_affine_1_0_GREEN_DOWN*tmp_kernel_op_31 + jac_affine_2_0_GREEN_DOWN*tmp_kernel_op_32)*(jac_affine_0_1_GREEN_DOWN*tmp_kernel_op_36 + jac_affine_1_1_GREEN_DOWN*tmp_kernel_op_37 + jac_affine_2_1_GREEN_DOWN*tmp_kernel_op_38) - (jac_affine_0_0_GREEN_DOWN*tmp_kernel_op_36 + jac_affine_1_0_GREEN_DOWN*tmp_kernel_op_37 + jac_affine_2_0_GREEN_DOWN*tmp_kernel_op_38)*(jac_affine_0_1_GREEN_DOWN*tmp_kernel_op_30 + jac_affine_1_1_GREEN_DOWN*tmp_kernel_op_31 + jac_affine_2_1_GREEN_DOWN*tmp_kernel_op_32)), 0.5);
             const real_t tmp_kernel_op_40 = jac_affine_0_0_GREEN_DOWN*jac_blending_0_0_q_3 + jac_affine_1_0_GREEN_DOWN*jac_blending_0_1_q_3 + jac_affine_2_0_GREEN_DOWN*jac_blending_0_2_q_3;
             const real_t tmp_kernel_op_41 = jac_affine_0_0_GREEN_DOWN*jac_blending_1_0_q_3 + jac_affine_1_0_GREEN_DOWN*jac_blending_1_1_q_3 + jac_affine_2_0_GREEN_DOWN*jac_blending_1_2_q_3;
             const real_t tmp_kernel_op_42 = jac_affine_0_0_GREEN_DOWN*jac_blending_2_0_q_3 + jac_affine_1_0_GREEN_DOWN*jac_blending_2_1_q_3 + jac_affine_2_0_GREEN_DOWN*jac_blending_2_2_q_3;
             const real_t tmp_kernel_op_43 = jac_blending_0_0_q_3*tmp_kernel_op_40 + jac_blending_1_0_q_3*tmp_kernel_op_41 + jac_blending_2_0_q_3*tmp_kernel_op_42;
             const real_t tmp_kernel_op_44 = jac_blending_0_1_q_3*tmp_kernel_op_40 + jac_blending_1_1_q_3*tmp_kernel_op_41 + jac_blending_2_1_q_3*tmp_kernel_op_42;
             const real_t tmp_kernel_op_45 = jac_blending_0_2_q_3*tmp_kernel_op_40 + jac_blending_1_2_q_3*tmp_kernel_op_41 + jac_blending_2_2_q_3*tmp_kernel_op_42;
             const real_t tmp_kernel_op_46 = jac_affine_0_1_GREEN_DOWN*jac_blending_0_0_q_3 + jac_affine_1_1_GREEN_DOWN*jac_blending_0_1_q_3 + jac_affine_2_1_GREEN_DOWN*jac_blending_0_2_q_3;
             const real_t tmp_kernel_op_47 = jac_affine_0_1_GREEN_DOWN*jac_blending_1_0_q_3 + jac_affine_1_1_GREEN_DOWN*jac_blending_1_1_q_3 + jac_affine_2_1_GREEN_DOWN*jac_blending_1_2_q_3;
             const real_t tmp_kernel_op_48 = jac_affine_0_1_GREEN_DOWN*jac_blending_2_0_q_3 + jac_affine_1_1_GREEN_DOWN*jac_blending_2_1_q_3 + jac_affine_2_1_GREEN_DOWN*jac_blending_2_2_q_3;
             const real_t tmp_kernel_op_49 = jac_blending_0_0_q_3*tmp_kernel_op_46 + jac_blending_1_0_q_3*tmp_kernel_op_47 + jac_blending_2_0_q_3*tmp_kernel_op_48;
             const real_t tmp_kernel_op_50 = jac_blending_0_1_q_3*tmp_kernel_op_46 + jac_blending_1_1_q_3*tmp_kernel_op_47 + jac_blending_2_1_q_3*tmp_kernel_op_48;
             const real_t tmp_kernel_op_51 = jac_blending_0_2_q_3*tmp_kernel_op_46 + jac_blending_1_2_q_3*tmp_kernel_op_47 + jac_blending_2_2_q_3*tmp_kernel_op_48;
             const real_t tmp_kernel_op_52 = 0.26041666666666669*pow(abs((jac_affine_0_0_GREEN_DOWN*tmp_kernel_op_43 + jac_affine_1_0_GREEN_DOWN*tmp_kernel_op_44 + jac_affine_2_0_GREEN_DOWN*tmp_kernel_op_45)*(jac_affine_0_1_GREEN_DOWN*tmp_kernel_op_49 + jac_affine_1_1_GREEN_DOWN*tmp_kernel_op_50 + jac_affine_2_1_GREEN_DOWN*tmp_kernel_op_51) - (jac_affine_0_0_GREEN_DOWN*tmp_kernel_op_49 + jac_affine_1_0_GREEN_DOWN*tmp_kernel_op_50 + jac_affine_2_0_GREEN_DOWN*tmp_kernel_op_51)*(jac_affine_0_1_GREEN_DOWN*tmp_kernel_op_43 + jac_affine_1_1_GREEN_DOWN*tmp_kernel_op_44 + jac_affine_2_1_GREEN_DOWN*tmp_kernel_op_45)), 0.5);
             const real_t elMatDiag_0 = tmp_kernel_op_13*((-0.66666666666666663 + ((real_t)(-tmp_kernel_op_0)))*(-0.66666666666666663 + ((real_t)(-tmp_kernel_op_0)))) + tmp_kernel_op_26*((-0.80000000000000004 + ((real_t)(-tmp_kernel_op_0)))*(-0.80000000000000004 + ((real_t)(-tmp_kernel_op_0)))) + tmp_kernel_op_39*((-0.80000000000000004 + ((real_t)(-tmp_kernel_op_0)))*(-0.80000000000000004 + ((real_t)(-tmp_kernel_op_0)))) + tmp_kernel_op_52*((-0.40000000000000002 + ((real_t)(-tmp_kernel_op_0)))*(-0.40000000000000002 + ((real_t)(-tmp_kernel_op_0))));
             const real_t elMatDiag_1 = tmp_kernel_op_13*0.1111111111111111 + tmp_kernel_op_26*0.040000000000000008 + tmp_kernel_op_39*0.35999999999999999 + tmp_kernel_op_52*0.040000000000000008;
             const real_t elMatDiag_2 = tmp_kernel_op_13*0.1111111111111111 + tmp_kernel_op_26*0.35999999999999999 + tmp_kernel_op_39*0.040000000000000008 + tmp_kernel_op_52*0.040000000000000008;
             const real_t elMatDiag_3 = tmp_kernel_op_13*((real_t)(tmp_kernel_op_53)) + tmp_kernel_op_26*((real_t)(tmp_kernel_op_53)) + tmp_kernel_op_39*((real_t)(tmp_kernel_op_53)) + tmp_kernel_op_52*((real_t)(tmp_kernel_op_53));
             ...
             _data_invDiag_[ctr_0 + (ctr_1 + 1)*(-ctr_2 + micro_edges_per_macro_edge + 2) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2)) + (((micro_edges_per_macro_edge + 1)*(micro_edges_per_macro_edge + 2)*(micro_edges_per_macro_edge + 3)) / (6)) - (((-ctr_2 + micro_edges_per_macro_edge + 1)*(-ctr_2 + micro_edges_per_macro_edge + 2)*(-ctr_2 + micro_edges_per_macro_edge + 3)) / (6))] = diagScaling*elMatDiag_3 + _data_invDiag_[ctr_0 + (ctr_1 + 1)*(-ctr_2 + micro_edges_per_macro_edge + 2) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2)) + (((micro_edges_per_macro_edge + 1)*(micro_edges_per_macro_edge + 2)*(micro_edges_per_macro_edge + 3)) / (6)) - (((-ctr_2 + micro_edges_per_macro_edge + 1)*(-ctr_2 + micro_edges_per_macro_edge + 2)*(-ctr_2 + micro_edges_per_macro_edge + 3)) / (6))];
          }
       }
    }
}
