...
void P1ElementwiseMassBoundary::toMatrix_P1ElementwiseMassBoundary_facet_id_0_macro_2D( idx_t * RESTRICT  _data_dst, idx_t * RESTRICT  _data_src, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float ) const
{
    {
       ...
       const real_t tmp_kernel_op_8 = tmp_kernel_op_6*0.21132486540518713 + tmp_kernel_op_7*0.78867513459481287;
       const int64_t tmp_kernel_op_9 = 0;
       const int64_t tmp_kernel_op_10 = 0;
       const int64_t tmp_kernel_op_11 = 0;
       const real_t elMat_0_0 = (tmp_kernel_op_1*tmp_kernel_op_1)*tmp_kernel_op_3 + (tmp_kernel_op_4*tmp_kernel_op_4)*tmp_kernel_op_5;
       const real_t elMat_0_1 = tmp_kernel_op_8;
       const int64_t elMat_0_2 = tmp_kernel_op_9;
       const real_t elMat_1_0 = tmp_kernel_op_8;
       const real_t elMat_1_1 = tmp_kernel_op_3*0.044658198738520456 + tmp_kernel_op_5*0.62200846792814624;
       const int64_t elMat_1_2 = tmp_kernel_op_10;
       const int64_t elMat_2_0 = tmp_kernel_op_9;
       const int64_t elMat_2_1 = tmp_kernel_op_10;
       const real_t elMat_2_2 = tmp_kernel_op_3*((real_t)(tmp_kernel_op_11)) + tmp_kernel_op_5*((real_t)(tmp_kernel_op_11));
       {
          /* FaceType.GRAY */
