...
{
    {
       ...
       const real_t tmp_kernel_op_19 = toMatrixScaling*(tmp_kernel_op_15*tmp_kernel_op_16 + tmp_kernel_op_17*tmp_kernel_op_18);
       const int64_t tmp_kernel_op_20 = tmp_kernel_op_5;
       const real_t tmp_kernel_op_21 = toMatrixScaling*(tmp_kernel_op_16*((real_t)(tmp_kernel_op_20)) + tmp_kernel_op_18*((real_t)(tmp_kernel_op_20)));
       const real_t tmp_kernel_op_22 = toMatrixScaling*(tmp_kernel_op_12*tmp_kernel_op_18 + tmp_kernel_op_16*tmp_kernel_op_3);
       ...
       const real_t tmp_kernel_op_26 = toMatrixScaling*(tmp_kernel_op_16*tmp_kernel_op_24 + tmp_kernel_op_18*tmp_kernel_op_25);
       ...
       const real_t tmp_kernel_op_29 = toMatrixScaling*(tmp_kernel_op_16*tmp_kernel_op_27 + tmp_kernel_op_18*tmp_kernel_op_28);
       ...
       const real_t tmp_kernel_op_32 = toMatrixScaling*(tmp_kernel_op_30*((real_t)(tmp_kernel_op_20)) + tmp_kernel_op_31*((real_t)(tmp_kernel_op_20)));
       const real_t tmp_kernel_op_33 = toMatrixScaling*(tmp_kernel_op_12*tmp_kernel_op_31 + tmp_kernel_op_3*tmp_kernel_op_30);
       const real_t tmp_kernel_op_34 = toMatrixScaling*(tmp_kernel_op_24*tmp_kernel_op_30 + tmp_kernel_op_25*tmp_kernel_op_31);
       const real_t tmp_kernel_op_35 = toMatrixScaling*(tmp_kernel_op_27*tmp_kernel_op_30 + tmp_kernel_op_28*tmp_kernel_op_31);
       ...
       const real_t tmp_kernel_op_39 = toMatrixScaling*(tmp_kernel_op_12*tmp_kernel_op_38 + tmp_kernel_op_3*tmp_kernel_op_37);
       const real_t tmp_kernel_op_40 = toMatrixScaling*(tmp_kernel_op_24*tmp_kernel_op_37 + tmp_kernel_op_25*tmp_kernel_op_38);
       const real_t tmp_kernel_op_41 = toMatrixScaling*(tmp_kernel_op_27*tmp_kernel_op_37 + tmp_kernel_op_28*tmp_kernel_op_38);
       ...
       const real_t tmp_kernel_op_45 = toMatrixScaling*(tmp_kernel_op_12*tmp_kernel_op_44 + tmp_kernel_op_3*tmp_kernel_op_43);
       const real_t tmp_kernel_op_46 = toMatrixScaling*(tmp_kernel_op_12*tmp_kernel_op_14*tmp_kernel_op_28 + tmp_kernel_op_27*tmp_kernel_op_3*tmp_kernel_op_9);
       const real_t tmp_kernel_op_47 = toMatrixScaling*(tmp_kernel_op_27*tmp_kernel_op_43 + tmp_kernel_op_28*tmp_kernel_op_44);
       const real_t elMat_0_0 = toMatrixScaling*((tmp_kernel_op_13*tmp_kernel_op_13)*tmp_kernel_op_14 + (tmp_kernel_op_7*tmp_kernel_op_7)*tmp_kernel_op_9);
       ...
       const real_t elMat_1_1 = toMatrixScaling*(tmp_kernel_op_14*(tmp_kernel_op_17*tmp_kernel_op_17) + (tmp_kernel_op_15*tmp_kernel_op_15)*tmp_kernel_op_9);
       ...
       const real_t elMat_2_2 = toMatrixScaling*(tmp_kernel_op_14*((real_t)(tmp_kernel_op_36)) + tmp_kernel_op_9*((real_t)(tmp_kernel_op_36)));
       ...
       const real_t elMat_3_3 = toMatrixScaling*(tmp_kernel_op_0*tmp_kernel_op_9*((real_t)(tmp_kernel_op_42)) + tmp_kernel_op_10*tmp_kernel_op_14*((real_t)(tmp_kernel_op_42)));
       ...
       const real_t elMat_4_4 = toMatrixScaling*(tmp_kernel_op_14*(tmp_kernel_op_25*tmp_kernel_op_25) + (tmp_kernel_op_24*tmp_kernel_op_24)*tmp_kernel_op_9);
       ...
       const real_t elMat_5_5 = toMatrixScaling*(tmp_kernel_op_14*(tmp_kernel_op_28*tmp_kernel_op_28) + (tmp_kernel_op_27*tmp_kernel_op_27)*tmp_kernel_op_9);
       {
          /* FaceType.GRAY */
