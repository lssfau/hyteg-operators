...
{
    {
       ...
       const real_t abs_det_jac_affine_GRAY = abs(jac_affine_0_0_GRAY*jac_affine_1_1_GRAY - jac_affine_0_1_GRAY*jac_affine_1_0_GRAY);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             const real_t tmp_kernel_op_6 = q_acc_1_2*toMatrixScaling;
             const real_t tmp_kernel_op_7 = q_acc_1_3*toMatrixScaling;
             const real_t tmp_kernel_op_8 = q_acc_1_4*toMatrixScaling;
             const real_t tmp_kernel_op_9 = q_acc_1_5*toMatrixScaling;
             const real_t tmp_kernel_op_10 = q_acc_1_6*toMatrixScaling;
             const real_t tmp_kernel_op_11 = q_acc_2_3*toMatrixScaling;
             const real_t tmp_kernel_op_12 = q_acc_2_4*toMatrixScaling;
             const real_t tmp_kernel_op_13 = q_acc_2_5*toMatrixScaling;
             const real_t tmp_kernel_op_14 = q_acc_2_6*toMatrixScaling;
             const real_t tmp_kernel_op_15 = q_acc_3_4*toMatrixScaling;
             const real_t tmp_kernel_op_16 = q_acc_3_5*toMatrixScaling;
             const real_t tmp_kernel_op_17 = q_acc_3_6*toMatrixScaling;
             const real_t tmp_kernel_op_18 = q_acc_4_5*toMatrixScaling;
             const real_t tmp_kernel_op_19 = q_acc_4_6*toMatrixScaling;
             const real_t tmp_kernel_op_20 = q_acc_5_6*toMatrixScaling;
             ...
             const real_t elMat_1_2 = tmp_kernel_op_6;
             const real_t elMat_1_3 = tmp_kernel_op_7;
             const real_t elMat_1_4 = tmp_kernel_op_8;
             const real_t elMat_1_5 = tmp_kernel_op_9;
             const real_t elMat_1_6 = tmp_kernel_op_10;
             const real_t elMat_2_0 = tmp_kernel_op_1;
             const real_t elMat_2_1 = tmp_kernel_op_6;
             const real_t elMat_2_2 = q_acc_2_2*toMatrixScaling;
             const real_t elMat_2_3 = tmp_kernel_op_11;
             const real_t elMat_2_4 = tmp_kernel_op_12;
             const real_t elMat_2_5 = tmp_kernel_op_13;
             const real_t elMat_2_6 = tmp_kernel_op_14;
             const real_t elMat_3_0 = tmp_kernel_op_2;
             const real_t elMat_3_1 = tmp_kernel_op_7;
             const real_t elMat_3_2 = tmp_kernel_op_11;
             const real_t elMat_3_3 = q_acc_3_3*toMatrixScaling;
             const real_t elMat_3_4 = tmp_kernel_op_15;
             const real_t elMat_3_5 = tmp_kernel_op_16;
             const real_t elMat_3_6 = tmp_kernel_op_17;
             const real_t elMat_4_0 = tmp_kernel_op_3;
             const real_t elMat_4_1 = tmp_kernel_op_8;
             const real_t elMat_4_2 = tmp_kernel_op_12;
             const real_t elMat_4_3 = tmp_kernel_op_15;
             const real_t elMat_4_4 = q_acc_4_4*toMatrixScaling;
             const real_t elMat_4_5 = tmp_kernel_op_18;
             const real_t elMat_4_6 = tmp_kernel_op_19;
             const real_t elMat_5_0 = tmp_kernel_op_4;
             const real_t elMat_5_1 = tmp_kernel_op_9;
             const real_t elMat_5_2 = tmp_kernel_op_13;
             const real_t elMat_5_3 = tmp_kernel_op_16;
             const real_t elMat_5_4 = tmp_kernel_op_18;
             const real_t elMat_5_5 = q_acc_5_5*toMatrixScaling;
             const real_t elMat_5_6 = tmp_kernel_op_20;
             const real_t elMat_6_0 = tmp_kernel_op_5;
             const real_t elMat_6_1 = tmp_kernel_op_10;
             const real_t elMat_6_2 = tmp_kernel_op_14;
             const real_t elMat_6_3 = tmp_kernel_op_17;
             const real_t elMat_6_4 = tmp_kernel_op_19;
             const real_t elMat_6_5 = tmp_kernel_op_20;
