       ...
       const real_t p_affine_const_3_2_WHITE_UP = macro_vertex_coord_id_0comp2 + tmp_coords_jac_0_WHITE_UP*(-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_3comp2);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 11; q += 1)
             {
                ...
                const real_t tmp_qloop_11 = tmp_qloop_10 - 4.0;
                const real_t tmp_qloop_12 = tmp_qloop_11 + tmp_qloop_9 + 8.0*_data_q_p_2[q];
                const real_t tmp_qloop_13 = -micromesh_dof_19*tmp_qloop_10;
                const real_t tmp_qloop_14 = tmp_qloop_7 + tmp_qloop_9;
                const real_t tmp_qloop_15 = tmp_qloop_10 + tmp_qloop_14 - 3.0;
                const real_t tmp_qloop_16 = micromesh_dof_10*tmp_qloop_15;
                const real_t tmp_qloop_17 = -micromesh_dof_18*tmp_qloop_9 + tmp_qloop_16;
                const real_t tmp_qloop_18 = micromesh_dof_13*tmp_qloop_8 + micromesh_dof_14*tmp_qloop_9 + micromesh_dof_15*tmp_qloop_10 - micromesh_dof_17*tmp_qloop_12 + tmp_qloop_13 + tmp_qloop_17;
                const real_t tmp_qloop_19 = tmp_qloop_9 - 1.0;
                const real_t tmp_qloop_20 = tmp_qloop_11 + tmp_qloop_7 + 8.0*_data_q_p_1[q];
                const real_t tmp_qloop_21 = -micromesh_dof_27*tmp_qloop_7;
                const real_t tmp_qloop_22 = micromesh_dof_20*tmp_qloop_15;
                const real_t tmp_qloop_23 = -micromesh_dof_29*tmp_qloop_10 + tmp_qloop_22;
                const real_t tmp_qloop_24 = micromesh_dof_22*tmp_qloop_19 + micromesh_dof_24*tmp_qloop_7 + micromesh_dof_26*tmp_qloop_10 - micromesh_dof_28*tmp_qloop_20 + tmp_qloop_21 + tmp_qloop_23;
                const real_t tmp_qloop_25 = tmp_qloop_10 - 1.0;
                const real_t tmp_qloop_26 = tmp_qloop_14 - 4.0 + 8.0*_data_q_p_0[q];
                const real_t tmp_qloop_27 = -micromesh_dof_8*tmp_qloop_9;
                const real_t tmp_qloop_28 = micromesh_dof_0*tmp_qloop_15;
                const real_t tmp_qloop_29 = -micromesh_dof_7*tmp_qloop_7 + tmp_qloop_28;
                const real_t tmp_qloop_30 = micromesh_dof_1*tmp_qloop_25 + micromesh_dof_5*tmp_qloop_7 + micromesh_dof_6*tmp_qloop_9 - micromesh_dof_9*tmp_qloop_26 + tmp_qloop_27 + tmp_qloop_29;
                const real_t tmp_qloop_31 = -micromesh_dof_17*tmp_qloop_7;
                const real_t tmp_qloop_32 = micromesh_dof_12*tmp_qloop_19 + micromesh_dof_14*tmp_qloop_7 + micromesh_dof_16*tmp_qloop_10 - micromesh_dof_18*tmp_qloop_20 + tmp_qloop_13 + tmp_qloop_16 + tmp_qloop_31;
                const real_t tmp_qloop_33 = -micromesh_dof_9*tmp_qloop_10;
                const real_t tmp_qloop_34 = micromesh_dof_3*tmp_qloop_8 + micromesh_dof_4*tmp_qloop_9 + micromesh_dof_5*tmp_qloop_10 - micromesh_dof_7*tmp_qloop_12 + tmp_qloop_27 + tmp_qloop_28 + tmp_qloop_33;
                const real_t tmp_qloop_35 = -micromesh_dof_28*tmp_qloop_9;
                const real_t tmp_qloop_36 = micromesh_dof_21*tmp_qloop_25 + micromesh_dof_25*tmp_qloop_7 + micromesh_dof_26*tmp_qloop_9 - micromesh_dof_29*tmp_qloop_26 + tmp_qloop_21 + tmp_qloop_22 + tmp_qloop_35;
                const real_t tmp_qloop_37 = micromesh_dof_23*tmp_qloop_8 + micromesh_dof_24*tmp_qloop_9 + micromesh_dof_25*tmp_qloop_10 - micromesh_dof_27*tmp_qloop_12 + tmp_qloop_23 + tmp_qloop_35;
                const real_t tmp_qloop_38 = micromesh_dof_2*tmp_qloop_19 + micromesh_dof_4*tmp_qloop_7 + micromesh_dof_6*tmp_qloop_10 - micromesh_dof_8*tmp_qloop_20 + tmp_qloop_29 + tmp_qloop_33;
                const real_t tmp_qloop_39 = micromesh_dof_11*tmp_qloop_25 + micromesh_dof_15*tmp_qloop_7 + micromesh_dof_16*tmp_qloop_9 - micromesh_dof_19*tmp_qloop_26 + tmp_qloop_17 + tmp_qloop_31;
                const real_t tmp_qloop_40 = abs(tmp_qloop_18*tmp_qloop_24*tmp_qloop_30 - tmp_qloop_18*tmp_qloop_36*tmp_qloop_38 - tmp_qloop_24*tmp_qloop_34*tmp_qloop_39 - tmp_qloop_30*tmp_qloop_32*tmp_qloop_37 + tmp_qloop_32*tmp_qloop_34*tmp_qloop_36 + tmp_qloop_37*tmp_qloop_38*tmp_qloop_39)*_data_q_w[q];
                const real_t tmp_qloop_41 = tmp_qloop_40*16.0;
                const real_t tmp_qloop_42 = tmp_qloop_40*4.0;
                const real_t tmp_qloop_43 = tmp_qloop_3*tmp_qloop_41;
                const real_t q_tmp_0_0 = tmp_qloop_41*((tmp_qloop_0 + tmp_qloop_1*0.5 + tmp_qloop_2*0.5 + tmp_qloop_3*0.5 + tmp_qloop_6 - 0.75*_data_q_p_0[q] - 0.75*_data_q_p_1[q] - 0.75*_data_q_p_2[q] + 0.25)*(tmp_qloop_0 + tmp_qloop_1*0.5 + tmp_qloop_2*0.5 + tmp_qloop_3*0.5 + tmp_qloop_6 - 0.75*_data_q_p_0[q] - 0.75*_data_q_p_1[q] - 0.75*_data_q_p_2[q] + 0.25));
                const real_t q_tmp_1_1 = tmp_qloop_42*((tmp_qloop_1 - 0.5*_data_q_p_0[q])*(tmp_qloop_1 - 0.5*_data_q_p_0[q]));
                const real_t q_tmp_2_2 = tmp_qloop_42*((tmp_qloop_2 - 0.5*_data_q_p_1[q])*(tmp_qloop_2 - 0.5*_data_q_p_1[q]));
                const real_t q_tmp_3_3 = tmp_qloop_42*((tmp_qloop_3 - 0.5*_data_q_p_2[q])*(tmp_qloop_3 - 0.5*_data_q_p_2[q]));
                const real_t q_tmp_4_4 = tmp_qloop_2*tmp_qloop_43;
                const real_t q_tmp_5_5 = tmp_qloop_1*tmp_qloop_43;
                const real_t q_tmp_6_6 = tmp_qloop_1*tmp_qloop_2*tmp_qloop_41;
                const real_t q_tmp_7_7 = tmp_qloop_41*((-tmp_qloop_3 - tmp_qloop_6 + _data_q_p_2[q])*(-tmp_qloop_3 - tmp_qloop_6 + _data_q_p_2[q]));
                const real_t q_tmp_8_8 = tmp_qloop_41*((-tmp_qloop_0 - tmp_qloop_2 - tmp_qloop_5 + _data_q_p_1[q])*(-tmp_qloop_0 - tmp_qloop_2 - tmp_qloop_5 + _data_q_p_1[q]));
                const real_t q_tmp_9_9 = tmp_qloop_41*((-tmp_qloop_0 - tmp_qloop_1 - tmp_qloop_4 + _data_q_p_0[q])*(-tmp_qloop_0 - tmp_qloop_1 - tmp_qloop_4 + _data_q_p_0[q]));
