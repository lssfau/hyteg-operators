...
void P1ElementwiseMassBoundary::toMatrixScaled_P1ElementwiseMassBoundary_facet_id_1_macro_3D( idx_t * RESTRICT  _data_dst, idx_t * RESTRICT  _data_src, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_0comp2, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_1comp2, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, real_t macro_vertex_coord_id_2comp2, real_t macro_vertex_coord_id_3comp0, real_t macro_vertex_coord_id_3comp1, real_t macro_vertex_coord_id_3comp2, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t toMatrixScaling ) const
{
    {
       ...
       const real_t tmp_kernel_op_11 = toMatrixScaling*(tmp_kernel_op_10*0.16666666666666666 + tmp_kernel_op_8*0.16666666666666666 + tmp_kernel_op_9*0.66666666666666663);
       const real_t tmp_kernel_op_12 = toMatrixScaling*(tmp_kernel_op_10*0.16666666666666666 + tmp_kernel_op_8*0.66666666666666663 + tmp_kernel_op_9*0.16666666666666666);
       ...
       const real_t tmp_kernel_op_17 = toMatrixScaling*(tmp_kernel_op_14*0.66666666666666663 + tmp_kernel_op_15*0.16666666666666666 + tmp_kernel_op_16*0.16666666666666666);
       const int64_t tmp_kernel_op_18 = 0;
       const int64_t tmp_kernel_op_19 = 0;
       const int64_t tmp_kernel_op_20 = 0;
       const real_t elMat_0_0 = toMatrixScaling*((tmp_kernel_op_1*tmp_kernel_op_1)*tmp_kernel_op_3 + (tmp_kernel_op_4*tmp_kernel_op_4)*tmp_kernel_op_5 + (tmp_kernel_op_6*tmp_kernel_op_6)*tmp_kernel_op_7);
       ...
       const real_t elMat_1_1 = toMatrixScaling*(tmp_kernel_op_3*0.027777777777777776 + tmp_kernel_op_5*0.44444444444444442 + tmp_kernel_op_7*0.027777777777777776);
       ...
       const real_t elMat_2_2 = toMatrixScaling*(tmp_kernel_op_3*0.44444444444444442 + tmp_kernel_op_5*0.027777777777777776 + tmp_kernel_op_7*0.027777777777777776);
       ...
       const real_t elMat_3_3 = toMatrixScaling*(tmp_kernel_op_3*((real_t)(tmp_kernel_op_20)) + tmp_kernel_op_5*((real_t)(tmp_kernel_op_20)) + tmp_kernel_op_7*((real_t)(tmp_kernel_op_20)));
       {
          /* CellType.WHITE_UP */
       ...
       const real_t tmp_moved_constant_7 = toMatrixScaling*(tmp_moved_constant_4*0.16666666666666666 + tmp_moved_constant_5*0.66666666666666663 + tmp_moved_constant_6*0.16666666666666666);
       const real_t tmp_moved_constant_8 = toMatrixScaling*(tmp_moved_constant_4*0.66666666666666663 + tmp_moved_constant_5*0.16666666666666666 + tmp_moved_constant_6*0.16666666666666666);
       ...
       const real_t tmp_moved_constant_12 = toMatrixScaling*(tmp_moved_constant_10*0.16666666666666666 + tmp_moved_constant_11*0.16666666666666666 + tmp_moved_constant_9*0.66666666666666663);
       const real_t tmp_moved_constant_13 = toMatrixScaling*((tmp_kernel_op_1*tmp_kernel_op_1)*tmp_moved_constant_1 + (tmp_kernel_op_4*tmp_kernel_op_4)*tmp_moved_constant_2 + (tmp_kernel_op_6*tmp_kernel_op_6)*tmp_moved_constant_3);
       ...
       const real_t tmp_moved_constant_17 = toMatrixScaling*(tmp_moved_constant_1*0.027777777777777776 + tmp_moved_constant_2*0.44444444444444442 + tmp_moved_constant_3*0.027777777777777776);
       ...
       const real_t tmp_moved_constant_21 = toMatrixScaling*(tmp_moved_constant_1*0.44444444444444442 + tmp_moved_constant_2*0.027777777777777776 + tmp_moved_constant_3*0.027777777777777776);
       const real_t tmp_moved_constant_22 = toMatrixScaling*(tmp_moved_constant_1*((real_t)(tmp_kernel_op_20)) + tmp_moved_constant_2*((real_t)(tmp_kernel_op_20)) + tmp_moved_constant_3*((real_t)(tmp_kernel_op_20)));
       {
          /* CellType.GREEN_UP */
