...
P2ElementwiseMassBoundary::P2ElementwiseMassBoundary( const std::shared_ptr< PrimitiveStorage >& storage,
                                                      size_t                                     minLevel,
                                                      size_t                                     maxLevel,
...
, P2ElementwiseMassBoundary_boundary_uid_( P2ElementwiseMassBoundary_boundary_uid )
{}

void P2ElementwiseMassBoundary::applyScaled( const real_t&               operatorScaling,
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            applyScaled_P2ElementwiseMassBoundary_facet_id_0_macro_3D(
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            applyScaled_P2ElementwiseMassBoundary_facet_id_1_macro_3D(
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            applyScaled_P2ElementwiseMassBoundary_facet_id_2_macro_3D(
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            applyScaled_P2ElementwiseMassBoundary_facet_id_3_macro_3D(
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            applyScaled_P2ElementwiseMassBoundary_facet_id_0_macro_2D(
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            applyScaled_P2ElementwiseMassBoundary_facet_id_1_macro_2D(
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            applyScaled_P2ElementwiseMassBoundary_facet_id_2_macro_2D(
...
void P2ElementwiseMassBoundary::apply( const P2Function< real_t >& src,
                                       const P2Function< real_t >& dst,
                                       uint_t                      level,
                                       DoFType                     flag,
                                       UpdateType                  updateType ) const
...
void P2ElementwiseMassBoundary::toMatrixScaled( const real_t&                               toMatrixScaling,
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            toMatrixScaled_P2ElementwiseMassBoundary_facet_id_0_macro_3D(
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            toMatrixScaled_P2ElementwiseMassBoundary_facet_id_1_macro_3D(
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            toMatrixScaled_P2ElementwiseMassBoundary_facet_id_2_macro_3D(
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            toMatrixScaled_P2ElementwiseMassBoundary_facet_id_3_macro_3D(
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            toMatrixScaled_P2ElementwiseMassBoundary_facet_id_0_macro_2D(
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            toMatrixScaled_P2ElementwiseMassBoundary_facet_id_1_macro_2D(
         ...
         if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
              ...
              P2ElementwiseMassBoundary_boundary_uid_ )
         {
            toMatrixScaled_P2ElementwiseMassBoundary_facet_id_2_macro_2D(
...
void P2ElementwiseMassBoundary::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                          const P2Function< idx_t >&                  src,
                                          const P2Function< idx_t >&                  dst,
                                          uint_t                                      level,
                                          DoFType                                     flag ) const
...
void P2ElementwiseMassBoundary::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
                 ...
                 P2ElementwiseMassBoundary_boundary_uid_ )
            {
               computeInverseDiagonalOperatorValuesScaled_P2ElementwiseMassBoundary_facet_id_0_macro_3D(
            ...
            if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
                 ...
                 P2ElementwiseMassBoundary_boundary_uid_ )
            {
               computeInverseDiagonalOperatorValuesScaled_P2ElementwiseMassBoundary_facet_id_1_macro_3D(
            ...
            if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
                 ...
                 P2ElementwiseMassBoundary_boundary_uid_ )
            {
               computeInverseDiagonalOperatorValuesScaled_P2ElementwiseMassBoundary_facet_id_2_macro_3D(
            ...
            if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
                 ...
                 P2ElementwiseMassBoundary_boundary_uid_ )
            {
               computeInverseDiagonalOperatorValuesScaled_P2ElementwiseMassBoundary_facet_id_3_macro_3D(
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
                 ...
                 P2ElementwiseMassBoundary_boundary_uid_ )
            {
               computeInverseDiagonalOperatorValuesScaled_P2ElementwiseMassBoundary_facet_id_0_macro_2D(
            ...
            if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
                 ...
                 P2ElementwiseMassBoundary_boundary_uid_ )
            {
               computeInverseDiagonalOperatorValuesScaled_P2ElementwiseMassBoundary_facet_id_1_macro_2D(
            ...
            if ( boundaryCondition_.getBoundaryUIDFromMeshFlag(
                 ...
                 P2ElementwiseMassBoundary_boundary_uid_ )
            {
               computeInverseDiagonalOperatorValuesScaled_P2ElementwiseMassBoundary_facet_id_2_macro_2D(
...
void P2ElementwiseMassBoundary::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseMassBoundary::getInverseDiagonalValues() const
{
   return invDiag_;
}
