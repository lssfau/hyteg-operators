                                              ...
                                              public OperatorWithInverseDiagonal< P2PlusBubbleFunction< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    585     937      24      18      0              0                 0              1
   void apply_P2PlusBubbleElementwiseMassAnnulusMap_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    536     888      24      18      0              0                 0              4
   void toMatrix_P2PlusBubbleElementwiseMassAnnulusMap_macro_2D( idx_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    417     666      24      18      0              0                 0              1
   void computeInverseDiagonalOperatorValues_P2PlusBubbleElementwiseMassAnnulusMap_macro_2D(
