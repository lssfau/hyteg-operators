                                             ...
                                             public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2767    4076      58      22      0              0                 0              1
   void applyScaled_P2ElementwiseMassIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2667    4021      58      22      0              0                 0              4
   void toMatrixScaled_P2ElementwiseMassIcosahedralShellMap_macro_3D( idx_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1962    3228      58      22      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseMassIcosahedralShellMap_macro_3D(
