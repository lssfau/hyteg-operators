...
class P2ElementwiseMassBoundaryAnnulusMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                            public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseMassBoundaryAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                        size_t                                     minLevel,
                                        size_t                                     maxLevel,
 ...
 private:
   ...
   BoundaryUID                             P2ElementwiseMassBoundaryAnnulusMap_boundary_uid_;
};
