...
void P2ElementwiseShearHeatingP1ViscosityParametricP2Map::applyScaled_P2ElementwiseShearHeatingP1ViscosityParametricP2Map_macro_3D( real_t * RESTRICT  _data_dstEdge, real_t * RESTRICT  _data_dstVertex, real_t * RESTRICT  _data_eta, real_t * RESTRICT  _data_micromesh_edge_0, real_t * RESTRICT  _data_micromesh_edge_1, real_t * RESTRICT  _data_micromesh_edge_2, real_t * RESTRICT  _data_micromesh_vertex_0, real_t * RESTRICT  _data_micromesh_vertex_1, real_t * RESTRICT  _data_micromesh_vertex_2, real_t * RESTRICT  _data_srcEdge, real_t * RESTRICT  _data_srcVertex, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t * RESTRICT  _data_uzEdge, real_t * RESTRICT  _data_uzVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_0comp2, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_1comp2, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, real_t macro_vertex_coord_id_2comp2, real_t macro_vertex_coord_id_3comp0, real_t macro_vertex_coord_id_3comp1, real_t macro_vertex_coord_id_3comp2, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling ) const
{
    {
       ...
       const real_t p_affine_const_3_2_WHITE_UP = macro_vertex_coord_id_0comp2 + tmp_coords_jac_0_WHITE_UP*(-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_3comp2);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 5; q += 1)
             {
                ...
                const real_t tmp_qloop_8 = -tmp_qloop_7*uy_dof_8;
                const real_t tmp_qloop_9 = 4.0*_data_q_p_2[q];
                const real_t tmp_qloop_10 = -tmp_qloop_9*uy_dof_7;
                ...
                const real_t tmp_qloop_18 = tmp_qloop_10 + tmp_qloop_12*uy_dof_1 + tmp_qloop_15 + tmp_qloop_17*uy_dof_9 + tmp_qloop_7*uy_dof_6 + tmp_qloop_8 + tmp_qloop_9*uy_dof_5;
                ...
                const real_t tmp_qloop_62 = -tmp_qloop_11*uy_dof_9 + tmp_qloop_15;
                const real_t tmp_qloop_63 = tmp_qloop_10 + tmp_qloop_11*uy_dof_6 + tmp_qloop_21*uy_dof_8 + tmp_qloop_22*uy_dof_2 + tmp_qloop_62 + tmp_qloop_9*uy_dof_4;
                ...
                const real_t tmp_qloop_66 = tmp_qloop_11*uy_dof_5 + tmp_qloop_29*uy_dof_7 + tmp_qloop_33*uy_dof_3 + tmp_qloop_62 + tmp_qloop_7*uy_dof_4 + tmp_qloop_8;
                ...
                const real_t tmp_qloop_70 = -tmp_qloop_7*ux_dof_8;
                const real_t tmp_qloop_71 = -tmp_qloop_9*ux_dof_7;
                const real_t tmp_qloop_72 = tmp_qloop_14*ux_dof_0;
                const real_t tmp_qloop_73 = tmp_qloop_12*ux_dof_1 + tmp_qloop_17*ux_dof_9 + tmp_qloop_7*ux_dof_6 + tmp_qloop_70 + tmp_qloop_71 + tmp_qloop_72 + tmp_qloop_9*ux_dof_5;
                ...
                const real_t tmp_qloop_76 = -tmp_qloop_11*ux_dof_9 + tmp_qloop_72;
                const real_t tmp_qloop_77 = tmp_qloop_11*ux_dof_6 + tmp_qloop_21*ux_dof_8 + tmp_qloop_22*ux_dof_2 + tmp_qloop_71 + tmp_qloop_76 + tmp_qloop_9*ux_dof_4;
                ...
                const real_t tmp_qloop_80 = tmp_qloop_11*ux_dof_5 + tmp_qloop_29*ux_dof_7 + tmp_qloop_33*ux_dof_3 + tmp_qloop_7*ux_dof_4 + tmp_qloop_70 + tmp_qloop_76;
                ...
                const real_t tmp_qloop_85 = -tmp_qloop_7*uz_dof_8;
                const real_t tmp_qloop_86 = -tmp_qloop_9*uz_dof_7;
                const real_t tmp_qloop_87 = tmp_qloop_14*uz_dof_0;
                const real_t tmp_qloop_88 = tmp_qloop_12*uz_dof_1 + tmp_qloop_17*uz_dof_9 + tmp_qloop_7*uz_dof_6 + tmp_qloop_85 + tmp_qloop_86 + tmp_qloop_87 + tmp_qloop_9*uz_dof_5;
                const real_t tmp_qloop_89 = tmp_qloop_59*tmp_qloop_88;
                const real_t tmp_qloop_90 = -tmp_qloop_11*uz_dof_9 + tmp_qloop_87;
                const real_t tmp_qloop_91 = tmp_qloop_11*uz_dof_6 + tmp_qloop_21*uz_dof_8 + tmp_qloop_22*uz_dof_2 + tmp_qloop_86 + tmp_qloop_9*uz_dof_4 + tmp_qloop_90;
                const real_t tmp_qloop_92 = tmp_qloop_59*tmp_qloop_91;
                const real_t tmp_qloop_93 = tmp_qloop_11*uz_dof_5 + tmp_qloop_29*uz_dof_7 + tmp_qloop_33*uz_dof_3 + tmp_qloop_7*uz_dof_4 + tmp_qloop_85 + tmp_qloop_90;
                ...
                const real_t tmp_qloop_128 = (eta_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q] - _data_q_p_2[q]) + eta_dof_1*_data_q_p_0[q] + eta_dof_2*_data_q_p_1[q] + eta_dof_3*_data_q_p_2[q])*(tmp_qloop_102*tmp_qloop_103 + tmp_qloop_103*tmp_qloop_95 + tmp_qloop_104*tmp_qloop_106 + tmp_qloop_105*tmp_qloop_106 + tmp_qloop_69*tmp_qloop_84 + tmp_qloop_83*tmp_qloop_84 + (tmp_qloop_107 + tmp_qloop_108 + tmp_qloop_109)*(-tmp_qloop_113 - tmp_qloop_117 + tmp_qloop_59*tmp_qloop_60*tmp_qloop_73*1.3333333333333333 + tmp_qloop_59*tmp_qloop_64*tmp_qloop_77*1.3333333333333333 + tmp_qloop_59*tmp_qloop_67*tmp_qloop_80*1.3333333333333333) + (tmp_qloop_110 + tmp_qloop_111 + tmp_qloop_112)*(-tmp_qloop_117 - tmp_qloop_118 + tmp_qloop_18*tmp_qloop_59*tmp_qloop_74*1.3333333333333333 + tmp_qloop_59*tmp_qloop_63*tmp_qloop_78*1.3333333333333333 + tmp_qloop_59*tmp_qloop_66*tmp_qloop_81*1.3333333333333333) + (tmp_qloop_114 + tmp_qloop_115 + tmp_qloop_116)*(tmp_qloop_100*tmp_qloop_59*tmp_qloop_93*1.3333333333333333 - tmp_qloop_113 - tmp_qloop_118 + tmp_qloop_59*tmp_qloop_88*tmp_qloop_96*1.3333333333333333 + tmp_qloop_59*tmp_qloop_91*tmp_qloop_98*1.3333333333333333))*abs(tmp_qloop_119*tmp_qloop_120*tmp_qloop_121 - tmp_qloop_119*tmp_qloop_124*tmp_qloop_126 - tmp_qloop_120*tmp_qloop_123*tmp_qloop_127 - tmp_qloop_121*tmp_qloop_122*tmp_qloop_125 + tmp_qloop_122*tmp_qloop_123*tmp_qloop_124 + tmp_qloop_125*tmp_qloop_126*tmp_qloop_127)*_data_q_w[q];
                const real_t tmp_qloop_129 = tmp_qloop_128*16.0;
                const real_t tmp_qloop_130 = tmp_qloop_1*2.0;
                const real_t tmp_qloop_131 = tmp_qloop_130 - _data_q_p_0[q];
                const real_t tmp_qloop_132 = tmp_qloop_2*2.0;
                const real_t tmp_qloop_133 = tmp_qloop_3*2.0;
                const real_t tmp_qloop_134 = tmp_qloop_0*4.0;
                const real_t tmp_qloop_135 = tmp_qloop_4*4.0;
                const real_t tmp_qloop_136 = tmp_qloop_5*4.0;
                const real_t tmp_qloop_137 = tmp_qloop_135 + tmp_qloop_136;
                const real_t tmp_qloop_138 = tmp_qloop_128*(tmp_qloop_130 + tmp_qloop_132 + tmp_qloop_133 + tmp_qloop_134 + tmp_qloop_137 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] - 3.0*_data_q_p_2[q] + 1.0);
                const real_t tmp_qloop_139 = tmp_qloop_132 - _data_q_p_1[q];
                const real_t tmp_qloop_140 = tmp_qloop_133 - _data_q_p_2[q];
                const real_t tmp_qloop_141 = -tmp_qloop_137 + tmp_qloop_3*-4.0 + tmp_qloop_9;
                const real_t tmp_qloop_142 = -tmp_qloop_134 - tmp_qloop_136 + tmp_qloop_2*-4.0 + tmp_qloop_7;
                const real_t tmp_qloop_143 = tmp_qloop_1*-4.0 + tmp_qloop_11 - tmp_qloop_134 - tmp_qloop_135;
                const real_t tmp_qloop_144 = tmp_qloop_128*4.0;
                const real_t tmp_qloop_145 = tmp_qloop_128*tmp_qloop_131;
                const real_t tmp_qloop_146 = tmp_qloop_128*tmp_qloop_139;
                const real_t tmp_qloop_147 = tmp_qloop_128*tmp_qloop_140;
                const real_t tmp_qloop_148 = tmp_qloop_129*tmp_qloop_3;
                const real_t tmp_qloop_149 = tmp_qloop_129*tmp_qloop_2;
                const real_t tmp_qloop_150 = tmp_qloop_128*tmp_qloop_141;
                const real_t tmp_qloop_151 = tmp_qloop_128*tmp_qloop_142;
                const real_t tmp_qloop_152 = tmp_qloop_128*tmp_qloop_143;
                ...
                const real_t q_tmp_0_1 = tmp_qloop_131*tmp_qloop_138;
                const real_t q_tmp_0_2 = tmp_qloop_138*tmp_qloop_139;
                const real_t q_tmp_0_3 = tmp_qloop_138*tmp_qloop_140;
                const real_t q_tmp_0_4 = tmp_qloop_136*tmp_qloop_138;
                const real_t q_tmp_0_5 = tmp_qloop_135*tmp_qloop_138;
                const real_t q_tmp_0_6 = tmp_qloop_134*tmp_qloop_138;
                const real_t q_tmp_0_7 = tmp_qloop_138*tmp_qloop_141;
                const real_t q_tmp_0_8 = tmp_qloop_138*tmp_qloop_142;
                const real_t q_tmp_0_9 = tmp_qloop_138*tmp_qloop_143;
                const real_t q_tmp_1_1 = tmp_qloop_144*((tmp_qloop_1 - 0.5*_data_q_p_0[q])*(tmp_qloop_1 - 0.5*_data_q_p_0[q]));
                const real_t q_tmp_1_2 = tmp_qloop_139*tmp_qloop_145;
                const real_t q_tmp_1_3 = tmp_qloop_140*tmp_qloop_145;
                const real_t q_tmp_1_4 = tmp_qloop_136*tmp_qloop_145;
                const real_t q_tmp_1_5 = tmp_qloop_135*tmp_qloop_145;
                const real_t q_tmp_1_6 = tmp_qloop_134*tmp_qloop_145;
                const real_t q_tmp_1_7 = tmp_qloop_141*tmp_qloop_145;
                const real_t q_tmp_1_8 = tmp_qloop_142*tmp_qloop_145;
                const real_t q_tmp_1_9 = tmp_qloop_143*tmp_qloop_145;
                const real_t q_tmp_2_2 = tmp_qloop_144*((tmp_qloop_2 - 0.5*_data_q_p_1[q])*(tmp_qloop_2 - 0.5*_data_q_p_1[q]));
                const real_t q_tmp_2_3 = tmp_qloop_140*tmp_qloop_146;
                const real_t q_tmp_2_4 = tmp_qloop_136*tmp_qloop_146;
                const real_t q_tmp_2_5 = tmp_qloop_135*tmp_qloop_146;
                const real_t q_tmp_2_6 = tmp_qloop_134*tmp_qloop_146;
                const real_t q_tmp_2_7 = tmp_qloop_141*tmp_qloop_146;
                const real_t q_tmp_2_8 = tmp_qloop_142*tmp_qloop_146;
                const real_t q_tmp_2_9 = tmp_qloop_143*tmp_qloop_146;
                const real_t q_tmp_3_3 = tmp_qloop_144*((tmp_qloop_3 - 0.5*_data_q_p_2[q])*(tmp_qloop_3 - 0.5*_data_q_p_2[q]));
                const real_t q_tmp_3_4 = tmp_qloop_136*tmp_qloop_147;
                const real_t q_tmp_3_5 = tmp_qloop_135*tmp_qloop_147;
                const real_t q_tmp_3_6 = tmp_qloop_134*tmp_qloop_147;
                const real_t q_tmp_3_7 = tmp_qloop_141*tmp_qloop_147;
                const real_t q_tmp_3_8 = tmp_qloop_142*tmp_qloop_147;
                const real_t q_tmp_3_9 = tmp_qloop_143*tmp_qloop_147;
                const real_t q_tmp_4_4 = tmp_qloop_148*tmp_qloop_2;
                const real_t q_tmp_4_5 = tmp_qloop_0*tmp_qloop_148;
                const real_t q_tmp_4_6 = tmp_qloop_149*tmp_qloop_4;
                const real_t q_tmp_4_7 = tmp_qloop_136*tmp_qloop_150;
                const real_t q_tmp_4_8 = tmp_qloop_136*tmp_qloop_151;
                const real_t q_tmp_4_9 = tmp_qloop_136*tmp_qloop_152;
                const real_t q_tmp_5_5 = tmp_qloop_1*tmp_qloop_148;
                const real_t q_tmp_5_6 = tmp_qloop_1*tmp_qloop_129*tmp_qloop_5;
                const real_t q_tmp_5_7 = tmp_qloop_135*tmp_qloop_150;
                const real_t q_tmp_5_8 = tmp_qloop_135*tmp_qloop_151;
                const real_t q_tmp_5_9 = tmp_qloop_135*tmp_qloop_152;
                const real_t q_tmp_6_6 = tmp_qloop_1*tmp_qloop_149;
                const real_t q_tmp_6_7 = tmp_qloop_134*tmp_qloop_150;
                const real_t q_tmp_6_8 = tmp_qloop_134*tmp_qloop_151;
                const real_t q_tmp_6_9 = tmp_qloop_134*tmp_qloop_152;
                const real_t q_tmp_7_7 = tmp_qloop_129*((-tmp_qloop_3 - tmp_qloop_6 + _data_q_p_2[q])*(-tmp_qloop_3 - tmp_qloop_6 + _data_q_p_2[q]));
                const real_t q_tmp_7_8 = tmp_qloop_142*tmp_qloop_150;
                const real_t q_tmp_7_9 = tmp_qloop_143*tmp_qloop_150;
                ...
                const real_t q_tmp_8_9 = tmp_qloop_143*tmp_qloop_151;
