...
void P2ElementwiseShearHeatingP1Viscosity::applyScaled_P2ElementwiseShearHeatingP1Viscosity_macro_3D( real_t * RESTRICT  _data_dstEdge, real_t * RESTRICT  _data_dstVertex, real_t * RESTRICT  _data_eta, real_t * RESTRICT  _data_srcEdge, real_t * RESTRICT  _data_srcVertex, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t * RESTRICT  _data_uzEdge, real_t * RESTRICT  _data_uzVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_0comp2, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_1comp2, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, real_t macro_vertex_coord_id_2comp2, real_t macro_vertex_coord_id_3comp0, real_t macro_vertex_coord_id_3comp1, real_t macro_vertex_coord_id_3comp2, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling ) const
{
    {
       ...
       const real_t abs_det_jac_affine_WHITE_UP = abs(tmp_coords_jac_6_WHITE_UP);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 5; q += 1)
             {
                ...
                const real_t tmp_qloop_63 = tmp_qloop_1*2.0;
                const real_t tmp_qloop_64 = tmp_qloop_63 - _data_q_p_0[q];
                const real_t tmp_qloop_65 = tmp_qloop_2*2.0;
                const real_t tmp_qloop_66 = tmp_qloop_3*2.0;
                const real_t tmp_qloop_67 = tmp_qloop_0*4.0;
                const real_t tmp_qloop_68 = tmp_qloop_4*4.0;
                const real_t tmp_qloop_69 = tmp_qloop_5*4.0;
                const real_t tmp_qloop_70 = tmp_qloop_68 + tmp_qloop_69;
                const real_t tmp_qloop_71 = tmp_qloop_61*(tmp_qloop_63 + tmp_qloop_65 + tmp_qloop_66 + tmp_qloop_67 + tmp_qloop_70 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] - 3.0*_data_q_p_2[q] + 1.0);
                const real_t tmp_qloop_72 = tmp_qloop_65 - _data_q_p_1[q];
                const real_t tmp_qloop_73 = tmp_qloop_66 - _data_q_p_2[q];
                const real_t tmp_qloop_74 = tmp_qloop_10 + tmp_qloop_3*-4.0 - tmp_qloop_70;
                const real_t tmp_qloop_75 = tmp_qloop_2*-4.0 - tmp_qloop_67 - tmp_qloop_69 + tmp_qloop_9;
                const real_t tmp_qloop_76 = tmp_qloop_1*-4.0 - tmp_qloop_67 - tmp_qloop_68 + tmp_qloop_7;
                const real_t tmp_qloop_77 = tmp_qloop_61*4.0;
                const real_t tmp_qloop_78 = tmp_qloop_61*tmp_qloop_64;
                const real_t tmp_qloop_79 = tmp_qloop_61*tmp_qloop_72;
                const real_t tmp_qloop_80 = tmp_qloop_61*tmp_qloop_73;
                const real_t tmp_qloop_81 = tmp_qloop_3*tmp_qloop_62;
                const real_t tmp_qloop_82 = tmp_qloop_2*tmp_qloop_62;
                const real_t tmp_qloop_83 = tmp_qloop_61*tmp_qloop_74;
                const real_t tmp_qloop_84 = tmp_qloop_61*tmp_qloop_75;
                const real_t tmp_qloop_85 = tmp_qloop_61*tmp_qloop_76;
                ...
                const real_t q_tmp_0_1 = tmp_qloop_64*tmp_qloop_71;
                const real_t q_tmp_0_2 = tmp_qloop_71*tmp_qloop_72;
                const real_t q_tmp_0_3 = tmp_qloop_71*tmp_qloop_73;
                const real_t q_tmp_0_4 = tmp_qloop_69*tmp_qloop_71;
                const real_t q_tmp_0_5 = tmp_qloop_68*tmp_qloop_71;
                const real_t q_tmp_0_6 = tmp_qloop_67*tmp_qloop_71;
                const real_t q_tmp_0_7 = tmp_qloop_71*tmp_qloop_74;
                const real_t q_tmp_0_8 = tmp_qloop_71*tmp_qloop_75;
                const real_t q_tmp_0_9 = tmp_qloop_71*tmp_qloop_76;
                const real_t q_tmp_1_1 = tmp_qloop_77*((tmp_qloop_1 - 0.5*_data_q_p_0[q])*(tmp_qloop_1 - 0.5*_data_q_p_0[q]));
                const real_t q_tmp_1_2 = tmp_qloop_72*tmp_qloop_78;
                const real_t q_tmp_1_3 = tmp_qloop_73*tmp_qloop_78;
                const real_t q_tmp_1_4 = tmp_qloop_69*tmp_qloop_78;
                const real_t q_tmp_1_5 = tmp_qloop_68*tmp_qloop_78;
                const real_t q_tmp_1_6 = tmp_qloop_67*tmp_qloop_78;
                const real_t q_tmp_1_7 = tmp_qloop_74*tmp_qloop_78;
                const real_t q_tmp_1_8 = tmp_qloop_75*tmp_qloop_78;
                const real_t q_tmp_1_9 = tmp_qloop_76*tmp_qloop_78;
                const real_t q_tmp_2_2 = tmp_qloop_77*((tmp_qloop_2 - 0.5*_data_q_p_1[q])*(tmp_qloop_2 - 0.5*_data_q_p_1[q]));
                const real_t q_tmp_2_3 = tmp_qloop_73*tmp_qloop_79;
                const real_t q_tmp_2_4 = tmp_qloop_69*tmp_qloop_79;
                const real_t q_tmp_2_5 = tmp_qloop_68*tmp_qloop_79;
                const real_t q_tmp_2_6 = tmp_qloop_67*tmp_qloop_79;
                const real_t q_tmp_2_7 = tmp_qloop_74*tmp_qloop_79;
                const real_t q_tmp_2_8 = tmp_qloop_75*tmp_qloop_79;
                const real_t q_tmp_2_9 = tmp_qloop_76*tmp_qloop_79;
                const real_t q_tmp_3_3 = tmp_qloop_77*((tmp_qloop_3 - 0.5*_data_q_p_2[q])*(tmp_qloop_3 - 0.5*_data_q_p_2[q]));
                const real_t q_tmp_3_4 = tmp_qloop_69*tmp_qloop_80;
                const real_t q_tmp_3_5 = tmp_qloop_68*tmp_qloop_80;
                const real_t q_tmp_3_6 = tmp_qloop_67*tmp_qloop_80;
                const real_t q_tmp_3_7 = tmp_qloop_74*tmp_qloop_80;
                const real_t q_tmp_3_8 = tmp_qloop_75*tmp_qloop_80;
                const real_t q_tmp_3_9 = tmp_qloop_76*tmp_qloop_80;
                const real_t q_tmp_4_4 = tmp_qloop_2*tmp_qloop_81;
                const real_t q_tmp_4_5 = tmp_qloop_0*tmp_qloop_81;
                const real_t q_tmp_4_6 = tmp_qloop_4*tmp_qloop_82;
                const real_t q_tmp_4_7 = tmp_qloop_69*tmp_qloop_83;
                const real_t q_tmp_4_8 = tmp_qloop_69*tmp_qloop_84;
                const real_t q_tmp_4_9 = tmp_qloop_69*tmp_qloop_85;
                const real_t q_tmp_5_5 = tmp_qloop_1*tmp_qloop_81;
                const real_t q_tmp_5_6 = tmp_qloop_1*tmp_qloop_5*tmp_qloop_62;
                const real_t q_tmp_5_7 = tmp_qloop_68*tmp_qloop_83;
                const real_t q_tmp_5_8 = tmp_qloop_68*tmp_qloop_84;
                const real_t q_tmp_5_9 = tmp_qloop_68*tmp_qloop_85;
                const real_t q_tmp_6_6 = tmp_qloop_1*tmp_qloop_82;
                const real_t q_tmp_6_7 = tmp_qloop_67*tmp_qloop_83;
                const real_t q_tmp_6_8 = tmp_qloop_67*tmp_qloop_84;
                const real_t q_tmp_6_9 = tmp_qloop_67*tmp_qloop_85;
                const real_t q_tmp_7_7 = tmp_qloop_62*((-tmp_qloop_3 - tmp_qloop_6 + _data_q_p_2[q])*(-tmp_qloop_3 - tmp_qloop_6 + _data_q_p_2[q]));
                const real_t q_tmp_7_8 = tmp_qloop_75*tmp_qloop_83;
                const real_t q_tmp_7_9 = tmp_qloop_76*tmp_qloop_83;
                ...
                const real_t q_tmp_8_9 = tmp_qloop_76*tmp_qloop_84;
