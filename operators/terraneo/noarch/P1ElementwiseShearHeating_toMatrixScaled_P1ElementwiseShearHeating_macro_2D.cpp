...
void P1ElementwiseShearHeating::toMatrixScaled_P1ElementwiseShearHeating_macro_2D( idx_t * RESTRICT  _data_dst, real_t * RESTRICT  _data_eta, idx_t * RESTRICT  _data_src, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t toMatrixScaling ) const
{
    {
       ...
       const real_t abs_det_jac_affine_GRAY = abs(tmp_coords_jac_1_GRAY);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             const real_t tmp_kernel_op_2 = q_acc_1_2*toMatrixScaling;
             ...
             const real_t elMat_1_2 = tmp_kernel_op_2;
             const real_t elMat_2_0 = tmp_kernel_op_1;
             const real_t elMat_2_1 = tmp_kernel_op_2;
