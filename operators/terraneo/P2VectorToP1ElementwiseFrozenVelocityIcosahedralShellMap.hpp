...
class P2VectorToP1ElementwiseFrozenVelocityIcosahedralShellMap
: public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 public:
   P2VectorToP1ElementwiseFrozenVelocityIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                             size_t                                     minLevel,
                                                             size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorToP1ElementwiseFrozenVelocityIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1938    2551      51      10      0              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseFrozenVelocityIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1818    2547      51      10      0              0                 0              4
   void
       toMatrixScaled_P2VectorToP1ElementwiseFrozenVelocityIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst,
                                                                                         real_t* RESTRICT _data_rhoEdge,
                                                                                         real_t* RESTRICT _data_rhoVertex,
