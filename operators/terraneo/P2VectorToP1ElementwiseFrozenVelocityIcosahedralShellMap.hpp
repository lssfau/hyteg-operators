...
: public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 ...
 private:
   ...
   void apply_P2VectorToP1ElementwiseFrozenVelocityIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst,
   ...
   void toMatrix_P2VectorToP1ElementwiseFrozenVelocityIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst,
                                                                                    real_t* RESTRICT _data_rhoEdge,
                                                                                    real_t* RESTRICT _data_rhoVertex,
