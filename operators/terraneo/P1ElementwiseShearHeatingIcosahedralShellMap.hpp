                                                     ...
                                                     public OperatorWithInverseDiagonal< P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1529    2173      46      10      0              0                 0              1
   void apply_P1ElementwiseShearHeatingIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1513    2157      46      10      0              0                 0              4
   void toMatrix_P1ElementwiseShearHeatingIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst,
                                                                        real_t* RESTRICT _data_mu,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1487    2112      46      10      0              0                 0              1
   void computeInverseDiagonalOperatorValues_P1ElementwiseShearHeatingIcosahedralShellMap_macro_3D(
