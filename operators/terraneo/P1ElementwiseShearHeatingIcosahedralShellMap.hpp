...
class P1ElementwiseShearHeatingIcosahedralShellMap : public Operator< P1Function< real_t >, P1Function< real_t > >,
                                                     public OperatorWithInverseDiagonal< P1Function< real_t > >
{
 public:
   P1ElementwiseShearHeatingIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                 size_t                                     minLevel,
                                                 size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P1ElementwiseShearHeatingIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1529    2177      46      10      0              0                 0              1
   void applyScaled_P1ElementwiseShearHeatingIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1513    2167      46      10      0              0                 0              4
   void toMatrixScaled_P1ElementwiseShearHeatingIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst,
                                                                              real_t* RESTRICT _data_eta,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1487    2116      46      10      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P1ElementwiseShearHeatingIcosahedralShellMap_macro_3D(
       real_t* RESTRICT _data_eta,
