...
class P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap
: public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 ...
 protected:
 private:
   /// Integral: P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1773    2427      51      10      0              0                 0              1
   void apply_P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1653    2307      51      10      0              0                 0              4
   void toMatrix_P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap_macro_3D(
