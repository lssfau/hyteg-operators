...
: public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1773    2431      51      10      0              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1653    2427      51      10      0              0                 0              4
   void toMatrixScaled_P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap_macro_3D(
