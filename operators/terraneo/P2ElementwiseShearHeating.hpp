                                  ...
                                  public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    352     406      12       0      0              0                 0              1
   void applyScaled_P2ElementwiseShearHeating_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1268    1337      36       0      0              0                 0              1
   void applyScaled_P2ElementwiseShearHeating_macro_3D( real_t* RESTRICT _data_dstEdge,
                                                        real_t* RESTRICT _data_dstVertex,
                                                        real_t* RESTRICT _data_etaEdge,
                                                        real_t* RESTRICT _data_etaVertex,
                                                        real_t* RESTRICT _data_srcEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    316     385      12       0      0              0                 0              4
   void toMatrixScaled_P2ElementwiseShearHeating_macro_2D( idx_t* RESTRICT                      _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1168    1282      36       0      0              0                 0              4
   void toMatrixScaled_P2ElementwiseShearHeating_macro_3D( idx_t* RESTRICT                      _data_dstEdge,
                                                           idx_t* RESTRICT                      _data_dstVertex,
                                                           real_t* RESTRICT                     _data_etaEdge,
                                                           real_t* RESTRICT                     _data_etaVertex,
                                                           idx_t* RESTRICT                      _data_srcEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    262     290      12       0      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseShearHeating_macro_2D(
       real_t* RESTRICT _data_etaEdge,
       real_t* RESTRICT _data_etaVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    953     972      36       0      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseShearHeating_macro_3D(
       real_t* RESTRICT _data_etaEdge,
       real_t* RESTRICT _data_etaVertex,
       real_t* RESTRICT _data_invDiag_Edge,
       real_t* RESTRICT _data_invDiag_Vertex,
