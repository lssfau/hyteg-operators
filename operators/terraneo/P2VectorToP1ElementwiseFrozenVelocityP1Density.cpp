                                                            ...
                                                            UpdateType                        updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         apply_P2VectorToP1ElementwiseFrozenVelocityP1Density_macro_3D(
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         apply_P2VectorToP1ElementwiseFrozenVelocityP1Density_macro_2D(
                                                               ...
                                                               DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrix_P2VectorToP1ElementwiseFrozenVelocityP1Density_macro_3D(
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrix_P2VectorToP1ElementwiseFrozenVelocityP1Density_macro_2D(
