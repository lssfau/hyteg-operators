...
P2VectorToP1ElementwiseFrozenVelocityAnnulusMap::P2VectorToP1ElementwiseFrozenVelocityAnnulusMap(
...
void P2VectorToP1ElementwiseFrozenVelocityAnnulusMap::applyScaled( const real_t&                     operatorScaling,
                                                                   ...
                                                                   UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2VectorToP1ElementwiseFrozenVelocityAnnulusMap_macro_2D(
...
void P2VectorToP1ElementwiseFrozenVelocityAnnulusMap::apply( const P2VectorFunction< real_t >& src,
                                                             const P1Function< real_t >&       dst,
                                                             uint_t                            level,
                                                             DoFType                           flag,
                                                             UpdateType                        updateType ) const
...
void P2VectorToP1ElementwiseFrozenVelocityAnnulusMap::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                                      ...
                                                                      DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2VectorToP1ElementwiseFrozenVelocityAnnulusMap_macro_2D(
...
void P2VectorToP1ElementwiseFrozenVelocityAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                const P2VectorFunction< idx_t >&            src,
                                                                const P1Function< idx_t >&                  dst,
                                                                uint_t                                      level,
                                                                DoFType                                     flag ) const
