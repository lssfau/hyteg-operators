                                            ...
                                            public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    556     762      20      12      0              0                 0              1
   void applyScaled_P2ElementwiseShearHeatingAnnulusMap_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    520     741      20      12      0              0                 0              4
   void toMatrixScaled_P2ElementwiseShearHeatingAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    466     646      20      12      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseShearHeatingAnnulusMap_macro_2D(
       real_t* RESTRICT _data_etaEdge,
       real_t* RESTRICT _data_etaVertex,
