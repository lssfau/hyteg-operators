...
P1ElementwiseShearHeating::P1ElementwiseShearHeating( const std::shared_ptr< PrimitiveStorage >& storage,
                                                      size_t                                     minLevel,
                                                      size_t                                     maxLevel,
...
void P1ElementwiseShearHeating::applyScaled( const real_t&               operatorScaling,
                                             ...
                                             UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P1ElementwiseShearHeating_macro_3D(
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P1ElementwiseShearHeating_macro_2D(
...
void P1ElementwiseShearHeating::apply( const P1Function< real_t >& src,
                                       const P1Function< real_t >& dst,
                                       uint_t                      level,
                                       DoFType                     flag,
                                       UpdateType                  updateType ) const
                                                ...
                                                DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P1ElementwiseShearHeating_macro_3D(
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P1ElementwiseShearHeating_macro_2D(
...
void P1ElementwiseShearHeating::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                          const P1Function< idx_t >&                  src,
                                          const P1Function< idx_t >&                  dst,
                                          uint_t                                      level,
                                          DoFType                                     flag ) const
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P1ElementwiseShearHeating_macro_3D(
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P1ElementwiseShearHeating_macro_2D(
