...
void P1ElementwiseShearHeating::applyScaled_P1ElementwiseShearHeating_macro_2D( real_t * RESTRICT  _data_dst, real_t * RESTRICT  _data_eta, real_t * RESTRICT  _data_src, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling ) const
{
    {
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_22 = _mm256_mul_pd(tmp_qloop_0,tmp_qloop_21);
                   const __m256d q_tmp_0_0 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_0,tmp_qloop_0),tmp_qloop_21);
                   const __m256d q_tmp_0_1 = _mm256_mul_pd(tmp_qloop_22,_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q]));
                   const __m256d q_tmp_0_2 = _mm256_mul_pd(tmp_qloop_22,_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q]));
                   ...
                   const __m256d q_tmp_1_2 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_21,_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q]));
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const real_t tmp_qloop_22 = tmp_qloop_0*tmp_qloop_21;
                   const real_t q_tmp_0_0 = (tmp_qloop_0*tmp_qloop_0)*tmp_qloop_21;
                   const real_t q_tmp_0_1 = tmp_qloop_22*_data_q_p_0[q];
                   const real_t q_tmp_0_2 = tmp_qloop_22*_data_q_p_1[q];
                   const real_t q_tmp_1_1 = tmp_qloop_21*(_data_q_p_0[q]*_data_q_p_0[q]);
                   const real_t q_tmp_1_2 = tmp_qloop_21*_data_q_p_0[q]*_data_q_p_1[q];
