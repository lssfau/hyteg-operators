...
void P2ElementwiseShearHeatingP1Viscosity::apply_P2ElementwiseShearHeatingP1Viscosity_macro_2D( real_t * RESTRICT  _data_dstEdge, real_t * RESTRICT  _data_dstVertex, real_t * RESTRICT  _data_mu, real_t * RESTRICT  _data_srcEdge, real_t * RESTRICT  _data_srcVertex, real_t * RESTRICT  _data_wxEdge, real_t * RESTRICT  _data_wxVertex, real_t * RESTRICT  _data_wyEdge, real_t * RESTRICT  _data_wyVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float ) const
{
    {
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_15 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_0,wy_dof_3),_mm256_mul_pd(tmp_qloop_13,wy_dof_2)),_mm256_mul_pd(tmp_qloop_14,wy_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_0,wy_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_10);
                   ...
                   const __m256d tmp_qloop_17 = _mm256_mul_pd(tmp_qloop_9,wx_dof_0);
                   const __m256d tmp_qloop_18 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_11,wx_dof_5),_mm256_mul_pd(tmp_qloop_7,wx_dof_3)),_mm256_mul_pd(tmp_qloop_8,wx_dof_1)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_7,wx_dof_4),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_17);
                   const __m256d tmp_qloop_19 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_0,wx_dof_3),_mm256_mul_pd(tmp_qloop_13,wx_dof_2)),_mm256_mul_pd(tmp_qloop_14,wx_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_0,wx_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_17);
                   ...
                   const __m256d tmp_qloop_32 = _mm256_mul_pd(tmp_qloop_26,tmp_qloop_27);
                   const __m256d tmp_qloop_33 = _mm256_mul_pd(tmp_qloop_26,tmp_qloop_29);
                   const __m256d tmp_qloop_34 = _mm256_mul_pd(tmp_qloop_26,tmp_qloop_30);
                   const __m256d q_tmp_0_0 = _mm256_mul_pd(tmp_qloop_26,_mm256_mul_pd(tmp_qloop_6,tmp_qloop_6));
                   const __m256d q_tmp_0_1 = _mm256_mul_pd(tmp_qloop_27,tmp_qloop_28);
                   const __m256d q_tmp_0_2 = _mm256_mul_pd(tmp_qloop_28,tmp_qloop_29);
                   const __m256d q_tmp_0_3 = _mm256_mul_pd(tmp_qloop_1,tmp_qloop_28);
                   const __m256d q_tmp_0_4 = _mm256_mul_pd(tmp_qloop_28,tmp_qloop_30);
                   const __m256d q_tmp_0_5 = _mm256_mul_pd(tmp_qloop_28,tmp_qloop_31);
                   const __m256d q_tmp_1_1 = _mm256_mul_pd(tmp_qloop_26,_mm256_mul_pd(tmp_qloop_27,tmp_qloop_27));
                   const __m256d q_tmp_1_2 = _mm256_mul_pd(tmp_qloop_29,tmp_qloop_32);
                   const __m256d q_tmp_1_3 = _mm256_mul_pd(tmp_qloop_1,tmp_qloop_32);
                   const __m256d q_tmp_1_4 = _mm256_mul_pd(tmp_qloop_30,tmp_qloop_32);
                   const __m256d q_tmp_1_5 = _mm256_mul_pd(tmp_qloop_31,tmp_qloop_32);
                   const __m256d q_tmp_2_2 = _mm256_mul_pd(tmp_qloop_26,_mm256_mul_pd(tmp_qloop_29,tmp_qloop_29));
                   const __m256d q_tmp_2_3 = _mm256_mul_pd(tmp_qloop_1,tmp_qloop_33);
                   const __m256d q_tmp_2_4 = _mm256_mul_pd(tmp_qloop_30,tmp_qloop_33);
                   const __m256d q_tmp_2_5 = _mm256_mul_pd(tmp_qloop_31,tmp_qloop_33);
                   const __m256d q_tmp_3_3 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_2,tmp_qloop_26),tmp_qloop_4),_mm256_set_pd(16.0,16.0,16.0,16.0));
                   const __m256d q_tmp_3_4 = _mm256_mul_pd(tmp_qloop_1,tmp_qloop_34);
                   const __m256d q_tmp_3_5 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_1,tmp_qloop_26),tmp_qloop_31);
                   const __m256d q_tmp_4_4 = _mm256_mul_pd(tmp_qloop_26,_mm256_mul_pd(tmp_qloop_30,tmp_qloop_30));
                   const __m256d q_tmp_4_5 = _mm256_mul_pd(tmp_qloop_31,tmp_qloop_34);
                   const __m256d q_tmp_5_5 = _mm256_mul_pd(tmp_qloop_26,_mm256_mul_pd(tmp_qloop_31,tmp_qloop_31));
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const real_t tmp_qloop_15 = tmp_qloop_0*wy_dof_3 - tmp_qloop_0*wy_dof_5 + tmp_qloop_10 + tmp_qloop_13*wy_dof_2 + tmp_qloop_14*wy_dof_4;
                   const real_t tmp_qloop_16 = jac_affine_inv_0_0_GRAY*tmp_qloop_12 + jac_affine_inv_1_0_GRAY*tmp_qloop_15;
                   const real_t tmp_qloop_17 = tmp_qloop_9*wx_dof_0;
                   const real_t tmp_qloop_18 = tmp_qloop_11*wx_dof_5 + tmp_qloop_17 + tmp_qloop_7*wx_dof_3 - tmp_qloop_7*wx_dof_4 + tmp_qloop_8*wx_dof_1;
                   const real_t tmp_qloop_19 = tmp_qloop_0*wx_dof_3 - tmp_qloop_0*wx_dof_5 + tmp_qloop_13*wx_dof_2 + tmp_qloop_14*wx_dof_4 + tmp_qloop_17;
                   ...
                   const real_t tmp_qloop_26 = abs_det_jac_affine_GRAY*(mu_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + mu_dof_1*_data_q_p_0[q] + mu_dof_2*_data_q_p_1[q])*(tmp_qloop_16*tmp_qloop_21 + tmp_qloop_20*tmp_qloop_21 + tmp_qloop_22*tmp_qloop_25 - tmp_qloop_25*(tmp_qloop_23 + tmp_qloop_24))*_data_q_w[q];
                   const real_t tmp_qloop_27 = tmp_qloop_3 - _data_q_p_0[q];
                   const real_t tmp_qloop_28 = tmp_qloop_26*tmp_qloop_6;
                   ...
                   const real_t tmp_qloop_32 = tmp_qloop_26*tmp_qloop_27;
                   const real_t tmp_qloop_33 = tmp_qloop_26*tmp_qloop_29;
                   const real_t tmp_qloop_34 = tmp_qloop_26*tmp_qloop_30;
                   const real_t q_tmp_0_0 = tmp_qloop_26*(tmp_qloop_6*tmp_qloop_6);
                   const real_t q_tmp_0_1 = tmp_qloop_27*tmp_qloop_28;
                   const real_t q_tmp_0_2 = tmp_qloop_28*tmp_qloop_29;
                   const real_t q_tmp_0_3 = tmp_qloop_1*tmp_qloop_28;
                   const real_t q_tmp_0_4 = tmp_qloop_28*tmp_qloop_30;
                   const real_t q_tmp_0_5 = tmp_qloop_28*tmp_qloop_31;
                   const real_t q_tmp_1_1 = tmp_qloop_26*(tmp_qloop_27*tmp_qloop_27);
                   const real_t q_tmp_1_2 = tmp_qloop_29*tmp_qloop_32;
                   const real_t q_tmp_1_3 = tmp_qloop_1*tmp_qloop_32;
                   const real_t q_tmp_1_4 = tmp_qloop_30*tmp_qloop_32;
                   const real_t q_tmp_1_5 = tmp_qloop_31*tmp_qloop_32;
                   const real_t q_tmp_2_2 = tmp_qloop_26*(tmp_qloop_29*tmp_qloop_29);
                   const real_t q_tmp_2_3 = tmp_qloop_1*tmp_qloop_33;
                   const real_t q_tmp_2_4 = tmp_qloop_30*tmp_qloop_33;
                   const real_t q_tmp_2_5 = tmp_qloop_31*tmp_qloop_33;
                   const real_t q_tmp_3_3 = tmp_qloop_2*tmp_qloop_26*tmp_qloop_4*16.0;
                   const real_t q_tmp_3_4 = tmp_qloop_1*tmp_qloop_34;
                   const real_t q_tmp_3_5 = tmp_qloop_1*tmp_qloop_26*tmp_qloop_31;
                   const real_t q_tmp_4_4 = tmp_qloop_26*(tmp_qloop_30*tmp_qloop_30);
                   const real_t q_tmp_4_5 = tmp_qloop_31*tmp_qloop_34;
                   const real_t q_tmp_5_5 = tmp_qloop_26*(tmp_qloop_31*tmp_qloop_31);
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const real_t tmp_qloop_25 = tmp_qloop_22 - tmp_qloop_23 - tmp_qloop_24;
                   const real_t tmp_qloop_26 = abs_det_jac_affine_BLUE*(mu_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + mu_dof_1*_data_q_p_0[q] + mu_dof_2*_data_q_p_1[q])*(tmp_qloop_16*tmp_qloop_21 + tmp_qloop_20*tmp_qloop_21 + tmp_qloop_22*tmp_qloop_25 - tmp_qloop_25*(tmp_qloop_23 + tmp_qloop_24))*_data_q_w[q];
                   const real_t tmp_qloop_27 = tmp_qloop_3 - _data_q_p_0[q];
                   const real_t tmp_qloop_28 = tmp_qloop_26*tmp_qloop_6;
                   const real_t tmp_qloop_29 = tmp_qloop_5 - _data_q_p_1[q];
                   const real_t tmp_qloop_30 = -tmp_qloop_1 + tmp_qloop_4*-4.0 + tmp_qloop_7;
