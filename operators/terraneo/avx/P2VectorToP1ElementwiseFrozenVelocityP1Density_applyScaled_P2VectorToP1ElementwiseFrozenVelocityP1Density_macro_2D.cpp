...
#include "../P2VectorToP1ElementwiseFrozenVelocityP1Density.hpp"
...
void P2VectorToP1ElementwiseFrozenVelocityP1Density::applyScaled_P2VectorToP1ElementwiseFrozenVelocityP1Density_macro_2D( real_t * RESTRICT  _data_dst, real_t * RESTRICT  _data_rho, real_t * RESTRICT  _data_src_edge_0, real_t * RESTRICT  _data_src_edge_1, real_t * RESTRICT  _data_src_vertex_0, real_t * RESTRICT  _data_src_vertex_1, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling ) const
{
    {
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_11 = _mm256_mul_pd(_mm256_mul_pd(_mm256_div_pd(_mm256_set_pd(1.0,1.0,1.0,1.0),_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(rho_dof_1,_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),_mm256_mul_pd(rho_dof_2,_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q]))),_mm256_mul_pd(rho_dof_0,tmp_qloop_10))),_mm256_set_pd(_data_q_w[q],_data_q_w[q],_data_q_w[q],_data_q_w[q])),_mm256_set_pd(abs_det_jac_affine_GRAY,abs_det_jac_affine_GRAY,abs_det_jac_affine_GRAY,abs_det_jac_affine_GRAY));
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
             {
                ...
                const real_t tmp_qloop_19 = jac_affine_inv_0_1_GRAY*tmp_qloop_7 + jac_affine_inv_1_1_GRAY*tmp_qloop_8;
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const real_t tmp_qloop_11 = abs_det_jac_affine_GRAY*1.0 / (rho_dof_0*tmp_qloop_10 + rho_dof_1*_data_q_p_0[q] + rho_dof_2*_data_q_p_1[q])*_data_q_w[q];
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_6 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-3.0,-3.0,-3.0,-3.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),_mm256_mul_pd(_mm256_set_pd(-3.0,-3.0,-3.0,-3.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q]))),_mm256_set_pd(1.0,1.0,1.0,1.0)),tmp_qloop_1),tmp_qloop_3),tmp_qloop_5);
                   const __m256d tmp_qloop_10 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q]))),_mm256_set_pd(1.0,1.0,1.0,1.0));
                   const __m256d tmp_qloop_11 = _mm256_mul_pd(_mm256_mul_pd(_mm256_div_pd(_mm256_set_pd(1.0,1.0,1.0,1.0),_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(rho_dof_1,_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),_mm256_mul_pd(rho_dof_2,_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q]))),_mm256_mul_pd(rho_dof_0,tmp_qloop_10))),_mm256_set_pd(_data_q_w[q],_data_q_w[q],_data_q_w[q],_data_q_w[q])),_mm256_set_pd(abs_det_jac_affine_BLUE,abs_det_jac_affine_BLUE,abs_det_jac_affine_BLUE,abs_det_jac_affine_BLUE));
                   const __m256d tmp_qloop_12 = _mm256_mul_pd(tmp_qloop_10,tmp_qloop_11);
                   const __m256d tmp_qloop_13 = _mm256_mul_pd(tmp_qloop_12,tmp_qloop_9);
                   const __m256d tmp_qloop_14 = _mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),tmp_qloop_3);
                   const __m256d tmp_qloop_15 = _mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q])),tmp_qloop_5);
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
             {
                ...
                const real_t tmp_qloop_7 = -rho_dof_0 + rho_dof_1;
                const real_t tmp_qloop_8 = -rho_dof_0 + rho_dof_2;
                const real_t tmp_qloop_9 = jac_affine_inv_0_0_BLUE*tmp_qloop_7 + jac_affine_inv_1_0_BLUE*tmp_qloop_8;
                const real_t tmp_qloop_19 = jac_affine_inv_0_1_BLUE*tmp_qloop_7 + jac_affine_inv_1_1_BLUE*tmp_qloop_8;
                for (int64_t q = 0; q < 4; q += 1)
                {
                   const real_t tmp_qloop_0 = 4.0*_data_q_p_1[q];
                   const real_t tmp_qloop_1 = tmp_qloop_0*_data_q_p_0[q];
                   ...
                   const real_t tmp_qloop_6 = tmp_qloop_1 + tmp_qloop_3 + tmp_qloop_5 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0;
                   const real_t tmp_qloop_10 = 1.0 - _data_q_p_0[q] - _data_q_p_1[q];
                   const real_t tmp_qloop_11 = abs_det_jac_affine_BLUE*1.0 / (rho_dof_0*tmp_qloop_10 + rho_dof_1*_data_q_p_0[q] + rho_dof_2*_data_q_p_1[q])*_data_q_w[q];
                   const real_t tmp_qloop_12 = tmp_qloop_10*tmp_qloop_11;
                   const real_t tmp_qloop_13 = tmp_qloop_12*tmp_qloop_9;
                   const real_t tmp_qloop_14 = tmp_qloop_3 - _data_q_p_0[q];
                   const real_t tmp_qloop_15 = tmp_qloop_5 - _data_q_p_1[q];
