...
void P2ElementwiseShearHeatingP1ViscosityParametricP2Map::computeInverseDiagonalOperatorValues_P2ElementwiseShearHeatingP1ViscosityParametricP2Map_macro_2D( real_t * RESTRICT  _data_invDiag_Edge, real_t * RESTRICT  _data_invDiag_Vertex, real_t * RESTRICT  _data_micromesh_edge_0, real_t * RESTRICT  _data_micromesh_edge_1, real_t * RESTRICT  _data_micromesh_vertex_0, real_t * RESTRICT  _data_micromesh_vertex_1, real_t * RESTRICT  _data_mu, real_t * RESTRICT  _data_wxEdge, real_t * RESTRICT  _data_wxVertex, real_t * RESTRICT  _data_wyEdge, real_t * RESTRICT  _data_wyVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float ) const
{
    {
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_23 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_0,wy_dof_3),_mm256_mul_pd(tmp_qloop_12,wy_dof_2)),_mm256_mul_pd(tmp_qloop_13,wy_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_0,wy_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_9);
                   ...
                   const __m256d tmp_qloop_26 = _mm256_mul_pd(tmp_qloop_8,wx_dof_0);
                   const __m256d tmp_qloop_27 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_0,wx_dof_3),_mm256_mul_pd(tmp_qloop_12,wx_dof_2)),_mm256_mul_pd(tmp_qloop_13,wx_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_0,wx_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_26);
                   const __m256d tmp_qloop_28 = _mm256_mul_pd(tmp_qloop_17,tmp_qloop_21);
                   const __m256d tmp_qloop_29 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_10,wx_dof_5),_mm256_mul_pd(tmp_qloop_6,wx_dof_3)),_mm256_mul_pd(tmp_qloop_7,wx_dof_1)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_6,wx_dof_4),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_26);
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const real_t tmp_qloop_23 = tmp_qloop_0*wy_dof_3 - tmp_qloop_0*wy_dof_5 + tmp_qloop_12*wy_dof_2 + tmp_qloop_13*wy_dof_4 + tmp_qloop_9;
                   ...
                   const real_t tmp_qloop_26 = tmp_qloop_8*wx_dof_0;
                   const real_t tmp_qloop_27 = tmp_qloop_0*wx_dof_3 - tmp_qloop_0*wx_dof_5 + tmp_qloop_12*wx_dof_2 + tmp_qloop_13*wx_dof_4 + tmp_qloop_26;
                   const real_t tmp_qloop_28 = tmp_qloop_17*tmp_qloop_21;
                   const real_t tmp_qloop_29 = tmp_qloop_10*wx_dof_5 + tmp_qloop_26 + tmp_qloop_6*wx_dof_3 - tmp_qloop_6*wx_dof_4 + tmp_qloop_7*wx_dof_1;
                   ...
                   const real_t tmp_qloop_36 = (mu_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + mu_dof_1*_data_q_p_0[q] + mu_dof_2*_data_q_p_1[q])*(tmp_qloop_25*tmp_qloop_33 + tmp_qloop_32*tmp_qloop_33 + tmp_qloop_34*tmp_qloop_35 - tmp_qloop_35*(tmp_qloop_11*tmp_qloop_31 + tmp_qloop_23*tmp_qloop_28))*abs(tmp_qloop_20)*_data_q_w[q];
