          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_24 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_0,uy_dof_3),_mm256_mul_pd(tmp_qloop_13,uy_dof_2)),_mm256_mul_pd(tmp_qloop_14,uy_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_0,uy_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_10);
                   ...
                   const __m256d tmp_qloop_27 = _mm256_mul_pd(tmp_qloop_9,ux_dof_0);
                   const __m256d tmp_qloop_28 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_0,ux_dof_3),_mm256_mul_pd(tmp_qloop_13,ux_dof_2)),_mm256_mul_pd(tmp_qloop_14,ux_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_0,ux_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_27);
                   const __m256d tmp_qloop_29 = _mm256_mul_pd(tmp_qloop_18,tmp_qloop_22);
                   const __m256d tmp_qloop_30 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_11,ux_dof_5),_mm256_mul_pd(tmp_qloop_7,ux_dof_3)),_mm256_mul_pd(tmp_qloop_8,ux_dof_1)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_7,ux_dof_4),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_27);
