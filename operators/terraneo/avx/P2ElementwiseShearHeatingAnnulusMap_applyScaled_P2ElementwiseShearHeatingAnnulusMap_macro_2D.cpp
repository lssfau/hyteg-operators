...
void P2ElementwiseShearHeatingAnnulusMap::applyScaled_P2ElementwiseShearHeatingAnnulusMap_macro_2D( real_t * RESTRICT  _data_dstEdge, real_t * RESTRICT  _data_dstVertex, real_t * RESTRICT  _data_etaEdge, real_t * RESTRICT  _data_etaVertex, real_t * RESTRICT  _data_srcEdge, real_t * RESTRICT  _data_srcVertex, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling, real_t radRayVertex, real_t radRefVertex, real_t rayVertex_0, real_t rayVertex_1, real_t refVertex_0, real_t refVertex_1, real_t thrVertex_0, real_t thrVertex_1 ) const
{
    {
       ...
       const real_t tmp_qloop_12 = tmp_qloop_11*1.0;
       {
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                const __m256d eta_dof_0 = _mm256_loadu_pd(& _data_etaVertex[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2))]);
                const __m256d eta_dof_1 = _mm256_loadu_pd(& _data_etaVertex[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1]);
                const __m256d eta_dof_2 = _mm256_loadu_pd(& _data_etaVertex[ctr_0 + (ctr_1 + 1)*(micro_edges_per_macro_edge + 2) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2))]);
                const __m256d eta_dof_3 = _mm256_loadu_pd(& _data_etaEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + ((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))]);
                const __m256d eta_dof_4 = _mm256_loadu_pd(& _data_etaEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + 2*((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))]);
                const __m256d eta_dof_5 = _mm256_loadu_pd(& _data_etaEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2))]);
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_46 = _mm256_add_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),tmp_qloop_37);
                   const __m256d tmp_qloop_47 = _mm256_add_pd(_mm256_add_pd(_mm256_set_pd(-3.0,-3.0,-3.0,-3.0),tmp_qloop_37),tmp_qloop_45);
                   const __m256d tmp_qloop_48 = _mm256_mul_pd(tmp_qloop_47,uy_dof_0);
                   const __m256d tmp_qloop_49 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-8.0,-8.0,-8.0,-8.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),_mm256_mul_pd(tmp_qloop_45,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),_mm256_set_pd(4.0,4.0,4.0,4.0));
                   const __m256d tmp_qloop_50 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_45,uy_dof_3),_mm256_mul_pd(tmp_qloop_46,uy_dof_1)),_mm256_mul_pd(tmp_qloop_49,uy_dof_5)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_45,uy_dof_4),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_48);
                   const __m256d tmp_qloop_52 = _mm256_add_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),tmp_qloop_45);
                   const __m256d tmp_qloop_53 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-8.0,-8.0,-8.0,-8.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q])),_mm256_mul_pd(tmp_qloop_37,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),_mm256_set_pd(4.0,4.0,4.0,4.0));
                   const __m256d tmp_qloop_54 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_37,uy_dof_3),_mm256_mul_pd(tmp_qloop_52,uy_dof_2)),_mm256_mul_pd(tmp_qloop_53,uy_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_37,uy_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_48);
                   const __m256d tmp_qloop_57 = _mm256_mul_pd(tmp_qloop_47,ux_dof_0);
                   const __m256d tmp_qloop_58 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_45,ux_dof_3),_mm256_mul_pd(tmp_qloop_46,ux_dof_1)),_mm256_mul_pd(tmp_qloop_49,ux_dof_5)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_45,ux_dof_4),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_57);
                   const __m256d tmp_qloop_60 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_37,ux_dof_3),_mm256_mul_pd(tmp_qloop_52,ux_dof_2)),_mm256_mul_pd(tmp_qloop_53,ux_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_37,ux_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_57);
                   const __m256d tmp_qloop_67 = _mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),tmp_qloop_40);
                   const __m256d tmp_qloop_68 = _mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q])),tmp_qloop_42);
                   const __m256d tmp_qloop_69 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_41,_mm256_set_pd(-4.0,-4.0,-4.0,-4.0)),_mm256_mul_pd(tmp_qloop_38,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_45);
                   const __m256d tmp_qloop_70 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_39,_mm256_set_pd(-4.0,-4.0,-4.0,-4.0)),_mm256_mul_pd(tmp_qloop_38,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_37);
                   ...
                   const __m256d tmp_qloop_51 = _mm256_add_pd(_mm256_mul_pd(jac_blending_inv_0_0,_mm256_set_pd(jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY)),_mm256_mul_pd(jac_blending_inv_1_0,_mm256_set_pd(jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY)));
                   const __m256d tmp_qloop_55 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_44,tmp_qloop_50),_mm256_mul_pd(tmp_qloop_51,tmp_qloop_54));
                   const __m256d tmp_qloop_63 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_44,tmp_qloop_58),_mm256_mul_pd(tmp_qloop_51,tmp_qloop_60));
                   const __m256d jac_blending_inv_1_1 = _mm256_mul_pd(jac_blending_0_0,tmp_qloop_22);
                   const __m256d tmp_qloop_56 = _mm256_add_pd(_mm256_mul_pd(jac_blending_inv_0_1,_mm256_set_pd(jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY)),_mm256_mul_pd(jac_blending_inv_1_1,_mm256_set_pd(jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY)));
                   ...
                   const __m256d tmp_qloop_61 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_56,tmp_qloop_58),_mm256_mul_pd(tmp_qloop_59,tmp_qloop_60));
                   const __m256d tmp_qloop_62 = _mm256_add_pd(tmp_qloop_55,tmp_qloop_61);
                   const __m256d tmp_qloop_64 = _mm256_mul_pd(tmp_qloop_50,tmp_qloop_56);
                   const __m256d tmp_qloop_65 = _mm256_mul_pd(tmp_qloop_54,tmp_qloop_59);
                   const __m256d tmp_qloop_66 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_64,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(tmp_qloop_65,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_63);
                   const __m256d tmp_qloop_71 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(abs_det_jac_blending,_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_55,tmp_qloop_62),_mm256_mul_pd(tmp_qloop_61,tmp_qloop_62)),_mm256_mul_pd(tmp_qloop_63,tmp_qloop_66)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_66,_mm256_add_pd(tmp_qloop_64,tmp_qloop_65)),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)))),_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(eta_dof_0,tmp_qloop_43),_mm256_mul_pd(eta_dof_1,tmp_qloop_67)),_mm256_mul_pd(eta_dof_2,tmp_qloop_68)),_mm256_mul_pd(eta_dof_3,tmp_qloop_38)),_mm256_mul_pd(eta_dof_4,tmp_qloop_69)),_mm256_mul_pd(eta_dof_5,tmp_qloop_70))),_mm256_set_pd(_data_q_w[q],_data_q_w[q],_data_q_w[q],_data_q_w[q])),_mm256_set_pd(abs_det_jac_affine_GRAY,abs_det_jac_affine_GRAY,abs_det_jac_affine_GRAY,abs_det_jac_affine_GRAY));
                   const __m256d tmp_qloop_72 = _mm256_mul_pd(tmp_qloop_43,tmp_qloop_71);
                   const __m256d tmp_qloop_73 = _mm256_mul_pd(tmp_qloop_67,tmp_qloop_71);
                   const __m256d tmp_qloop_74 = _mm256_mul_pd(tmp_qloop_68,tmp_qloop_71);
                   const __m256d tmp_qloop_75 = _mm256_mul_pd(tmp_qloop_69,tmp_qloop_71);
                   ...
                   const __m256d q_tmp_0_0 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_43,tmp_qloop_43),tmp_qloop_71);
                   const __m256d q_tmp_0_1 = _mm256_mul_pd(tmp_qloop_67,tmp_qloop_72);
                   const __m256d q_tmp_0_2 = _mm256_mul_pd(tmp_qloop_68,tmp_qloop_72);
                   const __m256d q_tmp_0_3 = _mm256_mul_pd(tmp_qloop_38,tmp_qloop_72);
                   const __m256d q_tmp_0_4 = _mm256_mul_pd(tmp_qloop_69,tmp_qloop_72);
                   const __m256d q_tmp_0_5 = _mm256_mul_pd(tmp_qloop_70,tmp_qloop_72);
                   const __m256d q_tmp_1_1 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_67,tmp_qloop_67),tmp_qloop_71);
                   const __m256d q_tmp_1_2 = _mm256_mul_pd(tmp_qloop_68,tmp_qloop_73);
                   const __m256d q_tmp_1_3 = _mm256_mul_pd(tmp_qloop_38,tmp_qloop_73);
                   const __m256d q_tmp_1_4 = _mm256_mul_pd(tmp_qloop_69,tmp_qloop_73);
                   const __m256d q_tmp_1_5 = _mm256_mul_pd(tmp_qloop_70,tmp_qloop_73);
                   const __m256d q_tmp_2_2 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_68,tmp_qloop_68),tmp_qloop_71);
                   const __m256d q_tmp_2_3 = _mm256_mul_pd(tmp_qloop_38,tmp_qloop_74);
                   const __m256d q_tmp_2_4 = _mm256_mul_pd(tmp_qloop_69,tmp_qloop_74);
                   const __m256d q_tmp_2_5 = _mm256_mul_pd(tmp_qloop_70,tmp_qloop_74);
                   const __m256d q_tmp_3_3 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_39,tmp_qloop_41),tmp_qloop_71),_mm256_set_pd(16.0,16.0,16.0,16.0));
                   const __m256d q_tmp_3_4 = _mm256_mul_pd(tmp_qloop_38,tmp_qloop_75);
                   const __m256d q_tmp_3_5 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_38,tmp_qloop_70),tmp_qloop_71);
                   const __m256d q_tmp_4_4 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_69,tmp_qloop_69),tmp_qloop_71);
                   const __m256d q_tmp_4_5 = _mm256_mul_pd(tmp_qloop_70,tmp_qloop_75);
                   const __m256d q_tmp_5_5 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_70,tmp_qloop_70),tmp_qloop_71);
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
             {
                ...
                const real_t eta_dof_0 = _data_etaVertex[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2))];
                const real_t eta_dof_1 = _data_etaVertex[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1];
                const real_t eta_dof_2 = _data_etaVertex[ctr_0 + (ctr_1 + 1)*(micro_edges_per_macro_edge + 2) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2))];
                const real_t eta_dof_3 = _data_etaEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + ((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))];
                const real_t eta_dof_4 = _data_etaEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + 2*((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))];
                const real_t eta_dof_5 = _data_etaEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2))];
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const real_t tmp_qloop_71 = abs_det_jac_affine_GRAY*abs_det_jac_blending*(tmp_qloop_55*tmp_qloop_62 + tmp_qloop_61*tmp_qloop_62 + tmp_qloop_63*tmp_qloop_66 - tmp_qloop_66*(tmp_qloop_64 + tmp_qloop_65))*(eta_dof_0*tmp_qloop_43 + eta_dof_1*tmp_qloop_67 + eta_dof_2*tmp_qloop_68 + eta_dof_3*tmp_qloop_38 + eta_dof_4*tmp_qloop_69 + eta_dof_5*tmp_qloop_70)*_data_q_w[q];
       ...
       const real_t abs_det_jac_affine_BLUE = abs(tmp_coords_jac_5_BLUE);
       {
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 += 4)
             {
                ...
                const __m256d eta_dof_0 = _mm256_loadu_pd(& _data_etaVertex[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1]);
                const __m256d eta_dof_1 = _mm256_loadu_pd(& _data_etaVertex[ctr_0 + (ctr_1 + 1)*(micro_edges_per_macro_edge + 2) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2))]);
                const __m256d eta_dof_2 = _mm256_loadu_pd(& _data_etaVertex[ctr_0 + (ctr_1 + 1)*(micro_edges_per_macro_edge + 2) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2)) + 1]);
                const __m256d eta_dof_3 = _mm256_loadu_pd(& _data_etaEdge[ctr_0 + (ctr_1 + 1)*(micro_edges_per_macro_edge + 1) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2))]);
                const __m256d eta_dof_4 = _mm256_loadu_pd(& _data_etaEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + 2*((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2)) + 1]);
                const __m256d eta_dof_5 = _mm256_loadu_pd(& _data_etaEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + ((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))]);
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_65 = _mm256_mul_pd(tmp_qloop_54,tmp_qloop_59);
                   const __m256d tmp_qloop_66 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_64,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(tmp_qloop_65,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_63);
                   const __m256d tmp_qloop_71 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(abs_det_jac_blending,_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_55,tmp_qloop_62),_mm256_mul_pd(tmp_qloop_61,tmp_qloop_62)),_mm256_mul_pd(tmp_qloop_63,tmp_qloop_66)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_66,_mm256_add_pd(tmp_qloop_64,tmp_qloop_65)),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)))),_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(eta_dof_0,tmp_qloop_43),_mm256_mul_pd(eta_dof_1,tmp_qloop_67)),_mm256_mul_pd(eta_dof_2,tmp_qloop_68)),_mm256_mul_pd(eta_dof_3,tmp_qloop_38)),_mm256_mul_pd(eta_dof_4,tmp_qloop_69)),_mm256_mul_pd(eta_dof_5,tmp_qloop_70))),_mm256_set_pd(_data_q_w[q],_data_q_w[q],_data_q_w[q],_data_q_w[q])),_mm256_set_pd(abs_det_jac_affine_BLUE,abs_det_jac_affine_BLUE,abs_det_jac_affine_BLUE,abs_det_jac_affine_BLUE));
                   const __m256d tmp_qloop_72 = _mm256_mul_pd(tmp_qloop_43,tmp_qloop_71);
                   const __m256d tmp_qloop_73 = _mm256_mul_pd(tmp_qloop_67,tmp_qloop_71);
                   const __m256d tmp_qloop_74 = _mm256_mul_pd(tmp_qloop_68,tmp_qloop_71);
                   const __m256d tmp_qloop_75 = _mm256_mul_pd(tmp_qloop_69,tmp_qloop_71);
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
             {
                ...
                const real_t eta_dof_0 = _data_etaVertex[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1];
                const real_t eta_dof_1 = _data_etaVertex[ctr_0 + (ctr_1 + 1)*(micro_edges_per_macro_edge + 2) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2))];
                const real_t eta_dof_2 = _data_etaVertex[ctr_0 + (ctr_1 + 1)*(micro_edges_per_macro_edge + 2) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2)) + 1];
                const real_t eta_dof_3 = _data_etaEdge[ctr_0 + (ctr_1 + 1)*(micro_edges_per_macro_edge + 1) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2))];
                const real_t eta_dof_4 = _data_etaEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + 2*((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2)) + 1];
                const real_t eta_dof_5 = _data_etaEdge[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 1) - ((ctr_1*(ctr_1 + 1)) / (2)) + ((micro_edges_per_macro_edge*(micro_edges_per_macro_edge + 1)) / (2))];
