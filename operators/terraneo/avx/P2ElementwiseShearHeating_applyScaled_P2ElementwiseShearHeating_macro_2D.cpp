...
void P2ElementwiseShearHeating::applyScaled_P2ElementwiseShearHeating_macro_2D( real_t * RESTRICT  _data_dstEdge, real_t * RESTRICT  _data_dstVertex, real_t * RESTRICT  _data_etaEdge, real_t * RESTRICT  _data_etaVertex, real_t * RESTRICT  _data_srcEdge, real_t * RESTRICT  _data_srcVertex, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling ) const
{
    {
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_30 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_16,tmp_qloop_21),_mm256_mul_pd(tmp_qloop_20,tmp_qloop_21)),_mm256_mul_pd(tmp_qloop_22,tmp_qloop_25)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_25,_mm256_add_pd(tmp_qloop_23,tmp_qloop_24)),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(eta_dof_0,tmp_qloop_6),_mm256_mul_pd(eta_dof_1,tmp_qloop_26)),_mm256_mul_pd(eta_dof_2,tmp_qloop_27)),_mm256_mul_pd(eta_dof_3,tmp_qloop_1)),_mm256_mul_pd(eta_dof_4,tmp_qloop_28)),_mm256_mul_pd(eta_dof_5,tmp_qloop_29))),_mm256_set_pd(_data_q_w[q],_data_q_w[q],_data_q_w[q],_data_q_w[q])),_mm256_set_pd(abs_det_jac_affine_GRAY,abs_det_jac_affine_GRAY,abs_det_jac_affine_GRAY,abs_det_jac_affine_GRAY));
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_28 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_4,_mm256_set_pd(-4.0,-4.0,-4.0,-4.0)),_mm256_mul_pd(tmp_qloop_1,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_7);
                   const __m256d tmp_qloop_29 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_2,_mm256_set_pd(-4.0,-4.0,-4.0,-4.0)),_mm256_mul_pd(tmp_qloop_1,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_0);
                   const __m256d tmp_qloop_30 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_16,tmp_qloop_21),_mm256_mul_pd(tmp_qloop_20,tmp_qloop_21)),_mm256_mul_pd(tmp_qloop_22,tmp_qloop_25)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_25,_mm256_add_pd(tmp_qloop_23,tmp_qloop_24)),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(eta_dof_0,tmp_qloop_6),_mm256_mul_pd(eta_dof_1,tmp_qloop_26)),_mm256_mul_pd(eta_dof_2,tmp_qloop_27)),_mm256_mul_pd(eta_dof_3,tmp_qloop_1)),_mm256_mul_pd(eta_dof_4,tmp_qloop_28)),_mm256_mul_pd(eta_dof_5,tmp_qloop_29))),_mm256_set_pd(_data_q_w[q],_data_q_w[q],_data_q_w[q],_data_q_w[q])),_mm256_set_pd(abs_det_jac_affine_BLUE,abs_det_jac_affine_BLUE,abs_det_jac_affine_BLUE,abs_det_jac_affine_BLUE));
                   const __m256d tmp_qloop_31 = _mm256_mul_pd(tmp_qloop_30,tmp_qloop_6);
                   const __m256d tmp_qloop_32 = _mm256_mul_pd(tmp_qloop_26,tmp_qloop_30);
                   const __m256d tmp_qloop_33 = _mm256_mul_pd(tmp_qloop_27,tmp_qloop_30);
                   const __m256d tmp_qloop_34 = _mm256_mul_pd(tmp_qloop_28,tmp_qloop_30);
