...
void P2ElementwiseShearHeatingP1ViscosityParametricP2Map::apply_P2ElementwiseShearHeatingP1ViscosityParametricP2Map_macro_2D( real_t * RESTRICT  _data_dstEdge, real_t * RESTRICT  _data_dstVertex, real_t * RESTRICT  _data_micromesh_edge_0, real_t * RESTRICT  _data_micromesh_edge_1, real_t * RESTRICT  _data_micromesh_vertex_0, real_t * RESTRICT  _data_micromesh_vertex_1, real_t * RESTRICT  _data_mu, real_t * RESTRICT  _data_srcEdge, real_t * RESTRICT  _data_srcVertex, real_t * RESTRICT  _data_wxEdge, real_t * RESTRICT  _data_wxVertex, real_t * RESTRICT  _data_wyEdge, real_t * RESTRICT  _data_wyVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float ) const
{
    {
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_10 = _mm256_mul_pd(tmp_qloop_9,wy_dof_0);
                   ...
                   const __m256d tmp_qloop_12 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_11,wy_dof_5),_mm256_mul_pd(tmp_qloop_7,wy_dof_3)),_mm256_mul_pd(tmp_qloop_8,wy_dof_1)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_7,wy_dof_4),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_10);
                   ...
                   const __m256d tmp_qloop_15 = _mm256_mul_pd(micromesh_dof_6,tmp_qloop_9);
                   const __m256d tmp_qloop_16 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(micromesh_dof_10,tmp_qloop_14),_mm256_mul_pd(micromesh_dof_8,tmp_qloop_13)),_mm256_mul_pd(micromesh_dof_9,tmp_qloop_0)),_mm256_mul_pd(_mm256_mul_pd(micromesh_dof_11,tmp_qloop_0),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_15);
                   const __m256d tmp_qloop_17 = _mm256_mul_pd(micromesh_dof_0,tmp_qloop_9);
                   const __m256d tmp_qloop_18 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(micromesh_dof_1,tmp_qloop_8),_mm256_mul_pd(micromesh_dof_3,tmp_qloop_7)),_mm256_mul_pd(micromesh_dof_5,tmp_qloop_11)),_mm256_mul_pd(_mm256_mul_pd(micromesh_dof_4,tmp_qloop_7),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_17);
                   const __m256d tmp_qloop_19 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(micromesh_dof_2,tmp_qloop_13),_mm256_mul_pd(micromesh_dof_3,tmp_qloop_0)),_mm256_mul_pd(micromesh_dof_4,tmp_qloop_14)),_mm256_mul_pd(_mm256_mul_pd(micromesh_dof_5,tmp_qloop_0),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_17);
                   const __m256d tmp_qloop_20 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(micromesh_dof_11,tmp_qloop_11),_mm256_mul_pd(micromesh_dof_7,tmp_qloop_8)),_mm256_mul_pd(micromesh_dof_9,tmp_qloop_7)),_mm256_mul_pd(_mm256_mul_pd(micromesh_dof_10,tmp_qloop_7),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_15);
                   const __m256d tmp_qloop_21 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_16,tmp_qloop_18),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_19,tmp_qloop_20),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)));
                   const __m256d tmp_qloop_22 = _mm256_div_pd(_mm256_set_pd(1.0,1.0,1.0,1.0),tmp_qloop_21);
                   const __m256d tmp_qloop_23 = _mm256_mul_pd(tmp_qloop_16,tmp_qloop_22);
                   const __m256d tmp_qloop_24 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_0,wy_dof_3),_mm256_mul_pd(tmp_qloop_13,wy_dof_2)),_mm256_mul_pd(tmp_qloop_14,wy_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_0,wy_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_10);
                   const __m256d tmp_qloop_25 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_20,tmp_qloop_22),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0));
                   const __m256d tmp_qloop_26 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_12,tmp_qloop_23),_mm256_mul_pd(tmp_qloop_24,tmp_qloop_25));
                   const __m256d tmp_qloop_27 = _mm256_mul_pd(tmp_qloop_9,wx_dof_0);
                   const __m256d tmp_qloop_28 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_0,wx_dof_3),_mm256_mul_pd(tmp_qloop_13,wx_dof_2)),_mm256_mul_pd(tmp_qloop_14,wx_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_0,wx_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_27);
                   const __m256d tmp_qloop_29 = _mm256_mul_pd(tmp_qloop_18,tmp_qloop_22);
                   const __m256d tmp_qloop_30 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_11,wx_dof_5),_mm256_mul_pd(tmp_qloop_7,wx_dof_3)),_mm256_mul_pd(tmp_qloop_8,wx_dof_1)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_7,wx_dof_4),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_27);
                   const __m256d tmp_qloop_31 = _mm256_mul_pd(tmp_qloop_19,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0));
                   const __m256d tmp_qloop_32 = _mm256_mul_pd(tmp_qloop_22,tmp_qloop_31);
                   const __m256d tmp_qloop_33 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_28,tmp_qloop_29),_mm256_mul_pd(tmp_qloop_30,tmp_qloop_32));
                   const __m256d tmp_qloop_34 = _mm256_add_pd(tmp_qloop_26,tmp_qloop_33);
                   const __m256d tmp_qloop_35 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_23,tmp_qloop_30),_mm256_mul_pd(tmp_qloop_25,tmp_qloop_28));
                   const __m256d tmp_qloop_36 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_12,tmp_qloop_22),tmp_qloop_31),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_18,tmp_qloop_22),tmp_qloop_24),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_35);
                   const __m256d tmp_qloop_37 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(mu_dof_0,_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q]))),_mm256_set_pd(1.0,1.0,1.0,1.0))),_mm256_mul_pd(mu_dof_1,_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q]))),_mm256_mul_pd(mu_dof_2,_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q]))),_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_26,tmp_qloop_34),_mm256_mul_pd(tmp_qloop_33,tmp_qloop_34)),_mm256_mul_pd(tmp_qloop_35,tmp_qloop_36)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_36,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_12,tmp_qloop_32),_mm256_mul_pd(tmp_qloop_24,tmp_qloop_29))),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)))),_mm256_set_pd(_data_q_w[q],_data_q_w[q],_data_q_w[q],_data_q_w[q])),_mm256_castsi256_pd(_mm256_and_si256(_mm256_set1_epi64x(0x7fffffffffffffff), _mm256_castpd_si256(tmp_qloop_21))));
                   const __m256d tmp_qloop_38 = _mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),tmp_qloop_3);
                   const __m256d tmp_qloop_39 = _mm256_mul_pd(tmp_qloop_37,tmp_qloop_6);
                   const __m256d tmp_qloop_40 = _mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q])),tmp_qloop_5);
                   const __m256d tmp_qloop_41 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_4,_mm256_set_pd(-4.0,-4.0,-4.0,-4.0)),_mm256_mul_pd(tmp_qloop_1,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_7);
                   ...
                   const __m256d tmp_qloop_44 = _mm256_mul_pd(tmp_qloop_37,tmp_qloop_40);
                   const __m256d tmp_qloop_45 = _mm256_mul_pd(tmp_qloop_37,tmp_qloop_41);
                   const __m256d q_tmp_0_0 = _mm256_mul_pd(tmp_qloop_37,_mm256_mul_pd(tmp_qloop_6,tmp_qloop_6));
                   const __m256d q_tmp_0_1 = _mm256_mul_pd(tmp_qloop_38,tmp_qloop_39);
                   const __m256d q_tmp_0_2 = _mm256_mul_pd(tmp_qloop_39,tmp_qloop_40);
                   const __m256d q_tmp_0_3 = _mm256_mul_pd(tmp_qloop_1,tmp_qloop_39);
                   const __m256d q_tmp_0_4 = _mm256_mul_pd(tmp_qloop_39,tmp_qloop_41);
                   const __m256d q_tmp_0_5 = _mm256_mul_pd(tmp_qloop_39,tmp_qloop_42);
                   const __m256d q_tmp_1_1 = _mm256_mul_pd(tmp_qloop_37,_mm256_mul_pd(tmp_qloop_38,tmp_qloop_38));
                   const __m256d q_tmp_1_2 = _mm256_mul_pd(tmp_qloop_40,tmp_qloop_43);
                   const __m256d q_tmp_1_3 = _mm256_mul_pd(tmp_qloop_1,tmp_qloop_43);
                   const __m256d q_tmp_1_4 = _mm256_mul_pd(tmp_qloop_41,tmp_qloop_43);
                   const __m256d q_tmp_1_5 = _mm256_mul_pd(tmp_qloop_42,tmp_qloop_43);
                   const __m256d q_tmp_2_2 = _mm256_mul_pd(tmp_qloop_37,_mm256_mul_pd(tmp_qloop_40,tmp_qloop_40));
                   const __m256d q_tmp_2_3 = _mm256_mul_pd(tmp_qloop_1,tmp_qloop_44);
                   const __m256d q_tmp_2_4 = _mm256_mul_pd(tmp_qloop_41,tmp_qloop_44);
                   const __m256d q_tmp_2_5 = _mm256_mul_pd(tmp_qloop_42,tmp_qloop_44);
                   const __m256d q_tmp_3_3 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_2,tmp_qloop_37),tmp_qloop_4),_mm256_set_pd(16.0,16.0,16.0,16.0));
                   const __m256d q_tmp_3_4 = _mm256_mul_pd(tmp_qloop_1,tmp_qloop_45);
                   const __m256d q_tmp_3_5 = _mm256_mul_pd(_mm256_mul_pd(tmp_qloop_1,tmp_qloop_37),tmp_qloop_42);
                   const __m256d q_tmp_4_4 = _mm256_mul_pd(tmp_qloop_37,_mm256_mul_pd(tmp_qloop_41,tmp_qloop_41));
                   const __m256d q_tmp_4_5 = _mm256_mul_pd(tmp_qloop_42,tmp_qloop_45);
                   const __m256d q_tmp_5_5 = _mm256_mul_pd(tmp_qloop_37,_mm256_mul_pd(tmp_qloop_42,tmp_qloop_42));
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const real_t tmp_qloop_10 = tmp_qloop_9*wy_dof_0;
                   const real_t tmp_qloop_11 = -tmp_qloop_7 - 8.0*_data_q_p_0[q] + 4.0;
                   const real_t tmp_qloop_12 = tmp_qloop_10 + tmp_qloop_11*wy_dof_5 + tmp_qloop_7*wy_dof_3 - tmp_qloop_7*wy_dof_4 + tmp_qloop_8*wy_dof_1;
                   ...
                   const real_t tmp_qloop_24 = tmp_qloop_0*wy_dof_3 - tmp_qloop_0*wy_dof_5 + tmp_qloop_10 + tmp_qloop_13*wy_dof_2 + tmp_qloop_14*wy_dof_4;
                   ...
                   const real_t tmp_qloop_27 = tmp_qloop_9*wx_dof_0;
                   const real_t tmp_qloop_28 = tmp_qloop_0*wx_dof_3 - tmp_qloop_0*wx_dof_5 + tmp_qloop_13*wx_dof_2 + tmp_qloop_14*wx_dof_4 + tmp_qloop_27;
                   const real_t tmp_qloop_29 = tmp_qloop_18*tmp_qloop_22;
                   const real_t tmp_qloop_30 = tmp_qloop_11*wx_dof_5 + tmp_qloop_27 + tmp_qloop_7*wx_dof_3 - tmp_qloop_7*wx_dof_4 + tmp_qloop_8*wx_dof_1;
                   ...
                   const real_t tmp_qloop_37 = (mu_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + mu_dof_1*_data_q_p_0[q] + mu_dof_2*_data_q_p_1[q])*(tmp_qloop_26*tmp_qloop_34 + tmp_qloop_33*tmp_qloop_34 + tmp_qloop_35*tmp_qloop_36 - tmp_qloop_36*(tmp_qloop_12*tmp_qloop_32 + tmp_qloop_24*tmp_qloop_29))*abs(tmp_qloop_21)*_data_q_w[q];
