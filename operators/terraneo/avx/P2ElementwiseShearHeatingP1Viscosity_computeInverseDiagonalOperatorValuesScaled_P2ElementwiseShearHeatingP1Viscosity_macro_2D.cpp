...
void P2ElementwiseShearHeatingP1Viscosity::computeInverseDiagonalOperatorValuesScaled_P2ElementwiseShearHeatingP1Viscosity_macro_2D( real_t * RESTRICT  _data_eta, real_t * RESTRICT  _data_invDiag_Edge, real_t * RESTRICT  _data_invDiag_Vertex, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t diagScaling, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float ) const
{
    {
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_14 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_0,uy_dof_3),_mm256_mul_pd(tmp_qloop_12,uy_dof_2)),_mm256_mul_pd(tmp_qloop_13,uy_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_0,uy_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_9);
                   ...
                   const __m256d tmp_qloop_17 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_10,ux_dof_5),_mm256_mul_pd(tmp_qloop_6,ux_dof_3)),_mm256_mul_pd(tmp_qloop_7,ux_dof_1)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_6,ux_dof_4),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_16);
                   const __m256d tmp_qloop_18 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_0,ux_dof_3),_mm256_mul_pd(tmp_qloop_12,ux_dof_2)),_mm256_mul_pd(tmp_qloop_13,ux_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_0,ux_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_16);
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const real_t tmp_qloop_14 = tmp_qloop_0*uy_dof_3 - tmp_qloop_0*uy_dof_5 + tmp_qloop_12*uy_dof_2 + tmp_qloop_13*uy_dof_4 + tmp_qloop_9;
                   ...
                   const real_t tmp_qloop_17 = tmp_qloop_10*ux_dof_5 + tmp_qloop_16 + tmp_qloop_6*ux_dof_3 - tmp_qloop_6*ux_dof_4 + tmp_qloop_7*ux_dof_1;
                   const real_t tmp_qloop_18 = tmp_qloop_0*ux_dof_3 - tmp_qloop_0*ux_dof_5 + tmp_qloop_12*ux_dof_2 + tmp_qloop_13*ux_dof_4 + tmp_qloop_16;
                   ...
                   const real_t tmp_qloop_25 = abs_det_jac_affine_GRAY*(eta_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + eta_dof_1*_data_q_p_0[q] + eta_dof_2*_data_q_p_1[q])*(tmp_qloop_15*tmp_qloop_20 + tmp_qloop_19*tmp_qloop_20 + tmp_qloop_21*tmp_qloop_24 - tmp_qloop_24*(tmp_qloop_22 + tmp_qloop_23))*_data_q_w[q];
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const real_t tmp_qloop_24 = tmp_qloop_21 - tmp_qloop_22 - tmp_qloop_23;
                   const real_t tmp_qloop_25 = abs_det_jac_affine_BLUE*(eta_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + eta_dof_1*_data_q_p_0[q] + eta_dof_2*_data_q_p_1[q])*(tmp_qloop_15*tmp_qloop_20 + tmp_qloop_19*tmp_qloop_20 + tmp_qloop_21*tmp_qloop_24 - tmp_qloop_24*(tmp_qloop_22 + tmp_qloop_23))*_data_q_w[q];
                   const real_t q_tmp_0_0 = tmp_qloop_25*((tmp_qloop_1 + tmp_qloop_3 + tmp_qloop_5 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0)*(tmp_qloop_1 + tmp_qloop_3 + tmp_qloop_5 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0));
                   const real_t q_tmp_1_1 = tmp_qloop_25*((tmp_qloop_3 - _data_q_p_0[q])*(tmp_qloop_3 - _data_q_p_0[q]));
                   const real_t q_tmp_2_2 = tmp_qloop_25*((tmp_qloop_5 - _data_q_p_1[q])*(tmp_qloop_5 - _data_q_p_1[q]));
                   const real_t q_tmp_3_3 = tmp_qloop_2*tmp_qloop_25*tmp_qloop_4*16.0;
