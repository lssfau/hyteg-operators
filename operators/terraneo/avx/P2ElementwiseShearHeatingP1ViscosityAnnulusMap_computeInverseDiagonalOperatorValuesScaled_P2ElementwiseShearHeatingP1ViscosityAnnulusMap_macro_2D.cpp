...
void P2ElementwiseShearHeatingP1ViscosityAnnulusMap::computeInverseDiagonalOperatorValuesScaled_P2ElementwiseShearHeatingP1ViscosityAnnulusMap_macro_2D( real_t * RESTRICT  _data_eta, real_t * RESTRICT  _data_invDiag_Edge, real_t * RESTRICT  _data_invDiag_Vertex, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t diagScaling, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t radRayVertex, real_t radRefVertex, real_t rayVertex_0, real_t rayVertex_1, real_t refVertex_0, real_t refVertex_1, real_t thrVertex_0, real_t thrVertex_1 ) const
{
    {
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_47 = _mm256_mul_pd(tmp_qloop_46,uy_dof_0);
                   ...
                   const __m256d tmp_qloop_49 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_44,uy_dof_3),_mm256_mul_pd(tmp_qloop_45,uy_dof_1)),_mm256_mul_pd(tmp_qloop_48,uy_dof_5)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_44,uy_dof_4),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_47);
                   ...
                   const __m256d tmp_qloop_53 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_37,uy_dof_3),_mm256_mul_pd(tmp_qloop_51,uy_dof_2)),_mm256_mul_pd(tmp_qloop_52,uy_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_37,uy_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_47);
                   const __m256d tmp_qloop_56 = _mm256_mul_pd(tmp_qloop_46,ux_dof_0);
                   const __m256d tmp_qloop_57 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_44,ux_dof_3),_mm256_mul_pd(tmp_qloop_45,ux_dof_1)),_mm256_mul_pd(tmp_qloop_48,ux_dof_5)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_44,ux_dof_4),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_56);
                   const __m256d tmp_qloop_59 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_37,ux_dof_3),_mm256_mul_pd(tmp_qloop_51,ux_dof_2)),_mm256_mul_pd(tmp_qloop_52,ux_dof_4)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_37,ux_dof_5),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_56);
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const real_t tmp_qloop_47 = tmp_qloop_46*uy_dof_0;
                   const real_t tmp_qloop_48 = -tmp_qloop_44 - 8.0*_data_q_p_0[q] + 4.0;
                   const real_t tmp_qloop_49 = tmp_qloop_44*uy_dof_3 - tmp_qloop_44*uy_dof_4 + tmp_qloop_45*uy_dof_1 + tmp_qloop_47 + tmp_qloop_48*uy_dof_5;
                   const real_t tmp_qloop_51 = tmp_qloop_44 - 1.0;
                   const real_t tmp_qloop_52 = -tmp_qloop_37 - 8.0*_data_q_p_1[q] + 4.0;
                   const real_t tmp_qloop_53 = tmp_qloop_37*uy_dof_3 - tmp_qloop_37*uy_dof_5 + tmp_qloop_47 + tmp_qloop_51*uy_dof_2 + tmp_qloop_52*uy_dof_4;
                   const real_t tmp_qloop_56 = tmp_qloop_46*ux_dof_0;
                   const real_t tmp_qloop_57 = tmp_qloop_44*ux_dof_3 - tmp_qloop_44*ux_dof_4 + tmp_qloop_45*ux_dof_1 + tmp_qloop_48*ux_dof_5 + tmp_qloop_56;
                   const real_t tmp_qloop_59 = tmp_qloop_37*ux_dof_3 - tmp_qloop_37*ux_dof_5 + tmp_qloop_51*ux_dof_2 + tmp_qloop_52*ux_dof_4 + tmp_qloop_56;
                   ...
                   const real_t tmp_qloop_66 = abs_det_jac_affine_GRAY*abs_det_jac_blending*(eta_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + eta_dof_1*_data_q_p_0[q] + eta_dof_2*_data_q_p_1[q])*(tmp_qloop_54*tmp_qloop_61 + tmp_qloop_60*tmp_qloop_61 + tmp_qloop_62*tmp_qloop_65 - tmp_qloop_65*(tmp_qloop_63 + tmp_qloop_64))*_data_q_w[q];
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 4; q += 1)
                {
                   ...
                   const real_t tmp_qloop_64 = tmp_qloop_53*tmp_qloop_58;
                   const real_t tmp_qloop_65 = tmp_qloop_62 - tmp_qloop_63 - tmp_qloop_64;
                   const real_t tmp_qloop_66 = abs_det_jac_affine_BLUE*abs_det_jac_blending*(eta_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + eta_dof_1*_data_q_p_0[q] + eta_dof_2*_data_q_p_1[q])*(tmp_qloop_54*tmp_qloop_61 + tmp_qloop_60*tmp_qloop_61 + tmp_qloop_62*tmp_qloop_65 - tmp_qloop_65*(tmp_qloop_63 + tmp_qloop_64))*_data_q_w[q];
                   const real_t hessian_blending_0_0_0 = tmp_qloop_14 - tmp_qloop_25 + tmp_qloop_28;
                   const real_t hessian_blending_1_0_0 = -tmp_qloop_26*(tmp_qloop_3*tmp_qloop_3*tmp_qloop_3) + tmp_qloop_29*tmp_qloop_4 + tmp_qloop_3*tmp_qloop_32 - tmp_qloop_31;
                   const real_t hessian_blending_0_0_1 = tmp_qloop_1*tmp_qloop_11*tmp_qloop_15*tmp_qloop_30*-2.0 - tmp_qloop_34;
                   const real_t hessian_blending_1_0_1 = tmp_qloop_1*tmp_qloop_10*tmp_qloop_6*tmp_qloop_9*1.0 - tmp_qloop_20 - tmp_qloop_28 - tmp_qloop_35;
