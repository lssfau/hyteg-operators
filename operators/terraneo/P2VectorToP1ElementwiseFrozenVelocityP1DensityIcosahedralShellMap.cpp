                                                                               ...
                                                                               UpdateType updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         apply_P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap_macro_3D(
                                                                                  ...
                                                                                  DoFType flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrix_P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap_macro_3D(
