...
#include "P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap.hpp"
...
P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap::
    P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                       size_t                                     minLevel,
                                                                       size_t                                     maxLevel,
...
void P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap::applyScaled( const real_t& operatorScaling,
                                                                                     ...
                                                                                     UpdateType updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap_macro_3D(
...
void P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap::apply( const P2VectorFunction< real_t >& src,
                                                                               const P1Function< real_t >&       dst,
                                                                               uint_t                            level,
                                                                               DoFType                           flag,
                                                                               UpdateType updateType ) const
...
void P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap::toMatrixScaled(
    ...
    DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap_macro_3D(
...
void P2VectorToP1ElementwiseFrozenVelocityP1DensityIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                                  const P2VectorFunction< idx_t >&            src,
                                                                                  const P1Function< idx_t >&                  dst,
                                                                                  uint_t  level,
                                                                                  DoFType flag ) const
