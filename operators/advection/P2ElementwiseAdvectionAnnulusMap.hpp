                                         ...
                                         public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    922    1347      26      21      0              0                 0              1
   void applyScaled_P2ElementwiseAdvectionAnnulusMap_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    886    1341      26      21      0              0                 0              4
   void toMatrixScaled_P2ElementwiseAdvectionAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    682    1101      26      21      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseAdvectionAnnulusMap_macro_2D(
