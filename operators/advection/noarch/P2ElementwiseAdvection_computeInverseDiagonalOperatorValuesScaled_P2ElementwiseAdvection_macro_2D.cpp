...
void P2ElementwiseAdvection::computeInverseDiagonalOperatorValuesScaled_P2ElementwiseAdvection_macro_2D( real_t * RESTRICT  _data_invDiag_Edge, real_t * RESTRICT  _data_invDiag_Vertex, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t diagScaling, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float ) const
{
    {
             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      ...
                      const real_t q_tmp_0_0 = (tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[12*q] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q])*_data_q_w[q]*_data_tabulated_and_untitled_0_0_GRAY[12*q + 1];
                      const real_t q_tmp_1_1 = (tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 2] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 1])*_data_q_w[q]*_data_tabulated_and_untitled_0_0_GRAY[12*q + 7];
                      const real_t q_tmp_2_2 = (tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 3] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 2])*_data_q_w[q]*_data_tabulated_and_untitled_0_0_GRAY[12*q + 8];
                      const real_t q_tmp_3_3 = (tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 4] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 3])*_data_q_w[q]*_data_tabulated_and_untitled_0_0_GRAY[12*q + 9];
                      const real_t q_tmp_4_4 = (tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 5] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 4])*_data_q_w[q]*_data_tabulated_and_untitled_0_0_GRAY[12*q + 10];
                      const real_t q_tmp_5_5 = (tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 6] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 5])*_data_q_w[q]*_data_tabulated_and_untitled_0_0_GRAY[12*q + 11];
             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      ...
                      const real_t q_tmp_0_0 = (tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[12*q] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q])*_data_q_w[q]*_data_tabulated_and_untitled_0_0_BLUE[12*q + 1];
                      const real_t q_tmp_1_1 = (tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 2] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 1])*_data_q_w[q]*_data_tabulated_and_untitled_0_0_BLUE[12*q + 7];
                      const real_t q_tmp_2_2 = (tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 3] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 2])*_data_q_w[q]*_data_tabulated_and_untitled_0_0_BLUE[12*q + 8];
                      const real_t q_tmp_3_3 = (tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 4] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 3])*_data_q_w[q]*_data_tabulated_and_untitled_0_0_BLUE[12*q + 9];
                      const real_t q_tmp_4_4 = (tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 5] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 4])*_data_q_w[q]*_data_tabulated_and_untitled_0_0_BLUE[12*q + 10];
                      const real_t q_tmp_5_5 = (tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 6] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 5])*_data_q_w[q]*_data_tabulated_and_untitled_0_0_BLUE[12*q + 11];
                      q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                      q_acc_1_1 = q_acc_1_1 + q_tmp_1_1;
                      q_acc_2_2 = q_acc_2_2 + q_tmp_2_2;
                      q_acc_3_3 = q_acc_3_3 + q_tmp_3_3;
