...
#include "P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap.hpp"
...
P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap::
    P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap(
                                                                                     ...
                                                                                     UpdateType updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap::apply( const P2Function< real_t >& src,
                                                                               const P2Function< real_t >& dst,
                                                                               uint_t                      level,
                                                                               DoFType                     flag,
                                                                               UpdateType                  updateType ) const
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap::toMatrixScaled(
    ...
    DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                                  const P2Function< idx_t >&                  src,
                                                                                  const P2Function< idx_t >&                  dst,
                                                                                  uint_t  level,
                                                                                  DoFType flag ) const
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap::computeInverseDiagonalOperatorValuesScaled(
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > >
    P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
