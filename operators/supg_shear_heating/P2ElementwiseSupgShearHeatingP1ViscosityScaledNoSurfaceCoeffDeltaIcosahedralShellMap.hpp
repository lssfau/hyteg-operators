...
class P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap
  ...
  public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   6144    8245      91      44     55              0                 0              1
   void applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   6044    8235      91      44     55              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap_macro_3D(
       real_t* RESTRICT                     _data_deltaEdge,
       real_t* RESTRICT                     _data_deltaVertex,
   ...
   real_t cutoff_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap_;
   real_t radius_surface_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap_;
};
