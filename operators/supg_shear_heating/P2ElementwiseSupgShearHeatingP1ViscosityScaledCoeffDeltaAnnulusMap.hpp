...
class P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap
  ...
  public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1094    1494      30      18      0              0                 0              1
   void applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap_macro_2D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1058    1488      30      18      0              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap_macro_2D(
       real_t* RESTRICT                     _data_deltaEdge,
       real_t* RESTRICT                     _data_deltaVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    884    1278      30      18      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap_macro_2D(
       real_t* RESTRICT _data_deltaEdge,
       real_t* RESTRICT _data_deltaVertex,
       real_t* RESTRICT _data_eta,
