...
#include "P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap.hpp"
...
P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap::
    P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap::applyScaled( const real_t& operatorScaling,
                                                                                               ...
                                                                                               UpdateType updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap::apply( const P2Function< real_t >& src,
                                                                                         const P2Function< real_t >& dst,
                                                                                         uint_t                      level,
                                                                                         DoFType                     flag,
                                                                                         UpdateType updateType ) const
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap::toMatrixScaled(
    ...
    DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap::toMatrix(
    const std::shared_ptr< SparseMatrixProxy >& mat,
    const P2Function< idx_t >&                  src,
    const P2Function< idx_t >&                  dst,
    uint_t                                      level,
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap::computeInverseDiagonalOperatorValuesScaled(
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > >
    P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
