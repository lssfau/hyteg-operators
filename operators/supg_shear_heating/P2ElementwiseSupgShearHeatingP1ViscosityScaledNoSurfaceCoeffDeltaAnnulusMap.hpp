...
class P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaAnnulusMap
  ...
  public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1166    1614      42      30     18              0                 0              1
   void applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaAnnulusMap_macro_2D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1130    1608      42      30     18              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaAnnulusMap_macro_2D(
       real_t* RESTRICT                     _data_deltaEdge,
       real_t* RESTRICT                     _data_deltaVertex,
   ...
   real_t                                  cutoff_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaAnnulusMap_;
   real_t radius_surface_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaAnnulusMap_;
};
