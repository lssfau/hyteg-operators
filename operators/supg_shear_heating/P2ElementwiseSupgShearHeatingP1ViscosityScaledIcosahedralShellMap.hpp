...
class P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap
  ...
  public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   6540    8751     168     154    209              0                 0              1
   void applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   6440    8741     168     154    209              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5460    7661     168     154    209              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap_macro_3D(
       real_t* RESTRICT _data_eta,
   ...
   real_t thermal_conductivity_P2ElementwiseSupgShearHeatingP1ViscosityScaledIcosahedralShellMap_;
};
