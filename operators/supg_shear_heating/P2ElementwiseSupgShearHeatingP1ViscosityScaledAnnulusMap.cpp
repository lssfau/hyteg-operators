...
P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap::P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap::apply( const P2Function< real_t >& src,
                                                                      const P2Function< real_t >& dst,
                                                                      uint_t                      level,
                                                                      DoFType                     flag,
                                                                      UpdateType                  updateType ) const
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap::toMatrixScaled( const real_t& toMatrixScaling,
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                         const P2Function< idx_t >&                  src,
                                                                         const P2Function< idx_t >&                  dst,
                                                                         uint_t                                      level,
                                                                         DoFType                                     flag ) const
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap::computeInverseDiagonalOperatorValuesScaled(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
