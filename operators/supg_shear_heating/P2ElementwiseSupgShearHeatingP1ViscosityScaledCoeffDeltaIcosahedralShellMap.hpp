...
class P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap
  ...
  public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5836    7772      69      22      0              0                 0              1
   void applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5736    7762      69      22      0              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaIcosahedralShellMap_macro_3D(
       real_t* RESTRICT                     _data_deltaEdge,
       real_t* RESTRICT                     _data_deltaVertex,
