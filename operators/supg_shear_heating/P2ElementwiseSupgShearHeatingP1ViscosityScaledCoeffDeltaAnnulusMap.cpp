...
P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap::
    P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                        size_t                                     minLevel,
                                                                        size_t                                     maxLevel,
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap::applyScaled( const real_t&               operatorScaling,
                                                                                      ...
                                                                                      UpdateType updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap_macro_2D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap::apply( const P2Function< real_t >& src,
                                                                                const P2Function< real_t >& dst,
                                                                                uint_t                      level,
                                                                                DoFType                     flag,
                                                                                UpdateType                  updateType ) const
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap::toMatrixScaled(
    ...
    DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap_macro_2D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap::toMatrix(
    const std::shared_ptr< SparseMatrixProxy >& mat,
    const P2Function< idx_t >&                  src,
    const P2Function< idx_t >&                  dst,
    uint_t                                      level,
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap::computeInverseDiagonalOperatorValuesScaled(
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap_macro_2D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > >
    P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDeltaAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
