...
P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta::P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta::applyScaled( const real_t&               operatorScaling,
                                                                            ...
                                                                            UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta_macro_3D(
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta_macro_2D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta::apply( const P2Function< real_t >& src,
                                                                      const P2Function< real_t >& dst,
                                                                      uint_t                      level,
                                                                      DoFType                     flag,
                                                                      UpdateType                  updateType ) const
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta::toMatrixScaled( const real_t& toMatrixScaling,
                                                                               ...
                                                                               DoFType flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta_macro_3D(
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta_macro_2D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                         const P2Function< idx_t >&                  src,
                                                                         const P2Function< idx_t >&                  dst,
                                                                         uint_t                                      level,
                                                                         DoFType                                     flag ) const
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta::computeInverseDiagonalOperatorValuesScaled(
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta_macro_3D(
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta_macro_2D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta::getInverseDiagonalValues() const
{
   return invDiag_;
}
