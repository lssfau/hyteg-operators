...
class P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                                 public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap(
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1232    1926      90      66     42              0                 0              1
   void applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1196    1920      90      66     42              0                 0              4
   void
       toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1022    1710      90      66     42              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap_macro_2D(
       real_t* RESTRICT _data_eta,
