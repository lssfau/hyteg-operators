...
class P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap
  ...
  public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1304    2046     102      78     60              0                 0              1
   void applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap_macro_2D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1268    2040     102      78     60              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap_macro_2D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1094    1830     102      78     60              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap_macro_2D(
       real_t* RESTRICT _data_eta,
