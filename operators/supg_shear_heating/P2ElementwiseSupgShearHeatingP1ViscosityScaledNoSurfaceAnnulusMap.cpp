...
P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::
    P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap(
                                                                                     ...
                                                                                     UpdateType updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap_macro_2D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::apply( const P2Function< real_t >& src,
                                                                               const P2Function< real_t >& dst,
                                                                               uint_t                      level,
                                                                               DoFType                     flag,
                                                                               UpdateType                  updateType ) const
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::toMatrixScaled(
    ...
    DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap_macro_2D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                                  const P2Function< idx_t >&                  src,
                                                                                  const P2Function< idx_t >&                  dst,
                                                                                  uint_t  level,
                                                                                  DoFType flag ) const
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::computeInverseDiagonalOperatorValuesScaled(
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap_macro_2D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > >
    P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
