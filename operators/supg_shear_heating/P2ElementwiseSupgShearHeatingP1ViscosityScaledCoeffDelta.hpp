...
class P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                                 public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta( const std::shared_ptr< PrimitiveStorage >& storage,
                                                             size_t                                     minLevel,
                                                             size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    638     762      18       0      0              0                 0              1
   void applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta_macro_2D( real_t* RESTRICT _data_deltaEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3196    3581      47       0      0              0                 0              1
   void applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta_macro_3D( real_t* RESTRICT _data_deltaEdge,
                                                                                       real_t* RESTRICT _data_deltaVertex,
                                                                                       real_t* RESTRICT _data_dstEdge,
                                                                                       real_t* RESTRICT _data_dstVertex,
                                                                                       real_t* RESTRICT _data_eta,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    602     756      18       0      0              0                 0              4
   void
       toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta_macro_2D( real_t* RESTRICT _data_deltaEdge,
                                                                                         real_t* RESTRICT _data_deltaVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3096    3571      47       0      0              0                 0              4
   void
       toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta_macro_3D( real_t* RESTRICT _data_deltaEdge,
                                                                                         real_t* RESTRICT _data_deltaVertex,
                                                                                         idx_t* RESTRICT  _data_dstEdge,
                                                                                         idx_t* RESTRICT  _data_dstVertex,
                                                                                         real_t* RESTRICT _data_eta,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    428     546      18       0      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta_macro_2D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2116    2491      47       0      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta_macro_3D(
       real_t* RESTRICT _data_deltaEdge,
       real_t* RESTRICT _data_deltaVertex,
       real_t* RESTRICT _data_eta,
       real_t* RESTRICT _data_invDiag_Edge,
