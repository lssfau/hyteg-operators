...
#include "P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap.hpp"
                                                                                              ...
                                                                                              UpdateType updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap::apply( const P2Function< real_t >& src,
                                                                                        const P2Function< real_t >& dst,
                                                                                        uint_t                      level,
                                                                                        DoFType                     flag,
                                                                                        UpdateType updateType ) const
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap::toMatrixScaled(
    ...
    DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap::toMatrix(
    const std::shared_ptr< SparseMatrixProxy >& mat,
    const P2Function< idx_t >&                  src,
    const P2Function< idx_t >&                  dst,
    uint_t                                      level,
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap::computeInverseDiagonalOperatorValuesScaled(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > >
    P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
