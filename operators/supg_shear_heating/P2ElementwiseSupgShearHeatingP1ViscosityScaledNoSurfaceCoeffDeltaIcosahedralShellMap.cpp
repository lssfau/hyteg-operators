...
#include "P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap.hpp"
...
P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap::
    P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap(
        ...
        real_t cutoff_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap,
        real_t radius_surface_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap )
...
, uy( _uy )
, uz( _uz )
, cutoff_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap_(
      cutoff_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap )
, radius_surface_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap_(
      radius_surface_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap )
{}

void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap::applyScaled(
    ...
    UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap::apply( const P2Function< real_t >& src,
                                                                                                  const P2Function< real_t >& dst,
                                                                                                  uint_t     level,
                                                                                                  DoFType    flag,
                                                                                                  UpdateType updateType ) const
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap::toMatrixScaled(
    ...
    DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap::toMatrix(
    const std::shared_ptr< SparseMatrixProxy >& mat,
    const P2Function< idx_t >&                  src,
    const P2Function< idx_t >&                  dst,
    uint_t                                      level,
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap::
    computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > >
    P2ElementwiseSupgShearHeatingP1ViscosityScaledNoSurfaceCoeffDeltaIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
