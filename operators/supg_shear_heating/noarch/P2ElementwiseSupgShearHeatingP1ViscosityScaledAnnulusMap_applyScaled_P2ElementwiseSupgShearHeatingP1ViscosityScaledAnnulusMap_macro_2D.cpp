...
#include "../P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap.hpp"
...
{
    {
       ...
       const real_t tmp_qloop_83 = 1.0 / (thermal_conductivity*thermal_conductivity*thermal_conductivity);
       const real_t tmp_qloop_94 = 1.0 / (thermal_conductivity);
       for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
       {
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             const real_t tmp_qloop_57 = ((ux_dof_0*-0.11111111111111111 + ux_dof_1*-0.11111111111111111 + ux_dof_2*-0.11111111111111111 + ux_dof_3*0.44444444444444444 + ux_dof_4*0.44444444444444444 + ux_dof_5*0.44444444444444444)*(ux_dof_0*-0.11111111111111111 + ux_dof_1*-0.11111111111111111 + ux_dof_2*-0.11111111111111111 + ux_dof_3*0.44444444444444444 + ux_dof_4*0.44444444444444444 + ux_dof_5*0.44444444444444444)) + ((uy_dof_0*-0.11111111111111111 + uy_dof_1*-0.11111111111111111 + uy_dof_2*-0.11111111111111111 + uy_dof_3*0.44444444444444444 + uy_dof_4*0.44444444444444444 + uy_dof_5*0.44444444444444444)*(uy_dof_0*-0.11111111111111111 + uy_dof_1*-0.11111111111111111 + uy_dof_2*-0.11111111111111111 + uy_dof_3*0.44444444444444444 + uy_dof_4*0.44444444444444444 + uy_dof_5*0.44444444444444444));
             const real_t tmp_qloop_58 = pow(tmp_qloop_57, 0.50000000000000000);
             const real_t tmp_qloop_59 = 1.0 / (tmp_qloop_58);
             const real_t tmp_qloop_84 = pow(tmp_qloop_57, 1.5000000000000000);
             {
                {
                   ...
                   const real_t tmp_qloop_85 = (abs(tmp_qloop_0)*abs(tmp_qloop_0)) + (abs(tmp_qloop_6)*abs(tmp_qloop_6));
                   const real_t tmp_qloop_86 = pow(tmp_qloop_85, 1.5000000000000000);
                   const real_t tmp_qloop_87 = (abs(tmp_qloop_2)*abs(tmp_qloop_2)) + (abs(tmp_qloop_8)*abs(tmp_qloop_8));
                   const real_t tmp_qloop_88 = pow(tmp_qloop_87, 1.5000000000000000);
                   const real_t tmp_qloop_89 = (abs(p_affine_1_0 + tmp_qloop_1)*abs(p_affine_1_0 + tmp_qloop_1)) + (abs(p_affine_1_1 + tmp_qloop_7)*abs(p_affine_1_1 + tmp_qloop_7));
                   const real_t tmp_qloop_90 = pow(tmp_qloop_89, 1.5000000000000000);
                   const real_t tmp_qloop_91 = abs(tmp_qloop_0*tmp_qloop_8 - tmp_qloop_2*tmp_qloop_6);
                   const real_t tmp_qloop_92 = 1.0 / (tmp_qloop_91*tmp_qloop_91*tmp_qloop_91);
                   const real_t tmp_qloop_93 = tmp_qloop_83*tmp_qloop_84*tmp_qloop_86*tmp_qloop_88*tmp_qloop_90*tmp_qloop_92;
                   const real_t tmp_qloop_95 = pow(tmp_qloop_85, 0.50000000000000000);
                   const real_t tmp_qloop_96 = pow(tmp_qloop_87, 0.50000000000000000);
                   const real_t tmp_qloop_97 = pow(tmp_qloop_89, 0.50000000000000000);
                   const real_t tmp_qloop_98 = 1.0 / (tmp_qloop_91);
                   const real_t tmp_qloop_99 = tmp_qloop_95*tmp_qloop_96*tmp_qloop_97*tmp_qloop_98;
                   const real_t tmp_qloop_100 = tmp_qloop_58*tmp_qloop_94*tmp_qloop_99;
                   const real_t tmp_qloop_101 = 1.0 / (thermal_conductivity*thermal_conductivity)*tmp_qloop_57*tmp_qloop_85*tmp_qloop_87*tmp_qloop_89*1.0 / (tmp_qloop_91*tmp_qloop_91);
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      ...
                      const real_t tmp_qloop_60 = 1.0 - _data_q_p_0[q] - _data_q_p_1[q];
                      const real_t tmp_qloop_62 = tmp_qloop_43 - 1.0;
                      const real_t tmp_qloop_63 = tmp_qloop_43 + tmp_qloop_51 - 3.0;
                      const real_t tmp_qloop_64 = tmp_qloop_63*uy_dof_0;
                      const real_t tmp_qloop_65 = -tmp_qloop_51 - 8.0*_data_q_p_0[q] + 4.0;
                      const real_t tmp_qloop_66 = tmp_qloop_51*uy_dof_3 - tmp_qloop_51*uy_dof_4 + tmp_qloop_62*uy_dof_1 + tmp_qloop_64 + tmp_qloop_65*uy_dof_5;
                      const real_t tmp_qloop_68 = tmp_qloop_51 - 1.0;
                      const real_t tmp_qloop_69 = -tmp_qloop_43 - 8.0*_data_q_p_1[q] + 4.0;
                      const real_t tmp_qloop_70 = tmp_qloop_43*uy_dof_3 - tmp_qloop_43*uy_dof_5 + tmp_qloop_64 + tmp_qloop_68*uy_dof_2 + tmp_qloop_69*uy_dof_4;
                      const real_t tmp_qloop_73 = tmp_qloop_63*ux_dof_0;
                      const real_t tmp_qloop_74 = tmp_qloop_51*ux_dof_3 - tmp_qloop_51*ux_dof_4 + tmp_qloop_62*ux_dof_1 + tmp_qloop_65*ux_dof_5 + tmp_qloop_73;
                      const real_t tmp_qloop_76 = tmp_qloop_43*ux_dof_3 - tmp_qloop_43*ux_dof_5 + tmp_qloop_68*ux_dof_2 + tmp_qloop_69*ux_dof_4 + tmp_qloop_73;
                      ...
                      const real_t tmp_qloop_61 = jac_affine_inv_0_0_GRAY*jac_blending_inv_0_0 + jac_affine_inv_0_1_GRAY*jac_blending_inv_1_0;
                      const real_t tmp_qloop_67 = jac_affine_inv_1_0_GRAY*jac_blending_inv_0_0 + jac_affine_inv_1_1_GRAY*jac_blending_inv_1_0;
                      const real_t tmp_qloop_71 = tmp_qloop_61*tmp_qloop_66 + tmp_qloop_67*tmp_qloop_70;
                      const real_t tmp_qloop_79 = tmp_qloop_61*tmp_qloop_74 + tmp_qloop_67*tmp_qloop_76;
                      const real_t jac_blending_inv_1_1 = jac_blending_0_0*tmp_qloop_28;
                      const real_t tmp_qloop_72 = jac_affine_inv_0_0_GRAY*jac_blending_inv_0_1 + jac_affine_inv_0_1_GRAY*jac_blending_inv_1_1;
                      const real_t tmp_qloop_75 = jac_affine_inv_1_0_GRAY*jac_blending_inv_0_1 + jac_affine_inv_1_1_GRAY*jac_blending_inv_1_1;
                      const real_t tmp_qloop_77 = tmp_qloop_72*tmp_qloop_74 + tmp_qloop_75*tmp_qloop_76;
                      const real_t tmp_qloop_78 = tmp_qloop_71 + tmp_qloop_77;
                      const real_t tmp_qloop_80 = tmp_qloop_66*tmp_qloop_72;
                      const real_t tmp_qloop_81 = tmp_qloop_70*tmp_qloop_75;
                      const real_t tmp_qloop_82 = tmp_qloop_79 - tmp_qloop_80 - tmp_qloop_81;
                      const real_t tmp_qloop_102 = abs_det_jac_blending*tmp_qloop_59*tmp_qloop_99*(eta_dof_0*tmp_qloop_60 + eta_dof_1*_data_q_p_0[q] + eta_dof_2*_data_q_p_1[q])*1.0 / (rho_dof_0*tmp_qloop_60 + rho_dof_1*_data_q_p_0[q] + rho_dof_2*_data_q_p_1[q])*(tmp_qloop_71*tmp_qloop_78 + tmp_qloop_77*tmp_qloop_78 + tmp_qloop_79*tmp_qloop_82 - tmp_qloop_82*(tmp_qloop_80 + tmp_qloop_81))*0.50000000000000000*((tmp_qloop_100 <= 1.1799999561582399) ? (tmp_qloop_100*0.16666666666666667 + tmp_qloop_93*-0.0027777777777777778): ((tmp_qloop_100 <= 3.0159389978870399) ? (tmp_qloop_101*-0.0089393368193446242 + tmp_qloop_58*tmp_qloop_94*tmp_qloop_95*tmp_qloop_96*tmp_qloop_97*tmp_qloop_98*0.17969906536907199 + tmp_qloop_93*-0.00051942446859271248 - 0.0064954259688208404): ((tmp_qloop_100 <= 6.7434348119715999) ? (tmp_qloop_101*-0.020516694887729999 + tmp_qloop_58*tmp_qloop_94*tmp_qloop_95*tmp_qloop_96*tmp_qloop_97*tmp_qloop_98*0.2146156710600175 + tmp_qloop_83*tmp_qloop_84*tmp_qloop_86*tmp_qloop_88*tmp_qloop_90*tmp_qloop_92*0.00076015027042957372 - 0.041597543561209399): ((tmp_qloop_100 <= 9.7000000058627194) ? (tmp_qloop_100*0.16399221771597999 + tmp_qloop_101*-0.01300962248982295 + tmp_qloop_93*0.0003890697253152925 + 0.072194442299590406): (thermal_conductivity*tmp_qloop_59*tmp_qloop_91*1.0 / (tmp_qloop_95)*1.0 / (tmp_qloop_96)*1.0 / (tmp_qloop_97)*-2.0 + 1.0)))))*_data_q_w[q];
                      const real_t tmp_qloop_103 = tmp_qloop_102*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 1] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_GRAY[6*q]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_GRAY[12*q + 1] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_GRAY[6*q]));
                      const real_t tmp_qloop_104 = tmp_qloop_102*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 7] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_GRAY[6*q + 1]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_GRAY[12*q + 7] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 1]));
                      const real_t tmp_qloop_105 = tmp_qloop_102*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 8] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_GRAY[6*q + 2]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_GRAY[12*q + 8] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 2]));
                      const real_t tmp_qloop_106 = tmp_qloop_102*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 9] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_GRAY[6*q + 3]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_GRAY[12*q + 9] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 3]));
                      const real_t tmp_qloop_107 = tmp_qloop_102*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 10] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_GRAY[6*q + 4]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_GRAY[12*q + 10] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 4]));
                      const real_t tmp_qloop_108 = tmp_qloop_102*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 11] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_GRAY[6*q + 5]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_GRAY[12*q + 11] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 5]));
                      ...
                      const real_t q_tmp_0_0 = tmp_qloop_103*_data_tabulated_and_untitled_0_0_GRAY[12*q];
                      const real_t q_tmp_0_1 = tmp_qloop_103*_data_tabulated_and_untitled_0_0_GRAY[12*q + 2];
                      const real_t q_tmp_0_2 = tmp_qloop_103*_data_tabulated_and_untitled_0_0_GRAY[12*q + 3];
                      const real_t q_tmp_0_3 = tmp_qloop_103*_data_tabulated_and_untitled_0_0_GRAY[12*q + 4];
                      const real_t q_tmp_0_4 = tmp_qloop_103*_data_tabulated_and_untitled_0_0_GRAY[12*q + 5];
                      const real_t q_tmp_0_5 = tmp_qloop_103*_data_tabulated_and_untitled_0_0_GRAY[12*q + 6];
                      const real_t q_tmp_1_0 = tmp_qloop_104*_data_tabulated_and_untitled_0_0_GRAY[12*q];
                      const real_t q_tmp_1_1 = tmp_qloop_104*_data_tabulated_and_untitled_0_0_GRAY[12*q + 2];
                      const real_t q_tmp_1_2 = tmp_qloop_104*_data_tabulated_and_untitled_0_0_GRAY[12*q + 3];
                      const real_t q_tmp_1_3 = tmp_qloop_104*_data_tabulated_and_untitled_0_0_GRAY[12*q + 4];
                      const real_t q_tmp_1_4 = tmp_qloop_104*_data_tabulated_and_untitled_0_0_GRAY[12*q + 5];
                      const real_t q_tmp_1_5 = tmp_qloop_104*_data_tabulated_and_untitled_0_0_GRAY[12*q + 6];
                      const real_t q_tmp_2_0 = tmp_qloop_105*_data_tabulated_and_untitled_0_0_GRAY[12*q];
                      const real_t q_tmp_2_1 = tmp_qloop_105*_data_tabulated_and_untitled_0_0_GRAY[12*q + 2];
                      const real_t q_tmp_2_2 = tmp_qloop_105*_data_tabulated_and_untitled_0_0_GRAY[12*q + 3];
                      const real_t q_tmp_2_3 = tmp_qloop_105*_data_tabulated_and_untitled_0_0_GRAY[12*q + 4];
                      const real_t q_tmp_2_4 = tmp_qloop_105*_data_tabulated_and_untitled_0_0_GRAY[12*q + 5];
                      const real_t q_tmp_2_5 = tmp_qloop_105*_data_tabulated_and_untitled_0_0_GRAY[12*q + 6];
                      const real_t q_tmp_3_0 = tmp_qloop_106*_data_tabulated_and_untitled_0_0_GRAY[12*q];
                      const real_t q_tmp_3_1 = tmp_qloop_106*_data_tabulated_and_untitled_0_0_GRAY[12*q + 2];
                      const real_t q_tmp_3_2 = tmp_qloop_106*_data_tabulated_and_untitled_0_0_GRAY[12*q + 3];
                      const real_t q_tmp_3_3 = tmp_qloop_106*_data_tabulated_and_untitled_0_0_GRAY[12*q + 4];
                      const real_t q_tmp_3_4 = tmp_qloop_106*_data_tabulated_and_untitled_0_0_GRAY[12*q + 5];
                      const real_t q_tmp_3_5 = tmp_qloop_106*_data_tabulated_and_untitled_0_0_GRAY[12*q + 6];
                      const real_t q_tmp_4_0 = tmp_qloop_107*_data_tabulated_and_untitled_0_0_GRAY[12*q];
                      const real_t q_tmp_4_1 = tmp_qloop_107*_data_tabulated_and_untitled_0_0_GRAY[12*q + 2];
                      const real_t q_tmp_4_2 = tmp_qloop_107*_data_tabulated_and_untitled_0_0_GRAY[12*q + 3];
                      const real_t q_tmp_4_3 = tmp_qloop_107*_data_tabulated_and_untitled_0_0_GRAY[12*q + 4];
                      const real_t q_tmp_4_4 = tmp_qloop_107*_data_tabulated_and_untitled_0_0_GRAY[12*q + 5];
                      const real_t q_tmp_4_5 = tmp_qloop_107*_data_tabulated_and_untitled_0_0_GRAY[12*q + 6];
                      const real_t q_tmp_5_0 = tmp_qloop_108*_data_tabulated_and_untitled_0_0_GRAY[12*q];
                      const real_t q_tmp_5_1 = tmp_qloop_108*_data_tabulated_and_untitled_0_0_GRAY[12*q + 2];
                      const real_t q_tmp_5_2 = tmp_qloop_108*_data_tabulated_and_untitled_0_0_GRAY[12*q + 3];
                      const real_t q_tmp_5_3 = tmp_qloop_108*_data_tabulated_and_untitled_0_0_GRAY[12*q + 4];
                      const real_t q_tmp_5_4 = tmp_qloop_108*_data_tabulated_and_untitled_0_0_GRAY[12*q + 5];
                      const real_t q_tmp_5_5 = tmp_qloop_108*_data_tabulated_and_untitled_0_0_GRAY[12*q + 6];
             ...
             const real_t tmp_moved_constant_24 = ((tmp_moved_constant_12*-0.11111111111111111 + tmp_moved_constant_13*-0.11111111111111111 + tmp_moved_constant_14*-0.11111111111111111 + tmp_moved_constant_15*0.44444444444444444 + tmp_moved_constant_16*0.44444444444444444 + tmp_moved_constant_17*0.44444444444444444)*(tmp_moved_constant_12*-0.11111111111111111 + tmp_moved_constant_13*-0.11111111111111111 + tmp_moved_constant_14*-0.11111111111111111 + tmp_moved_constant_15*0.44444444444444444 + tmp_moved_constant_16*0.44444444444444444 + tmp_moved_constant_17*0.44444444444444444)) + ((tmp_moved_constant_18*-0.11111111111111111 + tmp_moved_constant_19*-0.11111111111111111 + tmp_moved_constant_20*-0.11111111111111111 + tmp_moved_constant_21*0.44444444444444444 + tmp_moved_constant_22*0.44444444444444444 + tmp_moved_constant_23*0.44444444444444444)*(tmp_moved_constant_18*-0.11111111111111111 + tmp_moved_constant_19*-0.11111111111111111 + tmp_moved_constant_20*-0.11111111111111111 + tmp_moved_constant_21*0.44444444444444444 + tmp_moved_constant_22*0.44444444444444444 + tmp_moved_constant_23*0.44444444444444444));
             const real_t tmp_moved_constant_25 = pow(tmp_moved_constant_24, 0.50000000000000000);
             const real_t tmp_moved_constant_26 = 1.0 / (tmp_moved_constant_25);
             const real_t tmp_moved_constant_27 = pow(tmp_moved_constant_24, 1.5000000000000000);
             {
                {
                   ...
                   const real_t tmp_qloop_91 = abs(tmp_qloop_0*tmp_qloop_8 - tmp_qloop_2*tmp_qloop_6);
                   const real_t tmp_qloop_92 = 1.0 / (tmp_qloop_91*tmp_qloop_91*tmp_qloop_91);
                   const real_t tmp_qloop_93 = tmp_moved_constant_27*tmp_qloop_83*tmp_qloop_86*tmp_qloop_88*tmp_qloop_90*tmp_qloop_92;
                   const real_t tmp_qloop_95 = pow(tmp_qloop_85, 0.50000000000000000);
                   const real_t tmp_qloop_96 = pow(tmp_qloop_87, 0.50000000000000000);
                   const real_t tmp_qloop_97 = pow(tmp_qloop_89, 0.50000000000000000);
                   const real_t tmp_qloop_98 = 1.0 / (tmp_qloop_91);
                   const real_t tmp_qloop_99 = tmp_qloop_95*tmp_qloop_96*tmp_qloop_97*tmp_qloop_98;
                   const real_t tmp_qloop_100 = tmp_moved_constant_25*tmp_qloop_94*tmp_qloop_99;
                   const real_t tmp_qloop_101 = 1.0 / (thermal_conductivity*thermal_conductivity)*tmp_moved_constant_24*tmp_qloop_85*tmp_qloop_87*tmp_qloop_89*1.0 / (tmp_qloop_91*tmp_qloop_91);
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      const real_t tmp_qloop_3 = p_affine_0_0 - tmp_qloop_0*_data_q_p_0[q] - tmp_qloop_2*_data_q_p_1[q];
                      const real_t tmp_qloop_5 = (tmp_qloop_3*tmp_qloop_3);
                      ...
                      const real_t tmp_qloop_53 = tmp_qloop_43 - tmp_qloop_44 + tmp_qloop_45*-4.0;
                      const real_t tmp_qloop_54 = tmp_qloop_44 + tmp_qloop_46 + tmp_qloop_49 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0;
                      const real_t tmp_qloop_55 = tmp_moved_constant_12*tmp_qloop_54 + tmp_moved_constant_13*tmp_qloop_47 + tmp_moved_constant_14*tmp_qloop_50 + tmp_moved_constant_15*tmp_qloop_44 + tmp_moved_constant_16*tmp_qloop_52 + tmp_moved_constant_17*tmp_qloop_53;
                      const real_t tmp_qloop_56 = tmp_moved_constant_18*tmp_qloop_54 + tmp_moved_constant_19*tmp_qloop_47 + tmp_moved_constant_20*tmp_qloop_50 + tmp_moved_constant_21*tmp_qloop_44 + tmp_moved_constant_22*tmp_qloop_52 + tmp_moved_constant_23*tmp_qloop_53;
                      const real_t tmp_qloop_60 = 1.0 - _data_q_p_0[q] - _data_q_p_1[q];
                      const real_t tmp_qloop_62 = tmp_qloop_43 - 1.0;
                      const real_t tmp_qloop_63 = tmp_qloop_43 + tmp_qloop_51 - 3.0;
                      const real_t tmp_qloop_64 = tmp_moved_constant_18*tmp_qloop_63;
                      const real_t tmp_qloop_65 = -tmp_qloop_51 - 8.0*_data_q_p_0[q] + 4.0;
                      const real_t tmp_qloop_66 = tmp_moved_constant_19*tmp_qloop_62 + tmp_moved_constant_21*tmp_qloop_51 - tmp_moved_constant_22*tmp_qloop_51 + tmp_moved_constant_23*tmp_qloop_65 + tmp_qloop_64;
                      const real_t tmp_qloop_68 = tmp_qloop_51 - 1.0;
                      const real_t tmp_qloop_69 = -tmp_qloop_43 - 8.0*_data_q_p_1[q] + 4.0;
                      const real_t tmp_qloop_70 = tmp_moved_constant_20*tmp_qloop_68 + tmp_moved_constant_21*tmp_qloop_43 + tmp_moved_constant_22*tmp_qloop_69 - tmp_moved_constant_23*tmp_qloop_43 + tmp_qloop_64;
                      const real_t tmp_qloop_73 = tmp_moved_constant_12*tmp_qloop_63;
                      const real_t tmp_qloop_74 = tmp_moved_constant_13*tmp_qloop_62 + tmp_moved_constant_15*tmp_qloop_51 - tmp_moved_constant_16*tmp_qloop_51 + tmp_moved_constant_17*tmp_qloop_65 + tmp_qloop_73;
                      const real_t tmp_qloop_76 = tmp_moved_constant_14*tmp_qloop_68 + tmp_moved_constant_15*tmp_qloop_43 + tmp_moved_constant_16*tmp_qloop_69 - tmp_moved_constant_17*tmp_qloop_43 + tmp_qloop_73;
                      const real_t jac_blending_0_0 = tmp_qloop_10*tmp_qloop_24 + tmp_qloop_20*tmp_qloop_3;
                      const real_t jac_blending_0_1 = -tmp_qloop_21*tmp_qloop_22*tmp_qloop_3*tmp_qloop_9 - tmp_qloop_25*tmp_qloop_3;
                      const real_t jac_blending_1_0 = tmp_qloop_20*tmp_qloop_9 - tmp_qloop_26*tmp_qloop_9;
                      const real_t jac_blending_1_1 = tmp_qloop_21*tmp_qloop_22*tmp_qloop_5*1.0 - tmp_qloop_25*tmp_qloop_9;
                      ...
                      const real_t jac_blending_inv_0_1 = -jac_blending_0_1*tmp_qloop_28;
                      const real_t jac_blending_inv_1_0 = -jac_blending_1_0*tmp_qloop_28;
                      const real_t tmp_qloop_61 = jac_affine_inv_0_0_BLUE*jac_blending_inv_0_0 + jac_affine_inv_0_1_BLUE*jac_blending_inv_1_0;
                      const real_t tmp_qloop_67 = jac_affine_inv_1_0_BLUE*jac_blending_inv_0_0 + jac_affine_inv_1_1_BLUE*jac_blending_inv_1_0;
                      const real_t tmp_qloop_71 = tmp_qloop_61*tmp_qloop_66 + tmp_qloop_67*tmp_qloop_70;
                      const real_t tmp_qloop_79 = tmp_qloop_61*tmp_qloop_74 + tmp_qloop_67*tmp_qloop_76;
                      const real_t jac_blending_inv_1_1 = jac_blending_0_0*tmp_qloop_28;
                      const real_t tmp_qloop_72 = jac_affine_inv_0_0_BLUE*jac_blending_inv_0_1 + jac_affine_inv_0_1_BLUE*jac_blending_inv_1_1;
                      const real_t tmp_qloop_75 = jac_affine_inv_1_0_BLUE*jac_blending_inv_0_1 + jac_affine_inv_1_1_BLUE*jac_blending_inv_1_1;
                      const real_t tmp_qloop_77 = tmp_qloop_72*tmp_qloop_74 + tmp_qloop_75*tmp_qloop_76;
                      const real_t tmp_qloop_78 = tmp_qloop_71 + tmp_qloop_77;
                      const real_t tmp_qloop_80 = tmp_qloop_66*tmp_qloop_72;
                      const real_t tmp_qloop_81 = tmp_qloop_70*tmp_qloop_75;
                      const real_t tmp_qloop_82 = tmp_qloop_79 - tmp_qloop_80 - tmp_qloop_81;
                      const real_t tmp_qloop_102 = abs_det_jac_blending*tmp_moved_constant_26*tmp_qloop_99*1.0 / (tmp_moved_constant_10*_data_q_p_0[q] + tmp_moved_constant_11*_data_q_p_1[q] + tmp_moved_constant_9*tmp_qloop_60)*(tmp_moved_constant_6*tmp_qloop_60 + tmp_moved_constant_7*_data_q_p_0[q] + tmp_moved_constant_8*_data_q_p_1[q])*(tmp_qloop_71*tmp_qloop_78 + tmp_qloop_77*tmp_qloop_78 + tmp_qloop_79*tmp_qloop_82 - tmp_qloop_82*(tmp_qloop_80 + tmp_qloop_81))*0.50000000000000000*((tmp_qloop_100 <= 1.1799999561582399) ? (tmp_qloop_100*0.16666666666666667 + tmp_qloop_93*-0.0027777777777777778): ((tmp_qloop_100 <= 3.0159389978870399) ? (tmp_moved_constant_25*tmp_qloop_94*tmp_qloop_95*tmp_qloop_96*tmp_qloop_97*tmp_qloop_98*0.17969906536907199 + tmp_qloop_101*-0.0089393368193446242 + tmp_qloop_93*-0.00051942446859271248 - 0.0064954259688208404): ((tmp_qloop_100 <= 6.7434348119715999) ? (tmp_moved_constant_25*tmp_qloop_94*tmp_qloop_95*tmp_qloop_96*tmp_qloop_97*tmp_qloop_98*0.2146156710600175 + tmp_moved_constant_27*tmp_qloop_83*tmp_qloop_86*tmp_qloop_88*tmp_qloop_90*tmp_qloop_92*0.00076015027042957372 + tmp_qloop_101*-0.020516694887729999 - 0.041597543561209399): ((tmp_qloop_100 <= 9.7000000058627194) ? (tmp_qloop_100*0.16399221771597999 + tmp_qloop_101*-0.01300962248982295 + tmp_qloop_93*0.0003890697253152925 + 0.072194442299590406): (thermal_conductivity*tmp_moved_constant_26*tmp_qloop_91*1.0 / (tmp_qloop_95)*1.0 / (tmp_qloop_96)*1.0 / (tmp_qloop_97)*-2.0 + 1.0)))))*_data_q_w[q];
                      const real_t tmp_qloop_103 = tmp_qloop_102*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 1] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_BLUE[6*q]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_BLUE[12*q + 1] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_BLUE[6*q]));
                      const real_t tmp_qloop_104 = tmp_qloop_102*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 7] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_BLUE[6*q + 1]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_BLUE[12*q + 7] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 1]));
                      const real_t tmp_qloop_105 = tmp_qloop_102*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 8] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_BLUE[6*q + 2]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_BLUE[12*q + 8] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 2]));
                      const real_t tmp_qloop_106 = tmp_qloop_102*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 9] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_BLUE[6*q + 3]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_BLUE[12*q + 9] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 3]));
                      const real_t tmp_qloop_107 = tmp_qloop_102*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 10] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_BLUE[6*q + 4]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_BLUE[12*q + 10] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 4]));
                      const real_t tmp_qloop_108 = tmp_qloop_102*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 11] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_BLUE[6*q + 5]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_BLUE[12*q + 11] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 5]));
                      const real_t hessian_blending_0_0_0 = tmp_qloop_20 - tmp_qloop_31 + tmp_qloop_34;
                      const real_t hessian_blending_1_0_0 = tmp_qloop_10*tmp_qloop_35 - tmp_qloop_32*(tmp_qloop_9*tmp_qloop_9*tmp_qloop_9) - tmp_qloop_37 + tmp_qloop_38*tmp_qloop_9;
                      const real_t hessian_blending_0_0_1 = tmp_qloop_17*tmp_qloop_21*tmp_qloop_36*tmp_qloop_4*-2.0 - tmp_qloop_40;
                      const real_t hessian_blending_1_0_1 = tmp_qloop_12*tmp_qloop_15*tmp_qloop_16*tmp_qloop_4*1.0 - tmp_qloop_26 - tmp_qloop_34 - tmp_qloop_41;
                      ...
                      const real_t hessian_blending_0_1_1 = tmp_qloop_3*tmp_qloop_38 - (tmp_qloop_3*tmp_qloop_3*tmp_qloop_3)*tmp_qloop_32 + tmp_qloop_31 + tmp_qloop_42;
                      const real_t hessian_blending_1_1_1 = tmp_qloop_10*tmp_qloop_14*tmp_qloop_15*tmp_qloop_16*tmp_qloop_21*1.0 + tmp_qloop_13*tmp_qloop_15*tmp_qloop_16*tmp_qloop_21*tmp_qloop_5*1.0 - tmp_qloop_25 - tmp_qloop_39;
                      const real_t q_tmp_0_0 = tmp_qloop_103*_data_tabulated_and_untitled_0_0_BLUE[12*q];
                      const real_t q_tmp_0_1 = tmp_qloop_103*_data_tabulated_and_untitled_0_0_BLUE[12*q + 2];
                      const real_t q_tmp_0_2 = tmp_qloop_103*_data_tabulated_and_untitled_0_0_BLUE[12*q + 3];
                      const real_t q_tmp_0_3 = tmp_qloop_103*_data_tabulated_and_untitled_0_0_BLUE[12*q + 4];
                      const real_t q_tmp_0_4 = tmp_qloop_103*_data_tabulated_and_untitled_0_0_BLUE[12*q + 5];
                      const real_t q_tmp_0_5 = tmp_qloop_103*_data_tabulated_and_untitled_0_0_BLUE[12*q + 6];
                      const real_t q_tmp_1_0 = tmp_qloop_104*_data_tabulated_and_untitled_0_0_BLUE[12*q];
                      const real_t q_tmp_1_1 = tmp_qloop_104*_data_tabulated_and_untitled_0_0_BLUE[12*q + 2];
                      const real_t q_tmp_1_2 = tmp_qloop_104*_data_tabulated_and_untitled_0_0_BLUE[12*q + 3];
                      const real_t q_tmp_1_3 = tmp_qloop_104*_data_tabulated_and_untitled_0_0_BLUE[12*q + 4];
                      const real_t q_tmp_1_4 = tmp_qloop_104*_data_tabulated_and_untitled_0_0_BLUE[12*q + 5];
                      const real_t q_tmp_1_5 = tmp_qloop_104*_data_tabulated_and_untitled_0_0_BLUE[12*q + 6];
                      const real_t q_tmp_2_0 = tmp_qloop_105*_data_tabulated_and_untitled_0_0_BLUE[12*q];
                      const real_t q_tmp_2_1 = tmp_qloop_105*_data_tabulated_and_untitled_0_0_BLUE[12*q + 2];
                      const real_t q_tmp_2_2 = tmp_qloop_105*_data_tabulated_and_untitled_0_0_BLUE[12*q + 3];
                      const real_t q_tmp_2_3 = tmp_qloop_105*_data_tabulated_and_untitled_0_0_BLUE[12*q + 4];
                      const real_t q_tmp_2_4 = tmp_qloop_105*_data_tabulated_and_untitled_0_0_BLUE[12*q + 5];
                      const real_t q_tmp_2_5 = tmp_qloop_105*_data_tabulated_and_untitled_0_0_BLUE[12*q + 6];
                      const real_t q_tmp_3_0 = tmp_qloop_106*_data_tabulated_and_untitled_0_0_BLUE[12*q];
                      const real_t q_tmp_3_1 = tmp_qloop_106*_data_tabulated_and_untitled_0_0_BLUE[12*q + 2];
                      const real_t q_tmp_3_2 = tmp_qloop_106*_data_tabulated_and_untitled_0_0_BLUE[12*q + 3];
                      const real_t q_tmp_3_3 = tmp_qloop_106*_data_tabulated_and_untitled_0_0_BLUE[12*q + 4];
                      const real_t q_tmp_3_4 = tmp_qloop_106*_data_tabulated_and_untitled_0_0_BLUE[12*q + 5];
                      const real_t q_tmp_3_5 = tmp_qloop_106*_data_tabulated_and_untitled_0_0_BLUE[12*q + 6];
                      const real_t q_tmp_4_0 = tmp_qloop_107*_data_tabulated_and_untitled_0_0_BLUE[12*q];
                      const real_t q_tmp_4_1 = tmp_qloop_107*_data_tabulated_and_untitled_0_0_BLUE[12*q + 2];
                      const real_t q_tmp_4_2 = tmp_qloop_107*_data_tabulated_and_untitled_0_0_BLUE[12*q + 3];
                      const real_t q_tmp_4_3 = tmp_qloop_107*_data_tabulated_and_untitled_0_0_BLUE[12*q + 4];
                      const real_t q_tmp_4_4 = tmp_qloop_107*_data_tabulated_and_untitled_0_0_BLUE[12*q + 5];
                      const real_t q_tmp_4_5 = tmp_qloop_107*_data_tabulated_and_untitled_0_0_BLUE[12*q + 6];
                      const real_t q_tmp_5_0 = tmp_qloop_108*_data_tabulated_and_untitled_0_0_BLUE[12*q];
                      const real_t q_tmp_5_1 = tmp_qloop_108*_data_tabulated_and_untitled_0_0_BLUE[12*q + 2];
                      const real_t q_tmp_5_2 = tmp_qloop_108*_data_tabulated_and_untitled_0_0_BLUE[12*q + 3];
                      const real_t q_tmp_5_3 = tmp_qloop_108*_data_tabulated_and_untitled_0_0_BLUE[12*q + 4];
                      const real_t q_tmp_5_4 = tmp_qloop_108*_data_tabulated_and_untitled_0_0_BLUE[12*q + 5];
                      const real_t q_tmp_5_5 = tmp_qloop_108*_data_tabulated_and_untitled_0_0_BLUE[12*q + 6];
                      q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                      q_acc_0_1 = q_acc_0_1 + q_tmp_0_1;
                      q_acc_0_2 = q_acc_0_2 + q_tmp_0_2;
                      q_acc_0_3 = q_acc_0_3 + q_tmp_0_3;
