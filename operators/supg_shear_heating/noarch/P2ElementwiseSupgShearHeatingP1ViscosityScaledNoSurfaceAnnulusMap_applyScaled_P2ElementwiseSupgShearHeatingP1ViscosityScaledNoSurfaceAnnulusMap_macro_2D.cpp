...
{
    {
       ...
       const real_t tmp_qloop_91 = 1.0 / (thermal_conductivity*thermal_conductivity*thermal_conductivity);
       const real_t tmp_qloop_102 = 1.0 / (thermal_conductivity);
             ...
             {
                {
                   ...
                   const real_t tmp_qloop_109 = 1.0 / (thermal_conductivity*thermal_conductivity)*tmp_qloop_61*tmp_qloop_93*tmp_qloop_95*tmp_qloop_97*1.0 / (tmp_qloop_99*tmp_qloop_99);
             ...
             {
                {
                   ...
                   const real_t tmp_qloop_99 = abs(tmp_qloop_0*tmp_qloop_9 - tmp_qloop_2*tmp_qloop_7);
                   const real_t tmp_qloop_100 = 1.0 / (tmp_qloop_99*tmp_qloop_99*tmp_qloop_99);
                   const real_t tmp_qloop_101 = tmp_moved_constant_27*tmp_qloop_100*tmp_qloop_91*tmp_qloop_94*tmp_qloop_96*tmp_qloop_98;
                   const real_t tmp_qloop_103 = pow(tmp_qloop_93, 0.50000000000000000);
                   const real_t tmp_qloop_104 = pow(tmp_qloop_95, 0.50000000000000000);
                   const real_t tmp_qloop_105 = pow(tmp_qloop_97, 0.50000000000000000);
                   const real_t tmp_qloop_106 = 1.0 / (tmp_qloop_99);
                   const real_t tmp_qloop_107 = tmp_qloop_103*tmp_qloop_104*tmp_qloop_105*tmp_qloop_106;
                   const real_t tmp_qloop_108 = tmp_moved_constant_25*tmp_qloop_102*tmp_qloop_107;
                   const real_t tmp_qloop_109 = 1.0 / (thermal_conductivity*thermal_conductivity)*tmp_moved_constant_24*tmp_qloop_93*tmp_qloop_95*tmp_qloop_97*1.0 / (tmp_qloop_99*tmp_qloop_99);
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      const real_t tmp_qloop_3 = p_affine_0_0 - tmp_qloop_0*_data_q_p_0[q] - tmp_qloop_2*_data_q_p_1[q];
                      const real_t tmp_qloop_6 = (tmp_qloop_3*tmp_qloop_3);
                      ...
                      const real_t tmp_qloop_57 = tmp_qloop_47 - tmp_qloop_48 + tmp_qloop_49*-4.0;
                      const real_t tmp_qloop_58 = tmp_qloop_48 + tmp_qloop_50 + tmp_qloop_53 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0;
                      const real_t tmp_qloop_59 = tmp_moved_constant_12*tmp_qloop_58 + tmp_moved_constant_13*tmp_qloop_51 + tmp_moved_constant_14*tmp_qloop_54 + tmp_moved_constant_15*tmp_qloop_48 + tmp_moved_constant_16*tmp_qloop_56 + tmp_moved_constant_17*tmp_qloop_57;
                      const real_t tmp_qloop_60 = tmp_moved_constant_18*tmp_qloop_58 + tmp_moved_constant_19*tmp_qloop_51 + tmp_moved_constant_20*tmp_qloop_54 + tmp_moved_constant_21*tmp_qloop_48 + tmp_moved_constant_22*tmp_qloop_56 + tmp_moved_constant_23*tmp_qloop_57;
                      const real_t tmp_qloop_64 = 1.0 - _data_q_p_0[q] - _data_q_p_1[q];
                      const real_t tmp_qloop_66 = tmp_qloop_47 - 1.0;
                      const real_t tmp_qloop_67 = tmp_qloop_47 + tmp_qloop_55 - 3.0;
                      const real_t tmp_qloop_68 = tmp_moved_constant_18*tmp_qloop_67;
                      const real_t tmp_qloop_69 = -tmp_qloop_55 - 8.0*_data_q_p_0[q] + 4.0;
                      const real_t tmp_qloop_70 = tmp_moved_constant_19*tmp_qloop_66 + tmp_moved_constant_21*tmp_qloop_55 - tmp_moved_constant_22*tmp_qloop_55 + tmp_moved_constant_23*tmp_qloop_69 + tmp_qloop_68;
                      const real_t tmp_qloop_72 = tmp_qloop_55 - 1.0;
                      const real_t tmp_qloop_73 = -tmp_qloop_47 - 8.0*_data_q_p_1[q] + 4.0;
                      const real_t tmp_qloop_74 = tmp_moved_constant_20*tmp_qloop_72 + tmp_moved_constant_21*tmp_qloop_47 + tmp_moved_constant_22*tmp_qloop_73 - tmp_moved_constant_23*tmp_qloop_47 + tmp_qloop_68;
                      const real_t tmp_qloop_77 = tmp_moved_constant_12*tmp_qloop_67;
                      const real_t tmp_qloop_78 = tmp_moved_constant_13*tmp_qloop_66 + tmp_moved_constant_15*tmp_qloop_55 - tmp_moved_constant_16*tmp_qloop_55 + tmp_moved_constant_17*tmp_qloop_69 + tmp_qloop_77;
                      const real_t tmp_qloop_80 = tmp_moved_constant_14*tmp_qloop_72 + tmp_moved_constant_15*tmp_qloop_47 + tmp_moved_constant_16*tmp_qloop_73 - tmp_moved_constant_17*tmp_qloop_47 + tmp_qloop_77;
                      const real_t tmp_qloop_87 = -p_affine_0_0 + tmp_qloop_0*_data_q_p_0[q] + tmp_qloop_2*_data_q_p_1[q];
                      const real_t tmp_qloop_88 = -p_affine_0_1 + tmp_qloop_7*_data_q_p_0[q] + tmp_qloop_9*_data_q_p_1[q];
                      const real_t tmp_qloop_89 = 1.0 / (abs(pow((tmp_qloop_87*tmp_qloop_87) + (tmp_qloop_88*tmp_qloop_88), 0.50000000000000000))*abs(pow((tmp_qloop_87*tmp_qloop_87) + (tmp_qloop_88*tmp_qloop_88), 0.50000000000000000)));
                      const real_t tmp_qloop_90 = radRayVertex + tmp_qloop_19*1.0 / (tmp_qloop_14*tmp_qloop_4 - tmp_qloop_15*tmp_qloop_17)*(tmp_qloop_15*(rayVertex_1 + tmp_qloop_88) - tmp_qloop_4*(rayVertex_0 + tmp_qloop_87));
                      ...
                      const real_t tmp_qloop_85 = tmp_qloop_74*tmp_qloop_79;
                      const real_t tmp_qloop_86 = tmp_qloop_83 - tmp_qloop_84 - tmp_qloop_85;
                      const real_t tmp_qloop_110 = abs_det_jac_blending*tmp_moved_constant_26*tmp_qloop_107*1.0 / (tmp_moved_constant_10*_data_q_p_0[q] + tmp_moved_constant_11*_data_q_p_1[q] + tmp_moved_constant_9*tmp_qloop_64)*(tmp_moved_constant_6*tmp_qloop_64 + tmp_moved_constant_7*_data_q_p_0[q] + tmp_moved_constant_8*_data_q_p_1[q])*(tmp_qloop_75*tmp_qloop_82 + tmp_qloop_81*tmp_qloop_82 + tmp_qloop_83*tmp_qloop_86 - tmp_qloop_86*(tmp_qloop_84 + tmp_qloop_85))*0.50000000000000000*((cutoff > radius_surface - pow(tmp_qloop_89*(abs(tmp_qloop_87*tmp_qloop_90)*abs(tmp_qloop_87*tmp_qloop_90)) + tmp_qloop_89*(abs(tmp_qloop_88*tmp_qloop_90)*abs(tmp_qloop_88*tmp_qloop_90)), 0.50000000000000000)) ? (0.0): (1.0))*((tmp_qloop_108 <= 1.1799999561582399) ? (tmp_qloop_101*-0.0027777777777777778 + tmp_qloop_108*0.16666666666666667): ((tmp_qloop_108 <= 3.0159389978870399) ? (tmp_moved_constant_25*tmp_qloop_102*tmp_qloop_103*tmp_qloop_104*tmp_qloop_105*tmp_qloop_106*0.17969906536907199 + tmp_qloop_101*-0.00051942446859271248 + tmp_qloop_109*-0.0089393368193446242 - 0.0064954259688208404): ((tmp_qloop_108 <= 6.7434348119715999) ? (tmp_moved_constant_25*tmp_qloop_102*tmp_qloop_103*tmp_qloop_104*tmp_qloop_105*tmp_qloop_106*0.2146156710600175 + tmp_moved_constant_27*tmp_qloop_100*tmp_qloop_91*tmp_qloop_94*tmp_qloop_96*tmp_qloop_98*0.00076015027042957372 + tmp_qloop_109*-0.020516694887729999 - 0.041597543561209399): ((tmp_qloop_108 <= 9.7000000058627194) ? (tmp_qloop_101*0.0003890697253152925 + tmp_qloop_108*0.16399221771597999 + tmp_qloop_109*-0.01300962248982295 + 0.072194442299590406): (thermal_conductivity*tmp_moved_constant_26*1.0 / (tmp_qloop_103)*1.0 / (tmp_qloop_104)*1.0 / (tmp_qloop_105)*tmp_qloop_99*-2.0 + 1.0)))))*_data_q_w[q];
