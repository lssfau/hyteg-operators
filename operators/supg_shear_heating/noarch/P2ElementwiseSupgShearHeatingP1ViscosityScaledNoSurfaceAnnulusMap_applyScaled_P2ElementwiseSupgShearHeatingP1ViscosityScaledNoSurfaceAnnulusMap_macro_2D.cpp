             ...
             {
                {
                   ...
                   const real_t tmp_qloop_109 = 1.0 / (thermalConductivity*thermalConductivity)*tmp_moved_constant_24*tmp_qloop_93*tmp_qloop_95*tmp_qloop_97*1.0 / (tmp_qloop_99*tmp_qloop_99);
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      const real_t tmp_qloop_3 = p_affine_0_0 - tmp_qloop_0*_data_q_p_0[q] - tmp_qloop_2*_data_q_p_1[q];
                      const real_t tmp_qloop_6 = (tmp_qloop_3*tmp_qloop_3);
