             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      ...
                      const real_t tmp_qloop_80 = tmp_qloop_69*tmp_qloop_74;
                      const real_t tmp_qloop_81 = tmp_qloop_78 - tmp_qloop_79 - tmp_qloop_80;
                      const real_t tmp_qloop_86 = abs_det_jac_blending*(tmp_moved_constant_12*tmp_qloop_59 + tmp_moved_constant_13*_data_q_p_0[q] + tmp_moved_constant_14*_data_q_p_1[q])*1.0 / (tmp_moved_constant_15*tmp_qloop_59 + tmp_moved_constant_16*_data_q_p_0[q] + tmp_moved_constant_17*_data_q_p_1[q])*(tmp_qloop_70*tmp_qloop_77 + tmp_qloop_76*tmp_qloop_77 + tmp_qloop_78*tmp_qloop_81 - tmp_qloop_81*(tmp_qloop_79 + tmp_qloop_80))*(tmp_moved_constant_10*tmp_qloop_54 + tmp_moved_constant_11*tmp_qloop_55 + tmp_moved_constant_6*tmp_qloop_56 + tmp_moved_constant_7*tmp_qloop_49 + tmp_moved_constant_8*tmp_qloop_52 + tmp_moved_constant_9*tmp_qloop_46)*((cutoff > radiusSurface - pow(tmp_qloop_84*(abs(tmp_qloop_82*tmp_qloop_85)*abs(tmp_qloop_82*tmp_qloop_85)) + tmp_qloop_84*(abs(tmp_qloop_83*tmp_qloop_85)*abs(tmp_qloop_83*tmp_qloop_85)), 0.50000000000000000)) ? (0.0): (1.0))*_data_q_w[q];
