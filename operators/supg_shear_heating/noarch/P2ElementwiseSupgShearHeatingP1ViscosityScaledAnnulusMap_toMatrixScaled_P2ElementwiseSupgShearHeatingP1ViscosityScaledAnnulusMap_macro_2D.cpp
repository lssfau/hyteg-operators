...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap::toMatrixScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledAnnulusMap_macro_2D( idx_t * RESTRICT  _data_dstEdge, idx_t * RESTRICT  _data_dstVertex, real_t * RESTRICT  _data_eta, real_t * RESTRICT  _data_rho, idx_t * RESTRICT  _data_srcEdge, idx_t * RESTRICT  _data_srcVertex, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t radRayVertex, real_t radRefVertex, real_t rayVertex_0, real_t rayVertex_1, real_t refVertex_0, real_t refVertex_1, real_t thermal_conductivity, real_t thrVertex_0, real_t thrVertex_1, real_t toMatrixScaling ) const
{
    {
             ...
             {
                {
                   ...
                   const real_t tmp_qloop_91 = abs(tmp_qloop_0*tmp_qloop_8 - tmp_qloop_2*tmp_qloop_6);
                   const real_t tmp_qloop_92 = 1.0 / (tmp_qloop_91*tmp_qloop_91*tmp_qloop_91);
                   const real_t tmp_qloop_93 = tmp_moved_constant_21*tmp_qloop_83*tmp_qloop_86*tmp_qloop_88*tmp_qloop_90*tmp_qloop_92;
                   const real_t tmp_qloop_95 = pow(tmp_qloop_85, 0.50000000000000000);
                   const real_t tmp_qloop_96 = pow(tmp_qloop_87, 0.50000000000000000);
                   const real_t tmp_qloop_97 = pow(tmp_qloop_89, 0.50000000000000000);
                   const real_t tmp_qloop_98 = 1.0 / (tmp_qloop_91);
                   const real_t tmp_qloop_99 = tmp_qloop_95*tmp_qloop_96*tmp_qloop_97*tmp_qloop_98;
                   const real_t tmp_qloop_100 = tmp_moved_constant_19*tmp_qloop_94*tmp_qloop_99;
                   const real_t tmp_qloop_101 = 1.0 / (thermal_conductivity*thermal_conductivity)*tmp_moved_constant_18*tmp_qloop_85*tmp_qloop_87*tmp_qloop_89*1.0 / (tmp_qloop_91*tmp_qloop_91);
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      const real_t tmp_qloop_3 = p_affine_0_0 - tmp_qloop_0*_data_q_p_0[q] - tmp_qloop_2*_data_q_p_1[q];
                      const real_t tmp_qloop_5 = (tmp_qloop_3*tmp_qloop_3);
                      ...
                      const real_t tmp_qloop_53 = tmp_qloop_43 - tmp_qloop_44 + tmp_qloop_45*-4.0;
                      const real_t tmp_qloop_54 = tmp_qloop_44 + tmp_qloop_46 + tmp_qloop_49 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0;
                      const real_t tmp_qloop_55 = tmp_moved_constant_10*tmp_qloop_52 + tmp_moved_constant_11*tmp_qloop_53 + tmp_moved_constant_6*tmp_qloop_54 + tmp_moved_constant_7*tmp_qloop_47 + tmp_moved_constant_8*tmp_qloop_50 + tmp_moved_constant_9*tmp_qloop_44;
                      const real_t tmp_qloop_56 = tmp_moved_constant_12*tmp_qloop_54 + tmp_moved_constant_13*tmp_qloop_47 + tmp_moved_constant_14*tmp_qloop_50 + tmp_moved_constant_15*tmp_qloop_44 + tmp_moved_constant_16*tmp_qloop_52 + tmp_moved_constant_17*tmp_qloop_53;
                      const real_t tmp_qloop_60 = 1.0 - _data_q_p_0[q] - _data_q_p_1[q];
                      const real_t tmp_qloop_62 = tmp_qloop_43 - 1.0;
                      const real_t tmp_qloop_63 = tmp_qloop_43 + tmp_qloop_51 - 3.0;
                      const real_t tmp_qloop_64 = tmp_moved_constant_12*tmp_qloop_63;
                      const real_t tmp_qloop_65 = -tmp_qloop_51 - 8.0*_data_q_p_0[q] + 4.0;
                      const real_t tmp_qloop_66 = tmp_moved_constant_13*tmp_qloop_62 + tmp_moved_constant_15*tmp_qloop_51 - tmp_moved_constant_16*tmp_qloop_51 + tmp_moved_constant_17*tmp_qloop_65 + tmp_qloop_64;
                      const real_t tmp_qloop_68 = tmp_qloop_51 - 1.0;
                      const real_t tmp_qloop_69 = -tmp_qloop_43 - 8.0*_data_q_p_1[q] + 4.0;
                      const real_t tmp_qloop_70 = tmp_moved_constant_14*tmp_qloop_68 + tmp_moved_constant_15*tmp_qloop_43 + tmp_moved_constant_16*tmp_qloop_69 - tmp_moved_constant_17*tmp_qloop_43 + tmp_qloop_64;
                      const real_t tmp_qloop_73 = tmp_moved_constant_6*tmp_qloop_63;
                      const real_t tmp_qloop_74 = -tmp_moved_constant_10*tmp_qloop_51 + tmp_moved_constant_11*tmp_qloop_65 + tmp_moved_constant_7*tmp_qloop_62 + tmp_moved_constant_9*tmp_qloop_51 + tmp_qloop_73;
                      const real_t tmp_qloop_76 = tmp_moved_constant_10*tmp_qloop_69 - tmp_moved_constant_11*tmp_qloop_43 + tmp_moved_constant_8*tmp_qloop_68 + tmp_moved_constant_9*tmp_qloop_43 + tmp_qloop_73;
                      const real_t jac_blending_0_0 = tmp_qloop_10*tmp_qloop_24 + tmp_qloop_20*tmp_qloop_3;
                      const real_t jac_blending_0_1 = -tmp_qloop_21*tmp_qloop_22*tmp_qloop_3*tmp_qloop_9 - tmp_qloop_25*tmp_qloop_3;
                      const real_t jac_blending_1_0 = tmp_qloop_20*tmp_qloop_9 - tmp_qloop_26*tmp_qloop_9;
                      const real_t jac_blending_1_1 = tmp_qloop_21*tmp_qloop_22*tmp_qloop_5*1.0 - tmp_qloop_25*tmp_qloop_9;
                      ...
                      const real_t tmp_qloop_81 = tmp_qloop_70*tmp_qloop_75;
                      const real_t tmp_qloop_82 = tmp_qloop_79 - tmp_qloop_80 - tmp_qloop_81;
                      const real_t tmp_qloop_102 = abs_det_jac_blending*tmp_moved_constant_20*tmp_qloop_99*(tmp_moved_constant_0*tmp_qloop_60 + tmp_moved_constant_1*_data_q_p_0[q] + tmp_moved_constant_2*_data_q_p_1[q])*1.0 / (tmp_moved_constant_3*tmp_qloop_60 + tmp_moved_constant_4*_data_q_p_0[q] + tmp_moved_constant_5*_data_q_p_1[q])*(tmp_qloop_71*tmp_qloop_78 + tmp_qloop_77*tmp_qloop_78 + tmp_qloop_79*tmp_qloop_82 - tmp_qloop_82*(tmp_qloop_80 + tmp_qloop_81))*0.50000000000000000*((tmp_qloop_100 <= 1.1799999561582399) ? (tmp_qloop_100*0.16666666666666667 + tmp_qloop_93*-0.0027777777777777778): ((tmp_qloop_100 <= 3.0159389978870399) ? (tmp_moved_constant_19*tmp_qloop_94*tmp_qloop_95*tmp_qloop_96*tmp_qloop_97*tmp_qloop_98*0.17969906536907199 + tmp_qloop_101*-0.0089393368193446242 + tmp_qloop_93*-0.00051942446859271248 - 0.0064954259688208404): ((tmp_qloop_100 <= 6.7434348119715999) ? (tmp_moved_constant_19*tmp_qloop_94*tmp_qloop_95*tmp_qloop_96*tmp_qloop_97*tmp_qloop_98*0.2146156710600175 + tmp_moved_constant_21*tmp_qloop_83*tmp_qloop_86*tmp_qloop_88*tmp_qloop_90*tmp_qloop_92*0.00076015027042957372 + tmp_qloop_101*-0.020516694887729999 - 0.041597543561209399): ((tmp_qloop_100 <= 9.7000000058627194) ? (tmp_qloop_100*0.16399221771597999 + tmp_qloop_101*-0.01300962248982295 + tmp_qloop_93*0.0003890697253152925 + 0.072194442299590406): (thermal_conductivity*tmp_moved_constant_20*tmp_qloop_91*1.0 / (tmp_qloop_95)*1.0 / (tmp_qloop_96)*1.0 / (tmp_qloop_97)*-2.0 + 1.0)))))*_data_q_w[q];
