...
void P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta::computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgShearHeatingP1ViscosityScaledCoeffDelta_macro_2D( real_t * RESTRICT  _data_deltaEdge, real_t * RESTRICT  _data_deltaVertex, real_t * RESTRICT  _data_eta, real_t * RESTRICT  _data_invDiag_Edge, real_t * RESTRICT  _data_invDiag_Vertex, real_t * RESTRICT  _data_rho, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t diagScaling, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float ) const
{
    {
             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      ...
                      const real_t q_tmp_0_0 = tmp_qloop_22*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 1] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q])*_data_tabulated_and_untitled_0_0_GRAY[12*q];
                      const real_t q_tmp_1_1 = tmp_qloop_22*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 7] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 1])*_data_tabulated_and_untitled_0_0_GRAY[12*q + 2];
                      const real_t q_tmp_2_2 = tmp_qloop_22*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 8] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 2])*_data_tabulated_and_untitled_0_0_GRAY[12*q + 3];
                      const real_t q_tmp_3_3 = tmp_qloop_22*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 9] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 3])*_data_tabulated_and_untitled_0_0_GRAY[12*q + 4];
                      const real_t q_tmp_4_4 = tmp_qloop_22*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 10] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 4])*_data_tabulated_and_untitled_0_0_GRAY[12*q + 5];
                      const real_t q_tmp_5_5 = tmp_qloop_22*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 11] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 5])*_data_tabulated_and_untitled_0_0_GRAY[12*q + 6];
             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      ...
                      const real_t tmp_qloop_4 = tmp_qloop_3 - 1.0;
                      const real_t tmp_qloop_5 = tmp_qloop_2 + tmp_qloop_3 - 3.0;
                      const real_t tmp_qloop_6 = tmp_moved_constant_18*tmp_qloop_5;
                      const real_t tmp_qloop_7 = -tmp_qloop_2 - 8.0*_data_q_p_0[q] + 4.0;
                      const real_t tmp_qloop_8 = tmp_moved_constant_19*tmp_qloop_4 + tmp_moved_constant_21*tmp_qloop_2 - tmp_moved_constant_22*tmp_qloop_2 + tmp_moved_constant_23*tmp_qloop_7 + tmp_qloop_6;
                      const real_t tmp_qloop_9 = tmp_qloop_2 - 1.0;
                      const real_t tmp_qloop_10 = -tmp_qloop_3 - 8.0*_data_q_p_1[q] + 4.0;
                      const real_t tmp_qloop_11 = tmp_moved_constant_20*tmp_qloop_9 + tmp_moved_constant_21*tmp_qloop_3 + tmp_moved_constant_22*tmp_qloop_10 - tmp_moved_constant_23*tmp_qloop_3 + tmp_qloop_6;
                      const real_t tmp_qloop_12 = jac_affine_inv_0_0_BLUE*tmp_qloop_8 + jac_affine_inv_1_0_BLUE*tmp_qloop_11;
                      const real_t tmp_qloop_13 = tmp_moved_constant_12*tmp_qloop_5;
                      const real_t tmp_qloop_14 = tmp_moved_constant_13*tmp_qloop_4 + tmp_moved_constant_15*tmp_qloop_2 - tmp_moved_constant_16*tmp_qloop_2 + tmp_moved_constant_17*tmp_qloop_7 + tmp_qloop_13;
                      const real_t tmp_qloop_15 = tmp_moved_constant_14*tmp_qloop_9 + tmp_moved_constant_15*tmp_qloop_3 + tmp_moved_constant_16*tmp_qloop_10 - tmp_moved_constant_17*tmp_qloop_3 + tmp_qloop_13;
                      ...
                      const real_t tmp_qloop_21 = tmp_qloop_18 - tmp_qloop_19 - tmp_qloop_20;
                      const real_t tmp_qloop_22 = 1.0 / (tmp_moved_constant_10*_data_phi_0_0_BLUE[9*q + 7] + tmp_moved_constant_11*_data_phi_0_0_BLUE[9*q + 8] + tmp_moved_constant_9*_data_phi_0_0_BLUE[9*q + 6])*(tmp_moved_constant_6*_data_phi_0_0_BLUE[9*q + 6] + tmp_moved_constant_7*_data_phi_0_0_BLUE[9*q + 7] + tmp_moved_constant_8*_data_phi_0_0_BLUE[9*q + 8])*(tmp_qloop_12*tmp_qloop_17 + tmp_qloop_16*tmp_qloop_17 + tmp_qloop_18*tmp_qloop_21 - tmp_qloop_21*(tmp_qloop_19 + tmp_qloop_20))*(tmp_moved_constant_0*_data_phi_0_0_BLUE[9*q] + tmp_moved_constant_1*_data_phi_0_0_BLUE[9*q + 1] + tmp_moved_constant_2*_data_phi_0_0_BLUE[9*q + 2] + tmp_moved_constant_3*_data_phi_0_0_BLUE[9*q + 3] + tmp_moved_constant_4*_data_phi_0_0_BLUE[9*q + 4] + tmp_moved_constant_5*_data_phi_0_0_BLUE[9*q + 5])*_data_q_w[q];
                      const real_t q_tmp_0_0 = tmp_qloop_22*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 1] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q])*_data_tabulated_and_untitled_0_0_BLUE[12*q];
                      const real_t q_tmp_1_1 = tmp_qloop_22*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 7] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 1])*_data_tabulated_and_untitled_0_0_BLUE[12*q + 2];
                      const real_t q_tmp_2_2 = tmp_qloop_22*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 8] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 2])*_data_tabulated_and_untitled_0_0_BLUE[12*q + 3];
                      const real_t q_tmp_3_3 = tmp_qloop_22*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 9] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 3])*_data_tabulated_and_untitled_0_0_BLUE[12*q + 4];
                      const real_t q_tmp_4_4 = tmp_qloop_22*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 10] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 4])*_data_tabulated_and_untitled_0_0_BLUE[12*q + 5];
                      const real_t q_tmp_5_5 = tmp_qloop_22*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 11] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 5])*_data_tabulated_and_untitled_0_0_BLUE[12*q + 6];
                      q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                      q_acc_1_1 = q_acc_1_1 + q_tmp_1_1;
                      q_acc_2_2 = q_acc_2_2 + q_tmp_2_2;
                      q_acc_3_3 = q_acc_3_3 + q_tmp_3_3;
