...
class P2ElementwiseSupgAdvectionCoeffDeltaIcosahedralShellMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                                public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgAdvectionCoeffDeltaIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                            size_t                                     minLevel,
                                                            size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgAdvectionCoeffDeltaIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3823    5737      58      22      0              0                 0              1
   void applyScaled_P2ElementwiseSupgAdvectionCoeffDeltaIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_deltaEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3723    5682      58      22      0              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgAdvectionCoeffDeltaIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_deltaEdge,
                                                                                         real_t* RESTRICT _data_deltaVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3238    5043      58      22      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdvectionCoeffDeltaIcosahedralShellMap_macro_3D(
