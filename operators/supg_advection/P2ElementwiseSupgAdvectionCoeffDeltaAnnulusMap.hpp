...
class P2ElementwiseSupgAdvectionCoeffDeltaAnnulusMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                       public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgAdvectionCoeffDeltaAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                   size_t                                     minLevel,
                                                   size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgAdvectionCoeffDeltaAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    740    1152      24      18      0              0                 0              1
   void applyScaled_P2ElementwiseSupgAdvectionCoeffDeltaAnnulusMap_macro_2D( real_t* RESTRICT _data_deltaEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    704    1131      24      18      0              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgAdvectionCoeffDeltaAnnulusMap_macro_2D( real_t* RESTRICT _data_deltaEdge,
                                                                                real_t* RESTRICT _data_deltaVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    620     996      24      18      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdvectionCoeffDeltaAnnulusMap_macro_2D(
