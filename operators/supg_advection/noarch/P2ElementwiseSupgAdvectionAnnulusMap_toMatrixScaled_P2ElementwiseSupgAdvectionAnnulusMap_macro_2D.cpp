             ...
             {
                {
                   ...
                   const real_t tmp_qloop_77 = 1.0 / (thermal_conductivity*thermal_conductivity)*tmp_moved_constant_12*tmp_qloop_61*tmp_qloop_63*tmp_qloop_65*1.0 / (tmp_qloop_67*tmp_qloop_67);
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      const real_t tmp_qloop_3 = p_affine_0_0 - tmp_qloop_0*_data_q_p_0[q] - tmp_qloop_2*_data_q_p_1[q];
                      const real_t tmp_qloop_5 = (tmp_qloop_3*tmp_qloop_3);
