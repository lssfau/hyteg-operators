...
void P2ElementwiseSupgAdvection::computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdvection_macro_2D( real_t * RESTRICT  _data_invDiag_Edge, real_t * RESTRICT  _data_invDiag_Vertex, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t diagScaling, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t thermalConductivity ) const
{
    {
             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 4; q += 1)
                   {
                      ...
                      const real_t q_tmp_0_0 = tmp_qloop_30*((tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[7*q] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q])*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[7*q] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q]));
                      const real_t q_tmp_1_1 = tmp_qloop_30*((tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[7*q + 2] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 1])*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[7*q + 2] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 1]));
                      const real_t q_tmp_2_2 = tmp_qloop_30*((tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[7*q + 3] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 2])*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[7*q + 3] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 2]));
                      const real_t q_tmp_3_3 = tmp_qloop_30*((tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[7*q + 4] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 3])*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[7*q + 4] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 3]));
                      const real_t q_tmp_4_4 = tmp_qloop_30*((tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[7*q + 5] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 4])*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[7*q + 5] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 4]));
                      const real_t q_tmp_5_5 = tmp_qloop_30*((tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[7*q + 6] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 5])*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_GRAY[7*q + 6] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 5]));
             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 4; q += 1)
                   {
                      ...
                      const real_t tmp_qloop_28 = tmp_qloop_22*tmp_qloop_27*tmp_qloop_3;
                      const real_t tmp_qloop_29 = 1.0 / (thermalConductivity*thermalConductivity)*tmp_qloop_15*tmp_qloop_17*1.0 / (tmp_qloop_19*tmp_qloop_19)*tmp_qloop_2*tmp_qloop_9;
                      const real_t tmp_qloop_30 = tmp_qloop_27*tmp_qloop_4*0.50000000000000000*((tmp_qloop_28 <= 1.1799999561582399) ? (tmp_qloop_21*-0.0027777777777777778 + tmp_qloop_28*0.16666666666666667): ((tmp_qloop_28 <= 3.0159389978870399) ? (tmp_qloop_21*-0.00051942446859271248 + tmp_qloop_22*tmp_qloop_23*tmp_qloop_24*tmp_qloop_25*tmp_qloop_26*tmp_qloop_3*0.17969906536907199 + tmp_qloop_29*-0.0089393368193446242 - 0.0064954259688208404): ((tmp_qloop_28 <= 6.7434348119715999) ? (tmp_qloop_10*tmp_qloop_16*tmp_qloop_18*tmp_qloop_20*tmp_qloop_5*tmp_qloop_6*0.00076015027042957372 + tmp_qloop_22*tmp_qloop_23*tmp_qloop_24*tmp_qloop_25*tmp_qloop_26*tmp_qloop_3*0.2146156710600175 + tmp_qloop_29*-0.020516694887729999 - 0.041597543561209399): ((tmp_qloop_28 <= 9.7000000058627194) ? (tmp_qloop_21*0.0003890697253152925 + tmp_qloop_28*0.16399221771597999 + tmp_qloop_29*-0.01300962248982295 + 0.072194442299590406): (thermalConductivity*tmp_qloop_19*1.0 / (tmp_qloop_23)*1.0 / (tmp_qloop_24)*1.0 / (tmp_qloop_25)*tmp_qloop_4*-2.0 + 1.0)))))*_data_q_w[q]*_data_tabulated_and_untitled_0_0_BLUE[7*q + 1];
                      const real_t q_tmp_0_0 = tmp_qloop_30*((tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[7*q] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q])*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[7*q] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q]));
                      const real_t q_tmp_1_1 = tmp_qloop_30*((tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[7*q + 2] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 1])*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[7*q + 2] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 1]));
                      const real_t q_tmp_2_2 = tmp_qloop_30*((tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[7*q + 3] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 2])*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[7*q + 3] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 2]));
                      const real_t q_tmp_3_3 = tmp_qloop_30*((tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[7*q + 4] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 3])*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[7*q + 4] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 3]));
                      const real_t q_tmp_4_4 = tmp_qloop_30*((tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[7*q + 5] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 4])*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[7*q + 5] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 4]));
                      const real_t q_tmp_5_5 = tmp_qloop_30*((tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[7*q + 6] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 5])*(tmp_qloop_0*_data_tabulated_and_untitled_0_0_BLUE[7*q + 6] + tmp_qloop_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 5]));
                      q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                      q_acc_1_1 = q_acc_1_1 + q_tmp_1_1;
                      q_acc_2_2 = q_acc_2_2 + q_tmp_2_2;
                      q_acc_3_3 = q_acc_3_3 + q_tmp_3_3;
