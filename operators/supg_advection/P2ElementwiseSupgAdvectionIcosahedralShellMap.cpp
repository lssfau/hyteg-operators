...
#include "P2ElementwiseSupgAdvectionIcosahedralShellMap.hpp"
...
P2ElementwiseSupgAdvectionIcosahedralShellMap::P2ElementwiseSupgAdvectionIcosahedralShellMap(
    ...
    real_t                                     thermal_conductivity_P2ElementwiseSupgAdvectionIcosahedralShellMap )
: Operator( storage, minLevel, maxLevel )
, ux( _ux )
, uy( _uy )
, uz( _uz )
, thermal_conductivity_P2ElementwiseSupgAdvectionIcosahedralShellMap_(
      thermal_conductivity_P2ElementwiseSupgAdvectionIcosahedralShellMap )
{}

void P2ElementwiseSupgAdvectionIcosahedralShellMap::applyScaled( const real_t&               operatorScaling,
                                                                 ...
                                                                 UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseSupgAdvectionIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgAdvectionIcosahedralShellMap::apply( const P2Function< real_t >& src,
                                                           const P2Function< real_t >& dst,
                                                           uint_t                      level,
                                                           DoFType                     flag,
                                                           UpdateType                  updateType ) const
...
void P2ElementwiseSupgAdvectionIcosahedralShellMap::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                                    ...
                                                                    DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgAdvectionIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgAdvectionIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                              const P2Function< idx_t >&                  src,
                                                              const P2Function< idx_t >&                  dst,
                                                              uint_t                                      level,
                                                              DoFType                                     flag ) const
...
void P2ElementwiseSupgAdvectionIcosahedralShellMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdvectionIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgAdvectionIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseSupgAdvectionIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
