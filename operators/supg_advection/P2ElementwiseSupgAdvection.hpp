                                   ...
                                   public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    304     562      52      32     28              0                 0              1
   void applyScaled_P2ElementwiseSupgAdvection_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    978    1287      81      60     95              0                 0              1
   void applyScaled_P2ElementwiseSupgAdvection_macro_3D( real_t* RESTRICT _data_dstEdge,
                                                         real_t* RESTRICT _data_dstVertex,
                                                         real_t* RESTRICT _data_srcEdge,
                                                         real_t* RESTRICT _data_srcVertex,
                                                         real_t* RESTRICT _data_uxEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    268     541      52      32     28              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgAdvection_macro_2D( idx_t* RESTRICT                      _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    878    1232      81      60     95              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgAdvection_macro_3D( idx_t* RESTRICT                      _data_dstEdge,
                                                            idx_t* RESTRICT                      _data_dstVertex,
                                                            idx_t* RESTRICT                      _data_srcEdge,
                                                            idx_t* RESTRICT                      _data_srcVertex,
                                                            real_t* RESTRICT                     _data_uxEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    214     446      52      32     28              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdvection_macro_2D( real_t* RESTRICT _data_invDiag_Edge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    663     917      81      60     95              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdvection_macro_3D( real_t* RESTRICT _data_invDiag_Edge,
                                                                                        real_t* RESTRICT _data_invDiag_Vertex,
                                                                                        real_t* RESTRICT _data_uxEdge,
                                                                                        real_t* RESTRICT _data_uxVertex,
                                                                                        real_t* RESTRICT _data_uyEdge,
   ...
   real_t                                  thermal_conductivity_P2ElementwiseSupgAdvection_;
};
