...
P2ElementwiseSupgAdvectionAnnulusMap::P2ElementwiseSupgAdvectionAnnulusMap(
    const std::shared_ptr< PrimitiveStorage >& storage,
    size_t                                     minLevel,
    size_t                                     maxLevel,
    const P2Function< real_t >&                _ux,
    const P2Function< real_t >&                _uy,
    real_t                                     thermal_conductivity_P2ElementwiseSupgAdvectionAnnulusMap )
: Operator( storage, minLevel, maxLevel )
, ux( _ux )
, uy( _uy )
, thermal_conductivity_P2ElementwiseSupgAdvectionAnnulusMap_( thermal_conductivity_P2ElementwiseSupgAdvectionAnnulusMap )
{}

void P2ElementwiseSupgAdvectionAnnulusMap::applyScaled( const real_t&               operatorScaling,
                                                        ...
                                                        UpdateType                  updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseSupgAdvectionAnnulusMap_macro_2D(
             ...
             refVertex_0,
             refVertex_1,
             thermal_conductivity_P2ElementwiseSupgAdvectionAnnulusMap_,
             thrVertex_0,
             thrVertex_1 );
...
void P2ElementwiseSupgAdvectionAnnulusMap::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                           ...
                                                           DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgAdvectionAnnulusMap_macro_2D(
...
void P2ElementwiseSupgAdvectionAnnulusMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdvectionAnnulusMap_macro_2D(
