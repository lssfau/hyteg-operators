...
class P2ElementwiseSupgAdvectionCoeffDelta : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                             public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgAdvectionCoeffDelta( const std::shared_ptr< PrimitiveStorage >& storage,
                                         size_t                                     minLevel,
                                         size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgAdvectionCoeffDelta
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    236     322      12       0      0              0                 0              1
   void applyScaled_P2ElementwiseSupgAdvectionCoeffDelta_macro_2D( real_t* RESTRICT _data_deltaEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    748     912      36       0      0              0                 0              1
   void applyScaled_P2ElementwiseSupgAdvectionCoeffDelta_macro_3D( real_t* RESTRICT _data_deltaEdge,
                                                                   real_t* RESTRICT _data_deltaVertex,
                                                                   real_t* RESTRICT _data_dstEdge,
                                                                   real_t* RESTRICT _data_dstVertex,
                                                                   real_t* RESTRICT _data_srcEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    200     301      12       0      0              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgAdvectionCoeffDelta_macro_2D( real_t* RESTRICT _data_deltaEdge,
                                                                      real_t* RESTRICT _data_deltaVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    648     857      36       0      0              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgAdvectionCoeffDelta_macro_3D( real_t* RESTRICT _data_deltaEdge,
                                                                      real_t* RESTRICT _data_deltaVertex,
                                                                      idx_t* RESTRICT  _data_dstEdge,
                                                                      idx_t* RESTRICT  _data_dstVertex,
                                                                      idx_t* RESTRICT  _data_srcEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    146     206      12       0      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdvectionCoeffDelta_macro_2D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    433     542      36       0      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdvectionCoeffDelta_macro_3D(
       real_t* RESTRICT _data_deltaEdge,
       real_t* RESTRICT _data_deltaVertex,
       real_t* RESTRICT _data_invDiag_Edge,
       real_t* RESTRICT _data_invDiag_Vertex,
