...
class P2ElementwiseSupgAdvectionIcosahedralShellMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                      public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgAdvectionIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                  size_t                                     minLevel,
                                                  size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgAdvectionIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4527    6716     157     154    209              0                 0              1
   void applyScaled_P2ElementwiseSupgAdvectionIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4427    6661     157     154    209              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgAdvectionIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3942    6022     157     154    209              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdvectionIcosahedralShellMap_macro_3D(
   ...
   real_t                                  thermal_conductivity_P2ElementwiseSupgAdvectionIcosahedralShellMap_;
};
