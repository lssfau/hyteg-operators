                                             ...
                                             public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    878    1584      84      66     42              0                 0              1
   void applyScaled_P2ElementwiseSupgAdvectionAnnulusMap_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    842    1563      84      66     42              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgAdvectionAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    758    1428      84      66     42              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdvectionAnnulusMap_macro_2D(
   ...
   real_t                                  thermal_conductivity_P2ElementwiseSupgAdvectionAnnulusMap_;
};
