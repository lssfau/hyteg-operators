             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      ...
                      const real_t tmp_qloop_43 = tmp_qloop_42*2.0;
                      const real_t tmp_qloop_44 = tmp_qloop_39 + tmp_qloop_41 + tmp_qloop_43 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0;
                      const real_t tmp_qloop_48 = 1.0 / (tmp_moved_constant_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + tmp_moved_constant_1*_data_q_p_0[q] + tmp_moved_constant_2*_data_q_p_1[q]);
                      const real_t tmp_qloop_52 = tmp_qloop_41 - _data_q_p_0[q];
                      const real_t tmp_qloop_54 = tmp_qloop_43 - _data_q_p_1[q];
                      const real_t tmp_qloop_57 = -tmp_qloop_39 + tmp_qloop_42*-4.0 + 4.0*_data_q_p_1[q];
                      const real_t tmp_qloop_59 = -tmp_qloop_39 + tmp_qloop_40*-4.0 + 4.0*_data_q_p_0[q];
                      ...
                      const real_t jac_blending_inv_0_1 = -jac_blending_0_1*tmp_qloop_22;
                      const real_t jac_blending_inv_1_0 = -jac_blending_1_0*tmp_qloop_22;
                      const real_t tmp_qloop_47 = tmp_moved_constant_3*(jac_affine_inv_0_0_BLUE*jac_blending_inv_0_0 + jac_affine_inv_0_1_BLUE*jac_blending_inv_1_0) + tmp_moved_constant_4*(jac_affine_inv_1_0_BLUE*jac_blending_inv_0_0 + jac_affine_inv_1_1_BLUE*jac_blending_inv_1_0);
                      const real_t tmp_qloop_50 = tmp_qloop_47*tmp_qloop_49;
                      ...
                      const real_t tmp_qloop_62 = tmp_moved_constant_3*(jac_affine_inv_0_0_BLUE*jac_blending_inv_0_1 + jac_affine_inv_0_1_BLUE*jac_blending_inv_1_1) + tmp_moved_constant_4*(jac_affine_inv_1_0_BLUE*jac_blending_inv_0_1 + jac_affine_inv_1_1_BLUE*jac_blending_inv_1_1);
                      const real_t tmp_qloop_63 = tmp_qloop_49*tmp_qloop_62;
