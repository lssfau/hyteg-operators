             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      ...
                      const real_t tmp_qloop_22 = 1.0 / (tmp_qloop_21);
                      const real_t abs_det_jac_blending = tmp_qloop_21;
                      const real_t tmp_qloop_46 = abs_det_jac_blending*1.0 / (tmp_moved_constant_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + tmp_moved_constant_1*_data_q_p_0[q] + tmp_moved_constant_2*_data_q_p_1[q])*_data_q_w[q];
                      ...
                      const real_t jac_blending_inv_0_1 = -jac_blending_0_1*tmp_qloop_22;
                      const real_t jac_blending_inv_1_0 = -jac_blending_1_0*tmp_qloop_22;
                      const real_t tmp_qloop_45 = tmp_moved_constant_3*(jac_affine_inv_0_0_BLUE*jac_blending_inv_0_0 + jac_affine_inv_0_1_BLUE*jac_blending_inv_1_0) + tmp_moved_constant_4*(jac_affine_inv_1_0_BLUE*jac_blending_inv_0_0 + jac_affine_inv_1_1_BLUE*jac_blending_inv_1_0);
                      const real_t tmp_qloop_48 = tmp_qloop_45*tmp_qloop_47;
                      const real_t tmp_qloop_56 = tmp_qloop_45*tmp_qloop_55;
                      const real_t tmp_qloop_59 = tmp_qloop_45*tmp_qloop_58;
                      const real_t jac_blending_inv_1_1 = jac_blending_0_0*tmp_qloop_22;
                      const real_t tmp_qloop_53 = tmp_moved_constant_3*(jac_affine_inv_0_0_BLUE*jac_blending_inv_0_1 + jac_affine_inv_0_1_BLUE*jac_blending_inv_1_1) + tmp_moved_constant_4*(jac_affine_inv_1_0_BLUE*jac_blending_inv_0_1 + jac_affine_inv_1_1_BLUE*jac_blending_inv_1_1);
                      const real_t tmp_qloop_54 = tmp_qloop_47*tmp_qloop_53;
                      const real_t tmp_qloop_57 = tmp_qloop_53*tmp_qloop_55;
                      const real_t tmp_qloop_60 = tmp_qloop_53*tmp_qloop_58;
                      const real_t hessian_blending_0_0_0 = tmp_qloop_14 - tmp_qloop_25 + tmp_qloop_28;
