...
void P2VectorToP1ElementwiseGradRhoRhoDivergence::toMatrixScaled_P2VectorToP1ElementwiseGradRhoRhoDivergence_macro_2D( idx_t * RESTRICT  _data_dst, real_t * RESTRICT  _data_rho, idx_t * RESTRICT  _data_src_edge_0, idx_t * RESTRICT  _data_src_edge_1, idx_t * RESTRICT  _data_src_vertex_0, idx_t * RESTRICT  _data_src_vertex_1, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t toMatrixScaling ) const
{
    {
             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      ...
                      const real_t tmp_qloop_5 = tmp_qloop_4*2.0;
                      const real_t tmp_qloop_6 = tmp_qloop_1 + tmp_qloop_3 + tmp_qloop_5 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0;
                      const real_t tmp_qloop_10 = 1.0 / (tmp_moved_constant_0*_data_phi_0_0_BLUE[3*q] + tmp_moved_constant_1*_data_phi_0_0_BLUE[3*q + 1] + tmp_moved_constant_2*_data_phi_0_0_BLUE[3*q + 2]);
                      const real_t tmp_qloop_11 = tmp_qloop_10*_data_tabulated_and_untitled_0_0_BLUE[10*q + 1];
                      const real_t tmp_qloop_12 = tmp_moved_constant_5*tmp_qloop_11;
                      ...
                      const real_t tmp_qloop_24 = tmp_moved_constant_6*tmp_qloop_11;
                      ...
                      const real_t tmp_qloop_31 = tmp_moved_constant_5*tmp_qloop_30;
                      const real_t tmp_qloop_32 = tmp_moved_constant_6*tmp_qloop_30;
                      const real_t tmp_qloop_33 = tmp_qloop_10*_data_tabulated_and_untitled_0_0_BLUE[10*q + 9];
                      const real_t tmp_qloop_34 = tmp_moved_constant_5*tmp_qloop_33;
                      const real_t tmp_qloop_35 = tmp_moved_constant_6*tmp_qloop_33;
