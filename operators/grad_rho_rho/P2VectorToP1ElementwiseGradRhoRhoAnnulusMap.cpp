...
P2VectorToP1ElementwiseGradRhoRhoAnnulusMap::P2VectorToP1ElementwiseGradRhoRhoAnnulusMap(
...
void P2VectorToP1ElementwiseGradRhoRhoAnnulusMap::applyScaled( const real_t&                     operatorScaling,
                                                               ...
                                                               UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2VectorToP1ElementwiseGradRhoRhoAnnulusMap_macro_2D(
...
void P2VectorToP1ElementwiseGradRhoRhoAnnulusMap::apply( const P2VectorFunction< real_t >& src,
                                                         const P1Function< real_t >&       dst,
                                                         uint_t                            level,
                                                         DoFType                           flag,
                                                         UpdateType                        updateType ) const
...
void P2VectorToP1ElementwiseGradRhoRhoAnnulusMap::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                                  ...
                                                                  DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2VectorToP1ElementwiseGradRhoRhoAnnulusMap_macro_2D(
...
void P2VectorToP1ElementwiseGradRhoRhoAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                            const P2VectorFunction< idx_t >&            src,
                                                            const P1Function< idx_t >&                  dst,
                                                            uint_t                                      level,
                                                            DoFType                                     flag ) const
