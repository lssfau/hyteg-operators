...
class P2VectorToP1ElementwiseGradRhoRhoDivergence : public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 public:
   P2VectorToP1ElementwiseGradRhoRhoDivergence( const std::shared_ptr< PrimitiveStorage >& storage,
                                                size_t                                     minLevel,
                                                size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorToP1ElementwiseGradRhoRhoDivergence
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    674     879      18       0      0              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseGradRhoRhoDivergence_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3568    4695      47       0      0              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseGradRhoRhoDivergence_macro_3D( real_t* RESTRICT _data_dst,
                                                                          real_t* RESTRICT _data_rho,
                                                                          real_t* RESTRICT _data_src_edge_0,
                                                                          real_t* RESTRICT _data_src_edge_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    638     876      18       0      0              0                 0              4
   void toMatrixScaled_P2VectorToP1ElementwiseGradRhoRhoDivergence_macro_2D( idx_t* RESTRICT  _data_dst,
                                                                             real_t* RESTRICT _data_rho,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3448    4691      47       0      0              0                 0              4
   void toMatrixScaled_P2VectorToP1ElementwiseGradRhoRhoDivergence_macro_3D( idx_t* RESTRICT  _data_dst,
                                                                             real_t* RESTRICT _data_rho,
                                                                             idx_t* RESTRICT  _data_src_edge_0,
                                                                             idx_t* RESTRICT  _data_src_edge_1,
