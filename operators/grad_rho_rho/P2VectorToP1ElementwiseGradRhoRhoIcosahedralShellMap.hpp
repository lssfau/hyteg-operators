...
class P2VectorToP1ElementwiseGradRhoRhoIcosahedralShellMap : public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 public:
   P2VectorToP1ElementwiseGradRhoRhoIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                         size_t                                     minLevel,
                                                         size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorToP1ElementwiseGradRhoRhoIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3645    5102      69      22      0              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseGradRhoRhoIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3525    5098      69      22      0              0                 0              4
   void toMatrixScaled_P2VectorToP1ElementwiseGradRhoRhoIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst,
                                                                                      real_t* RESTRICT _data_rho,
