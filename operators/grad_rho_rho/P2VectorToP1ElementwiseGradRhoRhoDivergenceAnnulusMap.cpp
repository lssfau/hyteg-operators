...
P2VectorToP1ElementwiseGradRhoRhoDivergenceAnnulusMap::P2VectorToP1ElementwiseGradRhoRhoDivergenceAnnulusMap(
...
void P2VectorToP1ElementwiseGradRhoRhoDivergenceAnnulusMap::applyScaled( const real_t&                     operatorScaling,
                                                                         ...
                                                                         UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2VectorToP1ElementwiseGradRhoRhoDivergenceAnnulusMap_macro_2D(
...
void P2VectorToP1ElementwiseGradRhoRhoDivergenceAnnulusMap::apply( const P2VectorFunction< real_t >& src,
                                                                   const P1Function< real_t >&       dst,
                                                                   uint_t                            level,
                                                                   DoFType                           flag,
                                                                   UpdateType                        updateType ) const
...
void P2VectorToP1ElementwiseGradRhoRhoDivergenceAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                      const P2VectorFunction< idx_t >&            src,
                                                                      const P1Function< idx_t >&                  dst,
                                                                      uint_t                                      level,
                                                                      DoFType                                     flag ) const
