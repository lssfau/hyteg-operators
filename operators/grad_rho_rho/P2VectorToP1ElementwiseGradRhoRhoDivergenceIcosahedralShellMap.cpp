...
#include "P2VectorToP1ElementwiseGradRhoRhoDivergenceIcosahedralShellMap.hpp"
...
P2VectorToP1ElementwiseGradRhoRhoDivergenceIcosahedralShellMap::P2VectorToP1ElementwiseGradRhoRhoDivergenceIcosahedralShellMap(
...
void P2VectorToP1ElementwiseGradRhoRhoDivergenceIcosahedralShellMap::applyScaled( const real_t& operatorScaling,
                                                                                  ...
                                                                                  UpdateType updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2VectorToP1ElementwiseGradRhoRhoDivergenceIcosahedralShellMap_macro_3D(
...
void P2VectorToP1ElementwiseGradRhoRhoDivergenceIcosahedralShellMap::apply( const P2VectorFunction< real_t >& src,
                                                                            const P1Function< real_t >&       dst,
                                                                            uint_t                            level,
                                                                            DoFType                           flag,
                                                                            UpdateType                        updateType ) const
...
void P2VectorToP1ElementwiseGradRhoRhoDivergenceIcosahedralShellMap::toMatrixScaled(
    ...
    DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2VectorToP1ElementwiseGradRhoRhoDivergenceIcosahedralShellMap_macro_3D(
...
void P2VectorToP1ElementwiseGradRhoRhoDivergenceIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                               const P2VectorFunction< idx_t >&            src,
                                                                               const P1Function< idx_t >&                  dst,
                                                                               uint_t                                      level,
                                                                               DoFType flag ) const
