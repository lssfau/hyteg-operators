...
class P2VectorToP1ElementwiseGradRhoRhoDivergenceAnnulusMap : public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 public:
   P2VectorToP1ElementwiseGradRhoRhoDivergenceAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                          size_t                                     minLevel,
                                                          size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorToP1ElementwiseGradRhoRhoDivergenceAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1076    1809      30      18      0              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseGradRhoRhoDivergenceAnnulusMap_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1040    1806      30      18      0              0                 0              4
   void toMatrixScaled_P2VectorToP1ElementwiseGradRhoRhoDivergenceAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst,
                                                                                       real_t* RESTRICT _data_rho,
