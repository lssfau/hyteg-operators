...
class P2VectorToP1ElementwiseGradRhoRhoAnnulusMap : public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 public:
   P2VectorToP1ElementwiseGradRhoRhoAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                size_t                                     minLevel,
                                                size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorToP1ElementwiseGradRhoRhoAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    704     987      30      18      0              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseGradRhoRhoAnnulusMap_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    668     984      30      18      0              0                 0              4
   void toMatrixScaled_P2VectorToP1ElementwiseGradRhoRhoAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst,
                                                                             real_t* RESTRICT _data_rho,
