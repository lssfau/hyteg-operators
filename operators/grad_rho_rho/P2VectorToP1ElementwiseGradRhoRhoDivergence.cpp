...
P2VectorToP1ElementwiseGradRhoRhoDivergence::P2VectorToP1ElementwiseGradRhoRhoDivergence(
...
void P2VectorToP1ElementwiseGradRhoRhoDivergence::applyScaled( const real_t&                     operatorScaling,
                                                               ...
                                                               UpdateType                        updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2VectorToP1ElementwiseGradRhoRhoDivergence_macro_3D(
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2VectorToP1ElementwiseGradRhoRhoDivergence_macro_2D(
...
void P2VectorToP1ElementwiseGradRhoRhoDivergence::apply( const P2VectorFunction< real_t >& src,
                                                         const P1Function< real_t >&       dst,
                                                         uint_t                            level,
                                                         DoFType                           flag,
                                                         UpdateType                        updateType ) const
...
void P2VectorToP1ElementwiseGradRhoRhoDivergence::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                                  ...
                                                                  DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2VectorToP1ElementwiseGradRhoRhoDivergence_macro_3D(
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2VectorToP1ElementwiseGradRhoRhoDivergence_macro_2D(
...
void P2VectorToP1ElementwiseGradRhoRhoDivergence::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                            const P2VectorFunction< idx_t >&            src,
                                                            const P1Function< idx_t >&                  dst,
                                                            uint_t                                      level,
                                                            DoFType                                     flag ) const
