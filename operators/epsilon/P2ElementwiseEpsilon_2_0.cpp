...
#include "P2ElementwiseEpsilon_2_0.hpp"
...
P2ElementwiseEpsilon_2_0::P2ElementwiseEpsilon_2_0( const std::shared_ptr< PrimitiveStorage >& storage,
                                                    size_t                                     minLevel,
                                                    size_t                                     maxLevel,
...
void P2ElementwiseEpsilon_2_0::applyScaled( const real_t&               operatorScaling,
                                            ...
                                            UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseEpsilon_2_0_macro_3D(
...
void P2ElementwiseEpsilon_2_0::apply( const P2Function< real_t >& src,
                                      const P2Function< real_t >& dst,
                                      uint_t                      level,
                                      DoFType                     flag,
                                      UpdateType                  updateType ) const
...
void P2ElementwiseEpsilon_2_0::toMatrixScaled( const real_t&                               toMatrixScaling,
                                               ...
                                               DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseEpsilon_2_0_macro_3D(
...
void P2ElementwiseEpsilon_2_0::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                         const P2Function< idx_t >&                  src,
                                         const P2Function< idx_t >&                  dst,
                                         uint_t                                      level,
                                         DoFType                                     flag ) const
