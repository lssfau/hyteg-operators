...
void P2ElementwiseEpsilon_2_2::apply( const P2Function< walberla::float64 >& src,
...
std::shared_ptr< P2Function< walberla::float64 > > P2ElementwiseEpsilon_2_2::getInverseDiagonalValues() const
{
   return invDiag_;
}
