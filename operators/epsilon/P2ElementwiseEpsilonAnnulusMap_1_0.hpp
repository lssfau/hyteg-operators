...
class P2ElementwiseEpsilonAnnulusMap_1_0 : public Operator< P2Function< real_t >, P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    912    1106      20      12      0              0                 0              1
   void applyScaled_P2ElementwiseEpsilonAnnulusMap_1_0_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    876    1100      20      12      0              0                 0              4
   void toMatrixScaled_P2ElementwiseEpsilonAnnulusMap_1_0_macro_2D( idx_t* RESTRICT  _data_dstEdge,
