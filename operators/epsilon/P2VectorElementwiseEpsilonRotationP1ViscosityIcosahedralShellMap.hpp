...
///
class P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap
  ...
  public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  25183   32552     196     210    150              0                 0              1
   void apply_P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  24283   31652     196     210    150              0                 0              4
   void toMatrix_P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   6193    9182     196     210    150              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap_macro_3D(
