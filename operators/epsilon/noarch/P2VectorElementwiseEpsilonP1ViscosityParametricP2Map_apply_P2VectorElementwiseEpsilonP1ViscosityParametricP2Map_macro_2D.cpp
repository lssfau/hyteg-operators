...
{
    {
       ...
       const real_t p_affine_const_2_1_GRAY = macro_vertex_coord_id_0comp1 + tmp_coords_jac_0_GRAY*(-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             {
                const real_t tmp_qloop_0 = mu_dof_0*2.0*_data_phi_0_0_GRAY[10*q] + mu_dof_1*2.0*_data_phi_0_0_GRAY[10*q + 1] + mu_dof_2*2.0*_data_phi_0_0_GRAY[10*q + 2];
       ...
       const real_t p_affine_const_2_1_BLUE = tmp_coords_jac_2_BLUE + tmp_coords_jac_4_BLUE;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 3; q += 1)
             {
                const real_t tmp_qloop_0 = mu_dof_0*2.0*_data_phi_0_0_BLUE[10*q] + mu_dof_1*2.0*_data_phi_0_0_BLUE[10*q + 1] + mu_dof_2*2.0*_data_phi_0_0_BLUE[10*q + 2];
                const real_t tmp_qloop_1 = 4.0*_data_q_p_0[q];
                const real_t tmp_qloop_2 = 4.0*_data_q_p_1[q];
                const real_t tmp_qloop_3 = tmp_qloop_2 - 1.0;
                const real_t tmp_qloop_4 = -tmp_qloop_1 - 8.0*_data_q_p_1[q] + 4.0;
