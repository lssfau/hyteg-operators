                                           ...
                                           public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   void applyScaled_P2ElementwiseEpsilonAnnulusMap_1_1_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   void toMatrixScaled_P2ElementwiseEpsilonAnnulusMap_1_1_macro_2D( idx_t* RESTRICT  _data_dstEdge,
   ...
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseEpsilonAnnulusMap_1_1_macro_2D(
