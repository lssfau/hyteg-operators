...
class P2ElementwiseEpsilon_0_2 : public Operator< P2Function< real_t >, P2Function< real_t > >
{
 public:
 ...
 private:
   ...
   void applyScaled_P2ElementwiseEpsilon_0_2_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   void toMatrixScaled_P2ElementwiseEpsilon_0_2_macro_3D( idx_t* RESTRICT                      _data_dstEdge,
