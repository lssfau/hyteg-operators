...
class P2ElementwiseEpsilon_1_1 : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                 public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseEpsilon_1_1( const std::shared_ptr< PrimitiveStorage >& storage,
                             size_t                                     minLevel,
                             size_t                                     maxLevel,
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    146     150      12       0      0              0                 0              1
   void applyScaled_P2ElementwiseEpsilon_1_1_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    449     446      36       0      0              0                 0              1
   void applyScaled_P2ElementwiseEpsilon_1_1_macro_3D( real_t* RESTRICT _data_dstEdge,
                                                       real_t* RESTRICT _data_dstVertex,
                                                       real_t* RESTRICT _data_muEdge,
                                                       real_t* RESTRICT _data_muVertex,
                                                       real_t* RESTRICT _data_srcEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    110     129      12       0      0              0                 0              4
   void toMatrixScaled_P2ElementwiseEpsilon_1_1_macro_2D( idx_t* RESTRICT                      _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    349     391      36       0      0              0                 0              4
   void toMatrixScaled_P2ElementwiseEpsilon_1_1_macro_3D( idx_t* RESTRICT                      _data_dstEdge,
                                                          idx_t* RESTRICT                      _data_dstVertex,
                                                          real_t* RESTRICT                     _data_muEdge,
                                                          real_t* RESTRICT                     _data_muVertex,
                                                          idx_t* RESTRICT                      _data_srcEdge,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     71      69      12       0      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseEpsilon_1_1_macro_2D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    179     166      36       0      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseEpsilon_1_1_macro_3D(
       real_t* RESTRICT _data_invDiag_Edge,
       real_t* RESTRICT _data_invDiag_Vertex,
       real_t* RESTRICT _data_muEdge,
       real_t* RESTRICT _data_muVertex,
