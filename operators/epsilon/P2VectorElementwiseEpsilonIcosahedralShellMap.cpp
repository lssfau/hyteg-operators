...
#include "P2VectorElementwiseEpsilonIcosahedralShellMap.hpp"
...
P2VectorElementwiseEpsilonIcosahedralShellMap::P2VectorElementwiseEpsilonIcosahedralShellMap(
...
void P2VectorElementwiseEpsilonIcosahedralShellMap::applyScaled( const real_t&                     operatorScaling,
                                                                 ...
                                                                 UpdateType                        updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2VectorElementwiseEpsilonIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseEpsilonIcosahedralShellMap::apply( const P2VectorFunction< real_t >& src,
                                                           const P2VectorFunction< real_t >& dst,
                                                           uint_t                            level,
                                                           DoFType                           flag,
                                                           UpdateType                        updateType ) const
...
void P2VectorElementwiseEpsilonIcosahedralShellMap::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                                    ...
                                                                    DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2VectorElementwiseEpsilonIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseEpsilonIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                              const P2VectorFunction< idx_t >&            src,
                                                              const P2VectorFunction< idx_t >&            dst,
                                                              uint_t                                      level,
                                                              DoFType                                     flag ) const
...
void P2VectorElementwiseEpsilonIcosahedralShellMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseEpsilonIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseEpsilonIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2VectorFunction< real_t > > P2VectorElementwiseEpsilonIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
