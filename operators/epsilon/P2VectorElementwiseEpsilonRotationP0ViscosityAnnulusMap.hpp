...
///
class P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap
...
{
 public:
   P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                            size_t                                     minLevel,
                                                            size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2356    3516      20      36      0              0                 0              1
   void apply_P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2212    3372      20      36      0              0                 0              4
   void toMatrix_P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    856    1440      20      36      0              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap_macro_2D(
