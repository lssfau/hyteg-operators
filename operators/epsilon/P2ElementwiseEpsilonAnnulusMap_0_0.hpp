                                           ...
                                           public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    704    1018      20      12      0              0                 0              1
   void applyScaled_P2ElementwiseEpsilonAnnulusMap_0_0_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    668     997      20      12      0              0                 0              4
   void toMatrixScaled_P2ElementwiseEpsilonAnnulusMap_0_0_macro_2D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    442     702      20      12      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseEpsilonAnnulusMap_0_0_macro_2D(
