...
void P2ElementwiseEpsilonAnnulusMap_1_0::applyScaled( const real_t&               operatorScaling,
...
void P2ElementwiseEpsilonAnnulusMap_1_0::toMatrixScaled( const real_t&                               toMatrixScaling,
