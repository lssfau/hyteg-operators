  ...
  public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  12278   12457      46      10      0              0                 0              1
   void apply_P2VectorElementwiseEpsilonP1ViscosityIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  11378   11557      46      10      0              0                 0              4
   void toMatrix_P2VectorElementwiseEpsilonP1ViscosityIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2768    3962      46      10      0              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonP1ViscosityIcosahedralShellMap_macro_3D(
