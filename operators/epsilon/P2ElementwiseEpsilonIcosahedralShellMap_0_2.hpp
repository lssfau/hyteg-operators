...
class P2ElementwiseEpsilonIcosahedralShellMap_0_2 : public Operator< P2Function< real_t >, P2Function< real_t > >
{
 public:
   P2ElementwiseEpsilonIcosahedralShellMap_0_2( const std::shared_ptr< PrimitiveStorage >& storage,
                                                size_t                                     minLevel,
                                                size_t                                     maxLevel,
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3588    4007      46      10      0              0                 0              1
   void applyScaled_P2ElementwiseEpsilonIcosahedralShellMap_0_2_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3488    3997      46      10      0              0                 0              4
   void toMatrixScaled_P2ElementwiseEpsilonIcosahedralShellMap_0_2_macro_3D( idx_t* RESTRICT  _data_dstEdge,
