...
P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap::P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap(
...
void P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap::apply( const P2VectorFunction< real_t >& src,
                                                                     ...
                                                                     UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         apply_P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap_macro_2D(
...
void P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                        ...
                                                                        DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrix_P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap_macro_2D(
...
void P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap::computeInverseDiagonalOperatorValues()
{
...
std::shared_ptr< P2VectorFunction< real_t > >
    P2VectorElementwiseEpsilonRotationP0ViscosityAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
