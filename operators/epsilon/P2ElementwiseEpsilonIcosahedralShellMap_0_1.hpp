...
class P2ElementwiseEpsilonIcosahedralShellMap_0_1 : public Operator< P2Function< real_t >, P2Function< real_t > >
{
 public:
   P2ElementwiseEpsilonIcosahedralShellMap_0_1( const std::shared_ptr< PrimitiveStorage >& storage,
                                                size_t                                     minLevel,
                                                size_t                                     maxLevel,
 ...
 private:
   ...
   void applyScaled_P2ElementwiseEpsilonIcosahedralShellMap_0_1_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   void toMatrixScaled_P2ElementwiseEpsilonIcosahedralShellMap_0_1_macro_3D( idx_t* RESTRICT  _data_dstEdge,
