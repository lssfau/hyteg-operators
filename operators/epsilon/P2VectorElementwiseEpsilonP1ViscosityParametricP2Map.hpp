...
class P2VectorElementwiseEpsilonP1ViscosityParametricP2Map
...
{
 public:
   P2VectorElementwiseEpsilonP1ViscosityParametricP2Map( const std::shared_ptr< PrimitiveStorage >& storage,
                                                         size_t                                     minLevel,
                                                         size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseEpsilonP1ViscosityParametricP2Map
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1163    1293      15       0      3              0                 0              1
   void applyScaled_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   9689    9114      40       0      4              0                 0              1
   void applyScaled_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_3D( real_t* RESTRICT _data_dst_edge_0,
                                                                                   real_t* RESTRICT _data_dst_edge_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1019    1215      15       0      3              0                 0              4
   void toMatrixScaled_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   8789    8649      40       0      4              0                 0              4
   void toMatrixScaled_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_3D( idx_t* RESTRICT  _data_dst_edge_0,
                                                                                      idx_t* RESTRICT  _data_dst_edge_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    359     483      15       0      3              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_2D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1979    2354      40       0      4              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_3D(
       real_t* RESTRICT _data_invDiag__edge_0,
       real_t* RESTRICT _data_invDiag__edge_1,
