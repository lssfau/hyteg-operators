  ...
  public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1157    1281      15       0      3              0                 0              1
   void apply_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   9677    9084      40       0      4              0                 0              1
   void apply_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_3D( real_t* RESTRICT _data_dst_edge_0,
                                                                             real_t* RESTRICT _data_dst_edge_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1013    1137      15       0      3              0                 0              4
   void toMatrix_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   8777    8184      40       0      4              0                 0              4
   void toMatrix_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_3D( idx_t* RESTRICT  _data_dst_edge_0,
                                                                                idx_t* RESTRICT  _data_dst_edge_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    353     471      15       0      3              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_2D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1967    2324      40       0      4              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_3D(
       real_t* RESTRICT _data_invDiag__edge_0,
       real_t* RESTRICT _data_invDiag__edge_1,
