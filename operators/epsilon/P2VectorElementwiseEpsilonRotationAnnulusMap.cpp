...
P2VectorElementwiseEpsilonRotationAnnulusMap::P2VectorElementwiseEpsilonRotationAnnulusMap(
...
void P2VectorElementwiseEpsilonRotationAnnulusMap::apply( const P2VectorFunction< real_t >& src,
                                                          ...
                                                          UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         apply_P2VectorElementwiseEpsilonRotationAnnulusMap_macro_2D(
...
void P2VectorElementwiseEpsilonRotationAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                             ...
                                                             DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrix_P2VectorElementwiseEpsilonRotationAnnulusMap_macro_2D(
...
void P2VectorElementwiseEpsilonRotationAnnulusMap::computeInverseDiagonalOperatorValues()
{
...
std::shared_ptr< P2VectorFunction< real_t > > P2VectorElementwiseEpsilonRotationAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
