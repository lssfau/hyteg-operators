...
class P2ElementwiseEpsilon_0_0 : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                 public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseEpsilon_0_0( const std::shared_ptr< PrimitiveStorage >& storage,
                             size_t                                     minLevel,
                             size_t                                     maxLevel,
 ...
 private:
   ...
   void applyScaled_P2ElementwiseEpsilon_0_0_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   void applyScaled_P2ElementwiseEpsilon_0_0_macro_3D( real_t* RESTRICT _data_dstEdge,
                                                       real_t* RESTRICT _data_dstVertex,
                                                       real_t* RESTRICT _data_muEdge,
                                                       real_t* RESTRICT _data_muVertex,
                                                       real_t* RESTRICT _data_srcEdge,
   ...
   void toMatrixScaled_P2ElementwiseEpsilon_0_0_macro_2D( idx_t* RESTRICT                      _data_dstEdge,
   ...
   void toMatrixScaled_P2ElementwiseEpsilon_0_0_macro_3D( idx_t* RESTRICT                      _data_dstEdge,
                                                          idx_t* RESTRICT                      _data_dstVertex,
                                                          real_t* RESTRICT                     _data_muEdge,
                                                          real_t* RESTRICT                     _data_muVertex,
                                                          idx_t* RESTRICT                      _data_srcEdge,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     71      69      12       0      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseEpsilon_0_0_macro_2D(
   ...
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseEpsilon_0_0_macro_3D(
       real_t* RESTRICT _data_invDiag_Edge,
       real_t* RESTRICT _data_invDiag_Vertex,
       real_t* RESTRICT _data_muEdge,
       real_t* RESTRICT _data_muVertex,
