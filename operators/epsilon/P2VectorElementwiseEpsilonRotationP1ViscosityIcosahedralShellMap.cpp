...
#include "P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap.hpp"
...
P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap::
    P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                      size_t                                     minLevel,
                                                                      size_t                                     maxLevel,
...
void P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap::apply( const P2VectorFunction< real_t >& src,
                                                                              ...
                                                                              UpdateType                        updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         apply_P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                                 ...
                                                                                 DoFType flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrix_P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap_macro_3D(
...
std::shared_ptr< P2VectorFunction< real_t > >
    P2VectorElementwiseEpsilonRotationP1ViscosityIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
