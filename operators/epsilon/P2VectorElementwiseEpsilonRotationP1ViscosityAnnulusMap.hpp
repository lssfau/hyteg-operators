...
///
class P2VectorElementwiseEpsilonRotationP1ViscosityAnnulusMap
...
{
 public:
   P2VectorElementwiseEpsilonRotationP1ViscosityAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                            size_t                                     minLevel,
                                                            size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseEpsilonRotationP1ViscosityAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2364    3536      20      36      0              0                 0              1
   void apply_P2VectorElementwiseEpsilonRotationP1ViscosityAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2220    3392      20      36      0              0                 0              4
   void toMatrix_P2VectorElementwiseEpsilonRotationP1ViscosityAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    864    1460      20      36      0              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonRotationP1ViscosityAnnulusMap_macro_2D(
