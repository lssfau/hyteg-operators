...
///
class P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap
  ...
  public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 ...
 protected:
 private:
   /// Integral: P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  25168   32517     196     210    150              0                 0              1
   void apply_P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///  24268   31617     196     210    150              0                 0              4
   void toMatrix_P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   6178    9147     196     210    150              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap_macro_3D(
