...
#include "P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap.hpp"
...
P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap::
    P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                      size_t                                     minLevel,
                                                                      size_t                                     maxLevel,
...
void P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap::apply( const P2VectorFunction< real_t >& src,
                                                                              ...
                                                                              UpdateType                        updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         apply_P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                                 ...
                                                                                 DoFType flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrix_P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap_macro_3D(
...
std::shared_ptr< P2VectorFunction< real_t > >
    P2VectorElementwiseEpsilonRotationP0ViscosityIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
