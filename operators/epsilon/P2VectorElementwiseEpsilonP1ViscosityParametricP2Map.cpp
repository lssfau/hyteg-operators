                                                                  ...
                                                                  UpdateType                        updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         apply_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_3D(
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         apply_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_2D(
                                                                     ...
                                                                     DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrix_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_3D(
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrix_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_2D(
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_3D(
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonP1ViscosityParametricP2Map_macro_2D(
