...
#include "P2ElementwiseEpsilonIcosahedralShellMap_1_0.hpp"
...
P2ElementwiseEpsilonIcosahedralShellMap_1_0::P2ElementwiseEpsilonIcosahedralShellMap_1_0(
...
void P2ElementwiseEpsilonIcosahedralShellMap_1_0::applyScaled( const real_t&               operatorScaling,
                                                               ...
                                                               UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseEpsilonIcosahedralShellMap_1_0_macro_3D(
...
void P2ElementwiseEpsilonIcosahedralShellMap_1_0::apply( const P2Function< real_t >& src,
                                                         const P2Function< real_t >& dst,
                                                         uint_t                      level,
                                                         DoFType                     flag,
                                                         UpdateType                  updateType ) const
...
void P2ElementwiseEpsilonIcosahedralShellMap_1_0::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                                  ...
                                                                  DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseEpsilonIcosahedralShellMap_1_0_macro_3D(
...
void P2ElementwiseEpsilonIcosahedralShellMap_1_0::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                            const P2Function< idx_t >&                  src,
                                                            const P2Function< idx_t >&                  dst,
                                                            uint_t                                      level,
                                                            DoFType                                     flag ) const
