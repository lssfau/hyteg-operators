...
///
class P2VectorElementwiseEpsilonRotationAnnulusMap : public Operator< P2VectorFunction< real_t >, P2VectorFunction< real_t > >,
                                                     public OperatorWithInverseDiagonal< P2VectorFunction< real_t > >
{
 public:
   P2VectorElementwiseEpsilonRotationAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                 size_t                                     minLevel,
                                                 size_t                                     maxLevel,
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2376    3560      20      36      0              0                 0              1
   void apply_P2VectorElementwiseEpsilonRotationAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2232    3416      20      36      0              0                 0              4
   void toMatrix_P2VectorElementwiseEpsilonRotationAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    876    1484      20      36      0              0                 0              1
   void computeInverseDiagonalOperatorValues_P2VectorElementwiseEpsilonRotationAnnulusMap_macro_2D(
