                                                    ...
                                                    public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   void applyScaled_P2ElementwiseEpsilonIcosahedralShellMap_0_0_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   void toMatrixScaled_P2ElementwiseEpsilonIcosahedralShellMap_0_0_macro_3D( idx_t* RESTRICT  _data_dstEdge,
   ...
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseEpsilonIcosahedralShellMap_0_0_macro_3D(
