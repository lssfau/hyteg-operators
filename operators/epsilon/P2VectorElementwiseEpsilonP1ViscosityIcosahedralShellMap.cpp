...
#include "P2VectorElementwiseEpsilonP1ViscosityIcosahedralShellMap.hpp"
...
P2VectorElementwiseEpsilonP1ViscosityIcosahedralShellMap::P2VectorElementwiseEpsilonP1ViscosityIcosahedralShellMap(
...
void P2VectorElementwiseEpsilonP1ViscosityIcosahedralShellMap::applyScaled( const real_t&                     operatorScaling,
                                                                            ...
                                                                            UpdateType                        updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2VectorElementwiseEpsilonP1ViscosityIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseEpsilonP1ViscosityIcosahedralShellMap::apply( const P2VectorFunction< real_t >& src,
                                                                      const P2VectorFunction< real_t >& dst,
                                                                      uint_t                            level,
                                                                      DoFType                           flag,
                                                                      UpdateType                        updateType ) const
                                                                               ...
                                                                               DoFType flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2VectorElementwiseEpsilonP1ViscosityIcosahedralShellMap_macro_3D(
...
void P2VectorElementwiseEpsilonP1ViscosityIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                         const P2VectorFunction< idx_t >&            src,
                                                                         const P2VectorFunction< idx_t >&            dst,
                                                                         uint_t                                      level,
                                                                         DoFType                                     flag ) const
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2VectorElementwiseEpsilonP1ViscosityIcosahedralShellMap_macro_3D(
