...
class P2ElementwiseEpsilonIcosahedralShellMap_2_2 : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                    public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseEpsilonIcosahedralShellMap_2_2( const std::shared_ptr< PrimitiveStorage >& storage,
                                                size_t                                     minLevel,
                                                size_t                                     maxLevel,
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2928    3937      46      10      0              0                 0              1
   void applyScaled_P2ElementwiseEpsilonIcosahedralShellMap_2_2_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2828    3882      46      10      0              0                 0              4
   void toMatrixScaled_P2ElementwiseEpsilonIcosahedralShellMap_2_2_macro_3D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1618    2467      46      10      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseEpsilonIcosahedralShellMap_2_2_macro_3D(
