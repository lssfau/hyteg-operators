...
#include "P2ElementwiseSupgAdiabaticHeatingIcosahedralShellMap.hpp"
...
P2ElementwiseSupgAdiabaticHeatingIcosahedralShellMap::P2ElementwiseSupgAdiabaticHeatingIcosahedralShellMap(
                                                                        ...
                                                                        UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseSupgAdiabaticHeatingIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgAdiabaticHeatingIcosahedralShellMap::apply( const P2Function< real_t >& src,
                                                                  const P2Function< real_t >& dst,
                                                                  uint_t                      level,
                                                                  DoFType                     flag,
                                                                  UpdateType                  updateType ) const
...
void P2ElementwiseSupgAdiabaticHeatingIcosahedralShellMap::toMatrixScaled( const real_t& toMatrixScaling,
                                                                           ...
                                                                           DoFType flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgAdiabaticHeatingIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgAdiabaticHeatingIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                     const P2Function< idx_t >&                  src,
                                                                     const P2Function< idx_t >&                  dst,
                                                                     uint_t                                      level,
                                                                     DoFType                                     flag ) const
...
void P2ElementwiseSupgAdiabaticHeatingIcosahedralShellMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdiabaticHeatingIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgAdiabaticHeatingIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseSupgAdiabaticHeatingIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
