...
///     - ∫ delta T (u · g) ( u · ∇w )
///
class P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                              public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                          size_t                                     minLevel,
                                                          size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1041    1578      40      35     21              0                 0              1
   void applyScaled_P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap_macro_2D( real_t* RESTRICT _data_deltaEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1005    1572      40      35     21              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap_macro_2D( real_t* RESTRICT _data_deltaEdge,
                                                                                       real_t* RESTRICT _data_deltaVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    801    1332      40      35     21              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap_macro_2D(
