...
///     - ∫ delta T (u · g) ( u · ∇w )
///
class P2ElementwiseSupgAdiabaticHeatingAnnulusMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                    public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgAdiabaticHeatingAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                size_t                                     minLevel,
                                                size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgAdiabaticHeatingAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1202    2082     110      91     70              0                 0              1
   void applyScaled_P2ElementwiseSupgAdiabaticHeatingAnnulusMap_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1166    2076     110      91     70              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgAdiabaticHeatingAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    962    1836     110      91     70              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdiabaticHeatingAnnulusMap_macro_2D(
