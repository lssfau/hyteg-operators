             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 7; q += 1)
                   {
                      ...
                      const real_t q_tmp_0_0 = tmp_qloop_62*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_GRAY[12*q] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_GRAY[6*q]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_GRAY[12*q] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_GRAY[6*q]))*_data_tabulated_and_untitled_0_0_GRAY[12*q + 1];
                      const real_t q_tmp_1_1 = tmp_qloop_62*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 7] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_GRAY[6*q + 1]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_GRAY[12*q + 7] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 1]))*_data_tabulated_and_untitled_0_0_GRAY[12*q + 2];
                      const real_t q_tmp_2_2 = tmp_qloop_62*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 8] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_GRAY[6*q + 2]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_GRAY[12*q + 8] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 2]))*_data_tabulated_and_untitled_0_0_GRAY[12*q + 3];
                      const real_t q_tmp_3_3 = tmp_qloop_62*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 9] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_GRAY[6*q + 3]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_GRAY[12*q + 9] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 3]))*_data_tabulated_and_untitled_0_0_GRAY[12*q + 4];
                      const real_t q_tmp_4_4 = tmp_qloop_62*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 10] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_GRAY[6*q + 4]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_GRAY[12*q + 10] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 4]))*_data_tabulated_and_untitled_0_0_GRAY[12*q + 5];
                      const real_t q_tmp_5_5 = tmp_qloop_62*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_GRAY[12*q + 11] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_GRAY[6*q + 5]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_GRAY[12*q + 11] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_GRAY[6*q + 5]))*_data_tabulated_and_untitled_0_0_GRAY[12*q + 6];
             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 7; q += 1)
                   {
                      ...
                      const real_t tmp_qloop_53 = -tmp_qloop_45 + tmp_qloop_46*-4.0 + 4.0*_data_q_p_0[q];
                      const real_t tmp_qloop_54 = tmp_qloop_45 + tmp_qloop_47 + tmp_qloop_50 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0;
                      const real_t tmp_qloop_55 = tmp_moved_constant_10*tmp_qloop_52 + tmp_moved_constant_11*tmp_qloop_53 + tmp_moved_constant_6*tmp_qloop_54 + tmp_moved_constant_7*tmp_qloop_48 + tmp_moved_constant_8*tmp_qloop_51 + tmp_moved_constant_9*tmp_qloop_45;
                      const real_t tmp_qloop_56 = tmp_moved_constant_12*tmp_qloop_54 + tmp_moved_constant_13*tmp_qloop_48 + tmp_moved_constant_14*tmp_qloop_51 + tmp_moved_constant_15*tmp_qloop_45 + tmp_moved_constant_16*tmp_qloop_52 + tmp_moved_constant_17*tmp_qloop_53;
                      const real_t tmp_qloop_57 = -p_affine_0_0 + tmp_qloop_0*_data_q_p_0[q] + tmp_qloop_1*_data_q_p_1[q];
                      const real_t tmp_qloop_58 = -p_affine_0_1 + tmp_qloop_6*_data_q_p_0[q] + tmp_qloop_7*_data_q_p_1[q];
                      const real_t tmp_qloop_59 = 1.0 / (abs(pow((tmp_qloop_57*tmp_qloop_57) + (tmp_qloop_58*tmp_qloop_58), 0.50000000000000000))*abs(pow((tmp_qloop_57*tmp_qloop_57) + (tmp_qloop_58*tmp_qloop_58), 0.50000000000000000)));
                      const real_t tmp_qloop_60 = radRayVertex + tmp_qloop_17*1.0 / (tmp_qloop_12*tmp_qloop_3 - tmp_qloop_13*tmp_qloop_15)*(tmp_qloop_13*(rayVertex_1 + tmp_qloop_58) - tmp_qloop_3*(rayVertex_0 + tmp_qloop_57));
                      ...
                      const real_t tmp_qloop_30 = 1.0 / (tmp_qloop_29);
                      const real_t abs_det_jac_blending = tmp_qloop_29;
                      const real_t tmp_qloop_62 = abs_det_jac_blending*(-tmp_qloop_2*tmp_qloop_55*tmp_qloop_61 - tmp_qloop_56*tmp_qloop_61*tmp_qloop_8)*(-tmp_moved_constant_0*tmp_qloop_54 - tmp_moved_constant_1*tmp_qloop_48 - tmp_moved_constant_2*tmp_qloop_51 - tmp_moved_constant_3*tmp_qloop_45 - tmp_moved_constant_4*tmp_qloop_52 - tmp_moved_constant_5*tmp_qloop_53)*_data_q_w[q];
                      const real_t jac_blending_inv_0_0 = jac_blending_1_1*tmp_qloop_30;
                      const real_t jac_blending_inv_0_1 = -jac_blending_0_1*tmp_qloop_30;
                      const real_t jac_blending_inv_1_0 = -jac_blending_1_0*tmp_qloop_30;
                      const real_t jac_blending_inv_1_1 = jac_blending_0_0*tmp_qloop_30;
                      ...
                      const real_t hessian_blending_0_1_1 = tmp_qloop_2*tmp_qloop_40 - (tmp_qloop_2*tmp_qloop_2*tmp_qloop_2)*tmp_qloop_34 + tmp_qloop_33 + tmp_qloop_44;
                      const real_t hessian_blending_1_1_1 = tmp_qloop_13*tmp_qloop_16*tmp_qloop_18*tmp_qloop_23*tmp_qloop_5*1.0 + tmp_qloop_14*tmp_qloop_16*tmp_qloop_18*tmp_qloop_23*tmp_qloop_9*1.0 - tmp_qloop_27 - tmp_qloop_41;
                      const real_t q_tmp_0_0 = tmp_qloop_62*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_BLUE[12*q] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_BLUE[6*q]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_BLUE[12*q] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_BLUE[6*q]))*_data_tabulated_and_untitled_0_0_BLUE[12*q + 1];
                      const real_t q_tmp_1_1 = tmp_qloop_62*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 7] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_BLUE[6*q + 1]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_BLUE[12*q + 7] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 1]))*_data_tabulated_and_untitled_0_0_BLUE[12*q + 2];
                      ...
                      const real_t q_tmp_3_3 = tmp_qloop_62*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 9] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_BLUE[6*q + 3]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_BLUE[12*q + 9] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 3]))*_data_tabulated_and_untitled_0_0_BLUE[12*q + 4];
                      const real_t q_tmp_4_4 = tmp_qloop_62*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 10] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_BLUE[6*q + 4]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_BLUE[12*q + 10] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 4]))*_data_tabulated_and_untitled_0_0_BLUE[12*q + 5];
                      const real_t q_tmp_5_5 = tmp_qloop_62*(tmp_qloop_55*(jac_blending_inv_0_0*_data_tabulated_and_untitled_0_0_BLUE[12*q + 11] + jac_blending_inv_1_0*_data_tabulated_and_untitled_1_0_BLUE[6*q + 5]) + tmp_qloop_56*(jac_blending_inv_0_1*_data_tabulated_and_untitled_0_0_BLUE[12*q + 11] + jac_blending_inv_1_1*_data_tabulated_and_untitled_1_0_BLUE[6*q + 5]))*_data_tabulated_and_untitled_0_0_BLUE[12*q + 6];
                      q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                      q_acc_1_1 = q_acc_1_1 + q_tmp_1_1;
                      q_acc_2_2 = q_acc_2_2 + q_tmp_2_2;
                      q_acc_3_3 = q_acc_3_3 + q_tmp_3_3;
