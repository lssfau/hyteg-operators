...
P2ElementwiseSupgAdiabaticHeatingAnnulusMap::P2ElementwiseSupgAdiabaticHeatingAnnulusMap(
                                                               ...
                                                               UpdateType                  updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseSupgAdiabaticHeatingAnnulusMap_macro_2D(
...
void P2ElementwiseSupgAdiabaticHeatingAnnulusMap::apply( const P2Function< real_t >& src,
                                                         const P2Function< real_t >& dst,
                                                         uint_t                      level,
                                                         DoFType                     flag,
                                                         UpdateType                  updateType ) const
...
void P2ElementwiseSupgAdiabaticHeatingAnnulusMap::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                                  ...
                                                                  DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgAdiabaticHeatingAnnulusMap_macro_2D(
...
void P2ElementwiseSupgAdiabaticHeatingAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                            const P2Function< idx_t >&                  src,
                                                            const P2Function< idx_t >&                  dst,
                                                            uint_t                                      level,
                                                            DoFType                                     flag ) const
...
void P2ElementwiseSupgAdiabaticHeatingAnnulusMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdiabaticHeatingAnnulusMap_macro_2D(
...
void P2ElementwiseSupgAdiabaticHeatingAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseSupgAdiabaticHeatingAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
