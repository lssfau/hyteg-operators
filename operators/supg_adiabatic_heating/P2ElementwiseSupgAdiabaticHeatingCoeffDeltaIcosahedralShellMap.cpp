...
#include "P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap.hpp"
...
P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap::P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap(
...
void P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap::applyScaled( const real_t&               operatorScaling,
                                                                                  ...
                                                                                  UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap::apply( const P2Function< real_t >& src,
                                                                            const P2Function< real_t >& dst,
                                                                            uint_t                      level,
                                                                            DoFType                     flag,
                                                                            UpdateType                  updateType ) const
    ...
    DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                               const P2Function< idx_t >&                  src,
                                                                               const P2Function< idx_t >&                  dst,
                                                                               uint_t                                      level,
                                                                               DoFType flag ) const
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap_macro_3D(
