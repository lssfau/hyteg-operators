...
///     - ∫ delta T (u · g) ( u · ∇w )
///
class P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap
: public Operator< P2Function< real_t >, P2Function< real_t > >,
  public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                   size_t                                     minLevel,
                                                                   size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5863    8470      92      70     70              0                 0              1
   void applyScaled_P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5763    8460      92      70     70              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap_macro_3D(
       real_t* RESTRICT                     _data_deltaEdge,
       real_t* RESTRICT                     _data_deltaVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4513    7110      92      70     70              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdiabaticHeatingCoeffDeltaIcosahedralShellMap_macro_3D(
       real_t* RESTRICT _data_deltaEdge,
       real_t* RESTRICT _data_deltaVertex,
