...
P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap::P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap(
...
void P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap::applyScaled( const real_t&               operatorScaling,
                                                                         ...
                                                                         UpdateType                  updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap_macro_2D(
...
void P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap::apply( const P2Function< real_t >& src,
                                                                   const P2Function< real_t >& dst,
                                                                   uint_t                      level,
                                                                   DoFType                     flag,
                                                                   UpdateType                  updateType ) const
...
void P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap::toMatrixScaled( const real_t& toMatrixScaling,
                                                                            ...
                                                                            DoFType flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap_macro_2D(
...
void P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                      const P2Function< idx_t >&                  src,
                                                                      const P2Function< idx_t >&                  dst,
                                                                      uint_t                                      level,
                                                                      DoFType                                     flag ) const
...
void P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap::computeInverseDiagonalOperatorValuesScaled(
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap_macro_2D(
...
void P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseSupgAdiabaticHeatingCoeffDeltaAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
