                                   ...
                                   public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    296     480      45      24     21              0                 0              1
   void applyScaled_P2ElementwiseSupgDiffusion_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1013    1230      76      48     76              0                 0              1
   void applyScaled_P2ElementwiseSupgDiffusion_macro_3D( real_t* RESTRICT _data_dstEdge,
                                                         real_t* RESTRICT _data_dstVertex,
                                                         real_t* RESTRICT _data_rho,
                                                         real_t* RESTRICT _data_srcEdge,
                                                         real_t* RESTRICT _data_srcVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    260     474      45      24     21              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgDiffusion_macro_2D( idx_t* RESTRICT                      _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    913    1220      76      48     76              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgDiffusion_macro_3D( idx_t* RESTRICT                      _data_dstEdge,
                                                            idx_t* RESTRICT                      _data_dstVertex,
                                                            real_t* RESTRICT                     _data_rho,
                                                            idx_t* RESTRICT                      _data_srcEdge,
                                                            idx_t* RESTRICT                      _data_srcVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    176     354      45      24     21              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgDiffusion_macro_2D( real_t* RESTRICT _data_invDiag_Edge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    563     770      76      48     76              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgDiffusion_macro_3D( real_t* RESTRICT _data_invDiag_Edge,
                                                                                        real_t* RESTRICT _data_invDiag_Vertex,
                                                                                        real_t* RESTRICT _data_rho,
                                                                                        real_t* RESTRICT _data_uxEdge,
                                                                                        real_t* RESTRICT _data_uxVertex,
