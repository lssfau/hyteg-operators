...
#include "P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap.hpp"
...
P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap::P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap(
...
void P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap::applyScaled( const real_t&               operatorScaling,
                                                                           ...
                                                                           UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap::apply( const P2Function< real_t >& src,
                                                                     const P2Function< real_t >& dst,
                                                                     uint_t                      level,
                                                                     DoFType                     flag,
                                                                     UpdateType                  updateType ) const
...
void P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap::toMatrixScaled( const real_t& toMatrixScaling,
                                                                              ...
                                                                              DoFType flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                        const P2Function< idx_t >&                  src,
                                                                        const P2Function< idx_t >&                  dst,
                                                                        uint_t                                      level,
                                                                        DoFType                                     flag ) const
...
void P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap::computeInverseDiagonalOperatorValuesScaled(
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
