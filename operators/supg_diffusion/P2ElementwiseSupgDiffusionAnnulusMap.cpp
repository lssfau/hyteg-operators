...
P2ElementwiseSupgDiffusionAnnulusMap::P2ElementwiseSupgDiffusionAnnulusMap(
                                                        ...
                                                        UpdateType                  updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseSupgDiffusionAnnulusMap_macro_2D(
...
void P2ElementwiseSupgDiffusionAnnulusMap::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                           ...
                                                           DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgDiffusionAnnulusMap_macro_2D(
...
void P2ElementwiseSupgDiffusionAnnulusMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgDiffusionAnnulusMap_macro_2D(
