...
class P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                                public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                            size_t                                     minLevel,
                                                            size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5998    8202      46      10      0              0                 0              1
   void applyScaled_P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_deltaEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5898    8192      46      10      0              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_deltaEdge,
                                                                                         real_t* RESTRICT _data_deltaVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5458    7652      46      10      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgDiffusionCoeffDeltaIcosahedralShellMap_macro_3D(
