             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 3; q += 1)
                   {
                      ...
                      const real_t tmp_qloop_2 = (-tmp_moved_constant_0*_data_phi_0_0_BLUE[6*q] - tmp_moved_constant_1*_data_phi_0_0_BLUE[6*q + 1] - tmp_moved_constant_2*_data_phi_0_0_BLUE[6*q + 2] - tmp_moved_constant_3*_data_phi_0_0_BLUE[6*q + 3] - tmp_moved_constant_4*_data_phi_0_0_BLUE[6*q + 4] - tmp_moved_constant_5*_data_phi_0_0_BLUE[6*q + 5])*_data_q_w[q]*_data_tabulated_and_untitled_0_0_BLUE[13*q + 2];
