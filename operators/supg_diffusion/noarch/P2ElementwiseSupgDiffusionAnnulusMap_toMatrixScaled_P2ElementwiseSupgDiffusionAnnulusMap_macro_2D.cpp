...
void P2ElementwiseSupgDiffusionAnnulusMap::toMatrixScaled_P2ElementwiseSupgDiffusionAnnulusMap_macro_2D( idx_t * RESTRICT  _data_dstEdge, idx_t * RESTRICT  _data_dstVertex, real_t * RESTRICT  _data_rho, idx_t * RESTRICT  _data_srcEdge, idx_t * RESTRICT  _data_srcVertex, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t radRayVertex, real_t radRefVertex, real_t rayVertex_0, real_t rayVertex_1, real_t refVertex_0, real_t refVertex_1, real_t thermal_conductivity, real_t thrVertex_0, real_t thrVertex_1, real_t toMatrixScaling ) const
{
    {
       ...
       const real_t tmp_qloop_90 = 1.0 / (thermal_conductivity*thermal_conductivity*thermal_conductivity);
       const real_t tmp_qloop_101 = 1.0 / (thermal_conductivity);
             ...
             {
                {
                   ...
                   const real_t tmp_qloop_108 = 1.0 / (thermal_conductivity*thermal_conductivity)*tmp_qloop_87*tmp_qloop_92*tmp_qloop_94*tmp_qloop_96*1.0 / (tmp_qloop_98*tmp_qloop_98);
             ...
             {
                {
                   ...
                   const real_t tmp_qloop_98 = abs(tmp_qloop_0*tmp_qloop_8 - tmp_qloop_2*tmp_qloop_6);
                   const real_t tmp_qloop_99 = 1.0 / (tmp_qloop_98*tmp_qloop_98*tmp_qloop_98);
                   const real_t tmp_qloop_100 = tmp_moved_constant_28*tmp_qloop_90*tmp_qloop_93*tmp_qloop_95*tmp_qloop_97*tmp_qloop_99;
                   const real_t tmp_qloop_102 = pow(tmp_qloop_92, 0.50000000000000000);
                   const real_t tmp_qloop_103 = pow(tmp_qloop_94, 0.50000000000000000);
                   const real_t tmp_qloop_104 = pow(tmp_qloop_96, 0.50000000000000000);
                   const real_t tmp_qloop_105 = 1.0 / (tmp_qloop_98);
                   const real_t tmp_qloop_106 = tmp_qloop_102*tmp_qloop_103*tmp_qloop_104*tmp_qloop_105;
                   const real_t tmp_qloop_107 = tmp_moved_constant_26*tmp_qloop_101*tmp_qloop_106;
                   const real_t tmp_qloop_108 = 1.0 / (thermal_conductivity*thermal_conductivity)*tmp_moved_constant_25*tmp_qloop_92*tmp_qloop_94*tmp_qloop_96*1.0 / (tmp_qloop_98*tmp_qloop_98);
                   for (int64_t q = 0; q < 4; q += 1)
                   {
                      const real_t tmp_qloop_3 = p_affine_0_0 - tmp_qloop_0*_data_q_p_0[q] - tmp_qloop_2*_data_q_p_1[q];
                      const real_t tmp_qloop_5 = (tmp_qloop_3*tmp_qloop_3);
                      ...
                      const real_t tmp_qloop_83 = tmp_qloop_53 - tmp_qloop_75 + tmp_qloop_76*-4.0;
                      const real_t tmp_qloop_84 = tmp_qloop_75 + tmp_qloop_77 + tmp_qloop_80 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0;
                      const real_t tmp_qloop_85 = tmp_moved_constant_3*tmp_qloop_84 + tmp_moved_constant_4*tmp_qloop_78 + tmp_moved_constant_5*tmp_qloop_81 + tmp_moved_constant_6*tmp_qloop_75 + tmp_moved_constant_7*tmp_qloop_82 + tmp_moved_constant_8*tmp_qloop_83;
                      const real_t tmp_qloop_86 = tmp_moved_constant_10*tmp_qloop_78 + tmp_moved_constant_11*tmp_qloop_81 + tmp_moved_constant_12*tmp_qloop_75 + tmp_moved_constant_13*tmp_qloop_82 + tmp_moved_constant_14*tmp_qloop_83 + tmp_moved_constant_9*tmp_qloop_84;
                      const real_t tmp_qloop_114 = tmp_qloop_53 - 1.0;
                      ...
                      const real_t tmp_qloop_28 = 1.0 / (tmp_qloop_27);
                      const real_t abs_det_jac_blending = tmp_qloop_27;
                      const real_t tmp_qloop_109 = abs_det_jac_blending*tmp_moved_constant_27*tmp_qloop_106*1.0 / (tmp_moved_constant_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + tmp_moved_constant_1*_data_q_p_0[q] + tmp_moved_constant_2*_data_q_p_1[q])*0.50000000000000000*((tmp_qloop_107 <= 1.1799999561582399) ? (tmp_qloop_100*-0.0027777777777777778 + tmp_qloop_107*0.16666666666666667): ((tmp_qloop_107 <= 3.0159389978870399) ? (tmp_moved_constant_26*tmp_qloop_101*tmp_qloop_102*tmp_qloop_103*tmp_qloop_104*tmp_qloop_105*0.17969906536907199 + tmp_qloop_100*-0.00051942446859271248 + tmp_qloop_108*-0.0089393368193446242 - 0.0064954259688208404): ((tmp_qloop_107 <= 6.7434348119715999) ? (tmp_moved_constant_26*tmp_qloop_101*tmp_qloop_102*tmp_qloop_103*tmp_qloop_104*tmp_qloop_105*0.2146156710600175 + tmp_moved_constant_28*tmp_qloop_90*tmp_qloop_93*tmp_qloop_95*tmp_qloop_97*tmp_qloop_99*0.00076015027042957372 + tmp_qloop_108*-0.020516694887729999 - 0.041597543561209399): ((tmp_qloop_107 <= 9.7000000058627194) ? (tmp_qloop_100*0.0003890697253152925 + tmp_qloop_107*0.16399221771597999 + tmp_qloop_108*-0.01300962248982295 + 0.072194442299590406): (thermal_conductivity*tmp_moved_constant_27*1.0 / (tmp_qloop_102)*1.0 / (tmp_qloop_103)*1.0 / (tmp_qloop_104)*tmp_qloop_98*-2.0 + 1.0)))))*_data_q_w[q]*_data_tabulated_and_untitled_0_0_BLUE[7*q + 1];
                      const real_t jac_blending_inv_0_0 = jac_blending_1_1*tmp_qloop_28;
                      const real_t jac_blending_inv_0_1 = -jac_blending_0_1*tmp_qloop_28;
                      const real_t jac_blending_inv_1_0 = -jac_blending_1_0*tmp_qloop_28;
                      const real_t jac_blending_inv_1_1 = jac_blending_0_0*tmp_qloop_28;
                      ...
                      const real_t tmp_qloop_72 = jac_blending_inv_0_0*tmp_qloop_70 + jac_blending_inv_0_1*tmp_qloop_71;
                      const real_t tmp_qloop_73 = jac_blending_inv_1_0*tmp_qloop_70 + jac_blending_inv_1_1*tmp_qloop_71;
                      const real_t tmp_qloop_74 = jac_blending_inv_0_0*(jac_blending_inv_0_0*tmp_moved_constant_18 + jac_blending_inv_1_0*tmp_moved_constant_22) + jac_blending_inv_0_0*(tmp_qloop_56*tmp_qloop_59 + tmp_qloop_60*tmp_qloop_61) + jac_blending_inv_0_1*(jac_blending_inv_0_1*tmp_moved_constant_18 + jac_blending_inv_1_1*tmp_moved_constant_22) + jac_blending_inv_0_1*(tmp_qloop_56*tmp_qloop_64 + tmp_qloop_60*tmp_qloop_65) + jac_blending_inv_1_0*(jac_blending_inv_0_0*tmp_moved_constant_23 + jac_blending_inv_1_0*tmp_moved_constant_24) + jac_blending_inv_1_0*(tmp_qloop_56*tmp_qloop_68 + tmp_qloop_60*tmp_qloop_69) + jac_blending_inv_1_1*(jac_blending_inv_0_1*tmp_moved_constant_23 + jac_blending_inv_1_1*tmp_moved_constant_24) + jac_blending_inv_1_1*(tmp_qloop_56*tmp_qloop_72 + tmp_qloop_60*tmp_qloop_73);
                      const real_t tmp_qloop_117 = jac_blending_inv_0_0*(jac_blending_inv_0_0*tmp_moved_constant_30 + jac_blending_inv_1_0*tmp_moved_constant_29) + jac_blending_inv_0_0*(tmp_qloop_115*tmp_qloop_59 + tmp_qloop_116*tmp_qloop_61) + jac_blending_inv_0_1*(jac_blending_inv_0_1*tmp_moved_constant_30 + jac_blending_inv_1_1*tmp_moved_constant_29) + jac_blending_inv_0_1*(tmp_qloop_115*tmp_qloop_64 + tmp_qloop_116*tmp_qloop_65) + jac_blending_inv_1_0*(jac_blending_inv_0_0*tmp_moved_constant_29 + jac_blending_inv_1_0*tmp_moved_constant_31) + jac_blending_inv_1_0*(tmp_qloop_115*tmp_qloop_68 + tmp_qloop_116*tmp_qloop_69) + jac_blending_inv_1_1*(jac_blending_inv_0_1*tmp_moved_constant_29 + jac_blending_inv_1_1*tmp_moved_constant_31) + jac_blending_inv_1_1*(tmp_qloop_115*tmp_qloop_72 + tmp_qloop_116*tmp_qloop_73);
                      const real_t tmp_qloop_124 = jac_blending_inv_0_0*(jac_blending_inv_0_0*tmp_moved_constant_33 + jac_blending_inv_1_0*tmp_moved_constant_32) + jac_blending_inv_0_0*(tmp_qloop_122*tmp_qloop_59 + tmp_qloop_123*tmp_qloop_61) + jac_blending_inv_0_1*(jac_blending_inv_0_1*tmp_moved_constant_33 + jac_blending_inv_1_1*tmp_moved_constant_32) + jac_blending_inv_0_1*(tmp_qloop_122*tmp_qloop_64 + tmp_qloop_123*tmp_qloop_65) + jac_blending_inv_1_0*(jac_blending_inv_0_0*tmp_moved_constant_32 + jac_blending_inv_1_0*tmp_moved_constant_34) + jac_blending_inv_1_0*(tmp_qloop_122*tmp_qloop_68 + tmp_qloop_123*tmp_qloop_69) + jac_blending_inv_1_1*(jac_blending_inv_0_1*tmp_moved_constant_32 + jac_blending_inv_1_1*tmp_moved_constant_34) + jac_blending_inv_1_1*(tmp_qloop_122*tmp_qloop_72 + tmp_qloop_123*tmp_qloop_73);
                      const real_t tmp_qloop_138 = jac_blending_inv_0_0*(jac_blending_inv_0_0*tmp_moved_constant_36 + jac_blending_inv_1_0*tmp_moved_constant_39) + jac_blending_inv_0_0*(tmp_qloop_134*tmp_qloop_59 + tmp_qloop_137*tmp_qloop_61) + jac_blending_inv_0_1*(jac_blending_inv_0_1*tmp_moved_constant_36 + jac_blending_inv_1_1*tmp_moved_constant_39) + jac_blending_inv_0_1*(tmp_qloop_134*tmp_qloop_64 + tmp_qloop_137*tmp_qloop_65) + jac_blending_inv_1_0*(jac_blending_inv_0_0*tmp_moved_constant_39 + jac_blending_inv_1_0*tmp_moved_constant_41) + jac_blending_inv_1_0*(tmp_qloop_134*tmp_qloop_68 + tmp_qloop_137*tmp_qloop_69) + jac_blending_inv_1_1*(jac_blending_inv_0_1*tmp_moved_constant_39 + jac_blending_inv_1_1*tmp_moved_constant_41) + jac_blending_inv_1_1*(tmp_qloop_134*tmp_qloop_72 + tmp_qloop_137*tmp_qloop_73);
                      const real_t tmp_qloop_150 = jac_blending_inv_0_0*(jac_blending_inv_0_0*tmp_moved_constant_44 + jac_blending_inv_1_0*tmp_moved_constant_46) + jac_blending_inv_0_0*(tmp_qloop_148*tmp_qloop_59 + tmp_qloop_149*tmp_qloop_61) + jac_blending_inv_0_1*(jac_blending_inv_0_1*tmp_moved_constant_44 + jac_blending_inv_1_1*tmp_moved_constant_46) + jac_blending_inv_0_1*(tmp_qloop_148*tmp_qloop_64 + tmp_qloop_149*tmp_qloop_65) + jac_blending_inv_1_0*(jac_blending_inv_0_0*tmp_moved_constant_47 + jac_blending_inv_1_0*tmp_moved_constant_49) + jac_blending_inv_1_0*(tmp_qloop_148*tmp_qloop_68 + tmp_qloop_149*tmp_qloop_69) + jac_blending_inv_1_1*(jac_blending_inv_0_1*tmp_moved_constant_47 + jac_blending_inv_1_1*tmp_moved_constant_49) + jac_blending_inv_1_1*(tmp_qloop_148*tmp_qloop_72 + tmp_qloop_149*tmp_qloop_73);
                      const real_t tmp_qloop_160 = jac_blending_inv_0_0*(jac_blending_inv_0_0*tmp_moved_constant_51 + jac_blending_inv_1_0*tmp_moved_constant_53) + jac_blending_inv_0_0*(tmp_qloop_158*tmp_qloop_59 + tmp_qloop_159*tmp_qloop_61) + jac_blending_inv_0_1*(jac_blending_inv_0_1*tmp_moved_constant_51 + jac_blending_inv_1_1*tmp_moved_constant_53) + jac_blending_inv_0_1*(tmp_qloop_158*tmp_qloop_64 + tmp_qloop_159*tmp_qloop_65) + jac_blending_inv_1_0*(jac_blending_inv_0_0*tmp_moved_constant_54 + jac_blending_inv_1_0*tmp_moved_constant_55) + jac_blending_inv_1_0*(tmp_qloop_158*tmp_qloop_68 + tmp_qloop_159*tmp_qloop_69) + jac_blending_inv_1_1*(jac_blending_inv_0_1*tmp_moved_constant_54 + jac_blending_inv_1_1*tmp_moved_constant_55) + jac_blending_inv_1_1*(tmp_qloop_158*tmp_qloop_72 + tmp_qloop_159*tmp_qloop_73);
                      const real_t q_tmp_0_0 = -tmp_qloop_110*tmp_qloop_74;
                      const real_t q_tmp_0_1 = -tmp_qloop_110*tmp_qloop_117;
                      const real_t q_tmp_0_2 = -tmp_qloop_110*tmp_qloop_124;
                      const real_t q_tmp_0_3 = -tmp_qloop_110*tmp_qloop_138;
