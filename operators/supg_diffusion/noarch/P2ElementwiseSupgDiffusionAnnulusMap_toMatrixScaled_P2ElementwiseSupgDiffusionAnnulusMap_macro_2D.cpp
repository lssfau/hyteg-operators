             ...
             {
                {
                   ...
                   const real_t tmp_qloop_108 = 1.0 / (thermalConductivity*thermalConductivity)*tmp_moved_constant_25*tmp_qloop_92*tmp_qloop_94*tmp_qloop_96*1.0 / (tmp_qloop_98*tmp_qloop_98);
                   for (int64_t q = 0; q < 4; q += 1)
                   {
                      const real_t tmp_qloop_3 = p_affine_0_0 - tmp_qloop_0*_data_q_p_0[q] - tmp_qloop_2*_data_q_p_1[q];
                      const real_t tmp_qloop_5 = (tmp_qloop_3*tmp_qloop_3);
