             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 4; q += 1)
                   {
                      ...
                      const real_t tmp_qloop_77 = tmp_qloop_47 - tmp_qloop_69 + tmp_qloop_70*-4.0;
                      const real_t tmp_qloop_78 = tmp_qloop_69 + tmp_qloop_71 + tmp_qloop_74 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0;
                      const real_t tmp_qloop_79 = tmp_moved_constant_10*tmp_qloop_76 + tmp_moved_constant_11*tmp_qloop_77 + tmp_moved_constant_6*tmp_qloop_78 + tmp_moved_constant_7*tmp_qloop_72 + tmp_moved_constant_8*tmp_qloop_75 + tmp_moved_constant_9*tmp_qloop_69;
                      const real_t tmp_qloop_80 = tmp_moved_constant_12*tmp_qloop_78 + tmp_moved_constant_13*tmp_qloop_72 + tmp_moved_constant_14*tmp_qloop_75 + tmp_moved_constant_15*tmp_qloop_69 + tmp_moved_constant_16*tmp_qloop_76 + tmp_moved_constant_17*tmp_qloop_77;
                      const real_t tmp_qloop_86 = tmp_qloop_47 - 1.0;
                      ...
                      const real_t tmp_qloop_22 = 1.0 / (tmp_qloop_21);
                      const real_t abs_det_jac_blending = tmp_qloop_21;
                      const real_t tmp_qloop_81 = abs_det_jac_blending*(-tmp_moved_constant_0*tmp_qloop_78 - tmp_moved_constant_1*tmp_qloop_72 - tmp_moved_constant_2*tmp_qloop_75 - tmp_moved_constant_3*tmp_qloop_69 - tmp_moved_constant_4*tmp_qloop_76 - tmp_moved_constant_5*tmp_qloop_77)*_data_q_w[q]*_data_tabulated_and_untitled_0_0_BLUE[7*q + 1];
                      const real_t jac_blending_inv_0_0 = jac_blending_1_1*tmp_qloop_22;
                      const real_t jac_blending_inv_0_1 = -jac_blending_0_1*tmp_qloop_22;
                      const real_t jac_blending_inv_1_0 = -jac_blending_1_0*tmp_qloop_22;
                      const real_t jac_blending_inv_1_1 = jac_blending_0_0*tmp_qloop_22;
                      ...
                      const real_t tmp_qloop_66 = jac_blending_inv_0_0*tmp_qloop_64 + jac_blending_inv_0_1*tmp_qloop_65;
                      const real_t tmp_qloop_67 = jac_blending_inv_1_0*tmp_qloop_64 + jac_blending_inv_1_1*tmp_qloop_65;
                      const real_t tmp_qloop_68 = jac_blending_inv_0_0*(jac_blending_inv_0_0*tmp_moved_constant_21 + jac_blending_inv_1_0*tmp_moved_constant_25) + jac_blending_inv_0_0*(tmp_qloop_50*tmp_qloop_53 + tmp_qloop_54*tmp_qloop_55) + jac_blending_inv_0_1*(jac_blending_inv_0_1*tmp_moved_constant_21 + jac_blending_inv_1_1*tmp_moved_constant_25) + jac_blending_inv_0_1*(tmp_qloop_50*tmp_qloop_58 + tmp_qloop_54*tmp_qloop_59) + jac_blending_inv_1_0*(jac_blending_inv_0_0*tmp_moved_constant_26 + jac_blending_inv_1_0*tmp_moved_constant_27) + jac_blending_inv_1_0*(tmp_qloop_50*tmp_qloop_62 + tmp_qloop_54*tmp_qloop_63) + jac_blending_inv_1_1*(jac_blending_inv_0_1*tmp_moved_constant_26 + jac_blending_inv_1_1*tmp_moved_constant_27) + jac_blending_inv_1_1*(tmp_qloop_50*tmp_qloop_66 + tmp_qloop_54*tmp_qloop_67);
                      const real_t tmp_qloop_89 = jac_blending_inv_0_0*(jac_blending_inv_0_0*tmp_moved_constant_29 + jac_blending_inv_1_0*tmp_moved_constant_28) + jac_blending_inv_0_0*(tmp_qloop_53*tmp_qloop_87 + tmp_qloop_55*tmp_qloop_88) + jac_blending_inv_0_1*(jac_blending_inv_0_1*tmp_moved_constant_29 + jac_blending_inv_1_1*tmp_moved_constant_28) + jac_blending_inv_0_1*(tmp_qloop_58*tmp_qloop_87 + tmp_qloop_59*tmp_qloop_88) + jac_blending_inv_1_0*(jac_blending_inv_0_0*tmp_moved_constant_28 + jac_blending_inv_1_0*tmp_moved_constant_30) + jac_blending_inv_1_0*(tmp_qloop_62*tmp_qloop_87 + tmp_qloop_63*tmp_qloop_88) + jac_blending_inv_1_1*(jac_blending_inv_0_1*tmp_moved_constant_28 + jac_blending_inv_1_1*tmp_moved_constant_30) + jac_blending_inv_1_1*(tmp_qloop_66*tmp_qloop_87 + tmp_qloop_67*tmp_qloop_88);
                      const real_t tmp_qloop_96 = jac_blending_inv_0_0*(jac_blending_inv_0_0*tmp_moved_constant_32 + jac_blending_inv_1_0*tmp_moved_constant_31) + jac_blending_inv_0_0*(tmp_qloop_53*tmp_qloop_94 + tmp_qloop_55*tmp_qloop_95) + jac_blending_inv_0_1*(jac_blending_inv_0_1*tmp_moved_constant_32 + jac_blending_inv_1_1*tmp_moved_constant_31) + jac_blending_inv_0_1*(tmp_qloop_58*tmp_qloop_94 + tmp_qloop_59*tmp_qloop_95) + jac_blending_inv_1_0*(jac_blending_inv_0_0*tmp_moved_constant_31 + jac_blending_inv_1_0*tmp_moved_constant_33) + jac_blending_inv_1_0*(tmp_qloop_62*tmp_qloop_94 + tmp_qloop_63*tmp_qloop_95) + jac_blending_inv_1_1*(jac_blending_inv_0_1*tmp_moved_constant_31 + jac_blending_inv_1_1*tmp_moved_constant_33) + jac_blending_inv_1_1*(tmp_qloop_66*tmp_qloop_94 + tmp_qloop_67*tmp_qloop_95);
                      const real_t tmp_qloop_110 = jac_blending_inv_0_0*(jac_blending_inv_0_0*tmp_moved_constant_35 + jac_blending_inv_1_0*tmp_moved_constant_38) + jac_blending_inv_0_0*(tmp_qloop_106*tmp_qloop_53 + tmp_qloop_109*tmp_qloop_55) + jac_blending_inv_0_1*(jac_blending_inv_0_1*tmp_moved_constant_35 + jac_blending_inv_1_1*tmp_moved_constant_38) + jac_blending_inv_0_1*(tmp_qloop_106*tmp_qloop_58 + tmp_qloop_109*tmp_qloop_59) + jac_blending_inv_1_0*(jac_blending_inv_0_0*tmp_moved_constant_38 + jac_blending_inv_1_0*tmp_moved_constant_40) + jac_blending_inv_1_0*(tmp_qloop_106*tmp_qloop_62 + tmp_qloop_109*tmp_qloop_63) + jac_blending_inv_1_1*(jac_blending_inv_0_1*tmp_moved_constant_38 + jac_blending_inv_1_1*tmp_moved_constant_40) + jac_blending_inv_1_1*(tmp_qloop_106*tmp_qloop_66 + tmp_qloop_109*tmp_qloop_67);
                      const real_t tmp_qloop_122 = jac_blending_inv_0_0*(jac_blending_inv_0_0*tmp_moved_constant_43 + jac_blending_inv_1_0*tmp_moved_constant_45) + jac_blending_inv_0_0*(tmp_qloop_120*tmp_qloop_53 + tmp_qloop_121*tmp_qloop_55) + jac_blending_inv_0_1*(jac_blending_inv_0_1*tmp_moved_constant_43 + jac_blending_inv_1_1*tmp_moved_constant_45) + jac_blending_inv_0_1*(tmp_qloop_120*tmp_qloop_58 + tmp_qloop_121*tmp_qloop_59) + jac_blending_inv_1_0*(jac_blending_inv_0_0*tmp_moved_constant_46 + jac_blending_inv_1_0*tmp_moved_constant_48) + jac_blending_inv_1_0*(tmp_qloop_120*tmp_qloop_62 + tmp_qloop_121*tmp_qloop_63) + jac_blending_inv_1_1*(jac_blending_inv_0_1*tmp_moved_constant_46 + jac_blending_inv_1_1*tmp_moved_constant_48) + jac_blending_inv_1_1*(tmp_qloop_120*tmp_qloop_66 + tmp_qloop_121*tmp_qloop_67);
                      const real_t tmp_qloop_132 = jac_blending_inv_0_0*(jac_blending_inv_0_0*tmp_moved_constant_50 + jac_blending_inv_1_0*tmp_moved_constant_52) + jac_blending_inv_0_0*(tmp_qloop_130*tmp_qloop_53 + tmp_qloop_131*tmp_qloop_55) + jac_blending_inv_0_1*(jac_blending_inv_0_1*tmp_moved_constant_50 + jac_blending_inv_1_1*tmp_moved_constant_52) + jac_blending_inv_0_1*(tmp_qloop_130*tmp_qloop_58 + tmp_qloop_131*tmp_qloop_59) + jac_blending_inv_1_0*(jac_blending_inv_0_0*tmp_moved_constant_53 + jac_blending_inv_1_0*tmp_moved_constant_54) + jac_blending_inv_1_0*(tmp_qloop_130*tmp_qloop_62 + tmp_qloop_131*tmp_qloop_63) + jac_blending_inv_1_1*(jac_blending_inv_0_1*tmp_moved_constant_53 + jac_blending_inv_1_1*tmp_moved_constant_54) + jac_blending_inv_1_1*(tmp_qloop_130*tmp_qloop_66 + tmp_qloop_131*tmp_qloop_67);
                      const real_t q_tmp_0_0 = tmp_qloop_68*tmp_qloop_82;
                      const real_t q_tmp_0_1 = tmp_qloop_82*tmp_qloop_89;
                      const real_t q_tmp_0_2 = tmp_qloop_82*tmp_qloop_96;
                      const real_t q_tmp_0_3 = tmp_qloop_110*tmp_qloop_82;
