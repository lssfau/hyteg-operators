...
///     u: velocity function (vector space: Lagrange, degree: 2)
///     delta: coefficient (scalar space: Lagrange, degree: 2)
///
///     -∫ delta (∇ · ∇T) (u · ∇w)

class P2ElementwiseSupgDiffusionCoeffDelta : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                             public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgDiffusionCoeffDelta( const std::shared_ptr< PrimitiveStorage >& storage,
                                         size_t                                     minLevel,
                                         size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgDiffusionCoeffDelta
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    239     288      12       0      0              0                 0              1
   void applyScaled_P2ElementwiseSupgDiffusionCoeffDelta_macro_2D( real_t* RESTRICT _data_deltaEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    817     910      36       0      0              0                 0              1
   void applyScaled_P2ElementwiseSupgDiffusionCoeffDelta_macro_3D( real_t* RESTRICT _data_deltaEdge,
                                                                   real_t* RESTRICT _data_deltaVertex,
                                                                   real_t* RESTRICT _data_dstEdge,
                                                                   real_t* RESTRICT _data_dstVertex,
                                                                   real_t* RESTRICT _data_srcEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    203     282      12       0      0              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgDiffusionCoeffDelta_macro_2D( real_t* RESTRICT _data_deltaEdge,
                                                                      real_t* RESTRICT _data_deltaVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    717     900      36       0      0              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgDiffusionCoeffDelta_macro_3D( real_t* RESTRICT _data_deltaEdge,
                                                                      real_t* RESTRICT _data_deltaVertex,
                                                                      idx_t* RESTRICT  _data_dstEdge,
                                                                      idx_t* RESTRICT  _data_dstVertex,
                                                                      idx_t* RESTRICT  _data_srcEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    119     162      12       0      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgDiffusionCoeffDelta_macro_2D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    367     450      36       0      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgDiffusionCoeffDelta_macro_3D(
       real_t* RESTRICT _data_deltaEdge,
       real_t* RESTRICT _data_deltaVertex,
       real_t* RESTRICT _data_invDiag_Edge,
       real_t* RESTRICT _data_invDiag_Vertex,
