...
class P2ElementwiseSupgDiffusionCoeffDeltaAnnulusMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                       public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgDiffusionCoeffDeltaAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                   size_t                                     minLevel,
                                                   size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgDiffusionCoeffDeltaAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1140    1762      20      12      0              0                 0              1
   void applyScaled_P2ElementwiseSupgDiffusionCoeffDeltaAnnulusMap_macro_2D( real_t* RESTRICT _data_deltaEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1104    1756      20      12      0              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgDiffusionCoeffDeltaAnnulusMap_macro_2D( real_t* RESTRICT _data_deltaEdge,
                                                                                real_t* RESTRICT _data_deltaVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    990    1606      20      12      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgDiffusionCoeffDeltaAnnulusMap_macro_2D(
