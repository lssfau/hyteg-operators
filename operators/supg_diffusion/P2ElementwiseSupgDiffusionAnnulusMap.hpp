                                             ...
                                             public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1248    2066      64      44     28              0                 0              1
   void applyScaled_P2ElementwiseSupgDiffusionAnnulusMap_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1212    2060      64      44     28              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgDiffusionAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1098    1910      64      44     28              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgDiffusionAnnulusMap_macro_2D(
