...
void P2ElementwiseDiffusion::apply( const P2Function< walberla::float64 >& src,
...
std::shared_ptr< P2Function< walberla::float64 > > P2ElementwiseDiffusion::getInverseDiagonalValues() const
{
   return invDiag_;
}
