...
class P2ElementwiseDiffusionIcosahedralShellMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                  public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseDiffusionIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                              size_t                                     minLevel,
                                              size_t                                     maxLevel );
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1729    2408      42       5      0              0                 0              1
   void applyScaled_P2ElementwiseDiffusionIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1629    2353      42       5      0              0                 0              4
   void toMatrixScaled_P2ElementwiseDiffusionIcosahedralShellMap_macro_3D( idx_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1009    1408      42       5      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseDiffusionIcosahedralShellMap_macro_3D(
