...
void P1ElementwiseDiffusion::toMatrixScaled_P1ElementwiseDiffusion_macro_2D( idx_t * RESTRICT  _data_dst, idx_t * RESTRICT  _data_src, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t toMatrixScaling ) const
{
    {
       ...
       const real_t tmp_kernel_op_2 = abs_det_jac_affine_GRAY*toMatrixScaling*0.5;
       ...
       const real_t tmp_moved_constant_2 = abs_det_jac_affine_BLUE*toMatrixScaling*0.5;
