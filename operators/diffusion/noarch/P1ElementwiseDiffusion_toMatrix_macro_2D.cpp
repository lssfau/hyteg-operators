...
{
    {
       ...
       const walberla::float64 Dummy_1083 = -jac_affine_inv_0_0_GRAY - jac_affine_inv_1_0_GRAY;
       const walberla::float64 Dummy_1084 = -jac_affine_inv_0_1_GRAY - jac_affine_inv_1_1_GRAY;
       const walberla::float64 Dummy_1085 = abs_det_jac_affine_GRAY*0.50000000000000089;
       const walberla::float64 tmp_3 = Dummy_1085*(Dummy_1083*jac_affine_inv_0_0_GRAY + Dummy_1084*jac_affine_inv_0_1_GRAY);
       const walberla::float64 tmp_4 = Dummy_1085*(Dummy_1083*jac_affine_inv_1_0_GRAY + Dummy_1084*jac_affine_inv_1_1_GRAY);
       const walberla::float64 tmp_5 = Dummy_1085*(jac_affine_inv_0_0_GRAY*jac_affine_inv_1_0_GRAY + jac_affine_inv_0_1_GRAY*jac_affine_inv_1_1_GRAY);
       const walberla::float64 elMat_0_0 = Dummy_1085*((Dummy_1083*Dummy_1083) + (Dummy_1084*Dummy_1084));
       const walberla::float64 elMat_0_1 = tmp_3;
       const walberla::float64 elMat_0_2 = tmp_4;
       const walberla::float64 elMat_1_0 = tmp_3;
       const walberla::float64 elMat_1_1 = Dummy_1085*((jac_affine_inv_0_0_GRAY*jac_affine_inv_0_0_GRAY) + (jac_affine_inv_0_1_GRAY*jac_affine_inv_0_1_GRAY));
       const walberla::float64 elMat_1_2 = tmp_5;
       const walberla::float64 elMat_2_0 = tmp_4;
       const walberla::float64 elMat_2_1 = tmp_5;
       const walberla::float64 elMat_2_2 = Dummy_1085*((jac_affine_inv_1_0_GRAY*jac_affine_inv_1_0_GRAY) + (jac_affine_inv_1_1_GRAY*jac_affine_inv_1_1_GRAY));
       const walberla::float64 Dummy_1086 = -jac_affine_inv_0_0_BLUE - jac_affine_inv_1_0_BLUE;
       const walberla::float64 Dummy_1087 = -jac_affine_inv_0_1_BLUE - jac_affine_inv_1_1_BLUE;
       const walberla::float64 Dummy_1088 = abs_det_jac_affine_BLUE*0.50000000000000089;
       const walberla::float64 Dummy_1089 = Dummy_1088*(Dummy_1086*jac_affine_inv_0_0_BLUE + Dummy_1087*jac_affine_inv_0_1_BLUE);
       const walberla::float64 Dummy_1090 = Dummy_1088*(Dummy_1086*jac_affine_inv_1_0_BLUE + Dummy_1087*jac_affine_inv_1_1_BLUE);
       const walberla::float64 Dummy_1091 = Dummy_1088*(jac_affine_inv_0_0_BLUE*jac_affine_inv_1_0_BLUE + jac_affine_inv_0_1_BLUE*jac_affine_inv_1_1_BLUE);
       const walberla::float64 Dummy_1092 = Dummy_1088*((Dummy_1086*Dummy_1086) + (Dummy_1087*Dummy_1087));
       const walberla::float64 Dummy_1093 = Dummy_1089;
       const walberla::float64 Dummy_1094 = Dummy_1090;
       const walberla::float64 Dummy_1095 = Dummy_1089;
       const walberla::float64 Dummy_1096 = Dummy_1088*((jac_affine_inv_0_0_BLUE*jac_affine_inv_0_0_BLUE) + (jac_affine_inv_0_1_BLUE*jac_affine_inv_0_1_BLUE));
       const walberla::float64 Dummy_1097 = Dummy_1091;
       const walberla::float64 Dummy_1098 = Dummy_1090;
       const walberla::float64 Dummy_1099 = Dummy_1091;
       const walberla::float64 Dummy_1100 = Dummy_1088*((jac_affine_inv_1_0_BLUE*jac_affine_inv_1_0_BLUE) + (jac_affine_inv_1_1_BLUE*jac_affine_inv_1_1_BLUE));
       const walberla::float64 Dummy_1101 = -jac_affine_inv_0_0_GRAY - jac_affine_inv_1_0_GRAY;
       const walberla::float64 Dummy_1102 = -jac_affine_inv_0_1_GRAY - jac_affine_inv_1_1_GRAY;
       const walberla::float64 Dummy_1103 = abs_det_jac_affine_GRAY*0.50000000000000089;
       const walberla::float64 Dummy_1104 = Dummy_1103*(Dummy_1101*jac_affine_inv_0_0_GRAY + Dummy_1102*jac_affine_inv_0_1_GRAY);
       const walberla::float64 Dummy_1105 = Dummy_1103*(Dummy_1101*jac_affine_inv_1_0_GRAY + Dummy_1102*jac_affine_inv_1_1_GRAY);
       const walberla::float64 Dummy_1106 = Dummy_1103*(jac_affine_inv_0_0_GRAY*jac_affine_inv_1_0_GRAY + jac_affine_inv_0_1_GRAY*jac_affine_inv_1_1_GRAY);
       const walberla::float64 Dummy_1107 = Dummy_1103*((Dummy_1101*Dummy_1101) + (Dummy_1102*Dummy_1102));
       const walberla::float64 Dummy_1108 = Dummy_1104;
       const walberla::float64 Dummy_1109 = Dummy_1105;
       const walberla::float64 Dummy_1110 = Dummy_1104;
       const walberla::float64 Dummy_1111 = Dummy_1103*((jac_affine_inv_0_0_GRAY*jac_affine_inv_0_0_GRAY) + (jac_affine_inv_0_1_GRAY*jac_affine_inv_0_1_GRAY));
       const walberla::float64 Dummy_1112 = Dummy_1106;
       const walberla::float64 Dummy_1113 = Dummy_1105;
       const walberla::float64 Dummy_1114 = Dummy_1106;
       const walberla::float64 Dummy_1115 = Dummy_1103*((jac_affine_inv_1_0_GRAY*jac_affine_inv_1_0_GRAY) + (jac_affine_inv_1_1_GRAY*jac_affine_inv_1_1_GRAY));
             ...
             {
                {
                   ...
                   _data_mat[0] = ((walberla::float64)(Dummy_1092));
                   _data_mat[1] = ((walberla::float64)(Dummy_1093));
                   _data_mat[2] = ((walberla::float64)(Dummy_1094));
                   _data_mat[3] = ((walberla::float64)(Dummy_1095));
                   _data_mat[4] = ((walberla::float64)(Dummy_1096));
                   _data_mat[5] = ((walberla::float64)(Dummy_1097));
                   _data_mat[6] = ((walberla::float64)(Dummy_1098));
                   _data_mat[7] = ((walberla::float64)(Dummy_1099));
                   _data_mat[8] = ((walberla::float64)(Dummy_1100));
             ...
             {
                {
                   ...
                   _data_mat[0] = ((walberla::float64)(Dummy_1107));
                   _data_mat[1] = ((walberla::float64)(Dummy_1108));
                   _data_mat[2] = ((walberla::float64)(Dummy_1109));
                   _data_mat[3] = ((walberla::float64)(Dummy_1110));
                   _data_mat[4] = ((walberla::float64)(Dummy_1111));
                   _data_mat[5] = ((walberla::float64)(Dummy_1112));
                   _data_mat[6] = ((walberla::float64)(Dummy_1113));
                   _data_mat[7] = ((walberla::float64)(Dummy_1114));
                   _data_mat[8] = ((walberla::float64)(Dummy_1115));
