...
{
    {
       ...
       const real_t tmp_kernel_op_50 = -tmp_kernel_op_43 + 2.666666666666667;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             const real_t tmp_kernel_op_72 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_17*tmp_kernel_op_65 + tmp_kernel_op_19*tmp_kernel_op_64) + tmp_kernel_op_41*(tmp_kernel_op_38*tmp_kernel_op_68 + tmp_kernel_op_40*tmp_kernel_op_67) + tmp_kernel_op_62*(tmp_kernel_op_59*tmp_kernel_op_71 + tmp_kernel_op_61*tmp_kernel_op_70));
             ...
             const real_t tmp_kernel_op_82 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_17*tmp_kernel_op_74 + tmp_kernel_op_19*tmp_kernel_op_75) + tmp_kernel_op_41*(tmp_kernel_op_38*tmp_kernel_op_77 + tmp_kernel_op_40*tmp_kernel_op_78) + tmp_kernel_op_62*(tmp_kernel_op_59*tmp_kernel_op_80 + tmp_kernel_op_61*tmp_kernel_op_81));
             ...
             const real_t tmp_kernel_op_107 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_17*tmp_kernel_op_87 + tmp_kernel_op_19*tmp_kernel_op_90) + tmp_kernel_op_41*(tmp_kernel_op_38*tmp_kernel_op_95 + tmp_kernel_op_40*tmp_kernel_op_98) + tmp_kernel_op_62*(tmp_kernel_op_103*tmp_kernel_op_59 + tmp_kernel_op_106*tmp_kernel_op_61));
             ...
             const real_t tmp_kernel_op_114 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_108*tmp_kernel_op_17 + tmp_kernel_op_109*tmp_kernel_op_19) + tmp_kernel_op_41*(tmp_kernel_op_110*tmp_kernel_op_38 + tmp_kernel_op_111*tmp_kernel_op_40) + tmp_kernel_op_62*(tmp_kernel_op_112*tmp_kernel_op_59 + tmp_kernel_op_113*tmp_kernel_op_61));
             ...
             const real_t tmp_kernel_op_121 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_115*tmp_kernel_op_17 + tmp_kernel_op_116*tmp_kernel_op_19) + tmp_kernel_op_41*(tmp_kernel_op_117*tmp_kernel_op_38 + tmp_kernel_op_118*tmp_kernel_op_40) + tmp_kernel_op_62*(tmp_kernel_op_119*tmp_kernel_op_59 + tmp_kernel_op_120*tmp_kernel_op_61));
             ...
             const real_t tmp_kernel_op_131 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_10*tmp_kernel_op_128*tmp_kernel_op_18 + tmp_kernel_op_128*tmp_kernel_op_16*tmp_kernel_op_6) + tmp_kernel_op_41*(tmp_kernel_op_129*tmp_kernel_op_27*tmp_kernel_op_37 + tmp_kernel_op_129*tmp_kernel_op_31*tmp_kernel_op_39) + tmp_kernel_op_62*(tmp_kernel_op_130*tmp_kernel_op_48*tmp_kernel_op_58 + tmp_kernel_op_130*tmp_kernel_op_52*tmp_kernel_op_60));
             const real_t tmp_kernel_op_132 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_64*tmp_kernel_op_90 + tmp_kernel_op_65*tmp_kernel_op_87) + tmp_kernel_op_41*(tmp_kernel_op_67*tmp_kernel_op_98 + tmp_kernel_op_68*tmp_kernel_op_95) + tmp_kernel_op_62*(tmp_kernel_op_103*tmp_kernel_op_71 + tmp_kernel_op_106*tmp_kernel_op_70));
             const real_t tmp_kernel_op_133 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_108*tmp_kernel_op_65 + tmp_kernel_op_109*tmp_kernel_op_64) + tmp_kernel_op_41*(tmp_kernel_op_110*tmp_kernel_op_68 + tmp_kernel_op_111*tmp_kernel_op_67) + tmp_kernel_op_62*(tmp_kernel_op_112*tmp_kernel_op_71 + tmp_kernel_op_113*tmp_kernel_op_70));
             const real_t tmp_kernel_op_134 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_115*tmp_kernel_op_65 + tmp_kernel_op_116*tmp_kernel_op_64) + tmp_kernel_op_41*(tmp_kernel_op_117*tmp_kernel_op_68 + tmp_kernel_op_118*tmp_kernel_op_67) + tmp_kernel_op_62*(tmp_kernel_op_119*tmp_kernel_op_71 + tmp_kernel_op_120*tmp_kernel_op_70));
             ...
             const real_t tmp_kernel_op_138 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_74*tmp_kernel_op_87 + tmp_kernel_op_75*tmp_kernel_op_90) + tmp_kernel_op_41*(tmp_kernel_op_77*tmp_kernel_op_95 + tmp_kernel_op_78*tmp_kernel_op_98) + tmp_kernel_op_62*(tmp_kernel_op_103*tmp_kernel_op_80 + tmp_kernel_op_106*tmp_kernel_op_81));
             const real_t tmp_kernel_op_139 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_108*tmp_kernel_op_74 + tmp_kernel_op_109*tmp_kernel_op_75) + tmp_kernel_op_41*(tmp_kernel_op_110*tmp_kernel_op_77 + tmp_kernel_op_111*tmp_kernel_op_78) + tmp_kernel_op_62*(tmp_kernel_op_112*tmp_kernel_op_80 + tmp_kernel_op_113*tmp_kernel_op_81));
             const real_t tmp_kernel_op_140 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_115*tmp_kernel_op_74 + tmp_kernel_op_116*tmp_kernel_op_75) + tmp_kernel_op_41*(tmp_kernel_op_117*tmp_kernel_op_77 + tmp_kernel_op_118*tmp_kernel_op_78) + tmp_kernel_op_62*(tmp_kernel_op_119*tmp_kernel_op_80 + tmp_kernel_op_120*tmp_kernel_op_81));
             const real_t tmp_kernel_op_141 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_108*tmp_kernel_op_87 + tmp_kernel_op_109*tmp_kernel_op_90) + tmp_kernel_op_41*(tmp_kernel_op_110*tmp_kernel_op_95 + tmp_kernel_op_111*tmp_kernel_op_98) + tmp_kernel_op_62*(tmp_kernel_op_103*tmp_kernel_op_112 + tmp_kernel_op_106*tmp_kernel_op_113));
             const real_t tmp_kernel_op_142 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_115*tmp_kernel_op_87 + tmp_kernel_op_116*tmp_kernel_op_90) + tmp_kernel_op_41*(tmp_kernel_op_117*tmp_kernel_op_95 + tmp_kernel_op_118*tmp_kernel_op_98) + tmp_kernel_op_62*(tmp_kernel_op_103*tmp_kernel_op_119 + tmp_kernel_op_106*tmp_kernel_op_120));
             const real_t tmp_kernel_op_143 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_108*tmp_kernel_op_115 + tmp_kernel_op_109*tmp_kernel_op_116) + tmp_kernel_op_41*(tmp_kernel_op_110*tmp_kernel_op_117 + tmp_kernel_op_111*tmp_kernel_op_118) + tmp_kernel_op_62*(tmp_kernel_op_112*tmp_kernel_op_119 + tmp_kernel_op_113*tmp_kernel_op_120));
             const real_t elMat_0_0 = toMatrixScaling*(tmp_kernel_op_20*((tmp_kernel_op_17*tmp_kernel_op_17) + (tmp_kernel_op_19*tmp_kernel_op_19)) + tmp_kernel_op_41*((tmp_kernel_op_38*tmp_kernel_op_38) + (tmp_kernel_op_40*tmp_kernel_op_40)) + tmp_kernel_op_62*((tmp_kernel_op_59*tmp_kernel_op_59) + (tmp_kernel_op_61*tmp_kernel_op_61)));
             ...
             const real_t elMat_2_2 = toMatrixScaling*(tmp_kernel_op_20*(tmp_kernel_op_135*(tmp_kernel_op_18*tmp_kernel_op_18) + tmp_kernel_op_135*(tmp_kernel_op_6*tmp_kernel_op_6)) + tmp_kernel_op_41*(tmp_kernel_op_136*(tmp_kernel_op_27*tmp_kernel_op_27) + tmp_kernel_op_136*(tmp_kernel_op_39*tmp_kernel_op_39)) + tmp_kernel_op_62*(tmp_kernel_op_137*(tmp_kernel_op_48*tmp_kernel_op_48) + tmp_kernel_op_137*(tmp_kernel_op_60*tmp_kernel_op_60)));
             ...
             const real_t elMat_3_3 = toMatrixScaling*(tmp_kernel_op_20*((tmp_kernel_op_87*tmp_kernel_op_87) + (tmp_kernel_op_90*tmp_kernel_op_90)) + tmp_kernel_op_41*((tmp_kernel_op_95*tmp_kernel_op_95) + (tmp_kernel_op_98*tmp_kernel_op_98)) + tmp_kernel_op_62*((tmp_kernel_op_103*tmp_kernel_op_103) + (tmp_kernel_op_106*tmp_kernel_op_106)));
             ...
             const real_t elMat_4_4 = toMatrixScaling*(tmp_kernel_op_20*((tmp_kernel_op_108*tmp_kernel_op_108) + (tmp_kernel_op_109*tmp_kernel_op_109)) + tmp_kernel_op_41*((tmp_kernel_op_110*tmp_kernel_op_110) + (tmp_kernel_op_111*tmp_kernel_op_111)) + tmp_kernel_op_62*((tmp_kernel_op_112*tmp_kernel_op_112) + (tmp_kernel_op_113*tmp_kernel_op_113)));
