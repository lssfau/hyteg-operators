...
void P2ElementwiseDivKGradP1Coefficient::applyScaled_P2ElementwiseDivKGradP1Coefficient_macro_2D( real_t * RESTRICT  _data_dstEdge, real_t * RESTRICT  _data_dstVertex, real_t * RESTRICT  _data_k, real_t * RESTRICT  _data_srcEdge, real_t * RESTRICT  _data_srcVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling ) const
{
    {
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_5 = _mm256_mul_pd(_mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(k_dof_0,_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),_mm256_mul_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q]))),_mm256_set_pd(1.0,1.0,1.0,1.0))),_mm256_mul_pd(k_dof_1,_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q]))),_mm256_mul_pd(k_dof_2,_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q]))),_mm256_set_pd(_data_q_w[q],_data_q_w[q],_data_q_w[q],_data_q_w[q])),_mm256_set_pd(abs_det_jac_affine_GRAY,abs_det_jac_affine_GRAY,abs_det_jac_affine_GRAY,abs_det_jac_affine_GRAY));
                   const __m256d tmp_qloop_6 = _mm256_add_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),tmp_qloop_0);
                   const __m256d tmp_qloop_7 = _mm256_mul_pd(tmp_qloop_6,_mm256_set_pd(jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY));
                   const __m256d tmp_qloop_8 = _mm256_mul_pd(tmp_qloop_6,_mm256_set_pd(jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY));
                   const __m256d tmp_qloop_9 = _mm256_add_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),tmp_qloop_1);
                   const __m256d tmp_qloop_10 = _mm256_mul_pd(tmp_qloop_9,_mm256_set_pd(jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY));
                   const __m256d tmp_qloop_11 = _mm256_mul_pd(tmp_qloop_9,_mm256_set_pd(jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY));
                   const __m256d tmp_qloop_12 = _mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY));
                   const __m256d tmp_qloop_13 = _mm256_mul_pd(tmp_qloop_1,_mm256_set_pd(jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY));
                   const __m256d tmp_qloop_14 = _mm256_add_pd(tmp_qloop_12,tmp_qloop_13);
                   const __m256d tmp_qloop_15 = _mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY));
                   const __m256d tmp_qloop_16 = _mm256_mul_pd(tmp_qloop_1,_mm256_set_pd(jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY));
                   const __m256d tmp_qloop_17 = _mm256_add_pd(tmp_qloop_15,tmp_qloop_16);
                   const __m256d tmp_qloop_18 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-8.0,-8.0,-8.0,-8.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q])),_mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),_mm256_set_pd(4.0,4.0,4.0,4.0));
                   const __m256d tmp_qloop_19 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_13,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(tmp_qloop_18,_mm256_set_pd(jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY)));
                   const __m256d tmp_qloop_20 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_16,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(tmp_qloop_18,_mm256_set_pd(jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY)));
                   const __m256d tmp_qloop_21 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-8.0,-8.0,-8.0,-8.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),_mm256_mul_pd(tmp_qloop_1,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),_mm256_set_pd(4.0,4.0,4.0,4.0));
                   const __m256d tmp_qloop_22 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_12,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(tmp_qloop_21,_mm256_set_pd(jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY)));
                   const __m256d tmp_qloop_23 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_15,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(tmp_qloop_21,_mm256_set_pd(jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY)));
                   const __m256d tmp_qloop_24 = _mm256_mul_pd(tmp_qloop_6,tmp_qloop_6);
                   const __m256d tmp_qloop_25 = _mm256_mul_pd(tmp_qloop_9,tmp_qloop_9);
                   const __m256d q_tmp_0_0 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_3,tmp_qloop_3),_mm256_mul_pd(tmp_qloop_4,tmp_qloop_4)));
                   const __m256d q_tmp_0_1 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_3,tmp_qloop_7),_mm256_mul_pd(tmp_qloop_4,tmp_qloop_8)));
                   const __m256d q_tmp_0_2 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_10,tmp_qloop_3),_mm256_mul_pd(tmp_qloop_11,tmp_qloop_4)));
                   const __m256d q_tmp_0_3 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_14,tmp_qloop_3),_mm256_mul_pd(tmp_qloop_17,tmp_qloop_4)));
                   const __m256d q_tmp_0_4 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_19,tmp_qloop_3),_mm256_mul_pd(tmp_qloop_20,tmp_qloop_4)));
                   const __m256d q_tmp_0_5 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_22,tmp_qloop_3),_mm256_mul_pd(tmp_qloop_23,tmp_qloop_4)));
                   const __m256d q_tmp_1_1 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_24,_mm256_mul_pd(_mm256_set_pd(jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY),_mm256_set_pd(jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY,jac_affine_inv_0_0_GRAY))),_mm256_mul_pd(tmp_qloop_24,_mm256_mul_pd(_mm256_set_pd(jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY),_mm256_set_pd(jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY,jac_affine_inv_0_1_GRAY)))));
                   const __m256d q_tmp_1_2 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_10,tmp_qloop_7),_mm256_mul_pd(tmp_qloop_11,tmp_qloop_8)));
                   const __m256d q_tmp_1_3 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_14,tmp_qloop_7),_mm256_mul_pd(tmp_qloop_17,tmp_qloop_8)));
                   const __m256d q_tmp_1_4 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_19,tmp_qloop_7),_mm256_mul_pd(tmp_qloop_20,tmp_qloop_8)));
                   const __m256d q_tmp_1_5 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_22,tmp_qloop_7),_mm256_mul_pd(tmp_qloop_23,tmp_qloop_8)));
                   const __m256d q_tmp_2_2 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_25,_mm256_mul_pd(_mm256_set_pd(jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY),_mm256_set_pd(jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY,jac_affine_inv_1_0_GRAY))),_mm256_mul_pd(tmp_qloop_25,_mm256_mul_pd(_mm256_set_pd(jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY),_mm256_set_pd(jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY,jac_affine_inv_1_1_GRAY)))));
                   const __m256d q_tmp_2_3 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_10,tmp_qloop_14),_mm256_mul_pd(tmp_qloop_11,tmp_qloop_17)));
                   const __m256d q_tmp_2_4 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_10,tmp_qloop_19),_mm256_mul_pd(tmp_qloop_11,tmp_qloop_20)));
                   const __m256d q_tmp_2_5 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_10,tmp_qloop_22),_mm256_mul_pd(tmp_qloop_11,tmp_qloop_23)));
                   const __m256d q_tmp_3_3 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_14,tmp_qloop_14),_mm256_mul_pd(tmp_qloop_17,tmp_qloop_17)));
                   const __m256d q_tmp_3_4 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_14,tmp_qloop_19),_mm256_mul_pd(tmp_qloop_17,tmp_qloop_20)));
                   const __m256d q_tmp_3_5 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_14,tmp_qloop_22),_mm256_mul_pd(tmp_qloop_17,tmp_qloop_23)));
                   const __m256d q_tmp_4_4 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_19,tmp_qloop_19),_mm256_mul_pd(tmp_qloop_20,tmp_qloop_20)));
                   const __m256d q_tmp_4_5 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_19,tmp_qloop_22),_mm256_mul_pd(tmp_qloop_20,tmp_qloop_23)));
                   const __m256d q_tmp_5_5 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_22,tmp_qloop_22),_mm256_mul_pd(tmp_qloop_23,tmp_qloop_23)));
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const real_t tmp_qloop_5 = abs_det_jac_affine_GRAY*(k_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + k_dof_1*_data_q_p_0[q] + k_dof_2*_data_q_p_1[q])*_data_q_w[q];
                   const real_t tmp_qloop_6 = tmp_qloop_0 - 1.0;
                   const real_t tmp_qloop_7 = jac_affine_inv_0_0_GRAY*tmp_qloop_6;
                   const real_t tmp_qloop_8 = jac_affine_inv_0_1_GRAY*tmp_qloop_6;
                   const real_t tmp_qloop_9 = tmp_qloop_1 - 1.0;
                   const real_t tmp_qloop_10 = jac_affine_inv_1_0_GRAY*tmp_qloop_9;
                   const real_t tmp_qloop_11 = jac_affine_inv_1_1_GRAY*tmp_qloop_9;
                   const real_t tmp_qloop_12 = jac_affine_inv_1_0_GRAY*tmp_qloop_0;
                   const real_t tmp_qloop_13 = jac_affine_inv_0_0_GRAY*tmp_qloop_1;
                   const real_t tmp_qloop_14 = tmp_qloop_12 + tmp_qloop_13;
                   const real_t tmp_qloop_15 = jac_affine_inv_1_1_GRAY*tmp_qloop_0;
                   const real_t tmp_qloop_16 = jac_affine_inv_0_1_GRAY*tmp_qloop_1;
                   const real_t tmp_qloop_17 = tmp_qloop_15 + tmp_qloop_16;
                   const real_t tmp_qloop_18 = -tmp_qloop_0 - 8.0*_data_q_p_1[q] + 4.0;
                   const real_t tmp_qloop_19 = jac_affine_inv_1_0_GRAY*tmp_qloop_18 - tmp_qloop_13;
                   const real_t tmp_qloop_20 = jac_affine_inv_1_1_GRAY*tmp_qloop_18 - tmp_qloop_16;
                   const real_t tmp_qloop_21 = -tmp_qloop_1 - 8.0*_data_q_p_0[q] + 4.0;
                   const real_t tmp_qloop_22 = jac_affine_inv_0_0_GRAY*tmp_qloop_21 - tmp_qloop_12;
                   const real_t tmp_qloop_23 = jac_affine_inv_0_1_GRAY*tmp_qloop_21 - tmp_qloop_15;
                   const real_t tmp_qloop_24 = (tmp_qloop_6*tmp_qloop_6);
                   const real_t tmp_qloop_25 = (tmp_qloop_9*tmp_qloop_9);
                   const real_t q_tmp_0_0 = tmp_qloop_5*((tmp_qloop_3*tmp_qloop_3) + (tmp_qloop_4*tmp_qloop_4));
                   const real_t q_tmp_0_1 = tmp_qloop_5*(tmp_qloop_3*tmp_qloop_7 + tmp_qloop_4*tmp_qloop_8);
                   const real_t q_tmp_0_2 = tmp_qloop_5*(tmp_qloop_10*tmp_qloop_3 + tmp_qloop_11*tmp_qloop_4);
                   const real_t q_tmp_0_3 = tmp_qloop_5*(tmp_qloop_14*tmp_qloop_3 + tmp_qloop_17*tmp_qloop_4);
                   const real_t q_tmp_0_4 = tmp_qloop_5*(tmp_qloop_19*tmp_qloop_3 + tmp_qloop_20*tmp_qloop_4);
                   const real_t q_tmp_0_5 = tmp_qloop_5*(tmp_qloop_22*tmp_qloop_3 + tmp_qloop_23*tmp_qloop_4);
                   const real_t q_tmp_1_1 = tmp_qloop_5*((jac_affine_inv_0_0_GRAY*jac_affine_inv_0_0_GRAY)*tmp_qloop_24 + (jac_affine_inv_0_1_GRAY*jac_affine_inv_0_1_GRAY)*tmp_qloop_24);
                   const real_t q_tmp_1_2 = tmp_qloop_5*(tmp_qloop_10*tmp_qloop_7 + tmp_qloop_11*tmp_qloop_8);
                   const real_t q_tmp_1_3 = tmp_qloop_5*(tmp_qloop_14*tmp_qloop_7 + tmp_qloop_17*tmp_qloop_8);
                   const real_t q_tmp_1_4 = tmp_qloop_5*(tmp_qloop_19*tmp_qloop_7 + tmp_qloop_20*tmp_qloop_8);
                   const real_t q_tmp_1_5 = tmp_qloop_5*(tmp_qloop_22*tmp_qloop_7 + tmp_qloop_23*tmp_qloop_8);
                   const real_t q_tmp_2_2 = tmp_qloop_5*((jac_affine_inv_1_0_GRAY*jac_affine_inv_1_0_GRAY)*tmp_qloop_25 + (jac_affine_inv_1_1_GRAY*jac_affine_inv_1_1_GRAY)*tmp_qloop_25);
                   const real_t q_tmp_2_3 = tmp_qloop_5*(tmp_qloop_10*tmp_qloop_14 + tmp_qloop_11*tmp_qloop_17);
                   const real_t q_tmp_2_4 = tmp_qloop_5*(tmp_qloop_10*tmp_qloop_19 + tmp_qloop_11*tmp_qloop_20);
                   const real_t q_tmp_2_5 = tmp_qloop_5*(tmp_qloop_10*tmp_qloop_22 + tmp_qloop_11*tmp_qloop_23);
                   const real_t q_tmp_3_3 = tmp_qloop_5*((tmp_qloop_14*tmp_qloop_14) + (tmp_qloop_17*tmp_qloop_17));
                   const real_t q_tmp_3_4 = tmp_qloop_5*(tmp_qloop_14*tmp_qloop_19 + tmp_qloop_17*tmp_qloop_20);
                   const real_t q_tmp_3_5 = tmp_qloop_5*(tmp_qloop_14*tmp_qloop_22 + tmp_qloop_17*tmp_qloop_23);
                   const real_t q_tmp_4_4 = tmp_qloop_5*((tmp_qloop_19*tmp_qloop_19) + (tmp_qloop_20*tmp_qloop_20));
                   const real_t q_tmp_4_5 = tmp_qloop_5*(tmp_qloop_19*tmp_qloop_22 + tmp_qloop_20*tmp_qloop_23);
                   const real_t q_tmp_5_5 = tmp_qloop_5*((tmp_qloop_22*tmp_qloop_22) + (tmp_qloop_23*tmp_qloop_23));
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const __m256d tmp_qloop_6 = _mm256_add_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),tmp_qloop_0);
                   const __m256d tmp_qloop_7 = _mm256_mul_pd(tmp_qloop_6,_mm256_set_pd(jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE));
                   const __m256d tmp_qloop_8 = _mm256_mul_pd(tmp_qloop_6,_mm256_set_pd(jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE));
                   const __m256d tmp_qloop_9 = _mm256_add_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),tmp_qloop_1);
                   const __m256d tmp_qloop_10 = _mm256_mul_pd(tmp_qloop_9,_mm256_set_pd(jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE));
                   const __m256d tmp_qloop_11 = _mm256_mul_pd(tmp_qloop_9,_mm256_set_pd(jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE));
                   const __m256d tmp_qloop_12 = _mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE));
                   const __m256d tmp_qloop_13 = _mm256_mul_pd(tmp_qloop_1,_mm256_set_pd(jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE));
                   const __m256d tmp_qloop_14 = _mm256_add_pd(tmp_qloop_12,tmp_qloop_13);
                   const __m256d tmp_qloop_15 = _mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE));
                   const __m256d tmp_qloop_16 = _mm256_mul_pd(tmp_qloop_1,_mm256_set_pd(jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE));
                   const __m256d tmp_qloop_17 = _mm256_add_pd(tmp_qloop_15,tmp_qloop_16);
                   const __m256d tmp_qloop_18 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-8.0,-8.0,-8.0,-8.0),_mm256_set_pd(_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q],_data_q_p_1[q])),_mm256_mul_pd(tmp_qloop_0,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),_mm256_set_pd(4.0,4.0,4.0,4.0));
                   const __m256d tmp_qloop_19 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_13,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(tmp_qloop_18,_mm256_set_pd(jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE)));
                   const __m256d tmp_qloop_20 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_16,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(tmp_qloop_18,_mm256_set_pd(jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE)));
                   const __m256d tmp_qloop_21 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(_mm256_set_pd(-8.0,-8.0,-8.0,-8.0),_mm256_set_pd(_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q],_data_q_p_0[q])),_mm256_mul_pd(tmp_qloop_1,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),_mm256_set_pd(4.0,4.0,4.0,4.0));
                   const __m256d tmp_qloop_22 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_12,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(tmp_qloop_21,_mm256_set_pd(jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE)));
                   const __m256d tmp_qloop_23 = _mm256_add_pd(_mm256_mul_pd(tmp_qloop_15,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(tmp_qloop_21,_mm256_set_pd(jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE)));
                   const __m256d tmp_qloop_24 = _mm256_mul_pd(tmp_qloop_6,tmp_qloop_6);
                   const __m256d tmp_qloop_25 = _mm256_mul_pd(tmp_qloop_9,tmp_qloop_9);
                   const __m256d q_tmp_0_0 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_3,tmp_qloop_3),_mm256_mul_pd(tmp_qloop_4,tmp_qloop_4)));
                   const __m256d q_tmp_0_1 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_3,tmp_qloop_7),_mm256_mul_pd(tmp_qloop_4,tmp_qloop_8)));
                   ...
                   const __m256d q_tmp_0_4 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_19,tmp_qloop_3),_mm256_mul_pd(tmp_qloop_20,tmp_qloop_4)));
                   const __m256d q_tmp_0_5 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_22,tmp_qloop_3),_mm256_mul_pd(tmp_qloop_23,tmp_qloop_4)));
                   const __m256d q_tmp_1_1 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_24,_mm256_mul_pd(_mm256_set_pd(jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE),_mm256_set_pd(jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE,jac_affine_inv_0_0_BLUE))),_mm256_mul_pd(tmp_qloop_24,_mm256_mul_pd(_mm256_set_pd(jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE),_mm256_set_pd(jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE,jac_affine_inv_0_1_BLUE)))));
                   const __m256d q_tmp_1_2 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_10,tmp_qloop_7),_mm256_mul_pd(tmp_qloop_11,tmp_qloop_8)));
                   const __m256d q_tmp_1_3 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_14,tmp_qloop_7),_mm256_mul_pd(tmp_qloop_17,tmp_qloop_8)));
                   const __m256d q_tmp_1_4 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_19,tmp_qloop_7),_mm256_mul_pd(tmp_qloop_20,tmp_qloop_8)));
                   const __m256d q_tmp_1_5 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_22,tmp_qloop_7),_mm256_mul_pd(tmp_qloop_23,tmp_qloop_8)));
                   const __m256d q_tmp_2_2 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_25,_mm256_mul_pd(_mm256_set_pd(jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE),_mm256_set_pd(jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE,jac_affine_inv_1_0_BLUE))),_mm256_mul_pd(tmp_qloop_25,_mm256_mul_pd(_mm256_set_pd(jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE),_mm256_set_pd(jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE,jac_affine_inv_1_1_BLUE)))));
                   const __m256d q_tmp_2_3 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_10,tmp_qloop_14),_mm256_mul_pd(tmp_qloop_11,tmp_qloop_17)));
                   const __m256d q_tmp_2_4 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_10,tmp_qloop_19),_mm256_mul_pd(tmp_qloop_11,tmp_qloop_20)));
                   const __m256d q_tmp_2_5 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_10,tmp_qloop_22),_mm256_mul_pd(tmp_qloop_11,tmp_qloop_23)));
                   const __m256d q_tmp_3_3 = _mm256_mul_pd(tmp_qloop_5,_mm256_add_pd(_mm256_mul_pd(tmp_qloop_14,tmp_qloop_14),_mm256_mul_pd(tmp_qloop_17,tmp_qloop_17)));
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const real_t tmp_qloop_5 = abs_det_jac_affine_BLUE*(k_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + k_dof_1*_data_q_p_0[q] + k_dof_2*_data_q_p_1[q])*_data_q_w[q];
                   const real_t tmp_qloop_6 = tmp_qloop_0 - 1.0;
                   const real_t tmp_qloop_7 = jac_affine_inv_0_0_BLUE*tmp_qloop_6;
                   const real_t tmp_qloop_8 = jac_affine_inv_0_1_BLUE*tmp_qloop_6;
                   const real_t tmp_qloop_9 = tmp_qloop_1 - 1.0;
                   const real_t tmp_qloop_10 = jac_affine_inv_1_0_BLUE*tmp_qloop_9;
                   const real_t tmp_qloop_11 = jac_affine_inv_1_1_BLUE*tmp_qloop_9;
                   const real_t tmp_qloop_12 = jac_affine_inv_1_0_BLUE*tmp_qloop_0;
                   const real_t tmp_qloop_13 = jac_affine_inv_0_0_BLUE*tmp_qloop_1;
                   const real_t tmp_qloop_14 = tmp_qloop_12 + tmp_qloop_13;
                   const real_t tmp_qloop_15 = jac_affine_inv_1_1_BLUE*tmp_qloop_0;
                   const real_t tmp_qloop_16 = jac_affine_inv_0_1_BLUE*tmp_qloop_1;
                   const real_t tmp_qloop_17 = tmp_qloop_15 + tmp_qloop_16;
                   const real_t tmp_qloop_18 = -tmp_qloop_0 - 8.0*_data_q_p_1[q] + 4.0;
                   const real_t tmp_qloop_19 = jac_affine_inv_1_0_BLUE*tmp_qloop_18 - tmp_qloop_13;
                   const real_t tmp_qloop_20 = jac_affine_inv_1_1_BLUE*tmp_qloop_18 - tmp_qloop_16;
                   const real_t tmp_qloop_21 = -tmp_qloop_1 - 8.0*_data_q_p_0[q] + 4.0;
                   const real_t tmp_qloop_22 = jac_affine_inv_0_0_BLUE*tmp_qloop_21 - tmp_qloop_12;
                   const real_t tmp_qloop_23 = jac_affine_inv_0_1_BLUE*tmp_qloop_21 - tmp_qloop_15;
                   const real_t tmp_qloop_24 = (tmp_qloop_6*tmp_qloop_6);
                   const real_t tmp_qloop_25 = (tmp_qloop_9*tmp_qloop_9);
                   const real_t q_tmp_0_0 = tmp_qloop_5*((tmp_qloop_3*tmp_qloop_3) + (tmp_qloop_4*tmp_qloop_4));
                   const real_t q_tmp_0_1 = tmp_qloop_5*(tmp_qloop_3*tmp_qloop_7 + tmp_qloop_4*tmp_qloop_8);
                   ...
                   const real_t q_tmp_0_4 = tmp_qloop_5*(tmp_qloop_19*tmp_qloop_3 + tmp_qloop_20*tmp_qloop_4);
                   const real_t q_tmp_0_5 = tmp_qloop_5*(tmp_qloop_22*tmp_qloop_3 + tmp_qloop_23*tmp_qloop_4);
                   const real_t q_tmp_1_1 = tmp_qloop_5*((jac_affine_inv_0_0_BLUE*jac_affine_inv_0_0_BLUE)*tmp_qloop_24 + (jac_affine_inv_0_1_BLUE*jac_affine_inv_0_1_BLUE)*tmp_qloop_24);
                   const real_t q_tmp_1_2 = tmp_qloop_5*(tmp_qloop_10*tmp_qloop_7 + tmp_qloop_11*tmp_qloop_8);
                   const real_t q_tmp_1_3 = tmp_qloop_5*(tmp_qloop_14*tmp_qloop_7 + tmp_qloop_17*tmp_qloop_8);
                   const real_t q_tmp_1_4 = tmp_qloop_5*(tmp_qloop_19*tmp_qloop_7 + tmp_qloop_20*tmp_qloop_8);
                   const real_t q_tmp_1_5 = tmp_qloop_5*(tmp_qloop_22*tmp_qloop_7 + tmp_qloop_23*tmp_qloop_8);
                   const real_t q_tmp_2_2 = tmp_qloop_5*((jac_affine_inv_1_0_BLUE*jac_affine_inv_1_0_BLUE)*tmp_qloop_25 + (jac_affine_inv_1_1_BLUE*jac_affine_inv_1_1_BLUE)*tmp_qloop_25);
                   const real_t q_tmp_2_3 = tmp_qloop_5*(tmp_qloop_10*tmp_qloop_14 + tmp_qloop_11*tmp_qloop_17);
                   const real_t q_tmp_2_4 = tmp_qloop_5*(tmp_qloop_10*tmp_qloop_19 + tmp_qloop_11*tmp_qloop_20);
                   const real_t q_tmp_2_5 = tmp_qloop_5*(tmp_qloop_10*tmp_qloop_22 + tmp_qloop_11*tmp_qloop_23);
                   const real_t q_tmp_3_3 = tmp_qloop_5*((tmp_qloop_14*tmp_qloop_14) + (tmp_qloop_17*tmp_qloop_17));
