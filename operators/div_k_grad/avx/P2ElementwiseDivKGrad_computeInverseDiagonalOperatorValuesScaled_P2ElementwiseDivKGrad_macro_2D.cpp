          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const real_t tmp_qloop_8 = abs_det_jac_affine_GRAY*(k_dof_0*(tmp_qloop_3 + tmp_qloop_5 + tmp_qloop_7 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0) + k_dof_1*(tmp_qloop_5 - _data_q_p_0[q]) + k_dof_2*(tmp_qloop_7 - _data_q_p_1[q]) + k_dof_3*tmp_qloop_3 + k_dof_4*(tmp_qloop_1 - tmp_qloop_3 + tmp_qloop_6*-4.0) + k_dof_5*(tmp_qloop_0 - tmp_qloop_3 + tmp_qloop_4*-4.0))*_data_q_w[q];
                   const real_t tmp_qloop_9 = ((tmp_qloop_0 - 1.0)*(tmp_qloop_0 - 1.0));
                   const real_t tmp_qloop_10 = ((tmp_qloop_1 - 1.0)*(tmp_qloop_1 - 1.0));
                   const real_t tmp_qloop_11 = jac_affine_inv_1_0_GRAY*tmp_qloop_0;
                   const real_t tmp_qloop_12 = jac_affine_inv_0_0_GRAY*tmp_qloop_1;
                   const real_t tmp_qloop_13 = jac_affine_inv_1_1_GRAY*tmp_qloop_0;
                   const real_t tmp_qloop_14 = jac_affine_inv_0_1_GRAY*tmp_qloop_1;
                   const real_t tmp_qloop_15 = -tmp_qloop_0 - 8.0*_data_q_p_1[q] + 4.0;
                   const real_t tmp_qloop_16 = -tmp_qloop_1 - 8.0*_data_q_p_0[q] + 4.0;
                   const real_t q_tmp_0_0 = tmp_qloop_8*(((jac_affine_inv_0_0_GRAY*tmp_qloop_2 + jac_affine_inv_1_0_GRAY*tmp_qloop_2)*(jac_affine_inv_0_0_GRAY*tmp_qloop_2 + jac_affine_inv_1_0_GRAY*tmp_qloop_2)) + ((jac_affine_inv_0_1_GRAY*tmp_qloop_2 + jac_affine_inv_1_1_GRAY*tmp_qloop_2)*(jac_affine_inv_0_1_GRAY*tmp_qloop_2 + jac_affine_inv_1_1_GRAY*tmp_qloop_2)));
                   const real_t q_tmp_1_1 = tmp_qloop_8*((jac_affine_inv_0_0_GRAY*jac_affine_inv_0_0_GRAY)*tmp_qloop_9 + (jac_affine_inv_0_1_GRAY*jac_affine_inv_0_1_GRAY)*tmp_qloop_9);
                   const real_t q_tmp_2_2 = tmp_qloop_8*((jac_affine_inv_1_0_GRAY*jac_affine_inv_1_0_GRAY)*tmp_qloop_10 + (jac_affine_inv_1_1_GRAY*jac_affine_inv_1_1_GRAY)*tmp_qloop_10);
                   const real_t q_tmp_3_3 = tmp_qloop_8*(((tmp_qloop_11 + tmp_qloop_12)*(tmp_qloop_11 + tmp_qloop_12)) + ((tmp_qloop_13 + tmp_qloop_14)*(tmp_qloop_13 + tmp_qloop_14)));
                   const real_t q_tmp_4_4 = tmp_qloop_8*(((jac_affine_inv_1_0_GRAY*tmp_qloop_15 - tmp_qloop_12)*(jac_affine_inv_1_0_GRAY*tmp_qloop_15 - tmp_qloop_12)) + ((jac_affine_inv_1_1_GRAY*tmp_qloop_15 - tmp_qloop_14)*(jac_affine_inv_1_1_GRAY*tmp_qloop_15 - tmp_qloop_14)));
                   const real_t q_tmp_5_5 = tmp_qloop_8*(((jac_affine_inv_0_0_GRAY*tmp_qloop_16 - tmp_qloop_11)*(jac_affine_inv_0_0_GRAY*tmp_qloop_16 - tmp_qloop_11)) + ((jac_affine_inv_0_1_GRAY*tmp_qloop_16 - tmp_qloop_13)*(jac_affine_inv_0_1_GRAY*tmp_qloop_16 - tmp_qloop_13)));
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const real_t tmp_qloop_6 = (_data_q_p_1[q]*_data_q_p_1[q]);
                   const real_t tmp_qloop_7 = tmp_qloop_6*2.0;
                   const real_t tmp_qloop_8 = abs_det_jac_affine_BLUE*(k_dof_0*(tmp_qloop_3 + tmp_qloop_5 + tmp_qloop_7 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0) + k_dof_1*(tmp_qloop_5 - _data_q_p_0[q]) + k_dof_2*(tmp_qloop_7 - _data_q_p_1[q]) + k_dof_3*tmp_qloop_3 + k_dof_4*(tmp_qloop_1 - tmp_qloop_3 + tmp_qloop_6*-4.0) + k_dof_5*(tmp_qloop_0 - tmp_qloop_3 + tmp_qloop_4*-4.0))*_data_q_w[q];
                   const real_t tmp_qloop_9 = ((tmp_qloop_0 - 1.0)*(tmp_qloop_0 - 1.0));
                   const real_t tmp_qloop_10 = ((tmp_qloop_1 - 1.0)*(tmp_qloop_1 - 1.0));
                   const real_t tmp_qloop_11 = jac_affine_inv_1_0_BLUE*tmp_qloop_0;
                   const real_t tmp_qloop_12 = jac_affine_inv_0_0_BLUE*tmp_qloop_1;
                   const real_t tmp_qloop_13 = jac_affine_inv_1_1_BLUE*tmp_qloop_0;
                   const real_t tmp_qloop_14 = jac_affine_inv_0_1_BLUE*tmp_qloop_1;
                   const real_t tmp_qloop_15 = -tmp_qloop_0 - 8.0*_data_q_p_1[q] + 4.0;
                   const real_t tmp_qloop_16 = -tmp_qloop_1 - 8.0*_data_q_p_0[q] + 4.0;
                   const real_t q_tmp_0_0 = tmp_qloop_8*(((jac_affine_inv_0_0_BLUE*tmp_qloop_2 + jac_affine_inv_1_0_BLUE*tmp_qloop_2)*(jac_affine_inv_0_0_BLUE*tmp_qloop_2 + jac_affine_inv_1_0_BLUE*tmp_qloop_2)) + ((jac_affine_inv_0_1_BLUE*tmp_qloop_2 + jac_affine_inv_1_1_BLUE*tmp_qloop_2)*(jac_affine_inv_0_1_BLUE*tmp_qloop_2 + jac_affine_inv_1_1_BLUE*tmp_qloop_2)));
                   const real_t q_tmp_1_1 = tmp_qloop_8*((jac_affine_inv_0_0_BLUE*jac_affine_inv_0_0_BLUE)*tmp_qloop_9 + (jac_affine_inv_0_1_BLUE*jac_affine_inv_0_1_BLUE)*tmp_qloop_9);
                   const real_t q_tmp_2_2 = tmp_qloop_8*((jac_affine_inv_1_0_BLUE*jac_affine_inv_1_0_BLUE)*tmp_qloop_10 + (jac_affine_inv_1_1_BLUE*jac_affine_inv_1_1_BLUE)*tmp_qloop_10);
                   const real_t q_tmp_3_3 = tmp_qloop_8*(((tmp_qloop_11 + tmp_qloop_12)*(tmp_qloop_11 + tmp_qloop_12)) + ((tmp_qloop_13 + tmp_qloop_14)*(tmp_qloop_13 + tmp_qloop_14)));
                   const real_t q_tmp_4_4 = tmp_qloop_8*(((jac_affine_inv_1_0_BLUE*tmp_qloop_15 - tmp_qloop_12)*(jac_affine_inv_1_0_BLUE*tmp_qloop_15 - tmp_qloop_12)) + ((jac_affine_inv_1_1_BLUE*tmp_qloop_15 - tmp_qloop_14)*(jac_affine_inv_1_1_BLUE*tmp_qloop_15 - tmp_qloop_14)));
                   const real_t q_tmp_5_5 = tmp_qloop_8*(((jac_affine_inv_0_0_BLUE*tmp_qloop_16 - tmp_qloop_11)*(jac_affine_inv_0_0_BLUE*tmp_qloop_16 - tmp_qloop_11)) + ((jac_affine_inv_0_1_BLUE*tmp_qloop_16 - tmp_qloop_13)*(jac_affine_inv_0_1_BLUE*tmp_qloop_16 - tmp_qloop_13)));
                   q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                   q_acc_1_1 = q_acc_1_1 + q_tmp_1_1;
                   q_acc_2_2 = q_acc_2_2 + q_tmp_2_2;
                   q_acc_3_3 = q_acc_3_3 + q_tmp_3_3;
