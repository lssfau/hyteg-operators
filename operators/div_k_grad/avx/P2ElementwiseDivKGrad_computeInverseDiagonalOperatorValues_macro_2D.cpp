          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const walberla::float64 tmp_q_3 = tmp_q_0*_data_q_p_1[q];
                   const walberla::float64 tmp_q_4 = (_data_q_p_0[q]*_data_q_p_0[q]);
                   const walberla::float64 tmp_q_5 = tmp_q_4*2.0;
                   const walberla::float64 tmp_q_6 = (_data_q_p_1[q]*_data_q_p_1[q]);
                   const walberla::float64 tmp_q_7 = tmp_q_6*2.0;
                   const walberla::float64 tmp_q_8 = abs_det_jac_affine_GRAY*(k_dof_0*(tmp_q_3 + tmp_q_5 + tmp_q_7 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0) + k_dof_1*(tmp_q_5 - _data_q_p_0[q]) + k_dof_2*(tmp_q_7 - _data_q_p_1[q]) + k_dof_3*tmp_q_3 + k_dof_4*(tmp_q_1 - tmp_q_3 + tmp_q_6*-4.0) + k_dof_5*(tmp_q_0 - tmp_q_3 + tmp_q_4*-4.0))*_data_q_w[q];
                   const walberla::float64 tmp_q_9 = ((tmp_q_0 - 1.0)*(tmp_q_0 - 1.0));
                   const walberla::float64 tmp_q_10 = ((tmp_q_1 - 1.0)*(tmp_q_1 - 1.0));
                   const walberla::float64 tmp_q_11 = jac_affine_inv_1_0_GRAY*tmp_q_0;
                   const walberla::float64 tmp_q_12 = jac_affine_inv_0_0_GRAY*tmp_q_1;
                   const walberla::float64 tmp_q_13 = jac_affine_inv_1_1_GRAY*tmp_q_0;
                   const walberla::float64 tmp_q_14 = jac_affine_inv_0_1_GRAY*tmp_q_1;
                   const walberla::float64 tmp_q_15 = -tmp_q_0 - 8.0*_data_q_p_1[q] + 4.0;
                   const walberla::float64 tmp_q_16 = -tmp_q_1 - 8.0*_data_q_p_0[q] + 4.0;
                   const walberla::float64 q_tmp_0_0 = tmp_q_8*(((jac_affine_inv_0_0_GRAY*tmp_q_2 + jac_affine_inv_1_0_GRAY*tmp_q_2)*(jac_affine_inv_0_0_GRAY*tmp_q_2 + jac_affine_inv_1_0_GRAY*tmp_q_2)) + ((jac_affine_inv_0_1_GRAY*tmp_q_2 + jac_affine_inv_1_1_GRAY*tmp_q_2)*(jac_affine_inv_0_1_GRAY*tmp_q_2 + jac_affine_inv_1_1_GRAY*tmp_q_2)));
                   const walberla::float64 q_tmp_1_1 = tmp_q_8*((jac_affine_inv_0_0_GRAY*jac_affine_inv_0_0_GRAY)*tmp_q_9 + (jac_affine_inv_0_1_GRAY*jac_affine_inv_0_1_GRAY)*tmp_q_9);
                   const walberla::float64 q_tmp_2_2 = tmp_q_8*((jac_affine_inv_1_0_GRAY*jac_affine_inv_1_0_GRAY)*tmp_q_10 + (jac_affine_inv_1_1_GRAY*jac_affine_inv_1_1_GRAY)*tmp_q_10);
                   const walberla::float64 q_tmp_3_3 = tmp_q_8*(((tmp_q_11 + tmp_q_12)*(tmp_q_11 + tmp_q_12)) + ((tmp_q_13 + tmp_q_14)*(tmp_q_13 + tmp_q_14)));
                   const walberla::float64 q_tmp_4_4 = tmp_q_8*(((jac_affine_inv_1_0_GRAY*tmp_q_15 - tmp_q_12)*(jac_affine_inv_1_0_GRAY*tmp_q_15 - tmp_q_12)) + ((jac_affine_inv_1_1_GRAY*tmp_q_15 - tmp_q_14)*(jac_affine_inv_1_1_GRAY*tmp_q_15 - tmp_q_14)));
                   const walberla::float64 q_tmp_5_5 = tmp_q_8*(((jac_affine_inv_0_0_GRAY*tmp_q_16 - tmp_q_11)*(jac_affine_inv_0_0_GRAY*tmp_q_16 - tmp_q_11)) + ((jac_affine_inv_0_1_GRAY*tmp_q_16 - tmp_q_13)*(jac_affine_inv_0_1_GRAY*tmp_q_16 - tmp_q_13)));
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const walberla::float64 tmp_q_6 = (_data_q_p_1[q]*_data_q_p_1[q]);
                   const walberla::float64 tmp_q_7 = tmp_q_6*2.0;
                   const walberla::float64 tmp_q_8 = abs_det_jac_affine_BLUE*(k_dof_0*(tmp_q_3 + tmp_q_5 + tmp_q_7 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0) + k_dof_1*(tmp_q_5 - _data_q_p_0[q]) + k_dof_2*(tmp_q_7 - _data_q_p_1[q]) + k_dof_3*tmp_q_3 + k_dof_4*(tmp_q_1 - tmp_q_3 + tmp_q_6*-4.0) + k_dof_5*(tmp_q_0 - tmp_q_3 + tmp_q_4*-4.0))*_data_q_w[q];
                   const walberla::float64 tmp_q_9 = ((tmp_q_0 - 1.0)*(tmp_q_0 - 1.0));
                   const walberla::float64 tmp_q_10 = ((tmp_q_1 - 1.0)*(tmp_q_1 - 1.0));
                   const walberla::float64 tmp_q_11 = jac_affine_inv_1_0_BLUE*tmp_q_0;
                   const walberla::float64 tmp_q_12 = jac_affine_inv_0_0_BLUE*tmp_q_1;
                   const walberla::float64 tmp_q_13 = jac_affine_inv_1_1_BLUE*tmp_q_0;
                   const walberla::float64 tmp_q_14 = jac_affine_inv_0_1_BLUE*tmp_q_1;
                   const walberla::float64 tmp_q_15 = -tmp_q_0 - 8.0*_data_q_p_1[q] + 4.0;
                   const walberla::float64 tmp_q_16 = -tmp_q_1 - 8.0*_data_q_p_0[q] + 4.0;
                   const walberla::float64 q_tmp_0_0 = tmp_q_8*(((jac_affine_inv_0_0_BLUE*tmp_q_2 + jac_affine_inv_1_0_BLUE*tmp_q_2)*(jac_affine_inv_0_0_BLUE*tmp_q_2 + jac_affine_inv_1_0_BLUE*tmp_q_2)) + ((jac_affine_inv_0_1_BLUE*tmp_q_2 + jac_affine_inv_1_1_BLUE*tmp_q_2)*(jac_affine_inv_0_1_BLUE*tmp_q_2 + jac_affine_inv_1_1_BLUE*tmp_q_2)));
                   const walberla::float64 q_tmp_1_1 = tmp_q_8*((jac_affine_inv_0_0_BLUE*jac_affine_inv_0_0_BLUE)*tmp_q_9 + (jac_affine_inv_0_1_BLUE*jac_affine_inv_0_1_BLUE)*tmp_q_9);
                   const walberla::float64 q_tmp_2_2 = tmp_q_8*((jac_affine_inv_1_0_BLUE*jac_affine_inv_1_0_BLUE)*tmp_q_10 + (jac_affine_inv_1_1_BLUE*jac_affine_inv_1_1_BLUE)*tmp_q_10);
                   const walberla::float64 q_tmp_3_3 = tmp_q_8*(((tmp_q_11 + tmp_q_12)*(tmp_q_11 + tmp_q_12)) + ((tmp_q_13 + tmp_q_14)*(tmp_q_13 + tmp_q_14)));
                   const walberla::float64 q_tmp_4_4 = tmp_q_8*(((jac_affine_inv_1_0_BLUE*tmp_q_15 - tmp_q_12)*(jac_affine_inv_1_0_BLUE*tmp_q_15 - tmp_q_12)) + ((jac_affine_inv_1_1_BLUE*tmp_q_15 - tmp_q_14)*(jac_affine_inv_1_1_BLUE*tmp_q_15 - tmp_q_14)));
                   const walberla::float64 q_tmp_5_5 = tmp_q_8*(((jac_affine_inv_0_0_BLUE*tmp_q_16 - tmp_q_11)*(jac_affine_inv_0_0_BLUE*tmp_q_16 - tmp_q_11)) + ((jac_affine_inv_0_1_BLUE*tmp_q_16 - tmp_q_13)*(jac_affine_inv_0_1_BLUE*tmp_q_16 - tmp_q_13)));
                   q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                   q_acc_1_1 = q_acc_1_1 + q_tmp_1_1;
                   q_acc_2_2 = q_acc_2_2 + q_tmp_2_2;
                   q_acc_3_3 = q_acc_3_3 + q_tmp_3_3;
