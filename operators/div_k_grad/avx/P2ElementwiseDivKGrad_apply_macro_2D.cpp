...
{
    {
       ...
       const real_t Dummy_4001 = macro_vertex_coord_id_0comp0 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_1comp0)*1.0;
       const real_t Dummy_4002 = macro_vertex_coord_id_0comp1 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_1comp1)*1.0;
       const real_t Dummy_4003 = macro_vertex_coord_id_0comp0 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_2comp0)*1.0;
       const real_t Dummy_4004 = macro_vertex_coord_id_0comp1 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1)*1.0;
       const real_t Dummy_4005 = macro_vertex_coord_id_0comp0 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_1comp0)*1.0 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_2comp0)*1.0;
       const real_t Dummy_4006 = macro_vertex_coord_id_0comp1 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_1comp1)*1.0 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1)*1.0;
       const real_t Dummy_4007 = -Dummy_4001 + Dummy_4003;
       const real_t Dummy_4008 = -Dummy_4001 + Dummy_4005;
       const real_t Dummy_4009 = -Dummy_4002 + Dummy_4004;
       const real_t Dummy_4010 = -Dummy_4002 + Dummy_4006;
       const real_t Dummy_4011 = Dummy_4010*1.0 / (Dummy_4007*Dummy_4010 - Dummy_4008*Dummy_4009);
       const real_t Dummy_4012 = -Dummy_4008*1.0 / (Dummy_4007*Dummy_4010 - Dummy_4008*Dummy_4009);
       const real_t Dummy_4013 = -Dummy_4009*1.0 / (Dummy_4007*Dummy_4010 - Dummy_4008*Dummy_4009);
       const real_t Dummy_4014 = Dummy_4007*1.0 / (Dummy_4007*Dummy_4010 - Dummy_4008*Dummy_4009);
       const real_t Dummy_4015 = abs(Dummy_4007*Dummy_4010 - Dummy_4008*Dummy_4009);
       {
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const real_t tmp_q_15 = abs_det_jac_affine*_data_q_w[q];
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const real_t tmp_q_5 = tmp_q_3 + tmp_q_4;
                   const real_t tmp_q_6 = tmp_q_0*_data_q_p_1[q];
                   const real_t tmp_q_7 = (_data_q_p_0[q]*_data_q_p_0[q]);
                   const real_t tmp_q_8 = tmp_q_7*2.0;
                   const real_t tmp_q_9 = (_data_q_p_1[q]*_data_q_p_1[q]);
                   const real_t tmp_q_10 = tmp_q_9*2.0;
                   const real_t tmp_q_11 = k_dof_0*(tmp_q_10 + tmp_q_6 + tmp_q_8 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0) + k_dof_1*(tmp_q_8 - _data_q_p_0[q]) + k_dof_2*(tmp_q_10 - _data_q_p_1[q]) + k_dof_3*tmp_q_6 + k_dof_4*(tmp_q_1 - tmp_q_6 + tmp_q_9*-4.0) + k_dof_5*(tmp_q_0 - tmp_q_6 + tmp_q_7*-4.0);
                   const real_t tmp_q_12 = jac_affine_inv_0_1*tmp_q_2;
                   const real_t tmp_q_13 = jac_affine_inv_1_1*tmp_q_2;
                   const real_t tmp_q_14 = tmp_q_12 + tmp_q_13;
                   const real_t tmp_q_15 = abs_det_jac_affine*_data_q_w[q];
                   const real_t tmp_q_16 = tmp_q_0 - 1.0;
                   const real_t tmp_q_17 = jac_affine_inv_0_0*tmp_q_16;
                   const real_t tmp_q_18 = tmp_q_11*tmp_q_5;
                   const real_t tmp_q_19 = jac_affine_inv_0_1*tmp_q_16;
                   const real_t tmp_q_20 = tmp_q_11*tmp_q_14;
                   const real_t tmp_q_21 = tmp_q_1 - 1.0;
                   const real_t tmp_q_22 = jac_affine_inv_1_0*tmp_q_21;
                   const real_t tmp_q_23 = jac_affine_inv_1_1*tmp_q_21;
                   const real_t tmp_q_24 = jac_affine_inv_0_0*tmp_q_1;
                   const real_t tmp_q_25 = tmp_q_11*tmp_q_24;
                   const real_t tmp_q_26 = jac_affine_inv_1_0*tmp_q_0;
                   const real_t tmp_q_27 = tmp_q_11*tmp_q_26;
                   const real_t tmp_q_28 = tmp_q_25 + tmp_q_27;
                   const real_t tmp_q_29 = jac_affine_inv_0_1*tmp_q_1;
                   const real_t tmp_q_30 = tmp_q_11*tmp_q_29;
                   const real_t tmp_q_31 = jac_affine_inv_1_1*tmp_q_0;
                   const real_t tmp_q_32 = tmp_q_11*tmp_q_31;
                   const real_t tmp_q_33 = tmp_q_30 + tmp_q_32;
                   const real_t tmp_q_34 = -tmp_q_0 - 8.0*_data_q_p_1[q] + 4.0;
                   const real_t tmp_q_35 = jac_affine_inv_1_0*tmp_q_11*tmp_q_34 - tmp_q_25;
                   const real_t tmp_q_36 = jac_affine_inv_1_1*tmp_q_11*tmp_q_34 - tmp_q_30;
                   const real_t tmp_q_37 = -tmp_q_1 - 8.0*_data_q_p_0[q] + 4.0;
                   const real_t tmp_q_38 = jac_affine_inv_0_0*tmp_q_37;
                   const real_t tmp_q_39 = tmp_q_11*tmp_q_38 - tmp_q_27;
                   const real_t tmp_q_40 = jac_affine_inv_0_1*tmp_q_37;
                   const real_t tmp_q_41 = tmp_q_11*tmp_q_40 - tmp_q_32;
                   const real_t tmp_q_42 = tmp_q_11*(tmp_q_16*tmp_q_16);
                   const real_t tmp_q_43 = tmp_q_11*(tmp_q_21*tmp_q_21);
                   const real_t tmp_q_44 = tmp_q_24 + tmp_q_26;
                   const real_t tmp_q_45 = tmp_q_29 + tmp_q_31;
                   const real_t tmp_q_46 = jac_affine_inv_1_0*tmp_q_34 - tmp_q_24;
                   const real_t tmp_q_47 = jac_affine_inv_1_1*tmp_q_34 - tmp_q_29;
                   const real_t res_tmp_0_0 = tmp_q_15*(tmp_q_14*(tmp_q_11*tmp_q_12 + tmp_q_11*tmp_q_13) + tmp_q_5*(tmp_q_11*tmp_q_3 + tmp_q_11*tmp_q_4));
                   const real_t res_tmp_0_1 = tmp_q_15*(tmp_q_17*tmp_q_18 + tmp_q_19*tmp_q_20);
                   const real_t res_tmp_0_2 = tmp_q_15*(tmp_q_18*tmp_q_22 + tmp_q_20*tmp_q_23);
                   const real_t res_tmp_0_3 = tmp_q_15*(tmp_q_14*tmp_q_33 + tmp_q_28*tmp_q_5);
                   const real_t res_tmp_0_4 = tmp_q_15*(tmp_q_14*tmp_q_36 + tmp_q_35*tmp_q_5);
                   const real_t res_tmp_0_5 = tmp_q_15*(tmp_q_14*tmp_q_41 + tmp_q_39*tmp_q_5);
                   const real_t res_tmp_1_1 = tmp_q_15*((jac_affine_inv_0_0*jac_affine_inv_0_0)*tmp_q_42 + (jac_affine_inv_0_1*jac_affine_inv_0_1)*tmp_q_42);
                   const real_t res_tmp_1_2 = tmp_q_15*(tmp_q_11*tmp_q_17*tmp_q_22 + tmp_q_11*tmp_q_19*tmp_q_23);
                   const real_t res_tmp_1_3 = tmp_q_15*(tmp_q_17*tmp_q_28 + tmp_q_19*tmp_q_33);
                   const real_t res_tmp_1_4 = tmp_q_15*(tmp_q_17*tmp_q_35 + tmp_q_19*tmp_q_36);
                   const real_t res_tmp_1_5 = tmp_q_15*(tmp_q_17*tmp_q_39 + tmp_q_19*tmp_q_41);
                   const real_t res_tmp_2_2 = tmp_q_15*((jac_affine_inv_1_0*jac_affine_inv_1_0)*tmp_q_43 + (jac_affine_inv_1_1*jac_affine_inv_1_1)*tmp_q_43);
                   const real_t res_tmp_2_3 = tmp_q_15*(tmp_q_22*tmp_q_28 + tmp_q_23*tmp_q_33);
                   const real_t res_tmp_2_4 = tmp_q_15*(tmp_q_22*tmp_q_35 + tmp_q_23*tmp_q_36);
                   const real_t res_tmp_2_5 = tmp_q_15*(tmp_q_22*tmp_q_39 + tmp_q_23*tmp_q_41);
                   const real_t res_tmp_3_3 = tmp_q_15*(tmp_q_28*tmp_q_44 + tmp_q_33*tmp_q_45);
                   const real_t res_tmp_3_4 = tmp_q_15*(tmp_q_35*tmp_q_44 + tmp_q_36*tmp_q_45);
                   const real_t res_tmp_3_5 = tmp_q_15*(tmp_q_39*tmp_q_44 + tmp_q_41*tmp_q_45);
                   const real_t res_tmp_4_4 = tmp_q_15*(tmp_q_35*tmp_q_46 + tmp_q_36*tmp_q_47);
                   const real_t res_tmp_4_5 = tmp_q_15*(tmp_q_39*tmp_q_46 + tmp_q_41*tmp_q_47);
                   const real_t res_tmp_5_5 = tmp_q_15*(tmp_q_39*(-tmp_q_26 + tmp_q_38) + tmp_q_41*(-tmp_q_31 + tmp_q_40));
          ...
          for (int64_t ctr_1 = 0; ctr_1 < micro_edges_per_macro_edge; ctr_1 += 1)
          {
             for (int64_t ctr_0 = 0; ctr_0 < (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 += 4)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const __m256d tmp_q_14 = _mm256_add_pd(tmp_q_12,tmp_q_13);
                   const real_t tmp_q_15 = Dummy_4015*_data_q_w[q];
                   const __m256d tmp_q_16 = _mm256_add_pd(_mm256_set_pd(-1.0,-1.0,-1.0,-1.0),tmp_q_0);
             ...
             for (int64_t ctr_0 = (int64_t)((-ctr_1 + micro_edges_per_macro_edge - 1) / (4)) * (4); ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
             {
                ...
                for (int64_t q = 0; q < 3; q += 1)
                {
                   ...
                   const real_t tmp_q_1 = 4.0*_data_q_p_1[q];
                   const real_t tmp_q_2 = tmp_q_0 + tmp_q_1 - 3.0;
                   const real_t tmp_q_3 = Dummy_4011*tmp_q_2;
                   const real_t tmp_q_4 = Dummy_4013*tmp_q_2;
                   const real_t tmp_q_5 = tmp_q_3 + tmp_q_4;
                   const real_t tmp_q_6 = tmp_q_0*_data_q_p_1[q];
                   const real_t tmp_q_7 = (_data_q_p_0[q]*_data_q_p_0[q]);
                   const real_t tmp_q_8 = tmp_q_7*2.0;
                   ...
                   const real_t tmp_q_10 = tmp_q_9*2.0;
                   const real_t tmp_q_11 = k_dof_0*(tmp_q_10 + tmp_q_6 + tmp_q_8 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0) + k_dof_1*(tmp_q_8 - _data_q_p_0[q]) + k_dof_2*(tmp_q_10 - _data_q_p_1[q]) + k_dof_3*tmp_q_6 + k_dof_4*(tmp_q_1 - tmp_q_6 + tmp_q_9*-4.0) + k_dof_5*(tmp_q_0 - tmp_q_6 + tmp_q_7*-4.0);
                   const real_t tmp_q_12 = Dummy_4012*tmp_q_2;
                   const real_t tmp_q_13 = Dummy_4014*tmp_q_2;
                   const real_t tmp_q_14 = tmp_q_12 + tmp_q_13;
                   const real_t tmp_q_15 = Dummy_4015*_data_q_w[q];
                   const real_t tmp_q_16 = tmp_q_0 - 1.0;
                   const real_t tmp_q_17 = Dummy_4011*tmp_q_16;
                   const real_t tmp_q_18 = tmp_q_11*tmp_q_5;
                   const real_t tmp_q_19 = Dummy_4012*tmp_q_16;
                   const real_t tmp_q_20 = tmp_q_11*tmp_q_14;
                   const real_t tmp_q_21 = tmp_q_1 - 1.0;
                   const real_t tmp_q_22 = Dummy_4013*tmp_q_21;
                   const real_t tmp_q_23 = Dummy_4014*tmp_q_21;
                   const real_t tmp_q_24 = Dummy_4011*tmp_q_1;
                   const real_t tmp_q_25 = tmp_q_11*tmp_q_24;
                   const real_t tmp_q_26 = Dummy_4013*tmp_q_0;
                   const real_t tmp_q_27 = tmp_q_11*tmp_q_26;
                   const real_t tmp_q_28 = tmp_q_25 + tmp_q_27;
                   const real_t tmp_q_29 = Dummy_4012*tmp_q_1;
                   const real_t tmp_q_30 = tmp_q_11*tmp_q_29;
                   const real_t tmp_q_31 = Dummy_4014*tmp_q_0;
                   const real_t tmp_q_32 = tmp_q_11*tmp_q_31;
                   const real_t tmp_q_33 = tmp_q_30 + tmp_q_32;
                   const real_t tmp_q_34 = -tmp_q_0 - 8.0*_data_q_p_1[q] + 4.0;
                   const real_t tmp_q_35 = Dummy_4013*tmp_q_11*tmp_q_34 - tmp_q_25;
                   const real_t tmp_q_36 = Dummy_4014*tmp_q_11*tmp_q_34 - tmp_q_30;
                   const real_t tmp_q_37 = -tmp_q_1 - 8.0*_data_q_p_0[q] + 4.0;
                   const real_t tmp_q_38 = Dummy_4011*tmp_q_37;
                   const real_t tmp_q_39 = tmp_q_11*tmp_q_38 - tmp_q_27;
                   const real_t tmp_q_40 = Dummy_4012*tmp_q_37;
                   const real_t tmp_q_41 = tmp_q_11*tmp_q_40 - tmp_q_32;
                   const real_t tmp_q_42 = tmp_q_11*(tmp_q_16*tmp_q_16);
                   const real_t tmp_q_43 = tmp_q_11*(tmp_q_21*tmp_q_21);
                   const real_t tmp_q_44 = tmp_q_24 + tmp_q_26;
                   const real_t tmp_q_45 = tmp_q_29 + tmp_q_31;
                   const real_t tmp_q_46 = Dummy_4013*tmp_q_34 - tmp_q_24;
                   const real_t tmp_q_47 = Dummy_4014*tmp_q_34 - tmp_q_29;
                   const real_t res_tmp_0_0 = tmp_q_15*(tmp_q_14*(tmp_q_11*tmp_q_12 + tmp_q_11*tmp_q_13) + tmp_q_5*(tmp_q_11*tmp_q_3 + tmp_q_11*tmp_q_4));
                   const real_t res_tmp_0_1 = tmp_q_15*(tmp_q_17*tmp_q_18 + tmp_q_19*tmp_q_20);
                   const real_t res_tmp_0_2 = tmp_q_15*(tmp_q_18*tmp_q_22 + tmp_q_20*tmp_q_23);
                   const real_t res_tmp_0_3 = tmp_q_15*(tmp_q_14*tmp_q_33 + tmp_q_28*tmp_q_5);
                   const real_t res_tmp_0_4 = tmp_q_15*(tmp_q_14*tmp_q_36 + tmp_q_35*tmp_q_5);
                   const real_t res_tmp_0_5 = tmp_q_15*(tmp_q_14*tmp_q_41 + tmp_q_39*tmp_q_5);
                   const real_t res_tmp_1_1 = tmp_q_15*((Dummy_4011*Dummy_4011)*tmp_q_42 + (Dummy_4012*Dummy_4012)*tmp_q_42);
                   const real_t res_tmp_1_2 = tmp_q_15*(tmp_q_11*tmp_q_17*tmp_q_22 + tmp_q_11*tmp_q_19*tmp_q_23);
                   const real_t res_tmp_1_3 = tmp_q_15*(tmp_q_17*tmp_q_28 + tmp_q_19*tmp_q_33);
                   const real_t res_tmp_1_4 = tmp_q_15*(tmp_q_17*tmp_q_35 + tmp_q_19*tmp_q_36);
                   const real_t res_tmp_1_5 = tmp_q_15*(tmp_q_17*tmp_q_39 + tmp_q_19*tmp_q_41);
                   const real_t res_tmp_2_2 = tmp_q_15*((Dummy_4013*Dummy_4013)*tmp_q_43 + (Dummy_4014*Dummy_4014)*tmp_q_43);
                   const real_t res_tmp_2_3 = tmp_q_15*(tmp_q_22*tmp_q_28 + tmp_q_23*tmp_q_33);
                   const real_t res_tmp_2_4 = tmp_q_15*(tmp_q_22*tmp_q_35 + tmp_q_23*tmp_q_36);
                   const real_t res_tmp_2_5 = tmp_q_15*(tmp_q_22*tmp_q_39 + tmp_q_23*tmp_q_41);
                   const real_t res_tmp_3_3 = tmp_q_15*(tmp_q_28*tmp_q_44 + tmp_q_33*tmp_q_45);
