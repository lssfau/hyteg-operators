...
P1ElementwiseDivKGradAnnulusMap::P1ElementwiseDivKGradAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                  size_t                                     minLevel,
                                                                  size_t                                     maxLevel,
...
void P1ElementwiseDivKGradAnnulusMap::applyScaled( const real_t&               operatorScaling,
                                                   ...
                                                   UpdateType                  updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P1ElementwiseDivKGradAnnulusMap_macro_2D(
...
void P1ElementwiseDivKGradAnnulusMap::apply( const P1Function< real_t >& src,
                                             const P1Function< real_t >& dst,
                                             uint_t                      level,
                                             DoFType                     flag,
                                             UpdateType                  updateType ) const
...
void P1ElementwiseDivKGradAnnulusMap::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                      ...
                                                      DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P1ElementwiseDivKGradAnnulusMap_macro_2D(
...
void P1ElementwiseDivKGradAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                const P1Function< idx_t >&                  src,
                                                const P1Function< idx_t >&                  dst,
                                                uint_t                                      level,
                                                DoFType                                     flag ) const
...
void P1ElementwiseDivKGradAnnulusMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P1ElementwiseDivKGradAnnulusMap_macro_2D(
...
void P1ElementwiseDivKGradAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P1Function< real_t > > P1ElementwiseDivKGradAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
