...
class P1ElementwiseDivKGradAnnulusMap : public Operator< P1Function< real_t >, P1Function< real_t > >,
                                        public OperatorWithInverseDiagonal< P1Function< real_t > >
{
 public:
   P1ElementwiseDivKGradAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                    size_t                                     minLevel,
                                    size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P1ElementwiseDivKGradAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    254     384      18       9      0              0                 0              1
   void applyScaled_P1ElementwiseDivKGradAnnulusMap_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    245     378      18       9      0              0                 0              4
   void toMatrixScaled_P1ElementwiseDivKGradAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst,
                                                                 real_t* RESTRICT _data_k,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    230     348      18       9      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P1ElementwiseDivKGradAnnulusMap_macro_2D(
