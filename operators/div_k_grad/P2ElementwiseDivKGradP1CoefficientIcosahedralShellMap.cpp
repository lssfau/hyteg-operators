...
P2ElementwiseDivKGradP1CoefficientIcosahedralShellMap::P2ElementwiseDivKGradP1CoefficientIcosahedralShellMap(
...
void P2ElementwiseDivKGradP1CoefficientIcosahedralShellMap::applyScaled( const real_t&               operatorScaling,
                                                                         ...
                                                                         UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseDivKGradP1CoefficientIcosahedralShellMap_macro_3D(
...
void P2ElementwiseDivKGradP1CoefficientIcosahedralShellMap::apply( const P2Function< real_t >& src,
                                                                   const P2Function< real_t >& dst,
                                                                   uint_t                      level,
                                                                   DoFType                     flag,
                                                                   UpdateType                  updateType ) const
...
void P2ElementwiseDivKGradP1CoefficientIcosahedralShellMap::toMatrixScaled( const real_t& toMatrixScaling,
                                                                            ...
                                                                            DoFType flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseDivKGradP1CoefficientIcosahedralShellMap_macro_3D(
...
void P2ElementwiseDivKGradP1CoefficientIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                      const P2Function< idx_t >&                  src,
                                                                      const P2Function< idx_t >&                  dst,
                                                                      uint_t                                      level,
                                                                      DoFType                                     flag ) const
...
void P2ElementwiseDivKGradP1CoefficientIcosahedralShellMap::computeInverseDiagonalOperatorValuesScaled(
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseDivKGradP1CoefficientIcosahedralShellMap_macro_3D(
...
void P2ElementwiseDivKGradP1CoefficientIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseDivKGradP1CoefficientIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
