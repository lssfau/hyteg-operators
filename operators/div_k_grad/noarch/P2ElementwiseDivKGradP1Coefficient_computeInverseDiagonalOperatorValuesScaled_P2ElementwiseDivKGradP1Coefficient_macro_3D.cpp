...
void P2ElementwiseDivKGradP1Coefficient::computeInverseDiagonalOperatorValuesScaled_P2ElementwiseDivKGradP1Coefficient_macro_3D( real_t * RESTRICT  _data_invDiag_Edge, real_t * RESTRICT  _data_invDiag_Vertex, real_t * RESTRICT  _data_k, real_t diagScaling, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_0comp2, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_1comp2, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, real_t macro_vertex_coord_id_2comp2, real_t macro_vertex_coord_id_3comp0, real_t macro_vertex_coord_id_3comp1, real_t macro_vertex_coord_id_3comp2, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float ) const
{
    {
       ...
       const real_t abs_det_jac_affine_WHITE_UP = abs(tmp_coords_jac_6_WHITE_UP);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                ...
                const real_t tmp_qloop_6 = ((-0.25 + _data_q_p_0[q])*(-0.25 + _data_q_p_0[q]))*16.0;
                const real_t tmp_qloop_7 = ((-0.25 + _data_q_p_1[q])*(-0.25 + _data_q_p_1[q]))*16.0;
                const real_t tmp_qloop_8 = ((-0.25 + _data_q_p_2[q])*(-0.25 + _data_q_p_2[q]))*16.0;
                const real_t tmp_qloop_9 = jac_affine_inv_2_0_WHITE_UP*_data_q_p_1[q];
                const real_t tmp_qloop_10 = jac_affine_inv_1_0_WHITE_UP*_data_q_p_2[q];
                const real_t tmp_qloop_11 = jac_affine_inv_2_1_WHITE_UP*_data_q_p_1[q];
                const real_t tmp_qloop_12 = jac_affine_inv_1_1_WHITE_UP*_data_q_p_2[q];
                const real_t tmp_qloop_13 = jac_affine_inv_2_2_WHITE_UP*_data_q_p_1[q];
                const real_t tmp_qloop_14 = jac_affine_inv_1_2_WHITE_UP*_data_q_p_2[q];
                const real_t tmp_qloop_15 = jac_affine_inv_2_0_WHITE_UP*_data_q_p_0[q];
                const real_t tmp_qloop_16 = jac_affine_inv_0_0_WHITE_UP*_data_q_p_2[q];
                const real_t tmp_qloop_17 = jac_affine_inv_2_1_WHITE_UP*_data_q_p_0[q];
                const real_t tmp_qloop_18 = jac_affine_inv_0_1_WHITE_UP*_data_q_p_2[q];
                const real_t tmp_qloop_19 = jac_affine_inv_2_2_WHITE_UP*_data_q_p_0[q];
                const real_t tmp_qloop_20 = jac_affine_inv_0_2_WHITE_UP*_data_q_p_2[q];
                const real_t tmp_qloop_21 = jac_affine_inv_1_0_WHITE_UP*_data_q_p_0[q];
                const real_t tmp_qloop_22 = jac_affine_inv_0_0_WHITE_UP*_data_q_p_1[q];
                const real_t tmp_qloop_23 = jac_affine_inv_1_1_WHITE_UP*_data_q_p_0[q];
                const real_t tmp_qloop_24 = jac_affine_inv_0_1_WHITE_UP*_data_q_p_1[q];
                const real_t tmp_qloop_25 = jac_affine_inv_1_2_WHITE_UP*_data_q_p_0[q];
                const real_t tmp_qloop_26 = jac_affine_inv_0_2_WHITE_UP*_data_q_p_1[q];
                const real_t tmp_qloop_27 = -tmp_qloop_3 - 8.0*_data_q_p_2[q] + 4.0;
                const real_t tmp_qloop_28 = tmp_qloop_0 - 4.0;
                const real_t tmp_qloop_29 = -tmp_qloop_1 - tmp_qloop_28 - 8.0*_data_q_p_1[q];
                const real_t tmp_qloop_30 = -tmp_qloop_2 - tmp_qloop_28 - 8.0*_data_q_p_0[q];
                const real_t q_tmp_0_0 = tmp_qloop_5*(((jac_affine_inv_0_0_WHITE_UP*tmp_qloop_4 + jac_affine_inv_1_0_WHITE_UP*tmp_qloop_4 + jac_affine_inv_2_0_WHITE_UP*tmp_qloop_4)*(jac_affine_inv_0_0_WHITE_UP*tmp_qloop_4 + jac_affine_inv_1_0_WHITE_UP*tmp_qloop_4 + jac_affine_inv_2_0_WHITE_UP*tmp_qloop_4)) + ((jac_affine_inv_0_1_WHITE_UP*tmp_qloop_4 + jac_affine_inv_1_1_WHITE_UP*tmp_qloop_4 + jac_affine_inv_2_1_WHITE_UP*tmp_qloop_4)*(jac_affine_inv_0_1_WHITE_UP*tmp_qloop_4 + jac_affine_inv_1_1_WHITE_UP*tmp_qloop_4 + jac_affine_inv_2_1_WHITE_UP*tmp_qloop_4)) + ((jac_affine_inv_0_2_WHITE_UP*tmp_qloop_4 + jac_affine_inv_1_2_WHITE_UP*tmp_qloop_4 + jac_affine_inv_2_2_WHITE_UP*tmp_qloop_4)*(jac_affine_inv_0_2_WHITE_UP*tmp_qloop_4 + jac_affine_inv_1_2_WHITE_UP*tmp_qloop_4 + jac_affine_inv_2_2_WHITE_UP*tmp_qloop_4)));
                const real_t q_tmp_1_1 = tmp_qloop_5*((jac_affine_inv_0_0_WHITE_UP*jac_affine_inv_0_0_WHITE_UP)*tmp_qloop_6 + (jac_affine_inv_0_1_WHITE_UP*jac_affine_inv_0_1_WHITE_UP)*tmp_qloop_6 + (jac_affine_inv_0_2_WHITE_UP*jac_affine_inv_0_2_WHITE_UP)*tmp_qloop_6);
                const real_t q_tmp_2_2 = tmp_qloop_5*((jac_affine_inv_1_0_WHITE_UP*jac_affine_inv_1_0_WHITE_UP)*tmp_qloop_7 + (jac_affine_inv_1_1_WHITE_UP*jac_affine_inv_1_1_WHITE_UP)*tmp_qloop_7 + (jac_affine_inv_1_2_WHITE_UP*jac_affine_inv_1_2_WHITE_UP)*tmp_qloop_7);
                const real_t q_tmp_3_3 = tmp_qloop_5*((jac_affine_inv_2_0_WHITE_UP*jac_affine_inv_2_0_WHITE_UP)*tmp_qloop_8 + (jac_affine_inv_2_1_WHITE_UP*jac_affine_inv_2_1_WHITE_UP)*tmp_qloop_8 + (jac_affine_inv_2_2_WHITE_UP*jac_affine_inv_2_2_WHITE_UP)*tmp_qloop_8);
                const real_t q_tmp_4_4 = tmp_qloop_5*(((tmp_qloop_10 + tmp_qloop_9)*(tmp_qloop_10 + tmp_qloop_9))*16.0 + ((tmp_qloop_11 + tmp_qloop_12)*(tmp_qloop_11 + tmp_qloop_12))*16.0 + ((tmp_qloop_13 + tmp_qloop_14)*(tmp_qloop_13 + tmp_qloop_14))*16.0);
                const real_t q_tmp_5_5 = tmp_qloop_5*(((tmp_qloop_15 + tmp_qloop_16)*(tmp_qloop_15 + tmp_qloop_16))*16.0 + ((tmp_qloop_17 + tmp_qloop_18)*(tmp_qloop_17 + tmp_qloop_18))*16.0 + ((tmp_qloop_19 + tmp_qloop_20)*(tmp_qloop_19 + tmp_qloop_20))*16.0);
                const real_t q_tmp_6_6 = tmp_qloop_5*(((tmp_qloop_21 + tmp_qloop_22)*(tmp_qloop_21 + tmp_qloop_22))*16.0 + ((tmp_qloop_23 + tmp_qloop_24)*(tmp_qloop_23 + tmp_qloop_24))*16.0 + ((tmp_qloop_25 + tmp_qloop_26)*(tmp_qloop_25 + tmp_qloop_26))*16.0);
                const real_t q_tmp_7_7 = tmp_qloop_5*(((jac_affine_inv_2_0_WHITE_UP*tmp_qloop_27*0.25 - tmp_qloop_10 - tmp_qloop_16)*(jac_affine_inv_2_0_WHITE_UP*tmp_qloop_27*0.25 - tmp_qloop_10 - tmp_qloop_16))*16.0 + ((jac_affine_inv_2_1_WHITE_UP*tmp_qloop_27*0.25 - tmp_qloop_12 - tmp_qloop_18)*(jac_affine_inv_2_1_WHITE_UP*tmp_qloop_27*0.25 - tmp_qloop_12 - tmp_qloop_18))*16.0 + ((jac_affine_inv_2_2_WHITE_UP*tmp_qloop_27*0.25 - tmp_qloop_14 - tmp_qloop_20)*(jac_affine_inv_2_2_WHITE_UP*tmp_qloop_27*0.25 - tmp_qloop_14 - tmp_qloop_20))*16.0);
                const real_t q_tmp_8_8 = tmp_qloop_5*(((jac_affine_inv_1_0_WHITE_UP*tmp_qloop_29*0.25 - tmp_qloop_22 - tmp_qloop_9)*(jac_affine_inv_1_0_WHITE_UP*tmp_qloop_29*0.25 - tmp_qloop_22 - tmp_qloop_9))*16.0 + ((jac_affine_inv_1_1_WHITE_UP*tmp_qloop_29*0.25 - tmp_qloop_11 - tmp_qloop_24)*(jac_affine_inv_1_1_WHITE_UP*tmp_qloop_29*0.25 - tmp_qloop_11 - tmp_qloop_24))*16.0 + ((jac_affine_inv_1_2_WHITE_UP*tmp_qloop_29*0.25 - tmp_qloop_13 - tmp_qloop_26)*(jac_affine_inv_1_2_WHITE_UP*tmp_qloop_29*0.25 - tmp_qloop_13 - tmp_qloop_26))*16.0);
                const real_t q_tmp_9_9 = tmp_qloop_5*(((jac_affine_inv_0_0_WHITE_UP*tmp_qloop_30*0.25 - tmp_qloop_15 - tmp_qloop_21)*(jac_affine_inv_0_0_WHITE_UP*tmp_qloop_30*0.25 - tmp_qloop_15 - tmp_qloop_21))*16.0 + ((jac_affine_inv_0_1_WHITE_UP*tmp_qloop_30*0.25 - tmp_qloop_17 - tmp_qloop_23)*(jac_affine_inv_0_1_WHITE_UP*tmp_qloop_30*0.25 - tmp_qloop_17 - tmp_qloop_23))*16.0 + ((jac_affine_inv_0_2_WHITE_UP*tmp_qloop_30*0.25 - tmp_qloop_19 - tmp_qloop_25)*(jac_affine_inv_0_2_WHITE_UP*tmp_qloop_30*0.25 - tmp_qloop_19 - tmp_qloop_25))*16.0);
       ...
       const real_t abs_det_jac_affine_WHITE_DOWN = abs(tmp_coords_jac_18_WHITE_DOWN);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 2; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                ...
                const real_t tmp_qloop_7 = ((-0.25 + _data_q_p_1[q])*(-0.25 + _data_q_p_1[q]))*16.0;
                const real_t tmp_qloop_8 = ((-0.25 + _data_q_p_2[q])*(-0.25 + _data_q_p_2[q]))*16.0;
                const real_t tmp_qloop_9 = jac_affine_inv_2_0_WHITE_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_10 = jac_affine_inv_1_0_WHITE_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_11 = jac_affine_inv_2_1_WHITE_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_12 = jac_affine_inv_1_1_WHITE_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_13 = jac_affine_inv_2_2_WHITE_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_14 = jac_affine_inv_1_2_WHITE_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_15 = jac_affine_inv_2_0_WHITE_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_16 = jac_affine_inv_0_0_WHITE_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_17 = jac_affine_inv_2_1_WHITE_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_18 = jac_affine_inv_0_1_WHITE_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_19 = jac_affine_inv_2_2_WHITE_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_20 = jac_affine_inv_0_2_WHITE_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_21 = jac_affine_inv_1_0_WHITE_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_22 = jac_affine_inv_0_0_WHITE_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_23 = jac_affine_inv_1_1_WHITE_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_24 = jac_affine_inv_0_1_WHITE_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_25 = jac_affine_inv_1_2_WHITE_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_26 = jac_affine_inv_0_2_WHITE_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_27 = -tmp_qloop_3 - 8.0*_data_q_p_2[q] + 4.0;
                const real_t tmp_qloop_28 = tmp_qloop_0 - 4.0;
                const real_t tmp_qloop_29 = -tmp_qloop_1 - tmp_qloop_28 - 8.0*_data_q_p_1[q];
                const real_t tmp_qloop_30 = -tmp_qloop_2 - tmp_qloop_28 - 8.0*_data_q_p_0[q];
                const real_t q_tmp_0_0 = tmp_qloop_5*(((jac_affine_inv_0_0_WHITE_DOWN*tmp_qloop_4 + jac_affine_inv_1_0_WHITE_DOWN*tmp_qloop_4 + jac_affine_inv_2_0_WHITE_DOWN*tmp_qloop_4)*(jac_affine_inv_0_0_WHITE_DOWN*tmp_qloop_4 + jac_affine_inv_1_0_WHITE_DOWN*tmp_qloop_4 + jac_affine_inv_2_0_WHITE_DOWN*tmp_qloop_4)) + ((jac_affine_inv_0_1_WHITE_DOWN*tmp_qloop_4 + jac_affine_inv_1_1_WHITE_DOWN*tmp_qloop_4 + jac_affine_inv_2_1_WHITE_DOWN*tmp_qloop_4)*(jac_affine_inv_0_1_WHITE_DOWN*tmp_qloop_4 + jac_affine_inv_1_1_WHITE_DOWN*tmp_qloop_4 + jac_affine_inv_2_1_WHITE_DOWN*tmp_qloop_4)) + ((jac_affine_inv_0_2_WHITE_DOWN*tmp_qloop_4 + jac_affine_inv_1_2_WHITE_DOWN*tmp_qloop_4 + jac_affine_inv_2_2_WHITE_DOWN*tmp_qloop_4)*(jac_affine_inv_0_2_WHITE_DOWN*tmp_qloop_4 + jac_affine_inv_1_2_WHITE_DOWN*tmp_qloop_4 + jac_affine_inv_2_2_WHITE_DOWN*tmp_qloop_4)));
                const real_t q_tmp_1_1 = tmp_qloop_5*((jac_affine_inv_0_0_WHITE_DOWN*jac_affine_inv_0_0_WHITE_DOWN)*tmp_qloop_6 + (jac_affine_inv_0_1_WHITE_DOWN*jac_affine_inv_0_1_WHITE_DOWN)*tmp_qloop_6 + (jac_affine_inv_0_2_WHITE_DOWN*jac_affine_inv_0_2_WHITE_DOWN)*tmp_qloop_6);
                const real_t q_tmp_2_2 = tmp_qloop_5*((jac_affine_inv_1_0_WHITE_DOWN*jac_affine_inv_1_0_WHITE_DOWN)*tmp_qloop_7 + (jac_affine_inv_1_1_WHITE_DOWN*jac_affine_inv_1_1_WHITE_DOWN)*tmp_qloop_7 + (jac_affine_inv_1_2_WHITE_DOWN*jac_affine_inv_1_2_WHITE_DOWN)*tmp_qloop_7);
                const real_t q_tmp_3_3 = tmp_qloop_5*((jac_affine_inv_2_0_WHITE_DOWN*jac_affine_inv_2_0_WHITE_DOWN)*tmp_qloop_8 + (jac_affine_inv_2_1_WHITE_DOWN*jac_affine_inv_2_1_WHITE_DOWN)*tmp_qloop_8 + (jac_affine_inv_2_2_WHITE_DOWN*jac_affine_inv_2_2_WHITE_DOWN)*tmp_qloop_8);
                const real_t q_tmp_4_4 = tmp_qloop_5*(((tmp_qloop_10 + tmp_qloop_9)*(tmp_qloop_10 + tmp_qloop_9))*16.0 + ((tmp_qloop_11 + tmp_qloop_12)*(tmp_qloop_11 + tmp_qloop_12))*16.0 + ((tmp_qloop_13 + tmp_qloop_14)*(tmp_qloop_13 + tmp_qloop_14))*16.0);
                const real_t q_tmp_5_5 = tmp_qloop_5*(((tmp_qloop_15 + tmp_qloop_16)*(tmp_qloop_15 + tmp_qloop_16))*16.0 + ((tmp_qloop_17 + tmp_qloop_18)*(tmp_qloop_17 + tmp_qloop_18))*16.0 + ((tmp_qloop_19 + tmp_qloop_20)*(tmp_qloop_19 + tmp_qloop_20))*16.0);
                const real_t q_tmp_6_6 = tmp_qloop_5*(((tmp_qloop_21 + tmp_qloop_22)*(tmp_qloop_21 + tmp_qloop_22))*16.0 + ((tmp_qloop_23 + tmp_qloop_24)*(tmp_qloop_23 + tmp_qloop_24))*16.0 + ((tmp_qloop_25 + tmp_qloop_26)*(tmp_qloop_25 + tmp_qloop_26))*16.0);
                const real_t q_tmp_7_7 = tmp_qloop_5*(((jac_affine_inv_2_0_WHITE_DOWN*tmp_qloop_27*0.25 - tmp_qloop_10 - tmp_qloop_16)*(jac_affine_inv_2_0_WHITE_DOWN*tmp_qloop_27*0.25 - tmp_qloop_10 - tmp_qloop_16))*16.0 + ((jac_affine_inv_2_1_WHITE_DOWN*tmp_qloop_27*0.25 - tmp_qloop_12 - tmp_qloop_18)*(jac_affine_inv_2_1_WHITE_DOWN*tmp_qloop_27*0.25 - tmp_qloop_12 - tmp_qloop_18))*16.0 + ((jac_affine_inv_2_2_WHITE_DOWN*tmp_qloop_27*0.25 - tmp_qloop_14 - tmp_qloop_20)*(jac_affine_inv_2_2_WHITE_DOWN*tmp_qloop_27*0.25 - tmp_qloop_14 - tmp_qloop_20))*16.0);
                const real_t q_tmp_8_8 = tmp_qloop_5*(((jac_affine_inv_1_0_WHITE_DOWN*tmp_qloop_29*0.25 - tmp_qloop_22 - tmp_qloop_9)*(jac_affine_inv_1_0_WHITE_DOWN*tmp_qloop_29*0.25 - tmp_qloop_22 - tmp_qloop_9))*16.0 + ((jac_affine_inv_1_1_WHITE_DOWN*tmp_qloop_29*0.25 - tmp_qloop_11 - tmp_qloop_24)*(jac_affine_inv_1_1_WHITE_DOWN*tmp_qloop_29*0.25 - tmp_qloop_11 - tmp_qloop_24))*16.0 + ((jac_affine_inv_1_2_WHITE_DOWN*tmp_qloop_29*0.25 - tmp_qloop_13 - tmp_qloop_26)*(jac_affine_inv_1_2_WHITE_DOWN*tmp_qloop_29*0.25 - tmp_qloop_13 - tmp_qloop_26))*16.0);
                const real_t q_tmp_9_9 = tmp_qloop_5*(((jac_affine_inv_0_0_WHITE_DOWN*tmp_qloop_30*0.25 - tmp_qloop_15 - tmp_qloop_21)*(jac_affine_inv_0_0_WHITE_DOWN*tmp_qloop_30*0.25 - tmp_qloop_15 - tmp_qloop_21))*16.0 + ((jac_affine_inv_0_1_WHITE_DOWN*tmp_qloop_30*0.25 - tmp_qloop_17 - tmp_qloop_23)*(jac_affine_inv_0_1_WHITE_DOWN*tmp_qloop_30*0.25 - tmp_qloop_17 - tmp_qloop_23))*16.0 + ((jac_affine_inv_0_2_WHITE_DOWN*tmp_qloop_30*0.25 - tmp_qloop_19 - tmp_qloop_25)*(jac_affine_inv_0_2_WHITE_DOWN*tmp_qloop_30*0.25 - tmp_qloop_19 - tmp_qloop_25))*16.0);
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_1_1 = q_acc_1_1 + q_tmp_1_1;
                q_acc_2_2 = q_acc_2_2 + q_tmp_2_2;
                q_acc_3_3 = q_acc_3_3 + q_tmp_3_3;
       ...
       const real_t abs_det_jac_affine_BLUE_UP = abs(tmp_coords_jac_12_BLUE_UP);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                ...
                const real_t tmp_qloop_7 = ((-0.25 + _data_q_p_1[q])*(-0.25 + _data_q_p_1[q]))*16.0;
                const real_t tmp_qloop_8 = ((-0.25 + _data_q_p_2[q])*(-0.25 + _data_q_p_2[q]))*16.0;
                const real_t tmp_qloop_9 = jac_affine_inv_2_0_BLUE_UP*_data_q_p_1[q];
                const real_t tmp_qloop_10 = jac_affine_inv_1_0_BLUE_UP*_data_q_p_2[q];
                const real_t tmp_qloop_11 = jac_affine_inv_2_1_BLUE_UP*_data_q_p_1[q];
                const real_t tmp_qloop_12 = jac_affine_inv_1_1_BLUE_UP*_data_q_p_2[q];
                const real_t tmp_qloop_13 = jac_affine_inv_2_2_BLUE_UP*_data_q_p_1[q];
                const real_t tmp_qloop_14 = jac_affine_inv_1_2_BLUE_UP*_data_q_p_2[q];
                const real_t tmp_qloop_15 = jac_affine_inv_2_0_BLUE_UP*_data_q_p_0[q];
                const real_t tmp_qloop_16 = jac_affine_inv_0_0_BLUE_UP*_data_q_p_2[q];
                const real_t tmp_qloop_17 = jac_affine_inv_2_1_BLUE_UP*_data_q_p_0[q];
                const real_t tmp_qloop_18 = jac_affine_inv_0_1_BLUE_UP*_data_q_p_2[q];
                const real_t tmp_qloop_19 = jac_affine_inv_2_2_BLUE_UP*_data_q_p_0[q];
                const real_t tmp_qloop_20 = jac_affine_inv_0_2_BLUE_UP*_data_q_p_2[q];
                const real_t tmp_qloop_21 = jac_affine_inv_1_0_BLUE_UP*_data_q_p_0[q];
                const real_t tmp_qloop_22 = jac_affine_inv_0_0_BLUE_UP*_data_q_p_1[q];
                const real_t tmp_qloop_23 = jac_affine_inv_1_1_BLUE_UP*_data_q_p_0[q];
                const real_t tmp_qloop_24 = jac_affine_inv_0_1_BLUE_UP*_data_q_p_1[q];
                const real_t tmp_qloop_25 = jac_affine_inv_1_2_BLUE_UP*_data_q_p_0[q];
                const real_t tmp_qloop_26 = jac_affine_inv_0_2_BLUE_UP*_data_q_p_1[q];
                const real_t tmp_qloop_27 = -tmp_qloop_3 - 8.0*_data_q_p_2[q] + 4.0;
                const real_t tmp_qloop_28 = tmp_qloop_0 - 4.0;
                const real_t tmp_qloop_29 = -tmp_qloop_1 - tmp_qloop_28 - 8.0*_data_q_p_1[q];
                const real_t tmp_qloop_30 = -tmp_qloop_2 - tmp_qloop_28 - 8.0*_data_q_p_0[q];
                const real_t q_tmp_0_0 = tmp_qloop_5*(((jac_affine_inv_0_0_BLUE_UP*tmp_qloop_4 + jac_affine_inv_1_0_BLUE_UP*tmp_qloop_4 + jac_affine_inv_2_0_BLUE_UP*tmp_qloop_4)*(jac_affine_inv_0_0_BLUE_UP*tmp_qloop_4 + jac_affine_inv_1_0_BLUE_UP*tmp_qloop_4 + jac_affine_inv_2_0_BLUE_UP*tmp_qloop_4)) + ((jac_affine_inv_0_1_BLUE_UP*tmp_qloop_4 + jac_affine_inv_1_1_BLUE_UP*tmp_qloop_4 + jac_affine_inv_2_1_BLUE_UP*tmp_qloop_4)*(jac_affine_inv_0_1_BLUE_UP*tmp_qloop_4 + jac_affine_inv_1_1_BLUE_UP*tmp_qloop_4 + jac_affine_inv_2_1_BLUE_UP*tmp_qloop_4)) + ((jac_affine_inv_0_2_BLUE_UP*tmp_qloop_4 + jac_affine_inv_1_2_BLUE_UP*tmp_qloop_4 + jac_affine_inv_2_2_BLUE_UP*tmp_qloop_4)*(jac_affine_inv_0_2_BLUE_UP*tmp_qloop_4 + jac_affine_inv_1_2_BLUE_UP*tmp_qloop_4 + jac_affine_inv_2_2_BLUE_UP*tmp_qloop_4)));
                const real_t q_tmp_1_1 = tmp_qloop_5*((jac_affine_inv_0_0_BLUE_UP*jac_affine_inv_0_0_BLUE_UP)*tmp_qloop_6 + (jac_affine_inv_0_1_BLUE_UP*jac_affine_inv_0_1_BLUE_UP)*tmp_qloop_6 + (jac_affine_inv_0_2_BLUE_UP*jac_affine_inv_0_2_BLUE_UP)*tmp_qloop_6);
                const real_t q_tmp_2_2 = tmp_qloop_5*((jac_affine_inv_1_0_BLUE_UP*jac_affine_inv_1_0_BLUE_UP)*tmp_qloop_7 + (jac_affine_inv_1_1_BLUE_UP*jac_affine_inv_1_1_BLUE_UP)*tmp_qloop_7 + (jac_affine_inv_1_2_BLUE_UP*jac_affine_inv_1_2_BLUE_UP)*tmp_qloop_7);
                const real_t q_tmp_3_3 = tmp_qloop_5*((jac_affine_inv_2_0_BLUE_UP*jac_affine_inv_2_0_BLUE_UP)*tmp_qloop_8 + (jac_affine_inv_2_1_BLUE_UP*jac_affine_inv_2_1_BLUE_UP)*tmp_qloop_8 + (jac_affine_inv_2_2_BLUE_UP*jac_affine_inv_2_2_BLUE_UP)*tmp_qloop_8);
                const real_t q_tmp_4_4 = tmp_qloop_5*(((tmp_qloop_10 + tmp_qloop_9)*(tmp_qloop_10 + tmp_qloop_9))*16.0 + ((tmp_qloop_11 + tmp_qloop_12)*(tmp_qloop_11 + tmp_qloop_12))*16.0 + ((tmp_qloop_13 + tmp_qloop_14)*(tmp_qloop_13 + tmp_qloop_14))*16.0);
                const real_t q_tmp_5_5 = tmp_qloop_5*(((tmp_qloop_15 + tmp_qloop_16)*(tmp_qloop_15 + tmp_qloop_16))*16.0 + ((tmp_qloop_17 + tmp_qloop_18)*(tmp_qloop_17 + tmp_qloop_18))*16.0 + ((tmp_qloop_19 + tmp_qloop_20)*(tmp_qloop_19 + tmp_qloop_20))*16.0);
                const real_t q_tmp_6_6 = tmp_qloop_5*(((tmp_qloop_21 + tmp_qloop_22)*(tmp_qloop_21 + tmp_qloop_22))*16.0 + ((tmp_qloop_23 + tmp_qloop_24)*(tmp_qloop_23 + tmp_qloop_24))*16.0 + ((tmp_qloop_25 + tmp_qloop_26)*(tmp_qloop_25 + tmp_qloop_26))*16.0);
                const real_t q_tmp_7_7 = tmp_qloop_5*(((jac_affine_inv_2_0_BLUE_UP*tmp_qloop_27*0.25 - tmp_qloop_10 - tmp_qloop_16)*(jac_affine_inv_2_0_BLUE_UP*tmp_qloop_27*0.25 - tmp_qloop_10 - tmp_qloop_16))*16.0 + ((jac_affine_inv_2_1_BLUE_UP*tmp_qloop_27*0.25 - tmp_qloop_12 - tmp_qloop_18)*(jac_affine_inv_2_1_BLUE_UP*tmp_qloop_27*0.25 - tmp_qloop_12 - tmp_qloop_18))*16.0 + ((jac_affine_inv_2_2_BLUE_UP*tmp_qloop_27*0.25 - tmp_qloop_14 - tmp_qloop_20)*(jac_affine_inv_2_2_BLUE_UP*tmp_qloop_27*0.25 - tmp_qloop_14 - tmp_qloop_20))*16.0);
                const real_t q_tmp_8_8 = tmp_qloop_5*(((jac_affine_inv_1_0_BLUE_UP*tmp_qloop_29*0.25 - tmp_qloop_22 - tmp_qloop_9)*(jac_affine_inv_1_0_BLUE_UP*tmp_qloop_29*0.25 - tmp_qloop_22 - tmp_qloop_9))*16.0 + ((jac_affine_inv_1_1_BLUE_UP*tmp_qloop_29*0.25 - tmp_qloop_11 - tmp_qloop_24)*(jac_affine_inv_1_1_BLUE_UP*tmp_qloop_29*0.25 - tmp_qloop_11 - tmp_qloop_24))*16.0 + ((jac_affine_inv_1_2_BLUE_UP*tmp_qloop_29*0.25 - tmp_qloop_13 - tmp_qloop_26)*(jac_affine_inv_1_2_BLUE_UP*tmp_qloop_29*0.25 - tmp_qloop_13 - tmp_qloop_26))*16.0);
                const real_t q_tmp_9_9 = tmp_qloop_5*(((jac_affine_inv_0_0_BLUE_UP*tmp_qloop_30*0.25 - tmp_qloop_15 - tmp_qloop_21)*(jac_affine_inv_0_0_BLUE_UP*tmp_qloop_30*0.25 - tmp_qloop_15 - tmp_qloop_21))*16.0 + ((jac_affine_inv_0_1_BLUE_UP*tmp_qloop_30*0.25 - tmp_qloop_17 - tmp_qloop_23)*(jac_affine_inv_0_1_BLUE_UP*tmp_qloop_30*0.25 - tmp_qloop_17 - tmp_qloop_23))*16.0 + ((jac_affine_inv_0_2_BLUE_UP*tmp_qloop_30*0.25 - tmp_qloop_19 - tmp_qloop_25)*(jac_affine_inv_0_2_BLUE_UP*tmp_qloop_30*0.25 - tmp_qloop_19 - tmp_qloop_25))*16.0);
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_1_1 = q_acc_1_1 + q_tmp_1_1;
                q_acc_2_2 = q_acc_2_2 + q_tmp_2_2;
                q_acc_3_3 = q_acc_3_3 + q_tmp_3_3;
       ...
       const real_t abs_det_jac_affine_BLUE_DOWN = abs(tmp_coords_jac_15_BLUE_DOWN);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                ...
                const real_t tmp_qloop_7 = ((-0.25 + _data_q_p_1[q])*(-0.25 + _data_q_p_1[q]))*16.0;
                const real_t tmp_qloop_8 = ((-0.25 + _data_q_p_2[q])*(-0.25 + _data_q_p_2[q]))*16.0;
                const real_t tmp_qloop_9 = jac_affine_inv_2_0_BLUE_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_10 = jac_affine_inv_1_0_BLUE_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_11 = jac_affine_inv_2_1_BLUE_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_12 = jac_affine_inv_1_1_BLUE_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_13 = jac_affine_inv_2_2_BLUE_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_14 = jac_affine_inv_1_2_BLUE_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_15 = jac_affine_inv_2_0_BLUE_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_16 = jac_affine_inv_0_0_BLUE_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_17 = jac_affine_inv_2_1_BLUE_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_18 = jac_affine_inv_0_1_BLUE_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_19 = jac_affine_inv_2_2_BLUE_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_20 = jac_affine_inv_0_2_BLUE_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_21 = jac_affine_inv_1_0_BLUE_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_22 = jac_affine_inv_0_0_BLUE_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_23 = jac_affine_inv_1_1_BLUE_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_24 = jac_affine_inv_0_1_BLUE_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_25 = jac_affine_inv_1_2_BLUE_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_26 = jac_affine_inv_0_2_BLUE_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_27 = -tmp_qloop_3 - 8.0*_data_q_p_2[q] + 4.0;
                const real_t tmp_qloop_28 = tmp_qloop_0 - 4.0;
                const real_t tmp_qloop_29 = -tmp_qloop_1 - tmp_qloop_28 - 8.0*_data_q_p_1[q];
                const real_t tmp_qloop_30 = -tmp_qloop_2 - tmp_qloop_28 - 8.0*_data_q_p_0[q];
                const real_t q_tmp_0_0 = tmp_qloop_5*(((jac_affine_inv_0_0_BLUE_DOWN*tmp_qloop_4 + jac_affine_inv_1_0_BLUE_DOWN*tmp_qloop_4 + jac_affine_inv_2_0_BLUE_DOWN*tmp_qloop_4)*(jac_affine_inv_0_0_BLUE_DOWN*tmp_qloop_4 + jac_affine_inv_1_0_BLUE_DOWN*tmp_qloop_4 + jac_affine_inv_2_0_BLUE_DOWN*tmp_qloop_4)) + ((jac_affine_inv_0_1_BLUE_DOWN*tmp_qloop_4 + jac_affine_inv_1_1_BLUE_DOWN*tmp_qloop_4 + jac_affine_inv_2_1_BLUE_DOWN*tmp_qloop_4)*(jac_affine_inv_0_1_BLUE_DOWN*tmp_qloop_4 + jac_affine_inv_1_1_BLUE_DOWN*tmp_qloop_4 + jac_affine_inv_2_1_BLUE_DOWN*tmp_qloop_4)) + ((jac_affine_inv_0_2_BLUE_DOWN*tmp_qloop_4 + jac_affine_inv_1_2_BLUE_DOWN*tmp_qloop_4 + jac_affine_inv_2_2_BLUE_DOWN*tmp_qloop_4)*(jac_affine_inv_0_2_BLUE_DOWN*tmp_qloop_4 + jac_affine_inv_1_2_BLUE_DOWN*tmp_qloop_4 + jac_affine_inv_2_2_BLUE_DOWN*tmp_qloop_4)));
                const real_t q_tmp_1_1 = tmp_qloop_5*((jac_affine_inv_0_0_BLUE_DOWN*jac_affine_inv_0_0_BLUE_DOWN)*tmp_qloop_6 + (jac_affine_inv_0_1_BLUE_DOWN*jac_affine_inv_0_1_BLUE_DOWN)*tmp_qloop_6 + (jac_affine_inv_0_2_BLUE_DOWN*jac_affine_inv_0_2_BLUE_DOWN)*tmp_qloop_6);
                const real_t q_tmp_2_2 = tmp_qloop_5*((jac_affine_inv_1_0_BLUE_DOWN*jac_affine_inv_1_0_BLUE_DOWN)*tmp_qloop_7 + (jac_affine_inv_1_1_BLUE_DOWN*jac_affine_inv_1_1_BLUE_DOWN)*tmp_qloop_7 + (jac_affine_inv_1_2_BLUE_DOWN*jac_affine_inv_1_2_BLUE_DOWN)*tmp_qloop_7);
                const real_t q_tmp_3_3 = tmp_qloop_5*((jac_affine_inv_2_0_BLUE_DOWN*jac_affine_inv_2_0_BLUE_DOWN)*tmp_qloop_8 + (jac_affine_inv_2_1_BLUE_DOWN*jac_affine_inv_2_1_BLUE_DOWN)*tmp_qloop_8 + (jac_affine_inv_2_2_BLUE_DOWN*jac_affine_inv_2_2_BLUE_DOWN)*tmp_qloop_8);
                const real_t q_tmp_4_4 = tmp_qloop_5*(((tmp_qloop_10 + tmp_qloop_9)*(tmp_qloop_10 + tmp_qloop_9))*16.0 + ((tmp_qloop_11 + tmp_qloop_12)*(tmp_qloop_11 + tmp_qloop_12))*16.0 + ((tmp_qloop_13 + tmp_qloop_14)*(tmp_qloop_13 + tmp_qloop_14))*16.0);
                const real_t q_tmp_5_5 = tmp_qloop_5*(((tmp_qloop_15 + tmp_qloop_16)*(tmp_qloop_15 + tmp_qloop_16))*16.0 + ((tmp_qloop_17 + tmp_qloop_18)*(tmp_qloop_17 + tmp_qloop_18))*16.0 + ((tmp_qloop_19 + tmp_qloop_20)*(tmp_qloop_19 + tmp_qloop_20))*16.0);
                const real_t q_tmp_6_6 = tmp_qloop_5*(((tmp_qloop_21 + tmp_qloop_22)*(tmp_qloop_21 + tmp_qloop_22))*16.0 + ((tmp_qloop_23 + tmp_qloop_24)*(tmp_qloop_23 + tmp_qloop_24))*16.0 + ((tmp_qloop_25 + tmp_qloop_26)*(tmp_qloop_25 + tmp_qloop_26))*16.0);
                const real_t q_tmp_7_7 = tmp_qloop_5*(((jac_affine_inv_2_0_BLUE_DOWN*tmp_qloop_27*0.25 - tmp_qloop_10 - tmp_qloop_16)*(jac_affine_inv_2_0_BLUE_DOWN*tmp_qloop_27*0.25 - tmp_qloop_10 - tmp_qloop_16))*16.0 + ((jac_affine_inv_2_1_BLUE_DOWN*tmp_qloop_27*0.25 - tmp_qloop_12 - tmp_qloop_18)*(jac_affine_inv_2_1_BLUE_DOWN*tmp_qloop_27*0.25 - tmp_qloop_12 - tmp_qloop_18))*16.0 + ((jac_affine_inv_2_2_BLUE_DOWN*tmp_qloop_27*0.25 - tmp_qloop_14 - tmp_qloop_20)*(jac_affine_inv_2_2_BLUE_DOWN*tmp_qloop_27*0.25 - tmp_qloop_14 - tmp_qloop_20))*16.0);
                const real_t q_tmp_8_8 = tmp_qloop_5*(((jac_affine_inv_1_0_BLUE_DOWN*tmp_qloop_29*0.25 - tmp_qloop_22 - tmp_qloop_9)*(jac_affine_inv_1_0_BLUE_DOWN*tmp_qloop_29*0.25 - tmp_qloop_22 - tmp_qloop_9))*16.0 + ((jac_affine_inv_1_1_BLUE_DOWN*tmp_qloop_29*0.25 - tmp_qloop_11 - tmp_qloop_24)*(jac_affine_inv_1_1_BLUE_DOWN*tmp_qloop_29*0.25 - tmp_qloop_11 - tmp_qloop_24))*16.0 + ((jac_affine_inv_1_2_BLUE_DOWN*tmp_qloop_29*0.25 - tmp_qloop_13 - tmp_qloop_26)*(jac_affine_inv_1_2_BLUE_DOWN*tmp_qloop_29*0.25 - tmp_qloop_13 - tmp_qloop_26))*16.0);
                const real_t q_tmp_9_9 = tmp_qloop_5*(((jac_affine_inv_0_0_BLUE_DOWN*tmp_qloop_30*0.25 - tmp_qloop_15 - tmp_qloop_21)*(jac_affine_inv_0_0_BLUE_DOWN*tmp_qloop_30*0.25 - tmp_qloop_15 - tmp_qloop_21))*16.0 + ((jac_affine_inv_0_1_BLUE_DOWN*tmp_qloop_30*0.25 - tmp_qloop_17 - tmp_qloop_23)*(jac_affine_inv_0_1_BLUE_DOWN*tmp_qloop_30*0.25 - tmp_qloop_17 - tmp_qloop_23))*16.0 + ((jac_affine_inv_0_2_BLUE_DOWN*tmp_qloop_30*0.25 - tmp_qloop_19 - tmp_qloop_25)*(jac_affine_inv_0_2_BLUE_DOWN*tmp_qloop_30*0.25 - tmp_qloop_19 - tmp_qloop_25))*16.0);
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_1_1 = q_acc_1_1 + q_tmp_1_1;
                q_acc_2_2 = q_acc_2_2 + q_tmp_2_2;
                q_acc_3_3 = q_acc_3_3 + q_tmp_3_3;
       ...
       const real_t abs_det_jac_affine_GREEN_UP = abs(tmp_coords_jac_12_GREEN_UP);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                ...
                const real_t tmp_qloop_7 = ((-0.25 + _data_q_p_1[q])*(-0.25 + _data_q_p_1[q]))*16.0;
                const real_t tmp_qloop_8 = ((-0.25 + _data_q_p_2[q])*(-0.25 + _data_q_p_2[q]))*16.0;
                const real_t tmp_qloop_9 = jac_affine_inv_2_0_GREEN_UP*_data_q_p_1[q];
                const real_t tmp_qloop_10 = jac_affine_inv_1_0_GREEN_UP*_data_q_p_2[q];
                const real_t tmp_qloop_11 = jac_affine_inv_2_1_GREEN_UP*_data_q_p_1[q];
                const real_t tmp_qloop_12 = jac_affine_inv_1_1_GREEN_UP*_data_q_p_2[q];
                const real_t tmp_qloop_13 = jac_affine_inv_2_2_GREEN_UP*_data_q_p_1[q];
                const real_t tmp_qloop_14 = jac_affine_inv_1_2_GREEN_UP*_data_q_p_2[q];
                const real_t tmp_qloop_15 = jac_affine_inv_2_0_GREEN_UP*_data_q_p_0[q];
                const real_t tmp_qloop_16 = jac_affine_inv_0_0_GREEN_UP*_data_q_p_2[q];
                const real_t tmp_qloop_17 = jac_affine_inv_2_1_GREEN_UP*_data_q_p_0[q];
                const real_t tmp_qloop_18 = jac_affine_inv_0_1_GREEN_UP*_data_q_p_2[q];
                const real_t tmp_qloop_19 = jac_affine_inv_2_2_GREEN_UP*_data_q_p_0[q];
                const real_t tmp_qloop_20 = jac_affine_inv_0_2_GREEN_UP*_data_q_p_2[q];
                const real_t tmp_qloop_21 = jac_affine_inv_1_0_GREEN_UP*_data_q_p_0[q];
                const real_t tmp_qloop_22 = jac_affine_inv_0_0_GREEN_UP*_data_q_p_1[q];
                const real_t tmp_qloop_23 = jac_affine_inv_1_1_GREEN_UP*_data_q_p_0[q];
                const real_t tmp_qloop_24 = jac_affine_inv_0_1_GREEN_UP*_data_q_p_1[q];
                const real_t tmp_qloop_25 = jac_affine_inv_1_2_GREEN_UP*_data_q_p_0[q];
                const real_t tmp_qloop_26 = jac_affine_inv_0_2_GREEN_UP*_data_q_p_1[q];
                const real_t tmp_qloop_27 = -tmp_qloop_3 - 8.0*_data_q_p_2[q] + 4.0;
                const real_t tmp_qloop_28 = tmp_qloop_0 - 4.0;
                const real_t tmp_qloop_29 = -tmp_qloop_1 - tmp_qloop_28 - 8.0*_data_q_p_1[q];
                const real_t tmp_qloop_30 = -tmp_qloop_2 - tmp_qloop_28 - 8.0*_data_q_p_0[q];
                const real_t q_tmp_0_0 = tmp_qloop_5*(((jac_affine_inv_0_0_GREEN_UP*tmp_qloop_4 + jac_affine_inv_1_0_GREEN_UP*tmp_qloop_4 + jac_affine_inv_2_0_GREEN_UP*tmp_qloop_4)*(jac_affine_inv_0_0_GREEN_UP*tmp_qloop_4 + jac_affine_inv_1_0_GREEN_UP*tmp_qloop_4 + jac_affine_inv_2_0_GREEN_UP*tmp_qloop_4)) + ((jac_affine_inv_0_1_GREEN_UP*tmp_qloop_4 + jac_affine_inv_1_1_GREEN_UP*tmp_qloop_4 + jac_affine_inv_2_1_GREEN_UP*tmp_qloop_4)*(jac_affine_inv_0_1_GREEN_UP*tmp_qloop_4 + jac_affine_inv_1_1_GREEN_UP*tmp_qloop_4 + jac_affine_inv_2_1_GREEN_UP*tmp_qloop_4)) + ((jac_affine_inv_0_2_GREEN_UP*tmp_qloop_4 + jac_affine_inv_1_2_GREEN_UP*tmp_qloop_4 + jac_affine_inv_2_2_GREEN_UP*tmp_qloop_4)*(jac_affine_inv_0_2_GREEN_UP*tmp_qloop_4 + jac_affine_inv_1_2_GREEN_UP*tmp_qloop_4 + jac_affine_inv_2_2_GREEN_UP*tmp_qloop_4)));
                const real_t q_tmp_1_1 = tmp_qloop_5*((jac_affine_inv_0_0_GREEN_UP*jac_affine_inv_0_0_GREEN_UP)*tmp_qloop_6 + (jac_affine_inv_0_1_GREEN_UP*jac_affine_inv_0_1_GREEN_UP)*tmp_qloop_6 + (jac_affine_inv_0_2_GREEN_UP*jac_affine_inv_0_2_GREEN_UP)*tmp_qloop_6);
                const real_t q_tmp_2_2 = tmp_qloop_5*((jac_affine_inv_1_0_GREEN_UP*jac_affine_inv_1_0_GREEN_UP)*tmp_qloop_7 + (jac_affine_inv_1_1_GREEN_UP*jac_affine_inv_1_1_GREEN_UP)*tmp_qloop_7 + (jac_affine_inv_1_2_GREEN_UP*jac_affine_inv_1_2_GREEN_UP)*tmp_qloop_7);
                const real_t q_tmp_3_3 = tmp_qloop_5*((jac_affine_inv_2_0_GREEN_UP*jac_affine_inv_2_0_GREEN_UP)*tmp_qloop_8 + (jac_affine_inv_2_1_GREEN_UP*jac_affine_inv_2_1_GREEN_UP)*tmp_qloop_8 + (jac_affine_inv_2_2_GREEN_UP*jac_affine_inv_2_2_GREEN_UP)*tmp_qloop_8);
                const real_t q_tmp_4_4 = tmp_qloop_5*(((tmp_qloop_10 + tmp_qloop_9)*(tmp_qloop_10 + tmp_qloop_9))*16.0 + ((tmp_qloop_11 + tmp_qloop_12)*(tmp_qloop_11 + tmp_qloop_12))*16.0 + ((tmp_qloop_13 + tmp_qloop_14)*(tmp_qloop_13 + tmp_qloop_14))*16.0);
                const real_t q_tmp_5_5 = tmp_qloop_5*(((tmp_qloop_15 + tmp_qloop_16)*(tmp_qloop_15 + tmp_qloop_16))*16.0 + ((tmp_qloop_17 + tmp_qloop_18)*(tmp_qloop_17 + tmp_qloop_18))*16.0 + ((tmp_qloop_19 + tmp_qloop_20)*(tmp_qloop_19 + tmp_qloop_20))*16.0);
                const real_t q_tmp_6_6 = tmp_qloop_5*(((tmp_qloop_21 + tmp_qloop_22)*(tmp_qloop_21 + tmp_qloop_22))*16.0 + ((tmp_qloop_23 + tmp_qloop_24)*(tmp_qloop_23 + tmp_qloop_24))*16.0 + ((tmp_qloop_25 + tmp_qloop_26)*(tmp_qloop_25 + tmp_qloop_26))*16.0);
                const real_t q_tmp_7_7 = tmp_qloop_5*(((jac_affine_inv_2_0_GREEN_UP*tmp_qloop_27*0.25 - tmp_qloop_10 - tmp_qloop_16)*(jac_affine_inv_2_0_GREEN_UP*tmp_qloop_27*0.25 - tmp_qloop_10 - tmp_qloop_16))*16.0 + ((jac_affine_inv_2_1_GREEN_UP*tmp_qloop_27*0.25 - tmp_qloop_12 - tmp_qloop_18)*(jac_affine_inv_2_1_GREEN_UP*tmp_qloop_27*0.25 - tmp_qloop_12 - tmp_qloop_18))*16.0 + ((jac_affine_inv_2_2_GREEN_UP*tmp_qloop_27*0.25 - tmp_qloop_14 - tmp_qloop_20)*(jac_affine_inv_2_2_GREEN_UP*tmp_qloop_27*0.25 - tmp_qloop_14 - tmp_qloop_20))*16.0);
                const real_t q_tmp_8_8 = tmp_qloop_5*(((jac_affine_inv_1_0_GREEN_UP*tmp_qloop_29*0.25 - tmp_qloop_22 - tmp_qloop_9)*(jac_affine_inv_1_0_GREEN_UP*tmp_qloop_29*0.25 - tmp_qloop_22 - tmp_qloop_9))*16.0 + ((jac_affine_inv_1_1_GREEN_UP*tmp_qloop_29*0.25 - tmp_qloop_11 - tmp_qloop_24)*(jac_affine_inv_1_1_GREEN_UP*tmp_qloop_29*0.25 - tmp_qloop_11 - tmp_qloop_24))*16.0 + ((jac_affine_inv_1_2_GREEN_UP*tmp_qloop_29*0.25 - tmp_qloop_13 - tmp_qloop_26)*(jac_affine_inv_1_2_GREEN_UP*tmp_qloop_29*0.25 - tmp_qloop_13 - tmp_qloop_26))*16.0);
                const real_t q_tmp_9_9 = tmp_qloop_5*(((jac_affine_inv_0_0_GREEN_UP*tmp_qloop_30*0.25 - tmp_qloop_15 - tmp_qloop_21)*(jac_affine_inv_0_0_GREEN_UP*tmp_qloop_30*0.25 - tmp_qloop_15 - tmp_qloop_21))*16.0 + ((jac_affine_inv_0_1_GREEN_UP*tmp_qloop_30*0.25 - tmp_qloop_17 - tmp_qloop_23)*(jac_affine_inv_0_1_GREEN_UP*tmp_qloop_30*0.25 - tmp_qloop_17 - tmp_qloop_23))*16.0 + ((jac_affine_inv_0_2_GREEN_UP*tmp_qloop_30*0.25 - tmp_qloop_19 - tmp_qloop_25)*(jac_affine_inv_0_2_GREEN_UP*tmp_qloop_30*0.25 - tmp_qloop_19 - tmp_qloop_25))*16.0);
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_1_1 = q_acc_1_1 + q_tmp_1_1;
                q_acc_2_2 = q_acc_2_2 + q_tmp_2_2;
                q_acc_3_3 = q_acc_3_3 + q_tmp_3_3;
       ...
       const real_t abs_det_jac_affine_GREEN_DOWN = abs(tmp_coords_jac_15_GREEN_DOWN);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                ...
                const real_t tmp_qloop_7 = ((-0.25 + _data_q_p_1[q])*(-0.25 + _data_q_p_1[q]))*16.0;
                const real_t tmp_qloop_8 = ((-0.25 + _data_q_p_2[q])*(-0.25 + _data_q_p_2[q]))*16.0;
                const real_t tmp_qloop_9 = jac_affine_inv_2_0_GREEN_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_10 = jac_affine_inv_1_0_GREEN_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_11 = jac_affine_inv_2_1_GREEN_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_12 = jac_affine_inv_1_1_GREEN_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_13 = jac_affine_inv_2_2_GREEN_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_14 = jac_affine_inv_1_2_GREEN_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_15 = jac_affine_inv_2_0_GREEN_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_16 = jac_affine_inv_0_0_GREEN_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_17 = jac_affine_inv_2_1_GREEN_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_18 = jac_affine_inv_0_1_GREEN_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_19 = jac_affine_inv_2_2_GREEN_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_20 = jac_affine_inv_0_2_GREEN_DOWN*_data_q_p_2[q];
                const real_t tmp_qloop_21 = jac_affine_inv_1_0_GREEN_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_22 = jac_affine_inv_0_0_GREEN_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_23 = jac_affine_inv_1_1_GREEN_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_24 = jac_affine_inv_0_1_GREEN_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_25 = jac_affine_inv_1_2_GREEN_DOWN*_data_q_p_0[q];
                const real_t tmp_qloop_26 = jac_affine_inv_0_2_GREEN_DOWN*_data_q_p_1[q];
                const real_t tmp_qloop_27 = -tmp_qloop_3 - 8.0*_data_q_p_2[q] + 4.0;
                const real_t tmp_qloop_28 = tmp_qloop_0 - 4.0;
                const real_t tmp_qloop_29 = -tmp_qloop_1 - tmp_qloop_28 - 8.0*_data_q_p_1[q];
                const real_t tmp_qloop_30 = -tmp_qloop_2 - tmp_qloop_28 - 8.0*_data_q_p_0[q];
                const real_t q_tmp_0_0 = tmp_qloop_5*(((jac_affine_inv_0_0_GREEN_DOWN*tmp_qloop_4 + jac_affine_inv_1_0_GREEN_DOWN*tmp_qloop_4 + jac_affine_inv_2_0_GREEN_DOWN*tmp_qloop_4)*(jac_affine_inv_0_0_GREEN_DOWN*tmp_qloop_4 + jac_affine_inv_1_0_GREEN_DOWN*tmp_qloop_4 + jac_affine_inv_2_0_GREEN_DOWN*tmp_qloop_4)) + ((jac_affine_inv_0_1_GREEN_DOWN*tmp_qloop_4 + jac_affine_inv_1_1_GREEN_DOWN*tmp_qloop_4 + jac_affine_inv_2_1_GREEN_DOWN*tmp_qloop_4)*(jac_affine_inv_0_1_GREEN_DOWN*tmp_qloop_4 + jac_affine_inv_1_1_GREEN_DOWN*tmp_qloop_4 + jac_affine_inv_2_1_GREEN_DOWN*tmp_qloop_4)) + ((jac_affine_inv_0_2_GREEN_DOWN*tmp_qloop_4 + jac_affine_inv_1_2_GREEN_DOWN*tmp_qloop_4 + jac_affine_inv_2_2_GREEN_DOWN*tmp_qloop_4)*(jac_affine_inv_0_2_GREEN_DOWN*tmp_qloop_4 + jac_affine_inv_1_2_GREEN_DOWN*tmp_qloop_4 + jac_affine_inv_2_2_GREEN_DOWN*tmp_qloop_4)));
                const real_t q_tmp_1_1 = tmp_qloop_5*((jac_affine_inv_0_0_GREEN_DOWN*jac_affine_inv_0_0_GREEN_DOWN)*tmp_qloop_6 + (jac_affine_inv_0_1_GREEN_DOWN*jac_affine_inv_0_1_GREEN_DOWN)*tmp_qloop_6 + (jac_affine_inv_0_2_GREEN_DOWN*jac_affine_inv_0_2_GREEN_DOWN)*tmp_qloop_6);
                const real_t q_tmp_2_2 = tmp_qloop_5*((jac_affine_inv_1_0_GREEN_DOWN*jac_affine_inv_1_0_GREEN_DOWN)*tmp_qloop_7 + (jac_affine_inv_1_1_GREEN_DOWN*jac_affine_inv_1_1_GREEN_DOWN)*tmp_qloop_7 + (jac_affine_inv_1_2_GREEN_DOWN*jac_affine_inv_1_2_GREEN_DOWN)*tmp_qloop_7);
                const real_t q_tmp_3_3 = tmp_qloop_5*((jac_affine_inv_2_0_GREEN_DOWN*jac_affine_inv_2_0_GREEN_DOWN)*tmp_qloop_8 + (jac_affine_inv_2_1_GREEN_DOWN*jac_affine_inv_2_1_GREEN_DOWN)*tmp_qloop_8 + (jac_affine_inv_2_2_GREEN_DOWN*jac_affine_inv_2_2_GREEN_DOWN)*tmp_qloop_8);
                const real_t q_tmp_4_4 = tmp_qloop_5*(((tmp_qloop_10 + tmp_qloop_9)*(tmp_qloop_10 + tmp_qloop_9))*16.0 + ((tmp_qloop_11 + tmp_qloop_12)*(tmp_qloop_11 + tmp_qloop_12))*16.0 + ((tmp_qloop_13 + tmp_qloop_14)*(tmp_qloop_13 + tmp_qloop_14))*16.0);
                const real_t q_tmp_5_5 = tmp_qloop_5*(((tmp_qloop_15 + tmp_qloop_16)*(tmp_qloop_15 + tmp_qloop_16))*16.0 + ((tmp_qloop_17 + tmp_qloop_18)*(tmp_qloop_17 + tmp_qloop_18))*16.0 + ((tmp_qloop_19 + tmp_qloop_20)*(tmp_qloop_19 + tmp_qloop_20))*16.0);
                const real_t q_tmp_6_6 = tmp_qloop_5*(((tmp_qloop_21 + tmp_qloop_22)*(tmp_qloop_21 + tmp_qloop_22))*16.0 + ((tmp_qloop_23 + tmp_qloop_24)*(tmp_qloop_23 + tmp_qloop_24))*16.0 + ((tmp_qloop_25 + tmp_qloop_26)*(tmp_qloop_25 + tmp_qloop_26))*16.0);
                const real_t q_tmp_7_7 = tmp_qloop_5*(((jac_affine_inv_2_0_GREEN_DOWN*tmp_qloop_27*0.25 - tmp_qloop_10 - tmp_qloop_16)*(jac_affine_inv_2_0_GREEN_DOWN*tmp_qloop_27*0.25 - tmp_qloop_10 - tmp_qloop_16))*16.0 + ((jac_affine_inv_2_1_GREEN_DOWN*tmp_qloop_27*0.25 - tmp_qloop_12 - tmp_qloop_18)*(jac_affine_inv_2_1_GREEN_DOWN*tmp_qloop_27*0.25 - tmp_qloop_12 - tmp_qloop_18))*16.0 + ((jac_affine_inv_2_2_GREEN_DOWN*tmp_qloop_27*0.25 - tmp_qloop_14 - tmp_qloop_20)*(jac_affine_inv_2_2_GREEN_DOWN*tmp_qloop_27*0.25 - tmp_qloop_14 - tmp_qloop_20))*16.0);
                const real_t q_tmp_8_8 = tmp_qloop_5*(((jac_affine_inv_1_0_GREEN_DOWN*tmp_qloop_29*0.25 - tmp_qloop_22 - tmp_qloop_9)*(jac_affine_inv_1_0_GREEN_DOWN*tmp_qloop_29*0.25 - tmp_qloop_22 - tmp_qloop_9))*16.0 + ((jac_affine_inv_1_1_GREEN_DOWN*tmp_qloop_29*0.25 - tmp_qloop_11 - tmp_qloop_24)*(jac_affine_inv_1_1_GREEN_DOWN*tmp_qloop_29*0.25 - tmp_qloop_11 - tmp_qloop_24))*16.0 + ((jac_affine_inv_1_2_GREEN_DOWN*tmp_qloop_29*0.25 - tmp_qloop_13 - tmp_qloop_26)*(jac_affine_inv_1_2_GREEN_DOWN*tmp_qloop_29*0.25 - tmp_qloop_13 - tmp_qloop_26))*16.0);
                const real_t q_tmp_9_9 = tmp_qloop_5*(((jac_affine_inv_0_0_GREEN_DOWN*tmp_qloop_30*0.25 - tmp_qloop_15 - tmp_qloop_21)*(jac_affine_inv_0_0_GREEN_DOWN*tmp_qloop_30*0.25 - tmp_qloop_15 - tmp_qloop_21))*16.0 + ((jac_affine_inv_0_1_GREEN_DOWN*tmp_qloop_30*0.25 - tmp_qloop_17 - tmp_qloop_23)*(jac_affine_inv_0_1_GREEN_DOWN*tmp_qloop_30*0.25 - tmp_qloop_17 - tmp_qloop_23))*16.0 + ((jac_affine_inv_0_2_GREEN_DOWN*tmp_qloop_30*0.25 - tmp_qloop_19 - tmp_qloop_25)*(jac_affine_inv_0_2_GREEN_DOWN*tmp_qloop_30*0.25 - tmp_qloop_19 - tmp_qloop_25))*16.0);
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_1_1 = q_acc_1_1 + q_tmp_1_1;
                q_acc_2_2 = q_acc_2_2 + q_tmp_2_2;
                q_acc_3_3 = q_acc_3_3 + q_tmp_3_3;
