       ...
       const real_t p_affine_const_3_2_WHITE_UP = macro_vertex_coord_id_0comp2 + tmp_coords_jac_0_WHITE_UP*(-macro_vertex_coord_id_0comp2 + macro_vertex_coord_id_3comp2);
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                ...
                const real_t tmp_qloop_73 = (k_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q] - _data_q_p_2[q]) + k_dof_1*_data_q_p_0[q] + k_dof_2*_data_q_p_1[q] + k_dof_3*_data_q_p_2[q])*abs(tmp_qloop_64*tmp_qloop_65*tmp_qloop_66 - tmp_qloop_64*tmp_qloop_69*tmp_qloop_71 - tmp_qloop_65*tmp_qloop_68*tmp_qloop_72 - tmp_qloop_66*tmp_qloop_67*tmp_qloop_70 + tmp_qloop_67*tmp_qloop_68*tmp_qloop_69 + tmp_qloop_70*tmp_qloop_71*tmp_qloop_72)*_data_q_w[q]*_data_tabulated_and_untitled_0_0_WHITE_UP[9*q + 1];
