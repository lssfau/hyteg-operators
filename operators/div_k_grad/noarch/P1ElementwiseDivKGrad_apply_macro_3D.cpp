...
{
    {
       ...
       const walberla::float64 tmp_q_0 = -jac_affine_inv_0_0_WHITE_UP - jac_affine_inv_1_0_WHITE_UP - jac_affine_inv_2_0_WHITE_UP;
       const walberla::float64 tmp_q_1 = -jac_affine_inv_0_1_WHITE_UP - jac_affine_inv_1_1_WHITE_UP - jac_affine_inv_2_1_WHITE_UP;
       const walberla::float64 tmp_q_2 = -jac_affine_inv_0_2_WHITE_UP - jac_affine_inv_1_2_WHITE_UP - jac_affine_inv_2_2_WHITE_UP;
       {
          /* CellType.WHITE_UP */
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             {
                const walberla::float64 tmp_q_3 = abs_det_jac_affine_WHITE_UP*(k_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q] - _data_q_p_2[q]) + k_dof_1*_data_q_p_0[q] + k_dof_2*_data_q_p_1[q] + k_dof_3*_data_q_p_2[q])*_data_q_w[q];
                const walberla::float64 q_tmp_0_0 = tmp_q_3*((tmp_q_0*tmp_q_0) + (tmp_q_1*tmp_q_1) + (tmp_q_2*tmp_q_2));
                const walberla::float64 q_tmp_0_1 = tmp_q_3*(jac_affine_inv_0_0_WHITE_UP*tmp_q_0 + jac_affine_inv_0_1_WHITE_UP*tmp_q_1 + jac_affine_inv_0_2_WHITE_UP*tmp_q_2);
                const walberla::float64 q_tmp_0_2 = tmp_q_3*(jac_affine_inv_1_0_WHITE_UP*tmp_q_0 + jac_affine_inv_1_1_WHITE_UP*tmp_q_1 + jac_affine_inv_1_2_WHITE_UP*tmp_q_2);
                const walberla::float64 q_tmp_0_3 = tmp_q_3*(jac_affine_inv_2_0_WHITE_UP*tmp_q_0 + jac_affine_inv_2_1_WHITE_UP*tmp_q_1 + jac_affine_inv_2_2_WHITE_UP*tmp_q_2);
                const walberla::float64 q_tmp_1_1 = tmp_q_3*((jac_affine_inv_0_0_WHITE_UP*jac_affine_inv_0_0_WHITE_UP) + (jac_affine_inv_0_1_WHITE_UP*jac_affine_inv_0_1_WHITE_UP) + (jac_affine_inv_0_2_WHITE_UP*jac_affine_inv_0_2_WHITE_UP));
                const walberla::float64 q_tmp_1_2 = tmp_q_3*(jac_affine_inv_0_0_WHITE_UP*jac_affine_inv_1_0_WHITE_UP + jac_affine_inv_0_1_WHITE_UP*jac_affine_inv_1_1_WHITE_UP + jac_affine_inv_0_2_WHITE_UP*jac_affine_inv_1_2_WHITE_UP);
                const walberla::float64 q_tmp_1_3 = tmp_q_3*(jac_affine_inv_0_0_WHITE_UP*jac_affine_inv_2_0_WHITE_UP + jac_affine_inv_0_1_WHITE_UP*jac_affine_inv_2_1_WHITE_UP + jac_affine_inv_0_2_WHITE_UP*jac_affine_inv_2_2_WHITE_UP);
                const walberla::float64 q_tmp_2_2 = tmp_q_3*((jac_affine_inv_1_0_WHITE_UP*jac_affine_inv_1_0_WHITE_UP) + (jac_affine_inv_1_1_WHITE_UP*jac_affine_inv_1_1_WHITE_UP) + (jac_affine_inv_1_2_WHITE_UP*jac_affine_inv_1_2_WHITE_UP));
                const walberla::float64 q_tmp_2_3 = tmp_q_3*(jac_affine_inv_1_0_WHITE_UP*jac_affine_inv_2_0_WHITE_UP + jac_affine_inv_1_1_WHITE_UP*jac_affine_inv_2_1_WHITE_UP + jac_affine_inv_1_2_WHITE_UP*jac_affine_inv_2_2_WHITE_UP);
                const walberla::float64 q_tmp_3_3 = tmp_q_3*((jac_affine_inv_2_0_WHITE_UP*jac_affine_inv_2_0_WHITE_UP) + (jac_affine_inv_2_1_WHITE_UP*jac_affine_inv_2_1_WHITE_UP) + (jac_affine_inv_2_2_WHITE_UP*jac_affine_inv_2_2_WHITE_UP));
       ...
       const walberla::float64 Dummy_1918 = -jac_affine_inv_0_0_WHITE_DOWN - jac_affine_inv_1_0_WHITE_DOWN - jac_affine_inv_2_0_WHITE_DOWN;
       const walberla::float64 Dummy_1919 = -jac_affine_inv_0_1_WHITE_DOWN - jac_affine_inv_1_1_WHITE_DOWN - jac_affine_inv_2_1_WHITE_DOWN;
       const walberla::float64 Dummy_1920 = -jac_affine_inv_0_2_WHITE_DOWN - jac_affine_inv_1_2_WHITE_DOWN - jac_affine_inv_2_2_WHITE_DOWN;
       {
          /* CellType.WHITE_DOWN */
          for (int64_t ctr_2 = 0; ctr_2 < micro_edges_per_macro_edge; ctr_2 += 1)
          for (int64_t ctr_1 = 0; ctr_1 < -ctr_2 + micro_edges_per_macro_edge; ctr_1 += 1)
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 2; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                const walberla::float64 tmp_q_3 = abs_det_jac_affine_WHITE_DOWN*(k_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q] - _data_q_p_2[q]) + k_dof_1*_data_q_p_0[q] + k_dof_2*_data_q_p_1[q] + k_dof_3*_data_q_p_2[q])*_data_q_w[q];
                const walberla::float64 q_tmp_0_0 = tmp_q_3*((Dummy_1918*Dummy_1918) + (Dummy_1919*Dummy_1919) + (Dummy_1920*Dummy_1920));
                const walberla::float64 q_tmp_0_1 = tmp_q_3*(Dummy_1918*jac_affine_inv_0_0_WHITE_DOWN + Dummy_1919*jac_affine_inv_0_1_WHITE_DOWN + Dummy_1920*jac_affine_inv_0_2_WHITE_DOWN);
                const walberla::float64 q_tmp_0_2 = tmp_q_3*(Dummy_1918*jac_affine_inv_1_0_WHITE_DOWN + Dummy_1919*jac_affine_inv_1_1_WHITE_DOWN + Dummy_1920*jac_affine_inv_1_2_WHITE_DOWN);
                const walberla::float64 q_tmp_0_3 = tmp_q_3*(Dummy_1918*jac_affine_inv_2_0_WHITE_DOWN + Dummy_1919*jac_affine_inv_2_1_WHITE_DOWN + Dummy_1920*jac_affine_inv_2_2_WHITE_DOWN);
                const walberla::float64 q_tmp_1_1 = tmp_q_3*((jac_affine_inv_0_0_WHITE_DOWN*jac_affine_inv_0_0_WHITE_DOWN) + (jac_affine_inv_0_1_WHITE_DOWN*jac_affine_inv_0_1_WHITE_DOWN) + (jac_affine_inv_0_2_WHITE_DOWN*jac_affine_inv_0_2_WHITE_DOWN));
                const walberla::float64 q_tmp_1_2 = tmp_q_3*(jac_affine_inv_0_0_WHITE_DOWN*jac_affine_inv_1_0_WHITE_DOWN + jac_affine_inv_0_1_WHITE_DOWN*jac_affine_inv_1_1_WHITE_DOWN + jac_affine_inv_0_2_WHITE_DOWN*jac_affine_inv_1_2_WHITE_DOWN);
                const walberla::float64 q_tmp_1_3 = tmp_q_3*(jac_affine_inv_0_0_WHITE_DOWN*jac_affine_inv_2_0_WHITE_DOWN + jac_affine_inv_0_1_WHITE_DOWN*jac_affine_inv_2_1_WHITE_DOWN + jac_affine_inv_0_2_WHITE_DOWN*jac_affine_inv_2_2_WHITE_DOWN);
                const walberla::float64 q_tmp_2_2 = tmp_q_3*((jac_affine_inv_1_0_WHITE_DOWN*jac_affine_inv_1_0_WHITE_DOWN) + (jac_affine_inv_1_1_WHITE_DOWN*jac_affine_inv_1_1_WHITE_DOWN) + (jac_affine_inv_1_2_WHITE_DOWN*jac_affine_inv_1_2_WHITE_DOWN));
                const walberla::float64 q_tmp_2_3 = tmp_q_3*(jac_affine_inv_1_0_WHITE_DOWN*jac_affine_inv_2_0_WHITE_DOWN + jac_affine_inv_1_1_WHITE_DOWN*jac_affine_inv_2_1_WHITE_DOWN + jac_affine_inv_1_2_WHITE_DOWN*jac_affine_inv_2_2_WHITE_DOWN);
                const walberla::float64 q_tmp_3_3 = tmp_q_3*((jac_affine_inv_2_0_WHITE_DOWN*jac_affine_inv_2_0_WHITE_DOWN) + (jac_affine_inv_2_1_WHITE_DOWN*jac_affine_inv_2_1_WHITE_DOWN) + (jac_affine_inv_2_2_WHITE_DOWN*jac_affine_inv_2_2_WHITE_DOWN));
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_0_1 = q_acc_0_1 + q_tmp_0_1;
                q_acc_0_2 = q_acc_0_2 + q_tmp_0_2;
                q_acc_0_3 = q_acc_0_3 + q_tmp_0_3;
       ...
       const walberla::float64 Dummy_1921 = -jac_affine_inv_0_0_BLUE_UP - jac_affine_inv_1_0_BLUE_UP - jac_affine_inv_2_0_BLUE_UP;
       const walberla::float64 Dummy_1922 = -jac_affine_inv_0_1_BLUE_UP - jac_affine_inv_1_1_BLUE_UP - jac_affine_inv_2_1_BLUE_UP;
       const walberla::float64 Dummy_1923 = -jac_affine_inv_0_2_BLUE_UP - jac_affine_inv_1_2_BLUE_UP - jac_affine_inv_2_2_BLUE_UP;
       {
          /* CellType.BLUE_UP */
          for (int64_t ctr_2 = 0; ctr_2 < micro_edges_per_macro_edge; ctr_2 += 1)
          for (int64_t ctr_1 = 0; ctr_1 < -ctr_2 + micro_edges_per_macro_edge; ctr_1 += 1)
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                const walberla::float64 tmp_q_3 = abs_det_jac_affine_BLUE_UP*(k_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q] - _data_q_p_2[q]) + k_dof_1*_data_q_p_0[q] + k_dof_2*_data_q_p_1[q] + k_dof_3*_data_q_p_2[q])*_data_q_w[q];
                const walberla::float64 q_tmp_0_0 = tmp_q_3*((Dummy_1921*Dummy_1921) + (Dummy_1922*Dummy_1922) + (Dummy_1923*Dummy_1923));
                const walberla::float64 q_tmp_0_1 = tmp_q_3*(Dummy_1921*jac_affine_inv_0_0_BLUE_UP + Dummy_1922*jac_affine_inv_0_1_BLUE_UP + Dummy_1923*jac_affine_inv_0_2_BLUE_UP);
                const walberla::float64 q_tmp_0_2 = tmp_q_3*(Dummy_1921*jac_affine_inv_1_0_BLUE_UP + Dummy_1922*jac_affine_inv_1_1_BLUE_UP + Dummy_1923*jac_affine_inv_1_2_BLUE_UP);
                const walberla::float64 q_tmp_0_3 = tmp_q_3*(Dummy_1921*jac_affine_inv_2_0_BLUE_UP + Dummy_1922*jac_affine_inv_2_1_BLUE_UP + Dummy_1923*jac_affine_inv_2_2_BLUE_UP);
                const walberla::float64 q_tmp_1_1 = tmp_q_3*((jac_affine_inv_0_0_BLUE_UP*jac_affine_inv_0_0_BLUE_UP) + (jac_affine_inv_0_1_BLUE_UP*jac_affine_inv_0_1_BLUE_UP) + (jac_affine_inv_0_2_BLUE_UP*jac_affine_inv_0_2_BLUE_UP));
                const walberla::float64 q_tmp_1_2 = tmp_q_3*(jac_affine_inv_0_0_BLUE_UP*jac_affine_inv_1_0_BLUE_UP + jac_affine_inv_0_1_BLUE_UP*jac_affine_inv_1_1_BLUE_UP + jac_affine_inv_0_2_BLUE_UP*jac_affine_inv_1_2_BLUE_UP);
                const walberla::float64 q_tmp_1_3 = tmp_q_3*(jac_affine_inv_0_0_BLUE_UP*jac_affine_inv_2_0_BLUE_UP + jac_affine_inv_0_1_BLUE_UP*jac_affine_inv_2_1_BLUE_UP + jac_affine_inv_0_2_BLUE_UP*jac_affine_inv_2_2_BLUE_UP);
                const walberla::float64 q_tmp_2_2 = tmp_q_3*((jac_affine_inv_1_0_BLUE_UP*jac_affine_inv_1_0_BLUE_UP) + (jac_affine_inv_1_1_BLUE_UP*jac_affine_inv_1_1_BLUE_UP) + (jac_affine_inv_1_2_BLUE_UP*jac_affine_inv_1_2_BLUE_UP));
                const walberla::float64 q_tmp_2_3 = tmp_q_3*(jac_affine_inv_1_0_BLUE_UP*jac_affine_inv_2_0_BLUE_UP + jac_affine_inv_1_1_BLUE_UP*jac_affine_inv_2_1_BLUE_UP + jac_affine_inv_1_2_BLUE_UP*jac_affine_inv_2_2_BLUE_UP);
                const walberla::float64 q_tmp_3_3 = tmp_q_3*((jac_affine_inv_2_0_BLUE_UP*jac_affine_inv_2_0_BLUE_UP) + (jac_affine_inv_2_1_BLUE_UP*jac_affine_inv_2_1_BLUE_UP) + (jac_affine_inv_2_2_BLUE_UP*jac_affine_inv_2_2_BLUE_UP));
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_0_1 = q_acc_0_1 + q_tmp_0_1;
                q_acc_0_2 = q_acc_0_2 + q_tmp_0_2;
                q_acc_0_3 = q_acc_0_3 + q_tmp_0_3;
       ...
       const walberla::float64 Dummy_1924 = -jac_affine_inv_0_0_BLUE_DOWN - jac_affine_inv_1_0_BLUE_DOWN - jac_affine_inv_2_0_BLUE_DOWN;
       const walberla::float64 Dummy_1925 = -jac_affine_inv_0_1_BLUE_DOWN - jac_affine_inv_1_1_BLUE_DOWN - jac_affine_inv_2_1_BLUE_DOWN;
       const walberla::float64 Dummy_1926 = -jac_affine_inv_0_2_BLUE_DOWN - jac_affine_inv_1_2_BLUE_DOWN - jac_affine_inv_2_2_BLUE_DOWN;
       {
          /* CellType.BLUE_DOWN */
          for (int64_t ctr_2 = 0; ctr_2 < micro_edges_per_macro_edge; ctr_2 += 1)
          for (int64_t ctr_1 = 0; ctr_1 < -ctr_2 + micro_edges_per_macro_edge; ctr_1 += 1)
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                const walberla::float64 tmp_q_3 = abs_det_jac_affine_BLUE_DOWN*(k_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q] - _data_q_p_2[q]) + k_dof_1*_data_q_p_0[q] + k_dof_2*_data_q_p_1[q] + k_dof_3*_data_q_p_2[q])*_data_q_w[q];
                const walberla::float64 q_tmp_0_0 = tmp_q_3*((Dummy_1924*Dummy_1924) + (Dummy_1925*Dummy_1925) + (Dummy_1926*Dummy_1926));
                const walberla::float64 q_tmp_0_1 = tmp_q_3*(Dummy_1924*jac_affine_inv_0_0_BLUE_DOWN + Dummy_1925*jac_affine_inv_0_1_BLUE_DOWN + Dummy_1926*jac_affine_inv_0_2_BLUE_DOWN);
                const walberla::float64 q_tmp_0_2 = tmp_q_3*(Dummy_1924*jac_affine_inv_1_0_BLUE_DOWN + Dummy_1925*jac_affine_inv_1_1_BLUE_DOWN + Dummy_1926*jac_affine_inv_1_2_BLUE_DOWN);
                const walberla::float64 q_tmp_0_3 = tmp_q_3*(Dummy_1924*jac_affine_inv_2_0_BLUE_DOWN + Dummy_1925*jac_affine_inv_2_1_BLUE_DOWN + Dummy_1926*jac_affine_inv_2_2_BLUE_DOWN);
                const walberla::float64 q_tmp_1_1 = tmp_q_3*((jac_affine_inv_0_0_BLUE_DOWN*jac_affine_inv_0_0_BLUE_DOWN) + (jac_affine_inv_0_1_BLUE_DOWN*jac_affine_inv_0_1_BLUE_DOWN) + (jac_affine_inv_0_2_BLUE_DOWN*jac_affine_inv_0_2_BLUE_DOWN));
                const walberla::float64 q_tmp_1_2 = tmp_q_3*(jac_affine_inv_0_0_BLUE_DOWN*jac_affine_inv_1_0_BLUE_DOWN + jac_affine_inv_0_1_BLUE_DOWN*jac_affine_inv_1_1_BLUE_DOWN + jac_affine_inv_0_2_BLUE_DOWN*jac_affine_inv_1_2_BLUE_DOWN);
                const walberla::float64 q_tmp_1_3 = tmp_q_3*(jac_affine_inv_0_0_BLUE_DOWN*jac_affine_inv_2_0_BLUE_DOWN + jac_affine_inv_0_1_BLUE_DOWN*jac_affine_inv_2_1_BLUE_DOWN + jac_affine_inv_0_2_BLUE_DOWN*jac_affine_inv_2_2_BLUE_DOWN);
                const walberla::float64 q_tmp_2_2 = tmp_q_3*((jac_affine_inv_1_0_BLUE_DOWN*jac_affine_inv_1_0_BLUE_DOWN) + (jac_affine_inv_1_1_BLUE_DOWN*jac_affine_inv_1_1_BLUE_DOWN) + (jac_affine_inv_1_2_BLUE_DOWN*jac_affine_inv_1_2_BLUE_DOWN));
                const walberla::float64 q_tmp_2_3 = tmp_q_3*(jac_affine_inv_1_0_BLUE_DOWN*jac_affine_inv_2_0_BLUE_DOWN + jac_affine_inv_1_1_BLUE_DOWN*jac_affine_inv_2_1_BLUE_DOWN + jac_affine_inv_1_2_BLUE_DOWN*jac_affine_inv_2_2_BLUE_DOWN);
                const walberla::float64 q_tmp_3_3 = tmp_q_3*((jac_affine_inv_2_0_BLUE_DOWN*jac_affine_inv_2_0_BLUE_DOWN) + (jac_affine_inv_2_1_BLUE_DOWN*jac_affine_inv_2_1_BLUE_DOWN) + (jac_affine_inv_2_2_BLUE_DOWN*jac_affine_inv_2_2_BLUE_DOWN));
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_0_1 = q_acc_0_1 + q_tmp_0_1;
                q_acc_0_2 = q_acc_0_2 + q_tmp_0_2;
                q_acc_0_3 = q_acc_0_3 + q_tmp_0_3;
       ...
       const walberla::float64 Dummy_1927 = -jac_affine_inv_0_0_GREEN_UP - jac_affine_inv_1_0_GREEN_UP - jac_affine_inv_2_0_GREEN_UP;
       const walberla::float64 Dummy_1928 = -jac_affine_inv_0_1_GREEN_UP - jac_affine_inv_1_1_GREEN_UP - jac_affine_inv_2_1_GREEN_UP;
       const walberla::float64 Dummy_1929 = -jac_affine_inv_0_2_GREEN_UP - jac_affine_inv_1_2_GREEN_UP - jac_affine_inv_2_2_GREEN_UP;
       {
          /* CellType.GREEN_UP */
          for (int64_t ctr_2 = 0; ctr_2 < micro_edges_per_macro_edge; ctr_2 += 1)
          for (int64_t ctr_1 = 0; ctr_1 < -ctr_2 + micro_edges_per_macro_edge; ctr_1 += 1)
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                const walberla::float64 tmp_q_3 = abs_det_jac_affine_GREEN_UP*(k_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q] - _data_q_p_2[q]) + k_dof_1*_data_q_p_0[q] + k_dof_2*_data_q_p_1[q] + k_dof_3*_data_q_p_2[q])*_data_q_w[q];
                const walberla::float64 q_tmp_0_0 = tmp_q_3*((Dummy_1927*Dummy_1927) + (Dummy_1928*Dummy_1928) + (Dummy_1929*Dummy_1929));
                const walberla::float64 q_tmp_0_1 = tmp_q_3*(Dummy_1927*jac_affine_inv_0_0_GREEN_UP + Dummy_1928*jac_affine_inv_0_1_GREEN_UP + Dummy_1929*jac_affine_inv_0_2_GREEN_UP);
                const walberla::float64 q_tmp_0_2 = tmp_q_3*(Dummy_1927*jac_affine_inv_1_0_GREEN_UP + Dummy_1928*jac_affine_inv_1_1_GREEN_UP + Dummy_1929*jac_affine_inv_1_2_GREEN_UP);
                const walberla::float64 q_tmp_0_3 = tmp_q_3*(Dummy_1927*jac_affine_inv_2_0_GREEN_UP + Dummy_1928*jac_affine_inv_2_1_GREEN_UP + Dummy_1929*jac_affine_inv_2_2_GREEN_UP);
                const walberla::float64 q_tmp_1_1 = tmp_q_3*((jac_affine_inv_0_0_GREEN_UP*jac_affine_inv_0_0_GREEN_UP) + (jac_affine_inv_0_1_GREEN_UP*jac_affine_inv_0_1_GREEN_UP) + (jac_affine_inv_0_2_GREEN_UP*jac_affine_inv_0_2_GREEN_UP));
                const walberla::float64 q_tmp_1_2 = tmp_q_3*(jac_affine_inv_0_0_GREEN_UP*jac_affine_inv_1_0_GREEN_UP + jac_affine_inv_0_1_GREEN_UP*jac_affine_inv_1_1_GREEN_UP + jac_affine_inv_0_2_GREEN_UP*jac_affine_inv_1_2_GREEN_UP);
                const walberla::float64 q_tmp_1_3 = tmp_q_3*(jac_affine_inv_0_0_GREEN_UP*jac_affine_inv_2_0_GREEN_UP + jac_affine_inv_0_1_GREEN_UP*jac_affine_inv_2_1_GREEN_UP + jac_affine_inv_0_2_GREEN_UP*jac_affine_inv_2_2_GREEN_UP);
                const walberla::float64 q_tmp_2_2 = tmp_q_3*((jac_affine_inv_1_0_GREEN_UP*jac_affine_inv_1_0_GREEN_UP) + (jac_affine_inv_1_1_GREEN_UP*jac_affine_inv_1_1_GREEN_UP) + (jac_affine_inv_1_2_GREEN_UP*jac_affine_inv_1_2_GREEN_UP));
                const walberla::float64 q_tmp_2_3 = tmp_q_3*(jac_affine_inv_1_0_GREEN_UP*jac_affine_inv_2_0_GREEN_UP + jac_affine_inv_1_1_GREEN_UP*jac_affine_inv_2_1_GREEN_UP + jac_affine_inv_1_2_GREEN_UP*jac_affine_inv_2_2_GREEN_UP);
                const walberla::float64 q_tmp_3_3 = tmp_q_3*((jac_affine_inv_2_0_GREEN_UP*jac_affine_inv_2_0_GREEN_UP) + (jac_affine_inv_2_1_GREEN_UP*jac_affine_inv_2_1_GREEN_UP) + (jac_affine_inv_2_2_GREEN_UP*jac_affine_inv_2_2_GREEN_UP));
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_0_1 = q_acc_0_1 + q_tmp_0_1;
                q_acc_0_2 = q_acc_0_2 + q_tmp_0_2;
                q_acc_0_3 = q_acc_0_3 + q_tmp_0_3;
       ...
       const walberla::float64 Dummy_1930 = -jac_affine_inv_0_0_GREEN_DOWN - jac_affine_inv_1_0_GREEN_DOWN - jac_affine_inv_2_0_GREEN_DOWN;
       const walberla::float64 Dummy_1931 = -jac_affine_inv_0_1_GREEN_DOWN - jac_affine_inv_1_1_GREEN_DOWN - jac_affine_inv_2_1_GREEN_DOWN;
       const walberla::float64 Dummy_1932 = -jac_affine_inv_0_2_GREEN_DOWN - jac_affine_inv_1_2_GREEN_DOWN - jac_affine_inv_2_2_GREEN_DOWN;
       {
          /* CellType.GREEN_DOWN */
          for (int64_t ctr_2 = 0; ctr_2 < micro_edges_per_macro_edge; ctr_2 += 1)
          for (int64_t ctr_1 = 0; ctr_1 < -ctr_2 + micro_edges_per_macro_edge; ctr_1 += 1)
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 - ctr_2 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             for (int64_t q = 0; q < 4; q += 1)
             {
                const walberla::float64 tmp_q_3 = abs_det_jac_affine_GREEN_DOWN*(k_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q] - _data_q_p_2[q]) + k_dof_1*_data_q_p_0[q] + k_dof_2*_data_q_p_1[q] + k_dof_3*_data_q_p_2[q])*_data_q_w[q];
                const walberla::float64 q_tmp_0_0 = tmp_q_3*((Dummy_1930*Dummy_1930) + (Dummy_1931*Dummy_1931) + (Dummy_1932*Dummy_1932));
                const walberla::float64 q_tmp_0_1 = tmp_q_3*(Dummy_1930*jac_affine_inv_0_0_GREEN_DOWN + Dummy_1931*jac_affine_inv_0_1_GREEN_DOWN + Dummy_1932*jac_affine_inv_0_2_GREEN_DOWN);
                const walberla::float64 q_tmp_0_2 = tmp_q_3*(Dummy_1930*jac_affine_inv_1_0_GREEN_DOWN + Dummy_1931*jac_affine_inv_1_1_GREEN_DOWN + Dummy_1932*jac_affine_inv_1_2_GREEN_DOWN);
                const walberla::float64 q_tmp_0_3 = tmp_q_3*(Dummy_1930*jac_affine_inv_2_0_GREEN_DOWN + Dummy_1931*jac_affine_inv_2_1_GREEN_DOWN + Dummy_1932*jac_affine_inv_2_2_GREEN_DOWN);
                const walberla::float64 q_tmp_1_1 = tmp_q_3*((jac_affine_inv_0_0_GREEN_DOWN*jac_affine_inv_0_0_GREEN_DOWN) + (jac_affine_inv_0_1_GREEN_DOWN*jac_affine_inv_0_1_GREEN_DOWN) + (jac_affine_inv_0_2_GREEN_DOWN*jac_affine_inv_0_2_GREEN_DOWN));
                const walberla::float64 q_tmp_1_2 = tmp_q_3*(jac_affine_inv_0_0_GREEN_DOWN*jac_affine_inv_1_0_GREEN_DOWN + jac_affine_inv_0_1_GREEN_DOWN*jac_affine_inv_1_1_GREEN_DOWN + jac_affine_inv_0_2_GREEN_DOWN*jac_affine_inv_1_2_GREEN_DOWN);
                const walberla::float64 q_tmp_1_3 = tmp_q_3*(jac_affine_inv_0_0_GREEN_DOWN*jac_affine_inv_2_0_GREEN_DOWN + jac_affine_inv_0_1_GREEN_DOWN*jac_affine_inv_2_1_GREEN_DOWN + jac_affine_inv_0_2_GREEN_DOWN*jac_affine_inv_2_2_GREEN_DOWN);
                const walberla::float64 q_tmp_2_2 = tmp_q_3*((jac_affine_inv_1_0_GREEN_DOWN*jac_affine_inv_1_0_GREEN_DOWN) + (jac_affine_inv_1_1_GREEN_DOWN*jac_affine_inv_1_1_GREEN_DOWN) + (jac_affine_inv_1_2_GREEN_DOWN*jac_affine_inv_1_2_GREEN_DOWN));
                const walberla::float64 q_tmp_2_3 = tmp_q_3*(jac_affine_inv_1_0_GREEN_DOWN*jac_affine_inv_2_0_GREEN_DOWN + jac_affine_inv_1_1_GREEN_DOWN*jac_affine_inv_2_1_GREEN_DOWN + jac_affine_inv_1_2_GREEN_DOWN*jac_affine_inv_2_2_GREEN_DOWN);
                const walberla::float64 q_tmp_3_3 = tmp_q_3*((jac_affine_inv_2_0_GREEN_DOWN*jac_affine_inv_2_0_GREEN_DOWN) + (jac_affine_inv_2_1_GREEN_DOWN*jac_affine_inv_2_1_GREEN_DOWN) + (jac_affine_inv_2_2_GREEN_DOWN*jac_affine_inv_2_2_GREEN_DOWN));
                q_acc_0_0 = q_acc_0_0 + q_tmp_0_0;
                q_acc_0_1 = q_acc_0_1 + q_tmp_0_1;
                q_acc_0_2 = q_acc_0_2 + q_tmp_0_2;
                q_acc_0_3 = q_acc_0_3 + q_tmp_0_3;
