...
{
    {
       ...
       const double Dummy_3376 = macro_vertex_coord_id_0comp0 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_1comp0)*1.0;
       const double Dummy_3377 = macro_vertex_coord_id_0comp1 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_1comp1)*1.0;
       const double Dummy_3378 = macro_vertex_coord_id_0comp0 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_2comp0)*1.0;
       const double Dummy_3379 = macro_vertex_coord_id_0comp1 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1)*1.0;
       const double Dummy_3380 = macro_vertex_coord_id_0comp0 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_1comp0)*1.0 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_2comp0)*1.0;
       const double Dummy_3381 = macro_vertex_coord_id_0comp1 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_1comp1)*1.0 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1)*1.0;
       const double Dummy_3382 = -Dummy_3376 + Dummy_3378;
       const double Dummy_3383 = -Dummy_3376 + Dummy_3380;
       const double Dummy_3384 = -Dummy_3377 + Dummy_3379;
       const double Dummy_3385 = -Dummy_3377 + Dummy_3381;
       const double Dummy_3386 = Dummy_3385*1.0 / (Dummy_3382*Dummy_3385 - Dummy_3383*Dummy_3384);
       const double Dummy_3387 = -Dummy_3383*1.0 / (Dummy_3382*Dummy_3385 - Dummy_3383*Dummy_3384);
       const double Dummy_3388 = -Dummy_3384*1.0 / (Dummy_3382*Dummy_3385 - Dummy_3383*Dummy_3384);
       const double Dummy_3389 = Dummy_3382*1.0 / (Dummy_3382*Dummy_3385 - Dummy_3383*Dummy_3384);
       const double Dummy_3390 = fabs(Dummy_3382*Dummy_3385 - Dummy_3383*Dummy_3384);
       const double Dummy_3391 = -Dummy_3386 - Dummy_3388;
       const double Dummy_3392 = -Dummy_3387 - Dummy_3389;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             {
                const double tmp_q_1 = k_dof_0*(1.0 - _data_q_p_0[q] - _data_q_p_1[q]) + k_dof_1*_data_q_p_0[q] + k_dof_2*_data_q_p_1[q];
                const double tmp_q_2 = Dummy_3386*tmp_q_1;
                const double tmp_q_3 = Dummy_3388*tmp_q_1;
                const double tmp_q_5 = Dummy_3387*tmp_q_1;
                const double tmp_q_6 = Dummy_3389*tmp_q_1;
                const double tmp_q_7 = Dummy_3390*_data_q_w[q];
                const double res_tmp_0_0 = tmp_q_7*(Dummy_3391*(-tmp_q_2 - tmp_q_3) + Dummy_3392*(-tmp_q_5 - tmp_q_6));
                const double res_tmp_0_1 = tmp_q_7*(Dummy_3391*tmp_q_2 + Dummy_3392*tmp_q_5);
                const double res_tmp_0_2 = tmp_q_7*(Dummy_3391*tmp_q_3 + Dummy_3392*tmp_q_6);
                const double res_tmp_1_1 = tmp_q_7*((Dummy_3386*Dummy_3386)*tmp_q_1 + (Dummy_3387*Dummy_3387)*tmp_q_1);
                const double res_tmp_1_2 = tmp_q_7*(Dummy_3388*tmp_q_2 + Dummy_3389*tmp_q_5);
                const double res_tmp_2_2 = tmp_q_7*((Dummy_3388*Dummy_3388)*tmp_q_1 + (Dummy_3389*Dummy_3389)*tmp_q_1);
                q_acc_0_0 = q_acc_0_0 + res_tmp_0_0;
                q_acc_0_1 = q_acc_0_1 + res_tmp_0_1;
                q_acc_0_2 = q_acc_0_2 + res_tmp_0_2;
                q_acc_1_1 = q_acc_1_1 + res_tmp_1_1;
