                              ...
                              public OperatorWithInverseDiagonal< P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     95     105      12       0      0              0                 0              1
   void applyScaled_P1ElementwiseDivKGrad_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    277     276      36       0      0              0                 0              1
   void applyScaled_P1ElementwiseDivKGrad_macro_3D( real_t* RESTRICT _data_dst,
                                                    real_t* RESTRICT _data_k,
                                                    real_t* RESTRICT _data_src,
                                                    real_t           macro_vertex_coord_id_0comp0,
                                                    real_t           macro_vertex_coord_id_0comp1,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     86      99      12       0      0              0                 0              4
   void toMatrixScaled_P1ElementwiseDivKGrad_macro_2D( idx_t* RESTRICT                      _data_dst,
                                                       real_t* RESTRICT                     _data_k,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    261     266      36       0      0              0                 0              4
   void toMatrixScaled_P1ElementwiseDivKGrad_macro_3D( idx_t* RESTRICT                      _data_dst,
                                                       real_t* RESTRICT                     _data_k,
                                                       idx_t* RESTRICT                      _data_src,
                                                       real_t                               macro_vertex_coord_id_0comp0,
                                                       real_t                               macro_vertex_coord_id_0comp1,
   ...
   ///     71      69      12       0      0              0                 0              1
   void
       computeInverseDiagonalOperatorValuesScaled_P1ElementwiseDivKGrad_macro_2D( real_t* RESTRICT _data_invDiag_,
                                                                                  real_t* RESTRICT _data_k,
                                                                                  real_t           diagScaling,
                                                                                  real_t           macro_vertex_coord_id_0comp0,
                                                                                  real_t           macro_vertex_coord_id_0comp1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    193     164      36       0      0              0                 0              1
   void
       computeInverseDiagonalOperatorValuesScaled_P1ElementwiseDivKGrad_macro_3D( real_t* RESTRICT _data_invDiag_,
                                                                                  real_t* RESTRICT _data_k,
                                                                                  real_t           diagScaling,
                                                                                  real_t           macro_vertex_coord_id_0comp0,
                                                                                  real_t           macro_vertex_coord_id_0comp1,
