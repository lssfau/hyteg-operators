...
///     - ∫ T(u · g) w
///
class P2ElementwiseAdiabaticHeatingAnnulusMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseAdiabaticHeatingAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                            size_t                                     minLevel,
                                            size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseAdiabaticHeatingAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1078    1586      52      50     30              0                 0              1
   void applyScaled_P2ElementwiseAdiabaticHeatingAnnulusMap_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1042    1565      52      50     30              0                 0              4
   void toMatrixScaled_P2ElementwiseAdiabaticHeatingAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    898    1400      52      50     30              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseAdiabaticHeatingAnnulusMap_macro_2D(
