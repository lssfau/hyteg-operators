...
P2ElementwiseAdiabaticHeatingAnnulusMap::P2ElementwiseAdiabaticHeatingAnnulusMap(
...
void P2ElementwiseAdiabaticHeatingAnnulusMap::applyScaled( const real_t&               operatorScaling,
                                                           ...
                                                           UpdateType                  updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseAdiabaticHeatingAnnulusMap_macro_2D(
...
void P2ElementwiseAdiabaticHeatingAnnulusMap::apply( const P2Function< real_t >& src,
                                                     const P2Function< real_t >& dst,
                                                     uint_t                      level,
                                                     DoFType                     flag,
                                                     UpdateType                  updateType ) const
...
void P2ElementwiseAdiabaticHeatingAnnulusMap::toMatrixScaled( const real_t&                               toMatrixScaling,
...
void P2ElementwiseAdiabaticHeatingAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                        const P2Function< idx_t >&                  src,
                                                        const P2Function< idx_t >&                  dst,
                                                        uint_t                                      level,
                                                        DoFType                                     flag ) const
...
void P2ElementwiseAdiabaticHeatingAnnulusMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
...
void P2ElementwiseAdiabaticHeatingAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseAdiabaticHeatingAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
