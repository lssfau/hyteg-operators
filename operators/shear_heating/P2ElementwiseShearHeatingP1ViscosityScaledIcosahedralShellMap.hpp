...
class P2ElementwiseShearHeatingP1ViscosityScaledIcosahedralShellMap
: public Operator< P2Function< real_t >, P2Function< real_t > >,
  public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseShearHeatingP1ViscosityScaledIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                  size_t                                     minLevel,
                                                                  size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseShearHeatingP1ViscosityScaledIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4841    6608      78      28      0              0                 0              1
   void applyScaled_P2ElementwiseShearHeatingP1ViscosityScaledIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4741    6553      78      28      0              0                 0              4
   void toMatrixScaled_P2ElementwiseShearHeatingP1ViscosityScaledIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4121    5878      78      28      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseShearHeatingP1ViscosityScaledIcosahedralShellMap_macro_3D(
       real_t* RESTRICT _data_eta,
