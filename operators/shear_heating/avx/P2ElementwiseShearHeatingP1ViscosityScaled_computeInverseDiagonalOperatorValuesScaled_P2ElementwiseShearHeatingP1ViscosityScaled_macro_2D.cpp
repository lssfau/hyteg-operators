                ...
                {
                   {
                      ...
                      for (int64_t q = 0; q < 7; q += 1)
                      {
                         ...
                         const __m256d tmp_qloop_11 = _mm256_mul_pd(tmp_moved_constant_6,tmp_qloop_3);
                         const __m256d tmp_qloop_12 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_moved_constant_11,tmp_qloop_5),_mm256_mul_pd(tmp_moved_constant_7,tmp_qloop_2)),_mm256_mul_pd(tmp_moved_constant_9,tmp_qloop_0)),_mm256_mul_pd(_mm256_mul_pd(tmp_moved_constant_10,tmp_qloop_0),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_11);
                         const __m256d tmp_qloop_13 = _mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_moved_constant_10,tmp_qloop_8),_mm256_mul_pd(tmp_moved_constant_8,tmp_qloop_7)),_mm256_mul_pd(tmp_moved_constant_9,tmp_qloop_1)),_mm256_mul_pd(_mm256_mul_pd(tmp_moved_constant_11,tmp_qloop_1),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_11);
                         ...
                         const __m256d tmp_qloop_19 = _mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_17,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)),_mm256_mul_pd(tmp_qloop_18,_mm256_set_pd(-1.0,-1.0,-1.0,-1.0))),tmp_qloop_16);
                         const __m256d tmp_qloop_20 = _mm256_mul_pd(_mm256_mul_pd(_mm256_mul_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_moved_constant_0,_mm256_set_pd(_data_phi_0_0_BLUE[9*q + 6],_data_phi_0_0_BLUE[9*q + 6],_data_phi_0_0_BLUE[9*q + 6],_data_phi_0_0_BLUE[9*q + 6])),_mm256_mul_pd(tmp_moved_constant_1,_mm256_set_pd(_data_phi_0_0_BLUE[9*q + 7],_data_phi_0_0_BLUE[9*q + 7],_data_phi_0_0_BLUE[9*q + 7],_data_phi_0_0_BLUE[9*q + 7]))),_mm256_mul_pd(tmp_moved_constant_2,_mm256_set_pd(_data_phi_0_0_BLUE[9*q + 8],_data_phi_0_0_BLUE[9*q + 8],_data_phi_0_0_BLUE[9*q + 8],_data_phi_0_0_BLUE[9*q + 8]))),_mm256_div_pd(_mm256_set_pd(1.0,1.0,1.0,1.0),_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_moved_constant_3,_mm256_set_pd(_data_phi_0_0_BLUE[9*q + 6],_data_phi_0_0_BLUE[9*q + 6],_data_phi_0_0_BLUE[9*q + 6],_data_phi_0_0_BLUE[9*q + 6])),_mm256_mul_pd(tmp_moved_constant_4,_mm256_set_pd(_data_phi_0_0_BLUE[9*q + 7],_data_phi_0_0_BLUE[9*q + 7],_data_phi_0_0_BLUE[9*q + 7],_data_phi_0_0_BLUE[9*q + 7]))),_mm256_mul_pd(tmp_moved_constant_5,_mm256_set_pd(_data_phi_0_0_BLUE[9*q + 8],_data_phi_0_0_BLUE[9*q + 8],_data_phi_0_0_BLUE[9*q + 8],_data_phi_0_0_BLUE[9*q + 8]))))),_mm256_add_pd(_mm256_add_pd(_mm256_add_pd(_mm256_mul_pd(tmp_qloop_10,tmp_qloop_15),_mm256_mul_pd(tmp_qloop_14,tmp_qloop_15)),_mm256_mul_pd(tmp_qloop_16,tmp_qloop_19)),_mm256_mul_pd(_mm256_mul_pd(tmp_qloop_19,_mm256_add_pd(tmp_qloop_17,tmp_qloop_18)),_mm256_set_pd(-1.0,-1.0,-1.0,-1.0)))),_mm256_set_pd(_data_q_w[q],_data_q_w[q],_data_q_w[q],_data_q_w[q]));
