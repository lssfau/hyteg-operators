...
#include "P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap.hpp"
...
P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap::
    P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap(
                                                                                          ...
                                                                                          UpdateType updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap_macro_3D(
...
void P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap::apply( const P2Function< real_t >& src,
                                                                                    const P2Function< real_t >& dst,
                                                                                    uint_t                      level,
                                                                                    DoFType                     flag,
                                                                                    UpdateType                  updateType ) const
    ...
    DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap_macro_3D(
...
void P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap::toMatrix(
    const std::shared_ptr< SparseMatrixProxy >& mat,
    const P2Function< idx_t >&                  src,
    const P2Function< idx_t >&                  dst,
    uint_t                                      level,
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap_macro_3D(
