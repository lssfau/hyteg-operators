...
P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap(
...
void P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::apply( const P2Function< real_t >& src,
                                                                           const P2Function< real_t >& dst,
                                                                           uint_t                      level,
                                                                           DoFType                     flag,
                                                                           UpdateType                  updateType ) const
...
void P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::toMatrixScaled(
...
void P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                              const P2Function< idx_t >&                  src,
                                                                              const P2Function< idx_t >&                  dst,
                                                                              uint_t                                      level,
                                                                              DoFType flag ) const
...
void P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::computeInverseDiagonalOperatorValuesScaled(
...
void P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > >
    P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceAnnulusMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
