...
class P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap
  ...
  public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 ...
 protected:
 private:
   /// Integral: P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5233    7210     106      56     70              0                 0              1
   void applyScaled_P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5133    7155     106      56     70              0                 0              4
   void toMatrixScaled_P2ElementwiseShearHeatingP1ViscosityScaledNoSurfaceIcosahedralShellMap_macro_3D(
