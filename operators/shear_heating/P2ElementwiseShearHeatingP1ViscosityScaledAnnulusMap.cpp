...
P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap::P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap(
...
void P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap::applyScaled( const real_t&               operatorScaling,
                                                                        ...
                                                                        UpdateType                  updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap_macro_2D(
...
void P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap::apply( const P2Function< real_t >& src,
                                                                  const P2Function< real_t >& dst,
                                                                  uint_t                      level,
                                                                  DoFType                     flag,
                                                                  UpdateType                  updateType ) const
                                                                           ...
                                                                           DoFType flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap_macro_2D(
...
void P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                     const P2Function< idx_t >&                  src,
                                                                     const P2Function< idx_t >&                  dst,
                                                                     uint_t                                      level,
                                                                     DoFType                                     flag ) const
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap_macro_2D(
