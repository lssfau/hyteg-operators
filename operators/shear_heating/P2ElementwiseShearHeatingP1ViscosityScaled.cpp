...
P2ElementwiseShearHeatingP1ViscosityScaled::P2ElementwiseShearHeatingP1ViscosityScaled(
...
void P2ElementwiseShearHeatingP1ViscosityScaled::applyScaled( const real_t&               operatorScaling,
                                                              ...
                                                              UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseShearHeatingP1ViscosityScaled_macro_3D(
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseShearHeatingP1ViscosityScaled_macro_2D(
...
void P2ElementwiseShearHeatingP1ViscosityScaled::apply( const P2Function< real_t >& src,
                                                        const P2Function< real_t >& dst,
                                                        uint_t                      level,
                                                        DoFType                     flag,
                                                        UpdateType                  updateType ) const
...
void P2ElementwiseShearHeatingP1ViscosityScaled::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                                 ...
                                                                 DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseShearHeatingP1ViscosityScaled_macro_3D(
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ElementwiseShearHeatingP1ViscosityScaled_macro_2D(
...
void P2ElementwiseShearHeatingP1ViscosityScaled::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                           const P2Function< idx_t >&                  src,
                                                           const P2Function< idx_t >&                  dst,
                                                           uint_t                                      level,
                                                           DoFType                                     flag ) const
...
void P2ElementwiseShearHeatingP1ViscosityScaled::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseShearHeatingP1ViscosityScaled_macro_3D(
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseShearHeatingP1ViscosityScaled_macro_2D(
...
void P2ElementwiseShearHeatingP1ViscosityScaled::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseShearHeatingP1ViscosityScaled::getInverseDiagonalValues() const
{
   return invDiag_;
}
