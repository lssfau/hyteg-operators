...
class P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                             public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                         size_t                                     minLevel,
                                                         size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    852    1137      33      21      0              0                 0              1
   void applyScaled_P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    816    1116      33      21      0              0                 0              4
   void toMatrixScaled_P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    717     996      33      21      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseShearHeatingP1ViscosityScaledAnnulusMap_macro_2D(
       real_t* RESTRICT _data_eta,
