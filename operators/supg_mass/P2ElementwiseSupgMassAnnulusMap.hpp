...
class P2ElementwiseSupgMassAnnulusMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                        public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgMassAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                    size_t                                     minLevel,
                                    size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgMassAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    968    1638      84      66     42              0                 0              1
   void applyScaled_P2ElementwiseSupgMassAnnulusMap_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    932    1632      84      66     42              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgMassAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    758    1422      84      66     42              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgMassAnnulusMap_macro_2D(
   ...
   real_t                                  thermal_conductivity_P2ElementwiseSupgMassAnnulusMap_;
};
