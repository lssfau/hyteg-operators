...
class P2ElementwiseSupgMassIcosahedralShellMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                 public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgMassIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                             size_t                                     minLevel,
                                             size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgMassIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   5022    7101     157     154    209              0                 0              1
   void applyScaled_P2ElementwiseSupgMassIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4922    7091     157     154    209              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgMassIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3942    6011     157     154    209              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgMassIcosahedralShellMap_macro_3D(
   ...
   real_t                                  thermal_conductivity_P2ElementwiseSupgMassIcosahedralShellMap_;
};
