...
class P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap : public Operator< P2Function< real_t >, P2Function< real_t > >,
                                                           public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                       size_t                                     minLevel,
                                                       size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4318    6122      58      22      0              0                 0              1
   void applyScaled_P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_deltaEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   4218    6112      58      22      0              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_deltaEdge,
                                                                                    real_t* RESTRICT _data_deltaVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   3238    5032      58      22      0              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap_macro_3D(
