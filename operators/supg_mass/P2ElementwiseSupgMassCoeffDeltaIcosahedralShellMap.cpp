...
#include "P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap.hpp"
...
P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap::P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap(
...
void P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap::applyScaled( const real_t&               operatorScaling,
                                                                      ...
                                                                      UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap::apply( const P2Function< real_t >& src,
                                                                const P2Function< real_t >& dst,
                                                                uint_t                      level,
                                                                DoFType                     flag,
                                                                UpdateType                  updateType ) const
...
void P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap::toMatrixScaled( const real_t& toMatrixScaling,
                                                                         ...
                                                                         DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                   const P2Function< idx_t >&                  src,
                                                                   const P2Function< idx_t >&                  dst,
                                                                   uint_t                                      level,
                                                                   DoFType                                     flag ) const
...
void P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap_macro_3D(
...
void P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseSupgMassCoeffDeltaIcosahedralShellMap::getInverseDiagonalValues() const
{
   return invDiag_;
}
