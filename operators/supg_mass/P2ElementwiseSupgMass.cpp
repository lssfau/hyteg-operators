...
P2ElementwiseSupgMass::P2ElementwiseSupgMass( const std::shared_ptr< PrimitiveStorage >& storage,
                                              ...
                                              real_t thermalConductivity_P2ElementwiseSupgMass )
: Operator( storage, minLevel, maxLevel )
, ux( _ux )
, uy( _uy )
, uz( _uz )
, thermalConductivity_P2ElementwiseSupgMass_( thermalConductivity_P2ElementwiseSupgMass )
{}
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseSupgMass_macro_3D(
             ...
             operatorScaling,
             thermalConductivity_P2ElementwiseSupgMass_ );
