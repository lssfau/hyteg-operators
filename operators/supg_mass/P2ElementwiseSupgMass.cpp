...
P2ElementwiseSupgMass::P2ElementwiseSupgMass( const std::shared_ptr< PrimitiveStorage >& storage,
                                              size_t                                     minLevel,
                                              size_t                                     maxLevel,
                                              const P2Function< real_t >&                _ux,
                                              const P2Function< real_t >&                _uy,
                                              const P2Function< real_t >&                _uz,
                                              real_t thermal_conductivity_P2ElementwiseSupgMass )
: Operator( storage, minLevel, maxLevel )
, ux( _ux )
, uy( _uy )
, uz( _uz )
, thermal_conductivity_P2ElementwiseSupgMass_( thermal_conductivity_P2ElementwiseSupgMass )
{}

void P2ElementwiseSupgMass::applyScaled( const real_t&               operatorScaling,
                                         ...
                                         UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ElementwiseSupgMass_macro_3D(
             ...
             operatorScaling,
             thermal_conductivity_P2ElementwiseSupgMass_ );
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ElementwiseSupgMass_macro_2D(
...
void P2ElementwiseSupgMass::apply( const P2Function< real_t >& src,
                                   const P2Function< real_t >& dst,
                                   uint_t                      level,
                                   DoFType                     flag,
                                   UpdateType                  updateType ) const
...
void P2ElementwiseSupgMass::toMatrixScaled( const real_t&                               toMatrixScaling,
                                            ...
                                            DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgMass_macro_3D(
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ElementwiseSupgMass_macro_2D(
...
void P2ElementwiseSupgMass::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                      const P2Function< idx_t >&                  src,
                                      const P2Function< idx_t >&                  dst,
                                      uint_t                                      level,
                                      DoFType                                     flag ) const
...
void P2ElementwiseSupgMass::computeInverseDiagonalOperatorValuesScaled( const real_t& diagScaling )
{
   ...
   for ( uint_t level = minLevel_; level <= maxLevel_; level++ )
   {
      ...
      if ( storage_->hasGlobalCells() )
      {
         ...
         for ( auto& it : storage_->getCells() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgMass_macro_3D(
      ...
      else
      {
         ...
         for ( auto& it : storage_->getFaces() )
         {
            ...
            computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgMass_macro_2D(
...
void P2ElementwiseSupgMass::computeInverseDiagonalOperatorValues()
{
   return computeInverseDiagonalOperatorValuesScaled( static_cast< real_t >( 1 ) );
}
std::shared_ptr< P2Function< real_t > > P2ElementwiseSupgMass::getInverseDiagonalValues() const
{
   return invDiag_;
}
