...
class P2ElementwiseSupgMass : public Operator< P2Function< real_t >, P2Function< real_t > >,
                              public OperatorWithInverseDiagonal< P2Function< real_t > >
{
 public:
   P2ElementwiseSupgMass( const std::shared_ptr< PrimitiveStorage >& storage,
                          size_t                                     minLevel,
                          size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2ElementwiseSupgMass
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    512     864      72      48     42              0                 0              1
   void applyScaled_P2ElementwiseSupgMass_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2415    2998     135     132    209              0                 0              1
   void applyScaled_P2ElementwiseSupgMass_macro_3D( real_t* RESTRICT _data_dstEdge,
                                                    real_t* RESTRICT _data_dstVertex,
                                                    real_t* RESTRICT _data_srcEdge,
                                                    real_t* RESTRICT _data_srcVertex,
                                                    real_t* RESTRICT _data_uxEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    476     858      72      48     42              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgMass_macro_2D( idx_t* RESTRICT                      _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2315    2988     135     132    209              0                 0              4
   void toMatrixScaled_P2ElementwiseSupgMass_macro_3D( idx_t* RESTRICT                      _data_dstEdge,
                                                       idx_t* RESTRICT                      _data_dstVertex,
                                                       idx_t* RESTRICT                      _data_srcEdge,
                                                       idx_t* RESTRICT                      _data_srcVertex,
                                                       real_t* RESTRICT                     _data_uxEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    302     648      72      48     42              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgMass_macro_2D( real_t* RESTRICT _data_invDiag_Edge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1335    1908     135     132    209              0                 0              1
   void computeInverseDiagonalOperatorValuesScaled_P2ElementwiseSupgMass_macro_3D( real_t* RESTRICT _data_invDiag_Edge,
                                                                                   real_t* RESTRICT _data_invDiag_Vertex,
                                                                                   real_t* RESTRICT _data_uxEdge,
                                                                                   real_t* RESTRICT _data_uxVertex,
                                                                                   real_t* RESTRICT _data_uyEdge,
   ...
   real_t                                  thermal_conductivity_P2ElementwiseSupgMass_;
};
