...
void P2ElementwiseSupgMass::toMatrixScaled_P2ElementwiseSupgMass_macro_2D( idx_t * RESTRICT  _data_dstEdge, idx_t * RESTRICT  _data_dstVertex, idx_t * RESTRICT  _data_srcEdge, idx_t * RESTRICT  _data_srcVertex, real_t * RESTRICT  _data_uxEdge, real_t * RESTRICT  _data_uxVertex, real_t * RESTRICT  _data_uyEdge, real_t * RESTRICT  _data_uyVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t thermalConductivity, real_t toMatrixScaling ) const
{
    {
             ...
             {
                {
                   ...
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      const real_t tmp_qloop_0 = tmp_moved_constant_0*_data_phi_0_0_BLUE[6*q] + tmp_moved_constant_1*_data_phi_0_0_BLUE[6*q + 1] + tmp_moved_constant_2*_data_phi_0_0_BLUE[6*q + 2] + tmp_moved_constant_3*_data_phi_0_0_BLUE[6*q + 3] + tmp_moved_constant_4*_data_phi_0_0_BLUE[6*q + 4] + tmp_moved_constant_5*_data_phi_0_0_BLUE[6*q + 5];
                      const real_t tmp_qloop_1 = tmp_moved_constant_10*_data_phi_0_0_BLUE[6*q + 4] + tmp_moved_constant_11*_data_phi_0_0_BLUE[6*q + 5] + tmp_moved_constant_6*_data_phi_0_0_BLUE[6*q] + tmp_moved_constant_7*_data_phi_0_0_BLUE[6*q + 1] + tmp_moved_constant_8*_data_phi_0_0_BLUE[6*q + 2] + tmp_moved_constant_9*_data_phi_0_0_BLUE[6*q + 3];
                      const real_t tmp_qloop_2 = (tmp_qloop_0*tmp_qloop_0) + (tmp_qloop_1*tmp_qloop_1);
                      const real_t tmp_qloop_3 = pow(tmp_qloop_2, 0.50000000000000000);
                      const real_t tmp_qloop_4 = 1.0 / (tmp_qloop_3);
                      const real_t tmp_qloop_6 = pow(tmp_qloop_2, 1.5000000000000000);
