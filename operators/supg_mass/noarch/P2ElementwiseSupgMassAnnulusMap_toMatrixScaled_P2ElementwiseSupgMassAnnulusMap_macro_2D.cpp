             ...
             {
                {
                   ...
                   const real_t tmp_qloop_66 = abs(tmp_qloop_0*tmp_qloop_8 - tmp_qloop_2*tmp_qloop_6);
                   const real_t tmp_qloop_67 = 1.0 / (tmp_qloop_66*tmp_qloop_66*tmp_qloop_66);
                   const real_t tmp_qloop_68 = tmp_moved_constant_15*tmp_qloop_58*tmp_qloop_61*tmp_qloop_63*tmp_qloop_65*tmp_qloop_67;
                   const real_t tmp_qloop_70 = pow(tmp_qloop_60, 0.50000000000000000);
                   const real_t tmp_qloop_71 = pow(tmp_qloop_62, 0.50000000000000000);
                   const real_t tmp_qloop_72 = pow(tmp_qloop_64, 0.50000000000000000);
                   const real_t tmp_qloop_73 = 1.0 / (tmp_qloop_66);
                   ...
                   for (int64_t q = 0; q < 6; q += 1)
                   {
                      ...
                      const real_t tmp_qloop_51 = -tmp_qloop_43 + tmp_qloop_44*-4.0 + 4.0*_data_q_p_0[q];
                      const real_t tmp_qloop_52 = tmp_qloop_43 + tmp_qloop_45 + tmp_qloop_48 - 3.0*_data_q_p_0[q] - 3.0*_data_q_p_1[q] + 1.0;
                      const real_t tmp_qloop_53 = tmp_moved_constant_0*tmp_qloop_52 + tmp_moved_constant_1*tmp_qloop_46 + tmp_moved_constant_2*tmp_qloop_49 + tmp_moved_constant_3*tmp_qloop_43 + tmp_moved_constant_4*tmp_qloop_50 + tmp_moved_constant_5*tmp_qloop_51;
                      const real_t tmp_qloop_54 = tmp_moved_constant_10*tmp_qloop_50 + tmp_moved_constant_11*tmp_qloop_51 + tmp_moved_constant_6*tmp_qloop_52 + tmp_moved_constant_7*tmp_qloop_46 + tmp_moved_constant_8*tmp_qloop_49 + tmp_moved_constant_9*tmp_qloop_43;
                      const real_t jac_blending_0_0 = tmp_qloop_10*tmp_qloop_24 + tmp_qloop_20*tmp_qloop_3;
                      const real_t jac_blending_0_1 = -tmp_qloop_21*tmp_qloop_22*tmp_qloop_3*tmp_qloop_9 - tmp_qloop_25*tmp_qloop_3;
                      const real_t jac_blending_1_0 = tmp_qloop_20*tmp_qloop_9 - tmp_qloop_26*tmp_qloop_9;
                      const real_t jac_blending_1_1 = tmp_qloop_21*tmp_qloop_22*tmp_qloop_5*1.0 - tmp_qloop_25*tmp_qloop_9;
