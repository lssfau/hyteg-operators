...
///
class P1ToP2VectorElementwiseGradientRotationIcosahedralShellMap
: public Operator< P1Function< real_t >, P2VectorFunction< real_t > >
{
 public:
   P1ToP2VectorElementwiseGradientRotationIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                               size_t                                     minLevel,
                                                               size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P1ToP2VectorElementwiseGradientRotationIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2252    4612      71      44     30              0                 0              1
   void apply_P1ToP2VectorElementwiseGradientRotationIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2132    4492      71      44     30              0                 0              4
   void toMatrix_P1ToP2VectorElementwiseGradientRotationIcosahedralShellMap_macro_3D( idx_t* RESTRICT  _data_dst_edge_0,
