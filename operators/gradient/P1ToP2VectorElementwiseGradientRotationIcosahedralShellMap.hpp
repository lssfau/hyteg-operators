...
: public Operator< P1Function< real_t >, P2VectorFunction< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2252    4642      71      44     30              0                 0              1
   void applyScaled_P1ToP2VectorElementwiseGradientRotationIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2132    4612      71      44     30              0                 0              4
   void toMatrixScaled_P1ToP2VectorElementwiseGradientRotationIcosahedralShellMap_macro_3D(
