...
void P1ToP2ElementwiseGradientAnnulusMap_0_0::applyScaled_P1ToP2ElementwiseGradientAnnulusMap_0_0_macro_2D( real_t * RESTRICT  _data_dstEdge, real_t * RESTRICT  _data_dstVertex, real_t * RESTRICT  _data_src, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling, real_t radRayVertex, real_t radRefVertex, real_t rayVertex_0, real_t rayVertex_1, real_t refVertex_0, real_t refVertex_1, real_t thrVertex_0, real_t thrVertex_1 ) const
{
    {
       ...
       const real_t tmp_kernel_op_55 = -tmp_kernel_op_11 + 2.666666666666667;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             const real_t tmp_kernel_op_4 = tmp_kernel_op_3*(-jac_blending_inv_0_0_q_0*(jac_affine_inv_0_0_GRAY*tmp_kernel_op_2 + jac_affine_inv_1_0_GRAY*tmp_kernel_op_2) - jac_blending_inv_1_0_q_0*(jac_affine_inv_0_1_GRAY*tmp_kernel_op_2 + jac_affine_inv_1_1_GRAY*tmp_kernel_op_2));
             const real_t tmp_kernel_op_8 = abs_det_jac_affine_GRAY*abs_det_jac_blending_q_1*0.16666666666666666;
             const real_t tmp_kernel_op_9 = tmp_kernel_op_8*(-jac_blending_inv_0_0_q_1*(jac_affine_inv_0_0_GRAY*tmp_kernel_op_7 + jac_affine_inv_1_0_GRAY*tmp_kernel_op_7) - jac_blending_inv_1_0_q_1*(jac_affine_inv_0_1_GRAY*tmp_kernel_op_7 + jac_affine_inv_1_1_GRAY*tmp_kernel_op_7));
             const real_t tmp_kernel_op_13 = abs_det_jac_affine_GRAY*abs_det_jac_blending_q_2*0.16666666666666666;
             const real_t tmp_kernel_op_14 = tmp_kernel_op_13*(-jac_blending_inv_0_0_q_2*(jac_affine_inv_0_0_GRAY*tmp_kernel_op_12 + jac_affine_inv_1_0_GRAY*tmp_kernel_op_12) - jac_blending_inv_1_0_q_2*(jac_affine_inv_0_1_GRAY*tmp_kernel_op_12 + jac_affine_inv_1_1_GRAY*tmp_kernel_op_12));
             const real_t tmp_kernel_op_19 = tmp_kernel_op_3*(-jac_affine_inv_0_0_GRAY*jac_blending_inv_0_0_q_0*tmp_kernel_op_18 - jac_affine_inv_0_1_GRAY*jac_blending_inv_1_0_q_0*tmp_kernel_op_18);
             const real_t tmp_kernel_op_21 = tmp_kernel_op_8*(-jac_affine_inv_0_0_GRAY*jac_blending_inv_0_0_q_1*tmp_kernel_op_20 - jac_affine_inv_0_1_GRAY*jac_blending_inv_1_0_q_1*tmp_kernel_op_20);
             const real_t tmp_kernel_op_23 = tmp_kernel_op_13*(-jac_affine_inv_0_0_GRAY*jac_blending_inv_0_0_q_2*tmp_kernel_op_22 - jac_affine_inv_0_1_GRAY*jac_blending_inv_1_0_q_2*tmp_kernel_op_22);
             const real_t tmp_kernel_op_25 = tmp_kernel_op_3*(-jac_affine_inv_1_0_GRAY*jac_blending_inv_0_0_q_0*tmp_kernel_op_24 - jac_affine_inv_1_1_GRAY*jac_blending_inv_1_0_q_0*tmp_kernel_op_24);
             const real_t tmp_kernel_op_27 = tmp_kernel_op_8*(-jac_affine_inv_1_0_GRAY*jac_blending_inv_0_0_q_1*tmp_kernel_op_26 - jac_affine_inv_1_1_GRAY*jac_blending_inv_1_0_q_1*tmp_kernel_op_26);
             const real_t tmp_kernel_op_29 = tmp_kernel_op_13*(-jac_affine_inv_1_0_GRAY*jac_blending_inv_0_0_q_2*tmp_kernel_op_28 - jac_affine_inv_1_1_GRAY*jac_blending_inv_1_0_q_2*tmp_kernel_op_28);
             const real_t tmp_kernel_op_34 = tmp_kernel_op_3*(-jac_blending_inv_0_0_q_0*(tmp_kernel_op_30 + tmp_kernel_op_31) - jac_blending_inv_1_0_q_0*(tmp_kernel_op_32 + tmp_kernel_op_33));
             const real_t tmp_kernel_op_39 = tmp_kernel_op_8*(-jac_blending_inv_0_0_q_1*(tmp_kernel_op_35 + tmp_kernel_op_36) - jac_blending_inv_1_0_q_1*(tmp_kernel_op_37 + tmp_kernel_op_38));
             const real_t tmp_kernel_op_44 = tmp_kernel_op_13*(-jac_blending_inv_0_0_q_2*(tmp_kernel_op_40 + tmp_kernel_op_41) - jac_blending_inv_1_0_q_2*(tmp_kernel_op_42 + tmp_kernel_op_43));
             const real_t tmp_kernel_op_46 = tmp_kernel_op_3*(-jac_blending_inv_0_0_q_0*(jac_affine_inv_1_0_GRAY*tmp_kernel_op_45 - tmp_kernel_op_30) - jac_blending_inv_1_0_q_0*(jac_affine_inv_1_1_GRAY*tmp_kernel_op_45 - tmp_kernel_op_32));
             const real_t tmp_kernel_op_48 = tmp_kernel_op_8*(-jac_blending_inv_0_0_q_1*(jac_affine_inv_1_0_GRAY*tmp_kernel_op_47 - tmp_kernel_op_35) - jac_blending_inv_1_0_q_1*(jac_affine_inv_1_1_GRAY*tmp_kernel_op_47 - tmp_kernel_op_37));
             const real_t tmp_kernel_op_50 = tmp_kernel_op_13*(-jac_blending_inv_0_0_q_2*(jac_affine_inv_1_0_GRAY*tmp_kernel_op_49 - tmp_kernel_op_40) - jac_blending_inv_1_0_q_2*(jac_affine_inv_1_1_GRAY*tmp_kernel_op_49 - tmp_kernel_op_42));
             const real_t tmp_kernel_op_52 = tmp_kernel_op_3*(-jac_blending_inv_0_0_q_0*(jac_affine_inv_0_0_GRAY*tmp_kernel_op_51 - tmp_kernel_op_31) - jac_blending_inv_1_0_q_0*(jac_affine_inv_0_1_GRAY*tmp_kernel_op_51 - tmp_kernel_op_33));
             const real_t tmp_kernel_op_54 = tmp_kernel_op_8*(-jac_blending_inv_0_0_q_1*(jac_affine_inv_0_0_GRAY*tmp_kernel_op_53 - tmp_kernel_op_36) - jac_blending_inv_1_0_q_1*(jac_affine_inv_0_1_GRAY*tmp_kernel_op_53 - tmp_kernel_op_38));
             const real_t tmp_kernel_op_56 = tmp_kernel_op_13*(-jac_blending_inv_0_0_q_2*(jac_affine_inv_0_0_GRAY*tmp_kernel_op_55 - tmp_kernel_op_41) - jac_blending_inv_1_0_q_2*(jac_affine_inv_0_1_GRAY*tmp_kernel_op_55 - tmp_kernel_op_43));
       ...
       const real_t tmp_moved_constant_11 = jac_affine_inv_1_1_BLUE*tmp_kernel_op_10;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             const real_t tmp_kernel_op_4 = tmp_kernel_op_3*(-jac_blending_inv_0_0_q_0*(jac_affine_inv_0_0_BLUE*tmp_kernel_op_2 + jac_affine_inv_1_0_BLUE*tmp_kernel_op_2) - jac_blending_inv_1_0_q_0*(jac_affine_inv_0_1_BLUE*tmp_kernel_op_2 + jac_affine_inv_1_1_BLUE*tmp_kernel_op_2));
             const real_t tmp_kernel_op_8 = abs_det_jac_affine_BLUE*abs_det_jac_blending_q_1*0.16666666666666666;
             const real_t tmp_kernel_op_9 = tmp_kernel_op_8*(-jac_blending_inv_0_0_q_1*(jac_affine_inv_0_0_BLUE*tmp_kernel_op_7 + jac_affine_inv_1_0_BLUE*tmp_kernel_op_7) - jac_blending_inv_1_0_q_1*(jac_affine_inv_0_1_BLUE*tmp_kernel_op_7 + jac_affine_inv_1_1_BLUE*tmp_kernel_op_7));
             const real_t tmp_kernel_op_13 = abs_det_jac_affine_BLUE*abs_det_jac_blending_q_2*0.16666666666666666;
             const real_t tmp_kernel_op_14 = tmp_kernel_op_13*(-jac_blending_inv_0_0_q_2*(jac_affine_inv_0_0_BLUE*tmp_kernel_op_12 + jac_affine_inv_1_0_BLUE*tmp_kernel_op_12) - jac_blending_inv_1_0_q_2*(jac_affine_inv_0_1_BLUE*tmp_kernel_op_12 + jac_affine_inv_1_1_BLUE*tmp_kernel_op_12));
             const real_t tmp_kernel_op_19 = tmp_kernel_op_3*(-jac_affine_inv_0_0_BLUE*jac_blending_inv_0_0_q_0*tmp_kernel_op_18 - jac_affine_inv_0_1_BLUE*jac_blending_inv_1_0_q_0*tmp_kernel_op_18);
             const real_t tmp_kernel_op_21 = tmp_kernel_op_8*(-jac_affine_inv_0_0_BLUE*jac_blending_inv_0_0_q_1*tmp_kernel_op_20 - jac_affine_inv_0_1_BLUE*jac_blending_inv_1_0_q_1*tmp_kernel_op_20);
             const real_t tmp_kernel_op_23 = tmp_kernel_op_13*(-jac_affine_inv_0_0_BLUE*jac_blending_inv_0_0_q_2*tmp_kernel_op_22 - jac_affine_inv_0_1_BLUE*jac_blending_inv_1_0_q_2*tmp_kernel_op_22);
             const real_t tmp_kernel_op_25 = tmp_kernel_op_3*(-jac_affine_inv_1_0_BLUE*jac_blending_inv_0_0_q_0*tmp_kernel_op_24 - jac_affine_inv_1_1_BLUE*jac_blending_inv_1_0_q_0*tmp_kernel_op_24);
             const real_t tmp_kernel_op_27 = tmp_kernel_op_8*(-jac_affine_inv_1_0_BLUE*jac_blending_inv_0_0_q_1*tmp_kernel_op_26 - jac_affine_inv_1_1_BLUE*jac_blending_inv_1_0_q_1*tmp_kernel_op_26);
             const real_t tmp_kernel_op_29 = tmp_kernel_op_13*(-jac_affine_inv_1_0_BLUE*jac_blending_inv_0_0_q_2*tmp_kernel_op_28 - jac_affine_inv_1_1_BLUE*jac_blending_inv_1_0_q_2*tmp_kernel_op_28);
             const real_t tmp_kernel_op_34 = tmp_kernel_op_3*(-jac_blending_inv_0_0_q_0*(tmp_moved_constant_0 + tmp_moved_constant_1) - jac_blending_inv_1_0_q_0*(tmp_moved_constant_2 + tmp_moved_constant_3));
             const real_t tmp_kernel_op_39 = tmp_kernel_op_8*(-jac_blending_inv_0_0_q_1*(tmp_moved_constant_4 + tmp_moved_constant_5) - jac_blending_inv_1_0_q_1*(tmp_moved_constant_6 + tmp_moved_constant_7));
             const real_t tmp_kernel_op_44 = tmp_kernel_op_13*(-jac_blending_inv_0_0_q_2*(tmp_moved_constant_8 + tmp_moved_constant_9) - jac_blending_inv_1_0_q_2*(tmp_moved_constant_10 + tmp_moved_constant_11));
             const real_t tmp_kernel_op_46 = tmp_kernel_op_3*(-jac_blending_inv_0_0_q_0*(jac_affine_inv_1_0_BLUE*tmp_kernel_op_45 - tmp_moved_constant_0) - jac_blending_inv_1_0_q_0*(jac_affine_inv_1_1_BLUE*tmp_kernel_op_45 - tmp_moved_constant_2));
             const real_t tmp_kernel_op_48 = tmp_kernel_op_8*(-jac_blending_inv_0_0_q_1*(jac_affine_inv_1_0_BLUE*tmp_kernel_op_47 - tmp_moved_constant_4) - jac_blending_inv_1_0_q_1*(jac_affine_inv_1_1_BLUE*tmp_kernel_op_47 - tmp_moved_constant_6));
             const real_t tmp_kernel_op_50 = tmp_kernel_op_13*(-jac_blending_inv_0_0_q_2*(jac_affine_inv_1_0_BLUE*tmp_kernel_op_49 - tmp_moved_constant_8) - jac_blending_inv_1_0_q_2*(jac_affine_inv_1_1_BLUE*tmp_kernel_op_49 - tmp_moved_constant_10));
             const real_t tmp_kernel_op_52 = tmp_kernel_op_3*(-jac_blending_inv_0_0_q_0*(jac_affine_inv_0_0_BLUE*tmp_kernel_op_51 - tmp_moved_constant_1) - jac_blending_inv_1_0_q_0*(jac_affine_inv_0_1_BLUE*tmp_kernel_op_51 - tmp_moved_constant_3));
             const real_t tmp_kernel_op_54 = tmp_kernel_op_8*(-jac_blending_inv_0_0_q_1*(jac_affine_inv_0_0_BLUE*tmp_kernel_op_53 - tmp_moved_constant_5) - jac_blending_inv_1_0_q_1*(jac_affine_inv_0_1_BLUE*tmp_kernel_op_53 - tmp_moved_constant_7));
             const real_t tmp_kernel_op_56 = tmp_kernel_op_13*(-jac_blending_inv_0_0_q_2*(jac_affine_inv_0_0_BLUE*tmp_kernel_op_55 - tmp_moved_constant_9) - jac_blending_inv_1_0_q_2*(jac_affine_inv_0_1_BLUE*tmp_kernel_op_55 - tmp_moved_constant_11));
             const real_t elMatVec_0 = src_dof_0*(tmp_kernel_op_14*tmp_kernel_op_17 + tmp_kernel_op_15*tmp_kernel_op_4 + tmp_kernel_op_16*tmp_kernel_op_9) + src_dof_1*(tmp_kernel_op_14*0.16666666666666666 + tmp_kernel_op_4*0.16666666666666666 + tmp_kernel_op_9*0.66666666666666663) + src_dof_2*(tmp_kernel_op_14*0.16666666666666666 + tmp_kernel_op_4*0.66666666666666663 + tmp_kernel_op_9*0.16666666666666666);
             const real_t elMatVec_1 = src_dof_0*(tmp_kernel_op_15*tmp_kernel_op_19 + tmp_kernel_op_16*tmp_kernel_op_21 + tmp_kernel_op_17*tmp_kernel_op_23) + src_dof_1*(tmp_kernel_op_19*0.16666666666666666 + tmp_kernel_op_21*0.66666666666666663 + tmp_kernel_op_23*0.16666666666666666) + src_dof_2*(tmp_kernel_op_19*0.66666666666666663 + tmp_kernel_op_21*0.16666666666666666 + tmp_kernel_op_23*0.16666666666666666);
             const real_t elMatVec_2 = src_dof_0*(tmp_kernel_op_15*tmp_kernel_op_25 + tmp_kernel_op_16*tmp_kernel_op_27 + tmp_kernel_op_17*tmp_kernel_op_29) + src_dof_1*(tmp_kernel_op_25*0.16666666666666666 + tmp_kernel_op_27*0.66666666666666663 + tmp_kernel_op_29*0.16666666666666666) + src_dof_2*(tmp_kernel_op_25*0.66666666666666663 + tmp_kernel_op_27*0.16666666666666666 + tmp_kernel_op_29*0.16666666666666666);
             const real_t elMatVec_3 = src_dof_0*(tmp_kernel_op_15*tmp_kernel_op_34 + tmp_kernel_op_16*tmp_kernel_op_39 + tmp_kernel_op_17*tmp_kernel_op_44) + src_dof_1*(tmp_kernel_op_34*0.16666666666666666 + tmp_kernel_op_39*0.66666666666666663 + tmp_kernel_op_44*0.16666666666666666) + src_dof_2*(tmp_kernel_op_34*0.66666666666666663 + tmp_kernel_op_39*0.16666666666666666 + tmp_kernel_op_44*0.16666666666666666);
