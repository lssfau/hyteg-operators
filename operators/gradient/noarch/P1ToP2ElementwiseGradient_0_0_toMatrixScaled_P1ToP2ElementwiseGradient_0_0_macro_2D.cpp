...
void P1ToP2ElementwiseGradient_0_0::toMatrixScaled_P1ToP2ElementwiseGradient_0_0_macro_2D( idx_t * RESTRICT  _data_dstEdge, idx_t * RESTRICT  _data_dstVertex, idx_t * RESTRICT  _data_src, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t toMatrixScaling ) const
{
    {
       ...
       const real_t tmp_kernel_op_19 = jac_affine_inv_0_0_GRAY*(tmp_kernel_op_1 - 1.0);
       const real_t tmp_kernel_op_20 = tmp_kernel_op_10*tmp_kernel_op_6;
       const real_t tmp_kernel_op_21 = jac_affine_inv_0_0_GRAY*(tmp_kernel_op_7 - 1.0);
       const real_t tmp_kernel_op_22 = tmp_kernel_op_12*tmp_kernel_op_16;
       const real_t tmp_kernel_op_23 = jac_affine_inv_0_0_GRAY*(tmp_kernel_op_13 - 1.0);
       ...
       const real_t tmp_kernel_op_27 = jac_affine_inv_1_0_GRAY*(tmp_kernel_op_2 - 1.0);
       const real_t tmp_kernel_op_28 = jac_affine_inv_1_0_GRAY*(tmp_kernel_op_8 - 1.0);
       const real_t tmp_kernel_op_29 = jac_affine_inv_1_0_GRAY*(tmp_kernel_op_14 - 1.0);
       ...
       const real_t tmp_kernel_op_33 = jac_affine_inv_0_0_GRAY*tmp_kernel_op_2;
       const real_t tmp_kernel_op_34 = jac_affine_inv_1_0_GRAY*tmp_kernel_op_1;
       const real_t tmp_kernel_op_35 = tmp_kernel_op_4*(-tmp_kernel_op_33 - tmp_kernel_op_34);
       const real_t tmp_kernel_op_36 = jac_affine_inv_0_0_GRAY*tmp_kernel_op_8;
       const real_t tmp_kernel_op_37 = jac_affine_inv_1_0_GRAY*tmp_kernel_op_7;
       const real_t tmp_kernel_op_38 = tmp_kernel_op_10*(-tmp_kernel_op_36 - tmp_kernel_op_37);
       const real_t tmp_kernel_op_39 = jac_affine_inv_0_0_GRAY*tmp_kernel_op_14;
       const real_t tmp_kernel_op_40 = jac_affine_inv_1_0_GRAY*tmp_kernel_op_13;
       const real_t tmp_kernel_op_41 = tmp_kernel_op_16*(-tmp_kernel_op_39 - tmp_kernel_op_40);
       const real_t tmp_kernel_op_42 = tmp_kernel_op_4*(-jac_affine_inv_1_0_GRAY*(-tmp_kernel_op_1 - 1.333333333333333) + tmp_kernel_op_33);
       const real_t tmp_kernel_op_43 = tmp_kernel_op_10*(-jac_affine_inv_1_0_GRAY*(-tmp_kernel_op_7 + 2.666666666666667) + tmp_kernel_op_36);
       const real_t tmp_kernel_op_44 = tmp_kernel_op_16*(-jac_affine_inv_1_0_GRAY*(-tmp_kernel_op_13 + 2.666666666666667) + tmp_kernel_op_39);
       const real_t tmp_kernel_op_45 = tmp_kernel_op_4*(-jac_affine_inv_0_0_GRAY*(-tmp_kernel_op_2 + 2.666666666666667) + tmp_kernel_op_34);
       const real_t tmp_kernel_op_46 = tmp_kernel_op_10*(-jac_affine_inv_0_0_GRAY*(-tmp_kernel_op_8 - 1.333333333333333) + tmp_kernel_op_37);
       const real_t tmp_kernel_op_47 = tmp_kernel_op_16*(-jac_affine_inv_0_0_GRAY*(-tmp_kernel_op_14 + 2.666666666666667) + tmp_kernel_op_40);
       ...
       const real_t elMat_1_0 = toMatrixScaling*(-tmp_kernel_op_18*tmp_kernel_op_19 - tmp_kernel_op_20*tmp_kernel_op_21 - tmp_kernel_op_22*tmp_kernel_op_23);
       const real_t elMat_1_1 = toMatrixScaling*(tmp_kernel_op_24*-0.16666666666666666 + tmp_kernel_op_25*-0.66666666666666663 + tmp_kernel_op_26*-0.16666666666666666);
       const real_t elMat_1_2 = toMatrixScaling*(tmp_kernel_op_24*-0.66666666666666663 + tmp_kernel_op_25*-0.16666666666666666 + tmp_kernel_op_26*-0.16666666666666666);
       const real_t elMat_2_0 = toMatrixScaling*(-tmp_kernel_op_18*tmp_kernel_op_27 - tmp_kernel_op_20*tmp_kernel_op_28 - tmp_kernel_op_22*tmp_kernel_op_29);
       const real_t elMat_2_1 = toMatrixScaling*(tmp_kernel_op_30*-0.16666666666666666 + tmp_kernel_op_31*-0.66666666666666663 + tmp_kernel_op_32*-0.16666666666666666);
       const real_t elMat_2_2 = toMatrixScaling*(tmp_kernel_op_30*-0.66666666666666663 + tmp_kernel_op_31*-0.16666666666666666 + tmp_kernel_op_32*-0.16666666666666666);
       const real_t elMat_3_0 = toMatrixScaling*(tmp_kernel_op_0*tmp_kernel_op_35 + tmp_kernel_op_12*tmp_kernel_op_41 + tmp_kernel_op_38*tmp_kernel_op_6);
       const real_t elMat_3_1 = toMatrixScaling*(tmp_kernel_op_35*0.16666666666666666 + tmp_kernel_op_38*0.66666666666666663 + tmp_kernel_op_41*0.16666666666666666);
       const real_t elMat_3_2 = toMatrixScaling*(tmp_kernel_op_35*0.66666666666666663 + tmp_kernel_op_38*0.16666666666666666 + tmp_kernel_op_41*0.16666666666666666);
       const real_t elMat_4_0 = toMatrixScaling*(tmp_kernel_op_0*tmp_kernel_op_42 + tmp_kernel_op_12*tmp_kernel_op_44 + tmp_kernel_op_43*tmp_kernel_op_6);
       const real_t elMat_4_1 = toMatrixScaling*(tmp_kernel_op_42*0.16666666666666666 + tmp_kernel_op_43*0.66666666666666663 + tmp_kernel_op_44*0.16666666666666666);
       const real_t elMat_4_2 = toMatrixScaling*(tmp_kernel_op_42*0.66666666666666663 + tmp_kernel_op_43*0.16666666666666666 + tmp_kernel_op_44*0.16666666666666666);
       const real_t elMat_5_0 = toMatrixScaling*(tmp_kernel_op_0*tmp_kernel_op_45 + tmp_kernel_op_12*tmp_kernel_op_47 + tmp_kernel_op_46*tmp_kernel_op_6);
       const real_t elMat_5_1 = toMatrixScaling*(tmp_kernel_op_45*0.16666666666666666 + tmp_kernel_op_46*0.66666666666666663 + tmp_kernel_op_47*0.16666666666666666);
       const real_t elMat_5_2 = toMatrixScaling*(tmp_kernel_op_45*0.66666666666666663 + tmp_kernel_op_46*0.16666666666666666 + tmp_kernel_op_47*0.16666666666666666);
       ...
       const real_t tmp_moved_constant_36 = toMatrixScaling*(tmp_kernel_op_0*tmp_moved_constant_1 + tmp_kernel_op_12*tmp_moved_constant_5 + tmp_kernel_op_6*tmp_moved_constant_3);
       const real_t tmp_moved_constant_37 = toMatrixScaling*(tmp_moved_constant_1*0.16666666666666666 + tmp_moved_constant_3*0.66666666666666663 + tmp_moved_constant_5*0.16666666666666666);
       const real_t tmp_moved_constant_38 = toMatrixScaling*(tmp_moved_constant_1*0.66666666666666663 + tmp_moved_constant_3*0.16666666666666666 + tmp_moved_constant_5*0.16666666666666666);
       const real_t tmp_moved_constant_39 = toMatrixScaling*(-tmp_moved_constant_10*tmp_moved_constant_11 - tmp_moved_constant_6*tmp_moved_constant_7 - tmp_moved_constant_8*tmp_moved_constant_9);
       const real_t tmp_moved_constant_40 = toMatrixScaling*(tmp_moved_constant_12*-0.16666666666666666 + tmp_moved_constant_13*-0.66666666666666663 + tmp_moved_constant_14*-0.16666666666666666);
       const real_t tmp_moved_constant_41 = toMatrixScaling*(tmp_moved_constant_12*-0.66666666666666663 + tmp_moved_constant_13*-0.16666666666666666 + tmp_moved_constant_14*-0.16666666666666666);
       const real_t tmp_moved_constant_42 = toMatrixScaling*(-tmp_moved_constant_10*tmp_moved_constant_17 - tmp_moved_constant_15*tmp_moved_constant_6 - tmp_moved_constant_16*tmp_moved_constant_8);
       const real_t tmp_moved_constant_43 = toMatrixScaling*(tmp_moved_constant_18*-0.16666666666666666 + tmp_moved_constant_19*-0.66666666666666663 + tmp_moved_constant_20*-0.16666666666666666);
       const real_t tmp_moved_constant_44 = toMatrixScaling*(tmp_moved_constant_18*-0.66666666666666663 + tmp_moved_constant_19*-0.16666666666666666 + tmp_moved_constant_20*-0.16666666666666666);
       const real_t tmp_moved_constant_45 = toMatrixScaling*(tmp_kernel_op_0*tmp_moved_constant_23 + tmp_kernel_op_12*tmp_moved_constant_29 + tmp_kernel_op_6*tmp_moved_constant_26);
       const real_t tmp_moved_constant_46 = toMatrixScaling*(tmp_moved_constant_23*0.16666666666666666 + tmp_moved_constant_26*0.66666666666666663 + tmp_moved_constant_29*0.16666666666666666);
       const real_t tmp_moved_constant_47 = toMatrixScaling*(tmp_moved_constant_23*0.66666666666666663 + tmp_moved_constant_26*0.16666666666666666 + tmp_moved_constant_29*0.16666666666666666);
       const real_t tmp_moved_constant_48 = toMatrixScaling*(tmp_kernel_op_0*tmp_moved_constant_30 + tmp_kernel_op_12*tmp_moved_constant_32 + tmp_kernel_op_6*tmp_moved_constant_31);
       const real_t tmp_moved_constant_49 = toMatrixScaling*(tmp_moved_constant_30*0.16666666666666666 + tmp_moved_constant_31*0.66666666666666663 + tmp_moved_constant_32*0.16666666666666666);
       const real_t tmp_moved_constant_50 = toMatrixScaling*(tmp_moved_constant_30*0.66666666666666663 + tmp_moved_constant_31*0.16666666666666666 + tmp_moved_constant_32*0.16666666666666666);
       const real_t tmp_moved_constant_51 = toMatrixScaling*(tmp_kernel_op_0*tmp_moved_constant_33 + tmp_kernel_op_12*tmp_moved_constant_35 + tmp_kernel_op_6*tmp_moved_constant_34);
       const real_t tmp_moved_constant_52 = toMatrixScaling*(tmp_moved_constant_33*0.16666666666666666 + tmp_moved_constant_34*0.66666666666666663 + tmp_moved_constant_35*0.16666666666666666);
       const real_t tmp_moved_constant_53 = toMatrixScaling*(tmp_moved_constant_33*0.66666666666666663 + tmp_moved_constant_34*0.16666666666666666 + tmp_moved_constant_35*0.16666666666666666);
