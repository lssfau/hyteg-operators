...
{
    {
       ...
       const real_t tmp_kernel_op_55 = -tmp_kernel_op_14 + 2.666666666666667;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             const real_t tmp_kernel_op_5 = tmp_kernel_op_4*(-jac_blending_inv_0_0_q_0*(jac_affine_inv_0_0_GRAY*tmp_kernel_op_3 + jac_affine_inv_1_0_GRAY*tmp_kernel_op_3) - jac_blending_inv_1_0_q_0*(jac_affine_inv_0_1_GRAY*tmp_kernel_op_3 + jac_affine_inv_1_1_GRAY*tmp_kernel_op_3));
             const real_t tmp_kernel_op_10 = abs_det_jac_affine_GRAY*abs_det_jac_blending_q_1*0.16666666666666666;
             const real_t tmp_kernel_op_11 = tmp_kernel_op_10*(-jac_blending_inv_0_0_q_1*(jac_affine_inv_0_0_GRAY*tmp_kernel_op_9 + jac_affine_inv_1_0_GRAY*tmp_kernel_op_9) - jac_blending_inv_1_0_q_1*(jac_affine_inv_0_1_GRAY*tmp_kernel_op_9 + jac_affine_inv_1_1_GRAY*tmp_kernel_op_9));
             const real_t tmp_kernel_op_16 = abs_det_jac_affine_GRAY*abs_det_jac_blending_q_2*0.16666666666666666;
             const real_t tmp_kernel_op_17 = tmp_kernel_op_16*(-jac_blending_inv_0_0_q_2*(jac_affine_inv_0_0_GRAY*tmp_kernel_op_15 + jac_affine_inv_1_0_GRAY*tmp_kernel_op_15) - jac_blending_inv_1_0_q_2*(jac_affine_inv_0_1_GRAY*tmp_kernel_op_15 + jac_affine_inv_1_1_GRAY*tmp_kernel_op_15));
             const real_t tmp_kernel_op_19 = tmp_kernel_op_4*(-jac_affine_inv_0_0_GRAY*jac_blending_inv_0_0_q_0*tmp_kernel_op_18 - jac_affine_inv_0_1_GRAY*jac_blending_inv_1_0_q_0*tmp_kernel_op_18);
             const real_t tmp_kernel_op_21 = tmp_kernel_op_10*(-jac_affine_inv_0_0_GRAY*jac_blending_inv_0_0_q_1*tmp_kernel_op_20 - jac_affine_inv_0_1_GRAY*jac_blending_inv_1_0_q_1*tmp_kernel_op_20);
             const real_t tmp_kernel_op_23 = tmp_kernel_op_16*(-jac_affine_inv_0_0_GRAY*jac_blending_inv_0_0_q_2*tmp_kernel_op_22 - jac_affine_inv_0_1_GRAY*jac_blending_inv_1_0_q_2*tmp_kernel_op_22);
             const real_t tmp_kernel_op_25 = tmp_kernel_op_4*(-jac_affine_inv_1_0_GRAY*jac_blending_inv_0_0_q_0*tmp_kernel_op_24 - jac_affine_inv_1_1_GRAY*jac_blending_inv_1_0_q_0*tmp_kernel_op_24);
             const real_t tmp_kernel_op_27 = tmp_kernel_op_10*(-jac_affine_inv_1_0_GRAY*jac_blending_inv_0_0_q_1*tmp_kernel_op_26 - jac_affine_inv_1_1_GRAY*jac_blending_inv_1_0_q_1*tmp_kernel_op_26);
             const real_t tmp_kernel_op_29 = tmp_kernel_op_16*(-jac_affine_inv_1_0_GRAY*jac_blending_inv_0_0_q_2*tmp_kernel_op_28 - jac_affine_inv_1_1_GRAY*jac_blending_inv_1_0_q_2*tmp_kernel_op_28);
             const real_t tmp_kernel_op_34 = tmp_kernel_op_4*(-jac_blending_inv_0_0_q_0*(tmp_kernel_op_30 + tmp_kernel_op_31) - jac_blending_inv_1_0_q_0*(tmp_kernel_op_32 + tmp_kernel_op_33));
             const real_t tmp_kernel_op_39 = tmp_kernel_op_10*(-jac_blending_inv_0_0_q_1*(tmp_kernel_op_35 + tmp_kernel_op_36) - jac_blending_inv_1_0_q_1*(tmp_kernel_op_37 + tmp_kernel_op_38));
             const real_t tmp_kernel_op_44 = tmp_kernel_op_16*(-jac_blending_inv_0_0_q_2*(tmp_kernel_op_40 + tmp_kernel_op_41) - jac_blending_inv_1_0_q_2*(tmp_kernel_op_42 + tmp_kernel_op_43));
             const real_t tmp_kernel_op_46 = tmp_kernel_op_4*(-jac_blending_inv_0_0_q_0*(jac_affine_inv_1_0_GRAY*tmp_kernel_op_45 - tmp_kernel_op_30) - jac_blending_inv_1_0_q_0*(jac_affine_inv_1_1_GRAY*tmp_kernel_op_45 - tmp_kernel_op_32));
             const real_t tmp_kernel_op_48 = tmp_kernel_op_10*(-jac_blending_inv_0_0_q_1*(jac_affine_inv_1_0_GRAY*tmp_kernel_op_47 - tmp_kernel_op_35) - jac_blending_inv_1_0_q_1*(jac_affine_inv_1_1_GRAY*tmp_kernel_op_47 - tmp_kernel_op_37));
             const real_t tmp_kernel_op_50 = tmp_kernel_op_16*(-jac_blending_inv_0_0_q_2*(jac_affine_inv_1_0_GRAY*tmp_kernel_op_49 - tmp_kernel_op_40) - jac_blending_inv_1_0_q_2*(jac_affine_inv_1_1_GRAY*tmp_kernel_op_49 - tmp_kernel_op_42));
             const real_t tmp_kernel_op_52 = tmp_kernel_op_4*(-jac_blending_inv_0_0_q_0*(jac_affine_inv_0_0_GRAY*tmp_kernel_op_51 - tmp_kernel_op_31) - jac_blending_inv_1_0_q_0*(jac_affine_inv_0_1_GRAY*tmp_kernel_op_51 - tmp_kernel_op_33));
             const real_t tmp_kernel_op_54 = tmp_kernel_op_10*(-jac_blending_inv_0_0_q_1*(jac_affine_inv_0_0_GRAY*tmp_kernel_op_53 - tmp_kernel_op_36) - jac_blending_inv_1_0_q_1*(jac_affine_inv_0_1_GRAY*tmp_kernel_op_53 - tmp_kernel_op_38));
             const real_t tmp_kernel_op_56 = tmp_kernel_op_16*(-jac_blending_inv_0_0_q_2*(jac_affine_inv_0_0_GRAY*tmp_kernel_op_55 - tmp_kernel_op_41) - jac_blending_inv_1_0_q_2*(jac_affine_inv_0_1_GRAY*tmp_kernel_op_55 - tmp_kernel_op_43));
             ...
             const real_t elMat_1_0 = toMatrixScaling*(tmp_kernel_op_0*tmp_kernel_op_19 + tmp_kernel_op_12*tmp_kernel_op_23 + tmp_kernel_op_21*tmp_kernel_op_6);
             const real_t elMat_1_1 = toMatrixScaling*(tmp_kernel_op_19*0.16666666666666666 + tmp_kernel_op_21*0.66666666666666663 + tmp_kernel_op_23*0.16666666666666666);
             const real_t elMat_1_2 = toMatrixScaling*(tmp_kernel_op_19*0.66666666666666663 + tmp_kernel_op_21*0.16666666666666666 + tmp_kernel_op_23*0.16666666666666666);
             const real_t elMat_2_0 = toMatrixScaling*(tmp_kernel_op_0*tmp_kernel_op_25 + tmp_kernel_op_12*tmp_kernel_op_29 + tmp_kernel_op_27*tmp_kernel_op_6);
             const real_t elMat_2_1 = toMatrixScaling*(tmp_kernel_op_25*0.16666666666666666 + tmp_kernel_op_27*0.66666666666666663 + tmp_kernel_op_29*0.16666666666666666);
             const real_t elMat_2_2 = toMatrixScaling*(tmp_kernel_op_25*0.66666666666666663 + tmp_kernel_op_27*0.16666666666666666 + tmp_kernel_op_29*0.16666666666666666);
             const real_t elMat_3_0 = toMatrixScaling*(tmp_kernel_op_0*tmp_kernel_op_34 + tmp_kernel_op_12*tmp_kernel_op_44 + tmp_kernel_op_39*tmp_kernel_op_6);
             const real_t elMat_3_1 = toMatrixScaling*(tmp_kernel_op_34*0.16666666666666666 + tmp_kernel_op_39*0.66666666666666663 + tmp_kernel_op_44*0.16666666666666666);
             const real_t elMat_3_2 = toMatrixScaling*(tmp_kernel_op_34*0.66666666666666663 + tmp_kernel_op_39*0.16666666666666666 + tmp_kernel_op_44*0.16666666666666666);
             const real_t elMat_4_0 = toMatrixScaling*(tmp_kernel_op_0*tmp_kernel_op_46 + tmp_kernel_op_12*tmp_kernel_op_50 + tmp_kernel_op_48*tmp_kernel_op_6);
             const real_t elMat_4_1 = toMatrixScaling*(tmp_kernel_op_46*0.16666666666666666 + tmp_kernel_op_48*0.66666666666666663 + tmp_kernel_op_50*0.16666666666666666);
             const real_t elMat_4_2 = toMatrixScaling*(tmp_kernel_op_46*0.66666666666666663 + tmp_kernel_op_48*0.16666666666666666 + tmp_kernel_op_50*0.16666666666666666);
             const real_t elMat_5_0 = toMatrixScaling*(tmp_kernel_op_0*tmp_kernel_op_52 + tmp_kernel_op_12*tmp_kernel_op_56 + tmp_kernel_op_54*tmp_kernel_op_6);
             const real_t elMat_5_1 = toMatrixScaling*(tmp_kernel_op_52*0.16666666666666666 + tmp_kernel_op_54*0.66666666666666663 + tmp_kernel_op_56*0.16666666666666666);
             const real_t elMat_5_2 = toMatrixScaling*(tmp_kernel_op_52*0.66666666666666663 + tmp_kernel_op_54*0.16666666666666666 + tmp_kernel_op_56*0.16666666666666666);
       ...
       const real_t tmp_moved_constant_11 = jac_affine_inv_1_1_BLUE*tmp_kernel_op_13;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge - 1; ctr_0 += 1)
          {
             ...
             const real_t tmp_kernel_op_5 = tmp_kernel_op_4*(-jac_blending_inv_0_0_q_0*(jac_affine_inv_0_0_BLUE*tmp_kernel_op_3 + jac_affine_inv_1_0_BLUE*tmp_kernel_op_3) - jac_blending_inv_1_0_q_0*(jac_affine_inv_0_1_BLUE*tmp_kernel_op_3 + jac_affine_inv_1_1_BLUE*tmp_kernel_op_3));
             const real_t tmp_kernel_op_10 = abs_det_jac_affine_BLUE*abs_det_jac_blending_q_1*0.16666666666666666;
             const real_t tmp_kernel_op_11 = tmp_kernel_op_10*(-jac_blending_inv_0_0_q_1*(jac_affine_inv_0_0_BLUE*tmp_kernel_op_9 + jac_affine_inv_1_0_BLUE*tmp_kernel_op_9) - jac_blending_inv_1_0_q_1*(jac_affine_inv_0_1_BLUE*tmp_kernel_op_9 + jac_affine_inv_1_1_BLUE*tmp_kernel_op_9));
             const real_t tmp_kernel_op_16 = abs_det_jac_affine_BLUE*abs_det_jac_blending_q_2*0.16666666666666666;
             const real_t tmp_kernel_op_17 = tmp_kernel_op_16*(-jac_blending_inv_0_0_q_2*(jac_affine_inv_0_0_BLUE*tmp_kernel_op_15 + jac_affine_inv_1_0_BLUE*tmp_kernel_op_15) - jac_blending_inv_1_0_q_2*(jac_affine_inv_0_1_BLUE*tmp_kernel_op_15 + jac_affine_inv_1_1_BLUE*tmp_kernel_op_15));
             const real_t tmp_kernel_op_19 = tmp_kernel_op_4*(-jac_affine_inv_0_0_BLUE*jac_blending_inv_0_0_q_0*tmp_kernel_op_18 - jac_affine_inv_0_1_BLUE*jac_blending_inv_1_0_q_0*tmp_kernel_op_18);
             const real_t tmp_kernel_op_21 = tmp_kernel_op_10*(-jac_affine_inv_0_0_BLUE*jac_blending_inv_0_0_q_1*tmp_kernel_op_20 - jac_affine_inv_0_1_BLUE*jac_blending_inv_1_0_q_1*tmp_kernel_op_20);
             const real_t tmp_kernel_op_23 = tmp_kernel_op_16*(-jac_affine_inv_0_0_BLUE*jac_blending_inv_0_0_q_2*tmp_kernel_op_22 - jac_affine_inv_0_1_BLUE*jac_blending_inv_1_0_q_2*tmp_kernel_op_22);
             const real_t tmp_kernel_op_25 = tmp_kernel_op_4*(-jac_affine_inv_1_0_BLUE*jac_blending_inv_0_0_q_0*tmp_kernel_op_24 - jac_affine_inv_1_1_BLUE*jac_blending_inv_1_0_q_0*tmp_kernel_op_24);
             const real_t tmp_kernel_op_27 = tmp_kernel_op_10*(-jac_affine_inv_1_0_BLUE*jac_blending_inv_0_0_q_1*tmp_kernel_op_26 - jac_affine_inv_1_1_BLUE*jac_blending_inv_1_0_q_1*tmp_kernel_op_26);
             const real_t tmp_kernel_op_29 = tmp_kernel_op_16*(-jac_affine_inv_1_0_BLUE*jac_blending_inv_0_0_q_2*tmp_kernel_op_28 - jac_affine_inv_1_1_BLUE*jac_blending_inv_1_0_q_2*tmp_kernel_op_28);
             const real_t tmp_kernel_op_34 = tmp_kernel_op_4*(-jac_blending_inv_0_0_q_0*(tmp_moved_constant_0 + tmp_moved_constant_1) - jac_blending_inv_1_0_q_0*(tmp_moved_constant_2 + tmp_moved_constant_3));
             const real_t tmp_kernel_op_39 = tmp_kernel_op_10*(-jac_blending_inv_0_0_q_1*(tmp_moved_constant_4 + tmp_moved_constant_5) - jac_blending_inv_1_0_q_1*(tmp_moved_constant_6 + tmp_moved_constant_7));
             const real_t tmp_kernel_op_44 = tmp_kernel_op_16*(-jac_blending_inv_0_0_q_2*(tmp_moved_constant_8 + tmp_moved_constant_9) - jac_blending_inv_1_0_q_2*(tmp_moved_constant_10 + tmp_moved_constant_11));
             const real_t tmp_kernel_op_46 = tmp_kernel_op_4*(-jac_blending_inv_0_0_q_0*(jac_affine_inv_1_0_BLUE*tmp_kernel_op_45 - tmp_moved_constant_0) - jac_blending_inv_1_0_q_0*(jac_affine_inv_1_1_BLUE*tmp_kernel_op_45 - tmp_moved_constant_2));
             const real_t tmp_kernel_op_48 = tmp_kernel_op_10*(-jac_blending_inv_0_0_q_1*(jac_affine_inv_1_0_BLUE*tmp_kernel_op_47 - tmp_moved_constant_4) - jac_blending_inv_1_0_q_1*(jac_affine_inv_1_1_BLUE*tmp_kernel_op_47 - tmp_moved_constant_6));
             const real_t tmp_kernel_op_50 = tmp_kernel_op_16*(-jac_blending_inv_0_0_q_2*(jac_affine_inv_1_0_BLUE*tmp_kernel_op_49 - tmp_moved_constant_8) - jac_blending_inv_1_0_q_2*(jac_affine_inv_1_1_BLUE*tmp_kernel_op_49 - tmp_moved_constant_10));
             const real_t tmp_kernel_op_52 = tmp_kernel_op_4*(-jac_blending_inv_0_0_q_0*(jac_affine_inv_0_0_BLUE*tmp_kernel_op_51 - tmp_moved_constant_1) - jac_blending_inv_1_0_q_0*(jac_affine_inv_0_1_BLUE*tmp_kernel_op_51 - tmp_moved_constant_3));
             const real_t tmp_kernel_op_54 = tmp_kernel_op_10*(-jac_blending_inv_0_0_q_1*(jac_affine_inv_0_0_BLUE*tmp_kernel_op_53 - tmp_moved_constant_5) - jac_blending_inv_1_0_q_1*(jac_affine_inv_0_1_BLUE*tmp_kernel_op_53 - tmp_moved_constant_7));
             const real_t tmp_kernel_op_56 = tmp_kernel_op_16*(-jac_blending_inv_0_0_q_2*(jac_affine_inv_0_0_BLUE*tmp_kernel_op_55 - tmp_moved_constant_9) - jac_blending_inv_1_0_q_2*(jac_affine_inv_0_1_BLUE*tmp_kernel_op_55 - tmp_moved_constant_11));
             const real_t elMat_0_0 = toMatrixScaling*(tmp_kernel_op_0*tmp_kernel_op_5 + tmp_kernel_op_11*tmp_kernel_op_6 + tmp_kernel_op_12*tmp_kernel_op_17);
             const real_t elMat_0_1 = toMatrixScaling*(tmp_kernel_op_11*0.66666666666666663 + tmp_kernel_op_17*0.16666666666666666 + tmp_kernel_op_5*0.16666666666666666);
             const real_t elMat_0_2 = toMatrixScaling*(tmp_kernel_op_11*0.16666666666666666 + tmp_kernel_op_17*0.16666666666666666 + tmp_kernel_op_5*0.66666666666666663);
             const real_t elMat_1_0 = toMatrixScaling*(tmp_kernel_op_0*tmp_kernel_op_19 + tmp_kernel_op_12*tmp_kernel_op_23 + tmp_kernel_op_21*tmp_kernel_op_6);
