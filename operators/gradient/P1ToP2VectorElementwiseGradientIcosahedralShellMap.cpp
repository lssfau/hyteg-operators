...
#include "P1ToP2VectorElementwiseGradientIcosahedralShellMap.hpp"
...
P1ToP2VectorElementwiseGradientIcosahedralShellMap::P1ToP2VectorElementwiseGradientIcosahedralShellMap(
...
void P1ToP2VectorElementwiseGradientIcosahedralShellMap::applyScaled( const real_t&                     operatorScaling,
                                                                      ...
                                                                      UpdateType                        updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P1ToP2VectorElementwiseGradientIcosahedralShellMap_macro_3D(
...
void P1ToP2VectorElementwiseGradientIcosahedralShellMap::apply( const P1Function< real_t >&       src,
                                                                const P2VectorFunction< real_t >& dst,
                                                                uint_t                            level,
                                                                DoFType                           flag,
                                                                UpdateType                        updateType ) const
...
void P1ToP2VectorElementwiseGradientIcosahedralShellMap::toMatrixScaled( const real_t& toMatrixScaling,
                                                                         ...
                                                                         DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P1ToP2VectorElementwiseGradientIcosahedralShellMap_macro_3D(
...
void P1ToP2VectorElementwiseGradientIcosahedralShellMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                   const P1Function< idx_t >&                  src,
                                                                   const P2VectorFunction< idx_t >&            dst,
                                                                   uint_t                                      level,
                                                                   DoFType                                     flag ) const
