...
///         ∫ - ( ∇ · v ) u
///
class P1ToP2ElementwiseGradient_0_0 : public Operator< P1Function< real_t >, P2Function< real_t > >
{
 public:
   P1ToP2ElementwiseGradient_0_0( const std::shared_ptr< PrimitiveStorage >& storage, size_t minLevel, size_t maxLevel );
 ...
 private:
   ...
   void applyScaled_P1ToP2ElementwiseGradient_0_0_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   void applyScaled_P1ToP2ElementwiseGradient_0_0_macro_3D( real_t* RESTRICT _data_dstEdge,
                                                            real_t* RESTRICT _data_dstVertex,
                                                            real_t* RESTRICT _data_src,
                                                            real_t           macro_vertex_coord_id_0comp0,
                                                            real_t           macro_vertex_coord_id_0comp1,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     98     144      12       0      0              0                 0              4
   void toMatrixScaled_P1ToP2ElementwiseGradient_0_0_macro_2D( idx_t* RESTRICT                      _data_dstEdge,
   ...
   void toMatrixScaled_P1ToP2ElementwiseGradient_0_0_macro_3D( idx_t* RESTRICT                      _data_dstEdge,
                                                               idx_t* RESTRICT                      _data_dstVertex,
                                                               idx_t* RESTRICT                      _data_src,
                                                               real_t                               macro_vertex_coord_id_0comp0,
                                                               real_t                               macro_vertex_coord_id_0comp1,
