...
P1ToP2VectorElementwiseGradientRotationAnnulusMap::P1ToP2VectorElementwiseGradientRotationAnnulusMap(
...
void P1ToP2VectorElementwiseGradientRotationAnnulusMap::applyScaled( const real_t&                     operatorScaling,
                                                                     ...
                                                                     UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P1ToP2VectorElementwiseGradientRotationAnnulusMap_macro_2D(
...
void P1ToP2VectorElementwiseGradientRotationAnnulusMap::apply( const P1Function< real_t >&       src,
                                                               const P2VectorFunction< real_t >& dst,
                                                               uint_t                            level,
                                                               DoFType                           flag,
                                                               UpdateType                        updateType ) const
...
void P1ToP2VectorElementwiseGradientRotationAnnulusMap::toMatrixScaled( const real_t& toMatrixScaling,
                                                                        ...
                                                                        DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P1ToP2VectorElementwiseGradientRotationAnnulusMap_macro_2D(
...
void P1ToP2VectorElementwiseGradientRotationAnnulusMap::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                  const P1Function< idx_t >&                  src,
                                                                  const P2VectorFunction< idx_t >&            dst,
                                                                  uint_t                                      level,
                                                                  DoFType                                     flag ) const
