...
#include "P1ToP2ElementwiseGradientIcosahedralShellMap_1_0.hpp"
...
P1ToP2ElementwiseGradientIcosahedralShellMap_1_0::P1ToP2ElementwiseGradientIcosahedralShellMap_1_0(
...
void P1ToP2ElementwiseGradientIcosahedralShellMap_1_0::applyScaled( const real_t&               operatorScaling,
                                                                    ...
                                                                    UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P1ToP2ElementwiseGradientIcosahedralShellMap_1_0_macro_3D(
...
void P1ToP2ElementwiseGradientIcosahedralShellMap_1_0::apply( const P1Function< real_t >& src,
                                                              const P2Function< real_t >& dst,
                                                              uint_t                      level,
                                                              DoFType                     flag,
                                                              UpdateType                  updateType ) const
...
void P1ToP2ElementwiseGradientIcosahedralShellMap_1_0::toMatrixScaled( const real_t& toMatrixScaling,
                                                                       ...
                                                                       DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P1ToP2ElementwiseGradientIcosahedralShellMap_1_0_macro_3D(
...
void P1ToP2ElementwiseGradientIcosahedralShellMap_1_0::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                 const P1Function< idx_t >&                  src,
                                                                 const P2Function< idx_t >&                  dst,
                                                                 uint_t                                      level,
                                                                 DoFType                                     flag ) const
