...
class P1ToP2VectorElementwiseGradientAnnulusMap : public Operator< P1Function< real_t >, P2VectorFunction< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    270     426      16       6      0              0                 0              1
   void apply_P1ToP2VectorElementwiseGradientAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    234     390      16       6      0              0                 0              4
   void toMatrix_P1ToP2VectorElementwiseGradientAnnulusMap_macro_2D( idx_t* RESTRICT _data_dst_edge_0,
