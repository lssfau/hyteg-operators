...
///         ∫ - ( ∇ · v ) u
///
class P1ToP2VectorElementwiseGradientAnnulusMap : public Operator< P1Function< real_t >, P2VectorFunction< real_t > >
{
 public:
   P1ToP2VectorElementwiseGradientAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                              size_t                                     minLevel,
                                              size_t                                     maxLevel );
 ...
 protected:
 private:
   /// Integral: P1ToP2VectorElementwiseGradientAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    270     438      16       6      0              0                 0              1
   void applyScaled_P1ToP2VectorElementwiseGradientAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    234     426      16       6      0              0                 0              4
   void toMatrixScaled_P1ToP2VectorElementwiseGradientAnnulusMap_macro_2D( idx_t* RESTRICT _data_dst_edge_0,
