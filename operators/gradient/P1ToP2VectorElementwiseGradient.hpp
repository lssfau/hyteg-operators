...
class P1ToP2VectorElementwiseGradient : public Operator< P1Function< real_t >, P2VectorFunction< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    182     258      12       0      0              0                 0              1
   void apply_P1ToP2VectorElementwiseGradient_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    753     980      36       0      0              0                 0              1
   void apply_P1ToP2VectorElementwiseGradient_macro_3D( real_t* RESTRICT _data_dst_edge_0,
                                                        real_t* RESTRICT _data_dst_edge_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    146     222      12       0      0              0                 0              4
   void toMatrix_P1ToP2VectorElementwiseGradient_macro_2D( idx_t* RESTRICT                      _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    633     860      36       0      0              0                 0              4
   void toMatrix_P1ToP2VectorElementwiseGradient_macro_3D( idx_t* RESTRICT                      _data_dst_edge_0,
                                                           idx_t* RESTRICT                      _data_dst_edge_1,
