...
///         ∫ - ( ∇ · v ) u
///
class P1ToP2VectorElementwiseGradient : public Operator< P1Function< real_t >, P2VectorFunction< real_t > >
{
 public:
   P1ToP2VectorElementwiseGradient( const std::shared_ptr< PrimitiveStorage >& storage, size_t minLevel, size_t maxLevel );
 ...
 protected:
 private:
   /// Integral: P1ToP2VectorElementwiseGradient
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    182     270      12       0      0              0                 0              1
   void applyScaled_P1ToP2VectorElementwiseGradient_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    753    1010      36       0      0              0                 0              1
   void applyScaled_P1ToP2VectorElementwiseGradient_macro_3D( real_t* RESTRICT _data_dst_edge_0,
                                                              real_t* RESTRICT _data_dst_edge_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    146     258      12       0      0              0                 0              4
   void toMatrixScaled_P1ToP2VectorElementwiseGradient_macro_2D( idx_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    633     980      36       0      0              0                 0              4
   void toMatrixScaled_P1ToP2VectorElementwiseGradient_macro_3D( idx_t* RESTRICT _data_dst_edge_0,
                                                                 idx_t* RESTRICT _data_dst_edge_1,
