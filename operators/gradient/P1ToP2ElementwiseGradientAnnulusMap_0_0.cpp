...
void P1ToP2ElementwiseGradientAnnulusMap_0_0::applyScaled( const real_t&               operatorScaling,
                                                           ...
                                                           UpdateType                  updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P1ToP2ElementwiseGradientAnnulusMap_0_0_macro_2D(
...
void P1ToP2ElementwiseGradientAnnulusMap_0_0::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                              ...
                                                              DoFType                                     flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P1ToP2ElementwiseGradientAnnulusMap_0_0_macro_2D(
