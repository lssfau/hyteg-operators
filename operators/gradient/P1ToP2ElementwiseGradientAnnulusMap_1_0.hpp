...
class P1ToP2ElementwiseGradientAnnulusMap_1_0 : public Operator< P1Function< real_t >, P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    198     300      16       6      0              0                 0              1
   void applyScaled_P1ToP2ElementwiseGradientAnnulusMap_1_0_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    180     294      16       6      0              0                 0              4
   void toMatrixScaled_P1ToP2ElementwiseGradientAnnulusMap_1_0_macro_2D( idx_t* RESTRICT _data_dstEdge,
