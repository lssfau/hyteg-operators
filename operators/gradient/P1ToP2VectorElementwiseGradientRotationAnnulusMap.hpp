...
class P1ToP2VectorElementwiseGradientRotationAnnulusMap : public Operator< P1Function< real_t >, P2VectorFunction< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    384     812      16      12      0              0                 0              1
   void apply_P1ToP2VectorElementwiseGradientRotationAnnulusMap_macro_2D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    348     776      16      12      0              0                 0              4
   void toMatrix_P1ToP2VectorElementwiseGradientRotationAnnulusMap_macro_2D( idx_t* RESTRICT  _data_dst_edge_0,
