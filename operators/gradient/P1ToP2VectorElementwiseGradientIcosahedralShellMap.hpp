...
class P1ToP2VectorElementwiseGradientIcosahedralShellMap : public Operator< P1Function< real_t >, P2VectorFunction< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1192    1697      41       4      0              0                 0              1
   void apply_P1ToP2VectorElementwiseGradientIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst_edge_0,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1072    1577      41       4      0              0                 0              4
   void toMatrix_P1ToP2VectorElementwiseGradientIcosahedralShellMap_macro_3D( idx_t* RESTRICT _data_dst_edge_0,
