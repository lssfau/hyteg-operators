...
class P1ToP2ElementwiseGradient_2_0 : public Operator< P1Function< real_t >, P2Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     38      30      12       0      0              0                 0              1
   void applyScaled_P1ToP2ElementwiseGradient_2_0_macro_2D( real_t* RESTRICT _data_dstEdge,
   ...
   void applyScaled_P1ToP2ElementwiseGradient_2_0_macro_3D( real_t* RESTRICT _data_dstEdge,
                                                            real_t* RESTRICT _data_dstVertex,
                                                            real_t* RESTRICT _data_src,
                                                            real_t           macro_vertex_coord_id_0comp0,
                                                            real_t           macro_vertex_coord_id_0comp1,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     32      24      12       0      0              0                 0              4
   void toMatrixScaled_P1ToP2ElementwiseGradient_2_0_macro_2D( idx_t* RESTRICT                      _data_dstEdge,
   ...
   void toMatrixScaled_P1ToP2ElementwiseGradient_2_0_macro_3D( idx_t* RESTRICT                      _data_dstEdge,
                                                               idx_t* RESTRICT                      _data_dstVertex,
                                                               idx_t* RESTRICT                      _data_src,
                                                               real_t                               macro_vertex_coord_id_0comp0,
                                                               real_t                               macro_vertex_coord_id_0comp1,
