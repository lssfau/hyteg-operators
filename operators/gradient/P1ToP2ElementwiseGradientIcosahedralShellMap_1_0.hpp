...
///         ∫ - ( ∇ · v ) u
///
class P1ToP2ElementwiseGradientIcosahedralShellMap_1_0 : public Operator< P1Function< real_t >, P2Function< real_t > >
{
 public:
   P1ToP2ElementwiseGradientIcosahedralShellMap_1_0( const std::shared_ptr< PrimitiveStorage >& storage,
                                                     size_t                                     minLevel,
                                                     size_t                                     maxLevel );
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    688     919      41       4      0              0                 0              1
   void applyScaled_P1ToP2ElementwiseGradientIcosahedralShellMap_1_0_macro_3D( real_t* RESTRICT _data_dstEdge,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    648     909      41       4      0              0                 0              4
   void toMatrixScaled_P1ToP2ElementwiseGradientIcosahedralShellMap_1_0_macro_3D( idx_t* RESTRICT _data_dstEdge,
