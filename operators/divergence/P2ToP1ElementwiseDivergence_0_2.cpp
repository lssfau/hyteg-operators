...
P2ToP1ElementwiseDivergence_0_2::P2ToP1ElementwiseDivergence_0_2( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                  size_t                                     minLevel,
                                                                  size_t                                     maxLevel )
: Operator( storage, minLevel, maxLevel )
{}

void P2ToP1ElementwiseDivergence_0_2::applyScaled( const real_t&               operatorScaling,
                                                   ...
                                                   UpdateType                  updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         applyScaled_P2ToP1ElementwiseDivergence_0_2_macro_3D(
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         applyScaled_P2ToP1ElementwiseDivergence_0_2_macro_2D(
...
void P2ToP1ElementwiseDivergence_0_2::apply( const P2Function< real_t >& src,
                                             const P1Function< real_t >& dst,
                                             uint_t                      level,
                                             DoFType                     flag,
                                             UpdateType                  updateType ) const
...
void P2ToP1ElementwiseDivergence_0_2::toMatrixScaled( const real_t&                               toMatrixScaling,
                                                      ...
                                                      DoFType                                     flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrixScaled_P2ToP1ElementwiseDivergence_0_2_macro_3D(
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2ToP1ElementwiseDivergence_0_2_macro_2D(
...
void P2ToP1ElementwiseDivergence_0_2::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                const P2Function< idx_t >&                  src,
                                                const P1Function< idx_t >&                  dst,
                                                uint_t                                      level,
                                                DoFType                                     flag ) const
