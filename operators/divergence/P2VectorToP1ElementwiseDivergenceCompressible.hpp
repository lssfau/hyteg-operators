...
class P2VectorToP1ElementwiseDivergenceCompressible : public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 public:
   P2VectorToP1ElementwiseDivergenceCompressible( const std::shared_ptr< PrimitiveStorage >& storage,
                                                  size_t                                     minLevel,
                                                  size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorToP1ElementwiseDivergenceCompressible
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    289     369      12       0      0              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseDivergenceCompressible_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1069    1268      36       0      0              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseDivergenceCompressible_macro_3D( real_t* RESTRICT _data_dst,
                                                                            real_t* RESTRICT _data_rhoEdge,
                                                                            real_t* RESTRICT _data_rhoVertex,
                                                                            real_t* RESTRICT _data_src_edge_0,
                                                                            real_t* RESTRICT _data_src_edge_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    253     366      12       0      0              0                 0              4
   void toMatrixScaled_P2VectorToP1ElementwiseDivergenceCompressible_macro_2D( idx_t* RESTRICT  _data_dst,
                                                                               real_t* RESTRICT _data_rhoEdge,
                                                                               real_t* RESTRICT _data_rhoVertex,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    949    1264      36       0      0              0                 0              4
   void toMatrixScaled_P2VectorToP1ElementwiseDivergenceCompressible_macro_3D( idx_t* RESTRICT  _data_dst,
                                                                               real_t* RESTRICT _data_rhoEdge,
                                                                               real_t* RESTRICT _data_rhoVertex,
                                                                               idx_t* RESTRICT  _data_src_edge_0,
                                                                               idx_t* RESTRICT  _data_src_edge_1,
