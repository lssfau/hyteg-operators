...
void P2VectorToP1ElementwiseDivergenceCompressibleAnnulusMap::applyScaled( const real_t&                     operatorScaling,
...
void P2VectorToP1ElementwiseDivergenceCompressibleAnnulusMap::toMatrixScaled( const real_t& toMatrixScaling,
                                                                              ...
                                                                              DoFType flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrixScaled_P2VectorToP1ElementwiseDivergenceCompressibleAnnulusMap_macro_2D(
