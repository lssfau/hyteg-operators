...
class P2VectorToP1ElementwiseDivergenceAnnulusMap : public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    270     402      16       6      0              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseDivergenceAnnulusMap_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    234     399      16       6      0              0                 0              4
   void toMatrixScaled_P2VectorToP1ElementwiseDivergenceAnnulusMap_macro_2D( idx_t* RESTRICT _data_dst,
