...
///
class P2VectorToP1ElementwiseDivergenceRotationCompressibleAnnulusMap
: public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 public:
   P2VectorToP1ElementwiseDivergenceRotationCompressibleAnnulusMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                    size_t                                     minLevel,
                                                                    size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorToP1ElementwiseDivergenceRotationCompressibleAnnulusMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    497    1005      16      12      0              0                 0              1
   void apply_P2VectorToP1ElementwiseDivergenceRotationCompressibleAnnulusMap_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    461     969      16      12      0              0                 0              4
   void toMatrix_P2VectorToP1ElementwiseDivergenceRotationCompressibleAnnulusMap_macro_2D(
