...
: public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    497    1008      16      12      0              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseDivergenceRotationCompressibleAnnulusMap_macro_2D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    461    1005      16      12      0              0                 0              4
   void toMatrixScaled_P2VectorToP1ElementwiseDivergenceRotationCompressibleAnnulusMap_macro_2D(
