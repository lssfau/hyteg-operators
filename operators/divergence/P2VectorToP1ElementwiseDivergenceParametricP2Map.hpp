...
class P2VectorToP1ElementwiseDivergenceParametricP2Map : public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    329     336      15       0      3              0                 0              1
   void apply_P2VectorToP1ElementwiseDivergenceParametricP2Map_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1421    1424      40       0      4              0                 0              1
   void apply_P2VectorToP1ElementwiseDivergenceParametricP2Map_macro_3D( real_t* RESTRICT _data_dst,
                                                                         real_t* RESTRICT _data_micromesh_edge_0,
                                                                         real_t* RESTRICT _data_micromesh_edge_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    293     300      15       0      3              0                 0              4
   void toMatrix_P2VectorToP1ElementwiseDivergenceParametricP2Map_macro_2D( idx_t* RESTRICT  _data_dst,
                                                                            real_t* RESTRICT _data_micromesh_edge_0,
                                                                            real_t* RESTRICT _data_micromesh_edge_1,
                                                                            real_t* RESTRICT _data_micromesh_vertex_0,
                                                                            real_t* RESTRICT _data_micromesh_vertex_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1301    1304      40       0      4              0                 0              4
   void toMatrix_P2VectorToP1ElementwiseDivergenceParametricP2Map_macro_3D( idx_t* RESTRICT  _data_dst,
                                                                            real_t* RESTRICT _data_micromesh_edge_0,
                                                                            real_t* RESTRICT _data_micromesh_edge_1,
                                                                            real_t* RESTRICT _data_micromesh_edge_2,
                                                                            real_t* RESTRICT _data_micromesh_vertex_0,
