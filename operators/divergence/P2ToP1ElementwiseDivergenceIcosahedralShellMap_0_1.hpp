...
class P2ToP1ElementwiseDivergenceIcosahedralShellMap_0_1 : public Operator< P2Function< real_t >, P1Function< real_t > >
{
 public:
   P2ToP1ElementwiseDivergenceIcosahedralShellMap_0_1( const std::shared_ptr< PrimitiveStorage >& storage,
                                                       size_t                                     minLevel,
                                                       size_t                                     maxLevel );
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    688     889      41       4      0              0                 0              1
   void applyScaled_P2ToP1ElementwiseDivergenceIcosahedralShellMap_0_1_macro_3D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    648     885      41       4      0              0                 0              4
   void toMatrixScaled_P2ToP1ElementwiseDivergenceIcosahedralShellMap_0_1_macro_3D( idx_t* RESTRICT _data_dst,
