...
class P2ToP1ElementwiseDivergenceAnnulusMap_0_1 : public Operator< P2Function< real_t >, P1Function< real_t > >
{
 ...
 private:
   ...
   void applyScaled_P2ToP1ElementwiseDivergenceAnnulusMap_0_1_macro_2D( real_t* RESTRICT _data_dst,
   ...
   void toMatrixScaled_P2ToP1ElementwiseDivergenceAnnulusMap_0_1_macro_2D( idx_t* RESTRICT _data_dst,
