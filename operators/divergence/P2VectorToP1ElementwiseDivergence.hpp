...
class P2VectorToP1ElementwiseDivergence : public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    182     234      12       0      0              0                 0              1
   void apply_P2VectorToP1ElementwiseDivergence_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    753     884      36       0      0              0                 0              1
   void apply_P2VectorToP1ElementwiseDivergence_macro_3D( real_t* RESTRICT _data_dst,
                                                          real_t* RESTRICT _data_src_edge_0,
                                                          real_t* RESTRICT _data_src_edge_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    146     198      12       0      0              0                 0              4
   void toMatrix_P2VectorToP1ElementwiseDivergence_macro_2D( idx_t* RESTRICT                      _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    633     764      36       0      0              0                 0              4
   void toMatrix_P2VectorToP1ElementwiseDivergence_macro_3D( idx_t* RESTRICT                      _data_dst,
                                                             idx_t* RESTRICT                      _data_src_edge_0,
                                                             idx_t* RESTRICT                      _data_src_edge_1,
