...
P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map::P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map(
...
void P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map::apply( const P2VectorFunction< real_t >& src,
                                                                          ...
                                                                          UpdateType                        updateType ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      for ( auto& it : storage_->getCells() )
      {
         ...
         apply_P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map_macro_3D(
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         apply_P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map_macro_2D(
...
void P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map::toMatrix( const std::shared_ptr< SparseMatrixProxy >& mat,
                                                                             ...
                                                                             DoFType flag ) const
{
   ...
   if ( storage_->hasGlobalCells() )
   {
      ...
      for ( auto& it : storage_->getCells() )
      {
         ...
         toMatrix_P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map_macro_3D(
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrix_P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map_macro_2D(
