...
class P2VectorToP1ElementwiseDivergenceIcosahedralShellMap : public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 public:
   P2VectorToP1ElementwiseDivergenceIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                         size_t                                     minLevel,
                                                         size_t                                     maxLevel );
 ...
 protected:
 private:
   /// Integral: P2VectorToP1ElementwiseDivergenceIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1192    1597      41       4      0              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseDivergenceIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1072    1593      41       4      0              0                 0              4
   void toMatrixScaled_P2VectorToP1ElementwiseDivergenceIcosahedralShellMap_macro_3D( idx_t* RESTRICT _data_dst,
