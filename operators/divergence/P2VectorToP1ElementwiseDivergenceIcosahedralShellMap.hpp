...
class P2VectorToP1ElementwiseDivergenceIcosahedralShellMap : public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1192    1593      41       4      0              0                 0              1
   void apply_P2VectorToP1ElementwiseDivergenceIcosahedralShellMap_macro_3D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1072    1473      41       4      0              0                 0              4
   void toMatrix_P2VectorToP1ElementwiseDivergenceIcosahedralShellMap_macro_3D( idx_t* RESTRICT _data_dst,
