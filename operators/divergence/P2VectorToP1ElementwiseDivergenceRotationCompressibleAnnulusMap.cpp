                                                                             ...
                                                                             UpdateType                        updateType ) const
{
   ...
   else
   {
      for ( auto& it : storage_->getFaces() )
      {
         ...
         apply_P2VectorToP1ElementwiseDivergenceRotationCompressibleAnnulusMap_macro_2D(
                                                                                ...
                                                                                DoFType flag ) const
{
   ...
   else
   {
      ...
      for ( auto& it : storage_->getFaces() )
      {
         ...
         toMatrix_P2VectorToP1ElementwiseDivergenceRotationCompressibleAnnulusMap_macro_2D(
