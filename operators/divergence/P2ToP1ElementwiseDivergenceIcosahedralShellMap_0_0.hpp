...
class P2ToP1ElementwiseDivergenceIcosahedralShellMap_0_0 : public Operator< P2Function< real_t >, P1Function< real_t > >
{
 public:
   P2ToP1ElementwiseDivergenceIcosahedralShellMap_0_0( const std::shared_ptr< PrimitiveStorage >& storage,
                                                       size_t                                     minLevel,
                                                       size_t                                     maxLevel );
 ...
 private:
   ...
   void applyScaled_P2ToP1ElementwiseDivergenceIcosahedralShellMap_0_0_macro_3D( real_t* RESTRICT _data_dst,
   ...
   void toMatrixScaled_P2ToP1ElementwiseDivergenceIcosahedralShellMap_0_0_macro_3D( idx_t* RESTRICT _data_dst,
