...
void P2VectorToP1ElementwiseDivergenceAnnulusMap::toMatrix_P2VectorToP1ElementwiseDivergenceAnnulusMap_macro_2D( idx_t * RESTRICT  _data_dst, idx_t * RESTRICT  _data_src_edge_0, idx_t * RESTRICT  _data_src_edge_1, idx_t * RESTRICT  _data_src_vertex_0, idx_t * RESTRICT  _data_src_vertex_1, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t radRayVertex, real_t radRefVertex, real_t rayVertex_0, real_t rayVertex_1, real_t refVertex_0, real_t refVertex_1, real_t thrVertex_0, real_t thrVertex_1 ) const
{
    {
       ...
       const real_t tmp_kernel_op_91 = jac_affine_inv_0_1_GRAY*tmp_kernel_op_89 - tmp_kernel_op_66;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             const real_t elMat_0_0 = tmp_kernel_op_13*tmp_kernel_op_15 + tmp_kernel_op_21*tmp_kernel_op_23 + tmp_kernel_op_5*tmp_kernel_op_7;
             const real_t elMat_0_1 = tmp_kernel_op_15*tmp_kernel_op_31 + tmp_kernel_op_23*tmp_kernel_op_35 + tmp_kernel_op_27*tmp_kernel_op_7;
             const real_t elMat_0_2 = tmp_kernel_op_15*tmp_kernel_op_43 + tmp_kernel_op_23*tmp_kernel_op_47 + tmp_kernel_op_39*tmp_kernel_op_7;
             const real_t elMat_0_3 = tmp_kernel_op_15*tmp_kernel_op_61 + tmp_kernel_op_23*tmp_kernel_op_68 + tmp_kernel_op_54*tmp_kernel_op_7;
             const real_t elMat_0_4 = tmp_kernel_op_15*tmp_kernel_op_76 + tmp_kernel_op_23*tmp_kernel_op_80 + tmp_kernel_op_7*tmp_kernel_op_72;
             const real_t elMat_0_5 = tmp_kernel_op_15*tmp_kernel_op_88 + tmp_kernel_op_23*tmp_kernel_op_92 + tmp_kernel_op_7*tmp_kernel_op_84;
             const real_t elMat_0_6 = tmp_kernel_op_15*tmp_kernel_op_94 + tmp_kernel_op_23*tmp_kernel_op_95 + tmp_kernel_op_7*tmp_kernel_op_93;
             const real_t elMat_0_7 = tmp_kernel_op_15*tmp_kernel_op_97 + tmp_kernel_op_23*tmp_kernel_op_98 + tmp_kernel_op_7*tmp_kernel_op_96;
             const real_t elMat_0_8 = tmp_kernel_op_100*tmp_kernel_op_15 + tmp_kernel_op_101*tmp_kernel_op_23 + tmp_kernel_op_7*tmp_kernel_op_99;
             const real_t elMat_0_9 = tmp_kernel_op_102*tmp_kernel_op_7 + tmp_kernel_op_103*tmp_kernel_op_15 + tmp_kernel_op_104*tmp_kernel_op_23;
             const real_t elMat_0_10 = tmp_kernel_op_105*tmp_kernel_op_7 + tmp_kernel_op_106*tmp_kernel_op_15 + tmp_kernel_op_107*tmp_kernel_op_23;
             const real_t elMat_0_11 = tmp_kernel_op_108*tmp_kernel_op_7 + tmp_kernel_op_109*tmp_kernel_op_15 + tmp_kernel_op_110*tmp_kernel_op_23;
             const real_t elMat_1_0 = tmp_kernel_op_111*tmp_kernel_op_5 + tmp_kernel_op_112*tmp_kernel_op_13 + tmp_kernel_op_113*tmp_kernel_op_21;
             const real_t elMat_1_1 = tmp_kernel_op_111*tmp_kernel_op_27 + tmp_kernel_op_112*tmp_kernel_op_31 + tmp_kernel_op_113*tmp_kernel_op_35;
             const real_t elMat_1_2 = tmp_kernel_op_111*tmp_kernel_op_39 + tmp_kernel_op_112*tmp_kernel_op_43 + tmp_kernel_op_113*tmp_kernel_op_47;
             const real_t elMat_1_3 = tmp_kernel_op_111*tmp_kernel_op_54 + tmp_kernel_op_112*tmp_kernel_op_61 + tmp_kernel_op_113*tmp_kernel_op_68;
             const real_t elMat_1_4 = tmp_kernel_op_111*tmp_kernel_op_72 + tmp_kernel_op_112*tmp_kernel_op_76 + tmp_kernel_op_113*tmp_kernel_op_80;
             const real_t elMat_1_5 = tmp_kernel_op_111*tmp_kernel_op_84 + tmp_kernel_op_112*tmp_kernel_op_88 + tmp_kernel_op_113*tmp_kernel_op_92;
             const real_t elMat_1_6 = tmp_kernel_op_111*tmp_kernel_op_93 + tmp_kernel_op_112*tmp_kernel_op_94 + tmp_kernel_op_113*tmp_kernel_op_95;
             const real_t elMat_1_7 = tmp_kernel_op_111*tmp_kernel_op_96 + tmp_kernel_op_112*tmp_kernel_op_97 + tmp_kernel_op_113*tmp_kernel_op_98;
             const real_t elMat_1_8 = tmp_kernel_op_100*tmp_kernel_op_112 + tmp_kernel_op_101*tmp_kernel_op_113 + tmp_kernel_op_111*tmp_kernel_op_99;
             const real_t elMat_1_9 = tmp_kernel_op_102*tmp_kernel_op_111 + tmp_kernel_op_103*tmp_kernel_op_112 + tmp_kernel_op_104*tmp_kernel_op_113;
             const real_t elMat_1_10 = tmp_kernel_op_105*tmp_kernel_op_111 + tmp_kernel_op_106*tmp_kernel_op_112 + tmp_kernel_op_107*tmp_kernel_op_113;
             const real_t elMat_1_11 = tmp_kernel_op_108*tmp_kernel_op_111 + tmp_kernel_op_109*tmp_kernel_op_112 + tmp_kernel_op_110*tmp_kernel_op_113;
             const real_t elMat_2_0 = tmp_kernel_op_114*tmp_kernel_op_5 + tmp_kernel_op_115*tmp_kernel_op_13 + tmp_kernel_op_116*tmp_kernel_op_21;
             const real_t elMat_2_1 = tmp_kernel_op_114*tmp_kernel_op_27 + tmp_kernel_op_115*tmp_kernel_op_31 + tmp_kernel_op_116*tmp_kernel_op_35;
             const real_t elMat_2_2 = tmp_kernel_op_114*tmp_kernel_op_39 + tmp_kernel_op_115*tmp_kernel_op_43 + tmp_kernel_op_116*tmp_kernel_op_47;
             const real_t elMat_2_3 = tmp_kernel_op_114*tmp_kernel_op_54 + tmp_kernel_op_115*tmp_kernel_op_61 + tmp_kernel_op_116*tmp_kernel_op_68;
             const real_t elMat_2_4 = tmp_kernel_op_114*tmp_kernel_op_72 + tmp_kernel_op_115*tmp_kernel_op_76 + tmp_kernel_op_116*tmp_kernel_op_80;
             const real_t elMat_2_5 = tmp_kernel_op_114*tmp_kernel_op_84 + tmp_kernel_op_115*tmp_kernel_op_88 + tmp_kernel_op_116*tmp_kernel_op_92;
             const real_t elMat_2_6 = tmp_kernel_op_114*tmp_kernel_op_93 + tmp_kernel_op_115*tmp_kernel_op_94 + tmp_kernel_op_116*tmp_kernel_op_95;
             const real_t elMat_2_7 = tmp_kernel_op_114*tmp_kernel_op_96 + tmp_kernel_op_115*tmp_kernel_op_97 + tmp_kernel_op_116*tmp_kernel_op_98;
             const real_t elMat_2_8 = tmp_kernel_op_100*tmp_kernel_op_115 + tmp_kernel_op_101*tmp_kernel_op_116 + tmp_kernel_op_114*tmp_kernel_op_99;
             const real_t elMat_2_9 = tmp_kernel_op_102*tmp_kernel_op_114 + tmp_kernel_op_103*tmp_kernel_op_115 + tmp_kernel_op_104*tmp_kernel_op_116;
             const real_t elMat_2_10 = tmp_kernel_op_105*tmp_kernel_op_114 + tmp_kernel_op_106*tmp_kernel_op_115 + tmp_kernel_op_107*tmp_kernel_op_116;
             const real_t elMat_2_11 = tmp_kernel_op_108*tmp_kernel_op_114 + tmp_kernel_op_109*tmp_kernel_op_115 + tmp_kernel_op_110*tmp_kernel_op_116;
