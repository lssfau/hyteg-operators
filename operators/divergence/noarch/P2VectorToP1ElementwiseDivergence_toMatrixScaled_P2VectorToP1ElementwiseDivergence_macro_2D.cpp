...
void P2VectorToP1ElementwiseDivergence::toMatrixScaled_P2VectorToP1ElementwiseDivergence_macro_2D( idx_t * RESTRICT  _data_dst, idx_t * RESTRICT  _data_src_edge_0, idx_t * RESTRICT  _data_src_edge_1, idx_t * RESTRICT  _data_src_vertex_0, idx_t * RESTRICT  _data_src_vertex_1, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t toMatrixScaling ) const
{
    {
       ...
       const real_t elMat_0_0 = toMatrixScaling*(tmp_kernel_op_11*tmp_kernel_op_9 + tmp_kernel_op_15*tmp_kernel_op_17 + tmp_kernel_op_3*tmp_kernel_op_5);
       const real_t elMat_0_1 = toMatrixScaling*(-jac_affine_inv_0_0_GRAY*tmp_kernel_op_19 - jac_affine_inv_0_0_GRAY*tmp_kernel_op_21 - jac_affine_inv_0_0_GRAY*tmp_kernel_op_23);
       const real_t elMat_0_2 = toMatrixScaling*(-jac_affine_inv_1_0_GRAY*tmp_kernel_op_25 - jac_affine_inv_1_0_GRAY*tmp_kernel_op_27 - jac_affine_inv_1_0_GRAY*tmp_kernel_op_29);
       const real_t elMat_0_3 = toMatrixScaling*(tmp_kernel_op_11*tmp_kernel_op_35 + tmp_kernel_op_17*tmp_kernel_op_38 + tmp_kernel_op_32*tmp_kernel_op_5);
       const real_t elMat_0_4 = toMatrixScaling*(tmp_kernel_op_11*tmp_kernel_op_42 + tmp_kernel_op_17*tmp_kernel_op_44 + tmp_kernel_op_40*tmp_kernel_op_5);
       const real_t elMat_0_5 = toMatrixScaling*(tmp_kernel_op_11*tmp_kernel_op_48 + tmp_kernel_op_17*tmp_kernel_op_50 + tmp_kernel_op_46*tmp_kernel_op_5);
       const real_t elMat_0_6 = toMatrixScaling*(tmp_kernel_op_11*tmp_kernel_op_52 + tmp_kernel_op_17*tmp_kernel_op_53 + tmp_kernel_op_5*tmp_kernel_op_51);
       const real_t elMat_0_7 = toMatrixScaling*(-jac_affine_inv_0_1_GRAY*tmp_kernel_op_19 - jac_affine_inv_0_1_GRAY*tmp_kernel_op_21 - jac_affine_inv_0_1_GRAY*tmp_kernel_op_23);
       const real_t elMat_0_8 = toMatrixScaling*(-jac_affine_inv_1_1_GRAY*tmp_kernel_op_25 - jac_affine_inv_1_1_GRAY*tmp_kernel_op_27 - jac_affine_inv_1_1_GRAY*tmp_kernel_op_29);
       const real_t elMat_0_9 = toMatrixScaling*(tmp_kernel_op_11*tmp_kernel_op_59 + tmp_kernel_op_17*tmp_kernel_op_62 + tmp_kernel_op_5*tmp_kernel_op_56);
       const real_t elMat_0_10 = toMatrixScaling*(tmp_kernel_op_11*tmp_kernel_op_64 + tmp_kernel_op_17*tmp_kernel_op_65 + tmp_kernel_op_5*tmp_kernel_op_63);
       const real_t elMat_0_11 = toMatrixScaling*(tmp_kernel_op_11*tmp_kernel_op_67 + tmp_kernel_op_17*tmp_kernel_op_68 + tmp_kernel_op_5*tmp_kernel_op_66);
       const real_t elMat_1_0 = toMatrixScaling*(tmp_kernel_op_15*tmp_kernel_op_71 + tmp_kernel_op_3*tmp_kernel_op_69 + tmp_kernel_op_70*tmp_kernel_op_9);
       const real_t elMat_1_1 = toMatrixScaling*(-jac_affine_inv_0_0_GRAY*tmp_kernel_op_72 - jac_affine_inv_0_0_GRAY*tmp_kernel_op_73 - jac_affine_inv_0_0_GRAY*tmp_kernel_op_74);
       const real_t elMat_1_2 = toMatrixScaling*(-jac_affine_inv_1_0_GRAY*tmp_kernel_op_75 - jac_affine_inv_1_0_GRAY*tmp_kernel_op_76 - jac_affine_inv_1_0_GRAY*tmp_kernel_op_77);
       const real_t elMat_1_3 = toMatrixScaling*(tmp_kernel_op_32*tmp_kernel_op_69 + tmp_kernel_op_35*tmp_kernel_op_70 + tmp_kernel_op_38*tmp_kernel_op_71);
       const real_t elMat_1_4 = toMatrixScaling*(tmp_kernel_op_40*tmp_kernel_op_69 + tmp_kernel_op_42*tmp_kernel_op_70 + tmp_kernel_op_44*tmp_kernel_op_71);
       const real_t elMat_1_5 = toMatrixScaling*(tmp_kernel_op_46*tmp_kernel_op_69 + tmp_kernel_op_48*tmp_kernel_op_70 + tmp_kernel_op_50*tmp_kernel_op_71);
       const real_t elMat_1_6 = toMatrixScaling*(tmp_kernel_op_51*tmp_kernel_op_69 + tmp_kernel_op_52*tmp_kernel_op_70 + tmp_kernel_op_53*tmp_kernel_op_71);
       const real_t elMat_1_7 = toMatrixScaling*(-jac_affine_inv_0_1_GRAY*tmp_kernel_op_72 - jac_affine_inv_0_1_GRAY*tmp_kernel_op_73 - jac_affine_inv_0_1_GRAY*tmp_kernel_op_74);
       const real_t elMat_1_8 = toMatrixScaling*(-jac_affine_inv_1_1_GRAY*tmp_kernel_op_75 - jac_affine_inv_1_1_GRAY*tmp_kernel_op_76 - jac_affine_inv_1_1_GRAY*tmp_kernel_op_77);
       const real_t elMat_1_9 = toMatrixScaling*(tmp_kernel_op_56*tmp_kernel_op_69 + tmp_kernel_op_59*tmp_kernel_op_70 + tmp_kernel_op_62*tmp_kernel_op_71);
       const real_t elMat_1_10 = toMatrixScaling*(tmp_kernel_op_63*tmp_kernel_op_69 + tmp_kernel_op_64*tmp_kernel_op_70 + tmp_kernel_op_65*tmp_kernel_op_71);
       const real_t elMat_1_11 = toMatrixScaling*(tmp_kernel_op_66*tmp_kernel_op_69 + tmp_kernel_op_67*tmp_kernel_op_70 + tmp_kernel_op_68*tmp_kernel_op_71);
       const real_t elMat_2_0 = toMatrixScaling*(tmp_kernel_op_15*tmp_kernel_op_80 + tmp_kernel_op_3*tmp_kernel_op_78 + tmp_kernel_op_79*tmp_kernel_op_9);
       const real_t elMat_2_1 = toMatrixScaling*(-jac_affine_inv_0_0_GRAY*tmp_kernel_op_81 - jac_affine_inv_0_0_GRAY*tmp_kernel_op_82 - jac_affine_inv_0_0_GRAY*tmp_kernel_op_83);
       const real_t elMat_2_2 = toMatrixScaling*(-jac_affine_inv_1_0_GRAY*tmp_kernel_op_84 - jac_affine_inv_1_0_GRAY*tmp_kernel_op_85 - jac_affine_inv_1_0_GRAY*tmp_kernel_op_86);
       const real_t elMat_2_3 = toMatrixScaling*(tmp_kernel_op_32*tmp_kernel_op_78 + tmp_kernel_op_35*tmp_kernel_op_79 + tmp_kernel_op_38*tmp_kernel_op_80);
       const real_t elMat_2_4 = toMatrixScaling*(tmp_kernel_op_40*tmp_kernel_op_78 + tmp_kernel_op_42*tmp_kernel_op_79 + tmp_kernel_op_44*tmp_kernel_op_80);
       const real_t elMat_2_5 = toMatrixScaling*(tmp_kernel_op_46*tmp_kernel_op_78 + tmp_kernel_op_48*tmp_kernel_op_79 + tmp_kernel_op_50*tmp_kernel_op_80);
       const real_t elMat_2_6 = toMatrixScaling*(tmp_kernel_op_51*tmp_kernel_op_78 + tmp_kernel_op_52*tmp_kernel_op_79 + tmp_kernel_op_53*tmp_kernel_op_80);
       const real_t elMat_2_7 = toMatrixScaling*(-jac_affine_inv_0_1_GRAY*tmp_kernel_op_81 - jac_affine_inv_0_1_GRAY*tmp_kernel_op_82 - jac_affine_inv_0_1_GRAY*tmp_kernel_op_83);
       const real_t elMat_2_8 = toMatrixScaling*(-jac_affine_inv_1_1_GRAY*tmp_kernel_op_84 - jac_affine_inv_1_1_GRAY*tmp_kernel_op_85 - jac_affine_inv_1_1_GRAY*tmp_kernel_op_86);
       const real_t elMat_2_9 = toMatrixScaling*(tmp_kernel_op_56*tmp_kernel_op_78 + tmp_kernel_op_59*tmp_kernel_op_79 + tmp_kernel_op_62*tmp_kernel_op_80);
       const real_t elMat_2_10 = toMatrixScaling*(tmp_kernel_op_63*tmp_kernel_op_78 + tmp_kernel_op_64*tmp_kernel_op_79 + tmp_kernel_op_65*tmp_kernel_op_80);
       const real_t elMat_2_11 = toMatrixScaling*(tmp_kernel_op_66*tmp_kernel_op_78 + tmp_kernel_op_67*tmp_kernel_op_79 + tmp_kernel_op_68*tmp_kernel_op_80);
       ...
       const real_t tmp_moved_constant_66 = toMatrixScaling*(tmp_moved_constant_0*tmp_moved_constant_2 + tmp_moved_constant_3*tmp_moved_constant_5 + tmp_moved_constant_6*tmp_moved_constant_8);
       const real_t tmp_moved_constant_67 = toMatrixScaling*(-jac_affine_inv_0_0_BLUE*tmp_moved_constant_10 - jac_affine_inv_0_0_BLUE*tmp_moved_constant_11 - jac_affine_inv_0_0_BLUE*tmp_moved_constant_9);
       const real_t tmp_moved_constant_68 = toMatrixScaling*(-jac_affine_inv_1_0_BLUE*tmp_moved_constant_12 - jac_affine_inv_1_0_BLUE*tmp_moved_constant_13 - jac_affine_inv_1_0_BLUE*tmp_moved_constant_14);
       const real_t tmp_moved_constant_69 = toMatrixScaling*(tmp_moved_constant_17*tmp_moved_constant_2 + tmp_moved_constant_20*tmp_moved_constant_5 + tmp_moved_constant_23*tmp_moved_constant_8);
       const real_t tmp_moved_constant_70 = toMatrixScaling*(tmp_moved_constant_2*tmp_moved_constant_24 + tmp_moved_constant_25*tmp_moved_constant_5 + tmp_moved_constant_26*tmp_moved_constant_8);
       const real_t tmp_moved_constant_71 = toMatrixScaling*(tmp_moved_constant_2*tmp_moved_constant_27 + tmp_moved_constant_28*tmp_moved_constant_5 + tmp_moved_constant_29*tmp_moved_constant_8);
       const real_t tmp_moved_constant_72 = toMatrixScaling*(tmp_moved_constant_2*tmp_moved_constant_30 + tmp_moved_constant_31*tmp_moved_constant_5 + tmp_moved_constant_32*tmp_moved_constant_8);
       const real_t tmp_moved_constant_73 = toMatrixScaling*(-jac_affine_inv_0_1_BLUE*tmp_moved_constant_10 - jac_affine_inv_0_1_BLUE*tmp_moved_constant_11 - jac_affine_inv_0_1_BLUE*tmp_moved_constant_9);
       const real_t tmp_moved_constant_74 = toMatrixScaling*(-jac_affine_inv_1_1_BLUE*tmp_moved_constant_12 - jac_affine_inv_1_1_BLUE*tmp_moved_constant_13 - jac_affine_inv_1_1_BLUE*tmp_moved_constant_14);
       const real_t tmp_moved_constant_75 = toMatrixScaling*(tmp_moved_constant_2*tmp_moved_constant_35 + tmp_moved_constant_38*tmp_moved_constant_5 + tmp_moved_constant_41*tmp_moved_constant_8);
       const real_t tmp_moved_constant_76 = toMatrixScaling*(tmp_moved_constant_2*tmp_moved_constant_42 + tmp_moved_constant_43*tmp_moved_constant_5 + tmp_moved_constant_44*tmp_moved_constant_8);
       const real_t tmp_moved_constant_77 = toMatrixScaling*(tmp_moved_constant_2*tmp_moved_constant_45 + tmp_moved_constant_46*tmp_moved_constant_5 + tmp_moved_constant_47*tmp_moved_constant_8);
       const real_t tmp_moved_constant_78 = toMatrixScaling*(tmp_moved_constant_0*tmp_moved_constant_48 + tmp_moved_constant_3*tmp_moved_constant_49 + tmp_moved_constant_50*tmp_moved_constant_6);
       const real_t tmp_moved_constant_79 = toMatrixScaling*(-jac_affine_inv_0_0_BLUE*tmp_moved_constant_51 - jac_affine_inv_0_0_BLUE*tmp_moved_constant_52 - jac_affine_inv_0_0_BLUE*tmp_moved_constant_53);
       const real_t tmp_moved_constant_80 = toMatrixScaling*(-jac_affine_inv_1_0_BLUE*tmp_moved_constant_54 - jac_affine_inv_1_0_BLUE*tmp_moved_constant_55 - jac_affine_inv_1_0_BLUE*tmp_moved_constant_56);
       const real_t tmp_moved_constant_81 = toMatrixScaling*(tmp_moved_constant_17*tmp_moved_constant_48 + tmp_moved_constant_20*tmp_moved_constant_49 + tmp_moved_constant_23*tmp_moved_constant_50);
       const real_t tmp_moved_constant_82 = toMatrixScaling*(tmp_moved_constant_24*tmp_moved_constant_48 + tmp_moved_constant_25*tmp_moved_constant_49 + tmp_moved_constant_26*tmp_moved_constant_50);
       const real_t tmp_moved_constant_83 = toMatrixScaling*(tmp_moved_constant_27*tmp_moved_constant_48 + tmp_moved_constant_28*tmp_moved_constant_49 + tmp_moved_constant_29*tmp_moved_constant_50);
       const real_t tmp_moved_constant_84 = toMatrixScaling*(tmp_moved_constant_30*tmp_moved_constant_48 + tmp_moved_constant_31*tmp_moved_constant_49 + tmp_moved_constant_32*tmp_moved_constant_50);
       const real_t tmp_moved_constant_85 = toMatrixScaling*(-jac_affine_inv_0_1_BLUE*tmp_moved_constant_51 - jac_affine_inv_0_1_BLUE*tmp_moved_constant_52 - jac_affine_inv_0_1_BLUE*tmp_moved_constant_53);
       const real_t tmp_moved_constant_86 = toMatrixScaling*(-jac_affine_inv_1_1_BLUE*tmp_moved_constant_54 - jac_affine_inv_1_1_BLUE*tmp_moved_constant_55 - jac_affine_inv_1_1_BLUE*tmp_moved_constant_56);
       const real_t tmp_moved_constant_87 = toMatrixScaling*(tmp_moved_constant_35*tmp_moved_constant_48 + tmp_moved_constant_38*tmp_moved_constant_49 + tmp_moved_constant_41*tmp_moved_constant_50);
       const real_t tmp_moved_constant_88 = toMatrixScaling*(tmp_moved_constant_42*tmp_moved_constant_48 + tmp_moved_constant_43*tmp_moved_constant_49 + tmp_moved_constant_44*tmp_moved_constant_50);
       const real_t tmp_moved_constant_89 = toMatrixScaling*(tmp_moved_constant_45*tmp_moved_constant_48 + tmp_moved_constant_46*tmp_moved_constant_49 + tmp_moved_constant_47*tmp_moved_constant_50);
       const real_t tmp_moved_constant_90 = toMatrixScaling*(tmp_moved_constant_0*tmp_moved_constant_57 + tmp_moved_constant_3*tmp_moved_constant_58 + tmp_moved_constant_59*tmp_moved_constant_6);
       const real_t tmp_moved_constant_91 = toMatrixScaling*(-jac_affine_inv_0_0_BLUE*tmp_moved_constant_60 - jac_affine_inv_0_0_BLUE*tmp_moved_constant_61 - jac_affine_inv_0_0_BLUE*tmp_moved_constant_62);
       const real_t tmp_moved_constant_92 = toMatrixScaling*(-jac_affine_inv_1_0_BLUE*tmp_moved_constant_63 - jac_affine_inv_1_0_BLUE*tmp_moved_constant_64 - jac_affine_inv_1_0_BLUE*tmp_moved_constant_65);
       const real_t tmp_moved_constant_93 = toMatrixScaling*(tmp_moved_constant_17*tmp_moved_constant_57 + tmp_moved_constant_20*tmp_moved_constant_58 + tmp_moved_constant_23*tmp_moved_constant_59);
       const real_t tmp_moved_constant_94 = toMatrixScaling*(tmp_moved_constant_24*tmp_moved_constant_57 + tmp_moved_constant_25*tmp_moved_constant_58 + tmp_moved_constant_26*tmp_moved_constant_59);
       const real_t tmp_moved_constant_95 = toMatrixScaling*(tmp_moved_constant_27*tmp_moved_constant_57 + tmp_moved_constant_28*tmp_moved_constant_58 + tmp_moved_constant_29*tmp_moved_constant_59);
       const real_t tmp_moved_constant_96 = toMatrixScaling*(tmp_moved_constant_30*tmp_moved_constant_57 + tmp_moved_constant_31*tmp_moved_constant_58 + tmp_moved_constant_32*tmp_moved_constant_59);
       const real_t tmp_moved_constant_97 = toMatrixScaling*(-jac_affine_inv_0_1_BLUE*tmp_moved_constant_60 - jac_affine_inv_0_1_BLUE*tmp_moved_constant_61 - jac_affine_inv_0_1_BLUE*tmp_moved_constant_62);
       const real_t tmp_moved_constant_98 = toMatrixScaling*(-jac_affine_inv_1_1_BLUE*tmp_moved_constant_63 - jac_affine_inv_1_1_BLUE*tmp_moved_constant_64 - jac_affine_inv_1_1_BLUE*tmp_moved_constant_65);
       const real_t tmp_moved_constant_99 = toMatrixScaling*(tmp_moved_constant_35*tmp_moved_constant_57 + tmp_moved_constant_38*tmp_moved_constant_58 + tmp_moved_constant_41*tmp_moved_constant_59);
       const real_t tmp_moved_constant_100 = toMatrixScaling*(tmp_moved_constant_42*tmp_moved_constant_57 + tmp_moved_constant_43*tmp_moved_constant_58 + tmp_moved_constant_44*tmp_moved_constant_59);
       const real_t tmp_moved_constant_101 = toMatrixScaling*(tmp_moved_constant_45*tmp_moved_constant_57 + tmp_moved_constant_46*tmp_moved_constant_58 + tmp_moved_constant_47*tmp_moved_constant_59);
