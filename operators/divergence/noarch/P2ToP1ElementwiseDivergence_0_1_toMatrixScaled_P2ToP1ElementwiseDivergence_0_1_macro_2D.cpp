...
void P2ToP1ElementwiseDivergence_0_1::toMatrixScaled_P2ToP1ElementwiseDivergence_0_1_macro_2D( idx_t * RESTRICT  _data_dst, idx_t * RESTRICT  _data_srcEdge, idx_t * RESTRICT  _data_srcVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t toMatrixScaling ) const
{
    {
       ...
       const real_t elMat_0_1 = toMatrixScaling*(-tmp_kernel_op_11*tmp_kernel_op_19 - tmp_kernel_op_17*tmp_kernel_op_20 - tmp_kernel_op_18*tmp_kernel_op_5);
       const real_t elMat_0_2 = toMatrixScaling*(-tmp_kernel_op_11*tmp_kernel_op_22 - tmp_kernel_op_17*tmp_kernel_op_23 - tmp_kernel_op_21*tmp_kernel_op_5);
       const real_t elMat_0_3 = toMatrixScaling*(tmp_kernel_op_11*tmp_kernel_op_29 + tmp_kernel_op_17*tmp_kernel_op_32 + tmp_kernel_op_26*tmp_kernel_op_5);
       const real_t elMat_0_4 = toMatrixScaling*(tmp_kernel_op_11*tmp_kernel_op_34 + tmp_kernel_op_17*tmp_kernel_op_35 + tmp_kernel_op_33*tmp_kernel_op_5);
       const real_t elMat_0_5 = toMatrixScaling*(tmp_kernel_op_11*tmp_kernel_op_37 + tmp_kernel_op_17*tmp_kernel_op_38 + tmp_kernel_op_36*tmp_kernel_op_5);
       const real_t elMat_1_0 = toMatrixScaling*(tmp_kernel_op_15*tmp_kernel_op_41 + tmp_kernel_op_3*tmp_kernel_op_39 + tmp_kernel_op_40*tmp_kernel_op_9);
       const real_t elMat_1_1 = toMatrixScaling*(-tmp_kernel_op_18*tmp_kernel_op_39 - tmp_kernel_op_19*tmp_kernel_op_40 - tmp_kernel_op_20*tmp_kernel_op_41);
       const real_t elMat_1_2 = toMatrixScaling*(-tmp_kernel_op_21*tmp_kernel_op_39 - tmp_kernel_op_22*tmp_kernel_op_40 - tmp_kernel_op_23*tmp_kernel_op_41);
       const real_t elMat_1_3 = toMatrixScaling*(tmp_kernel_op_26*tmp_kernel_op_39 + tmp_kernel_op_29*tmp_kernel_op_40 + tmp_kernel_op_32*tmp_kernel_op_41);
       const real_t elMat_1_4 = toMatrixScaling*(tmp_kernel_op_33*tmp_kernel_op_39 + tmp_kernel_op_34*tmp_kernel_op_40 + tmp_kernel_op_35*tmp_kernel_op_41);
       const real_t elMat_1_5 = toMatrixScaling*(tmp_kernel_op_36*tmp_kernel_op_39 + tmp_kernel_op_37*tmp_kernel_op_40 + tmp_kernel_op_38*tmp_kernel_op_41);
       const real_t elMat_2_0 = toMatrixScaling*(tmp_kernel_op_15*tmp_kernel_op_44 + tmp_kernel_op_3*tmp_kernel_op_42 + tmp_kernel_op_43*tmp_kernel_op_9);
       const real_t elMat_2_1 = toMatrixScaling*(-tmp_kernel_op_18*tmp_kernel_op_42 - tmp_kernel_op_19*tmp_kernel_op_43 - tmp_kernel_op_20*tmp_kernel_op_44);
       const real_t elMat_2_2 = toMatrixScaling*(-tmp_kernel_op_21*tmp_kernel_op_42 - tmp_kernel_op_22*tmp_kernel_op_43 - tmp_kernel_op_23*tmp_kernel_op_44);
       const real_t elMat_2_3 = toMatrixScaling*(tmp_kernel_op_26*tmp_kernel_op_42 + tmp_kernel_op_29*tmp_kernel_op_43 + tmp_kernel_op_32*tmp_kernel_op_44);
       const real_t elMat_2_4 = toMatrixScaling*(tmp_kernel_op_33*tmp_kernel_op_42 + tmp_kernel_op_34*tmp_kernel_op_43 + tmp_kernel_op_35*tmp_kernel_op_44);
       const real_t elMat_2_5 = toMatrixScaling*(tmp_kernel_op_36*tmp_kernel_op_42 + tmp_kernel_op_37*tmp_kernel_op_43 + tmp_kernel_op_38*tmp_kernel_op_44);
       ...
       const real_t tmp_moved_constant_36 = toMatrixScaling*(tmp_moved_constant_0*tmp_moved_constant_2 + tmp_moved_constant_3*tmp_moved_constant_5 + tmp_moved_constant_6*tmp_moved_constant_8);
       const real_t tmp_moved_constant_37 = toMatrixScaling*(-tmp_moved_constant_10*tmp_moved_constant_5 - tmp_moved_constant_11*tmp_moved_constant_8 - tmp_moved_constant_2*tmp_moved_constant_9);
       const real_t tmp_moved_constant_38 = toMatrixScaling*(-tmp_moved_constant_12*tmp_moved_constant_2 - tmp_moved_constant_13*tmp_moved_constant_5 - tmp_moved_constant_14*tmp_moved_constant_8);
       const real_t tmp_moved_constant_39 = toMatrixScaling*(tmp_moved_constant_17*tmp_moved_constant_2 + tmp_moved_constant_20*tmp_moved_constant_5 + tmp_moved_constant_23*tmp_moved_constant_8);
       const real_t tmp_moved_constant_40 = toMatrixScaling*(tmp_moved_constant_2*tmp_moved_constant_24 + tmp_moved_constant_25*tmp_moved_constant_5 + tmp_moved_constant_26*tmp_moved_constant_8);
       const real_t tmp_moved_constant_41 = toMatrixScaling*(tmp_moved_constant_2*tmp_moved_constant_27 + tmp_moved_constant_28*tmp_moved_constant_5 + tmp_moved_constant_29*tmp_moved_constant_8);
       const real_t tmp_moved_constant_42 = toMatrixScaling*(tmp_moved_constant_0*tmp_moved_constant_30 + tmp_moved_constant_3*tmp_moved_constant_31 + tmp_moved_constant_32*tmp_moved_constant_6);
       const real_t tmp_moved_constant_43 = toMatrixScaling*(-tmp_moved_constant_10*tmp_moved_constant_31 - tmp_moved_constant_11*tmp_moved_constant_32 - tmp_moved_constant_30*tmp_moved_constant_9);
       const real_t tmp_moved_constant_44 = toMatrixScaling*(-tmp_moved_constant_12*tmp_moved_constant_30 - tmp_moved_constant_13*tmp_moved_constant_31 - tmp_moved_constant_14*tmp_moved_constant_32);
       const real_t tmp_moved_constant_45 = toMatrixScaling*(tmp_moved_constant_17*tmp_moved_constant_30 + tmp_moved_constant_20*tmp_moved_constant_31 + tmp_moved_constant_23*tmp_moved_constant_32);
       const real_t tmp_moved_constant_46 = toMatrixScaling*(tmp_moved_constant_24*tmp_moved_constant_30 + tmp_moved_constant_25*tmp_moved_constant_31 + tmp_moved_constant_26*tmp_moved_constant_32);
       const real_t tmp_moved_constant_47 = toMatrixScaling*(tmp_moved_constant_27*tmp_moved_constant_30 + tmp_moved_constant_28*tmp_moved_constant_31 + tmp_moved_constant_29*tmp_moved_constant_32);
       const real_t tmp_moved_constant_48 = toMatrixScaling*(tmp_moved_constant_0*tmp_moved_constant_33 + tmp_moved_constant_3*tmp_moved_constant_34 + tmp_moved_constant_35*tmp_moved_constant_6);
       const real_t tmp_moved_constant_49 = toMatrixScaling*(-tmp_moved_constant_10*tmp_moved_constant_34 - tmp_moved_constant_11*tmp_moved_constant_35 - tmp_moved_constant_33*tmp_moved_constant_9);
       const real_t tmp_moved_constant_50 = toMatrixScaling*(-tmp_moved_constant_12*tmp_moved_constant_33 - tmp_moved_constant_13*tmp_moved_constant_34 - tmp_moved_constant_14*tmp_moved_constant_35);
       const real_t tmp_moved_constant_51 = toMatrixScaling*(tmp_moved_constant_17*tmp_moved_constant_33 + tmp_moved_constant_20*tmp_moved_constant_34 + tmp_moved_constant_23*tmp_moved_constant_35);
       const real_t tmp_moved_constant_52 = toMatrixScaling*(tmp_moved_constant_24*tmp_moved_constant_33 + tmp_moved_constant_25*tmp_moved_constant_34 + tmp_moved_constant_26*tmp_moved_constant_35);
       const real_t tmp_moved_constant_53 = toMatrixScaling*(tmp_moved_constant_27*tmp_moved_constant_33 + tmp_moved_constant_28*tmp_moved_constant_34 + tmp_moved_constant_29*tmp_moved_constant_35);
