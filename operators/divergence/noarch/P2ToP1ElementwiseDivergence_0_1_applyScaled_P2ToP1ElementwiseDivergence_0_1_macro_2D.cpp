...
void P2ToP1ElementwiseDivergence_0_1::applyScaled_P2ToP1ElementwiseDivergence_0_1_macro_2D( real_t * RESTRICT  _data_dst, real_t * RESTRICT  _data_srcEdge, real_t * RESTRICT  _data_srcVertex, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t operatorScaling ) const
{
    {
       ...
       const real_t tmp_kernel_op_3 = jac_affine_inv_0_1_GRAY*(tmp_kernel_op_2 - 1.0);
       ...
       const real_t tmp_kernel_op_7 = jac_affine_inv_0_1_GRAY*(tmp_kernel_op_6 - 1.0);
       ...
       const real_t tmp_kernel_op_11 = jac_affine_inv_0_1_GRAY*(tmp_kernel_op_10 - 1.0);
       const real_t tmp_kernel_op_12 = 2.6666666666666665;
       const real_t tmp_kernel_op_13 = jac_affine_inv_1_1_GRAY*(tmp_kernel_op_12 - 1.0);
       const real_t tmp_kernel_op_14 = 0.66666666666666663;
       const real_t tmp_kernel_op_15 = jac_affine_inv_1_1_GRAY*(tmp_kernel_op_14 - 1.0);
       const real_t tmp_kernel_op_16 = 0.66666666666666663;
       const real_t tmp_kernel_op_17 = jac_affine_inv_1_1_GRAY*(tmp_kernel_op_16 - 1.0);
       const real_t tmp_kernel_op_18 = jac_affine_inv_0_1_GRAY*tmp_kernel_op_12;
       const real_t tmp_kernel_op_19 = jac_affine_inv_1_1_GRAY*tmp_kernel_op_2;
       const real_t tmp_kernel_op_20 = -tmp_kernel_op_18 - tmp_kernel_op_19;
       const real_t tmp_kernel_op_21 = jac_affine_inv_0_1_GRAY*tmp_kernel_op_14;
       const real_t tmp_kernel_op_22 = jac_affine_inv_1_1_GRAY*tmp_kernel_op_6;
       const real_t tmp_kernel_op_23 = -tmp_kernel_op_21 - tmp_kernel_op_22;
       const real_t tmp_kernel_op_24 = jac_affine_inv_0_1_GRAY*tmp_kernel_op_16;
       const real_t tmp_kernel_op_25 = jac_affine_inv_1_1_GRAY*tmp_kernel_op_10;
       const real_t tmp_kernel_op_26 = -tmp_kernel_op_24 - tmp_kernel_op_25;
       const real_t tmp_kernel_op_27 = -jac_affine_inv_1_1_GRAY*(-tmp_kernel_op_2 - 1.333333333333333) + tmp_kernel_op_18;
       const real_t tmp_kernel_op_28 = -jac_affine_inv_1_1_GRAY*(-tmp_kernel_op_6 + 2.666666666666667) + tmp_kernel_op_21;
       const real_t tmp_kernel_op_29 = -jac_affine_inv_1_1_GRAY*(-tmp_kernel_op_10 + 2.666666666666667) + tmp_kernel_op_24;
       const real_t tmp_kernel_op_30 = -jac_affine_inv_0_1_GRAY*(-tmp_kernel_op_12 + 2.666666666666667) + tmp_kernel_op_19;
       const real_t tmp_kernel_op_31 = -jac_affine_inv_0_1_GRAY*(-tmp_kernel_op_14 - 1.333333333333333) + tmp_kernel_op_22;
       const real_t tmp_kernel_op_32 = -jac_affine_inv_0_1_GRAY*(-tmp_kernel_op_16 + 2.666666666666667) + tmp_kernel_op_25;
       const real_t tmp_kernel_op_33 = tmp_kernel_op_12 + tmp_kernel_op_2 - 3.0;
       const real_t tmp_kernel_op_34 = -jac_affine_inv_0_1_GRAY*tmp_kernel_op_33 - jac_affine_inv_1_1_GRAY*tmp_kernel_op_33;
       const real_t tmp_kernel_op_35 = tmp_kernel_op_14 + tmp_kernel_op_6 - 3.0;
       const real_t tmp_kernel_op_36 = -jac_affine_inv_0_1_GRAY*tmp_kernel_op_35 - jac_affine_inv_1_1_GRAY*tmp_kernel_op_35;
       const real_t tmp_kernel_op_37 = tmp_kernel_op_10 + tmp_kernel_op_16 - 3.0;
       const real_t tmp_kernel_op_38 = -jac_affine_inv_0_1_GRAY*tmp_kernel_op_37 - jac_affine_inv_1_1_GRAY*tmp_kernel_op_37;
             ...
             {
                {
                   ...
                   const real_t p_affine_2_0 = macro_vertex_coord_id_0comp0 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_1comp0)*(1.0 + _data_float_loop_ctr_array_dim_0[ctr_0 - phantom_ctr_0])*1.0 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp0 + macro_vertex_coord_id_2comp0)*(1.0 + _data_float_loop_ctr_array_dim_1[ctr_0 - phantom_ctr_0])*1.0;
                   const real_t p_affine_2_1 = macro_vertex_coord_id_0comp1 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_1comp1)*(1.0 + _data_float_loop_ctr_array_dim_0[ctr_0 - phantom_ctr_0])*1.0 + 1.0 / (micro_edges_per_macro_edge_float)*(-macro_vertex_coord_id_0comp1 + macro_vertex_coord_id_2comp1)*(1.0 + _data_float_loop_ctr_array_dim_1[ctr_0 - phantom_ctr_0])*1.0;
                   _data_dst[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1] = operatorScaling*tmp_moved_constant_42 + _data_dst[ctr_0 + ctr_1*(micro_edges_per_macro_edge + 2) - ((ctr_1*(ctr_1 + 1)) / (2)) + 1];
                   _data_dst[ctr_0 + (ctr_1 + 1)*(micro_edges_per_macro_edge + 2) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2))] = operatorScaling*tmp_moved_constant_43 + _data_dst[ctr_0 + (ctr_1 + 1)*(micro_edges_per_macro_edge + 2) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2))];
                   _data_dst[ctr_0 + (ctr_1 + 1)*(micro_edges_per_macro_edge + 2) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2)) + 1] = operatorScaling*tmp_moved_constant_44 + _data_dst[ctr_0 + (ctr_1 + 1)*(micro_edges_per_macro_edge + 2) - (((ctr_1 + 1)*(ctr_1 + 2)) / (2)) + 1];
                }
             }
          }
