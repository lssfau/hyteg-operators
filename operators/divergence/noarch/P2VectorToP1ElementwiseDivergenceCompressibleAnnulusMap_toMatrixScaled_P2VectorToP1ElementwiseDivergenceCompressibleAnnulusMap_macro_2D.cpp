...
void P2VectorToP1ElementwiseDivergenceCompressibleAnnulusMap::toMatrixScaled_P2VectorToP1ElementwiseDivergenceCompressibleAnnulusMap_macro_2D( idx_t * RESTRICT  _data_dst, real_t * RESTRICT  _data_rhoEdge, real_t * RESTRICT  _data_rhoVertex, idx_t * RESTRICT  _data_src_edge_0, idx_t * RESTRICT  _data_src_edge_1, idx_t * RESTRICT  _data_src_vertex_0, idx_t * RESTRICT  _data_src_vertex_1, real_t macro_vertex_coord_id_0comp0, real_t macro_vertex_coord_id_0comp1, real_t macro_vertex_coord_id_1comp0, real_t macro_vertex_coord_id_1comp1, real_t macro_vertex_coord_id_2comp0, real_t macro_vertex_coord_id_2comp1, std::shared_ptr< SparseMatrixProxy > mat, int64_t micro_edges_per_macro_edge, real_t micro_edges_per_macro_edge_float, real_t radRayVertex, real_t radRefVertex, real_t rayVertex_0, real_t rayVertex_1, real_t refVertex_0, real_t refVertex_1, real_t thrVertex_0, real_t thrVertex_1, real_t toMatrixScaling ) const
{
    {
       ...
       const real_t tmp_kernel_op_142 = jac_affine_inv_0_1_GRAY*tmp_kernel_op_76 - tmp_kernel_op_123;
       {
          ...
          for (int64_t ctr_0 = 0; ctr_0 < -ctr_1 + micro_edges_per_macro_edge; ctr_0 += 1)
          {
             ...
             const real_t elMat_0_0 = toMatrixScaling*(tmp_kernel_op_26*tmp_kernel_op_28 + tmp_kernel_op_55*tmp_kernel_op_57 + tmp_kernel_op_84*tmp_kernel_op_86);
             const real_t elMat_0_1 = toMatrixScaling*(tmp_kernel_op_28*tmp_kernel_op_89 + tmp_kernel_op_57*tmp_kernel_op_92 + tmp_kernel_op_86*tmp_kernel_op_95);
             const real_t elMat_0_2 = toMatrixScaling*(tmp_kernel_op_101*tmp_kernel_op_57 + tmp_kernel_op_104*tmp_kernel_op_86 + tmp_kernel_op_28*tmp_kernel_op_98);
             const real_t elMat_0_3 = toMatrixScaling*(tmp_kernel_op_111*tmp_kernel_op_28 + tmp_kernel_op_118*tmp_kernel_op_57 + tmp_kernel_op_125*tmp_kernel_op_86);
             const real_t elMat_0_4 = toMatrixScaling*(tmp_kernel_op_128*tmp_kernel_op_28 + tmp_kernel_op_131*tmp_kernel_op_57 + tmp_kernel_op_134*tmp_kernel_op_86);
             const real_t elMat_0_5 = toMatrixScaling*(tmp_kernel_op_137*tmp_kernel_op_28 + tmp_kernel_op_140*tmp_kernel_op_57 + tmp_kernel_op_143*tmp_kernel_op_86);
             const real_t elMat_0_6 = toMatrixScaling*(tmp_kernel_op_145*tmp_kernel_op_28 + tmp_kernel_op_147*tmp_kernel_op_57 + tmp_kernel_op_149*tmp_kernel_op_86);
             const real_t elMat_0_7 = toMatrixScaling*(tmp_kernel_op_150*tmp_kernel_op_28 + tmp_kernel_op_151*tmp_kernel_op_57 + tmp_kernel_op_152*tmp_kernel_op_86);
             const real_t elMat_0_8 = toMatrixScaling*(tmp_kernel_op_153*tmp_kernel_op_28 + tmp_kernel_op_154*tmp_kernel_op_57 + tmp_kernel_op_155*tmp_kernel_op_86);
             const real_t elMat_0_9 = toMatrixScaling*(tmp_kernel_op_156*tmp_kernel_op_28 + tmp_kernel_op_157*tmp_kernel_op_57 + tmp_kernel_op_158*tmp_kernel_op_86);
             const real_t elMat_0_10 = toMatrixScaling*(tmp_kernel_op_159*tmp_kernel_op_28 + tmp_kernel_op_160*tmp_kernel_op_57 + tmp_kernel_op_161*tmp_kernel_op_86);
             const real_t elMat_0_11 = toMatrixScaling*(tmp_kernel_op_162*tmp_kernel_op_28 + tmp_kernel_op_163*tmp_kernel_op_57 + tmp_kernel_op_164*tmp_kernel_op_86);
             const real_t elMat_1_0 = toMatrixScaling*(tmp_kernel_op_165*tmp_kernel_op_26 + tmp_kernel_op_166*tmp_kernel_op_55 + tmp_kernel_op_167*tmp_kernel_op_84);
             const real_t elMat_1_1 = toMatrixScaling*(tmp_kernel_op_165*tmp_kernel_op_89 + tmp_kernel_op_166*tmp_kernel_op_92 + tmp_kernel_op_167*tmp_kernel_op_95);
             const real_t elMat_1_2 = toMatrixScaling*(tmp_kernel_op_101*tmp_kernel_op_166 + tmp_kernel_op_104*tmp_kernel_op_167 + tmp_kernel_op_165*tmp_kernel_op_98);
             const real_t elMat_1_3 = toMatrixScaling*(tmp_kernel_op_111*tmp_kernel_op_165 + tmp_kernel_op_118*tmp_kernel_op_166 + tmp_kernel_op_125*tmp_kernel_op_167);
             const real_t elMat_1_4 = toMatrixScaling*(tmp_kernel_op_128*tmp_kernel_op_165 + tmp_kernel_op_131*tmp_kernel_op_166 + tmp_kernel_op_134*tmp_kernel_op_167);
             const real_t elMat_1_5 = toMatrixScaling*(tmp_kernel_op_137*tmp_kernel_op_165 + tmp_kernel_op_140*tmp_kernel_op_166 + tmp_kernel_op_143*tmp_kernel_op_167);
             const real_t elMat_1_6 = toMatrixScaling*(tmp_kernel_op_145*tmp_kernel_op_165 + tmp_kernel_op_147*tmp_kernel_op_166 + tmp_kernel_op_149*tmp_kernel_op_167);
             const real_t elMat_1_7 = toMatrixScaling*(tmp_kernel_op_150*tmp_kernel_op_165 + tmp_kernel_op_151*tmp_kernel_op_166 + tmp_kernel_op_152*tmp_kernel_op_167);
             const real_t elMat_1_8 = toMatrixScaling*(tmp_kernel_op_153*tmp_kernel_op_165 + tmp_kernel_op_154*tmp_kernel_op_166 + tmp_kernel_op_155*tmp_kernel_op_167);
             const real_t elMat_1_9 = toMatrixScaling*(tmp_kernel_op_156*tmp_kernel_op_165 + tmp_kernel_op_157*tmp_kernel_op_166 + tmp_kernel_op_158*tmp_kernel_op_167);
             const real_t elMat_1_10 = toMatrixScaling*(tmp_kernel_op_159*tmp_kernel_op_165 + tmp_kernel_op_160*tmp_kernel_op_166 + tmp_kernel_op_161*tmp_kernel_op_167);
             const real_t elMat_1_11 = toMatrixScaling*(tmp_kernel_op_162*tmp_kernel_op_165 + tmp_kernel_op_163*tmp_kernel_op_166 + tmp_kernel_op_164*tmp_kernel_op_167);
             const real_t elMat_2_0 = toMatrixScaling*(tmp_kernel_op_168*tmp_kernel_op_26 + tmp_kernel_op_169*tmp_kernel_op_55 + tmp_kernel_op_170*tmp_kernel_op_84);
             const real_t elMat_2_1 = toMatrixScaling*(tmp_kernel_op_168*tmp_kernel_op_89 + tmp_kernel_op_169*tmp_kernel_op_92 + tmp_kernel_op_170*tmp_kernel_op_95);
             const real_t elMat_2_2 = toMatrixScaling*(tmp_kernel_op_101*tmp_kernel_op_169 + tmp_kernel_op_104*tmp_kernel_op_170 + tmp_kernel_op_168*tmp_kernel_op_98);
             const real_t elMat_2_3 = toMatrixScaling*(tmp_kernel_op_111*tmp_kernel_op_168 + tmp_kernel_op_118*tmp_kernel_op_169 + tmp_kernel_op_125*tmp_kernel_op_170);
             const real_t elMat_2_4 = toMatrixScaling*(tmp_kernel_op_128*tmp_kernel_op_168 + tmp_kernel_op_131*tmp_kernel_op_169 + tmp_kernel_op_134*tmp_kernel_op_170);
             const real_t elMat_2_5 = toMatrixScaling*(tmp_kernel_op_137*tmp_kernel_op_168 + tmp_kernel_op_140*tmp_kernel_op_169 + tmp_kernel_op_143*tmp_kernel_op_170);
             const real_t elMat_2_6 = toMatrixScaling*(tmp_kernel_op_145*tmp_kernel_op_168 + tmp_kernel_op_147*tmp_kernel_op_169 + tmp_kernel_op_149*tmp_kernel_op_170);
             const real_t elMat_2_7 = toMatrixScaling*(tmp_kernel_op_150*tmp_kernel_op_168 + tmp_kernel_op_151*tmp_kernel_op_169 + tmp_kernel_op_152*tmp_kernel_op_170);
             const real_t elMat_2_8 = toMatrixScaling*(tmp_kernel_op_153*tmp_kernel_op_168 + tmp_kernel_op_154*tmp_kernel_op_169 + tmp_kernel_op_155*tmp_kernel_op_170);
             const real_t elMat_2_9 = toMatrixScaling*(tmp_kernel_op_156*tmp_kernel_op_168 + tmp_kernel_op_157*tmp_kernel_op_169 + tmp_kernel_op_158*tmp_kernel_op_170);
             const real_t elMat_2_10 = toMatrixScaling*(tmp_kernel_op_159*tmp_kernel_op_168 + tmp_kernel_op_160*tmp_kernel_op_169 + tmp_kernel_op_161*tmp_kernel_op_170);
             const real_t elMat_2_11 = toMatrixScaling*(tmp_kernel_op_162*tmp_kernel_op_168 + tmp_kernel_op_163*tmp_kernel_op_169 + tmp_kernel_op_164*tmp_kernel_op_170);
