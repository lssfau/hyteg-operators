...
class P2ToP1ElementwiseDivergence_0_0 : public Operator< P2Function< real_t >, P1Function< real_t > >
{
 ...
 private:
   ...
   void applyScaled_P2ToP1ElementwiseDivergence_0_0_macro_2D( real_t* RESTRICT _data_dst,
   ...
   void applyScaled_P2ToP1ElementwiseDivergence_0_0_macro_3D( real_t* RESTRICT _data_dst,
                                                              real_t* RESTRICT _data_srcEdge,
                                                              real_t* RESTRICT _data_srcVertex,
                                                              real_t           macro_vertex_coord_id_0comp0,
                                                              real_t           macro_vertex_coord_id_0comp1,
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///     98     132      12       0      0              0                 0              4
   void toMatrixScaled_P2ToP1ElementwiseDivergence_0_0_macro_2D( idx_t* RESTRICT _data_dst,
   ...
   void toMatrixScaled_P2ToP1ElementwiseDivergence_0_0_macro_3D( idx_t* RESTRICT _data_dst,
                                                                 idx_t* RESTRICT _data_srcEdge,
                                                                 idx_t* RESTRICT _data_srcVertex,
                                                                 real_t          macro_vertex_coord_id_0comp0,
                                                                 real_t          macro_vertex_coord_id_0comp1,
