...
class P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map
: public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 public:
   P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                 size_t                                     minLevel,
                                                                 size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    419     465      15       0      3              0                 0              1
   void apply_P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map_macro_2D( real_t* RESTRICT _data_dst,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1681    1800      40       0      4              0                 0              1
   void apply_P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map_macro_3D( real_t* RESTRICT _data_dst,
                                                                                     real_t* RESTRICT _data_micromesh_edge_0,
                                                                                     real_t* RESTRICT _data_micromesh_edge_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///    383     429      15       0      3              0                 0              4
   void toMatrix_P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map_macro_2D( idx_t* RESTRICT  _data_dst,
                                                                                        real_t* RESTRICT _data_micromesh_edge_0,
                                                                                        real_t* RESTRICT _data_micromesh_edge_1,
                                                                                        real_t* RESTRICT _data_micromesh_vertex_0,
                                                                                        real_t* RESTRICT _data_micromesh_vertex_1,
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   1561    1680      40       0      4              0                 0              4
   void toMatrix_P2VectorToP1ElementwiseDivergenceCompressibleParametricP2Map_macro_3D( idx_t* RESTRICT  _data_dst,
                                                                                        real_t* RESTRICT _data_micromesh_edge_0,
                                                                                        real_t* RESTRICT _data_micromesh_edge_1,
                                                                                        real_t* RESTRICT _data_micromesh_edge_2,
                                                                                        real_t* RESTRICT _data_micromesh_vertex_0,
