...
: public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2592    5178      71      44     30              0                 0              1
   void apply_P2VectorToP1ElementwiseDivergenceRotationCompressibleIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2472    5066      71      44     30              0                 0              4
   void toMatrix_P2VectorToP1ElementwiseDivergenceRotationCompressibleIcosahedralShellMap_macro_3D(
