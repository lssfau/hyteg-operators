...
///
class P2VectorToP1ElementwiseDivergenceRotationCompressibleIcosahedralShellMap
: public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 public:
   P2VectorToP1ElementwiseDivergenceRotationCompressibleIcosahedralShellMap( const std::shared_ptr< PrimitiveStorage >& storage,
                                                                             size_t                                     minLevel,
                                                                             size_t                                     maxLevel,
 ...
 protected:
 private:
   /// Integral: P2VectorToP1ElementwiseDivergenceRotationCompressibleIcosahedralShellMap
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2592    5182      71      44     30              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseDivergenceRotationCompressibleIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2472    5186      71      44     30              0                 0              4
   void toMatrixScaled_P2VectorToP1ElementwiseDivergenceRotationCompressibleIcosahedralShellMap_macro_3D(
