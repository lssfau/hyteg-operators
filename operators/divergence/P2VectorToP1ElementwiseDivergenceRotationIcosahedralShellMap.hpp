...
: public Operator< P2VectorFunction< real_t >, P1Function< real_t > >
{
 ...
 private:
   ...
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2252    4730      71      44     30              0                 0              1
   void applyScaled_P2VectorToP1ElementwiseDivergenceRotationIcosahedralShellMap_macro_3D(
   ...
   ///   adds    muls    divs    pows    abs    assignments    function_calls    unknown_ops
   /// ------  ------  ------  ------  -----  -------------  ----------------  -------------
   ///   2132    4734      71      44     30              0                 0              4
   void toMatrixScaled_P2VectorToP1ElementwiseDivergenceRotationIcosahedralShellMap_macro_3D(
